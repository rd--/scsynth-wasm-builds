...
function genDictionaryAssignmentSlots(withLet, rhsDictionaryName, keyVarNamesArray) {
...
const asSl = {
    ...
    DictionaryAssignment (_l, lhs, _r, _e, rhs) {
        ...
        const slots = genDictionaryAssignmentSlots(false, rhsDictionaryName, keyVarNamesArray);
    ...
    DictionaryInitializer (_l, lhs, _r, _e, rhs) {
        const rhsDictionaryName = genSym('__SPL');
        const keyVarNamesArray = lhs.asIteration().children.map((c)=>c.parametersOf);
        const slots = genDictionaryAssignmentSlots(true, rhsDictionaryName, keyVarNamesArray);
