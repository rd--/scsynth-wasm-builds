...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _zIndex_2(
      _self,
      _plus_2(_max_1(_zIndices_1(_smallKansas_1(_self))), 1),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _x, _y) {
    ...
    _setProperty_4(
      _style_1(_framePane_1(_self)),
      "left",
      _plusPlus_2(_asString_1(_x), "px"),
      "",
    );
    return _setProperty_4(
      _style_1(_framePane_1(_self)),
      "top",
      _plusPlus_2(_asString_1(_y), "px"),
      "",
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _pointerBegin_1 = function (_event) {
      ...
      _x0_2(_self, _minus_2(_x_1(_event), _x_1(_titleRect)));
      return _y0_2(_self, _minus_2(_y_1(_event), _y_1(_titleRect)));
    };
    let _pointerMove_1 = function (_event) {
      ...
      return _ifTrue_2(_inMove_1(_self), function () {
        ...
        return _moveTo_3(
          _self,
          _minus_2(_x_1(_event), _x0_1(_self)),
          _minus_2(_y_1(_event), _y0_1(_self)),
        );
      });
    };
    ...
    _addEventListener_3(_menuButton_1(_self), "click", function (_event) {
      ...
      return _menu_5(
        _smallKansas_1(_self),
        "Frame Menu",
        _plusPlus_2(_frameMenuItems_1(_subject_1(_self)), _menuItems_1(_self)),
        true,
        _event,
      );
    });
    ...
    return _addEventListener_3(
      ...
      function (_event) {
        ...
        return _ifTrue_2(_ctrlKey_1(_event), function () {
          ...
          /* Statements */
          return _ifTrue_2(_equals_2(_key_1(_event), "Escape"), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
