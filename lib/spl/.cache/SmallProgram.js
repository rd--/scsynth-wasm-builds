...
sl.addMethod(
  ...
  function (_self, _result) {
    ...
    let _answerText = _createElement_2(
      "pre",
      Object.fromEntries([["class", "answerText"]]),
    );
    /* Statements */
    ...
    return _ifTrue_2(_isPromise_1(_result), function () {
      ...
      return _then_2(_result, function (_nextResult) {
        ...
        /* Statements */
        return _addToAnswer_2(_self, _nextResult);
      });
    });
  },
...
sl.addMethod(
  ...
  function (_self, _smallKansas) {
    ...
    _addEventListener_3(_program_1(_self), "keydown", function (_event) {
      ...
      /* Statements */
      _ifTrue_2(_shiftKey_1(_event), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _smallKansas, _event) {
    ...
    /* Statements */
    return _addFrame_3(_smallKansas, _SmallProgram_1(_smallKansas), _event);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _initialize_2(_newSmallProgram_0(), _self);
  },
