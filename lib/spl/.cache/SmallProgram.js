...
sl.addMethod(
  ...
  function (_self, _programText, _result) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _programText, _result"; /* console.error(errorMessage); */
    ...
    return _ifTrue_2(_isPromise_1(_result), function () {
      ...
      return _then_2(_result, function (_nextResult) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _nextResult"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _smallKansas, _description, _program, _expectedAnswer) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _smallKansas, _description, _program, _expectedAnswer"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    ...
    _program_2(
      ...
      _createElement_2(
        "textarea",
        Object.fromEntries([["class", "program"], ["spellcheck", "false"]]),
      ),
    );
    ...
    _addEventListener_3(_program_1(_self), "keydown", function (_event) {
      ...
      let _bindings = _collect_2(_menuItems_1(_self), function (_each) {
        ...
        /* Statements */
        return _keyBinding_2(_each, _event);
      });
      /* Statements */
      ...
      return _ifTrue_2(_shiftKey_1(_event), function () {
        ...
        return _caseOfOtherwise_3(_key_1(_event), [
          _hyphenMinusGreaterThanSign_2("Enter", function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage =
                "Arity: expected 0, "; /* console.error(errorMessage); */
          ...
          _hyphenMinusGreaterThanSign_2("ArrowUp", function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage =
                "Arity: expected 0, "; /* console.error(errorMessage); */
          ...
          _hyphenMinusGreaterThanSign_2("ArrowDown", function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage =
                "Arity: expected 0, "; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _description, _program, _expectedAnswer) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _description, _program, _expectedAnswer"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _smallKansas) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _smallKansas"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
