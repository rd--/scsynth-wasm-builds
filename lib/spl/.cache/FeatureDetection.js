...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _findRepeat_2(_self, _equal_2);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "findTransientRepeat",
  ["self", "n", "aBlock:/2"],
  sl.annotateFunction(function (_self, _n, _aBlock_2) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _n, _aBlock_2";
      throw new Error(errorMessage);
    } /* Statements */
    let _k = _size_1(_self);
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _toDo_3(
        ...
        sl.annotateFunction(function (_i) {
          ...
          let _part = _ListView_4(_self, _i, _k, 1);
          let _repeat = _findRepeat_2(_part, _aBlock_2);
          return _ifTrue_2(
            _ampersand_2(
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _n) {
    ...
    return _findTransientRepeat_3(_self, _n, _equal_2);
  }, ["self", "n"]),
