...
sl.addMethod(
  ...
  function (_generator, _period, _maxDepth) {
    ...
    let _nextPair_1 = function (_pair) {
      ...
      let __genSym149 = _assertIsOfSize_2(_pair, 2),
        _i = _at_2(__genSym149, 1),
        _j = _at_2(__genSym149, 2);
      /* Statements */
    ...
    _whileTrue_1(function () {
      ...
      let _k = _max_2(_i, _j);
      let __genSym150 = _assertIsOfSize_2(_nextPair_1([_i, _j]), 2),
        _p = _at_2(__genSym150, 1),
        _q = _at_2(__genSym150, 2);
      let _nextLevel = _copyReplaceAllWith_3(_previousLevel, [_k], [_p, _q]);
      /* Statements */
      /* List Assignment */ (function () {
        const __genSym151 = [_p, _q];
        _i = _at_2(__genSym151, 1);
        _j = _at_2(__genSym151, 2);
      })();
