...
sl.addMethod(
  ...
  function (_self, _degree) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _degree"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _scaleDegree) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _scaleDegree"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _scaleDegree, _accidental) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _scaleDegree, _accidental"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_startIndex, _intervals, _description) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _startIndex, _intervals, _description"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
