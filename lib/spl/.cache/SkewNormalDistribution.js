sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _mu, _sigma, _alpha) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL318 = _assertIsOfSize_2(
          [_max_2(_u1, _u2), _min_2(_u1, _u2)],
          2,
        );
        let _u = _at_2(__SPL318, 1);
        let _v = _at_2(__SPL318, 2);
        /* Statements */
        return _if_3(
  ...
  "{ :self :mu :sigma :alpha | let f = { :x | +(*(x, sigma), mu) }; let u1 = normalDistribution(self,0, 1); if((=(alpha, 0)), { f(u1) }, { let u2 = normalDistribution(self,0, 1); let __SPL318 = assertIsOfSize([max(u1,u2), min(u1,u2)], 2); let u = at(__SPL318, 1); let v = at(__SPL318, 2); if((=(alpha, -1)), { f(v) }, { if((=(alpha, 1)), { f(u) }, { f(/((+((*((+(1, alpha)), u)), (*((-(1, alpha)), v)))), (*(sqrt((+(1, (*(alpha, alpha))))), sqrt(2))))) }) }) }) }",
);
