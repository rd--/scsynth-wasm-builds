sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _mu, _sigma, _alpha) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL546 = _assertIsOfSize_2(
          [_max_2(_u1, _u2), _min_2(_u1, _u2)],
          2,
        );
        let _u = _at_2(__SPL546, 1);
        let _v = _at_2(__SPL546, 2);
        /* Statements */
        return _if_3(
  ...
  "{ :self :mu :sigma :alpha | let f = { :x | +(*(x, sigma), mu) }; let u1 = normalDistribution(self,0, 1); if((=(alpha, 0)), { f(u1) }, { let u2 = normalDistribution(self,0, 1); let __SPL546 = assertIsOfSize([max(u1,u2), min(u1,u2)], 2); let u = at(__SPL546, 1); let v = at(__SPL546, 2); if((=(alpha, -1)), { f(v) }, { if((=(alpha, 1)), { f(u) }, { f(/((+((*((+(1, alpha)), u)), (*((-(1, alpha)), v)))), (*(sqrt((+(1, (*(alpha, alpha))))), sqrt(2))))) }) }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let mu = mu(self); let sigma = sigma(self); let alpha = alpha(self); { :x | /((*(exp(-((/(square((-(x, mu))), (*(2, square(sigma))))))), erfc(-((/((*(alpha, (-(x, mu)))), (*(sqrt(2), sigma)))))))), (*(sqrt(pi(2)), sigma))) } }",
);
