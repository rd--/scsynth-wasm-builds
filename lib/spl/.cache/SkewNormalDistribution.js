sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :mu :sigma :alpha | let f = { :x | +(*(x, sigma), mu) }; let u1 = normalDistribution(self,0, 1); if((=(alpha, 0)), { f(u1) }, { let u2 = normalDistribution(self,0, 1); let __SplVar1 = assertIsOfSize([max(u1,u2), min(u1,u2)], 2); let u = at(__SplVar1, 1); let v = at(__SplVar1, 2); if((=(alpha, -1)), { f(v) }, { if((=(alpha, 1)), { f(u) }, { f(/((+((*((+(1, alpha)), u)), (*((-(1, alpha)), v)))), (*(sqrt((+(1, (*(alpha, alpha))))), sqrt(2))))) }) }) }) }",
);
