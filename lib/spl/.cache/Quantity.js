...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    return _plusSign_2(_self, _negated_1(_anObject));
  }, ["self", "anObject"]),
  "{ :self :anObject | +(self, negated(anObject)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | if((=(unit(self), 'hertz')), { magnitude(self) }, { error(self,'hertz: not frequency') }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _Quantity_2(_negated_1(_magnitude_1(_self)), _unit_1(_self));
  }, ["self"]),
  "{ :self | Quantity(negated(magnitude(self)), unit(self)) }",
);
