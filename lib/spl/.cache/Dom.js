...
sl.addTraitMethod(
  ...
  function (_self, _anArray) {
    ...
    /* Primitive */
    return _self.append(..._anArray);
  },
  "{ :self :anArray | <primitive: return _self.append(..._anArray);> }",
);
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Primitive */
    return _self.classList;
  },
  "{ :self | <primitive: return _self.classList;> }",
);
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _do_2(_asArray_1(_children_1(_self)), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
...
sl.addTraitMethod(
  ...
  function (_self, _anArray) {
    ...
    /* Statements */
    return _do_2(_anArray, function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _transformList) {
    ...
    /* Primitive */
    return _self.transform = transformList;
  },
...
sl.addMethod(
  ...
  function (_self, _margin) {
    ...
    return _unwords_1(
      _collect_2([
        _minus_2(_x_1(_origin_1(_self)), _margin),
        _minus_2(_y_1(_origin_1(_self)), _margin),
        _plus_2(_width_1(_self), _times_2(_margin, 2)),
        _plus_2(_height_1(_self), _times_2(_margin, 2)),
      ], _asString_1),
    );
  },
  ...
  function (_self, _aString) {
    ...
    return _if_3(_isEmpty_1(_aString), function () {
      ...
      return _valueWithReturn_1(function (_return_1) {
        ...
        /* Statements */
        _toDo_3(0, _minus_2(_length_1(_self), 1), function (_index) {
          /* ArityCheck */
          if (arguments.length !== 1) {
          ...
          /* Statements */
          return _ifTrue_2(
            _equals_2(_value_1(_item_2(_options_1(_self), _index)), _aString),
            function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
                const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_equals_2(_selectedIndex_1(_self), -1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _toString_1) {
    ...
    /* Statements */
    return _asHtmlRow_2(_asArray_1(_self), _toString_1);
  },
