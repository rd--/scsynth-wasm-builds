...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar1 = _assertIsOfSize_2(_c_1(_self), 2);
    ...
    let __SplUnused9 = _at_2(__SplVar2, 2);
    /* Statements */
    return _r;
  }, ["self"]),
  "{ :self | let __SplVar1 = assertIsOfSize(c(self), 2); let p = at(__SplVar1, 1); let q = at(__SplVar1, 2); let __SplVar2 = assertIsOfSize(toPolarCoordinates((-(q, p))), 2); let r = at(__SplVar2, 1); let _ = at(__SplVar2, 2); r }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar3 = _assertIsOfSize_2(_c_1(_self), 2);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar4 = _assertIsOfSize_2(_c_1(_self), 2);
    let _p = _at_2(__SplVar4, 1);
    let _q = _at_2(__SplVar4, 2);
    /* Statements */
    return _size_1(_p);
  }, ["self"]),
  "{ :self | let __SplVar4 = assertIsOfSize(c(self), 2); let p = at(__SplVar4, 1); let q = at(__SplVar4, 2); size(p) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let _r = _r_1(_self);
    let __SplVar5 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 4);
    let _a = _at_2(__SplVar5, 1);
    let _b = _at_2(__SplVar5, 2);
    let _c = _at_2(__SplVar5, 3);
    let _d = _at_2(__SplVar5, 4);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar6 = _assertIsOfSize_2(_c_1(_self), 2);
    let _p = _at_2(__SplVar6, 1);
    let _q = _at_2(__SplVar6, 2);
    let __SplVar7 = _assertIsOfSize_2(
      _toPolarCoordinates_1(_hyphenMinus_2(_q, _p)),
      2,
    );
    let __SplUnused10 = _at_2(__SplVar7, 1);
    let _theta = _at_2(__SplVar7, 2);
    /* Statements */
    return _theta;
  }, ["self"]),
  "{ :self | let __SplVar6 = assertIsOfSize(c(self), 2); let p = at(__SplVar6, 1); let q = at(__SplVar6, 2); let __SplVar7 = assertIsOfSize(toPolarCoordinates((-(q, p))), 2); let _ = at(__SplVar7, 1); let theta = at(__SplVar7, 2); theta }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar8 = _assertIsOfSize_2(_c_1(_self), 2);
