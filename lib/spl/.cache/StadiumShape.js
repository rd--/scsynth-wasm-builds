...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL7 = _assertIsOfSize_2(_c_1(_self), 2);
    ...
    let __genSym15 = _at_2(__SPL8, 2);
    /* Statements */
    return _r;
  }, ["self"]),
  "{ :self | let __SPL7 = assertIsOfSize(c(self), 2); let p = at(__SPL7, 1); let q = at(__SPL7, 2); let __SPL8 = assertIsOfSize(toPolarCoordinates((-(q, p))), 2); let r = at(__SPL8, 1); let _ = at(__SPL8, 2); r }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL9 = _assertIsOfSize_2(_c_1(_self), 2);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL10 = _assertIsOfSize_2(_c_1(_self), 2);
    let _p = _at_2(__SPL10, 1);
    let _q = _at_2(__SPL10, 2);
    /* Statements */
    return _size_1(_p);
  }, ["self"]),
  "{ :self | let __SPL10 = assertIsOfSize(c(self), 2); let p = at(__SPL10, 1); let q = at(__SPL10, 2); size(p) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let _r = _r_1(_self);
    let __SPL11 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 4);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL12 = _assertIsOfSize_2(_c_1(_self), 2);
    ...
    let __genSym16 = _at_2(__SPL13, 1);
    let _theta = _at_2(__SPL13, 2);
    /* Statements */
    return _theta;
  }, ["self"]),
  "{ :self | let __SPL12 = assertIsOfSize(c(self), 2); let p = at(__SPL12, 1); let q = at(__SPL12, 2); let __SPL13 = assertIsOfSize(toPolarCoordinates((-(q, p))), 2); let _ = at(__SPL13, 1); let theta = at(__SPL13, 2); theta }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL14 = _assertIsOfSize_2(_c_1(_self), 2);
