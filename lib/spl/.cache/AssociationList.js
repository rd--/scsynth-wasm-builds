...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _associationList_1(_self);
  },
...
sl.addMethod(
  ...
  function (_self, _key, _ifPresent_1, _ifAbsent_0) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _key, _ifPresent_1, _ifAbsent_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _ifNil_3(
      _detectIndex_2(_associationList_1(_self), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage =
      ...
      function (_index) {
        ...
        /* Statements */
        return _ifPresent_1(_value_1(_at_2(_associationList_1(_self), _index)));
      },
    );
  },
...
sl.addMethod(
  ...
  function (_self, _key) {
    ...
    /* Statements */
    return _detectIfFoundIfNone_4(_associationList_1(_self), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _each"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _collect_2(_associationList_1(_self), _key_1);
  },
  ...
  function (_self, _key, _aBlock_0) {
    ...
    return _ifNil_3(
      ...
      function (_index) {
        ...
        /* Statements */
        return _removeAt_2(_associationList_1(_self), _index);
      },
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _size_1(_associationList_1(_self));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _collect_2(_associationList_1(_self), _value_1);
  },
