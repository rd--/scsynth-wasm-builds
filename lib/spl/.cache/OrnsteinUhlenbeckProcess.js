...
sl.addMethodToExistingType(
  ...
  "{ :self :r :t :n | let a = { :y :t | *(theta(self), (-(mu(self), y))) }; let b = { :y :t | sigma(self) }; TemporalData(!({ let x0 = x0(self); ifNil(x0, { x0 := normalDistribution(r,mu(self), /(sigma(self), sqrt((*(2, theta(self)))))) }); transposed(eulerMaruyamaMethod(r,a:/2, b:/2, t, x0)) }, n)) }",
);
