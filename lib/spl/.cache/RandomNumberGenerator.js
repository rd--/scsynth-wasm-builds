    ...
    return _exclamationMark_2(
      sl.annotateFunction(function () {
        ...
        return _asPermutation_1(
          _fisherYatesShuffle_2(_self, _iota_1(_anInteger)),
        );
      }, []),
      _shape,
    );
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _randomPermutation_3(_self, _anInteger, []);
  }, ["self", "anInteger"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _anInteger, _shape) {
    ...
    return _collect_2(
      _randomPermutation_3(_self, _anInteger, _shape),
      _permutationList_1,
    );
  }, ["self", "anInteger", "shape"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _permutationList_1(_randomPermutation_3(_self, _anInteger, []));
  }, ["self", "anInteger"]),
