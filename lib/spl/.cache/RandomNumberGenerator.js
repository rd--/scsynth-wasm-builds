...
sl.addTraitMethod(
  ...
  function (_self, _probablity, _shape) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _probablity, _shape"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aSequence, _shape) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aSequence, _shape"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_self, _min, _max, _shape) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _min, _max, _shape"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _Complex_2(
...
sl.addTraitMethod(
  ...
  function (_self, _min, _max, _aBlock_1, _shape) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _min, _max, _aBlock_1, _shape"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _exclamationMark_2(function () {
...
sl.addTraitMethod(
  ...
  function (_self, _max) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _max"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_self, _anInteger, _shape) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _anInteger, _shape"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _exclamationMark_2(function () {
...
sl.addTraitMethod(
  ...
  function (_self, _aCollection, _count) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aCollection, _count"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_self, _aSequence, _aNumber) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aSequence, _aNumber"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _answer = [];
...
sl.addTraitMethod(
  ...
  function (_self, _e, _w, _n) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _e, _w, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _k = _sum_1(_w);
...
sl.addMethod(
  ...
  function (_max) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _max"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_max, _shape) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _max, _shape"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
