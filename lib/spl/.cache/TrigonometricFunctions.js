...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isZero(self), { Infinity }, { arcSin((/(1, self))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isZero(self), { Infinity }, { arcCos((/(1, self))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :z | *(Complex(0, -1), log((+(sqrt((-(1, (/(1, square(z)))))), (/(Complex(0, 1), z)))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :z | *(Complex(0, -1), (-(log((+(sqrt((-(1, square(z)))), 1))), log(z)))) }",
);
