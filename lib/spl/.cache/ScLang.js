...
sl.extendTraitWithMethod(
  ...
  "normalize",
  ["self", "outMin", "outMax"],
  function (_self, _outMin, _outMax) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _outMin, _outMax";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _linLin_5(_self, _min_1(_self), _max_1(_self), _outMin, _outMax);
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _collect_2(
      _upOrDownTo_2(0, _hyphenMinus_2(_bitShift_2(1, _size_1(_self)), 1)),
      function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
...
sl.extendTraitWithMethod(
  ...
  function (_self, _base) {
    ...
    return _circumflexAccent_2(
      _base,
      _ceiling_1(_solidus_2(_log_1(_self), _log_1(_base))),
    );
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _base) {
    ...
    return _circumflexAccent_2(
      _base,
      _hyphenMinus_2(_ceiling_1(_solidus_2(_log_1(_self), _log_1(_base))), 1),
    );
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aMatrix) {
    ...
    return _withIndexCollect_2(_self, function (_each, _index) {
      ...
      /* Statements */
      return _plusSignPlusSign_2(_each, _atWrap_2(_aMatrix, _index));
    });
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _harmonicNumber, _amplitude, _initialPhase) {
    ...
    let _frequency = _solidus_2(1, _harmonicNumber);
    let _increment = _asterisk_2(
      _solidus_2(_asterisk_2(2, _pi), _size),
      _frequency,
    );
    ...
    return _do_2(_upOrDownTo_2(1, _size), function (_each) {
      ...
      _atPut_3(
        ...
        _plusSign_2(
          _at_2(_self, _each),
          _asterisk_2(_sin_1(_phase), _amplitude),
        ),
      );
...
sl.extendTraitWithMethod(
  ...
  function (_self, _size) {
    ...
    return _collect_2(_upOrDownTo_2(1, _size), function (_index) {
      ...
      /* Statements */
      return _solidus_2(
        _hyphenMinus_2(_indexInBetween_2(_a, _index), 1),
        _size,
      );
    });
  },
    ...
    return _if_3(_lessThanSignEqualsSign_2(_size_1(_self), 1), function () {
      ...
      _valueWithReturn_1(function (_return_1) {
        ...
        return _doAdjacentPairs_2(_self, function (_a, _b) {
          ...
          /* Temporaries */
          let _diff = _hyphenMinus_2(_b, _a);
          /* Statements */
          return _ifNil_3(_step, function () {
            ...
            /* Statements */
            return _ifTrue_2(_tildeEqualsSign_2(_step, _diff), function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
                const errorMessage = "Arity: expected 0, ";
                console.error(errorMessage);
...
sl.extendTraitWithMethod(
  ...
  function (_self, _min, _max) {
    ...
    /* Statements */
    return _rescale_5(_self, _min_1(_self), _max_1(_self), _min, _max);
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _newSize) {
    ...
    /* Statements */
    return _collect_2(
      _upOrDownTo_2(0, _hyphenMinus_2(_newSize, 1)),
      function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
...
sl.extendTraitWithMethod(
  ...
  function (_self, _windowSize, _stepSize) {
    ...
    /* Statements */
    return _concatenation_1(_slidingWindows_3(_self, _windowSize, _stepSize));
  },
