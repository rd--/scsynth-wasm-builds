...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _lessThan_2(_randomFloat_1(_system), _self);
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _upperBound) {
    ...
    /* Statements */
    return _linExpFromTo_3(_randomFloat_1(1), _self, _upperBound);
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    _do_2(_self, function (_item) {
      ...
      /* Statements */
      _atPut_3(_answer, _index, _minus_2(_item, _prev));
      _prev = _item;
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aMagnitude) {
    ...
    /* Statements */
    return _detectIndex_2(_self, function (_item) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _item";
        console.error(errorMessage);
      ...
      /* Statements */
      return _greaterThan_2(_item, _aMagnitude);
    });
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _blendAt_2(_self, _randomFloat_2(1, _size_1(_self)));
  },
