sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _u, _m) {
    ...
    let __SPL539 = _assertIsOfSize_2(_u, 3);
    let _umin = _at_2(__SPL539, 1);
    let _umax = _at_2(__SPL539, 2);
    let _targetUtil = _at_2(__SPL539, 3);
    let _sets = [];
    /* Statements */
    _timesRepeat_2(
      _m,
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _n, _u, _nsets) {
    ...
    let _k = _min_1(_Tuple_1([_floor_1(_u), _hyphenMinus_2(_n, 1)]));
