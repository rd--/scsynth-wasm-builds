sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _u, _m) {
    ...
    let __SPL313 = _assertIsOfSize_2(_u, 3);
    let _umin = _at_2(__SPL313, 1);
    let _umax = _at_2(__SPL313, 2);
    let _targetUtil = _at_2(__SPL313, 3);
    let _sets = [];
    /* Statements */
    _timesRepeat_2(
      _m,
