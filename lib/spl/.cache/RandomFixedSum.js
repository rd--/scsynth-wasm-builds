sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _u, _m) {
    ...
    let __SPL1 = _assertIsOfSize_2(_u, 3);
    let _umin = _at_2(__SPL1, 1);
    let _umax = _at_2(__SPL1, 2);
    let _targetUtil = _at_2(__SPL1, 3);
    let _sets = [];
    /* Statements */
    _timesRepeat_2(
      _m,
