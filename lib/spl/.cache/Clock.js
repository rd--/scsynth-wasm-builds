...
sl.addMethodToExistingType(
  ...
  "{ :self :aBlock:/2 :anObject :delay | scheduleInjecting(self, 0, anObject, { :currentTime :inputValue | let nextDelay = value(delay); ifTrue((&(isNotNil(inputValue), { isNotNil(nextDelay) })), { [nextDelay, aBlock(currentTime, inputValue)] }) }) }",
);
