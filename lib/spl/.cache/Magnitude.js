...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _u, _v) {
    ...
    let __SPL510 = _assertIsOfSize_2(_u, 2);
    let _min = _at_2(__SPL510, 1);
    let _max = _at_2(__SPL510, 2);
    let __SPL511 = _assertIsOfSize_2(_v, 2);
    let _vMin = _at_2(__SPL511, 1);
    let _vMax = _at_2(__SPL511, 2);
    /* Statements */
    return _if_3(
  ...
  "{ :self :u :v | let __SPL510 = assertIsOfSize(u, 2); let min = at(__SPL510, 1); let max = at(__SPL510, 2); let __SPL511 = assertIsOfSize(v, 2); let vMin = at(__SPL511, 1); let vMax = at(__SPL511, 2); if((<(self, min)), { vMin }, { if((>(self, max)), { vMax }, { self }) }) }",
);
