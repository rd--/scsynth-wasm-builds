...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _u, _v) {
    ...
    let _vMin = _at_2(__SPL4, 1);
    let _vMax = _at_2(__SPL4, 2);
    /* Statements */
    return _if_3(
  ...
  "{ :self :u :v | let __SPL3 = assertIsOfSize(u, 2); let min = at(__SPL3, 1); let max = at(__SPL3, 2); let __SPL4 = assertIsOfSize(v, 2); let vMin = at(__SPL4, 1); let vMax = at(__SPL4, 2); if((<(self, min)), { vMin }, { if((>(self, max)), { vMax }, { self }) }) }",
);
