...
sl.addMethodToExistingTrait(
  ...
  "{ :self :u :v | let __SplVar1 = assertIsOfSize(u, 2); let min = at(__SplVar1, 1); let max = at(__SplVar1, 2); let __SplVar2 = assertIsOfSize(v, 2); let vMin = at(__SplVar2, 1); let vMax = at(__SplVar2, 2); if((<(self, min)), { vMin }, { if((>(self, max)), { vMax }, { self }) }) }",
);
