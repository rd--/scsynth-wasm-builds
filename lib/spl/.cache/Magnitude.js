...
sl.addTraitMethod(
  ...
  function (_self, _aMagnitude) {
    ...
    /* Statements */
    return _typeResponsibility_2(_self, "@Magnitude>>lessThan");
  },
...
sl.addTraitMethod(
  ...
  function (_self, _aMagnitude) {
    ...
    /* Statements */
    return _or_2(_lessThan_2(_self, _aMagnitude), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _equals_2(_self, _aMagnitude);
    });
  },
  "{ :self :aMagnitude |\n\t\tself < aMagnitude | {\n\t\t\tself = aMagnitude\n\t\t}\n\t}",
);
...
sl.addTraitMethod(
  ...
  function (_self, _aMagnitude) {
    ...
    /* Statements */
    return _lessThan_2(_aMagnitude, _self);
  },
  "{ :self :aMagnitude |\n\t\taMagnitude < self\n\t}",
);
...
sl.addTraitMethod(
  ...
  function (_self, _aMagnitude) {
    ...
    /* Statements */
    return _lessThanEquals_2(_aMagnitude, _self);
  },
  "{ :self :aMagnitude |\n\t\taMagnitude <= self\n\t}",
);
...
sl.addTraitMethod(
  ...
  function (_self, _aMagnitude) {
    ...
    /* Statements */
    return _if_3(_equals_2(_self, _aMagnitude), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _if_3(_lessThan_2(_self, _aMagnitude), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _min, _max) {
    ...
    /* Statements */
    return _and_2(_lessThanEquals_2(_min, _self), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _lessThanEquals_2(_self, _max);
    });
  },
  "{ :self :min :max |\n\t\tmin <= self & {\n\t\t\tself <= max\n\t\t}\n\t}",
);
...
sl.addTraitMethod(
  ...
  function (_self, _min, _max) {
    ...
    /* Statements */
    return _max_2(_min_2(_self, _max), _min);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _first, _second) {
    ...
    /* Statements */
    return _if_3(_lessThan_2(_first, _second), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _aMagnitude, _aBlock_1) {
    ...
    /* Statements */
    return _if_3(
      _greaterThan_2(_aBlock_1(_self), _aBlock_1(_aMagnitude)),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addTraitMethod(
  ...
  function (_self, _aMagnitude) {
    ...
    /* Statements */
    return _if_3(_greaterThan_2(_self, _aMagnitude), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _aMagnitude, _aBlock_1) {
    ...
    /* Statements */
    return _if_3(
      _lessThan_2(_aBlock_1(_self), _aBlock_1(_aMagnitude)),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
