...
sl.addMethodToExistingTrait(
  ...
  "{ :self :operand | compare(self,operand) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _u, _v) {
    ...
    let __SPL28 = _assertIsOfSize_2(_u, 2);
    let _min = _at_2(__SPL28, 1);
    let _max = _at_2(__SPL28, 2);
    let __SPL29 = _assertIsOfSize_2(_v, 2);
    let _vMin = _at_2(__SPL29, 1);
    let _vMax = _at_2(__SPL29, 2);
    /* Statements */
    return _if_3(
  ...
  "{ :self :u :v | let __SPL28 = assertIsOfSize(u, 2); let min = at(__SPL28, 1); let max = at(__SPL28, 2); let __SPL29 = assertIsOfSize(v, 2); let vMin = at(__SPL29, 1); let vMax = at(__SPL29, 2); if((<(self, min)), { vMin }, { if((>(self, max)), { vMax }, { self }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :operand | if((=(self, operand)), { 0 }, { if((<(self, operand)), { -1 }, { 1 }) }) }",
);
