...
sl.addTraitMethod(
  ...
  function (_self, _lowMagnitude, _highMagnitude) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _lowMagnitude, _highMagnitude"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _lowMagnitude) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _lowMagnitude"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _highMagnitude) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _highMagnitude"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _min, _max, _vMin, _vMax) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _min, _max, _vMin, _vMax"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _first, _second) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _first, _second"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aMin, _aMax) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aMin, _aMax"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aMagnitude, _aBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aMagnitude, _aBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(
