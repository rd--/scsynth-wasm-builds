...
sl.extendTraitWithMethod(
  ...
  function (_input) {
    ...
    /* Statements */
    return _LsScan_2(_input, _plus_2);
  },
  "{ :input |\n\t\tLsScan(input, +)\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_input) {
    ...
    /* Statements */
    return _LsAdjacent_2(_input, _flip_1(_minus_2));
  },
...
sl.extendTraitWithMethod(
  ...
  function (_input, _windowSize, _stepSize) {
    ...
    /* Temporaries */
    let _overlap = _max_2(_minus_2(_windowSize, _stepSize), 0);
    let _require = _minus_2(_windowSize, _overlap);
    let _skip = _max_2(_minus_2(_stepSize, _windowSize), 0);
    ...
    return _BlockStream_2(function () {
      ...
      /* Statements */
      return _if_3(_tildeEquals_2(_size_1(_current), _require), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Temporaries */
        let _answer = _plusPlus_2(_window, _current);
        /* Statements */
        _ifTrue_2(_greaterThan_2(_skip, 0), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    let _timeDifference = _dividedBy_2(_minus_2(_unixTime, _systemTime), 1000);
    /* Statements */
      ...
      return _ifNil_3(_next, function () {
        ...
        let _packets = _concatenation_1(_collect_2(_events, function (_each) {
          ...
          return _asPatternEventMessages_2(
            _each,
            _plus_2(_currentTime, _timeDifference),
          );
        }));
        /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _currentTime) {
    ...
    let _synthId = _plus_2(100, _uniqueId_1(_system));
    let _addAction = 0;
    let _targetNode = 1;
    ...
    let _sNewBundle = _OscBundle_2(_plus_2(_currentTime, _latency), [
      _sNewMessage,
    ]);
    /* Statements */
    return _if_3(_includesKey_2(_self, "gate"), function () {
      ...
      let _releaseTime = _plus_2(_currentTime, _sustain);
      let _nSetMessage = _OscMessage_2("/n_set", [_synthId, "gate", 0]);
      let _nSetBundle = _OscBundle_2(_plus_2(_releaseTime, _latency), [
        _nSetMessage,
      ]);
      /* Statements */
  ...
  function (_low, _high, _p1, _p2, _length) {
    ...
    return _take_2(
      _BlockStream_2(function () {
        ...
        /* Statements */
        return _randomFloatEularianBetaDistribution_4(
          _next_1(_low),
          _next_1(_high),
          _next_1(_p1),
          _next_1(_p2),
...
sl.extendTraitWithMethod(
  ...
  "Ls",
  "LsBrownUsing",
  ["low", "high", "step", "aBlock:/2"],
  function (_low, _high, _step, _aBlock_2) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage = "Arity: expected 4, _low, _high, _step, _aBlock_2";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Temporaries */
    ...
    _next = _aBlock_2(_next_1(_low), _next_1(_high));
    return _withAndCollect_4(_low, _high, _step, function (_low, _high, _step) {
      ...
      _next = _foldBetweenAnd_3(
        _plus_2(_next, _aBlock_2(_negated_1(_step), _step)),
        _low,
        _high,
      );
      return _answer;
...
sl.extendTraitWithMethod(
  ...
  function (_low, _high, _step, _length) {
    ...
    /* Statements */
    return _take_2(
      _LsBrownUsing_4(_low, _high, _step, _randomFloat_2),
      _length,
    );
  },
...
sl.extendTraitWithMethod(
  ...
  function (_mean, _spread, _length) {
    ...
    return _take_2(
      _withCollect_3(_mean, _spread, _randomFloatCauchyDistribution_2),
      _length,
    );
  },
...
sl.extendTraitWithMethod(
  ...
  function (_low, _high, _step, _length) {
    ...
    /* Statements */
    return _take_2(
      _LsBrownUsing_4(_low, _high, _step, _randomIntegerExcludingZero_2),
      _length,
    );
  },
...
sl.extendTraitWithMethod(
  ...
  function (_low, _high, _length) {
    ...
    /* Statements */
    return _take_2(_randomFloat_2(_LsConstant_1(_low), _high), _length);
  },
