...
sl.extendTraitWithMethod(
  ...
  function (_anObject, _aStream) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _anObject, _aStream"; /* console.error(errorMessage); */
...
sl.extendTraitWithMethod(
  ...
  function (_anObject) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_aBlock_1, _start) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _aBlock_1, _start"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _next = _start;
...
sl.addMethod(
  ...
  function (_aBlock_1, _start, _length) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _aBlock_1, _start, _length"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_count, _input) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _count, _input"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_start, _step, _length) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _start, _step, _length"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _LsUnfold_3(
...
sl.extendTraitWithMethod(
  ...
  function (_list, _indices) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _list, _indices"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_list) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _list"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _index = 1;
...
sl.extendTraitWithMethod(
  ...
  function (_list, _count) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _list, _count"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_list, _repeats) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _list, _repeats"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_list, _which) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _list, _which"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _index = null;
...
sl.extendTraitWithMethod(
  ...
  function (_list, _steps) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _list, _steps"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_input) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _input"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_input, _aBlock_2) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _input, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_input, _size) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _input, _size"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_input, _latch, _initialValue) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _input, _latch, _initialValue"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_input, _repeats) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _input, _repeats"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_input, _windowSize, _stepSize) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _input, _windowSize, _stepSize"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_input, _anInteger) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _input, _anInteger"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _currentTime) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _currentTime"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _latency = 0.2;
...
sl.extendTraitWithMethod(
  ...
  function (_low, _high, _p1, _p2, _length) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _low, _high, _p1, _p2, _length"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_low, _high, _step, _aBlock_4) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _low, _high, _step, _aBlock_4"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _next = null;
    ...
    return _withAndCollect_4(_low, _high, _step, function (_low, _high, _step) {
      ...
      if (arguments.length !== 3) {
        const errorMessage =
          "Arity: expected 3, _low, _high, _step"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Temporaries */
      let _answer = _next;
...
sl.extendTraitWithMethod(
  ...
  function (_low, _high, _step, _length) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _low, _high, _step, _length"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_mean, _spread, _length) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _mean, _spread, _length"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_low, _high, _length) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _low, _high, _length"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _take_2(
      _withCollect_3(
        ...
        function (_min, _max) {
          ...
          if (arguments.length !== 2) {
            const errorMessage =
              "Arity: expected 2, _min, _max"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Statements */
...
sl.addMethod(
  ...
  function (_key, _value, _input) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _key, _value, _input"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    ...
    return _withCollect_3(_input, _value, function (_each, _z) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _each, _z"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
