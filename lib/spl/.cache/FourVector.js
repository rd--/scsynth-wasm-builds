...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL144 = _assertIsOfSize_2(_self, 4);
    let _w = _at_2(__SPL144, 1);
    let _x = _at_2(__SPL144, 2);
    let _y = _at_2(__SPL144, 3);
    let _z = _at_2(__SPL144, 4);
    /* Statements */
    return _FourVector_4(_w, _x, _y, _z);
  }, ["self"]),
  "{ :self | let __SPL144 = assertIsOfSize(self, 4); let w = at(__SPL144, 1); let x = at(__SPL144, 2); let y = at(__SPL144, 3); let z = at(__SPL144, 4); FourVector(w, x, y, z) }",
);
