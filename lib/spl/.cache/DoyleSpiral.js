...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r, _z, _delta, _limit) {
    ...
    let __SplVar1 = _assertIsOfSize_2(_limit, 2);
    let _minD = _at_2(__SplVar1, 1);
    let _maxD = _at_2(__SplVar1, 2);
    let _q = _z;
    let _modQ = _abs_1(_q);
    let _answer = [];
    let _count = 0;
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p, _q, _l) {
    ...
    let __SplVar2 = _assertIsOfSize_2(_doyleSpiralParameters_2(_p, _q), 3);
  ...
  "{ :p :q :l | let __SplVar2 = assertIsOfSize(doyleSpiralParameters(p, q), 3); let a = at(__SplVar2, 1); let b = at(__SplVar2, 2); let r = at(__SplVar2, 3); let z = a; let answer = []; toDo(1, q, { :i | addAll(answer,doyleSpiralArm(r, z, a, l)); z := *(z, b) }); answer }",
);
