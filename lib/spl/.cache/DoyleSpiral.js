...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r, _z, _delta, _limit) {
    ...
    let __SPL117 = _assertIsOfSize_2(_limit, 2);
    let _minD = _at_2(__SPL117, 1);
    let _maxD = _at_2(__SPL117, 2);
    let _q = _z;
    let _modQ = _abs_1(_q);
    let _answer = [];
    let _count = 0;
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p, _q, _l) {
    ...
    let __SPL118 = _assertIsOfSize_2(_doyleSpiralParameters_2(_p, _q), 3);
    let _a = _at_2(__SPL118, 1);
    let _b = _at_2(__SPL118, 2);
    let _r = _at_2(__SPL118, 3);
    let _z = _a;
    let _answer = [];
    /* Statements */
    _toDo_3(
  ...
  "{ :p :q :l | let __SPL118 = assertIsOfSize(doyleSpiralParameters(p, q), 3); let a = at(__SPL118, 1); let b = at(__SPL118, 2); let r = at(__SPL118, 3); let z = a; let answer = []; toDo(1, q, { :i | addAll(answer,doyleSpiralArm(r, z, a, l)); z := *(z, b) }); answer }",
);
