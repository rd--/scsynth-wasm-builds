...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL132 = _assertIsOfSize_2(_radii_1(_self), 2);
    let _rx = _at_2(__SPL132, 1);
    let _ry = _at_2(__SPL132, 2);
    /* Statements */
    return _pi_1(_asterisk_2(_rx, _ry));
  }, ["self"]),
  "{ :self | let __SPL132 = assertIsOfSize(radii(self), 2); let rx = at(__SPL132, 1); let ry = at(__SPL132, 2); pi((*(rx, ry))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _a = _at_2(__SPL133, 1);
    let _b = _at_2(__SPL133, 2);
    let _u = [_a, 0];
    let _v = [0, _b];
    /* Statements */
    return _ellipseAxisAlignedBoundingBox_3(_c, _u, _v);
  }, ["self"]),
  "{ :self | let c = center(self); let __SPL133 = assertIsOfSize(radii(self), 2); let a = at(__SPL133, 1); let b = at(__SPL133, 2); let u = [a, 0]; let v = [0, b]; ellipseAxisAlignedBoundingBox(c, u, v) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL134 = _assertIsOfSize_2(_majorMinorAxes_1(_self), 2);
    let _a = _at_2(__SPL134, 1);
    let _b = _at_2(__SPL134, 2);
    /* Statements */
    return _sqrt_1(_hyphenMinus_2(1, _square_1(_solidus_2(_b, _a))));
  }, ["self"]),
  "{ :self | let __SPL134 = assertIsOfSize(majorMinorAxes(self), 2); let a = at(__SPL134, 1); let b = at(__SPL134, 2); sqrt((-(1, square((/(b, a)))))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL135 = _assertIsOfSize_2(_center_1(_self), 2);
    let _x0 = _at_2(__SPL135, 1);
    let _y0 = _at_2(__SPL135, 2);
    let __SPL136 = _assertIsOfSize_2(_radii_1(_self), 2);
    let _a = _at_2(__SPL136, 1);
    let _b = _at_2(__SPL136, 2);
    /* Statements */
  ...
  "{ :self | let __SPL135 = assertIsOfSize(center(self), 2); let x0 = at(__SPL135, 1); let y0 = at(__SPL135, 2); let __SPL136 = assertIsOfSize(radii(self), 2); let a = at(__SPL136, 1); let b = at(__SPL136, 2); { :x :y | -(+((/(square((-(x, x0))), square(a))), (/(square((-(y, y0))), square(b)))), 1) } }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL137 = _assertIsOfSize_2(_majorMinorAxes_1(_self), 2);
    let _a = _at_2(__SPL137, 1);
    let _b = _at_2(__SPL137, 2);
    /* Statements */
    return _sqrt_1(_hyphenMinus_2(_square_1(_a), _square_1(_b)));
  }, ["self"]),
  "{ :self | let __SPL137 = assertIsOfSize(majorMinorAxes(self), 2); let a = at(__SPL137, 1); let b = at(__SPL137, 2); sqrt((-(square(a), square(b)))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL138 = _assertIsOfSize_2(_sorted_1(_radii_1(_self)), 2);
    let _b = _at_2(__SPL138, 1);
    let _a = _at_2(__SPL138, 2);
    /* Statements */
    return [_a, _b];
  }, ["self"]),
  "{ :self | let __SPL138 = assertIsOfSize(sorted(radii(self)), 2); let b = at(__SPL138, 1); let a = at(__SPL138, 2); [a, b] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL139 = _assertIsOfSize_2(_radii_1(_self), 2);
    let _a = _at_2(__SPL139, 1);
    let _b = _at_2(__SPL139, 2);
    /* Statements */
    return _solidus_2(_square_1(_b), _a);
  }, ["self"]),
  "{ :self | let __SPL139 = assertIsOfSize(radii(self), 2); let a = at(__SPL139, 1); let b = at(__SPL139, 2); /(square(b), a) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let __SPL140 = _assertIsOfSize_2(_center_1(_self), 2);
    let _cx = _at_2(__SPL140, 1);
    let _cy = _at_2(__SPL140, 2);
    let __SPL141 = _assertIsOfSize_2(_radii_1(_self), 2);
    let _rx = _at_2(__SPL141, 1);
    let _ry = _at_2(__SPL141, 2);
    /* Statements */
  ...
  '{ :self :options | let precision = at(options, \'precision\'); let __SPL140 = assertIsOfSize(center(self), 2); let cx = at(__SPL140, 1); let cy = at(__SPL140, 2); let __SPL141 = assertIsOfSize(radii(self), 2); let rx = at(__SPL141, 1); let ry = at(__SPL141, 2); format(\'<ellipse cx="%" cy="%" rx="%" ry="%" />\',[printStringToFixed(cx,precision), printStringToFixed(cy,precision), printStringToFixed(rx,precision), printStringToFixed(ry,precision)]) }',
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL142 = _assertIsOfSize_2(_center_1(_self), 2);
    let _x = _at_2(__SPL142, 1);
    let _y = _at_2(__SPL142, 2);
    let __SPL143 = _assertIsOfSize_2(_radii_1(_self), 2);
    let _a = _at_2(__SPL143, 1);
    let _b = _at_2(__SPL143, 2);
    /* Statements */
  ...
  "{ :self | let __SPL142 = assertIsOfSize(center(self), 2); let x = at(__SPL142, 1); let y = at(__SPL142, 2); let __SPL143 = assertIsOfSize(radii(self), 2); let a = at(__SPL143, 1); let b = at(__SPL143, 2); [[+(x, a), y], [x, +(y, b)], [-(x, a), y], [x, -(y, b)]] }",
);
