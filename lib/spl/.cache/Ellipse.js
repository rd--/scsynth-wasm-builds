...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL15 = _assertIsOfSize_2(_radii_1(_self), 2);
    let _rx = _at_2(__SPL15, 1);
    let _ry = _at_2(__SPL15, 2);
    /* Statements */
    return _pi_1(_asterisk_2(_rx, _ry));
  }, ["self"]),
  "{ :self | let __SPL15 = assertIsOfSize(radii(self), 2); let rx = at(__SPL15, 1); let ry = at(__SPL15, 2); pi((*(rx, ry))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL16 = _assertIsOfSize_2(_sorted_1(_radii_1(_self)), 2);
    let _b = _at_2(__SPL16, 1);
    let _a = _at_2(__SPL16, 2);
    /* Statements */
    return _sqrt_1(_hyphenMinus_2(1, _squared_1(_solidus_2(_b, _a))));
  }, ["self"]),
  "{ :self | let __SPL16 = assertIsOfSize(sorted(radii(self)), 2); let b = at(__SPL16, 1); let a = at(__SPL16, 2); sqrt((-(1, squared((/(b, a)))))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let __SPL17 = _assertIsOfSize_2(_center_1(_self), 2);
    let _cx = _at_2(__SPL17, 1);
    let _cy = _at_2(__SPL17, 2);
    let __SPL18 = _assertIsOfSize_2(_radii_1(_self), 2);
  ...
  '{ :self :options | let precision = at(options, \'precision\'); let __SPL17 = assertIsOfSize(center(self), 2); let cx = at(__SPL17, 1); let cy = at(__SPL17, 2); let __SPL18 = assertIsOfSize(radii(self), 2); let rx = at(__SPL18, 1); let ry = at(__SPL18, 2); format(\'<ellipse cx="%" cy="%" rx="%" ry="%" />\',[printStringToFixed(cx,precision), printStringToFixed(cy,precision), printStringToFixed(rx,precision), printStringToFixed(ry,precision)]) }',
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL19 = assertIsOfSize(radii(self), 2); let a = at(__SPL19, 1); let b = at(__SPL19, 2); sqrt((-(squared(a), squared(b)))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL20 = assertIsOfSize(radii(self), 2); let a = at(__SPL20, 1); let b = at(__SPL20, 2); /(squared(b), a) }",
);
