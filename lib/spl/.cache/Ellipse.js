...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar1 = assertIsOfSize(radii(self), 2); let rx = at(__SplVar1, 1); let ry = at(__SplVar1, 2); pi((*(rx, ry))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let c = center(self); let __SplVar2 = assertIsOfSize(radii(self), 2); let a = at(__SplVar2, 1); let b = at(__SplVar2, 2); let u = [a, 0]; let v = [0, b]; ellipseAxisAlignedBoundingBox(c, u, v) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar3 = assertIsOfSize(majorMinorAxes(self), 2); let a = at(__SplVar3, 1); let b = at(__SplVar3, 2); sqrt((-(1, square((/(b, a)))))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar4 = assertIsOfSize(center(self), 2); let x0 = at(__SplVar4, 1); let y0 = at(__SplVar4, 2); let __SplVar5 = assertIsOfSize(radii(self), 2); let a = at(__SplVar5, 1); let b = at(__SplVar5, 2); { :x :y | -(+((/(square((-(x, x0))), square(a))), (/(square((-(y, y0))), square(b)))), 1) } }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar6 = assertIsOfSize(majorMinorAxes(self), 2); let a = at(__SplVar6, 1); let b = at(__SplVar6, 2); sqrt((-(square(a), square(b)))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar7 = assertIsOfSize(sorted(radii(self)), 2); let b = at(__SplVar7, 1); let a = at(__SplVar7, 2); [a, b] }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar8 = assertIsOfSize(radii(self), 2); let a = at(__SplVar8, 1); let b = at(__SplVar8, 2); /(square(b), a) }",
);
...
sl.addMethodToExistingType(
  ...
  '{ :self :options | let precision = at(options, \'precision\'); let __SplVar9 = assertIsOfSize(center(self), 2); let cx = at(__SplVar9, 1); let cy = at(__SplVar9, 2); let __SplVar10 = assertIsOfSize(radii(self), 2); let rx = at(__SplVar10, 1); let ry = at(__SplVar10, 2); format(\'<ellipse cx="%" cy="%" rx="%" ry="%" />\',[printStringToFixed(cx,precision), printStringToFixed(cy,precision), printStringToFixed(rx,precision), printStringToFixed(ry,precision)]) }',
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar11 = assertIsOfSize(center(self), 2); let x = at(__SplVar11, 1); let y = at(__SplVar11, 2); let __SplVar12 = assertIsOfSize(radii(self), 2); let a = at(__SplVar12, 1); let b = at(__SplVar12, 2); [[+(x, a), y], [x, +(y, b)], [-(x, a), y], [x, -(y, b)]] }",
);
