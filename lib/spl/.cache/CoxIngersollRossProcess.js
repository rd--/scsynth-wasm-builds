...
sl.addMethodToExistingType(
  ...
  "{ :self :r :t :n | let mu = mu(self); let sigma = sigma(self); let theta = theta(self); let x0 = x0(self); let a = { :y :t | *(sigma, (-(mu, y))) }; let b = { :y :t | *(sigma, sqrt(y)) }; TemporalData(!({ transpose(eulerMaruyamaMethod(r,a:/2, b:/2, t, x0)) }, n)) }",
);
