...
sl.addTraitMethod(
  ...
  function (_self, _path) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _path"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _pathString) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _pathString"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _index) {
    ...
    /* Statements */
    return _typeResponsibility_2(_self, "@Indexable>>at");
  },
...
sl.addTraitMethod(
  ...
  function (_self, _primaryIndex, _secondaryIndex) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _primaryIndex, _secondaryIndex"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _primaryIndex, _secondaryIndex, _tertiaryIndex) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _primaryIndex, _secondaryIndex, _tertiaryIndex"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _at_2(
...
sl.addTraitMethod(
  ...
  function (
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _primaryIndex, _secondaryIndex, _tertiaryIndex, _quaternaryIndex"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _at_2(
...
sl.addTraitMethod(
  ...
  function (_self, _indices, _anObject) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _indices, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _indices, _values) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _indices, _values"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    _withDo_3(_indices, _values, function (_index, _value) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _index, _value"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _index, _aBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _index, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_includesIndex_2(_self, _index), function () {
...
sl.addTraitMethod(
  ...
  function (_self, _index, _aBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _index, _aBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _index, _ifPresent_1, _ifAbsent_0) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _index, _ifPresent_1, _ifAbsent_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_includesIndex_2(_self, _index), function () {
...
sl.addTraitMethod(
  ...
  function (_self, _indices, _value) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _indices, _value"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _item = _self;
    ...
    return _ifEmpty_3(_indices, function () {
      ...
      _toDo_3(
        ...
        function (_indicesIndex) {
          ...
          if (arguments.length !== 1) {
            const errorMessage =
              "Arity: expected 1, _indicesIndex"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_self, _primaryIndex, _secondaryIndex, _anObject) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _primaryIndex, _secondaryIndex, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _primaryIndex, _secondaryIndex, _tertiaryIndex, _anObject) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _primaryIndex, _secondaryIndex, _tertiaryIndex, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _atPut_3(
...
sl.addTraitMethod(
  ...
  function (
    ...
    if (arguments.length !== 6) {
      const errorMessage =
        "Arity: expected 6, _self, _primaryIndex, _secondaryIndex, _tertiaryIndex, _quaternaryIndex, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _atPut_3(
...
sl.addTraitMethod(
  ...
  function (_self, _index) {
    ...
    /* Statements */
    return _typeResponsibility_2(_self, "@Indexable>>basicAt");
  },
...
sl.addTraitMethod(
  ...
  function (_self, _index, _anObject) {
    ...
    /* Statements */
    return _typeResponsibility_2(_self, "@Indexable>>basicAtPut");
  },
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    let _answer = [];
    /* Statements */
    _deepIndicesStartingAtDo_3(_self, [], function (_each, _index) {
      /* ArityCheck */
      if (arguments.length !== 2) {
        const errorMessage =
...
sl.addTraitMethod(
  ...
  function (_self, _startIndex, _aBlock_2) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _startIndex, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_self, _for, _index) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _for, _index"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _error_2(
...
sl.addTraitMethod(
  ...
  function (_self, _anObject, _aBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _anObject, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _anObject) {
    ...
    _withIndexDo_2(_self, function (_each, _index) {
      ...
      /* Statements */
      return _ifTrue_2(_equalsSign_2(_each, _anObject), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage =
            "Arity: expected 0, "; /* console.error(errorMessage); */
