...
sl.addMethodToExistingTrait(
  ...
  "{ :self :index | atIfAbsent(self, index, { error(self,++('@Indexable>>at: invalid index: ', index)) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :anObject | indicesDo(self, { :index | atPut(self, index, anObject) }); anObject }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _aCollection) {
    ...
    return _includesAllOf_2(_indices_1(_self), _aCollection);
  }, ["self", "aCollection"]),
  "{ :self :aCollection | includesAllOf(indices(self),aCollection) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :anObject :aBlock:/0 | valueWithReturn({ :return:/1 | indicesDo(self, { :index | ifTrue((=(at(self, index), anObject)), { return(index) }) }); aBlock() }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let x = min(self); indicesOf(self,x) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :n | let x = sorted(self); collect(upOrDownTo(1, n), { :y | indicesOf(self,at(x, y)) }) }",
);
