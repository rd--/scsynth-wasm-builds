...
sl.addTraitMethod(
  ...
  function (_self, _index) {
    ...
    return _if_3(_includesIndex_2(_self, _index), function () {
      ...
      return _error_2(
        _self,
        _plusPlus_2("@Indexable>>assertIsValidIndex: no such index: ", _index),
      );
    });
  },
...
sl.addTraitMethod(
  ...
  function (_self, _index, _value) {
    ...
    /* Statements */
    return _atPut_3(_self, _index, _plus_2(_at_2(_self, _index), _value));
  },
...
sl.addTraitMethod(
  ...
  function (_self, _indices, _value) {
    ...
    return _ifEmpty_3(_indices, function () {
      ...
      /* Statements */
      _toDo_3(1, _minus_2(_size_1(_indices), 1), function (_indicesIndex) {
        /* ArityCheck */
        if (arguments.length !== 1) {
  ...
  function (_self, _anObject, _aBlock_0) {
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      _do_2(_indices_1(_self), function (_index) {
        ...
        /* Statements */
        return _ifTrue_2(
          _equals_2(_at_2(_self, _index), _anObject),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
