...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _vector) {
    ...
    let __SPL2 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL2, 1);
    let _b = _at_2(__SPL2, 2);
    let _c = _at_2(__SPL2, 3);
    let _d = _at_2(__SPL2, 4);
    let _e = _at_2(__SPL2, 5);
    let _f = _at_2(__SPL2, 6);
    let _g = _at_2(__SPL2, 7);
    let _h = _at_2(__SPL2, 8);
    let _i = _at_2(__SPL2, 9);
    let __SPL3 = _assertIsOfSize_2(_asList_1(_vector), 3);
  ...
  "{ :self :vector | let __SPL2 = assertIsOfSize(elements(self), 9); let a = at(__SPL2, 1); let b = at(__SPL2, 2); let c = at(__SPL2, 3); let d = at(__SPL2, 4); let e = at(__SPL2, 5); let f = at(__SPL2, 6); let g = at(__SPL2, 7); let h = at(__SPL2, 8); let i = at(__SPL2, 9); let __SPL3 = assertIsOfSize(asList(vector), 3); let x = at(__SPL3, 1); let y = at(__SPL3, 2); let z = at(__SPL3, 3); CartesianCoordinates(+(+((*(a, x)), (*(b, y))), (*(c, z))), +(+((*(d, x)), (*(e, y))), (*(f, z))), +(+((*(g, x)), (*(h, y))), (*(i, z)))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL4 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL4, 1);
    let _b = _at_2(__SPL4, 2);
    let _c = _at_2(__SPL4, 3);
    let _d = _at_2(__SPL4, 4);
    let _e = _at_2(__SPL4, 5);
    let _f = _at_2(__SPL4, 6);
    let _g = _at_2(__SPL4, 7);
    let _h = _at_2(__SPL4, 8);
    let _i = _at_2(__SPL4, 9);
    /* Statements */
  ...
  "{ :self | let __SPL4 = assertIsOfSize(elements(self), 9); let a = at(__SPL4, 1); let b = at(__SPL4, 2); let c = at(__SPL4, 3); let d = at(__SPL4, 4); let e = at(__SPL4, 5); let f = at(__SPL4, 6); let g = at(__SPL4, 7); let h = at(__SPL4, 8); let i = at(__SPL4, 9); -(-(-(+(+((*(*(a, e), i)), (*(*(b, f), g))), (*(*(c, d), h))), (*(*(c, e), g))), (*(*(b, d), i))), (*(*(a, f), h))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL5 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL5, 1);
    let _b = _at_2(__SPL5, 2);
    let _c = _at_2(__SPL5, 3);
    let _d = _at_2(__SPL5, 4);
    let _e = _at_2(__SPL5, 5);
    let _f = _at_2(__SPL5, 6);
    let _g = _at_2(__SPL5, 7);
    let _h = _at_2(__SPL5, 8);
    let _i = _at_2(__SPL5, 9);
    /* Statements */
    _elements_2(
      _self,
  ...
  "{ :self | let __SPL5 = assertIsOfSize(elements(self), 9); let a = at(__SPL5, 1); let b = at(__SPL5, 2); let c = at(__SPL5, 3); let d = at(__SPL5, 4); let e = at(__SPL5, 5); let f = at(__SPL5, 6); let g = at(__SPL5, 7); let h = at(__SPL5, 8); let i = at(__SPL5, 9); elements(self, *(determinant(self), [-((*(e, i)), (*(f, h))), negate((-((*(b, i)), (*(c, h))))), -((*(b, f)), (*(c, e))), negate((-((*(d, i)), (*(f, g))))), -((*(a, i)), (*(c, g))), negate((-((*(a, f)), (*(c, d))))), -((*(d, h)), (*(e, g))), (-(negate((*(a, h))), (*(b, g)))), -((*(a, e)), (*(b, d)))])); self }",
);
