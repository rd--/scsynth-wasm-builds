...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _vector) {
    ...
    let __SPL167 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL167, 1);
    let _b = _at_2(__SPL167, 2);
    let _c = _at_2(__SPL167, 3);
    let _d = _at_2(__SPL167, 4);
    let _e = _at_2(__SPL167, 5);
    let _f = _at_2(__SPL167, 6);
    let _g = _at_2(__SPL167, 7);
    let _h = _at_2(__SPL167, 8);
    let _i = _at_2(__SPL167, 9);
    let __SPL168 = _assertIsOfSize_2(_asList_1(_vector), 3);
    let _x = _at_2(__SPL168, 1);
    let _y = _at_2(__SPL168, 2);
    let _z = _at_2(__SPL168, 3);
    /* Statements */
  ...
  "{ :self :vector | let __SPL167 = assertIsOfSize(elements(self), 9); let a = at(__SPL167, 1); let b = at(__SPL167, 2); let c = at(__SPL167, 3); let d = at(__SPL167, 4); let e = at(__SPL167, 5); let f = at(__SPL167, 6); let g = at(__SPL167, 7); let h = at(__SPL167, 8); let i = at(__SPL167, 9); let __SPL168 = assertIsOfSize(asList(vector), 3); let x = at(__SPL168, 1); let y = at(__SPL168, 2); let z = at(__SPL168, 3); CartesianCoordinates(+(+((*(a, x)), (*(b, y))), (*(c, z))), +(+((*(d, x)), (*(e, y))), (*(f, z))), +(+((*(g, x)), (*(h, y))), (*(i, z)))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL169 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL169, 1);
    let _b = _at_2(__SPL169, 2);
    let _c = _at_2(__SPL169, 3);
    let _d = _at_2(__SPL169, 4);
    let _e = _at_2(__SPL169, 5);
    let _f = _at_2(__SPL169, 6);
    let _g = _at_2(__SPL169, 7);
    let _h = _at_2(__SPL169, 8);
    let _i = _at_2(__SPL169, 9);
    /* Statements */
  ...
  "{ :self | let __SPL169 = assertIsOfSize(elements(self), 9); let a = at(__SPL169, 1); let b = at(__SPL169, 2); let c = at(__SPL169, 3); let d = at(__SPL169, 4); let e = at(__SPL169, 5); let f = at(__SPL169, 6); let g = at(__SPL169, 7); let h = at(__SPL169, 8); let i = at(__SPL169, 9); -(-(-(+(+((*(*(a, e), i)), (*(*(b, f), g))), (*(*(c, d), h))), (*(*(c, e), g))), (*(*(b, d), i))), (*(*(a, f), h))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL170 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL170, 1);
    let _b = _at_2(__SPL170, 2);
    let _c = _at_2(__SPL170, 3);
    let _d = _at_2(__SPL170, 4);
    let _e = _at_2(__SPL170, 5);
    let _f = _at_2(__SPL170, 6);
    let _g = _at_2(__SPL170, 7);
    let _h = _at_2(__SPL170, 8);
    let _i = _at_2(__SPL170, 9);
    /* Statements */
    _elements_2(
      _self,
  ...
  "{ :self | let __SPL170 = assertIsOfSize(elements(self), 9); let a = at(__SPL170, 1); let b = at(__SPL170, 2); let c = at(__SPL170, 3); let d = at(__SPL170, 4); let e = at(__SPL170, 5); let f = at(__SPL170, 6); let g = at(__SPL170, 7); let h = at(__SPL170, 8); let i = at(__SPL170, 9); elements(self, *(determinant(self), [-((*(e, i)), (*(f, h))), negated((-((*(b, i)), (*(c, h))))), -((*(b, f)), (*(c, e))), negated((-((*(d, i)), (*(f, g))))), -((*(a, i)), (*(c, g))), negated((-((*(a, f)), (*(c, d))))), -((*(d, h)), (*(e, g))), (-(negated((*(a, h))), (*(b, g)))), -((*(a, e)), (*(b, d)))])); self }",
);
