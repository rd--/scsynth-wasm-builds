...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _vector) {
    ...
    let __SPL132 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL132, 1);
    let _b = _at_2(__SPL132, 2);
    let _c = _at_2(__SPL132, 3);
    let _d = _at_2(__SPL132, 4);
    let _e = _at_2(__SPL132, 5);
    let _f = _at_2(__SPL132, 6);
    let _g = _at_2(__SPL132, 7);
    let _h = _at_2(__SPL132, 8);
    let _i = _at_2(__SPL132, 9);
    let __SPL133 = _assertIsOfSize_2(_asList_1(_vector), 3);
    let _x = _at_2(__SPL133, 1);
    let _y = _at_2(__SPL133, 2);
    let _z = _at_2(__SPL133, 3);
    /* Statements */
  ...
  "{ :self :vector | let __SPL132 = assertIsOfSize(elements(self), 9); let a = at(__SPL132, 1); let b = at(__SPL132, 2); let c = at(__SPL132, 3); let d = at(__SPL132, 4); let e = at(__SPL132, 5); let f = at(__SPL132, 6); let g = at(__SPL132, 7); let h = at(__SPL132, 8); let i = at(__SPL132, 9); let __SPL133 = assertIsOfSize(asList(vector), 3); let x = at(__SPL133, 1); let y = at(__SPL133, 2); let z = at(__SPL133, 3); CartesianCoordinates(+(+((*(a, x)), (*(b, y))), (*(c, z))), +(+((*(d, x)), (*(e, y))), (*(f, z))), +(+((*(g, x)), (*(h, y))), (*(i, z)))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL134 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL134, 1);
    let _b = _at_2(__SPL134, 2);
    let _c = _at_2(__SPL134, 3);
    let _d = _at_2(__SPL134, 4);
    let _e = _at_2(__SPL134, 5);
    let _f = _at_2(__SPL134, 6);
    let _g = _at_2(__SPL134, 7);
    let _h = _at_2(__SPL134, 8);
    let _i = _at_2(__SPL134, 9);
    /* Statements */
  ...
  "{ :self | let __SPL134 = assertIsOfSize(elements(self), 9); let a = at(__SPL134, 1); let b = at(__SPL134, 2); let c = at(__SPL134, 3); let d = at(__SPL134, 4); let e = at(__SPL134, 5); let f = at(__SPL134, 6); let g = at(__SPL134, 7); let h = at(__SPL134, 8); let i = at(__SPL134, 9); -(-(-(+(+((*(*(a, e), i)), (*(*(b, f), g))), (*(*(c, d), h))), (*(*(c, e), g))), (*(*(b, d), i))), (*(*(a, f), h))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL135 = _assertIsOfSize_2(_elements_1(_self), 9);
    let _a = _at_2(__SPL135, 1);
    let _b = _at_2(__SPL135, 2);
    let _c = _at_2(__SPL135, 3);
    let _d = _at_2(__SPL135, 4);
    let _e = _at_2(__SPL135, 5);
    let _f = _at_2(__SPL135, 6);
    let _g = _at_2(__SPL135, 7);
    let _h = _at_2(__SPL135, 8);
    let _i = _at_2(__SPL135, 9);
    /* Statements */
    _elements_2(
      _self,
  ...
  "{ :self | let __SPL135 = assertIsOfSize(elements(self), 9); let a = at(__SPL135, 1); let b = at(__SPL135, 2); let c = at(__SPL135, 3); let d = at(__SPL135, 4); let e = at(__SPL135, 5); let f = at(__SPL135, 6); let g = at(__SPL135, 7); let h = at(__SPL135, 8); let i = at(__SPL135, 9); elements(self, *(determinant(self), [-((*(e, i)), (*(f, h))), negated((-((*(b, i)), (*(c, h))))), -((*(b, f)), (*(c, e))), negated((-((*(d, i)), (*(f, g))))), -((*(a, i)), (*(c, g))), negated((-((*(a, f)), (*(c, d))))), -((*(d, h)), (*(e, g))), (-(negated((*(a, h))), (*(b, g)))), -((*(a, e)), (*(b, d)))])); self }",
);
