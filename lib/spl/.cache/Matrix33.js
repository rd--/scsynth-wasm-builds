...
sl.addMethod(
  ...
  function (_self, _vector) {
    ...
    let __genSym8 = _assertIsOfSize_2(_asList_1(_vector), 3),
      _x = _at_2(__genSym8, 1),
      _y = _at_2(__genSym8, 2),
      _z = _at_2(__genSym8, 3);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym10 = _assertIsOfSize_2(_elements_1(_self), 9),
      _a = _at_2(__genSym10, 1),
      _b = _at_2(__genSym10, 2),
      _c = _at_2(__genSym10, 3),
      _d = _at_2(__genSym10, 4),
      _e = _at_2(__genSym10, 5),
      _f = _at_2(__genSym10, 6),
      _g = _at_2(__genSym10, 7),
      _h = _at_2(__genSym10, 8),
      _i = _at_2(__genSym10, 9);
    /* Statements */
    _elements_2(
      _self,
