...
sl.addMethod(
  ...
  function (_self, _vector) {
    ...
    /* Temporaries */
    let __genSym20 = _assertIsOfSize_2(_elements_1(_self), 9),
      _a = _at_2(__genSym20, 1),
      _b = _at_2(__genSym20, 2),
      _c = _at_2(__genSym20, 3),
      _d = _at_2(__genSym20, 4),
      _e = _at_2(__genSym20, 5),
      _f = _at_2(__genSym20, 6),
      _g = _at_2(__genSym20, 7),
      _h = _at_2(__genSym20, 8),
      _i = _at_2(__genSym20, 9);
    let __genSym21 = _assertIsOfSize_2(_asList_1(_vector), 3),
      _x = _at_2(__genSym21, 1),
      _y = _at_2(__genSym21, 2),
      _z = _at_2(__genSym21, 3);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym22 = _assertIsOfSize_2(_elements_1(_self), 9),
      _a = _at_2(__genSym22, 1),
      _b = _at_2(__genSym22, 2),
      _c = _at_2(__genSym22, 3),
      _d = _at_2(__genSym22, 4),
      _e = _at_2(__genSym22, 5),
      _f = _at_2(__genSym22, 6),
      _g = _at_2(__genSym22, 7),
      _h = _at_2(__genSym22, 8),
      _i = _at_2(__genSym22, 9);
    /* Statements */
