...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL526 = _assertIsOfSize_2(_dmsList_1(_self), 3);
    let _d = _at_2(__SPL526, 1);
  ...
  "{ :self | let __SPL526 = assertIsOfSize(dmsList(self), 3); let d = at(__SPL526, 1); let m = at(__SPL526, 2); let s = at(__SPL526, 3); format('%°%′%″',[printString(d), printString(m), printStringToFixed(s,3)]) }",
);
