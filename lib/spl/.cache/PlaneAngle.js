...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL1 = _assertIsOfSize_2(_dmsList_1(_self), 3);
  ...
  "{ :self | let __SPL1 = assertIsOfSize(dmsList(self), 3); let d = at(__SPL1, 1); let m = at(__SPL1, 2); let s = at(__SPL1, 3); format('%°%′%″',[printString(d), printString(m), printStringToFixed(s,3)]) }",
);
