...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL433 = _assertIsOfSize_2(_dmsList_1(_self), 3);
    let _d = _at_2(__SPL433, 1);
    let _m = _at_2(__SPL433, 2);
    let _s = _at_2(__SPL433, 3);
    /* Statements */
    return _format_2("%°%′%″", [
      _printString_1(_d),
      _printString_1(_m),
  ...
  "{ :self | let __SPL433 = assertIsOfSize(dmsList(self), 3); let d = at(__SPL433, 1); let m = at(__SPL433, 2); let s = at(__SPL433, 3); format('%°%′%″',[printString(d), printString(m), printStringToFixed(s,3)]) }",
);
