        ...
        return _if_3(_isNumber_1(_each), function () {
          ...
          return _if_3(_isList_1(_each), function () {
            ...
            let __genSym1 = _assertIsOfSize_2(_each, 2),
              _numerator = _at_2(__genSym1, 1),
              _denominator = _at_2(__genSym1, 2);
            /* Statements */
            return _ratioToCents_1(_solidus_2(_numerator, _denominator));
          }, function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
            ...
            return _error_2(_self, "asCents: invalid pitch");
          });
        });
      },
    );
      ...
      function (_each) {
        ...
        return _if_3(_isNumber_1(_each), function () {
          ...
          return _if_3(_isList_1(_each), function () {
            ...
            return _error_2(_self, "asRatios: invalid pitch");
          });
        });
      },
    );
  ...
  function (_self) {
    ...
    return _if_3(_isNumber_1(_octave), function () {
      ...
      return _if_3(_isList_1(_octave), function () {
        ...
        let __genSym3 = _assertIsOfSize_2(_octave, 2),
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _requireLibraryItem_2(_self, "Music/Scales/ScalaIntervalNames");
  },
    ...
    return _cached_3(_self, "scalaRationalTuningArchive", function () {
      ...
      return _collect_2(
        ...
        function (_each) {
          ...
          return _asRatioTuning_1(_contents_1(_each));
        },
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _dataBase = _scalaIntervalNames_1(_system);
    /* Statements */
    return _atIfAbsent_3(_dataBase, _printString_1(_self), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _dataBase = _scalaIntervalNames_1(_system);
    let _key = _keyAtValueIfAbsent_3(_dataBase, _self, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        /* console.error(errorMessage); */
      ...
      ["parser", function (_libraryItem) {
        ...
        return _collect_2(_libraryItem, function (_each) {
          ...
          _if_3(_includesKey_2(_each, "octave"), function () {
            ...
            let __genSym4 = _assertIsOfSize_2(_at_2(_each, "octave"), 2),
              _numerator = _at_2(__genSym4, 1),
              _denominator = _at_2(__genSym4, 2);
            /* Statements */
            return _atPut_3(
              _each,
              "octave",
    ...
    Object.fromEntries([
      ...
      ["parser", function (_libraryItem) {
        ...
        return _collect_2(_libraryItem, function (_each) {
          ...
          let __genSym5 = _assertIsOfSize_2(_each, 3),
            _zeroIndexedStartIndex = _at_2(__genSym5, 1),
            _intervals = _at_2(__genSym5, 2),
            _description = _at_2(__genSym5, 3);
          /* Statements */
          return _Scale_3(
    ...
    Object.fromEntries([
      ...
      ["parser", function (_libraryItem) {
        ...
        _keysAndValuesDo_2(_libraryItem, function (_key, _value) {
          ...
          let __genSym6 = _assertIsOfSize_2(_value, 2),
            _n = _at_2(__genSym6, 1),
            _d = _at_2(__genSym6, 2);
          /* Statements */
          return _add_2(
            _answer,
