...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _atMatrixOrElementwise_2(
      _self,
      sl.annotateFunction(function (_m) {
        ...
        let __SplVar1 = _assertIsOfSize_2(_m, 2);
        let _lowerLeft = _at_2(__SplVar1, 1);
        let _upperRight = _at_2(__SplVar1, 2);
