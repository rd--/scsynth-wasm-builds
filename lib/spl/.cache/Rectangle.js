...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    return _ampersand_2(_isRectangle_1(_anObject), function () {
      ...
      /* Statements */
      return _ampersand_2(
        _equalsSign_2(_origin_1(_self), _origin_1(_anObject)),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          return _equalsSign_2(_corner_1(_self), _corner_1(_anObject));
        },
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _solidus_2(_plusSign_2(_topLeft_1(_self), _bottomRight_1(_self)), 2);
  },
...
sl.addMethod(
  ...
  function (_self, _aPoint) {
    ...
    /* Statements */
    return _ampersand_2(
      _lessThanSignEqualsSign_2(_origin_1(_self), _aPoint),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        /* Statements */
        return _lessThanSign_2(_aPoint, _corner_1(_self));
      },
    );
  },
  "{ :self :aPoint |\n\t\tself.origin <= aPoint & {\n\t\t\taPoint < self.corner\n\t\t}\n\t}",
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _hyphenMinus_2(_corner_1(_self), _origin_1(_self));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _hyphenMinus_2(_y_1(_corner_1(_self)), _y_1(_origin_1(_self)));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _ampersand_2(_isInteger_1(_x_1(_self)), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _scale) {
    ...
    /* Statements */
    return _Rectangle_2(
      _asterisk_2(_origin_1(_self), _scale),
      _asterisk_2(_corner_1(_self), _scale),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _factor) {
    ...
    /* Statements */
    return _Rectangle_2(
      _plusSign_2(_origin_1(_self), _factor),
      _plusSign_2(_corner_1(_self), _factor),
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _hyphenMinus_2(_x_1(_corner_1(_self)), _x_1(_origin_1(_self)));
  },
...
sl.addMethod(
  ...
  function (_centerPoint, _extentPoint) {
    ...
    return _rectangleOriginExtent_2(
      _hyphenMinus_2(_centerPoint, _solidusSolidus_2(_extentPoint, 2)),
      _extentPoint,
    );
  },
...
sl.addMethod(
  ...
  function (_originPoint, _extentPoint) {
    ...
    return _rectangleOriginCorner_2(
      _originPoint,
      _plusSign_2(_originPoint, _extentPoint),
    );
  },
