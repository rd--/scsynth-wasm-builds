...
sl.addMethodToExistingType(
  ...
  "{ :self :aBlock:/1 | join(['Rectangle(', aBlock(lowerLeft(self)), ', ', aBlock(upperRight(self)), ')'],'') }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :scale | Rectangle(*(lowerLeft(self), scale), *(upperRight(self), scale)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    _allButFirstDo_2(_self, function (_aPoint) {
      /* ArityCheck */
      if (arguments.length !== 1) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_lowerLeft, _upperRight) {
    ...
    return _if_3(_greaterThanSign_2(_rank_1(_lowerLeft), 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
