...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plus_2(
      _log2_1(_times_2(_hertz_1(_self), _dividedBy_2(1, 440))),
      4.75,
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plus_2(
      _times_2(_log2_1(_times_2(_hertz_1(_self), _dividedBy_2(1, 440))), 12),
      69,
    );
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _hertz_1(_times_2(440, _raisedTo_2(2, _minus_2(_self, 4.75))));
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let _octave = _minus_2(_floor_1(_dividedBy_2(_self, 12)), 1);
    let _zero = _times_2(_plus_2(_octave, 1), 12);
    let _pitchClass = _dividedBy_2(_minus_2(_self, _zero), 100);
    /* Statements */
    return _plus_2(_octave, _pitchClass);
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    let _pitchClass = _times_2(_minus_2(_self, _octave), 100);
    /* Statements */
    return _plus_2(_times_2(_plus_2(_octave, 1), 12), _pitchClass);
  },
