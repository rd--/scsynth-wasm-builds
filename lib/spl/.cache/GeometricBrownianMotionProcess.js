...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _r, _t, _n) {
    ...
    let _c_1 = sl.annotateFunction(function (_y) {
      ...
      return _asterisk_2(_solidus_2(_squared_1(_sigma_1(_self)), 2), _y);
    }, ["y"]);
    /* Statements */
  ...
  "{ :self :r :t :n | let a = { :y | *(mu(self), y) }; let b = { :y | *(sigma(self), y) }; let c = { :y | *((/(squared(sigma(self)), 2)), y) }; TemporalData(!({ transposed(milsteinMethod(r,a:/1, b:/1, c:/1, t, x0(self))) }, n)) }",
);
