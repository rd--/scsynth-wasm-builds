...
sl.extendTraitWithMethod(
  ...
  function (_part, _voice) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _part, _voice"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _addrZero = 13000;
...
sl.extendTraitWithMethod(
  ...
  function (_part, _voice, _voiceBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _part, _voice, _voiceBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_part, _numVoices, _voiceBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _part, _numVoices, _voiceBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _collect_2(_upOrDownTo_2(1, _numVoices), function (_voice) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _voice"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_voiceNumber) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _voiceNumber"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
