...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    return _plusSign_2(
      _hyphenMinus_2(_asterisk_2(3, _squared_1(_n)), _asterisk_2(3, _n)),
      1,
    );
  }, ["n"]),
  "{ :n | +(-((*(3, squared(n))), (*(3, n))), 1) }",
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isOdd(self), { 0 }, { let f:/1 = memoize({ :m | let n = /(m, 2); if((=(n, 0)), { 1 }, { negated(sum(collect(Span(1, n, 1), { :k | *(binomial(*(2, n), *(2, k)), f(*(2, (-(n, k))))) }))) }) },false); f(self) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    return _solidus_2(_hyphenMinus_2(_asterisk_2(3, _squared_1(_n)), _n), 2);
  }, ["n"]),
  "{ :n | /((-(*(3, squared(n)), n)), 2) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r) {
    ...
    return sl.annotateFunction(function (_n) {
      ...
      return _solidus_2(
        _hyphenMinus_2(
          _plusSign_2(
            _asterisk_2(3, _squared_1(_n)),
            _asterisk_2(_cubed_1(_n), _hyphenMinus_2(_r, 2)),
          ),
  ...
  "{ :r | { :n | /((-(+((*(3, squared(n))), (*(cubed(n), (-(r, 2))))), (*(n, (-(r, 5)))))), 6) } }",
);
