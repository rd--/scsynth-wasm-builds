...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _round_1(
      _asterisk_2(
        _solidus_2(1, _plusSign_2(_self, 1)),
  ...
  sl.annotateFunction(function (_z) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _d = _List_2(_i, 0);
        _atPut_3(_d, 1, 1);
        let _x = _hyphenMinus_2(_z, _t_2(_hyphenMinus_2(_i, 1), _i));
        let _m = _hyphenMinus_2(_i, 1);
        _whileTrue_2(
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
      ...
      sl.annotateFunction(function (_n) {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _plusSign_2(
              _a_1(_hyphenMinus_2(_n, 1)),
              _sum_2(
                _Range_3(2, _hyphenMinus_2(_n, 2), 1),
                sl.annotateFunction(function (_k) {
                  /* ArityCheck */
                  if (arguments.length !== 1) {
                    const errorMessage = "Arity: expected 1, _k";
                  ...
                  return _asterisk_2(
                    _a_1(_k),
                    _a_1(_hyphenMinus_2(_hyphenMinus_2(_n, 2), _k)),
                  );
                }, ["k"]),
              ),
            );
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    return _floor_1(
      _solidus_2(
        _hyphenMinus_2(_sqrt_1(_plusSign_2(1, _asterisk_2(8, _n))), 1),
        2,
      ),
    );
  }, ["n"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "lahNumber",
  ["n", "k", "s"],
  sl.annotateFunction(function (_n, _k, _s) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _n, _k, _s";
      throw new Error(errorMessage);
    } /* Statements */
    return _caseOf_2(_s, [
      ...
      _hyphenMinusGreaterThanSign_2(
        ...
        sl.annotateFunction(function () {
          ...
          return _asterisk_2(_circumflexAccent_2(-1, _n), _lahNumber_2(_n, _k));
        }, []),
      ),
    ]);
  }, ["n", "k", "s"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n, _k) {
    ...
    return _asterisk_2(
      _binomial_2(_n, _k),
      _factorialPower_2(_hyphenMinus_2(_n, 1), _hyphenMinus_2(_n, _k)),
    );
  }, ["n", "k"]),
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _asterisk_2(
              ...
              _plusSign_2(
                1,
                _solidus_2(_asterisk_2(_hyphenMinus_2(_m, 1), _k), _n),
              ),
            );
          }, []),
        );
      ...
      sl.annotateFunction(function (_i) {
        ...
        return _Polynomial_1(
          _Map_1([
            ...
            _hyphenMinusGreaterThanSign_2(_hyphenMinus_2(_n, _i), -1),
          ]),
        );
      }, ["i"]),
    );
    let _b = _product_2(
      ...
      sl.annotateFunction(function (_i) {
        ...
        return _Polynomial_1(
          _Map_1([
            _hyphenMinusGreaterThanSign_2(0, 1),
            _hyphenMinusGreaterThanSign_2(_plusSign_2(_i, 1), -1),
          ]),
        );
      }, ["i"]),
    );
