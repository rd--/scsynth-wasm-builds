...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _a = _at_2(__SPL546, 1);
    let _b = _at_2(__SPL546, 2);
    /* Statements */
    return _initializeSlots_3(_newUniformDistribution_0(), _a, _b);
  }, ["self"]),
  "{ :self | let __SPL546 = assertIsOfSize(if(isVector(self), { self }, { transpose(self) }), 2); let a = at(__SPL546, 1); let b = at(__SPL546, 2); initializeSlots(newUniformDistribution(),a, b) }",
);
