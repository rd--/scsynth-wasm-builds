...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL319 = _assertIsOfSize_2(
      _if_3(
        _isVector_1(_self),
        sl.annotateFunction(function () {
          /* ArityCheck */
    ...
    let _a = _at_2(__SPL319, 1);
    let _b = _at_2(__SPL319, 2);
    /* Statements */
    return _initializeSlots_3(_newUniformDistribution_0(), _a, _b);
  }, ["self"]),
  "{ :self | let __SPL319 = assertIsOfSize(if(isVector(self), { self }, { transposed(self) }), 2); let a = at(__SPL319, 1); let b = at(__SPL319, 2); initializeSlots(newUniformDistribution(),a, b) }",
);
