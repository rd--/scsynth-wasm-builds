...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar1 = assertIsOfSize(if(isVector(self), { self }, { transpose(self) }), 2); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); initializeSlots(newUniformDistribution(),a, b) }",
);
