...
sl.addTraitMethod(
  ...
  function (_self, _aString, _aBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aString, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aBlockAssociationCollection) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aBlockAssociationCollection"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _caseOfOtherwise_3(
      ...
      function (_case) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _case"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aBlockAssociationCollection, _otherwise_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aBlockAssociationCollection, _otherwise_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    return (function (_unusedObject) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _unusedObject"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _self;
...
sl.addTraitMethod(
  ...
  function (_self, _maxIndices) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _maxIndices"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aString, _aValue) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aString, _aValue"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _block_1(
