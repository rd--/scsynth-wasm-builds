...
sl.addMethodToExistingTrait(
  ...
  "constant",
  ["self", "numArgs"],
  sl.annotateFunction(function (_self, _numArgs) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _numArgs";
      throw new Error(errorMessage);
    } /* Statements */
    return _caseOf_2(_numArgs, [
      ...
      _hyphenMinusGreaterThanSign_2(
        ...
        sl.annotateFunction(function () {
          ...
          return sl.annotateFunction(
            function (_unusedFirstArgument, _unusedSecondArgument) {
              /* ArityCheck */
              if (arguments.length !== 2) {
                const errorMessage =
                  "Arity: expected 2, _unusedFirstArgument, _unusedSecondArgument";
                throw new Error(errorMessage);
              } /* Statements */
              return _self;
            },
