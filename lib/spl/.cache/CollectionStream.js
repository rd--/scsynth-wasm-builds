...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _greaterThanEquals_2(_position_1(_self), _readLimit_1(_self));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(
      _greaterThanEquals_2(_position_1(_self), _readLimit_1(_self)),
      function () {
        /* ArityCheck */
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    let _endPosition = _min_2(
      _plus_2(_position_1(_self), _anInteger),
      _readLimit_1(_self),
    );
...
sl.addMethod(
  ...
  function (_self, _newStart, _newStop) {
    ...
    /* Statements */
    _position_2(_self, _minus_2(_newStart, 1));
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Temporaries */
    let _start = _plus_2(_position_1(_self), 1);
    let _end = _indexOfStartingAt_3(_collection_1(_self), _anObject, _start);
    /* Statements */
    return _if_3(
      _or_2(_equals_2(_end, 0), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _greaterThan_2(_end, _readLimit_1(_self));
      }),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
      ...
      function () {
        ...
        return _copyFromTo_3(_collection_1(_self), _start, _minus_2(_end, 1));
      },
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let _start = _plus_2(1, _position_1(_self));
    /* Statements */
