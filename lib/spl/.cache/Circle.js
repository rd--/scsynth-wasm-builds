...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym29 = _assertIsOfSize_2(_radii_1(_self), 2),
      _rx = _at_2(__genSym29, 1),
      _ry = _at_2(__genSym29, 2);
    /* Statements */
    return _asterisk_2(_asterisk_2(_pi, _rx), _ry);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym30 = _assertIsOfSize_2(_radii_1(_self), 2),
      _a = _at_2(__genSym30, 1),
      _b = _at_2(__genSym30, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _options) {
    ...
    let _precision = _at_2(_options, "precision");
    let __genSym31 = _assertIsOfSize_2(_center_1(_self), 2),
      _cx = _at_2(__genSym31, 1),
      _cy = _at_2(__genSym31, 2);
    let __genSym32 = _assertIsOfSize_2(_radii_1(_self), 2),
      _rx = _at_2(__genSym32, 1),
      _ry = _at_2(__genSym32, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _options) {
    ...
    let _precision = _at_2(_options, "precision");
    let __genSym35 = _assertIsOfSize_2(_center_1(_self), 2),
      _cx = _at_2(__genSym35, 1),
      _cy = _at_2(__genSym35, 2);
    let __genSym36 = _assertIsOfSize_2(_radii_1(_self), 2),
      _rx = _at_2(__genSym36, 1),
      _ry = _at_2(__genSym36, 2);
    let __genSym37 = _assertIsOfSize_2(_angles_1(_self), 2),
      _startAngle = _at_2(__genSym37, 1),
      _endAngle = _at_2(__genSym37, 2);
    let __genSym38 = _assertIsOfSize_2(
        _plusSign_2([_cx, _cy], [
      ...
      _x1 = _at_2(__genSym38, 1),
      _y1 = _at_2(__genSym38, 2);
    let __genSym39 = _assertIsOfSize_2(
      ...
      _x2 = _at_2(__genSym39, 1),
      _y2 = _at_2(__genSym39, 2);
