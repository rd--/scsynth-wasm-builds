          ...
          _hyphenMinusGreaterThanSign_2(
            ...
            sl.annotateFunction(function () {
              ...
              let __SplVar4 = _assertIsOfSize_2(
                _collect_2(_self, _listToComplex_1),
                3,
              );
              ...
              return _Circle_2(_realImaginary_1(_c), _r);
            }, []),
          ),
        ]);
      }, []),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _r) {
    ...
    let _z = _hyphenMinus_2(_asterisk_2(_x1, _x1), _asterisk_2(_x2, _x2));
    return [
      _solidus_2(_z, _sum),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar5 = _assertIsOfSize_2(_numeratorDenominator_1(_self), 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _circle) {
    ...
    return _listToComplex_1(
      _circleInversion_2(_realImaginary_1(_self), _circle),
    );
  }, ["self", "circle"]),
