...
sl.addTraitMethod(
  ...
  function (_self, _n, _aCollection, _startIndex) {
    ...
    /* Statements */
    return _if_3(_equals_2(_count, _n), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      return _copyFromTo_3(
        _aCollection,
        1,
        _minus_2(_plus_2(_startIndex, _count), 1),
      );
    });
  },
...
sl.addTraitMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _equals_2(_anObject, _next_1(_self));
  },
  "{ :self :anObject |\n\t\tanObject = self.next\n\t}",
);
...
sl.addTraitMethod(
  ...
  function (_self, _aCollection, _startIndex, _n) {
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      /* Statements */
      _upToDo_3(0, _minus_2(_n, 1), function (_i) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        return _atPut_3(_aCollection, _plus_2(_startIndex, _i), _obj);
      });
      return _n;
    });
  },
