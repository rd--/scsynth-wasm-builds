...
sl.addTraitMethod(
  ...
  function (_self, _n, _aCollection, _startIndex) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _n, _aCollection, _startIndex"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_self, _aCollection, _startIndex, _n) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _aCollection, _startIndex, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _valueWithReturn_1(function (_return_1) {
