...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL93 = _assertIsOfSize_2(_coordinates_1(_self), 3);
    let _rho = _at_2(__SPL93, 1);
    let _phi = _at_2(__SPL93, 2);
    let _z = _at_2(__SPL93, 3);
    /* Statements */
    return _Record_1([["rho", _rho], ["phi", _phi], ["z", _z]]);
  }, ["self"]),
  "{ :self | let __SPL93 = assertIsOfSize(coordinates(self), 3); let rho = at(__SPL93, 1); let phi = at(__SPL93, 2); let z = at(__SPL93, 3); Record([['rho', rho], ['phi', phi], ['z', z]]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL94 = _assertIsOfSize_2(_self, 3);
    let _rho = _at_2(__SPL94, 1);
    let _phi = _at_2(__SPL94, 2);
    let _z = _at_2(__SPL94, 3);
    /* Statements */
    return _initializeSlots_2(_newCylindricalCoordinates_0(), _self);
  }, ["self"]),
  "{ :self | let __SPL94 = assertIsOfSize(self, 3); let rho = at(__SPL94, 1); let phi = at(__SPL94, 2); let z = at(__SPL94, 3); initializeSlots(newCylindricalCoordinates(),self) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL95 = _assertIsOfSize_2(_self, 3);
        let _rho = _at_2(__SPL95, 1);
        let _phi = _at_2(__SPL95, 2);
        let _z = _at_2(__SPL95, 3);
  ...
  "{ :self | if(isVector(self), { let __SPL95 = assertIsOfSize(self, 3); let rho = at(__SPL95, 1); let phi = at(__SPL95, 2); let z = at(__SPL95, 3); let x = *(rho, cos(phi)); let y = *(rho, sin(phi)); [x, y, z] }, { collect(self,fromCylindricalCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL96 = _assertIsOfSize_2(_self, 3);
        let _x = _at_2(__SPL96, 1);
        let _y = _at_2(__SPL96, 2);
        let _z = _at_2(__SPL96, 3);
  ...
  "{ :self | if(isVector(self), { let __SPL96 = assertIsOfSize(self, 3); let x = at(__SPL96, 1); let y = at(__SPL96, 2); let z = at(__SPL96, 3); let rho = sqrt((+(squared(x), squared(y)))); let phi = atan2(y,x); [rho, phi, z] }, { collect(self,toCylindricalCoordinates:/1) }) }",
);
