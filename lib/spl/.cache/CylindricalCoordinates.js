...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL124 = _assertIsOfSize_2(_coordinates_1(_self), 3);
    let _rho = _at_2(__SPL124, 1);
    let _phi = _at_2(__SPL124, 2);
    let _z = _at_2(__SPL124, 3);
    /* Statements */
    return _Record_1([["rho", _rho], ["phi", _phi], ["z", _z]]);
  }, ["self"]),
  "{ :self | let __SPL124 = assertIsOfSize(coordinates(self), 3); let rho = at(__SPL124, 1); let phi = at(__SPL124, 2); let z = at(__SPL124, 3); Record([['rho', rho], ['phi', phi], ['z', z]]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL125 = _assertIsOfSize_2(_self, 3);
  ...
  "{ :self | let __SPL125 = assertIsOfSize(self, 3); let rho = at(__SPL125, 1); let phi = at(__SPL125, 2); let z = at(__SPL125, 3); initializeSlots(newCylindricalCoordinates(),self) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let __SPL126 = assertIsOfSize(self, 3); let rho = at(__SPL126, 1); let phi = at(__SPL126, 2); let z = at(__SPL126, 3); let x = *(rho, cos(phi)); let y = *(rho, sin(phi)); [x, y, z] }, { collect(self,fromCylindricalCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _x = _at_2(__SPL127, 1);
        let _y = _at_2(__SPL127, 2);
  ...
  "{ :self | if(isVector(self), { let __SPL127 = assertIsOfSize(self, 3); let x = at(__SPL127, 1); let y = at(__SPL127, 2); let z = at(__SPL127, 3); let rho = sqrt((+(square(x), square(y)))); let phi = atan2(y,x); [rho, phi, z] }, { collect(self,toCylindricalCoordinates:/1) }) }",
);
