...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL111 = _assertIsOfSize_2(_coordinates_1(_self), 3);
    let _rho = _at_2(__SPL111, 1);
    let _phi = _at_2(__SPL111, 2);
    let _z = _at_2(__SPL111, 3);
    /* Statements */
    return _Record_1([["rho", _rho], ["phi", _phi], ["z", _z]]);
  }, ["self"]),
  "{ :self | let __SPL111 = assertIsOfSize(coordinates(self), 3); let rho = at(__SPL111, 1); let phi = at(__SPL111, 2); let z = at(__SPL111, 3); Record([['rho', rho], ['phi', phi], ['z', z]]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _rho = _at_2(__SPL112, 1);
    let _phi = _at_2(__SPL112, 2);
    let _z = _at_2(__SPL112, 3);
    /* Statements */
    return _initializeSlots_2(_newCylindricalCoordinates_0(), _self);
  }, ["self"]),
  "{ :self | let __SPL112 = assertIsOfSize(self, 3); let rho = at(__SPL112, 1); let phi = at(__SPL112, 2); let z = at(__SPL112, 3); initializeSlots(newCylindricalCoordinates(),self) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL113 = _assertIsOfSize_2(_self, 3);
        let _rho = _at_2(__SPL113, 1);
        let _phi = _at_2(__SPL113, 2);
        let _z = _at_2(__SPL113, 3);
  ...
  "{ :self | if(isVector(self), { let __SPL113 = assertIsOfSize(self, 3); let rho = at(__SPL113, 1); let phi = at(__SPL113, 2); let z = at(__SPL113, 3); let x = *(rho, cos(phi)); let y = *(rho, sin(phi)); [x, y, z] }, { collect(self,fromCylindricalCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL114 = _assertIsOfSize_2(_self, 3);
        let _x = _at_2(__SPL114, 1);
        let _y = _at_2(__SPL114, 2);
        let _z = _at_2(__SPL114, 3);
  ...
  "{ :self | if(isVector(self), { let __SPL114 = assertIsOfSize(self, 3); let x = at(__SPL114, 1); let y = at(__SPL114, 2); let z = at(__SPL114, 3); let rho = sqrt((+(squared(x), squared(y)))); let phi = atan2(y,x); [rho, phi, z] }, { collect(self,toCylindricalCoordinates:/1) }) }",
);
