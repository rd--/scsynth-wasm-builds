...
sl.extendTraitWithMethod(
  ...
  function (_rho, _phi, _z) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _rho, _phi, _z"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym16 = _assertIsOfSize_2(_self, 3),
      _rho = _at_2(__genSym16, 1),
      _phi = _at_2(__genSym16, 2),
      _z = _at_2(__genSym16, 3);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym17 = _assertIsOfSize_2(_self, 3),
      _rho = _at_2(__genSym17, 1),
      _phi = _at_2(__genSym17, 2),
      _z = _at_2(__genSym17, 3);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym18 = _assertIsOfSize_2(_self, 3),
      _x = _at_2(__genSym18, 1),
      _y = _at_2(__genSym18, 2),
      _z = _at_2(__genSym18, 3);
