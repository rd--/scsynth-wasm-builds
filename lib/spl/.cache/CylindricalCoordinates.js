...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL15 = _assertIsOfSize_2(_coordinates_1(_self), 3);
    let _rho = _at_2(__SPL15, 1);
    let _phi = _at_2(__SPL15, 2);
    let _z = _at_2(__SPL15, 3);
    /* Statements */
    return _Record_1([["rho", _rho], ["phi", _phi], ["z", _z]]);
  }, ["self"]),
  "{ :self | let __SPL15 = assertIsOfSize(coordinates(self), 3); let rho = at(__SPL15, 1); let phi = at(__SPL15, 2); let z = at(__SPL15, 3); Record([['rho', rho], ['phi', phi], ['z', z]]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _rho = _at_2(__SPL16, 1);
    let _phi = _at_2(__SPL16, 2);
    let _z = _at_2(__SPL16, 3);
    /* Statements */
    return _initializeSlots_2(_newCylindricalCoordinates_0(), _self);
  }, ["self"]),
  "{ :self | let __SPL16 = assertIsOfSize(self, 3); let rho = at(__SPL16, 1); let phi = at(__SPL16, 2); let z = at(__SPL16, 3); initializeSlots(newCylindricalCoordinates(),self) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _rho = _at_2(__SPL17, 1);
        let _phi = _at_2(__SPL17, 2);
  ...
  "{ :self | if(isVector(self), { let __SPL17 = assertIsOfSize(self, 3); let rho = at(__SPL17, 1); let phi = at(__SPL17, 2); let z = at(__SPL17, 3); let x = *(rho, cos(phi)); let y = *(rho, sin(phi)); [x, y, z] }, { collect(self,fromCylindricalCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL18 = _assertIsOfSize_2(_self, 3);
  ...
  "{ :self | if(isVector(self), { let __SPL18 = assertIsOfSize(self, 3); let x = at(__SPL18, 1); let y = at(__SPL18, 2); let z = at(__SPL18, 3); let rho = sqrt((+(square(x), square(y)))); let phi = atan2(y,x); [rho, phi, z] }, { collect(self,toCylindricalCoordinates:/1) }) }",
);
