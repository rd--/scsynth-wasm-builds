...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL173 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 4);
    let _a = _at_2(__SPL173, 1);
    let _b = _at_2(__SPL173, 2);
    let _c = _at_2(__SPL173, 3);
    let _d = _at_2(__SPL173, 4);
    /* Statements */
    return _toBarycentricCoordinates_4(_a, _b, _c, _d);
  }, ["self"]),
  "{ :self | let __SPL173 = assertIsOfSize(vertexCoordinates(self), 4); let a = at(__SPL173, 1); let b = at(__SPL173, 2); let c = at(__SPL173, 3); let d = at(__SPL173, 4); toBarycentricCoordinates(a, b, c, d) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL174 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL174, 1);
    let _n = _at_2(__SPL174, 2);
    /* Statements */
    return _if_3(
      _ampersand_2(
        _equalsSign_2(_m, 4),
  ...
  "{ :self | let __SPL174 = assertIsOfSize(shape(self), 2); let m = at(__SPL174, 1); let n = at(__SPL174, 2); if((&(=(m, 4), { =(n, 3) })), { initializeSlots(newTetrahedron(),self) }, { error(self,'Tetrahedron: invalid matrix') }) }",
);
