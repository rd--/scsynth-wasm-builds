...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL17 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 4);
    let _a = _at_2(__SPL17, 1);
    let _b = _at_2(__SPL17, 2);
    let _c = _at_2(__SPL17, 3);
    let _d = _at_2(__SPL17, 4);
    /* Statements */
    return _toBarycentricCoordinates_4(_a, _b, _c, _d);
  }, ["self"]),
  "{ :self | let __SPL17 = assertIsOfSize(vertexCoordinates(self), 4); let a = at(__SPL17, 1); let b = at(__SPL17, 2); let c = at(__SPL17, 3); let d = at(__SPL17, 4); toBarycentricCoordinates(a, b, c, d) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL18 = assertIsOfSize(shape(self), 2); let m = at(__SPL18, 1); let n = at(__SPL18, 2); if((&(=(m, 4), { =(n, 3) })), { initializeSlots(newTetrahedron(),self) }, { error(self,'Tetrahedron: invalid matrix') }) }",
);
