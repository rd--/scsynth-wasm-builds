...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _and_2(_isPair_1(_anObject), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _and_2(
        _equals_2(_at_2(_self, 1), _at_2(_anObject, 1)),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          return _equals_2(_at_2(_self, 2), _at_2(_anObject, 2));
        },
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self, _index) {
    ...
    return _if_3(_equals_2(_index, 1), function () {
      ...
      /* Statements */
      return _if_3(_equals_2(_index, 2), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
