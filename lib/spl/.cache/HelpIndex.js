...
sl.addMethod(
  ...
  function (_self, _topic) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _topic"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _kind) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _kind"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _kind, _name) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _kind, _name"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function (_self) {
    ...
    return _initializeSlots_2(
      ...
      _collect_2(_select_2(_lines_1(_self), _notEmpty_1), function (_each) {
        ...
        /* Temporaries */
        let __genSym66 = _assertIsOfSize_2(
            _splitBy_2(_replaceString_3(_each, ".help.sl", ""), "/"),
            2,
          ),
          _kind = _at_2(__genSym66, 1),
          _name = _at_2(__genSym66, 2);
        /* Statements */
        return [_kind, _name];
      }),
    );
