sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL104 = _assertIsOfSize_2(_self, 2);
    let _lambda = _at_2(__SPL104, 1);
    let _phi = _at_2(__SPL104, 2);
    /* Statements */
    return [_phi, _asterisk_2(2, _sin_1(_lambda))];
  }, ["self"]),
  "{ :self | let __SPL104 = assertIsOfSize(self, 2); let lambda = at(__SPL104, 1); let phi = at(__SPL104, 2); [phi, *(2, sin(lambda))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _lambda = _at_2(__SPL105, 1);
    let _phi = _at_2(__SPL105, 2);
    /* Statements */
    return [
  ...
  "{ :self | let __SPL105 = assertIsOfSize(self, 2); let lambda = at(__SPL105, 1); let phi = at(__SPL105, 2); [/(phi, sqrt(2)), *((+(1, (/(sqrt(2), 2)))), tan((/(lambda, 2))))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL106 = _assertIsOfSize_2(_self, 2);
    let _phi = _at_2(__SPL106, 1);
    let _lambda = _at_2(__SPL106, 2);
    /* Statements */
    return [_lambda, _arcSinh_1(_tan_1(_phi))];
  }, ["self"]),
  "{ :self | let __SPL106 = assertIsOfSize(self, 2); let phi = at(__SPL106, 1); let lambda = at(__SPL106, 2); [lambda, arcSinh(tan(phi))] }",
);
