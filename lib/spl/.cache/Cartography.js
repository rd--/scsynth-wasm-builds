sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL113 = assertIsOfSize(self, 2); let lambda = at(__SPL113, 1); let phi = at(__SPL113, 2); [phi, *(2, sin(lambda))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _lambda = _at_2(__SPL114, 1);
    let _phi = _at_2(__SPL114, 2);
    /* Statements */
    return [
  ...
  "{ :self | let __SPL114 = assertIsOfSize(self, 2); let lambda = at(__SPL114, 1); let phi = at(__SPL114, 2); [/(phi, sqrt(2)), *((+(1, (/(sqrt(2), 2)))), tan((/(lambda, 2))))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL115 = _assertIsOfSize_2(_self, 2);
    let _phi = _at_2(__SPL115, 1);
    let _lambda = _at_2(__SPL115, 2);
    /* Statements */
    return [_lambda, _arcSinh_1(_tan_1(_phi))];
  }, ["self"]),
  "{ :self | let __SPL115 = assertIsOfSize(self, 2); let phi = at(__SPL115, 1); let lambda = at(__SPL115, 2); [lambda, arcSinh(tan(phi))] }",
);
