sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _lambda = _at_2(__SPL1, 1);
    let _phi = _at_2(__SPL1, 2);
    /* Statements */
    return [_phi, _asterisk_2(2, _sin_1(_lambda))];
  }, ["self"]),
  "{ :self | let __SPL1 = assertIsOfSize(self, 2); let lambda = at(__SPL1, 1); let phi = at(__SPL1, 2); [phi, *(2, sin(lambda))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL2 = _assertIsOfSize_2(_self, 2);
    let _lambda = _at_2(__SPL2, 1);
  ...
  "{ :self | let __SPL2 = assertIsOfSize(self, 2); let lambda = at(__SPL2, 1); let phi = at(__SPL2, 2); [/(phi, sqrt(2)), *((+(1, (/(sqrt(2), 2)))), tan((/(lambda, 2))))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _phi = _at_2(__SPL3, 1);
    let _lambda = _at_2(__SPL3, 2);
    /* Statements */
    return [_lambda, _arcSinh_1(_tan_1(_phi))];
  }, ["self"]),
  "{ :self | let __SPL3 = assertIsOfSize(self, 2); let phi = at(__SPL3, 1); let lambda = at(__SPL3, 2); [lambda, arcSinh(tan(phi))] }",
);
