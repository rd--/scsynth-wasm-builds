sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :algorithm | <primitive: return crypto.subtle.digest(_algorithm, _self);>\n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :algorithm | then(basicDigest(self,algorithm),asByteArray:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :algorithm | then(digest(utf8ByteArray(self),algorithm),base16Encode:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :seed | murmurHashGenerator(utf8ByteArray(self),seed) }",
);
