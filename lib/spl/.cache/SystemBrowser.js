      ...
      function (_browser, _path) {
        ...
        return _caseOf_2(_size_1(_path), [
          ...
          _minusGreaterThan_2(1, function () {
            ...
            _setStatus_2(
              _browser,
              _joinSeparatedBy_2(_typeTraits_2(_system, _at_2(_path, 1)), ", "),
            );
            _methodSet = _select_2(
              ...
              function (_each) {
                ...
                /* Statements */
                return _tildeEquals_2(_name_1(_origin_1(_each)), "Object");
              },
            );
            return _sorted_1(
              _asArray_1(_collect_2(_methodSet, _qualifiedName_1)),
            );
          }),
          _minusGreaterThan_2(2, function () {
            ...
            _selectedMethod = _detect_2(_methodSet, function (_each) {
              ...
              /* Statements */
              return _equals_2(_qualifiedName_1(_each), _at_2(_path, 2));
            });
