...
sl.addMethod(
  ...
  function (_self, _signature) {
    ...
    /* Temporaries */
    let __genSym1 = _assertIsOfSize_2(_parseMethodSignature_1(_signature), 2),
      _qualifiedOriginName = _at_2(__genSym1, 1),
      _qualifiedMethodName = _at_2(__genSym1, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aDuration) {
    ...
    let __genSym2 = _assertIsOfSize_2(
      ...
      _count = _at_2(__genSym2, 1),
      _elapsedTime = _at_2(__genSym2, 2);
    /* Statements */
    return _join_1([
