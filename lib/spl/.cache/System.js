...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    _atPut_3(_cache_1(_self), "uniqueIdentifier", _plusSign_2(_answer, 1));
    return _answer;
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _atPut_3(_cache_1(_self), "uniqueIdentifier", _anInteger);
  }, ["self", "anInteger"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _deleteAfter = _RegularExpression_2("([\\[\\(])\\s+", "g");
    let _deleteBefore = _RegularExpression_2("\\s+([\\]\\)\\.])", "g");
    let _a = _normalizeWhitespace_1(_self);
    let _b = _replaceAllWith_3(_deleteAfter, _a, "$1");
    let _c = _replaceAllWith_3(_deleteBefore, _b, "$1");
    return _c;
  }, ["self"]),
