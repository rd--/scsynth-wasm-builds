...
sl.addMethod(
  ...
  function (_self, _signature) {
    ...
    /* Temporaries */
    let __genSym44 = _assertIsOfSize_2(_parseMethodSignature_1(_signature), 2),
      _qualifiedOriginName = _at_2(__genSym44, 1),
      _qualifiedMethodName = _at_2(__genSym44, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aDuration) {
    ...
    /* Temporaries */
    let __genSym45 = _assertIsOfSize_2(
        _benchForMilliseconds_2(_self, _milliseconds_1(_aDuration)),
        2,
      ),
      _count = _at_2(__genSym45, 1),
      _elapsedTime = _at_2(__genSym45, 2);
    /* Statements */
    return _join_1([
