...
sl.addMethodToExistingType(
  ...
  "{ :self :path :defaultValue | if(isEmpty(path), { error(self,'System>>preferencesReadPath: empty path') }, { let item = preferencesRead(self,at(path, 1)); let index = 2; whileTrue({ &(isNotNil(item), { <=(index, size(path)) }) }, { item := atIfAbsent(item, at(path, index), { nil }); index := +(index, 1) }); ?(item, { defaultValue }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :unused | <primitive: return Number.MIN_VALUE;>\n }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | cached(self, 'splOperatorCharacters', { contents('&*^@$=!>-<#%+?\\\\/~|') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let table = splPunctuationCharacterNameTable(self); cached(self, 'splOperatorNameTable', { asRecord(collect(++(collect(['& * ^ @ $ = ! > - < # % + ? \\\\ / ~ |', '&& @* @> == !^ !> !+ !~ >= >> >~ -> - <= <! <- << <~ ++ \\\\\\\\ // != !== ||', '>>> <=> +++'],words:/1)), { :each | ->(each, splOperatorTokenName(each,table)) })) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :unused | <primitive: return sl.splPunctuationCharacterNameTable;>\n }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :unused | <primitive: return sl.splPunctuationCharacters.split('');>\n }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aString | Url(++('https://rohandrape.net/sw/spl/', aString)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | <primitive: return sl.isSplOperatorCharacter(_self);>\n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | <primitive: return sl.isSplOperatorToken(_self);>\n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | <primitive: return sl.isSplPunctuationCharacter(_self);>\n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | <primitive: return sl.isSplPunctuationToken(_self);>\n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | <primitive: return sl.isSplSyntaxCharacter(_self);>\n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | <primitive: return sl.isSplSyntaxToken(_self);>\n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | valueWithReturn({ :return:/1 | associationsDo(splOperatorNameTable(system), { :each | ifTrue((=(value(each), self)), { return(key(each)) }) }); nil }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :table | if(isSplOperatorToken(self), { splPunctuationTokenName(self,table) }, { error(self,'splOperatorTokenName: not operator token') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | splOperatorTokenName(self,splPunctuationCharacterNameTable(system)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | splPunctuationTokenName(self,splPunctuationCharacterNameTable(system)) }",
);
