  ...
  function (_self, _traitName, _methodName) {
    ...
    return _anySatisfy_2(
      ...
      function (_each) {
        ...
        /* Statements */
        return _equals_2(_name_1(_each), _methodName);
      },
    );
  },
...
sl.addMethod(
  ...
  function (_self, _resource, _options) {
    ...
    return _fetchJson_4(_self, _resource, _options, function (_errorCode) {
      ...
      /* Statements */
      return _error_2(_self, _plusPlus_2("fetchJson: ", _errorCode));
    });
  },
  ...
  function (_self, _resource, _mimeType, _options) {
    ...
    return _fetchMimeType_5(
      ...
      function (_errorCode) {
        ...
        /* Statements */
        return _error_2(_self, _plusPlus_2("fetchMimeType: ", _errorCode));
      },
    );
  },
...
sl.addMethod(
  ...
  function (_self, _resource, _options) {
    ...
    return _fetchString_4(_self, _resource, _options, function (_errorCode) {
      ...
      /* Statements */
      return _error_2(_self, _plusPlus_2("fetchString: ", _errorCode));
    });
  },
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _or_2(_isTraitName_2(_self, _aString), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
    ...
    return _if_3(_isMethodName_2(_self, _methodName), function () {
      ...
      _do_2(_table, function (_dictionary) {
        ...
        return _do_2(_dictionary, function (_method) {
          ...
          /* Statements */
          return _include_2(_answer, _method);
        });
      });
      return _asArray_1(_answer);
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      /* Statements */
      return _error_1(
        _plusPlus_2("methodImplementations: not a methodName: ", _methodName),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self, _signature) {
    ...
    /* Temporaries */
    let __genSym29 = _assertIsOfSize_2(_parseMethodSignature_1(_signature), 2),
      _qualifiedOriginName = _at_2(__genSym29, 1),
      _qualifiedMethodName = _at_2(__genSym29, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aBlock_0) {
    ...
    /* Statements */
    _aBlock_0();
    return _minus_2(_systemTimeInMilliseconds_1(_self), _beginTime);
  },
  ...
  function (_self) {
    ...
    return _select_2(
      ...
      function (_methodName) {
        ...
        /* Statements */
        return _greaterThan_2(_size_1(_methodArities_2(_self, _methodName)), 1);
      },
    );
  },
  ...
  function (_self) {
    ...
    return _select_2(
      ...
      function (_methodName) {
        ...
        /* Statements */
        return _equals_2(_methodArities_2(_self, _methodName), [0]);
      },
    );
  },
      ...
      return _asRecord_1(
        _collect_2(
          ...
          function (_each) {
            ...
            /* Statements */
            return _minusGreaterThan_2(
              _each,
              _join_1(
                _camelCase_1(
                  _collect_2(_stringArray_1(_each), function (_letter) {
                    /* ArityCheck */
                    if (arguments.length !== 1) {
...
sl.addMethod(
  ...
  function (_self, _packageName) {
    ...
    _methodDo_2(_self, function (_each) {
      ...
      /* Statements */
      return _ifTrue_2(
        _equals_2(_packageName_1(_each), _packageName),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _packageName) {
    ...
    return _select_2(_typeDictionary_1(_self), function (_each) {
      ...
      /* Statements */
      return _equals_2(_packageName_1(_each), _packageName);
    });
  },
  ...
  function (_self, _path, _defaultValue) {
    ...
    return _if_3(_isEmpty_1(_path), function () {
      ...
      _whileTrue_2(function () {
        ...
        /* Statements */
        return _and_2(_notNil_1(_item), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          /* Statements */
          return _lessThanEquals_2(_index, _size_1(_path));
        });
      }, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
      ...
      return _query_2(_item, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _traitName) {
    ...
    return _if_3(_isTraitName_2(_self, _traitName), function () {
      ...
      /* Statements */
      return _error_2(_self, _plusPlus_2("trait: not a trait: ", _traitName));
    });
  },
  ...
  function (_self, _traitOrTypeName) {
    ...
    return _if_3(_isTypeName_2(_self, _traitOrTypeName), function () {
      ...
      return _if_3(_isTraitName_2(_self, _traitOrTypeName), function () {
        ...
        return _error_2(
          _self,
          _plusPlus_2("traitOrType: not a trait or type: ", _traitOrTypeName),
        );
      });
    });
  },
...
sl.addMethod(
  ...
  function (_self, _traitName) {
    ...
    return _if_3(_isTraitName_2(_self, _traitName), function () {
      ...
      return _error_2(
        _self,
        _plusPlus_2("traitTypes: not a trait: ", _traitName),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self, _typeName) {
    ...
    /* Statements */
    _do_2(
      _traitNameArray_1(_typeLookup_2(_self, _typeName)),
      function (_traitName) {
        /* ArityCheck */
        if (arguments.length !== 1) {
...
sl.addMethod(
  ...
  function (_self, _typeName) {
    ...
    return _if_3(_isTypeName_2(_self, _typeName), function () {
      ...
      return _error_2(
        _self,
        _plusPlus_2("typeLookup: not a type: ", _typeName),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self, _typeName) {
    ...
    /* Statements */
    return _traitNameArray_1(_typeLookup_2(_self, _typeName));
  },
...
sl.addMethod(
  ...
  function (_self, _traitName) {
    ...
    return _indices_1(_select_2(_typeDictionary_1(_system), function (_each) {
      ...
      /* Statements */
      return _includes_2(_traitNameArray_1(_each), _traitName);
    }));
  },
    ...
    return _collect_2(
      _select_2(
        ...
        function (_each) {
          ...
          /* Statements */
          return _equals_2(_value_1(_each), "*Uncategorized*");
        },
      ),
      _key_1,
    );
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    _atPut_3(_cache_1(_self), "uniqueId", _plus_2(_answer, 1));
    return _answer;
  },
  ...
  function (_self, _aBlock) {
    ...
    return _anySatisfy_2(
      ...
      function (_each) {
        ...
        /* Statements */
        return _equals_2(_qualifiedName_1(_each), _name_1(_aBlock));
      },
    );
  },
...
sl.addMethod(
  ...
  function (_self_0, _interval) {
    ...
    return [_count, _minus_2(_t1, _t0)];
  },
...
sl.addMethod(
  ...
  function (_self, _aDuration) {
    ...
    let __genSym30 = _assertIsOfSize_2(
      ...
      _count = _at_2(__genSym30, 1),
      _elapsedTime = _at_2(__genSym30, 2);
    /* Statements */
    return _join_1([
      _roundTo_2(_dividedBy_2(_count, _dividedBy_2(_elapsedTime, 1000)), 0.001),
      " per second; ",
      _roundTo_2(_dividedBy_2(_dividedBy_2(_elapsedTime, 1000), _count), 0.001),
      " per count",
    ]);
  },
...
sl.addMethod(
  ...
  function (_self_0) {
    ...
    /* Statements */
    _self_0();
    return _minus_2(_systemTimeInMilliseconds_1(_system), _startTime);
  },
