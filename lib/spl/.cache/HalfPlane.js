...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p, _v) {
    ...
    let __SPL106 = _assertIsOfSize_2(_p, 2);
    let _p1 = _at_2(__SPL106, 1);
    let _p2 = _at_2(__SPL106, 2);
    let __SPL107 = _assertIsOfSize_2(_v, 2);
    let _v1 = _at_2(__SPL107, 1);
    let _v2 = _at_2(__SPL107, 2);
  ...
  "{ :p :v | let __SPL106 = assertIsOfSize(p, 2); let p1 = at(__SPL106, 1); let p2 = at(__SPL106, 2); let __SPL107 = assertIsOfSize(v, 2); let v1 = at(__SPL107, 1); let v2 = at(__SPL107, 2); let v0 = -(p2, p1); let c1 = cross(v0,v1); let c2 = cross(v0,v2); arcCos((/(dot(c1,c2), (*(norm(c1), norm(c2)))))) }",
);
