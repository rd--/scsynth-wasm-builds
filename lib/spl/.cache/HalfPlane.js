...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p, _v) {
    ...
    let _v1 = _at_2(__SPL3, 1);
    let _v2 = _at_2(__SPL3, 2);
  ...
  "{ :p :v | let __SPL2 = assertIsOfSize(p, 2); let p1 = at(__SPL2, 1); let p2 = at(__SPL2, 2); let __SPL3 = assertIsOfSize(v, 2); let v1 = at(__SPL3, 1); let v2 = at(__SPL3, 2); let v0 = -(p2, p1); let c1 = cross(v0,v1); let c2 = cross(v0,v2); arcCos((/(dot(c1,c2), (*(norm(c1), norm(c2)))))) }",
);
