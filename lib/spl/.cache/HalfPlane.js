...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :p :v | let __SplVar1 = assertIsOfSize(p, 2); let p1 = at(__SplVar1, 1); let p2 = at(__SplVar1, 2); let __SplVar2 = assertIsOfSize(v, 2); let v1 = at(__SplVar2, 1); let v2 = at(__SplVar2, 2); let v0 = -(p2, p1); let c1 = cross(v0,v1); let c2 = cross(v0,v2); arcCos((/(dot(c1,c2), (*(norm(c1), norm(c2)))))) }",
);
