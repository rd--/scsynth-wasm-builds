...
sl.extendTypeOrTraitWithMethod(
  ...
  "splHelpFragment",
  ["topic", "anchor"],
  sl.annotateFunction(function (_topic, _anchor) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _topic, _anchor";
      throw new Error(errorMessage);
    } /* Temporaries */
    let _h = _readHelpFile_2(_system, _topic);
    let _m = _contents_1(_markdown_1(_h));
    let _f = _detect_2(
      _m,
      sl.annotateFunction(function (_each) {
        /* ArityCheck */
        ...
        return _ampersand_2(
          ...
          sl.annotateFunction(function () {
            ...
            let _i = _at_2(_each, "info");
            /* Statements */
            return _includesSubstring_2(_i, _anchor);
          }, []),
        );
      }, ["each"]),
    );
    ...
    let _p = _detect_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        return _equalsSign_2(_at_2(_each, "id"), _hyphenMinus_2(_k, 1));
      }, ["each"]),
    );
    /* Statements */
    return [_at_2(_p, "literal"), _at_2(_f, "literal")];
  }, ["topic", "anchor"]),
