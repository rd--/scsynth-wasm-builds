    ...
    _do_2(_markdown_1(_self), function (_each) {
      ...
      return _ifTrue_2(
        ...
        function () {
          ...
          /* Temporaries */
          let __genSym65 = _assertIsOfSize_2(_at_2(_each, "sourcePosition"), 2),
            _start = _at_2(__genSym65, 1),
            _end = _at_2(__genSym65, 2);
          /* Statements */
          return _ifTrue_2(
...
sl.addMethod(
  ...
  function (_self, _index, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _index, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _index) {
    ...
    return _linesFromWhile_3(_self, _index, function (_each, _unusedIndex) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _each, _unusedIndex"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self, _prefix) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _prefix"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _options) {
    ...
    _ifTrue_2(_at_2(_options, "verbose"), function () {
      ...
      return _postLine_1(
        _asTuple_1([
          _decodeUri_1(_fileNameWithoutExtensions_1(_origin_1(_self))),
          _name_1(_self),
        ]),
      );
    });
    _do_2(_codeBlocks_1(_self), function (_each) {
      ...
      /* Statements */
      return _ifTrue_2(
        _includesSubstring_2(_at_2(_each, "information"), "methodDefinition"),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage =
    ...
    _do_2(_documentTests_1(_self), function (_each) {
      ...
      return _if_3(_evaluate_1(_each), function () {
        ...
        /* Statements */
        return _postLine_1(_plusSignPlusSign_2("	FAIL: ", _format_1(_each)));
      });
    });
    _ifTrue_2(_at_2(_options, "verbose"), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _postLine_1(_format_2("	Pass % of %", [_passCount, _testCount]));
    });
...
sl.addMethod(
  ...
  function (_origin, _source) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _origin, _source"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
