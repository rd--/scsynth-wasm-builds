sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self:/0 :delay | <primitive: if(sl.isSmallFloat(_delay)) {\n\t\t\treturn setTimeout(_self_0, _delay * 1000);\n\t\t}>\nerror(self:/0,'Block>>basicValueAfter: not a number') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self:/1 :delay :anObject | <primitive: if(sl.isSmallFloat(_delay)) {\n\t\t\treturn setTimeout(_self_1, _delay * 1000, _anObject);\n\t\t}>\nerror(self:/1,'Block>>basicValueAfterWith: not a number') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self:/0 :delay | <primitive: if(sl.isSmallFloat(_delay)) {\n\t\t\treturn setInterval(_self_0, _delay * 1000);\n\t\t}>\nerror(self:/0,'Block>>basicValueEvery: not a number') }",
);
