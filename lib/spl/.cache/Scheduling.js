sl.addMethod(
  ...
  function (_self_0, _delayInMilliseconds) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_0, _delayInMilliseconds"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self_1, _delayInMilliseconds, _anObject) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_1, _delayInMilliseconds, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
    if (sl.isSmallFloat(_delayInMilliseconds)) {
