...
sl.addMethod(
  ...
  function (_self, _disk, _pile) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _disk, _pile"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _pile) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _pile"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _top = _at_2(_piles_1(_self), _pile);
...
sl.addMethod(
  ...
  function (_self, _fromPile, _toPile) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _fromPile, _toPile"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _pile, _disks) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _pile, _disks"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _disks, _fromPile, _toPile) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _disks, _fromPile, _toPile"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _result) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _result"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
