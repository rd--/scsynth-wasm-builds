...
sl.addMethod(
  ...
  function (_self, _disk, _pile) {
    ...
    /* Statements */
    _ifTrue_2(
      _and_2(_notNil_1(_top), function () {
        /* ArityCheck */
        ...
        /* Statements */
        return _greaterThanEquals_2(_size_1(_disk), _size_1(_top));
      }),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self, _fromPile, _toPile) {
    ...
    return _movesDone_2(_self, _plus_2(_movesDone_1(_self), 1));
  },
...
sl.addMethod(
  ...
  function (_self, _pile, _disks) {
    ...
    /* Statements */
    return _downToDo_3(_disks, 0, function (_i) {
      /* ArityCheck */
      if (arguments.length !== 1) {
...
sl.addMethod(
  ...
  function (_self, _disks, _fromPile, _toPile) {
    ...
    /* Statements */
    return _if_3(_equals_2(_disks, 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Temporaries */
      let _otherPile = _minus_2(_minus_2(6, _fromPile), _toPile);
      /* Statements */
      _moveDisksFromTo_4(_self, _minus_2(_disks, 1), _fromPile, _otherPile);
