...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _packageCategories = _sort_1(
      _copyWithoutDuplicates_1(_collect_2(_packages, _category_1)),
    );
    let _methods = null;
        ...
        return _caseOf_2(_size_1(_path), [
          ...
          _minusGreaterThan_2(1, function () {
            ...
            return _sort_1(_selectThenCollect_3(_packages, function (_each) {
              ...
              /* Statements */
              return _equals_2(_category_1(_each), _at_2(_path, 1));
            }, function (_each) {
              /* ArityCheck */
              if (arguments.length !== 1) {
                const errorMessage = "Arity: expected 1, _each";
          ...
          _minusGreaterThan_2(2, function () {
            ...
            let _implements = _collect_2(
              _plusPlus_2(_traits, _types),
              _qualifiedName_1,
            );
            /* Statements */
            _setStatus_2(_browser, _joinSeparatedBy_2(_implements, ", "));
            _methods = _packageMethods_2(_system, _at_2(_path, 2));
            return _sort_1(
              _copyWithoutDuplicates_1(_collect_2(_methods, function (_each) {
                /* ArityCheck */
                if (arguments.length !== 1) {
                  const errorMessage = "Arity: expected 1, _each";
                  console.error(errorMessage);
          ...
          _minusGreaterThan_2(3, function () {
            ...
            _if_3(_isTypeName_2(_system, _at_2(_path, 3)), function () {
              ...
              return _setStatus_2(
                _browser,
                _joinSeparatedBy_2(
                  _typeTraits_2(_system, _at_2(_path, 3)),
                  ", ",
                ),
              );
            }, function () {
          ...
          _minusGreaterThan_2(4, function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
            ...
            _selectedMethod = _detect_2(_methods, function (_each) {
              ...
              /* Statements */
              return _and_2(
                _equals_2(_qualifiedName_1(_origin_1(_each)), _at_2(_path, 3)),
                function () {
                  /* ArityCheck */
                  if (arguments.length !== 0) {
                    const errorMessage = "Arity: expected 0, ";
                  ...
                  /* Statements */
                  return _equals_2(_qualifiedName_1(_each), _at_2(_path, 4));
                },
              );
            });
