...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _collect_2(
      _to_2(1, _hyphenMinus_2(_vertexCount_1(_self), 1)),
    ...
    _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _p = _ramerDouglasPeuckerAlgorithm_2(
          _ListView_4(_self, 1, _index, 1),
          _epsilon,
        );
        let _q = _ramerDouglasPeuckerAlgorithm_2(
          _ListView_4(_self, _index, _end, 1),
          _epsilon,
        );
        /* Statements */
        _addAll_2(
          _answer,
          _ListView_4(_p, 1, _hyphenMinus_2(_size_1(_p), 1), 1),
        );
...
sl.extendTypeOrTraitWithMethod(
  ...
  "Line",
  "spirangle",
  ["n", "m", "center", "radii", "initialAngle"],
  sl.annotateFunction(function (_n, _m, _center, _radii, _initialAngle) {
    /* ArityCheck */
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _n, _m, _center, _radii, _initialAngle";
      throw new Error(errorMessage);
    } /* Temporaries */
    ...
    let _v = _plusSign_2(_center, _fromPolarCoordinates_1([_r, _theta]));
