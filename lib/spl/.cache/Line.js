...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL155 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 2);
        let _p1 = _at_2(__SPL155, 1);
        let _p2 = _at_2(__SPL155, 2);
        let __SPL156 = _assertIsOfSize_2(_p1, 2);
        let _x1 = _at_2(__SPL156, 1);
        let _y1 = _at_2(__SPL156, 2);
        let __SPL157 = _assertIsOfSize_2(_p2, 2);
        let _x2 = _at_2(__SPL157, 1);
        let _y2 = _at_2(__SPL157, 2);
        /* Statements */
  ...
  '{ :self :options | if((=(vertexCount(self), 2)), { let precision = at(options, \'precision\'); let __SPL155 = assertIsOfSize(vertexCoordinates(self), 2); let p1 = at(__SPL155, 1); let p2 = at(__SPL155, 2); let __SPL156 = assertIsOfSize(p1, 2); let x1 = at(__SPL156, 1); let y1 = at(__SPL156, 2); let __SPL157 = assertIsOfSize(p2, 2); let x2 = at(__SPL157, 1); let y2 = at(__SPL157, 2); format(\'<line x1="%" y1="%" x2="%" y2="%" />\',[printStringToFixed(x1,precision), printStringToFixed(y1,precision), printStringToFixed(x2,precision), printStringToFixed(y2,precision)]) }, { format(\'<polyline points="%" />\',[asSvgPointList(vertexCoordinates(self),options)]) }) }',
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL158 = _assertIsOfSize_2(_at_2(_self, 1), 2);
    let _x1 = _at_2(__SPL158, 1);
    let _y1 = _at_2(__SPL158, 2);
    let __SPL159 = _assertIsOfSize_2(_at_2(_self, 2), 2);
    let _x2 = _at_2(__SPL159, 1);
    let _y2 = _at_2(__SPL159, 2);
  ...
  "{ :self | let __SPL158 = assertIsOfSize(at(self, 1), 2); let x1 = at(__SPL158, 1); let y1 = at(__SPL158, 2); let __SPL159 = assertIsOfSize(at(self, 2), 2); let x2 = at(__SPL159, 1); let y2 = at(__SPL159, 2); let dx = abs((-(x2, x1))); let sx = if((<(x1, x2)), { 1 }, { -1 }); let dy = -(abs((-(y2, y1)))); let sy = if((<(y1, y2)), { 1 }, { -1 }); let e = +(dx, dy); let answer = []; whileTrue({ add(answer,[x1, y1]); if((&((==(x1, x2)), { ==(y1, y2) })), { false }, { let e2 = *(2, e); ifTrue((>=(e2, dy)), { e := +(e, dy); x1 := +(x1, sx) }); ifTrue((<=(e2, dx)), { e := +(e, dx); y1 := +(y1, sy) }); true }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL160 = _assertIsOfSize_2(_at_2(_self, 1), 2);
    let _x0 = _at_2(__SPL160, 1);
    let _y0 = _at_2(__SPL160, 2);
    let __SPL161 = _assertIsOfSize_2(_at_2(_self, 2), 2);
    let _x1 = _at_2(__SPL161, 1);
    let _y1 = _at_2(__SPL161, 2);
            ...
            _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                _add_2(_answer, [
                  ...
                  _xPixel0,
                  _asterisk_2(
                    _hyphenMinus_2(1, _fractionPart_1(_yEnd0)),
                    _xGap0,
                  ),
                ]);
                return _add_2(_answer, [
                  ...
                  _xPixel0,
                  _asterisk_2(_fractionPart_1(_yEnd0), _xGap0),
                ]);
              }, []),
              sl.annotateFunction(function () {
                /* ArityCheck */
                ...
                _if_3(
                  ...
                  sl.annotateFunction(function () {
                    ...
                    _add_2(_answer, [
                      ...
                      _x,
                      _hyphenMinus_2(1, _fractionPart_1(_interY)),
                    ]);
                    return _add_2(_answer, [
                      _plusSign_2(_integerPart_1(_interY), 1),
                      _x,
                      _fractionPart_1(_interY),
                    ]);
                  }, []),
                  sl.annotateFunction(function () {
                    /* ArityCheck */
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                _add_2(_answer, [
                  ...
                  _xPixel1,
                  _asterisk_2(
                    _hyphenMinus_2(1, _fractionPart_1(_yEnd1)),
                    _xGap1,
                  ),
                ]);
                return _add_2(_answer, [
                  ...
                  _xPixel1,
                  _asterisk_2(_fractionPart_1(_yEnd1), _xGap1),
                ]);
              }, []),
              sl.annotateFunction(function () {
                /* ArityCheck */
  ...
  "{ :self | let __SPL160 = assertIsOfSize(at(self, 1), 2); let x0 = at(__SPL160, 1); let y0 = at(__SPL160, 2); let __SPL161 = assertIsOfSize(at(self, 2), 2); let x1 = at(__SPL161, 1); let y1 = at(__SPL161, 2); let isSteep = >(abs(-(y1, y0)), abs(-(x1, x0))); let answer = []; if(isSteep, { xiaolinWuLineAlgorithm([[y0, x0], [y1, x1]]) }, { if((>(x0, x1)), { xiaolinWuLineAlgorithm([[x1, y1], [x0, y0]]) }, { let dx = -(x1, x0); let dy = -(y1, y0); let gradient = /(dy, dx); let xEnd0 = rounded(x0); let yEnd0 = +(y0, (*(gradient, (-(xEnd0, x0))))); let xGap0 = -(1, fractionPart((+(x0, 0.5)))); let xPixel0 = xEnd0; let yPixel0 = integerPart(yEnd0); let interY = +(yEnd0, gradient); let xEnd1 = rounded(x1); let yEnd1 = +(y1, (*(gradient, (-(xEnd1, x1))))); let xGap1 = fractionPart((+(x1, 0.5))); let xPixel1 = xEnd1; let yPixel1 = integerPart(yEnd1); if(isSteep, { add(answer,[yPixel0, xPixel0, *((-(1, fractionPart(yEnd0))), xGap0)]); add(answer,[+(yPixel0, 1), xPixel0, *(fractionPart(yEnd0), xGap0)]) }, { add(answer,[xPixel0, yPixel0, *((-(1, fractionPart(yEnd0))), xGap0)]); add(answer,[xPixel0, +(yPixel0, 1), *(fractionPart(yEnd0), xGap0)]) }); toDo((+(xPixel0, 1)), -(xPixel1, 1), { :x | if(isSteep, { add(answer,[integerPart(interY), x, -(1, fractionPart(interY))]); add(answer,[+(integerPart(interY), 1), x, fractionPart(interY)]) }, { add(answer,[x, integerPart(interY), -(1, fractionPart(interY))]); add(answer,[x, +(integerPart(interY), 1), fractionPart(interY)]) }); interY := +(interY, gradient) }); if(isSteep, { add(answer,[yPixel1, xPixel1, *((-(1, fractionPart(yEnd1))), xGap1)]); add(answer,[+(yPixel1, 1), xPixel1, *(fractionPart(yEnd1), xGap1)]) }, { add(answer,[xPixel1, yPixel1, *((-(1, fractionPart(yEnd1))), xGap1)]); add(answer,[xPixel1, +(yPixel1, 1), *(fractionPart(yEnd1), xGap1)]) }) }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n, _m, _centre, _radii, _initialAngle) {
    ...
    let __SPL162 = _assertIsOfSize_2(_radii, 2);
    let _radiusIncrement = _at_2(__SPL162, 1);
    let _initialRadial = _at_2(__SPL162, 2);
