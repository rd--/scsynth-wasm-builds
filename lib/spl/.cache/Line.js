...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL19 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 2);
    let _a = _at_2(__SPL19, 1);
    let _b = _at_2(__SPL19, 2);
    /* Statements */
    return _lineEquation_2(_a, _b);
  }, ["self"]),
  "{ :self | let __SPL19 = assertIsOfSize(vertexCoordinates(self), 2); let a = at(__SPL19, 1); let b = at(__SPL19, 2); lineEquation(a,b) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL20 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 2);
        let _p1 = _at_2(__SPL20, 1);
        let _p2 = _at_2(__SPL20, 2);
        let __SPL21 = _assertIsOfSize_2(_p1, 2);
        let _x1 = _at_2(__SPL21, 1);
        let _y1 = _at_2(__SPL21, 2);
        let __SPL22 = _assertIsOfSize_2(_p2, 2);
  ...
  '{ :self :options | if((=(vertexCount(self), 2)), { let precision = at(options, \'precision\'); let __SPL20 = assertIsOfSize(vertexCoordinates(self), 2); let p1 = at(__SPL20, 1); let p2 = at(__SPL20, 2); let __SPL21 = assertIsOfSize(p1, 2); let x1 = at(__SPL21, 1); let y1 = at(__SPL21, 2); let __SPL22 = assertIsOfSize(p2, 2); let x2 = at(__SPL22, 1); let y2 = at(__SPL22, 2); format(\'<line x1="%" y1="%" x2="%" y2="%" />\',[printStringToFixed(x1,precision), printStringToFixed(y1,precision), printStringToFixed(x2,precision), printStringToFixed(y2,precision)]) }, { format(\'<polyline points="%" />\',[asSvgPointList(vertexCoordinates(self),options)]) }) }',
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL23 = _assertIsOfSize_2(_at_2(_self, 1), 2);
    let _x1 = _at_2(__SPL23, 1);
    let _y1 = _at_2(__SPL23, 2);
    let __SPL24 = _assertIsOfSize_2(_at_2(_self, 2), 2);
  ...
  "{ :self | let __SPL23 = assertIsOfSize(at(self, 1), 2); let x1 = at(__SPL23, 1); let y1 = at(__SPL23, 2); let __SPL24 = assertIsOfSize(at(self, 2), 2); let x2 = at(__SPL24, 1); let y2 = at(__SPL24, 2); let dx = abs((-(x2, x1))); let sx = if((<(x1, x2)), { 1 }, { -1 }); let dy = -(abs((-(y2, y1)))); let sy = if((<(y1, y2)), { 1 }, { -1 }); let e = +(dx, dy); let answer = []; whileTrue({ add(answer,[x1, y1]); if((&((==(x1, x2)), { ==(y1, y2) })), { false }, { let e2 = *(2, e); ifTrue((>=(e2, dy)), { e := +(e, dy); x1 := +(x1, sx) }); ifTrue((<=(e2, dx)), { e := +(e, dx); y1 := +(y1, sy) }); true }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _x0 = _at_2(__SPL25, 1);
    let _y0 = _at_2(__SPL25, 2);
    let __SPL26 = _assertIsOfSize_2(_at_2(_self, 2), 2);
    let _x1 = _at_2(__SPL26, 1);
    let _y1 = _at_2(__SPL26, 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n, _m, _centre, _radii, _initialAngle) {
    ...
    let __SPL27 = _assertIsOfSize_2(_radii, 2);
    let _radiusIncrement = _at_2(__SPL27, 1);
    let _initialRadial = _at_2(__SPL27, 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aRectangle) {
    ...
    let __SPL28 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 2);
    ...
    let _accept = _at_2(__SPL29, 1);
    let _x1 = _at_2(__SPL29, 2);
    let _y1 = _at_2(__SPL29, 3);
    let _x2 = _at_2(__SPL29, 4);
    let _y2 = _at_2(__SPL29, 5);
    /* Statements */
    return _if_3(
      _accept,
      sl.annotateFunction(function () {
  ...
  "{ :self :aRectangle | let __SPL28 = assertIsOfSize(vertexCoordinates(self), 2); let a = at(__SPL28, 1); let b = at(__SPL28, 2); let c = lowerLeft(aRectangle); let d = upperRight(aRectangle); let __SPL29 = assertIsOfSize(cohenSutherlandAlgorithm(at(a, 1), at(a, 2), at(b, 1), at(b, 2), at(c, 1), at(c, 2), at(d, 1), at(d, 2)), 5); let accept = at(__SPL29, 1); let x1 = at(__SPL29, 2); let y1 = at(__SPL29, 3); let x2 = at(__SPL29, 4); let y2 = at(__SPL29, 5); if(accept, { Line([[x1, y1], [x2, y2]]) }, { nil }) }",
);
