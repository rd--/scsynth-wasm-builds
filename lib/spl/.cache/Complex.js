...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL1 = assertIsOfSize(self, 2); let a = at(__SPL1, 1); let b = at(__SPL1, 2); j(a,b) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _elseClause_0) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL2 = _assertIsOfSize_2(_splitBy_2(_self, "J"), 2);
        let _real = _at_2(__SPL2, 1);
        let _imaginary = _at_2(__SPL2, 2);
        /* Statements */
        return _Complex_2(
  ...
  "{ :self :elseClause:/0 | if(isComplexString(self), { let __SPL2 = assertIsOfSize(splitBy(self,'J'), 2); let real = at(__SPL2, 1); let imaginary = at(__SPL2, 2); Complex(parseNumber(real,elseClause:/0), parseNumber(imaginary,elseClause:/0)) }, { elseClause() }) }",
);
