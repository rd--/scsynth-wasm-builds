  ...
  function (_self, _anObject, _epsilon) {
    ...
    return _if_3(_isNumber_1(_anObject), function () {
      ...
      return _if_3(_isComplex_1(_anObject), function () {
        ...
        /* Statements */
        return _ampersand_2(
          _closeToBy_3(_real_1(_self), _real_1(_anObject), _epsilon),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
        ...
        return _adaptToComplexAndApply_3(_anObject, _self, function (_p, _q) {
          ...
          /* Statements */
          return _closeToBy_3(_p, _q, _epsilon);
        });
      });
    }, function () {
      /* ArityCheck */
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _closeToBy_3(_self, _anObject, 0.0001);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_lessThanSign_2(_imaginary_1(_self), 0), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_min, _max) {
    ...
    /* Statements */
    return _Complex_2(
      _randomFloat_2(_real_1(_min), _real_1(_max)),
      _randomFloat_2(_imaginary_1(_min), _imaginary_1(_max)),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _closeToBy_3(_self, _anObject, 0.000000000001);
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym27 = _assertIsOfSize_2(_self, 2),
