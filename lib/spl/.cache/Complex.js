...
sl.addType(
  ...
  "Complex",
  "Complex",
  ["Object", "Equatable", "Comparable", "Number"],
  ["real", "imaginary"],
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let a = real(self); let b = imaginary(self); [[a, negate(b)], [b, a]] }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | if(isComplex(operand), { compare(abs(self),abs(operand)) }, { error(self,'compare: not Complex') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aNumber | shouldNotImplement(self,'quotient') }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aNumber | shouldNotImplement(self,'remainder') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :real :imaginary | Complex(asFloat(real), asFloat(imaginary)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL80 = _assertIsOfSize_2(_self, 2);
    let _a = _at_2(__SPL80, 1);
    let _b = _at_2(__SPL80, 2);
    /* Statements */
    return _j_2(_a, _b);
  }, ["self"]),
  "{ :self | let __SPL80 = assertIsOfSize(self, 2); let a = at(__SPL80, 1); let b = at(__SPL80, 2); j(a,b) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _elseClause_0) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL81 = _assertIsOfSize_2(_splitBy_2(_self, "J"), 2);
        let _real = _at_2(__SPL81, 1);
        let _imaginary = _at_2(__SPL81, 2);
        /* Statements */
        return _Complex_2(
  ...
  "{ :self :elseClause:/0 | if(isComplexString(self), { let __SPL81 = assertIsOfSize(splitBy(self,'J'), 2); let real = at(__SPL81, 1); let imaginary = at(__SPL81, 2); Complex(parseNumber(real,elseClause:/0), parseNumber(imaginary,elseClause:/0)) }, { elseClause() }) }",
);
