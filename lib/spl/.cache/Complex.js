...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _shape, _rng) {
    ...
    return _randomComplex_3(_rng, [_Complex_2(0, 0), _self], _shape);
  }, ["self", "shape", "rng"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL288 = _assertIsOfSize_2(_self, 2);
    let _a = _at_2(__SPL288, 1);
    let _b = _at_2(__SPL288, 2);
    /* Statements */
    return _j_2(_a, _b);
  }, ["self"]),
  "{ :self | let __SPL288 = assertIsOfSize(self, 2); let a = at(__SPL288, 1); let b = at(__SPL288, 2); j(a,b) }",
);
