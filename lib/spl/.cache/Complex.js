...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL495 = _assertIsOfSize_2(_self, 2);
    let _a = _at_2(__SPL495, 1);
    let _b = _at_2(__SPL495, 2);
    /* Statements */
    return _j_2(_a, _b);
  }, ["self"]),
  "{ :self | let __SPL495 = assertIsOfSize(self, 2); let a = at(__SPL495, 1); let b = at(__SPL495, 2); j(a,b) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _elseClause_0) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL496 = _assertIsOfSize_2(_splitBy_2(_self, "J"), 2);
        let _real = _at_2(__SPL496, 1);
        let _imaginary = _at_2(__SPL496, 2);
        /* Statements */
        return _Complex_2(
  ...
  "{ :self :elseClause:/0 | if(isComplexString(self), { let __SPL496 = assertIsOfSize(splitBy(self,'J'), 2); let real = at(__SPL496, 1); let imaginary = at(__SPL496, 2); Complex(parseNumber(real,elseClause:/0), parseNumber(imaginary,elseClause:/0)) }, { elseClause() }) }",
);
