...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _Complex_2(
      _ceiling_1(_real_1(_self)),
      _ceiling_1(_imaginary_1(_self)),
    );
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _Complex_2(_floor_1(_real_1(_self)), _floor_1(_imaginary_1(_self)));
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _epsilon) {
    ...
    let _x = _integerChop_2(_real_1(_self), _epsilon);
    let _y = _integerChop_2(_imaginary_1(_self), _epsilon);
    return _if_3(
      _isZero_1(_y),
      sl.annotateFunction(function () {
        /* ArityCheck */
...
sl.addMethodToExistingType(
  ...
  "Complex",
  "isInteger",
  ["unusedSelf", "unusedEpsilon"],
  sl.annotateFunction(function (_unusedSelf, _unusedEpsilon) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _unusedSelf, _unusedEpsilon";
      throw new Error(errorMessage);
    } /* Statements */
    return false;
  }, ["unusedSelf", "unusedEpsilon"]),
