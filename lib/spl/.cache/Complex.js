...
sl.addMethod(
  ...
  function (_self, _anObject, _epsilon) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _anObject, _epsilon"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_isNumber_1(_anObject), function () {
...
sl.addMethod(
  ...
  function (_self, _places) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _places"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _join_2([
...
sl.addMethod(
  ...
  function (_x, _a, _m) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _x, _a, _m"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aComplexNumber, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aComplexNumber, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_real, _imaginary) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _real, _imaginary"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
