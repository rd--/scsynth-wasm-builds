...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_s) {
    ...
    let _d = _sum_2(
      _to_2(_plusSign_2(_n, 1), _asterisk_2(2, _n)),
      sl.annotateFunction(function (_k) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _k";
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_m) {
    ...
    return _exp_1(
      _solidus_2(
        _asterisk_2(_pi_1(-1), _ellipticK_1(_hyphenMinus_2(1, _m))),
        _ellipticK_1(_m),
      ),
    );
  }, ["m"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "ellipticTheta",
  ["a", "u", "q", "k"],
  sl.annotateFunction(function (_a, _u, _q, _k) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage = "Arity: expected 4, _a, _u, _q, _k";
      throw new Error(errorMessage);
    } /* Statements */
    return _caseOf_2(_a, [
          ...
          return _asterisk_2(
            ...
            _sum_2(
              ...
              sl.annotateFunction(function (_n) {
                ...
                return _asterisk_2(
                  _asterisk_2(
                    _circumflexAccent_2(-1, _n),
                    _circumflexAccent_2(
                      _q,
                      _circumflexAccent_2(_plusSign_2(_n, 0.5), 2),
                    ),
                  ),
                  _sin_1(_asterisk_2(_plusSign_2(_asterisk_2(2, _n), 1), _u)),
                );
              }, ["n"]),
            ),
          );
            ...
            _sum_2(
              ...
              sl.annotateFunction(function (_n) {
                ...
                return _asterisk_2(
                  ...
                  _cos_1(_asterisk_2(_plusSign_2(_asterisk_2(2, _n), 1), _u)),
                );
              }, ["n"]),
            ),
          );
        ...
        sl.annotateFunction(function () {
          ...
          return _plusSign_2(
            ...
            _asterisk_2(
              2,
              _sum_2(
                _nonemptyRange_3(1, _plusSign_2(_k, 1), 1),
                sl.annotateFunction(function (_n) {
                  /* ArityCheck */
                  if (arguments.length !== 1) {
                    const errorMessage = "Arity: expected 1, _n";
                  ...
                  return _asterisk_2(
                    _circumflexAccent_2(_q, _circumflexAccent_2(_n, 2)),
                    _cos_1(_asterisk_2(_asterisk_2(2, _n), _u)),
                  );
                }, ["n"]),
              ),
            ),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "ellipticTheta",
  ["a", "u", "q"],
  sl.annotateFunction(function (_a, _u, _q) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _a, _u, _q";
      throw new Error(errorMessage);
    } /* Temporaries */
    let _k = 4;
    /* Statements */
    return _ellipticTheta_4(_a, _u, _q, _k);
  }, ["a", "u", "q"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_u, _m) {
    ...
    /* Statements */
    return _if_3(
      _greaterThanSignEqualsSign_2(_modulo_2(_solidus_2(_u, _k), 4), 2),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
