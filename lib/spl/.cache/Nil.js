...
sl.addMethod(
  ...
  function (_self, _whenNil_0) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _whenNil_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _whenNil_0();
...
sl.addMethod(
  ...
  function (_self, _whenNil_0, _whenNotNil) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _whenNil_0, _whenNotNil"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _whenNil_0();
...
sl.addMethod(
  ...
  function (_self, _whenNotNil) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _whenNotNil"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return null;
...
sl.addMethod(
  ...
  function (_self, _whenNotNil, _whenNil_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _whenNotNil, _whenNil_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _whenNil_0();
