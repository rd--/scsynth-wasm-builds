...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _stringList = _flatten_1(_self);
    return _if_3(
      _anySatisfy_2(
        _stringList,
      ...
      sl.annotateFunction(function () {
        ...
        return _error_2(_self, "invalid input");
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        let _nonEmptyStringList = _reject_2(_stringList, _isEmpty_1);
        return _Svg_1(_unlines_1(_nonEmptyStringList));
      }, []),
    );
  }, ["self"]),
