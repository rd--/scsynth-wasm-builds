...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    return _unwords_1(_collect_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        let __SPL377 = _assertIsOfSize_2(_each, 2);
        let _x = _at_2(__SPL377, 1);
        let _y = _at_2(__SPL377, 2);
        /* Statements */
        return _format_2("%,%", [
  ...
  "{ :self :options | let precision = at(options, 'precision'); unwords(collect(self, { :each | let __SPL377 = assertIsOfSize(each, 2); let x = at(__SPL377, 1); let y = at(__SPL377, 2); format('%,%',[printStringToFixed(x,precision), printStringToFixed(y,precision)]) })) }",
);
