...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :z | if((<=(z, 0.000001)), { let eulerMascheroni = 0.57721566490153286060; +(-(-(0, eulerMascheroni), (/(1, z))), (*(1.6449340668482264365, z))) }, { let answer = 0; let r = nil; whileTrue({ <(z, 8.5) }, { answer := -(answer, (/(1, z))); z := +(z, 1) }); r := /(1, z); answer := -(+(answer, log(z)), (*(0.5, r))); r := *(r, r); -(answer, (*(r, (-(/(1, 12), (*(r, (-(/(1, 120), (*(r, (-(/(1, 252), (*(r, (-(/(1, 240), (*(r, (/(1, 132))))))))))))))))))))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let leadingFactor = gammaLanczosFormulaLeadingFactor(self); let series = gammaLanczosFormulaSeries(self); /(*((*(exp(leadingFactor), series)), sqrt(pi(2))), self) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let g = 7; let n = 9; let p = [0.99999999999980993, 676.5203681218851, -1259.1392167224028, 771.32342877765313, -176.61502916214059, 12.507343278686905, -0.13857109526572012, 9.9843695780195716E-6, 1.5056327351493116E-7]; let epsilon = 1E-07; let z = asComplex(self); if((<(real(z), 0.5)), { chop((/(pi(1), (*(sin(*(pi(1), z)), gamma(-(1, z)))))),epsilon) }, { let x = at(p, 1); let t = nil; z := -(z, 1); toDo(2, size(p), { :i | x := +(x, (/(at(p, i), (-(+(z, i), 1))))) }); t := +(+(z, g), 0.5); chop((*(*(*(sqrt(pi(2)), (^(t, (+(z, 0.5))))), exp(-(0, t))), x)),epsilon) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :z | if((=(imaginary(z), 0)), { gamma(real(z)) }, { if((<(real(z), 0.5)), { /(/(pi(1), sin(pi(z))), gamma((-(1, z)))) }, { let n = -(z, 1); let gammaG = 4.7421875; let gammaP = [0.99999999999999709182, 57.156235665862923517, -59.597960355475491248, 14.136097974741747174, -0.49191381609762019978, 0.33994649984811888699E-4, 0.46523628927048575665E-4, -0.98374475304879564677E-4, 0.15808870322491248884E-3, -0.21026444172410488319E-3, 0.21743961811521264320E-3, -0.16431810653676389022E-3, 0.84418223983852743293E-4, -0.26190838401581408670E-4, 0.36899182659531622704E-5]; let t = +(+(n, gammaG), 0.5); let x = Complex(at(gammaP, 1), 0); toDo(2, size(gammaP), { :i | x := +(x, (/(at(gammaP, i), (+(n, (-(i, 1))))))) }); *(*(*(sqrt(pi(2)), (^(t, (+(n, 0.5))))), exp((-(0, t)))), x) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _n) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _product_1(
          _plusSign_2(_a, _upOrDownTo_2(0, _hyphenMinus_2(_n, 1))),
        );
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
  ...
  "{ :a :n | if((&(isInteger(a), { isInteger(n) })), { product((+(a, upOrDownTo(0, -(n, 1))))) }, { let p = gamma(+(a, n)); let q = gamma(a); /(p, q) }) }",
);
