sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ifError_2(
      sl.annotateFunction(function () {
        ...
        return _at_2(_fileInformation_1(_self), "isDirectory");
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
  ...
  "{ :self | ifError({ at(fileInformation(self),'isDirectory') }, { false }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ifError_2(
      sl.annotateFunction(function () {
        ...
        return _at_2(_fileInformation_1(_self), "isFile");
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
  ...
  "{ :self | ifError({ at(fileInformation(self),'isFile') }, { false }) }",
);
