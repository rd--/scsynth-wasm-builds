...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _allEqualBy_2(_self, _equal_2);
  }, ["self"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _deleteDuplicates_2(_self, _equal_2);
  }, ["self"]),
  ...
  sl.annotateFunction(function (_self, _aBlock_2) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _deleteDuplicatesIdentical_1(_self);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _aCollection) {
    ...
    return _differenceAll_3(_self, _aCollection, _equal_2);
  }, ["self", "aCollection"]),
  ...
  sl.annotateFunction(function (_self, _minMax) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SplVar4 = _assertIsOfSize_2(_minMax, 2);
        let _p = _at_2(__SplVar4, 1);
        let _q = _at_2(__SplVar4, 2);
        return _if_3(
          _lessThanSign_2(_i, _p),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
      ...
      sl.annotateFunction(function () {
        ...
        return _rescale_3(_self, [_i, _j], _minMax);
      }, []),
    );
  }, ["self", "minMax"]),
      ...
      sl.annotateFunction(function (_each) {
        ...
        return _detectIndexIfFoundIfNone_4(
          ...
          sl.annotateFunction(function (_entry) {
            ...
            return _aBlock_2(_at_2(_entry, 1), _each);
          }, ["entry"]),
          sl.annotateFunction(function (_index) {
            ...
            let _entry = _at_2(_answer, _index);
            return _atPut_3(_entry, 2, _plusSign_2(_at_2(_entry, 2), 1));
          }, ["index"]),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _tally_2(_self, _equal_2);
  }, ["self"]),
  "{ :self |\n\t\tself.tally(equal:/2)\n\t}",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _deleteDuplicates_1(_self);
  }, ["self"]),
