...
sl.addMethodToExistingTrait(
  ...
  "{ :self :anInteger :aBlock:/2 | collect(self, { :each | aBlock(anInteger, each) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection | let answer = new(species(self)); do(self, { :each | ifFalse(includes(aCollection,each), { add(answer,each) }) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let seen = IdentitySet(); select(self, { :each | if(includes(seen,each), { false }, { uncheckedInclude(seen,each); true }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection :aBlock:/2 | reject(self, { :each | anySatisfy(aCollection, { :subCollection | includesBy(subCollection,each, aBlock:/2) }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection | differenceAll(self,aCollection, =) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | if((<(size(self), 2)), { error(self,'@Collection>>extendedGcd') }, { let __SplVar1 = assertIsOfSize(extendedGcd(at(self, 1),at(self, 2)), 2); let g = at(__SplVar1, 1); let c = at(__SplVar1, 2); toDo(3, size(self), { :each | let __SplVar2 = assertIsOfSize(extendedGcd(g,at(self, each)), 2); let nextG = at(__SplVar2, 1); let nextC = at(__SplVar2, 2); g := nextG; add(c,last(nextC)) }); [g, c] }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | if(isEmpty(self), { 0 }, { reduce(self,gcd:/2) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let answer = new(species(self)); ifFalse(isEmpty(self), { do(anyOne(self), { :x | ifTrue(allSatisfy(self, { :c | includes(c,x) }), { add(answer,x) }) }) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :notEmptyBlock | ifFalse(isEmpty(self), { cull(notEmptyBlock,self) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :notEmptyBlock :emptyBlock:/0 | if(isEmpty(self), { emptyBlock() }, { cull(notEmptyBlock,self) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection | anySatisfy(self, { :each | includes(aCollection,each) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let m = max(self); +(m, log(sum(exp((-(self, m)))))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _minima, _maxima) {
    ...
    return _rescale_3(_self, [_min_1(_self), _max_1(_self)], [
      _minima,
      _maxima,
    ]);
  }, ["self", "minima", "maxima"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _minima, _maxima) {
    ...
    /* Statements */
    return _rescale_3(_self, [_negate_1(_x), _x], [_minima, _maxima]);
  }, ["self", "minima", "maxima"]),
  "{ :self :minima :maxima | let x = max(abs(min(self)),abs(max(self))); rescale(self,[negate(x), x], [minima, maxima]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :n | if((<(n, 0)), { rankedMin(self,negate(n)) }, { let m = size(self); quantile(self,/((+(-(m, n), 1)), m)) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :n | if((<(n, 0)), { rankedMax(self,negate(n)) }, { quantile(self,/(n, size(self))) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :a :b | collect(self,rescaleBlock(a, b)) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let answer = new(species(anyOne(self))); do(self, { :each | includeAll(answer,each) }); answer }",
);
