...
sl.addMethodToExistingTrait(
      ...
      sl.annotateFunction(function () {
        ...
        _toDo_3(
          ...
          sl.annotateFunction(function (_each) {
            ...
            let _nextG = _at_2(__SPL11, 1);
            let _nextC = _at_2(__SPL11, 2);
            /* Statements */
            _g = _nextG;
  ...
  "{ :self | if((<(size(self), 2)), { error(self,'@Collection>>extendedGcd') }, { let __SPL10 = assertIsOfSize(extendedGcd(at(self, 1),at(self, 2)), 2); let g = at(__SPL10, 1); let c = at(__SPL10, 2); toDo(3, size(self), { :each | let __SPL11 = assertIsOfSize(extendedGcd(g,at(self, each)), 2); let nextG = at(__SPL11, 1); let nextC = at(__SPL11, 2); g := nextG; add(c,last(nextC)) }); [g, c] }) }",
);
