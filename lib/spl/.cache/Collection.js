...
sl.addTraitMethod(
  ...
  function (_self, _numberOfElements) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _numberOfElements"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _numberOfElements, _aBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _numberOfElements, _aBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _index = 0;
...
sl.addTraitMethod(
  ...
  function (_self, _level, _aBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _level, _aBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    return _withLevelCollect_2(_self, function (_each, _thisLevel) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _each, _thisLevel"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _r) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _r"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock, _aCollection) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aBlock, _aCollection"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _collectBlock_1, _doBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _collectBlock_1, _doBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _collectBlock_1, _selectBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _collectBlock_1, _selectBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _answer = _new_1(_species_1(_self));
...
sl.addTraitMethod(
  ...
  function (_self, _oldElement) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _oldElement"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function (_self, _aCollection) {
    ...
    return _reject_2(_self, function (_each) {
      ...
      return _anySatisfy_2(_aCollection, function (_subCollection) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _subCollection"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
  ...
  function (_self) {
    ...
    return _if_3(_lessThanSign_2(_size_1(_self), 2), function () {
      ...
      let __genSym2 = _assertIsOfSize_2(
        ...
        _g = _at_2(__genSym2, 1),
        _c = _at_2(__genSym2, 2);
      /* Statements */
      _toDo_3(3, _size_1(_self), function (_each) {
        ...
        /* Temporaries */
        let __genSym3 = _assertIsOfSize_2(
            _extendedGcd_2(_g, _at_2(_self, _each)),
            2,
          ),
          _nextG = _at_2(__genSym3, 1),
          _nextC = _at_2(__genSym3, 2);
        /* Statements */
        _g = _nextG;
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    let __genSym4 = _assertIsOfSize_2(_minMax_1(_self), 2),
      _min = _at_2(__genSym4, 1),
      _max = _at_2(__genSym4, 2);
    ...
    _do_2(_self, function (_e) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _e"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _emptyBlock_0, _notEmptyBlock) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _emptyBlock_0, _notEmptyBlock"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_isEmpty_1(_self), function () {
...
sl.addTraitMethod(
  ...
  function (_self, _emptyBlock_0, _notEmptyBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _emptyBlock_0, _notEmptyBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_isEmpty_1(_self), function () {
...
sl.addTraitMethod(
  ...
  function (_self, _a, _b, _c, _d) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _a, _b, _c, _d"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let __genSym5 = _assertIsOfSize_2(_quartiles_5(_self, _a, _b, _c, _d), 3),
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym6 = _assertIsOfSize_2(_quartiles_1(_self), 3),
      _q1 = _at_2(__genSym6, 1),
      _q2 = _at_2(__genSym6, 2),
      _q3 = _at_2(__genSym6, 3);
    /* Statements */
    return _hyphenMinus_2(_q3, _q1);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    _withLevelDo_2(_self, function (_each, _level) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _each, _level"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aCollection) {
    ...
    return _levelBy_2(_self, function (_level) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _level"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _minima, _maxima) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _minima, _maxima"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function (_self, _aBlock_1) {
    ...
    _toDo_3(0, _hyphenMinus_2(_size, 1), function (_i) {
      ...
      _withIndexDo_2(_powersOfTwo, function (_each, _j) {
        ...
        if (arguments.length !== 2) {
          const errorMessage =
            "Arity: expected 2, _each, _j"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
        return _ifTrue_2(
...
sl.addTraitMethod(
  ...
  function (_self, _p, _a, _b, _c, _d) {
    ...
    if (arguments.length !== 6) {
      const errorMessage =
        "Arity: expected 6, _self, _p, _a, _b, _c, _d"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_isVector_1(_self), function () {
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    return _select_2(_self, function (_element) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _element"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _selectBlock_1, _collectBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _selectBlock_1, _collectBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _answer = _new_1(_species_1(_self));
  ...
  function (_self) {
    ...
    _collect_2(_self, function (_each) {
      ...
      return _atIfPresentIfAbsent_4(_map, _lhs, function (_entry) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _entry"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _maxNumberOfElements) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _maxNumberOfElements"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_2, _level) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aBlock_2, _level"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _type = _typeOf_1(_self);
