...
sl.addTraitMethod(
  ...
  function (_self, _randomNumberGenerator) {
    ...
    /* Temporaries */
    let _randomIndex = _atRandom_2(_size_1(_self), _randomNumberGenerator);
    let _index = 1;
    /* Statements */
    return _valueWithReturn_1(function (_return_1) {
      /* ArityCheck */
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _atRandom_2(_self, _system);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _a, _b, _c, _d) {
    ...
    /* Temporaries */
    let __genSym3 = _assertIsOfSize_2(_quartiles_5(_self, _a, _b, _c, _d), 3),
      _q1 = _at_2(__genSym3, 1),
      _q2 = _at_2(__genSym3, 2),
      _q3 = _at_2(__genSym3, 3);
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym4 = _assertIsOfSize_2(_quartiles_1(_self), 3),
...
sl.addTraitMethod(
  ...
  function (_self, _count, _randomNumberGenerator) {
    ...
    _whileTrue_2(function () {
      ...
      /* Temporaries */
      let _next = _atRandom_2(_pool, _randomNumberGenerator);
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _count, _randomNumberGenerator) {
    ...
    _whileTrue_2(function () {
      ...
      /* Temporaries */
      let _next = _atRandom_2(_self, _randomNumberGenerator);
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _count, _randomNumberGenerator) {
    ...
    /* Statements */
    return _randomSampleLargePool_3(_self, _count, _randomNumberGenerator);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _count) {
    ...
    /* Statements */
    return _randomSample_3(_self, _count, _system);
  },
