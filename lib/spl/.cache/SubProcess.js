...
sl.addMethod(
  ...
  function (_self, _name, _aString) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _name, _aString"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _exitCode) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _exitCode"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
    host.exit(_exitCode);
...
sl.addMethod(
  ...
  function (_self, _commandName, _arguments) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _commandName, _arguments"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
