...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _isNotNil_1(_cause_1(_self));
  }, ["self"]),
  "{ :self |\n\t\tself.cause.isNotNil\n\t}",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _asString_1(_cause_1(_self));
      }, []),
    );
  }, ["self"]),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _format_2("Error(%, %)", [
          _storeString_1(_messageText_1(_self)),
          _storeString_1(_cause_1(_self)),
        ]);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        ...
        return _format_2("Error(%)", [_storeString_1(_messageText_1(_self))]);
      }, []),
    );
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "Error",
  ["self", "cause"],
  sl.annotateFunction(function (_self, _cause) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _cause";
      throw new Error(errorMessage);
    } /* Primitive */
    return Error(_self, { cause: _cause });
  }, ["self", "cause"]),
