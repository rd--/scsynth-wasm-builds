...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    return _ifNil_3(_cause_1(_self), function () {
      ...
      return _plusPlus_2(
        _plusPlus_2(
          _plusPlus_2(_plusPlus_2(_name_1(_self), ": "), _messageText_1(_self)),
          ": ",
        ),
        _causeText_1(_self),
      );
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_plusPlus_2("Error('", _messageText_1(_self)), "')");
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _signature) {
    ...
    /* Statements */
    return _error_2(_self, _plusPlus_2(_signature, ": should not implement"));
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _signature) {
    ...
    /* Statements */
    return _error_2(_self, _plusPlus_2(_signature, ": type responsibility"));
  },
