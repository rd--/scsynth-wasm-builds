...
sl.addMethod(
  ...
  function (_self, _aMenuItem) {
    ...
    /* Statements */
    return _lessThanEquals_2(_name_1(_self), _name_1(_aMenuItem));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _ifNil_3(_accessKey_1(_self), function () {
      ...
      /* Statements */
      return _plusPlus_2(_plusPlus_2(" (", _accessKey_1(_self)), ")");
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_name_1(_self), _accessKeyDislayText_1(_self));
  },
