...
sl.addMethod(
  ...
  function (_self, _aMenuItem) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aMenuItem"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _accessKey, _onSelect) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _accessKey, _onSelect"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _title, _entries) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _title, _entries"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _entries) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _entries"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    ...
    return _collect_2(_entries, function (_menuItem) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _menuItem"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _title, _entries, _isTransient, _event) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _title, _entries, _isTransient, _event"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
