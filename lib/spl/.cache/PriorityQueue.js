...
sl.addMethod(
  ...
  "PriorityQueue",
  "pushAllWithPriority",
  ["self", "associationsArray"],
  function (_self, _associationsArray) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _associationsArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _do_2(_associationsArray, function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
