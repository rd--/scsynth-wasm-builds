...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplUnused10 = _at_2(__SplVar2, 2);
    /* Statements */
    return _r;
  }, ["self"]),
  "{ :self |\n\t\tlet [r, _] = self.radii;\n\t\tr\n\t}",
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplUnused11 = _at_2(__SplVar3, 1);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplUnused12 = _at_2(__SplVar6, 1);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplUnused14 = _at_2(__SplVar8, 2);
    /* Statements */
    return _r;
  }, ["self"]),
  "{ :self |\n\t\tlet [r, _] = self.radii;\n\t\tr\n\t}",
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplUnused15 = _at_2(__SplVar9, 1);
