...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _c1 = 0;
    let _c2 = _c1;
    let __genSym35 = _whileTrue_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.extendTraitWithMethod(
  ...
  function (_p1, _p2) {
    ...
    /* Temporaries */
    let __genSym36 = _assertIsOfSize_2(_p1, 2),
      _x1 = _at_2(__genSym36, 1),
      _y1 = _at_2(__genSym36, 2);
    let __genSym37 = _assertIsOfSize_2(_p2, 2),
      _x2 = _at_2(__genSym37, 1),
      _y2 = _at_2(__genSym37, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_l1, _l2) {
    ...
    /* Temporaries */
    let __genSym38 = _assertIsOfSize_2(_l1, 2),
      _p1 = _at_2(__genSym38, 1),
      _p2 = _at_2(__genSym38, 2);
    let __genSym39 = _assertIsOfSize_2(_l2, 2),
      _p3 = _at_2(__genSym39, 1),
      _p4 = _at_2(__genSym39, 2);
    let __genSym40 = _assertIsOfSize_2(_p1, 2),
      _x1 = _at_2(__genSym40, 1),
      _y1 = _at_2(__genSym40, 2);
    let __genSym41 = _assertIsOfSize_2(_p2, 2),
      _x2 = _at_2(__genSym41, 1),
      _y2 = _at_2(__genSym41, 2);
    let __genSym42 = _assertIsOfSize_2(_p3, 2),
      _x3 = _at_2(__genSym42, 1),
      _y3 = _at_2(__genSym42, 2);
    let __genSym43 = _assertIsOfSize_2(_p4, 2),
      _x4 = _at_2(__genSym43, 1),
      _y4 = _at_2(__genSym43, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym44 = _assertIsOfSize_2(_self, 3),
      _q1 = _at_2(__genSym44, 1),
      _p = _at_2(__genSym44, 2),
      _q2 = _at_2(__genSym44, 3);
    let __genSym45 = _assertIsOfSize_2(_q1, 2),
      _x1 = _at_2(__genSym45, 1),
      _y1 = _at_2(__genSym45, 2);
    let __genSym46 = _assertIsOfSize_2(_p, 2),
      _x0 = _at_2(__genSym46, 1),
      _y0 = _at_2(__genSym46, 2);
    let __genSym47 = _assertIsOfSize_2(_q2, 2),
      _x2 = _at_2(__genSym47, 1),
      _y2 = _at_2(__genSym47, 2);
    let _n = _plusSign_2(
...
sl.extendTraitWithMethod(
  ...
  function (_aLine, _aPoint) {
    ...
    /* Temporaries */
    let __genSym48 = _assertIsOfSize_2(_aLine, 2),
      _p1 = _at_2(__genSym48, 1),
      _p2 = _at_2(__genSym48, 2);
    let _p0 = _aPoint;
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_l, _p) {
    ...
    /* Temporaries */
    let __genSym49 = _assertIsOfSize_2(_l, 2),
