...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p1, _p2) {
    ...
    let __SPL178 = _assertIsOfSize_2(_p1, 2);
    let _x1 = _at_2(__SPL178, 1);
    let _y1 = _at_2(__SPL178, 2);
    let __SPL179 = _assertIsOfSize_2(_p2, 2);
    let _x2 = _at_2(__SPL179, 1);
    let _y2 = _at_2(__SPL179, 2);
  ...
  "{ :p1 :p2 | let __SPL178 = assertIsOfSize(p1, 2); let x1 = at(__SPL178, 1); let y1 = at(__SPL178, 2); let __SPL179 = assertIsOfSize(p2, 2); let x2 = at(__SPL179, 1); let y2 = at(__SPL179, 2); let a = -(y2, y1); let b = -(x1, x2); let c = -((*(y1, (-(x2, x1)))), (*(x1, (-(y2, y1))))); [a, b, c] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_l1, _l2) {
    ...
    let __SPL180 = _assertIsOfSize_2(_l1, 2);
    let _p1 = _at_2(__SPL180, 1);
    let _p2 = _at_2(__SPL180, 2);
    let __SPL181 = _assertIsOfSize_2(_l2, 2);
    let _p3 = _at_2(__SPL181, 1);
    let _p4 = _at_2(__SPL181, 2);
    let __SPL182 = _assertIsOfSize_2(_p1, 2);
    let _x1 = _at_2(__SPL182, 1);
    let _y1 = _at_2(__SPL182, 2);
    let __SPL183 = _assertIsOfSize_2(_p2, 2);
    let _x2 = _at_2(__SPL183, 1);
    let _y2 = _at_2(__SPL183, 2);
    let __SPL184 = _assertIsOfSize_2(_p3, 2);
    let _x3 = _at_2(__SPL184, 1);
    let _y3 = _at_2(__SPL184, 2);
    let __SPL185 = _assertIsOfSize_2(_p4, 2);
    let _x4 = _at_2(__SPL185, 1);
    let _y4 = _at_2(__SPL185, 2);
  ...
  "{ :l1 :l2 | let __SPL180 = assertIsOfSize(l1, 2); let p1 = at(__SPL180, 1); let p2 = at(__SPL180, 2); let __SPL181 = assertIsOfSize(l2, 2); let p3 = at(__SPL181, 1); let p4 = at(__SPL181, 2); let __SPL182 = assertIsOfSize(p1, 2); let x1 = at(__SPL182, 1); let y1 = at(__SPL182, 2); let __SPL183 = assertIsOfSize(p2, 2); let x2 = at(__SPL183, 1); let y2 = at(__SPL183, 2); let __SPL184 = assertIsOfSize(p3, 2); let x3 = at(__SPL184, 1); let y3 = at(__SPL184, 2); let __SPL185 = assertIsOfSize(p4, 2); let x4 = at(__SPL185, 1); let y4 = at(__SPL185, 2); let a1 = -(y2, y1); let b1 = -(x1, x2); let c1 = +((*(a1, x1)), (*(b1, y1))); let a2 = -(y4, y3); let b2 = -(x3, x4); let c2 = +((*(a2, x3)), (*(b2, y3))); let delta = -((*(a1, b2)), (*(a2, b1))); [/((-((*(b2, c1)), (*(b1, c2)))), delta), /((-((*(a1, c2)), (*(a2, c1)))), delta)] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL186 = _assertIsOfSize_2(_self, 2);
    let _u = _at_2(__SPL186, 1);
    let _v = _at_2(__SPL186, 2);
    /* Statements */
    return _plusSign_2(_u, _solidus_2(_hyphenMinus_2(_v, _u), 2));
  }, ["self"]),
  "{ :self | let __SPL186 = assertIsOfSize(self, 2); let u = at(__SPL186, 1); let v = at(__SPL186, 2); +(u, (/((-(v, u)), 2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL187 = _assertIsOfSize_2(_self, 2);
    let _u = _at_2(__SPL187, 1);
    let _v = _at_2(__SPL187, 2);
  ...
  "{ :self | let __SPL187 = assertIsOfSize(self, 2); let u = at(__SPL187, 1); let v = at(__SPL187, 2); let m = rotationMatrix(pi(0.5)); InfiniteLine(midpoint([u, v]), dot((-(v, u)),m)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _q1 = _at_2(__SPL188, 1);
    let _p = _at_2(__SPL188, 2);
    let _q2 = _at_2(__SPL188, 3);
    let __SPL189 = _assertIsOfSize_2(_q1, 2);
    let _x1 = _at_2(__SPL189, 1);
    let _y1 = _at_2(__SPL189, 2);
    let __SPL190 = _assertIsOfSize_2(_p, 2);
    let _x0 = _at_2(__SPL190, 1);
    let _y0 = _at_2(__SPL190, 2);
    let __SPL191 = _assertIsOfSize_2(_q2, 2);
    let _x2 = _at_2(__SPL191, 1);
    let _y2 = _at_2(__SPL191, 2);
    let _n = _plusSign_2(
  ...
  "{ :self | let __SPL188 = assertIsOfSize(self, 3); let q1 = at(__SPL188, 1); let p = at(__SPL188, 2); let q2 = at(__SPL188, 3); let __SPL189 = assertIsOfSize(q1, 2); let x1 = at(__SPL189, 1); let y1 = at(__SPL189, 2); let __SPL190 = assertIsOfSize(p, 2); let x0 = at(__SPL190, 1); let y0 = at(__SPL190, 2); let __SPL191 = assertIsOfSize(q2, 2); let x2 = at(__SPL191, 1); let y2 = at(__SPL191, 2); let n = +((*((-(x1, x0)), (-(x2, x0)))), (*((-(y1, y0)), (-(y2, y0))))); let d = *(sqrt((+(squared((-(x1, x0))), squared((-(y1, y0)))))), sqrt((+(squared((-(x2, x0))), squared((-(y2, y0))))))); arcCos((/(n, d))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_aLine, _aPoint) {
    ...
    let __SPL192 = _assertIsOfSize_2(_aLine, 2);
    let _p1 = _at_2(__SPL192, 1);
    let _p2 = _at_2(__SPL192, 2);
    let _p0 = _aPoint;
    /* Statements */
    return _if_3(
  ...
  "{ :aLine :aPoint | let __SPL192 = assertIsOfSize(aLine, 2); let p1 = at(__SPL192, 1); let p2 = at(__SPL192, 2); let p0 = aPoint; if((=(size(p0), 2)), { /(abs((*(2, shoelaceFormula([p0, p1, p2])))), abs(euclideanDistance(p1,p2))) }, { /(norm(cross((-(p0, p1)),-(p0, p2))), norm((-(p2, p1)))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_l, _p) {
    ...
    let __SPL193 = _assertIsOfSize_2(_l, 2);
    let _a = _at_2(__SPL193, 1);
    let _b = _at_2(__SPL193, 2);
  ...
  "{ :l :p | let __SPL193 = assertIsOfSize(l, 2); let a = at(__SPL193, 1); let b = at(__SPL193, 2); let u = -(p, a); let v = -(b, a); let r = projection(u, v); +(a, r) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_l, _p) {
    ...
    let __SPL194 = _assertIsOfSize_2(_l, 2);
    let _a = _at_2(__SPL194, 1);
    let _b = _at_2(__SPL194, 2);
  ...
  "{ :l :p | let __SPL194 = assertIsOfSize(l, 2); let a = at(__SPL194, 1); let b = at(__SPL194, 2); let d = euclideanDistance(a,b); if((=(d, 0)), { a }, { let u = -(p, a); let v = -(b, a); let r = projection(u, v); let t = vectorAngle(v,r); if((~(t, pi(1))), { a }, { let i = +(a, r); if((>(euclideanDistance(a,i), d)), { b }, { i }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_u, _v) {
    ...
    let __SPL195 = _assertIsOfSize_2(_u, 2);
    let _u1 = _at_2(__SPL195, 1);
    let _u2 = _at_2(__SPL195, 2);
    let __SPL196 = _assertIsOfSize_2(_v, 2);
    let _v1 = _at_2(__SPL196, 1);
    let _v2 = _at_2(__SPL196, 2);
    /* Statements */
    return _atan2_2(
  ...
  "{ :u :v | let __SPL195 = assertIsOfSize(u, 2); let u1 = at(__SPL195, 1); let u2 = at(__SPL195, 2); let __SPL196 = assertIsOfSize(v, 2); let v1 = at(__SPL196, 1); let v2 = at(__SPL196, 2); atan2(-((*(u1, v2)), (*(u2, v1))), +((*(u1, v1)), (*(u2, v2)))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _p = _key_1(_self);
    let __SPL197 = _assertIsOfSize_2(_value_1(_self), 2);
    let _q1 = _at_2(__SPL197, 1);
    let _q2 = _at_2(__SPL197, 2);
    /* Statements */
  ...
  "{ :self | let p = key(self); let __SPL197 = assertIsOfSize(value(self), 2); let q1 = at(__SPL197, 1); let q2 = at(__SPL197, 2); counterClockwiseVectorAngle(-(q1, p), -(q2, p)) }",
);
