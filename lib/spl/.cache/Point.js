...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :p1 :p2 | let __SplVar1 = assertIsOfSize(p1, 2); let x1 = at(__SplVar1, 1); let y1 = at(__SplVar1, 2); let __SplVar2 = assertIsOfSize(p2, 2); let x2 = at(__SplVar2, 1); let y2 = at(__SplVar2, 2); let a = -(y2, y1); let b = -(x1, x2); let c = -((*(y1, (-(x2, x1)))), (*(x1, (-(y2, y1))))); let e = [a, b, c]; if(allSatisfy(e,isInteger:/1), { /(e, gcd(e)) }, { e }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar3 = assertIsOfSize(self, 3); let a = at(__SplVar3, 1); let b = at(__SplVar3, 2); let c = at(__SplVar3, 3); let m = -(0, (/(c, b))); let y = -(0, (/(a, b))); UnivariatePolynomial([m, y]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :l1 :l2 | let __SplVar4 = assertIsOfSize(l1, 2); let p1 = at(__SplVar4, 1); let p2 = at(__SplVar4, 2); let __SplVar5 = assertIsOfSize(l2, 2); let p3 = at(__SplVar5, 1); let p4 = at(__SplVar5, 2); let __SplVar6 = assertIsOfSize(p1, 2); let x1 = at(__SplVar6, 1); let y1 = at(__SplVar6, 2); let __SplVar7 = assertIsOfSize(p2, 2); let x2 = at(__SplVar7, 1); let y2 = at(__SplVar7, 2); let __SplVar8 = assertIsOfSize(p3, 2); let x3 = at(__SplVar8, 1); let y3 = at(__SplVar8, 2); let __SplVar9 = assertIsOfSize(p4, 2); let x4 = at(__SplVar9, 1); let y4 = at(__SplVar9, 2); let a1 = -(y2, y1); let b1 = -(x1, x2); let c1 = +((*(a1, x1)), (*(b1, y1))); let a2 = -(y4, y3); let b2 = -(x3, x4); let c2 = +((*(a2, x3)), (*(b2, y3))); let delta = -((*(a1, b2)), (*(a2, b1))); [/((-((*(b2, c1)), (*(b1, c2)))), delta), /((-((*(a1, c2)), (*(a2, c1)))), delta)] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar10 = assertIsOfSize(self, 2); let u = at(__SplVar10, 1); let v = at(__SplVar10, 2); +(u, (/((-(v, u)), 2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar11 = assertIsOfSize(self, 2); let u = at(__SplVar11, 1); let v = at(__SplVar11, 2); let m = rotationMatrix(pi(0.5)); InfiniteLine(midpoint([u, v]), dot((-(v, u)),m)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar12 = assertIsOfSize(self, 3); let q1 = at(__SplVar12, 1); let p = at(__SplVar12, 2); let q2 = at(__SplVar12, 3); let __SplVar13 = assertIsOfSize(q1, 2); let x1 = at(__SplVar13, 1); let y1 = at(__SplVar13, 2); let __SplVar14 = assertIsOfSize(p, 2); let x0 = at(__SplVar14, 1); let y0 = at(__SplVar14, 2); let __SplVar15 = assertIsOfSize(q2, 2); let x2 = at(__SplVar15, 1); let y2 = at(__SplVar15, 2); let n = +((*((-(x1, x0)), (-(x2, x0)))), (*((-(y1, y0)), (-(y2, y0))))); let d = *(sqrt((+(square((-(x1, x0))), square((-(y1, y0)))))), sqrt((+(square((-(x2, x0))), square((-(y2, y0))))))); arcCos((/(n, d))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :aLine :aPoint | let __SplVar16 = assertIsOfSize(aLine, 2); let p1 = at(__SplVar16, 1); let p2 = at(__SplVar16, 2); let p0 = aPoint; if((=(size(p0), 2)), { /(abs((*(2, shoelaceFormula([p0, p1, p2])))), abs(euclideanDistance(p1,p2))) }, { /(norm(cross((-(p0, p1)),-(p0, p2))), norm((-(p2, p1)))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :l :p | let __SplVar17 = assertIsOfSize(l, 2); let a = at(__SplVar17, 1); let b = at(__SplVar17, 2); let u = -(p, a); let v = -(b, a); let r = projection(u, v); +(a, r) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :l :p | let __SplVar18 = assertIsOfSize(l, 2); let a = at(__SplVar18, 1); let b = at(__SplVar18, 2); let d = euclideanDistance(a,b); if((=(d, 0)), { a }, { let u = -(p, a); let v = -(b, a); let r = projection(u, v); let t = vectorAngle(v,r); if((~(t, pi(1))), { a }, { let i = +(a, r); if((>(euclideanDistance(a,i), d)), { b }, { i }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :u :v | let __SplVar19 = assertIsOfSize(u, 2); let u1 = at(__SplVar19, 1); let u2 = at(__SplVar19, 2); let __SplVar20 = assertIsOfSize(v, 2); let v1 = at(__SplVar20, 1); let v2 = at(__SplVar20, 2); atan2(-((*(u1, v2)), (*(u2, v1))), +((*(u1, v1)), (*(u2, v2)))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :p :q | let __SplVar21 = assertIsOfSize(p, 2); let x1 = at(__SplVar21, 1); let y1 = at(__SplVar21, 2); let __SplVar22 = assertIsOfSize(q, 2); let x2 = at(__SplVar22, 1); let y2 = at(__SplVar22, 2); let m = /((-(y2, y1)), (-(x2, x1))); let c = -(y1, (*(m, x1))); [m, c] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let p = key(self); let __SplVar23 = assertIsOfSize(value(self), 2); let q1 = at(__SplVar23, 1); let q2 = at(__SplVar23, 2); counterClockwiseVectorAngle(-(q1, p), -(q2, p)) }",
);
