...
sl.addType(
  ...
  "Point",
  "Point",
  ["Object", "Storeable", "Equatable", "Geometry", "CartesianCoordinates"],
  ["coordinates"],
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "Point",
  "anglePath",
  ["angles", "distances", "origin", "initialAngle"],
  sl.annotateFunction(function (_angles, _distances, _origin, _initialAngle) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _angles, _distances, _origin, _initialAngle";
      throw new Error(errorMessage);
    } /* Temporaries */
    let _answer = [_origin];
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _anglePath_4(_self, [1], [0, 0], 0);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let _m = _plusSign_2(_solidusSolidus_2(_n, 6), 1);
    let _l = _first_2(
      _catenate_1(
        _collect_2(
          ...
          sl.annotateFunction(function (_i) {
            ...
            return _plusSign_2(_i, [1, 1, 1, 1, 2, 1]);
          }, ["i"]),
        ),
      ),
      _n,
    );
    let _a = _catenate_1(_collect_2(
      _l,
      sl.annotateFunction(function (_i) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        return _plusSignPlusSign_2(
          [_degree_1(60)],
          _List_2(_hyphenMinus_2(_i, 1), 0),
        );
      }, ["i"]),
    ));
    let _d = _List_2(_size_1(_a), 1);
    /* Statements */
    return _anglePath_4(_a, _d, [0, 0], 0);
  }, ["n"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let _m = _plusSign_2(_solidusSolidus_2(_n, 2), 1);
    let _l = _first_2(
      _catenate_1(
        _collect_2(
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let _l = _rangeOrRelativeRange_3(1, _n, 1);
    let _a = _catenate_1(_collect_2(
      _l,
      sl.annotateFunction(function (_i) {
        /* ArityCheck */
