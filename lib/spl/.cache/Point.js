...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p1, _p2) {
    ...
    let __SPL1 = _assertIsOfSize_2(_p1, 2);
    let _x1 = _at_2(__SPL1, 1);
    let _y1 = _at_2(__SPL1, 2);
    let __SPL2 = _assertIsOfSize_2(_p2, 2);
    let _x2 = _at_2(__SPL2, 1);
    let _y2 = _at_2(__SPL2, 2);
  ...
  "{ :p1 :p2 | let __SPL1 = assertIsOfSize(p1, 2); let x1 = at(__SPL1, 1); let y1 = at(__SPL1, 2); let __SPL2 = assertIsOfSize(p2, 2); let x2 = at(__SPL2, 1); let y2 = at(__SPL2, 2); let a = -(y2, y1); let b = -(x1, x2); let c = -((*(y1, (-(x2, x1)))), (*(x1, (-(y2, y1))))); let e = [a, b, c]; if(allSatisfy(e,isInteger:/1), { /(e, gcd(e)) }, { e }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL3 = assertIsOfSize(self, 3); let a = at(__SPL3, 1); let b = at(__SPL3, 2); let c = at(__SPL3, 3); let m = -(0, (/(c, b))); let y = -(0, (/(a, b))); UnivariatePolynomial([m, y]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_l1, _l2) {
    ...
    let __SPL4 = _assertIsOfSize_2(_l1, 2);
    let _p1 = _at_2(__SPL4, 1);
    let _p2 = _at_2(__SPL4, 2);
    let __SPL5 = _assertIsOfSize_2(_l2, 2);
    let _p3 = _at_2(__SPL5, 1);
    let _p4 = _at_2(__SPL5, 2);
    let __SPL6 = _assertIsOfSize_2(_p1, 2);
    let _x1 = _at_2(__SPL6, 1);
    let _y1 = _at_2(__SPL6, 2);
    let __SPL7 = _assertIsOfSize_2(_p2, 2);
    let _x2 = _at_2(__SPL7, 1);
    let _y2 = _at_2(__SPL7, 2);
    let __SPL8 = _assertIsOfSize_2(_p3, 2);
    let _x3 = _at_2(__SPL8, 1);
    let _y3 = _at_2(__SPL8, 2);
    let __SPL9 = _assertIsOfSize_2(_p4, 2);
    let _x4 = _at_2(__SPL9, 1);
    let _y4 = _at_2(__SPL9, 2);
  ...
  "{ :l1 :l2 | let __SPL4 = assertIsOfSize(l1, 2); let p1 = at(__SPL4, 1); let p2 = at(__SPL4, 2); let __SPL5 = assertIsOfSize(l2, 2); let p3 = at(__SPL5, 1); let p4 = at(__SPL5, 2); let __SPL6 = assertIsOfSize(p1, 2); let x1 = at(__SPL6, 1); let y1 = at(__SPL6, 2); let __SPL7 = assertIsOfSize(p2, 2); let x2 = at(__SPL7, 1); let y2 = at(__SPL7, 2); let __SPL8 = assertIsOfSize(p3, 2); let x3 = at(__SPL8, 1); let y3 = at(__SPL8, 2); let __SPL9 = assertIsOfSize(p4, 2); let x4 = at(__SPL9, 1); let y4 = at(__SPL9, 2); let a1 = -(y2, y1); let b1 = -(x1, x2); let c1 = +((*(a1, x1)), (*(b1, y1))); let a2 = -(y4, y3); let b2 = -(x3, x4); let c2 = +((*(a2, x3)), (*(b2, y3))); let delta = -((*(a1, b2)), (*(a2, b1))); [/((-((*(b2, c1)), (*(b1, c2)))), delta), /((-((*(a1, c2)), (*(a2, c1)))), delta)] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _u = _at_2(__SPL10, 1);
    let _v = _at_2(__SPL10, 2);
    /* Statements */
    return _plusSign_2(_u, _solidus_2(_hyphenMinus_2(_v, _u), 2));
  }, ["self"]),
  "{ :self | let __SPL10 = assertIsOfSize(self, 2); let u = at(__SPL10, 1); let v = at(__SPL10, 2); +(u, (/((-(v, u)), 2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _u = _at_2(__SPL11, 1);
    let _v = _at_2(__SPL11, 2);
  ...
  "{ :self | let __SPL11 = assertIsOfSize(self, 2); let u = at(__SPL11, 1); let v = at(__SPL11, 2); let m = rotationMatrix(pi(0.5)); InfiniteLine(midpoint([u, v]), dot((-(v, u)),m)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _q1 = _at_2(__SPL12, 1);
    let _p = _at_2(__SPL12, 2);
    let _q2 = _at_2(__SPL12, 3);
    let __SPL13 = _assertIsOfSize_2(_q1, 2);
    let _x1 = _at_2(__SPL13, 1);
    let _y1 = _at_2(__SPL13, 2);
    let __SPL14 = _assertIsOfSize_2(_p, 2);
    let _x0 = _at_2(__SPL14, 1);
    let _y0 = _at_2(__SPL14, 2);
    let __SPL15 = _assertIsOfSize_2(_q2, 2);
    let _x2 = _at_2(__SPL15, 1);
    let _y2 = _at_2(__SPL15, 2);
    let _n = _plusSign_2(
  ...
  "{ :self | let __SPL12 = assertIsOfSize(self, 3); let q1 = at(__SPL12, 1); let p = at(__SPL12, 2); let q2 = at(__SPL12, 3); let __SPL13 = assertIsOfSize(q1, 2); let x1 = at(__SPL13, 1); let y1 = at(__SPL13, 2); let __SPL14 = assertIsOfSize(p, 2); let x0 = at(__SPL14, 1); let y0 = at(__SPL14, 2); let __SPL15 = assertIsOfSize(q2, 2); let x2 = at(__SPL15, 1); let y2 = at(__SPL15, 2); let n = +((*((-(x1, x0)), (-(x2, x0)))), (*((-(y1, y0)), (-(y2, y0))))); let d = *(sqrt((+(square((-(x1, x0))), square((-(y1, y0)))))), sqrt((+(square((-(x2, x0))), square((-(y2, y0))))))); arcCos((/(n, d))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_aLine, _aPoint) {
    ...
    let __SPL16 = _assertIsOfSize_2(_aLine, 2);
    let _p1 = _at_2(__SPL16, 1);
    let _p2 = _at_2(__SPL16, 2);
    let _p0 = _aPoint;
    /* Statements */
    return _if_3(
  ...
  "{ :aLine :aPoint | let __SPL16 = assertIsOfSize(aLine, 2); let p1 = at(__SPL16, 1); let p2 = at(__SPL16, 2); let p0 = aPoint; if((=(size(p0), 2)), { /(abs((*(2, shoelaceFormula([p0, p1, p2])))), abs(euclideanDistance(p1,p2))) }, { /(norm(cross((-(p0, p1)),-(p0, p2))), norm((-(p2, p1)))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_l, _p) {
    ...
    let __SPL17 = _assertIsOfSize_2(_l, 2);
  ...
  "{ :l :p | let __SPL17 = assertIsOfSize(l, 2); let a = at(__SPL17, 1); let b = at(__SPL17, 2); let u = -(p, a); let v = -(b, a); let r = projection(u, v); +(a, r) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_l, _p) {
    ...
    let __SPL18 = _assertIsOfSize_2(_l, 2);
  ...
  "{ :l :p | let __SPL18 = assertIsOfSize(l, 2); let a = at(__SPL18, 1); let b = at(__SPL18, 2); let d = euclideanDistance(a,b); if((=(d, 0)), { a }, { let u = -(p, a); let v = -(b, a); let r = projection(u, v); let t = vectorAngle(v,r); if((~(t, pi(1))), { a }, { let i = +(a, r); if((>(euclideanDistance(a,i), d)), { b }, { i }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_u, _v) {
    ...
    let __SPL19 = _assertIsOfSize_2(_u, 2);
    let _u1 = _at_2(__SPL19, 1);
    let _u2 = _at_2(__SPL19, 2);
    let __SPL20 = _assertIsOfSize_2(_v, 2);
    let _v1 = _at_2(__SPL20, 1);
    let _v2 = _at_2(__SPL20, 2);
    /* Statements */
    return _atan2_2(
  ...
  "{ :u :v | let __SPL19 = assertIsOfSize(u, 2); let u1 = at(__SPL19, 1); let u2 = at(__SPL19, 2); let __SPL20 = assertIsOfSize(v, 2); let v1 = at(__SPL20, 1); let v2 = at(__SPL20, 2); atan2(-((*(u1, v2)), (*(u2, v1))), +((*(u1, v1)), (*(u2, v2)))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p, _q) {
    ...
    let __SPL21 = _assertIsOfSize_2(_p, 2);
    let _x1 = _at_2(__SPL21, 1);
    let _y1 = _at_2(__SPL21, 2);
    let __SPL22 = _assertIsOfSize_2(_q, 2);
    let _x2 = _at_2(__SPL22, 1);
    let _y2 = _at_2(__SPL22, 2);
    let _m = _solidus_2(_hyphenMinus_2(_y2, _y1), _hyphenMinus_2(_x2, _x1));
    let _c = _hyphenMinus_2(_y1, _asterisk_2(_m, _x1));
    /* Statements */
    return [_m, _c];
  }, ["p", "q"]),
  "{ :p :q | let __SPL21 = assertIsOfSize(p, 2); let x1 = at(__SPL21, 1); let y1 = at(__SPL21, 2); let __SPL22 = assertIsOfSize(q, 2); let x2 = at(__SPL22, 1); let y2 = at(__SPL22, 2); let m = /((-(y2, y1)), (-(x2, x1))); let c = -(y1, (*(m, x1))); [m, c] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _p = _key_1(_self);
    let __SPL23 = _assertIsOfSize_2(_value_1(_self), 2);
    let _q1 = _at_2(__SPL23, 1);
    let _q2 = _at_2(__SPL23, 2);
    /* Statements */
  ...
  "{ :self | let p = key(self); let __SPL23 = assertIsOfSize(value(self), 2); let q1 = at(__SPL23, 1); let q2 = at(__SPL23, 2); counterClockwiseVectorAngle(-(q1, p), -(q2, p)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aList :origin | let c = [origin]; do(aList, { :i | let a = last(c); let b = at(self, i); add(c,+(a, b)) }); c }",
);
