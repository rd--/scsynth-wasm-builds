...
sl.extendTraitWithMethod(
  ...
  function (_angles, _distances, _origin) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _angles, _distances, _origin"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _answer = [_origin];
...
sl.extendTraitWithMethod(
  ...
  function (_aPoint, _aVector) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _aPoint, _aVector"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_aMatrix) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _aMatrix"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_p1, _p2) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _p1, _p2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_l1, _l2) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _l1, _l2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_vector) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _vector"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_aLine, _aPoint) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _aLine, _aPoint"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_l, _p) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _l, _p"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_alpha, _beta, _a) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _alpha, _beta, _a"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _x2 = _asterisk_2(
...
sl.extendTraitWithMethod(
  ...
  function (_alpha, _c, _beta) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _alpha, _c, _beta"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _x = _asterisk_2(
...
sl.extendTraitWithMethod(
  ...
  function (_a, _gamma, _b) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _a, _gamma, _b"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _x = _sqrt_1(
...
sl.extendTraitWithMethod(
  ...
  function (_a, _b, _c) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _a, _b, _c"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _y = _solidus_2(
