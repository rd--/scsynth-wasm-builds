sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_f_1, _x, _alpha, _tolerance) {
    ...
    let _gradientOf_1 = sl.annotateFunction(function (_p) {
      ...
      let __SPL379 = _assertIsOfSize_2(_p, 2);
