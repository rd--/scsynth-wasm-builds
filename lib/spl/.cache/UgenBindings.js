...
sl.addMethod(
  ...
  function (_bufnum, _phase, _loop, _inputArray) {
    ...
    /* Primitive */
    return sc.BufWr(_bufnum, _phase, _loop, _inputArray);
  },
  "{ :bufnum :phase :loop :inputArray | <primitive: return sc.BufWr(_bufnum, _phase, _loop, _inputArray);> }",
);
...
sl.addMethod(
  ...
  function (_freqscale, _freqoffset, _specificationsArrayRef) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _freqscale, _freqoffset, _specificationsArrayRef";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.Klang(_freqscale, _freqoffset, _specificationsArrayRef);
  },
  "{ :freqscale :freqoffset :specificationsArrayRef | <primitive: return sc.Klang(_freqscale, _freqoffset, _specificationsArrayRef);> }",
);
...
sl.addMethod(
  ...
  function (
    ...
    _freqoffset,
    _decayscale,
    _specificationsArrayRef,
  ) {
    /* ArityCheck */
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _input, _freqscale, _freqoffset, _decayscale, _specificationsArrayRef";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
  ...
  "{ :input :freqscale :freqoffset :decayscale :specificationsArrayRef | <primitive: return sc.Klank(_input, _freqscale, _freqoffset, _decayscale, _specificationsArrayRef);> }",
);
...
sl.addMethod(
  ...
  function (_channelsArray) {
    ...
    /* Primitive */
    return sc.LocalOut(_channelsArray);
  },
  "{ :channelsArray | <primitive: return sc.LocalOut(_channelsArray);> }",
);
...
sl.addMethod(
  ...
  "Multiplexer",
  ["selector", "inputArray"],
  function (_selector, _inputArray) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _selector, _inputArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.Multiplexer(_selector, _inputArray);
  },
  "{ :selector :inputArray | <primitive: return sc.Multiplexer(_selector, _inputArray);> }",
);
...
sl.addMethod(
  ...
  function (_bus, _channelsArray) {
    ...
    /* Primitive */
    return sc.Out(_bus, _channelsArray);
  },
  "{ :bus :channelsArray | <primitive: return sc.Out(_bus, _channelsArray);> }",
);
...
sl.addMethod(
  ...
  function (
    ...
    if (arguments.length !== 9) {
      const errorMessage =
        "Arity: expected 9, _bufnum, _offset, _recLevel, _preLevel, _run, _loop, _trigger, _doneAction, _inputArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
  ...
  "{ :bufnum :offset :recLevel :preLevel :run :loop :trigger :doneAction :inputArray | <primitive: return sc.RecordBuf(_bufnum, _offset, _recLevel, _preLevel, _run, _loop, _trigger, _doneAction, _inputArray);> }",
);
...
sl.addMethod(
  ...
  function (_bus, _channelsArray) {
    ...
    /* Primitive */
    return sc.ReplaceOut(_bus, _channelsArray);
  },
  "{ :bus :channelsArray | <primitive: return sc.ReplaceOut(_bus, _channelsArray);> }",
);
...
sl.addMethod(
  ...
  function (
    ...
    if (arguments.length !== 15) {
      const errorMessage =
        "Arity: expected 15, _pit, _pos, _size, _dens, _tex, _drywet, _inGain, _spread, _rvb, _fb, _freeze, _mode, _lofi, _trig, _inputArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
  ...
  "{ :pit :pos :size :dens :tex :drywet :inGain :spread :rvb :fb :freeze :mode :lofi :trig :inputArray | <primitive: return sc.MiClouds(_pit, _pos, _size, _dens, _tex, _drywet, _inGain, _spread, _rvb, _fb, _freeze, _mode, _lofi, _trig, _inputArray);> }",
);
...
sl.addMethod(
  ...
  "UgenBindings",
  "WDistances",
  ["gate", "x", "y", "z", "coordinateArray"],
  function (_gate, _x, _y, _z, _coordinateArray) {
    /* ArityCheck */
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _gate, _x, _y, _z, _coordinateArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.WDistances(_gate, _x, _y, _z, _coordinateArray);
  },
  "{ :gate :x :y :z :coordinateArray | <primitive: return sc.WDistances(_gate, _x, _y, _z, _coordinateArray);> }",
);
...
sl.addMethod(
  ...
  "UgenBindings",
  "WkNearest",
  ["numChannels", "gate", "x", "y", "z", "coordinateArray"],
  function (_numChannels, _gate, _x, _y, _z, _coordinateArray) {
    /* ArityCheck */
    if (arguments.length !== 6) {
      const errorMessage =
        "Arity: expected 6, _numChannels, _gate, _x, _y, _z, _coordinateArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.WkNearest(_numChannels, _gate, _x, _y, _z, _coordinateArray);
  },
  "{ :numChannels :gate :x :y :z :coordinateArray | <primitive: return sc.WkNearest(_numChannels, _gate, _x, _y, _z, _coordinateArray);> }",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _MidiCps_1(_times_2(_self, 100));
  },
  "{ :self |\n\t\t(self * 100).MidiCps\n\t}",
);
