...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aNumber | if((&(isNegative(self), { isNegative(aNumber) })), { negate(gcd(negate(self),negate(aNumber))) }, { gcd(self,aNumber) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aNumber | if((|(isNegative(self), { isNegative(aNumber) })), { negate(lcm(abs(self),abs(aNumber))) }, { lcm(self,aNumber) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isNegative(self), { negate(sqrt(negate(self))) }, { sqrt(self) }) }",
);
