...
sl.extendTypeOrTraitWithMethod(
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _toDo_3(
        ...
        sl.annotateFunction(function (_i) {
          ...
          let _k = _hyphenMinus_2(_m, _asterisk_2(2, _i));
          /* Statements */
          return _toDo_3(
            1,
            _k,
            sl.annotateFunction(function (_n) {
              ...
              let _q = _plusSign_2(_n, _i);
              let _r = _plusSign_2(_n, _asterisk_2(2, _i));
              /* Statements */
              return _ifTrue_2(
                _equalsSign_2(
                  _asterisk_2(2, _at_2(_a, _q)),
                  _plusSign_2(_at_2(_a, _n), _at_2(_a, _r)),
                ),
                sl.annotateFunction(function () {
                  /* ArityCheck */
                  if (arguments.length !== 0) {
  ...
  "{ :a | let m = size(a); valueWithReturn({ :return:/1 | toDo(1, //(m, 2), { :i | let k = -(m, (*(2, i))); toDo(1, k, { :n | let q = +(n, i); let r = +(n, (*(2, i))); ifTrue((=((*(2, at(a, q))), (+(at(a, n), at(a, r))))), { return([n, q, r]) }) }) }); nil }) }",
);
