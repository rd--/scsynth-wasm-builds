  ...
  function (_self) {
    ...
    let _filter_1 = _ifNil_3(_filterText_1(_self), function () {
      ...
      return (function (_unusedString) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _unusedString"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
        return true;
...
sl.addMethod(
  ...
  function (_self, _withFilter, _titleText, _listSize) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _withFilter, _titleText, _listSize"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _title, _listSize) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _title, _listSize"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
