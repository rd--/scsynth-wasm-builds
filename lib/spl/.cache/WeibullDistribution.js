...
sl.addMethodToExistingType(
  ...
  "{ :self | let alpha = alpha(self); let beta = beta(self); let mu = mu(self); { :x | if((>=(x, 0)), { -(1, exp(negated((^((/((-(x, mu)), beta)), alpha))))) }, { 0 }) } }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let alpha = alpha(self); let beta = beta(self); let mu = mu(self); { :x | if((>=(x, mu)), { *(*((/(alpha, beta)), (^((/((-(x, mu)), beta)), (-(alpha, 1))))), exp(negated((^((/((-(x, mu)), beta)), alpha))))) }, { 0 }) } }",
);
