...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _and_2(_isRatioTuning_1(_anObject), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _and_2(_equals_2(_name_1(_self), _name_1(_anObject)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _and_2(
          _equals_2(_description_1(_self), _description_1(_anObject)),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
            ...
            /* Statements */
            return _equals_2(_ratios_1(_self), _ratios_1(_anObject));
          },
        );
      });
    });
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _collect_2(_ratios_1(_self), function (_each) {
      ...
      /* Statements */
      return _times_2(_log2_1(_asFloat_1(_each)), 1200);
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _collect_2(
      _dividedBy_2(_ratios_1(_self), _reduce_2(_ratios_1(_self), _gcd_2)),
      _asInteger_1,
    );
  },
...
sl.addMethod(
  ...
  function (_self, _description, _integers, _octave) {
    ...
    let _ratios = _collect_2(_integers, function (_each) {
      ...
      /* Statements */
      return _normalized_1(_Fraction_2(_each, _first_1(_integers)));
    });
    /* Statements */
