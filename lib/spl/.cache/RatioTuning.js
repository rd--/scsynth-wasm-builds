    ...
    return _withIndexCollect_2(_n, function (_p, _i) {
      ...
      return _collect_2(
        ...
        function (_q) {
          ...
          if (arguments.length !== 1) {
            const errorMessage =
              "Arity: expected 1, _q"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Statements */
...
sl.addMethod(
  ...
  function (_self, _description, _integers, _octave) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _description, _integers, _octave"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _description, _ratios, _octave) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _description, _ratios, _octave"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
