...
sl.addMethod(
  ...
  function (_self, _aPackage) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aPackage"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function (_self, _aSequence) {
    ...
    return _ifNotEmpty_2(_requires_1(_self), function (_packageNames) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _packageNames"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _name, _requires, _url, _text) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _name, _requires, _url, _text"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _asRecord_1(_concatenation_1(_collect_2(_fields, function (_each) {
      ...
      /* Temporaries */
      let __genSym127 = _assertIsOfSize_2(
          _splitBy_2(_withBlanksTrimmed_1(_each), ": "),
          2,
        ),
        _key = _at_2(__genSym127, 1),
        _value = _at_2(__genSym127, 2);
      /* Statements */
      return _caseOfOtherwise_3(_key, [
        _hyphenMinusGreaterThanSign_2("Package", function () {
          ...
          let __genSym128 = _assertIsOfSize_2(
            ...
            _category = _at_2(__genSym128, 1),
            _name = _at_2(__genSym128, 2);
          /* Statements */
          return [
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym129 = _assertIsOfSize_2(_splitBy_2(_self, "-"), 2),
...
sl.addMethod(
  ...
  function (_self, _package) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _package"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    return _if_3(_isQualifiedPackageName_1(_name), function () {
      ...
      /* Temporaries */
      let __genSym130 = _assertIsOfSize_2(
          _parseQualifiedPackageName_1(_name),
          2,
        ),
        _categoryName = _at_2(__genSym130, 1),
        _packageName = _at_2(__genSym130, 2);
