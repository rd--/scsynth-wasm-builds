...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _asRecord_1(_concatenation_1(_collect_2(_fields, function (_each) {
      ...
      /* Temporaries */
      let __genSym15 = _assertIsOfSize_2(
          _splitBy_2(_withBlanksTrimmed_1(_each), ": "),
          2,
        ),
        _key = _at_2(__genSym15, 1),
        _value = _at_2(__genSym15, 2);
      /* Statements */
      return _caseOfOtherwise_3(_key, [
        _hyphenMinusGreaterThanSign_2("Package", function () {
          ...
          /* Temporaries */
          let __genSym16 = _assertIsOfSize_2(
              _parseQualifiedPackageName_1(_withBlanksTrimmed_1(_value)),
              2,
            ),
            _category = _at_2(__genSym16, 1),
            _name = _at_2(__genSym16, 2);
          /* Statements */
          return [
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym17 = _assertIsOfSize_2(_splitBy_2(_self, "-"), 2),
      _category = _at_2(__genSym17, 1),
      _name = _at_2(__genSym17, 2);
    /* Statements */
  ...
  function (_self, _name) {
    ...
    return _if_3(_isQualifiedPackageName_1(_name), function () {
      ...
      let __genSym18 = _assertIsOfSize_2(
        ...
        _categoryName = _at_2(__genSym18, 1),
        _packageName = _at_2(__genSym18, 2);
