...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _asRecord_1(_concatenation_1(_collect_2(_fields, function (_each) {
      ...
      /* Temporaries */
      let __genSym48 = _assertIsOfSize_2(
          _splitBy_2(_withBlanksTrimmed_1(_each), ": "),
          2,
        ),
        _key = _at_2(__genSym48, 1),
        _value = _at_2(__genSym48, 2);
      /* Statements */
      return _caseOfOtherwise_3(_key, [
        _hyphenMinusGreaterThanSign_2("Package", function () {
          ...
          /* Temporaries */
          let __genSym49 = _assertIsOfSize_2(
              _parseQualifiedPackageName_1(_withBlanksTrimmed_1(_value)),
              2,
            ),
            _category = _at_2(__genSym49, 1),
            _name = _at_2(__genSym49, 2);
          /* Statements */
          return [
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym50 = _assertIsOfSize_2(_splitBy_2(_self, "-"), 2),
      _category = _at_2(__genSym50, 1),
      _name = _at_2(__genSym50, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    return _if_3(_isQualifiedPackageName_1(_name), function () {
      ...
      /* Temporaries */
      let __genSym51 = _assertIsOfSize_2(
          _parseQualifiedPackageName_1(_name),
          2,
        ),
        _categoryName = _at_2(__genSym51, 1),
        _packageName = _at_2(__genSym51, 2);
