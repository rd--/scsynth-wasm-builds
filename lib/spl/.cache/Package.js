...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _asRecord_1(_concatenation_1(_collect_2(_fields, function (_each) {
      ...
      /* Temporaries */
      let __genSym25 = _assertIsOfSize_2(
          _splitBy_2(_withBlanksTrimmed_1(_each), ": "),
          2,
        ),
        _key = _at_2(__genSym25, 1),
        _value = _at_2(__genSym25, 2);
      /* Statements */
      return _caseOfOtherwise_3(_key, [
        _minusGreaterThan_2("Package", function () {
          ...
          let __genSym26 = _assertIsOfSize_2(
            ...
            _category = _at_2(__genSym26, 1),
            _name = _at_2(__genSym26, 2);
          /* Statements */
          return [
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym27 = _assertIsOfSize_2(_splitBy_2(_self, "-"), 2),
      _category = _at_2(__genSym27, 1),
      _name = _at_2(__genSym27, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    return _if_3(_isQualifiedPackageName_1(_name), function () {
      ...
      /* Temporaries */
      let __genSym28 = _assertIsOfSize_2(
          _parseQualifiedPackageName_1(_name),
          2,
        ),
        _categoryName = _at_2(__genSym28, 1),
        _packageName = _at_2(__genSym28, 2);
