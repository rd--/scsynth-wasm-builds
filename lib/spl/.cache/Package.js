  ...
  function (_self) {
    ...
    return _asRecord_1(_concatenation_1(_collect_2(_fields, function (_each) {
      ...
      let __genSym1 = _assertIsOfSize_2(
        ...
        _key = _at_2(__genSym1, 1),
        _value = _at_2(__genSym1, 2);
      /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym3 = _assertIsOfSize_2(_splitBy_2(_self, "-"), 2),
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    return _if_3(_isQualifiedPackageName_1(_name), function () {
      ...
      /* Temporaries */
      let __genSym4 = _assertIsOfSize_2(_parseQualifiedPackageName_1(_name), 2),
        _categoryName = _at_2(__genSym4, 1),
        _packageName = _at_2(__genSym4, 2);
