  ...
  function (_self, _aPackage) {
    ...
    return _or_2(
      ...
      function () {
        ...
        /* Statements */
        return _lessThan_2(_name_1(_self), _name_1(_aPackage));
      },
    );
  },
...
sl.addMethod(
  ...
  function (_self, _aPackage) {
    ...
    /* Statements */
    return _or_2(_equals_2(_self, _aPackage), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _lessThan_2(_self, _aPackage);
    });
  },
  "{ :self :aPackage |\n\t\tself = aPackage | {\n\t\t\tself < aPackage\n\t\t}\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _copyWithoutDuplicates_1(_answer);
  },
  ...
  function (_self) {
    ...
    return _ifFalse_2(_isLoaded_1(_self), function () {
      ...
      return _primitiveLoadPackageSequence_1(
        _plusPlus_2(_requirements, [_name_1(_self)]),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_plusPlus_2(_category_1(_self), "-"), _name_1(_self));
  },
  ...
  function (_self) {
    ...
    return _asRecord_1(_concatenation_1(_collect_2(_fields, function (_each) {
      ...
      let __genSym2 = _assertIsOfSize_2(
        ...
        _key = _at_2(__genSym2, 1),
        _value = _at_2(__genSym2, 2);
      /* Statements */
      return _caseOfOtherwise_3(_key, [
        _minusGreaterThan_2("Package", function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          let __genSym3 = _assertIsOfSize_2(
            ...
            _category = _at_2(__genSym3, 1),
            _name = _at_2(__genSym3, 2);
          /* Statements */
          return [
            _minusGreaterThan_2("Category", _category),
            _minusGreaterThan_2("Name", _name),
          ];
        }),
        _minusGreaterThan_2("Requires", function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          /* Statements */
          return [
            _minusGreaterThan_2(_key, _words_1(_withBlanksTrimmed_1(_value))),
          ];
        }),
      ], function () {
        /* ArityCheck */
        ...
        return _error_2(
          _self,
          _plusPlus_2("parsePackageHeader: unknown field: ", _key),
        );
      });
    })));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym4 = _assertIsOfSize_2(_splitBy_2(_self, "-"), 2),
      _category = _at_2(__genSym4, 1),
      _name = _at_2(__genSym4, 2);
    /* Statements */
  ...
  function (_self) {
    ...
    _do_2(_self, function (_each) {
      ...
      return _ifTrue_2(_isLoaded_1(_each), function () {
        ...
        return _error_2(
          _self,
          _plusPlus_2("loadPackages: package loaded: ", _name_1(_each)),
        );
      });
    });
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    return _if_3(_isQualifiedPackageName_1(_name), function () {
      ...
      /* Temporaries */
      let __genSym5 = _assertIsOfSize_2(_parseQualifiedPackageName_1(_name), 2),
        _categoryName = _at_2(__genSym5, 1),
        _packageName = _at_2(__genSym5, 2);
      let _package = _at_2(_packageDictionary_1(_self), _packageName);
      /* Statements */
      return _if_3(
        _and_2(_equals_2(_categoryName, _category_1(_package)), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
  ...
  function (_self, _package) {
    ...
    return _if_3(
      ...
      function () {
        ...
        return _error_2(
          _self,
          _plusPlus_2("registerPackage: package exists: ", _name_1(_package)),
        );
      },
      function () {
        /* ArityCheck */
