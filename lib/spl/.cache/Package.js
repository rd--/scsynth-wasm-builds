...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _asRecord_1(_concatenation_1(_collect_2(_fields, function (_each) {
      ...
      let __genSym224 = _assertIsOfSize_2(
          _splitBy_2(_withBlanksTrimmed_1(_each), ": "),
          2,
        ),
        _key = _at_2(__genSym224, 1),
        _value = _at_2(__genSym224, 2);
      /* Statements */
      return _caseOfOtherwise_3(_key, [
        _hyphenMinusGreaterThanSign_2("Package", function () {
          ...
          let __genSym225 = _assertIsOfSize_2(
              _parseQualifiedPackageName_1(_withBlanksTrimmed_1(_value)),
              2,
            ),
            _category = _at_2(__genSym225, 1),
            _name = _at_2(__genSym225, 2);
          /* Statements */
          return [
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym226 = _assertIsOfSize_2(_splitBy_2(_self, "-"), 2),
      _category = _at_2(__genSym226, 1),
      _name = _at_2(__genSym226, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    return _if_3(_isQualifiedPackageName_1(_name), function () {
      ...
      let __genSym227 = _assertIsOfSize_2(
          _parseQualifiedPackageName_1(_name),
          2,
        ),
        _categoryName = _at_2(__genSym227, 1),
        _packageName = _at_2(__genSym227, 2);
