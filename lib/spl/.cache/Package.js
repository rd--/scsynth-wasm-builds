  ...
  function (_self) {
    ...
    return _asRecord_1(_concatenation_1(_collect_2(_fields, function (_each) {
      ...
      let __genSym8 = _assertIsOfSize_2(
        ...
        _key = _at_2(__genSym8, 1),
        _value = _at_2(__genSym8, 2);
      /* Statements */
      return _caseOfOtherwise_3(_key, [
        _hyphenMinusGreaterThanSign_2("Package", function () {
          ...
          let __genSym9 = _assertIsOfSize_2(
            ...
            _category = _at_2(__genSym9, 1),
            _name = _at_2(__genSym9, 2);
          /* Statements */
          return [
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym10 = _assertIsOfSize_2(_splitBy_2(_self, "-"), 2),
      _category = _at_2(__genSym10, 1),
      _name = _at_2(__genSym10, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    return _if_3(_isQualifiedPackageName_1(_name), function () {
      ...
      let __genSym11 = _assertIsOfSize_2(
          _parseQualifiedPackageName_1(_name),
          2,
        ),
        _categoryName = _at_2(__genSym11, 1),
        _packageName = _at_2(__genSym11, 2);
