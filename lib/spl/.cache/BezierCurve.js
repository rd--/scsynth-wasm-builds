...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL98 = _assertIsOfSize_2(_self, 3);
    let _c = _at_2(__SPL98, 1);
    let _u = _at_2(__SPL98, 2);
    let _v = _at_2(__SPL98, 3);
    let __SPL99 = _assertIsOfSize_2(_c, 2);
    let _xc = _at_2(__SPL99, 1);
    let _yc = _at_2(__SPL99, 2);
    let __SPL100 = _assertIsOfSize_2(_u, 2);
    let _x1 = _at_2(__SPL100, 1);
    let _y1 = _at_2(__SPL100, 2);
    let __SPL101 = _assertIsOfSize_2(_v, 2);
    let _x4 = _at_2(__SPL101, 1);
    let _y4 = _at_2(__SPL101, 2);
  ...
  "{ :self | let __SPL98 = assertIsOfSize(self, 3); let c = at(__SPL98, 1); let u = at(__SPL98, 2); let v = at(__SPL98, 3); let __SPL99 = assertIsOfSize(c, 2); let xc = at(__SPL99, 1); let yc = at(__SPL99, 2); let __SPL100 = assertIsOfSize(u, 2); let x1 = at(__SPL100, 1); let y1 = at(__SPL100, 2); let __SPL101 = assertIsOfSize(v, 2); let x4 = at(__SPL101, 1); let y4 = at(__SPL101, 2); let ax = -(x1, xc); let ay = -(y1, yc); let bx = -(x4, xc); let by = -(y4, yc); let q1 = +((*(ax, ax)), (*(ay, ay))); let q2 = +(+(q1, (*(ax, bx))), (*(ay, by))); let k2 = /(*((/(4, 3)), (-(sqrt((*(*(2, q1), q2))), q2))), (-((*(ax, by)), (*(ay, bx))))); let x2 = -(+(xc, ax), (*(k2, ay))); let y2 = +(+(yc, ay), (*(k2, ax))); let x3 = +(+(xc, bx), (*(k2, by))); let y3 = -(+(yc, by), (*(k2, bx))); BezierCurve([[x1, y1], [x2, y2], [x3, y3], [x4, y4]], 3) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c, _r, _a) {
    ...
    let __SPL102 = _assertIsOfSize_2(_a, 2);
    let _a1 = _at_2(__SPL102, 1);
    let _a2 = _at_2(__SPL102, 2);
    let _u = _fromPolarCoordinates_1([_r, _a1]);
    let _v = _fromPolarCoordinates_1([_r, _a2]);
    /* Statements */
    return _approximateCircularArc_1([_c, _u, _v]);
  }, ["c", "r", "a"]),
  "{ :c :r :a | let __SPL102 = assertIsOfSize(a, 2); let a1 = at(__SPL102, 1); let a2 = at(__SPL102, 2); let u = fromPolarCoordinates([r, a1]); let v = fromPolarCoordinates([r, a2]); approximateCircularArc([c, u, v]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _size) {
    ...
    let __SPL103 = _assertIsOfSize_2(_bezierDistanceTable_2(_self, _size), 2);
    let _muList = _at_2(__SPL103, 1);
    let _d = _at_2(__SPL103, 2);
  ...
  "{ :self :size | let __SPL103 = assertIsOfSize(bezierDistanceTable(self,size), 2); let muList = at(__SPL103, 1); let d = at(__SPL103, 2); let arcLength = last(d); collect(discretize((--(0, arcLength)),size),composeLeft(bezierFunction(self),linearInterpolator(d,muList))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let __SPL104 = _assertIsOfSize_2(_self, 4);
    let _p1 = _at_2(__SPL104, 1);
    let _p2 = _at_2(__SPL104, 2);
    let _p3 = _at_2(__SPL104, 3);
    let _p4 = _at_2(__SPL104, 4);
  ...
  "{ :self :x | let __SPL104 = assertIsOfSize(self, 4); let p1 = at(__SPL104, 1); let p2 = at(__SPL104, 2); let p3 = at(__SPL104, 3); let p4 = at(__SPL104, 4); let u = -(1, x); let x2 = *(x, x); let x3 = *(x2, x); let u2 = *(u, u); let u3 = *(u2, u); +(+(+((*(p1, u3)), (*(p2, (*(*(3, u2), x))))), (*(p3, (*(*(3, u), x2))))), (*(p4, x3))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let __SPL105 = _assertIsOfSize_2(_self, 2);
    let _p1 = _at_2(__SPL105, 1);
    let _p2 = _at_2(__SPL105, 2);
    let _u = _hyphenMinus_2(1, _x);
    /* Statements */
    return _plusSign_2(_asterisk_2(_p1, _u), _asterisk_2(_p2, _x));
  }, ["self", "x"]),
  "{ :self :x | let __SPL105 = assertIsOfSize(self, 2); let p1 = at(__SPL105, 1); let p2 = at(__SPL105, 2); let u = -(1, x); +((*(p1, u)), (*(p2, x))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let __SPL106 = _assertIsOfSize_2(_self, 3);
    let _p1 = _at_2(__SPL106, 1);
    let _p2 = _at_2(__SPL106, 2);
    let _p3 = _at_2(__SPL106, 3);
    let _x2 = _asterisk_2(_x, _x);
    let _u = _hyphenMinus_2(1, _x);
    let _u2 = _asterisk_2(_u, _u);
    /* Statements */
  ...
  "{ :self :x | let __SPL106 = assertIsOfSize(self, 3); let p1 = at(__SPL106, 1); let p2 = at(__SPL106, 2); let p3 = at(__SPL106, 3); let x2 = *(x, x); let u = -(1, x); let u2 = *(u, u); +(+((*(p1, u2)), (*(*(*(p2, 2), u), x))), (*(p3, x2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL107 = _assertIsOfSize_2(_self, 3);
    let _q1 = _at_2(__SPL107, 1);
    let _q2 = _at_2(__SPL107, 2);
    let _q3 = _at_2(__SPL107, 3);
    let _c1 = _q1;
    let _c2 = _plusSign_2(
      _q1,
  ...
  "{ :self | let __SPL107 = assertIsOfSize(self, 3); let q1 = at(__SPL107, 1); let q2 = at(__SPL107, 2); let q3 = at(__SPL107, 3); let c1 = q1; let c2 = +(q1, (*((-(q2, q1)), (/(2, 3))))); let c3 = +(q3, (*((-(q2, q3)), (/(2, 3))))); let c4 = q3; [c1, c2, c3, c4] }",
);
