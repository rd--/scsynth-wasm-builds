...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _size) {
    ...
    let __SPL95 = _assertIsOfSize_2(_bezierDistanceTable_2(_self, _size), 2);
    let _muList = _at_2(__SPL95, 1);
    let _d = _at_2(__SPL95, 2);
  ...
  "{ :self :size | let __SPL95 = assertIsOfSize(bezierDistanceTable(self,size), 2); let muList = at(__SPL95, 1); let d = at(__SPL95, 2); let arcLength = last(d); collect(discretize((--(0, arcLength)),size),composeLeft(bezierFunction(self),linearInterpolator(d,muList))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let __SPL96 = _assertIsOfSize_2(_self, 4);
    let _p1 = _at_2(__SPL96, 1);
    let _p2 = _at_2(__SPL96, 2);
    let _p3 = _at_2(__SPL96, 3);
    let _p4 = _at_2(__SPL96, 4);
  ...
  "{ :self :x | let __SPL96 = assertIsOfSize(self, 4); let p1 = at(__SPL96, 1); let p2 = at(__SPL96, 2); let p3 = at(__SPL96, 3); let p4 = at(__SPL96, 4); let u = -(1, x); let x2 = *(x, x); let x3 = *(x2, x); let u2 = *(u, u); let u3 = *(u2, u); +(+(+((*(p1, u3)), (*(p2, (*(*(3, u2), x))))), (*(p3, (*(*(3, u), x2))))), (*(p4, x3))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let __SPL97 = _assertIsOfSize_2(_self, 2);
    let _p1 = _at_2(__SPL97, 1);
    let _p2 = _at_2(__SPL97, 2);
    let _u = _hyphenMinus_2(1, _x);
    /* Statements */
    return _plusSign_2(_asterisk_2(_p1, _u), _asterisk_2(_p2, _x));
  }, ["self", "x"]),
  "{ :self :x | let __SPL97 = assertIsOfSize(self, 2); let p1 = at(__SPL97, 1); let p2 = at(__SPL97, 2); let u = -(1, x); +((*(p1, u)), (*(p2, x))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let _p1 = _at_2(__SPL98, 1);
    let _p2 = _at_2(__SPL98, 2);
    let _p3 = _at_2(__SPL98, 3);
    let _x2 = _asterisk_2(_x, _x);
    let _u = _hyphenMinus_2(1, _x);
    let _u2 = _asterisk_2(_u, _u);
    /* Statements */
  ...
  "{ :self :x | let __SPL98 = assertIsOfSize(self, 3); let p1 = at(__SPL98, 1); let p2 = at(__SPL98, 2); let p3 = at(__SPL98, 3); let x2 = *(x, x); let u = -(1, x); let u2 = *(u, u); +(+((*(p1, u2)), (*(*(*(p2, 2), u), x))), (*(p3, x2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL99 = _assertIsOfSize_2(_self, 3);
    let _q1 = _at_2(__SPL99, 1);
    let _q2 = _at_2(__SPL99, 2);
    let _q3 = _at_2(__SPL99, 3);
    let _c1 = _q1;
    let _c2 = _plusSign_2(
      _q1,
  ...
  "{ :self | let __SPL99 = assertIsOfSize(self, 3); let q1 = at(__SPL99, 1); let q2 = at(__SPL99, 2); let q3 = at(__SPL99, 3); let c1 = q1; let c2 = +(q1, (*((-(q2, q1)), (/(2, 3))))); let c3 = +(q3, (*((-(q2, q3)), (/(2, 3))))); let c4 = q3; [c1, c2, c3, c4] }",
);
