...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _size) {
    ...
    let __SPL8 = _assertIsOfSize_2(_bezierDistanceTable_2(_self, _size), 2);
    let _muList = _at_2(__SPL8, 1);
    let _d = _at_2(__SPL8, 2);
  ...
  "{ :self :size | let __SPL8 = assertIsOfSize(bezierDistanceTable(self,size), 2); let muList = at(__SPL8, 1); let d = at(__SPL8, 2); let arcLength = last(d); collect(discretize((--(0, arcLength)),size),composeLeft(bezierFunction(self),linearInterpolator(d,muList))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :x | let __SPL9 = assertIsOfSize(self, 4); let p1 = at(__SPL9, 1); let p2 = at(__SPL9, 2); let p3 = at(__SPL9, 3); let p4 = at(__SPL9, 4); let u = -(1, x); let x2 = *(x, x); let x3 = *(x2, x); let u2 = *(u, u); let u3 = *(u2, u); +(+(+((*(p1, u3)), (*(p2, (*(*(3, u2), x))))), (*(p3, (*(*(3, u), x2))))), (*(p4, x3))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :x | let __SPL10 = assertIsOfSize(self, 2); let p1 = at(__SPL10, 1); let p2 = at(__SPL10, 2); let u = -(1, x); +((*(p1, u)), (*(p2, x))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :x | let __SPL11 = assertIsOfSize(self, 3); let p1 = at(__SPL11, 1); let p2 = at(__SPL11, 2); let p3 = at(__SPL11, 3); let x2 = *(x, x); let u = -(1, x); let u2 = *(u, u); +(+((*(p1, u2)), (*(*(*(p2, 2), u), x))), (*(p3, x2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL12 = assertIsOfSize(self, 3); let q1 = at(__SPL12, 1); let q2 = at(__SPL12, 2); let q3 = at(__SPL12, 3); let c1 = q1; let c2 = +(q1, (*((-(q2, q1)), (/(2, 3))))); let c3 = +(q3, (*((-(q2, q3)), (/(2, 3))))); let c4 = q3; [c1, c2, c3, c4] }",
);
