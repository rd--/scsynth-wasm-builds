sl.addType(
  ...
  "BezierCurve",
  "BezierCurve",
  ["Object", "Equatable", "Cache", "Geometry"],
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _svgFragment_2(_Line_1(_controlPoints_1(_self)), _options);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _u = _at_2(__SplVar1, 2);
    let _v = _at_2(__SplVar1, 3);
    let __SplVar2 = _assertIsOfSize_2(_c, 2);
    let _xc = _at_2(__SplVar2, 1);
    let _yc = _at_2(__SplVar2, 2);
    let __SplVar3 = _assertIsOfSize_2(_u, 2);
    let _x1 = _at_2(__SplVar3, 1);
    let _y1 = _at_2(__SplVar3, 2);
    let __SplVar4 = _assertIsOfSize_2(_v, 2);
    let _x4 = _at_2(__SplVar4, 1);
    let _y4 = _at_2(__SplVar4, 2);
    let _ax = _hyphenMinus_2(_x1, _xc);
    let _ay = _hyphenMinus_2(_y1, _yc);
    let _bx = _hyphenMinus_2(_x4, _xc);
    let _by = _hyphenMinus_2(_y4, _yc);
    let _q1 = _plusSign_2(_asterisk_2(_ax, _ax), _asterisk_2(_ay, _ay));
    let _q2 = _plusSign_2(
      _plusSign_2(_q1, _asterisk_2(_ax, _bx)),
      _asterisk_2(_ay, _by),
    );
    let _k2 = _solidus_2(
      _asterisk_2(
        _solidus_2(4, 3),
        _hyphenMinus_2(_sqrt_1(_asterisk_2(_asterisk_2(2, _q1), _q2)), _q2),
      ),
      _hyphenMinus_2(_asterisk_2(_ax, _by), _asterisk_2(_ay, _bx)),
    );
    let _x2 = _hyphenMinus_2(_plusSign_2(_xc, _ax), _asterisk_2(_k2, _ay));
    let _y2 = _plusSign_2(_plusSign_2(_yc, _ay), _asterisk_2(_k2, _ax));
    let _x3 = _plusSign_2(_plusSign_2(_xc, _bx), _asterisk_2(_k2, _by));
    let _y3 = _hyphenMinus_2(_plusSign_2(_yc, _by), _asterisk_2(_k2, _bx));
    /* Statements */
    return _BezierCurve_2([[_x1, _y1], [_x2, _y2], [_x3, _y3], [_x4, _y4]], 3);
  }, ["self"]),
  "{ :self | let __SplVar1 = assertIsOfSize(self, 3); let c = at(__SplVar1, 1); let u = at(__SplVar1, 2); let v = at(__SplVar1, 3); let __SplVar2 = assertIsOfSize(c, 2); let xc = at(__SplVar2, 1); let yc = at(__SplVar2, 2); let __SplVar3 = assertIsOfSize(u, 2); let x1 = at(__SplVar3, 1); let y1 = at(__SplVar3, 2); let __SplVar4 = assertIsOfSize(v, 2); let x4 = at(__SplVar4, 1); let y4 = at(__SplVar4, 2); let ax = -(x1, xc); let ay = -(y1, yc); let bx = -(x4, xc); let by = -(y4, yc); let q1 = +((*(ax, ax)), (*(ay, ay))); let q2 = +(+(q1, (*(ax, bx))), (*(ay, by))); let k2 = /(*((/(4, 3)), (-(sqrt((*(*(2, q1), q2))), q2))), (-((*(ax, by)), (*(ay, bx))))); let x2 = -(+(xc, ax), (*(k2, ay))); let y2 = +(+(yc, ay), (*(k2, ax))); let x3 = +(+(xc, bx), (*(k2, by))); let y3 = -(+(yc, by), (*(k2, bx))); BezierCurve([[x1, y1], [x2, y2], [x3, y3], [x4, y4]], 3) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "approximateCircularArc",
  ["c", "r", "a"],
  sl.annotateFunction(function (_c, _r, _a) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _c, _r, _a";
      throw new Error(errorMessage);
    } /* Temporaries */
    let __SplVar5 = _assertIsOfSize_2(_a, 2);
    let _a1 = _at_2(__SplVar5, 1);
    let _a2 = _at_2(__SplVar5, 2);
    let _u = _fromPolarCoordinates_1([_r, _a1]);
    let _v = _fromPolarCoordinates_1([_r, _a2]);
    /* Statements */
    return _approximateCircularArc_1([_c, _u, _v]);
  }, ["c", "r", "a"]),
  "{ :c :r :a | let __SplVar5 = assertIsOfSize(a, 2); let a1 = at(__SplVar5, 1); let a2 = at(__SplVar5, 2); let u = fromPolarCoordinates([r, a1]); let v = fromPolarCoordinates([r, a2]); approximateCircularArc([c, u, v]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :x | let left = []; let right = []; let deCasteljaus = { :p :t | if((=(size(p), 1)), { addLast(left,at(p, 1)); addFirst(right,at(p, 1)) }, { let k = -(size(p), 1); deCasteljaus(collect(upOrDownTo(1, k), { :i | ifTrue((=(i, 1)), { addLast(left,at(p, i)) }); ifTrue((=(i, k)), { addFirst(right,at(p, +(i, 1))) }); +((*((-(1, t)), at(p, i))), (*(t, at(p, +(i, 1))))) }),t) }) }; deCasteljaus(self, x); [left, right] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _size) {
    ...
    let __SplVar6 = _assertIsOfSize_2(_bezierDistanceTable_2(_self, _size), 2);
    let _muList = _at_2(__SplVar6, 1);
  ...
  "{ :self :size | let __SplVar6 = assertIsOfSize(bezierDistanceTable(self,size), 2); let muList = at(__SplVar6, 1); let d = at(__SplVar6, 2); let arcLength = last(d); collect(discretize((--(0, arcLength)),size),composeLeft(bezierFunction(self),linearInterpolator(d,muList))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let __SplVar7 = _assertIsOfSize_2(_self, 4);
    let _p1 = _at_2(__SplVar7, 1);
    let _p2 = _at_2(__SplVar7, 2);
    let _p3 = _at_2(__SplVar7, 3);
    let _p4 = _at_2(__SplVar7, 4);
  ...
  "{ :self :x | let __SplVar7 = assertIsOfSize(self, 4); let p1 = at(__SplVar7, 1); let p2 = at(__SplVar7, 2); let p3 = at(__SplVar7, 3); let p4 = at(__SplVar7, 4); let u = -(1, x); let x2 = *(x, x); let x3 = *(x2, x); let u2 = *(u, u); let u3 = *(u2, u); +(+(+((*(p1, u3)), (*(p2, (*(*(3, u2), x))))), (*(p3, (*(*(3, u), x2))))), (*(p4, x3))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let _p1 = _at_2(__SplVar8, 1);
    let _p2 = _at_2(__SplVar8, 2);
    let _u = _hyphenMinus_2(1, _x);
    /* Statements */
    return _plusSign_2(_asterisk_2(_p1, _u), _asterisk_2(_p2, _x));
  }, ["self", "x"]),
  "{ :self :x | let __SplVar8 = assertIsOfSize(self, 2); let p1 = at(__SplVar8, 1); let p2 = at(__SplVar8, 2); let u = -(1, x); +((*(p1, u)), (*(p2, x))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let _p1 = _at_2(__SplVar9, 1);
    let _p2 = _at_2(__SplVar9, 2);
    let _p3 = _at_2(__SplVar9, 3);
    let _x2 = _asterisk_2(_x, _x);
    let _u = _hyphenMinus_2(1, _x);
    let _u2 = _asterisk_2(_u, _u);
    /* Statements */
  ...
  "{ :self :x | let __SplVar9 = assertIsOfSize(self, 3); let p1 = at(__SplVar9, 1); let p2 = at(__SplVar9, 2); let p3 = at(__SplVar9, 3); let x2 = *(x, x); let u = -(1, x); let u2 = *(u, u); +(+((*(p1, u2)), (*(*(*(p2, 2), u), x))), (*(p3, x2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _q1 = _at_2(__SplVar10, 1);
    let _q2 = _at_2(__SplVar10, 2);
    let _q3 = _at_2(__SplVar10, 3);
    let _c1 = _q1;
    let _c2 = _plusSign_2(
      _q1,
  ...
  "{ :self | let __SplVar10 = assertIsOfSize(self, 3); let q1 = at(__SplVar10, 1); let q2 = at(__SplVar10, 2); let q3 = at(__SplVar10, 3); let c1 = q1; let c2 = +(q1, (*((-(q2, q1)), (/(2, 3))))); let c3 = +(q3, (*((-(q2, q3)), (/(2, 3))))); let c4 = q3; [c1, c2, c3, c4] }",
);
