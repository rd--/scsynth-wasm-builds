...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL1 = _assertIsOfSize_2(_self, 3);
    let _c = _at_2(__SPL1, 1);
    let _u = _at_2(__SPL1, 2);
    let _v = _at_2(__SPL1, 3);
    let __SPL2 = _assertIsOfSize_2(_c, 2);
    let _xc = _at_2(__SPL2, 1);
    let _yc = _at_2(__SPL2, 2);
    let __SPL3 = _assertIsOfSize_2(_u, 2);
    let _x1 = _at_2(__SPL3, 1);
    let _y1 = _at_2(__SPL3, 2);
    let __SPL4 = _assertIsOfSize_2(_v, 2);
    let _x4 = _at_2(__SPL4, 1);
    let _y4 = _at_2(__SPL4, 2);
  ...
  "{ :self | let __SPL1 = assertIsOfSize(self, 3); let c = at(__SPL1, 1); let u = at(__SPL1, 2); let v = at(__SPL1, 3); let __SPL2 = assertIsOfSize(c, 2); let xc = at(__SPL2, 1); let yc = at(__SPL2, 2); let __SPL3 = assertIsOfSize(u, 2); let x1 = at(__SPL3, 1); let y1 = at(__SPL3, 2); let __SPL4 = assertIsOfSize(v, 2); let x4 = at(__SPL4, 1); let y4 = at(__SPL4, 2); let ax = -(x1, xc); let ay = -(y1, yc); let bx = -(x4, xc); let by = -(y4, yc); let q1 = +((*(ax, ax)), (*(ay, ay))); let q2 = +(+(q1, (*(ax, bx))), (*(ay, by))); let k2 = /(*((/(4, 3)), (-(sqrt((*(*(2, q1), q2))), q2))), (-((*(ax, by)), (*(ay, bx))))); let x2 = -(+(xc, ax), (*(k2, ay))); let y2 = +(+(yc, ay), (*(k2, ax))); let x3 = +(+(xc, bx), (*(k2, by))); let y3 = -(+(yc, by), (*(k2, bx))); BezierCurve([[x1, y1], [x2, y2], [x3, y3], [x4, y4]], 3) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c, _r, _a) {
    ...
    let __SPL5 = _assertIsOfSize_2(_a, 2);
    let _a1 = _at_2(__SPL5, 1);
    let _a2 = _at_2(__SPL5, 2);
    let _u = _fromPolarCoordinates_1([_r, _a1]);
    let _v = _fromPolarCoordinates_1([_r, _a2]);
    /* Statements */
    return _approximateCircularArc_1([_c, _u, _v]);
  }, ["c", "r", "a"]),
  "{ :c :r :a | let __SPL5 = assertIsOfSize(a, 2); let a1 = at(__SPL5, 1); let a2 = at(__SPL5, 2); let u = fromPolarCoordinates([r, a1]); let v = fromPolarCoordinates([r, a2]); approximateCircularArc([c, u, v]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _size) {
    ...
    let __SPL6 = _assertIsOfSize_2(_bezierDistanceTable_2(_self, _size), 2);
    let _muList = _at_2(__SPL6, 1);
    let _d = _at_2(__SPL6, 2);
  ...
  "{ :self :size | let __SPL6 = assertIsOfSize(bezierDistanceTable(self,size), 2); let muList = at(__SPL6, 1); let d = at(__SPL6, 2); let arcLength = last(d); collect(discretize((--(0, arcLength)),size),composeLeft(bezierFunction(self),linearInterpolator(d,muList))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let __SPL7 = _assertIsOfSize_2(_self, 4);
    let _p1 = _at_2(__SPL7, 1);
    let _p2 = _at_2(__SPL7, 2);
    let _p3 = _at_2(__SPL7, 3);
    let _p4 = _at_2(__SPL7, 4);
  ...
  "{ :self :x | let __SPL7 = assertIsOfSize(self, 4); let p1 = at(__SPL7, 1); let p2 = at(__SPL7, 2); let p3 = at(__SPL7, 3); let p4 = at(__SPL7, 4); let u = -(1, x); let x2 = *(x, x); let x3 = *(x2, x); let u2 = *(u, u); let u3 = *(u2, u); +(+(+((*(p1, u3)), (*(p2, (*(*(3, u2), x))))), (*(p3, (*(*(3, u), x2))))), (*(p4, x3))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let _p1 = _at_2(__SPL8, 1);
    let _p2 = _at_2(__SPL8, 2);
    let _u = _hyphenMinus_2(1, _x);
    /* Statements */
    return _plusSign_2(_asterisk_2(_p1, _u), _asterisk_2(_p2, _x));
  }, ["self", "x"]),
  "{ :self :x | let __SPL8 = assertIsOfSize(self, 2); let p1 = at(__SPL8, 1); let p2 = at(__SPL8, 2); let u = -(1, x); +((*(p1, u)), (*(p2, x))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _x) {
    ...
    let _p1 = _at_2(__SPL9, 1);
    let _p2 = _at_2(__SPL9, 2);
    let _p3 = _at_2(__SPL9, 3);
    let _x2 = _asterisk_2(_x, _x);
    let _u = _hyphenMinus_2(1, _x);
    let _u2 = _asterisk_2(_u, _u);
    /* Statements */
  ...
  "{ :self :x | let __SPL9 = assertIsOfSize(self, 3); let p1 = at(__SPL9, 1); let p2 = at(__SPL9, 2); let p3 = at(__SPL9, 3); let x2 = *(x, x); let u = -(1, x); let u2 = *(u, u); +(+((*(p1, u2)), (*(*(*(p2, 2), u), x))), (*(p3, x2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL10 = assertIsOfSize(self, 3); let q1 = at(__SPL10, 1); let q2 = at(__SPL10, 2); let q3 = at(__SPL10, 3); let c1 = q1; let c2 = +(q1, (*((-(q2, q1)), (/(2, 3))))); let c3 = +(q3, (*((-(q2, q3)), (/(2, 3))))); let c4 = q3; [c1, c2, c3, c4] }",
);
