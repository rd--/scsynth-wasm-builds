...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _cached_3(_self, "approximation", function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
      } /* Statements */
      return _concatenation_1(_componentApproximationList_1(_self));
    });
  },
  "{ :self | cached(self, 'approximation', { concatenation(componentApproximationList(self)) }) }",
);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _cached_3(_self, "arcLength", function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _cached_3(_self, "componentArcLengthList", function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _cached_3(_self, "componentApproximationList", function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
      ...
      /* Statements */
      return _collect_2(_componentCoordinatesList_1(_self), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _cached_3(_self, "componentCoordinatesList", function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _cached_3(_self, "componentDerivativesList", function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _cached_3(_self, "componentDistanceList", function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
      } /* Statements */
      return _collect_2(_componentApproximationList_1(_self), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
          throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _cached_3(_self, "distance", function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
      ...
      let _sum = 0;
      /* Statements */
      _collect_2(_componentDistanceList_1(_self), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
          throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | caseOfOtherwise(size(self), [->({ 2 }, { { :x | linearBezierFunctionAt(self,x) } }), ->({ 3 }, { { :x | quadraticBezierFunctionAt(self,x) } }), ->({ 4 }, { { :x | cubicBezierFunctionAt(self,x) } })], { { :x | deCasteljausAlgorithm(self,x) } }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _x) {
    ...
    _whileTrue_2(function () {
      ...
      /* Statements */
      _toDo_3(1, _hyphenMinus_2(_size_1(_p), 1), function (_j) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _j";
          throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :x | let left = []; let right = []; let deCasteljaus = { :p :t | if((=(size(p), 1)), { addLast(left,at(p, 1)); addFirst(right,at(p, 1)) }, { let k = -(size(p), 1); deCasteljaus(collect(upOrDownTo(1, k), { :i | ifTrue((=(i, 1)), { addLast(left,at(p, i)) }); ifTrue((=(i, k)), { addFirst(right,at(p, +(i, 1))) }); +((*((-(1, t)), at(p, i))), (*(t, at(p, +(i, 1))))) }),t) }) }; deCasteljaus(self, x); asTuple([left, right]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _size) {
    ...
    let __SPL53 = _assertIsOfSize_2(_bezierDistanceTable_2(_self, _size), 2);
    let _muList = _at_2(__SPL53, 1);
    let _d = _at_2(__SPL53, 2);
  ...
  "{ :self :size | let __SPL53 = assertIsOfSize(bezierDistanceTable(self,size), 2); let muList = at(__SPL53, 1); let d = at(__SPL53, 2); let arcLength = last(d); collect(discretize((--(0, arcLength)),size),composeLeft(bezierFunction(self),linearInterpolator(d,muList))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _x) {
    ...
    let __SPL54 = _assertIsOfSize_2(_self, 4);
    let _p1 = _at_2(__SPL54, 1);
    let _p2 = _at_2(__SPL54, 2);
    let _p3 = _at_2(__SPL54, 3);
    let _p4 = _at_2(__SPL54, 4);
  ...
  "{ :self :x | let __SPL54 = assertIsOfSize(self, 4); let p1 = at(__SPL54, 1); let p2 = at(__SPL54, 2); let p3 = at(__SPL54, 3); let p4 = at(__SPL54, 4); let u = -(1, x); let x2 = *(x, x); let x3 = *(x2, x); let u2 = *(u, u); let u3 = *(u2, u); +(+(+((*(p1, u3)), (*(p2, (*(*(3, u2), x))))), (*(p3, (*(*(3, u), x2))))), (*(p4, x3))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _x) {
    ...
    let __SPL55 = _assertIsOfSize_2(_self, 2);
    let _p1 = _at_2(__SPL55, 1);
    let _p2 = _at_2(__SPL55, 2);
    let _u = _hyphenMinus_2(1, _x);
    /* Statements */
    return _plusSign_2(_asterisk_2(_p1, _u), _asterisk_2(_p2, _x));
  },
  "{ :self :x | let __SPL55 = assertIsOfSize(self, 2); let p1 = at(__SPL55, 1); let p2 = at(__SPL55, 2); let u = -(1, x); +((*(p1, u)), (*(p2, x))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _x) {
    ...
    let __SPL56 = _assertIsOfSize_2(_self, 3);
    let _p1 = _at_2(__SPL56, 1);
    let _p2 = _at_2(__SPL56, 2);
    let _p3 = _at_2(__SPL56, 3);
    let _x2 = _asterisk_2(_x, _x);
    let _u = _hyphenMinus_2(1, _x);
    let _u2 = _asterisk_2(_u, _u);
    /* Statements */
  ...
  "{ :self :x | let __SPL56 = assertIsOfSize(self, 3); let p1 = at(__SPL56, 1); let p2 = at(__SPL56, 2); let p3 = at(__SPL56, 3); let x2 = *(x, x); let u = -(1, x); let u2 = *(u, u); +(+((*(p1, u2)), (*(*(*(p2, 2), u), x))), (*(p3, x2))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL57 = _assertIsOfSize_2(_self, 3);
    let _q1 = _at_2(__SPL57, 1);
    let _q2 = _at_2(__SPL57, 2);
    let _q3 = _at_2(__SPL57, 3);
    let _c1 = _q1;
    let _c2 = _plusSign_2(
      _q1,
  ...
  "{ :self | let __SPL57 = assertIsOfSize(self, 3); let q1 = at(__SPL57, 1); let q2 = at(__SPL57, 2); let q3 = at(__SPL57, 3); let c1 = q1; let c2 = +(q1, (*((-(q2, q1)), (/(2, 3))))); let c3 = +(q3, (*((-(q2, q3)), (/(2, 3))))); let c4 = q3; [c1, c2, c3, c4] }",
);
