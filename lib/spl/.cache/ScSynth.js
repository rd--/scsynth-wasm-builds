...
sl.addMethod(
  ...
  function (_self, _address, _onMessage) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _address, _onMessage"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _oscPacket) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _oscPacket"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _address) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _address"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _aUgen) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aUgen"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(
...
sl.addMethod(
  ...
  function (_self, _systemTimeInSeconds) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _systemTimeInSeconds"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_aUgen) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _aUgen"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
    return sc.kr(_aUgen);
...
sl.addMethod(
  ...
  function (_self, _duration) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _duration"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _scSynDefName, _scSynDefFileName) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _scSynDefName, _scSynDefFileName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _numberOfChannels, _channelIndices) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _numberOfChannels, _channelIndices"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _numberOfChannels, _channelIndex) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _numberOfChannels, _channelIndex"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
