...
sl.addMethod(
  ...
  function (_self, _oscPacket) {
    ...
    /* Primitive */
    return _self.sendOsc(_oscPacket);
  },
...
sl.addMethod(
  ...
  function (_self, _index, _value) {
    ...
    return _sendOsc_2(
      _self,
      Object.fromEntries([["address", "/c_set"], ["args", [
        Object.fromEntries([["type", "i"], ["value", _index]]),
        Object.fromEntries([["type", "f"], ["value", _value]]),
      ]]]),
    );
  },
  "{ :self :index :value |\n\t\tself.sendOsc(\n\t\t\t(\n\t\t\t\taddress: '/c_set',\n\t\t\t\targs: [\n\t\t\t\t\t(type: 'i', value: index),\n\t\t\t\t\t(type: 'f', value: value)\n\t\t\t\t]\n\t\t\t)\n\t\t)\n\t}",
...
sl.addMethod(
  ...
  function (_self, _aUgen) {
    ...
    /* Statements */
    return _if_3(
      _and_2(_isUgen_1(_aUgen), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _equals_2(_numChannels_1(_scUgen_1(_aUgen)), 0);
      }),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_tildeEquals_2(_rank_1(_self), 2), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _error_1("asLocalBufferArray: not a matrix");
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Statements */
    return _Splay_1(_bang_2(_self, _anInteger));
  },
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Statements */
    return _Mix_1(_bang_2(_self, _anInteger));
  },
  "{ :self :anInteger |\n\t\tMix(self ! anInteger)\n\t}",
);
