...
sl.addMethod(
  ...
  function (_self, _open, _close) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _open, _close"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _asSet_1(_contents_1(_self));
  },
  "{ :self |\n\t\tself.contents.asSet\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _indices) {
    ...
    /* Statements */
    return _join_2(_atAll_2(_contents_1(_self), _indices), "");
  },
...
sl.addMethod(
  ...
  function (_self, _stringToFind, _stringToReplaceWith) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _stringToFind, _stringToReplaceWith"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _codePoint) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _codePoint"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_isCharacter_1(_self), function () {
...
sl.addMethod(
  ...
  function (_self, _aBlock_1, _aCollection) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aBlock_1, _aCollection"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _smallSize) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _smallSize"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Statements */
    return _join_2(_deBruijnSequence_2(_contents_1(_self), _anInteger), "");
  },
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _editDistance_2(_contents_1(_self), _contents_1(_aString));
  },
...
sl.addMethod(
  ...
  function (_self, _subString, _start) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _subString, _start"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _aString, _anInteger) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aString, _anInteger"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _open, _close, _aBlock_0) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _open, _close, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _arguments) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _arguments"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _hammingDistance_2(_contents_1(_self), _contents_1(_aString));
  },
...
sl.addMethod(
  ...
  function (_self, _aCharacter) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aCharacter"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _join_2(_longestIncreasingSubsequence_1(_contents_1(_self)), "");
  },
...
sl.addMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    /* Statements */
    return _join_2(_aBlock_1(_asList_1(_self)), "");
  },
...
sl.addMethod(
  ...
  function (_self, _anInteger, _aString) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _anInteger, _aString"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _aString, _count) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aString, _count"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
