...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _joinCharacters_1(_select_2(_characters_1(_self), _isAscii_1));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _join_1(_longestAscendingSequence_1(_asList_1(_self)));
  },
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _join_1(
      _longestCommonSequence_2(_asList_1(_self), _asList_1(_aString)),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _collect_2(
      _longestCommonSubsequenceList_2(_asList_1(_self), _asList_1(_aString)),
      _join_1,
    );
  },
