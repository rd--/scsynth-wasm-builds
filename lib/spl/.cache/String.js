...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    return _uncheckedConcatenation_2(_self, _asString_1(_anObject));
  }, ["self", "anObject"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _if_3(
      _greaterThanSignEqualsSign_2(_abs_1(_anInteger), _size_1(_self)),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addMethodToExistingType(
  ...
  "repeat",
  ["self", "n", "m"],
  sl.annotateFunction(function (_self, _n, _m) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _n, _m";
      throw new Error(errorMessage);
    } /* Statements */
    return _stringRepeat_3(_self, _n, _m);
  }, ["self", "n", "m"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _rotateLeft_2(_self, _negate_1(_anInteger));
  }, ["self", "anInteger"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _encoding) {
    ...
    return _fromCharacterCode_2(
      _sort_1(_toCharacterCode_2(_self, _encoding)),
      _encoding,
    );
  }, ["self", "encoding"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _stringJoin_1(_sort_1(_characters_1(_self)));
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _fromCodePoints_1(_sort_1(_codePoints_1(_self)));
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  "stringInsert",
  ["s1", "s2", "n"],
  sl.annotateFunction(function (_s1, _s2, _n) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _s1, _s2, _n";
      throw new Error(errorMessage);
    } /* Statements */
    _ifTrue_2(
      _isNegative_1(_n),
      sl.annotateFunction(function () {
        ...
        return _n = _plusSign_2(_plusSign_2(_size_1(_s1), _n), 2);
      }, []),
    );
    return _stringJoin_1([
      _take_2(_s1, _hyphenMinus_2(_n, 1)),
      _s2,
      _drop_2(_s1, _hyphenMinus_2(_n, 1)),
    ]);
  }, ["s1", "s2", "n"]),
  "{ :s1 :s2 :n |\n\t\tn.isNegative.ifTrue {\n\t\t\tn := s1.size + n + 2\n\t\t};\n\t\t[s1.take(n - 1), s2, s1.drop(n - 1)].stringJoin\n\t}",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_s, _n) {
    ...
    return _stringJoin_1(_numberSign_2(_n, [_s]));
  }, ["s", "n"]),
  "{ :s :n |\n\t\t(n # [s]).stringJoin\n\t}",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _plusSignPlusSign_2(_self, _uniqueIdentifier_1(_system));
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _stringIntercalate_2(_collect_2(_self, _asString_1), ", ");
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _stringJoin_1(_collect_2(_self, _fromCodePoint_1));
  }, ["self"]),
    ...
    return _stringJoin_1(
      _collect_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          return _plusSignPlusSign_2(_each, "\n");
        }, ["each"]),
      ),
    );
  }, ["self"]),
