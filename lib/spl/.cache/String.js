...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :delimiters | let __SplVar1 = assertIsOfSize(delimiters, 2); let p = at(__SplVar1, 1); let q = at(__SplVar1, 2); let c = ++(++([p], characters(self)), [q]); stringJoin(burrowsWheelerTransform(c)) }",
);
