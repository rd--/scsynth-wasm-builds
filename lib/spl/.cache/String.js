...
sl.addType(
  ...
  "String",
  "String",
  ["Object", "Json", "Iterable", "Indexable", "Character"],
  [],
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _sort_3(
      _associations_1(_asIdentityBag_1(_characters_1(_self))),
      _greaterThanSignEqualsSign_2,
      _value_1,
    );
  }, ["self"]),
  "{ :self | sort(associations(asIdentityBag(characters(self))),>=, value:/1) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :n | sort(associations(asIdentityBag(collect(partition(characters(self),n, 1),stringJoin:/1))),>=, value:/1) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _sort_3(
      _associations_1(
        _asIdentityBag_1(_select_2(_characters_1(_self), _isLetter_1)),
      ),
      _greaterThanSignEqualsSign_2,
      _value_1,
    );
  }, ["self"]),
  "{ :self | sort(associations(asIdentityBag(select(characters(self),isLetter:/1))),>=, value:/1) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :n | sort(associations(asIdentityBag(collect(partition(select(characters(self),isLetter:/1),n, 1),stringJoin:/1))),>=, value:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _delimiters) {
    ...
    let __SPL85 = _assertIsOfSize_2(_delimiters, 2);
    let _p = _at_2(__SPL85, 1);
    let _q = _at_2(__SPL85, 2);
  ...
  "{ :self :delimiters | let __SPL85 = assertIsOfSize(delimiters, 2); let p = at(__SPL85, 1); let q = at(__SPL85, 2); let c = ++(++([p], characters(self)), [q]); stringJoin(burrowsWheelerTransform(c)) }",
);
