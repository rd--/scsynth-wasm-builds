...
sl.addMethodToExistingType(
  ...
  "{ :self :anObject | if(isCharacter(self), { &(isCharacter(anObject), { ==(codePoint(self), codePoint(anObject)) }) }, { ==(self, anObject) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anObject | uncheckedAppendString(self,asString(anObject)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | <(codePoint(self), codePoint(operand)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | caseOf(self, [->('english', { ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'] }), ->('greek', { ['α', 'β', 'γ', 'δ', 'ε', 'ζ', 'η', 'θ', 'ι', 'κ', 'λ', 'μ', 'ν', 'ξ', 'ο', 'π', 'ρ', 'σ', 'τ', 'υ', 'φ', 'χ', 'ψ', 'ω'] })], { error(self,'String>>alphabet: unknown alphabet') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | base16Encode(asciiByteArray(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | IdentitySet(characters(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :index :ifAbsent:/0 | if(includesIndex(self,index), { let codePoint = codePointAt(self,index); ifNil(codePoint, { ifAbsent() }, { if(isUtf16SurrogateCodePoint(codePoint), { error(self,'String>>at: code point is lone surrogate') }, { fromCodePoint(codePoint) }) }) }, { ifAbsent() }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | sort(associations(asIdentityMultiset(characters(self))),|>=, value:/1) }",
);
...
sl.addMethodToExistingType(
    ...
    return _sort_3(
      _associations_1(
        _asIdentityMultiset_1(
          _collect_2(_partition_3(_characters_1(_self), _n, 1), _stringJoin_1),
        ),
      ),
      _verticalLineGreaterThanSignEqualsSign_2,
      _value_1,
  ...
  "{ :self :n | sort(associations(asIdentityMultiset(collect(partition(characters(self),n, 1),stringJoin:/1))),|>=, value:/1) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    /* Statements */
    return _error_2(_self, "String>>compare: non string operand");
  }, ["self", "operand"]),
  "{ :self :operand | <primitive: if(typeof _operand == 'string') {\n\t\t\tconst n = _self.localeCompare(_operand);\n\t\t\tif(n < 0) {\n\t\t\t\treturn -1;\n\t\t\t} else if(n == 0) {\n\t\t\t\treturn 0;\n\t\t\t} else {\n\t\t\t\treturn 1;\n\t\t\t}\n\t\t};>\nerror(self,'String>>compare: non string operand') }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :start :end | ifFalse(includesIndex(self,start), { error(self,'copyFromTo: invalid start index') }); ifFalse(includesIndex(self,end), { error(self,'copyFromTo: invalid end index') }); if((>(start, end)), { '' }, { uncheckedCopyFromTo(self,start, end) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | <primitive: return _self[0].toLowerCase() + _self.slice(1);>\n }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | stringJoin(difference(characters(self),characters(operand))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anInteger | copyFromTo(self,1, -(+(1, anInteger), 1)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | if((=(self, 'N')), { 0 }, { let value = 0; let v1 = 0; let v2 = 0; let letters = asciiByteArray('IVXLCDM'); reverseDo(asciiByteArray(self), { :each | v1 := at([1, 5, 10, 50, 100, 500, 1000],indexOf(letters,each)); if((>=(v1, v2)), { value := +(value, v1) }, { value := -(value, v1) }); v2 := v1 }); value }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | includes(['Nil', 'Boolean', 'Block', 'SmallFloat', 'LargeInteger', 'String'],self) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _isPalindrome_1(_contents_1(_self));
  }, ["self"]),
  "{ :self | isPalindrome(contents(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | <primitive: return /\\p{Punctuation}/u.test(_self);>\n }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | sort(associations(asIdentityMultiset(select(characters(self),isLetter:/1))),|>=, value:/1) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :n | sort(associations(asIdentityMultiset(collect(partition(select(characters(self),isLetter:/1),n, 1),stringJoin:/1))),|>=, value:/1) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :elseClause | <primitive: let answer = null;\n\t\ttry {\n\t\t\tanswer = JSON.parse(_self);\n\t\t} catch (_unused) {\n\t\t\treturn _elseClause();\n\t\t};\n\t\treturn answer;>\n }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :n :d | let k = size(self); let p = []; let i = 1; let j = n; whileTrue({ <=(j, k) }, { add(p,copyFromTo(self,i, j)); i := +(i, d); j := +(j, d) }); p }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | <primitive: return _self.replace(/\\p{Punctuation}/gu, '');>\n }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _n) {
    ...
    return _stringCatenate_1(_numberSign_2(_self, _n));
  }, ["self", "n"]),
  "{ :self :n | stringCatenate((#(self, n))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :stringToFind :stringToReplaceWith | assertIsString(stringToFind); assertIsString(stringToReplaceWith); uncheckedReplaceString(self,stringToFind, stringToReplaceWith) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :stringToFind :stringToReplaceWith | assertIsString(stringToFind); assertIsString(stringToReplaceWith); uncheckedReplaceStringAll(self,stringToFind, stringToReplaceWith) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | onCharacters(self,reverse:/1) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anInteger | let k = size(self); let n = %(anInteger, k); if((=(n, 0)), { self }, { ++(allButFirst(self,n), first(self,n)) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :index | fromCodePoint(codePointAt(self,index)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | ++([first(self)], collect(allButFirst(self),capitalize:/1)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | collect(self,capitalize:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | collect(self,decapitalize:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let stopWords = englishStopWords(system); reject(self, { :each | includes(stopWords,asLowerCase(each)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aString | if((&&(allSatisfy(self,isString:/1), isString(aString))), { uncheckedStringIntercalate(self,aString) }, { error(self,'List>>stringIntercalate: non-string arguments') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aString | uncheckedStringIntercalate(collect(flatten(self),asString:/1),asString(aString)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | collect(self,stringLength:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | lexicographicSort(collect(upOrDownTo(1, size(self)), { :each | rotateLeft(self,each) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | collect(burrowsWheelerMatrix(self),last:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :eot | let k = size(self); let table = List(k, List()); timesRepeat(k, { do(upOrDownTo(1, k), { :i | atPut(table, i, ++([at(self, i)], at(table, i))) }); lexicographicSort(table) }); copyFromTo(detect(table, { :each | =(last(each), eot) }),2, -(k, 1)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _delimiters) {
    ...
    let __SPL1 = _assertIsOfSize_2(_delimiters, 2);
    let _p = _at_2(__SPL1, 1);
    let _q = _at_2(__SPL1, 2);
  ...
  "{ :self :delimiters | let __SPL1 = assertIsOfSize(delimiters, 2); let p = at(__SPL1, 1); let q = at(__SPL1, 2); let c = ++(++([p], characters(self)), [q]); stringJoin(burrowsWheelerTransform(c)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :eot | stringJoin(inverseBurrowWheelerTransform(characters(self),eot)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | collect(self,porterStemmer:/1) }",
);
