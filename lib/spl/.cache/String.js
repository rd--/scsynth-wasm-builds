...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _equals_2(_lessThanEqualsGreaterThan_2(_self, _aString), -1);
  },
  "{ :self :aString |\n\t\tself <=> aString = -1\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _lessThanEquals_2(_lessThanEqualsGreaterThan_2(_self, _aString), 0);
  },
  "{ :self :aString |\n\t\tself <=> aString <= 0\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _greaterThanEquals_2(
      _lessThanEqualsGreaterThan_2(_self, _aString),
      1,
    );
  },
  "{ :self :aString |\n\t\tself <=> aString >= 1\n\t}",
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _joinCharacters_1(_select_2(_characterArray_1(_self), _isAscii_1));
  },
...
sl.addMethod(
  ...
  function (_self, _open, _close) {
    ...
    /* Statements */
    return _if_3(
      _or_2(_includesSubstring_2(_self, _open), function () {
        /* ArityCheck */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_equals_2(_size_1(_self), 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _smallSize) {
    ...
    /* Statements */
    return _if_3(_lessThanEquals_2(_size_1(_self), _smallSize), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _if_3(_lessThan_2(_smallSize, 5), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Temporaries */
        let _leftSize = _dividedByDividedBy_2(_minus_2(_smallSize, 2), 2);
        /* Statements */
        return _copyReplaceFromToWith_4(
          ...
          _minus_2(
            _size_1(_self),
            _minus_2(_minus_2(_smallSize, _leftSize), 3),
          ),
          "...",
        );
      });
...
sl.addMethod(
  ...
  function (_self, _start, _stop, _replacement) {
    ...
    /* Statements */
    return _join_1([
      _copyFromTo_3(_self, 1, _minus_2(_start, 1)),
      _replacement,
      _copyFromTo_3(_self, _plus_2(_stop, 1), _size_1(_self)),
    ]);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _do_2(_self, function (_each) {
      ...
      /* Statements */
      return _answer = _plus_2(_answer, 1);
    });
    return _answer;
  },
  "{ :self |\n\t\tlet answer = 0;\n\t\tself.do { :each |\n\t\t\tanswer := answer + 1\n\t\t};\n\t\tanswer\n\t}",
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Statements */
    return _if_3(_greaterThanEquals_2(_anInteger, _size_1(_self)), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      return _copyFromTo_3(
        _self,
        _plus_2(_minus_2(_size_1(_self), _anInteger), 1),
        _size_1(_self),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self, _subString, _start) {
    ...
    /* Statements */
    return _if_3(_equals_2(_last, 0), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _open, _close, _aBlock_0) {
    ...
    /* Statements */
    return _if_3(
      _or_2(_equals_2(_start, 0), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _aCharacter) {
    ...
    /* Statements */
    return _includes_2(_characterArray_1(_self), _aCharacter);
  },
  ...
  function (_self, _aString) {
    ...
    return _if_3(_isString_1(_aString), function () {
      ...
      _whileTrue_2(function () {
        ...
        return _ifTrue_2(_tildeEquals_2(_index, 0), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
      ...
      return _error_2(
        _self,
        _plusPlus_2("indicesOf: not a string: ", _aString),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _equals_2(_countUtf16CodeUnits_1(_self), _countCharacters_1(_self));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _or_2(_equals_2(_size_1(_self), 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _and_2(_equals_2(_size_1(_self), 2), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    return _if_3(_isString_1(_aString), function () {
      ...
      return _error_2(
        _self,
        _plusPlus_2("occurrencesOf: not a string: ", _aString),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _join_1(_reversed_1(_asArray_1(_self)));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _reverseDo_2(_asciiByteArray_1(_self), function (_each) {
      ...
      _if_3(_greaterThanEquals_2(_v1, _v2), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _value = _plus_2(_value, _v1);
      }, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        /* Statements */
        return _value = _minus_2(_value, _v1);
      });
      return _v2 = _v1;
    });
    return _value;
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _if_3(_equals_2(_self, _aString), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _equals_2(_asLowercase_1(_self), _asLowercase_1(_aString));
    });
  },
...
sl.addMethod(
  ...
  function (_self, _index) {
    ...
    let _begin = _if_3(_lessThan_2(_previousSpaceIndex, 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _plus_2(_previousSpaceIndex, 1);
    });
    let _end = _if_3(_lessThan_2(_nextSpaceIndex, 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
    ...
    /* Statements */
    return _copyFromTo_3(_self, _begin, _minus_2(_end, 1));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_indefiniteArticle_1(_self), _self);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_lessThan_2(_size_1(_self), 2), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _if_3(
        _and_2(_equals_2(_quote, _last_1(_self)), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
        ...
        function () {
          ...
          /* Statements */
          return _copyFromTo_3(_self, 2, _minus_2(_size_1(_self), 1));
        },
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
