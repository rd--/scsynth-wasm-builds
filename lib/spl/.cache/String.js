...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _delimiters) {
    ...
    let __SPL558 = _assertIsOfSize_2(_delimiters, 2);
    let _p = _at_2(__SPL558, 1);
    let _q = _at_2(__SPL558, 2);
  ...
  "{ :self :delimiters | let __SPL558 = assertIsOfSize(delimiters, 2); let p = at(__SPL558, 1); let q = at(__SPL558, 2); let c = ++(++([p], characters(self)), [q]); stringJoin(burrowsWheelerTransform(c)) }",
);
