    ...
    return _atSetRunOffsetAndValue_3(
      ...
      function (_run, _offset, _value) {
        ...
        if (arguments.length !== 3) {
          const errorMessage =
            "Arity: expected 3, _run, _offset, _value"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _index, _aBlock_3) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _index, _aBlock_3"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _aBlock_2) {
    ...
    return _toDo_3(1, _size_1(_runs_1(_self)), function (_runIndex) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _runIndex"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _aBlock_3) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aBlock_3"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _start = 1;
    ...
    return _withDo_3(
      ...
      function (_length, _value) {
        ...
        if (arguments.length !== 2) {
          const errorMessage =
            "Arity: expected 2, _length, _value"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _values) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _values"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
