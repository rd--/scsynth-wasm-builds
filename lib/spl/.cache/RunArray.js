...
sl.addMethodToExistingType(
  ...
  "{ :self | runsAndValuesCollect(self, { :key :value | ->(key, value) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let answer = IdentityMultiset(); runsAndValuesDo(self, { :run :value | addWithOccurrences(answer,value, run) }); answer }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anObject :aBlock:/2 | if((==(self, anObject)), { true }, { &(isRunArray(anObject), { &(hasEqualElements(runs(self),runs(anObject), aBlock:/2), { hasEqualElements(values(self),values(anObject), aBlock:/2) }) }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | RunArray(reverse(runs(self)), reverse(values(self))) }",
);
