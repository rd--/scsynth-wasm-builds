...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _if_3(_equalsEquals_2(_self, _anObject), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _and_2(_isRunArray_1(_anObject), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plus_2(_times_2(_size_1(_runs_1(_self)), 2), 3);
  },
  "{ :self |\n\t\tself.runs.size * 2 + 3\n\t}",
);
  ...
  function (_self, _index) {
    ...
    return _atSetRunOffsetAndValue_3(
      ...
      function (_run, _offset, _value) {
        ...
        /* Statements */
        _ifTrue_2(_lessThan_2(_offset, 0), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
        ...
        _ifTrue_2(
          _greaterThanEquals_2(_offset, _at_2(_runs_1(_self), _run)),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _index, _aBlock_3) {
    ...
    /* Statements */
    _if_3(
      _or_2(_equalsEquals_2(_cachedIndex_1(_self), null), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _lessThan_2(_index, _cachedIndex_1(_self));
      }),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        /* Statements */
        _run = 1;
        return _offset = _minus_2(_index, 1);
      },
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _offset = _plus_2(
          _cachedOffset_1(_self),
          _minus_2(_index, _cachedIndex_1(_self)),
        );
      },
    );
    _whileTrue_2(function () {
      ...
      /* Statements */
      return _and_2(_lessThanEquals_2(_run, _limit), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _greaterThanEquals_2(_offset, _at_2(_runs_1(_self), _run));
      });
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
      ...
      /* Statements */
      _offset = _minus_2(_offset, _at_2(_runs_1(_self), _run));
      return _run = _plus_2(_run, 1);
    });
    _cachedIndex_2(_self, _index);
    _cachedRun_2(_self, _run);
    _cachedOffset_2(_self, _offset);
    _ifTrue_2(_greaterThan_2(_run, _limit), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      _run = _minus_2(_run, 1);
      return _offset = _plus_2(_offset, _at_2(_runs_1(_self), _run));
    });
  ...
  function (_self, _aBlock_1) {
    ...
    return _toDo_3(1, _size_1(_runs_1(_self)), function (_index) {
      ...
      return _whileTrue_2(function () {
        ...
        /* Statements */
        _run = _minus_2(_run, 1);
        return _greaterThanEquals_2(_run, 0);
      }, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
  ...
  function (_self, _index) {
    ...
    return _atSetRunOffsetAndValue_3(
      ...
      function (_run, _offset, _value) {
        ...
        /* Statements */
        return _minus_2(_at_2(_runs_1(_self), _run), _offset);
      },
    );
  },
  ...
  function (_self, _aBlock_2) {
    ...
    return _toDo_3(1, _size_1(_runs_1(_self)), function (_runIndex) {
      ...
      return _whileTrue_2(function () {
        ...
        /* Statements */
        return _greaterThanEquals_2(_run = _minus_2(_run, 1), 0);
      }, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
  ...
  function (_self, _aBlock_3) {
    ...
    return _withDo_3(
      ...
      function (_length, _value) {
        ...
        /* Temporaries */
        let _stop = _minus_2(_plus_2(_start, _length), 1);
        /* Statements */
        _aBlock_3(_start, _stop, _value);
        return _start = _plus_2(_stop, 1);
      },
    );
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    _do_2(_self, function (_each) {
      ...
      /* Statements */
      return _if_3(_equals_2(_lastValue, _value), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _lastLength = _plus_2(_lastLength, 1);
      }, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        /* Statements */
        _ifTrue_2(_greaterThan_2(_lastLength, 0), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
