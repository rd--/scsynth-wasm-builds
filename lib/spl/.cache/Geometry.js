...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let _fragment = _svgFragment_2(_self, _options);
    return _if_3(
      _isString_1(_fragment),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
      ...
      sl.annotateFunction(function () {
        ...
        return _stringIntercalate_2(_flatten_1(_fragment), "\n");
      }, []),
    );
  }, ["self", "options"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let _fragmentText = _svgFragmentText_2(_geometry_1(_self), _options);
    _ifTrue_2(
