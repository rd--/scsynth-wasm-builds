...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    _do_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        let __SPL70 = _assertIsOfSize_2(_transposed_1(_each), 2);
  ...
  "{ :self | let t = []; let v = []; do(self, { :each | let __SPL70 = assertIsOfSize(transposed(each), 2); let i = at(__SPL70, 1); let j = at(__SPL70, 2); add(t,i); add(v,j) }); TemporalData(v, t) }",
);
...
sl.extendTypeOrTraitWithMethod(
    ...
    return _TemporalData_1(
      _collect_2(
        ...
        sl.annotateFunction(function (_timeSpecification) {
          ...
          let __SPL71 = _assertIsOfSize_2(_timeSpecification, 3);
          let _tMin = _at_2(__SPL71, 1);
          let _tMax = _at_2(__SPL71, 2);
          let _tStep = _at_2(__SPL71, 3);
  ...
  "{ :aBlock:/1 :timeSpecificationList | TemporalData(collect(timeSpecificationList, { :timeSpecification | let __SPL71 = assertIsOfSize(timeSpecification, 3); let tMin = at(__SPL71, 1); let tMax = at(__SPL71, 2); let tStep = at(__SPL71, 3); let timeList = asList(thenTo(tMin, +(tMin, tStep), tMax)); transposed([timeList, aBlock(timeList)]) })) }",
);
