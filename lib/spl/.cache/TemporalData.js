...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    _do_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        let __SPL75 = _assertIsOfSize_2(_transpose_1(_each), 2);
  ...
  "{ :self | let t = []; let v = []; do(self, { :each | let __SPL75 = assertIsOfSize(transpose(each), 2); let i = at(__SPL75, 1); let j = at(__SPL75, 2); add(t,i); add(v,j) }); TemporalData(v, t) }",
);
...
sl.extendTypeOrTraitWithMethod(
    ...
    return _TemporalData_1(
      _collect_2(
        ...
        sl.annotateFunction(function (_timeSpecification) {
          ...
          let __SPL76 = _assertIsOfSize_2(_timeSpecification, 3);
          let _tMin = _at_2(__SPL76, 1);
          let _tMax = _at_2(__SPL76, 2);
          let _tStep = _at_2(__SPL76, 3);
  ...
  "{ :aBlock:/1 :timeSpecificationList | TemporalData(collect(timeSpecificationList, { :timeSpecification | let __SPL76 = assertIsOfSize(timeSpecification, 3); let tMin = at(__SPL76, 1); let tMax = at(__SPL76, 2); let tStep = at(__SPL76, 3); let timeList = asList(thenTo(tMin, +(tMin, tStep), tMax)); transpose([timeList, aBlock(timeList)]) })) }",
);
