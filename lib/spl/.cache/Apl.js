...
sl.extendTraitWithMethod(
  ...
  function (_haystack, _needle) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _haystack, _needle"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _windowSize, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _windowSize, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _collect_2(
...
sl.addMethod(
  ...
  function (_self, _aString, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aString, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_g_2, _f_1, _h_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _g_2, _f_1, _h_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return (function (_x) {
