...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _and_2(_isCons_1(_anObject), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _and_2(_equals_2(_car_1(_self), _car_1(_anObject)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _equals_2(_cdr_1(_self), _cdr_1(_anObject));
      });
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _if_3(_equals_2(_next, null), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
  ...
  function (_self) {
    ...
    _do_2(_self, function (_each) {
      ...
      return _answer = _Cons_2(
        _if_3(_isSequenceable_1(_each), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
