...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL561 = _assertIsOfSize_2(_self, 3);
  ...
  "{ :self | let __SPL561 = assertIsOfSize(self, 3); let year = at(__SPL561, 1); let month = at(__SPL561, 2); let dayOfMonth = at(__SPL561, 3); Date(year, month, dayOfMonth) }",
);
