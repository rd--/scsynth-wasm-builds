...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL468 = _assertIsOfSize_2(_self, 3);
    let _year = _at_2(__SPL468, 1);
    let _month = _at_2(__SPL468, 2);
    let _dayOfMonth = _at_2(__SPL468, 3);
    /* Statements */
    return _Date_3(_year, _month, _dayOfMonth);
  }, ["self"]),
  "{ :self | let __SPL468 = assertIsOfSize(self, 3); let year = at(__SPL468, 1); let month = at(__SPL468, 2); let dayOfMonth = at(__SPL468, 3); Date(year, month, dayOfMonth) }",
);
