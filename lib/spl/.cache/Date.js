...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _year = _at_2(__SPL9, 1);
    let _month = _at_2(__SPL9, 2);
    let _dayOfMonth = _at_2(__SPL9, 3);
    /* Statements */
    return _Date_3(_year, _month, _dayOfMonth);
  }, ["self"]),
  "{ :self | let __SPL9 = assertIsOfSize(self, 3); let year = at(__SPL9, 1); let month = at(__SPL9, 2); let dayOfMonth = at(__SPL9, 3); Date(year, month, dayOfMonth) }",
);
