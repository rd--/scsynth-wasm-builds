  ...
  sl.annotateFunction(function (_sigma) {
    ...
    return sl.annotateFunction(function (_u) {
      ...
      return _asterisk_2(
        _m,
        _exp_1(
          _negated_1(_solidus_2(_squared_1(_u), _asterisk_2(2, _sigmaSquared))),
        ),
      );
    }, ["u"]);
  }, ["sigma"]),
  "{ :sigma | let m = /(1, (*(sqrt(pi(2)), sigma))); let sigmaSquared = *(sigma, sigma); { :u | *(m, exp(negated((/(squared(u), (*(2, sigmaSquared))))))) } }",
);
  ...
  sl.annotateFunction(function (_a, _b, _c) {
    ...
    return sl.annotateFunction(function (_t) {
      ...
      return _asterisk_2(
        _a,
        _exp_1(
          _asterisk_2(_exp_1(_asterisk_2(_negated_1(_c), _t)), _negated_1(_b)),
        ),
      );
    }, ["t"]);
  }, ["a", "b", "c"]),
  "{ :a :b :c | { :t | *(a, exp((*(exp((*(negated(c), t))), negated(b))))) } }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _isOne_1(_asterisk_2(_abs_1(_fractionPart_1(_self)), 2));
  }, ["self"]),
  "{ :self | isOne((*(abs(fractionPart(self)), 2))) }",
);
    ...
    return sl.annotateFunction(function (_x) {
      ...
      return _solidus_2(
        _hyphenMinus_2(
          ...
          _exp_1(_asterisk_2(_negated_1(_b), _x)),
        ),
        _plusSign_2(
          _exp_1(_asterisk_2(_c, _x)),
          _exp_1(_asterisk_2(_negated_1(_d), _x)),
        ),
      );
    }, ["x"]);
  }, ["a", "b", "c", "d"]),
  "{ :a :b :c :d | { :x | /((-(exp((*(a, x))), exp((*(negated(b), x))))), (+(exp((*(c, x))), exp((*(negated(d), x)))))) } }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_beta) {
    ...
    return sl.annotateFunction(function (_x) {
      ...
      return _solidus_2(
        _x,
        _plusSign_2(1, _exp_1(_asterisk_2(_negated_1(_beta), _x))),
      );
    }, ["x"]);
  }, ["beta"]),
  "{ :beta | { :x | /(x, (+(1, exp((*(negated(beta), x)))))) } }",
);
