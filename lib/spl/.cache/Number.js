...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _absoluteValue_1(_hyphenMinus_2(_self, _operand));
  }, ["self", "operand"]),
...
sl.addMethodToExistingTrait(
  ...
  "betaExpansion",
  ["x", "beta", "p"],
  sl.annotateFunction(function (_x, _beta, _p) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _x, _beta, _p";
      throw new Error(errorMessage);
    } /* Temporaries */
    let _k = _max_2(_ceiling_1(_solidus_2(_log_1(_x), _log_1(_beta))), 0);
    let _r = [];
    let _i = _hyphenMinus_2(_k, 1);
    /* Statements */
    _whileTrue_2(
      sl.annotateFunction(function () {
        /* ArityCheck */
        ...
        return _greaterThanSign_2(_i, _hyphenMinus_2(_negate_1(_p), 1));
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        let _m = _circumflexAccent_2(_beta, _i);
        let _d = _floor_1(_percentSign_2(_solidus_2(_x, _m), _beta));
        /* Statements */
        _x = _hyphenMinus_2(_x, _asterisk_2(_d, _m));
        _add_2(_r, _d);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _asterisk_2(
      _hyphenMinus_2(_self, _operand),
      _plusSign_2(_self, _operand),
    );
  }, ["self", "operand"]),
  ...
  sl.annotateFunction(function (_self, _aNumber) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _ampersand_2(
          _greaterThanSignEqualsSign_2(_abs_1(_self), _abs_1(_aNumber)),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
  ...
  sl.annotateFunction(function (_x, _n) {
    ...
    _timesRepeat_2(
      ...
      sl.annotateFunction(function () {
        ...
        let _s = _ceiling_1(_solidus_2(1, _x));
        /* Statements */
        _add_2(_a, _s);
        return _x = _hyphenMinus_2(_x, _solidus_2(1, _s));
      }, []),
    );
    return _a;
  }, ["x", "n"]),
      ...
      sl.annotateFunction(function (_x, _y) {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _solidus_2(
              _hyphenMinus_2(_y, _x),
              _log_1(_solidus_2(_y, _x)),
            );
          }, []),
        );
      }, ["x", "y"]),
      ...
      sl.annotateFunction(function () {
        ...
        return _collect_2(
          ...
          sl.annotateFunction(function (_each) {
            ...
            return _powerMod_3(_base, _each, _modulo);
          }, ["each"]),
        );
      }, []),
      sl.annotateFunction(function () {
...
sl.addMethodToExistingTrait(
  ...
  "Number",
  "printString",
  ["self", "radix", "placesDesired"],
  sl.annotateFunction(function (_self, _radix, _placesDesired) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _radix, _placesDesired";
      throw new Error(errorMessage);
    } /* Statements */
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _printStringShowingDecimalPlaces_2(_self, _placesDesired);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _error_2(_self, "printString: r≠10 & k≠∞");
      }, []),
    );
  }, ["self", "radix", "placesDesired"]),
...
sl.addMethodToExistingTrait(
  ...
  "relativeChange",
  ["x", "y", "f:/2"],
  sl.annotateFunction(function (_x, _y, _f_2) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _x, _y, _f_2";
      throw new Error(errorMessage);
    } /* Statements */
    return _solidus_2(_hyphenMinus_2(_y, _x), _f_2(_x, _y));
  }, ["x", "y", "f:/2"]),
  "{ :x :y :f:/2 |\n\t\t(y - x) / f(x, y)\n\t}",
);
...
sl.addMethodToExistingTrait(
  ...
  ["total", "proportions", "multiple"],
  sl.annotateFunction(function (_total, _proportions, _multiple) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _total, _proportions, _multiple";
      throw new Error(errorMessage);
    } /* Temporaries */
    let _scaledData = _asterisk_2(
      _solidus_2(_proportions, _sum_1(_proportions)),
      _total,
    );
    let _roundedData = _round_2(_scaledData, _multiple);
    let _roundingError = _hyphenMinus_2(_total, _sum_1(_roundedData));
    /* Statements */
    _ifFalse_2(
      _isZero_1(_roundingError),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        let _maxItem = _max_1(_roundedData);
        let _maxIndex = _indexOf_2(_roundedData, _maxItem);
        /* Statements */
        return _atPut_3(
          _roundedData,
          _maxIndex,
          _plusSign_2(_maxItem, _roundingError),
        );
      }, []),
    );
    return _roundedData;
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _asterisk_2(_self, _operand);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _base) {
    ...
    let _d = _at_2(__SplVar5, 1);
    let _p = _at_2(__SplVar5, 2);
    let _e = _reverse_1(_hyphenMinus_2(_p, _indicesOf_2(_d, 1)));
    /* Statements */
    return _sum_1(_circumflexAccent_2(_base, _e));
  }, ["self", "base"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SplVar6 = _assertIsOfSize_2(_a, 2);
    let _min = _at_2(__SplVar6, 1);
    let _max = _at_2(__SplVar6, 2);
    let __SplVar7 = _assertIsOfSize_2(_b, 2);
    let _yMin = _at_2(__SplVar7, 1);
    let _yMax = _at_2(__SplVar7, 2);
    /* Statements */
    return sl.annotateFunction(function (_x) {
      /* ArityCheck */
      if (arguments.length !== 1) {
