    ...
    _whileFalse_2(
      ...
      sl.annotateFunction(function () {
        ...
        return (sl.annotateFunction(function () {
          ...
          /* Statements */
          _a = _at_2(__SPL1, 1);
          return _b = _at_2(__SPL1, 2);
        }, [])());
      }, []),
    );
    return _a;
  }, ["self", "aNumber"]),
  "{ :self :aNumber | let a = self; let b = aNumber; whileFalse({ isVeryCloseTo(a,b) }, { ({ let __SPL1 = [*(0.5, (+(a, b))), sqrt((*(a, b)))]; a := at(__SPL1, 1); b := at(__SPL1, 2) } . ()) }); a }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | typeResponsibility(self,'@Number>>asInteger') }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aNumber :epsilon | typeResponsibility(self,'isCloseToBy') }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :limit | if(isZero(self), { self }, { +(+(eulerGamma(1), (log(abs(log(self))))), sum(collect(Span(1, limit, 1), { :k | /((^(log(self), k)), (*(factorial(k), k))) }))) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :c | let x = asFloat(self); *(sign(x), log10((+(1, abs((/(x, c))))))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let c = /(1, log(10)); logScale(self,c) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :placesDesired | if((<=(placesDesired, 0)), { printString(round(self)) }, { let rounder = ^(10, placesDesired); let round = round(self,reciprocal(rounder)); let prefix = if(isNegative(round), { '-' }, { '' }); let roundFractionPart = round((*(fractionalPart(abs(round)), rounder))); stringCatenate([prefix, printString(truncate(integerPart(abs(round)))), '.', padLeft(printString(roundFractionPart),[placesDesired], '0')]) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _a) {
    ...
    let __SPL2 = _assertIsOfSize_2(_a, 2);
    let _min = _at_2(__SPL2, 1);
    let _max = _at_2(__SPL2, 2);
    /* Statements */
    return _solidus_2(_hyphenMinus_2(_self, _min), _hyphenMinus_2(_max, _min));
  }, ["self", "a"]),
  "{ :self :a | let __SPL2 = assertIsOfSize(a, 2); let min = at(__SPL2, 1); let max = at(__SPL2, 2); /((-(self, min)), (-(max, min))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _a, _b) {
    ...
    let __SPL3 = _assertIsOfSize_2(_a, 2);
    let _min = _at_2(__SPL3, 1);
    let _max = _at_2(__SPL3, 2);
    let __SPL4 = _assertIsOfSize_2(_b, 2);
    let _yMin = _at_2(__SPL4, 1);
    let _yMax = _at_2(__SPL4, 2);
    /* Statements */
    return _plusSign_2(
      _asterisk_2(
  ...
  "{ :self :a :b | let __SPL3 = assertIsOfSize(a, 2); let min = at(__SPL3, 1); let max = at(__SPL3, 2); let __SPL4 = assertIsOfSize(b, 2); let yMin = at(__SPL4, 1); let yMax = at(__SPL4, 2); +(*((/((-(self, min)), (-(max, min)))), (-(yMax, yMin))), yMin) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aNumber | *(round((/(self, aNumber))), aNumber) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aNumber | let scalar = ^(10, aNumber); /(round((*(self, scalar))), scalar) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aNumber | if((<(self, 0)), { roundUp(self,aNumber) }, { roundDown(self,aNumber) }) }",
);
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _greaterThanSign_2(_self, _operand);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _error_2(_self, "succeeds: invalid operand");
      }, []),
    );
  }, ["self", "operand"]),
  "{ :self :operand | if(isNumber(operand), { >(self, operand) }, { error(self,'succeeds: invalid operand') }) }",
);
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _greaterThanSignEqualsSign_2(_self, _operand);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _error_2(_self, "succeedsOrEqualTo: invalid operand");
      }, []),
    );
  }, ["self", "operand"]),
  "{ :self :operand | if(isNumber(operand), { >=(self, operand) }, { error(self,'succeedsOrEqualTo: invalid operand') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL6 = _assertIsOfSize_2(_b, 2);
    let _yMin = _at_2(__SPL6, 1);
    let _yMax = _at_2(__SPL6, 2);
    /* Statements */
    return sl.annotateFunction(function (_x) {
      /* ArityCheck */
      if (arguments.length !== 1) {
  ...
  "{ :a :b | let __SPL5 = assertIsOfSize(a, 2); let min = at(__SPL5, 1); let max = at(__SPL5, 2); let __SPL6 = assertIsOfSize(b, 2); let yMin = at(__SPL6, 1); let yMax = at(__SPL6, 2); { :x | +(*((/((-(x, min)), (-(max, min)))), (-(yMax, yMin))), yMin) } }",
);
