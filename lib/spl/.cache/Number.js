...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aNumber | let a = self; let b = aNumber; whileFalse({ isVeryCloseTo(a,b) }, { ({ let __SplVar1 = [*(0.5, (+(a, b))), sqrt((*(a, b)))]; a := at(__SplVar1, 1); b := at(__SplVar1, 2) } . ()) }); a }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :a | let __SplVar2 = assertIsOfSize(a, 2); let min = at(__SplVar2, 1); let max = at(__SplVar2, 2); /((-(self, min)), (-(max, min))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :a :b | let __SplVar3 = assertIsOfSize(a, 2); let min = at(__SplVar3, 1); let max = at(__SplVar3, 2); let __SplVar4 = assertIsOfSize(b, 2); let yMin = at(__SplVar4, 1); let yMax = at(__SplVar4, 2); +(*((/((-(self, min)), (-(max, min)))), (-(yMax, yMin))), yMin) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :end :aBlock:/2 | let index = self; valueWithReturn({ :return:/1 | whileTrue({ <=(index, end) }, { aBlock(index, return:/1); index := +(index, 1) }) }); self }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b | let __SplVar5 = assertIsOfSize(a, 2); let min = at(__SplVar5, 1); let max = at(__SplVar5, 2); let __SplVar6 = assertIsOfSize(b, 2); let yMin = at(__SplVar6, 1); let yMax = at(__SplVar6, 2); { :x | +(*((/((-(x, min)), (-(max, min)))), (-(yMax, yMin))), yMin) } }",
);
