    ...
    _whileFalse_2(
      ...
      sl.annotateFunction(function () {
        ...
        return (sl.annotateFunction(function () {
          ...
          /* Statements */
          _a = _at_2(__SPL512, 1);
          return _b = _at_2(__SPL512, 2);
        }, [])());
      }, []),
    );
    return _a;
  }, ["self", "aNumber"]),
  "{ :self :aNumber | let a = self; let b = aNumber; whileFalse({ isVeryCloseTo(a,b) }, { ({ let __SPL512 = [*(0.5, (+(a, b))), sqrt((*(a, b)))]; a := at(__SPL512, 1); b := at(__SPL512, 2) } . ()) }); a }",
);
  ...
  sl.annotateFunction(function (_sigma) {
    ...
    return sl.annotateFunction(function (_u) {
      ...
      return _asterisk_2(
        _m,
        _exp_1(
          _negate_1(_solidus_2(_square_1(_u), _asterisk_2(2, _sigmaSquare))),
        ),
      );
    }, ["u"]);
  }, ["sigma"]),
  "{ :sigma | let m = /(1, (*(sqrt(pi(2)), sigma))); let sigmaSquared = *(sigma, sigma); { :u | *(m, exp(negate((/(square(u), (*(2, sigmaSquare))))))) } }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _tildeEqualsSign_2(_self, 0);
  }, ["self"]),
  "{ :self | ~=(self, 0) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _a) {
    ...
    let __SPL513 = _assertIsOfSize_2(_a, 2);
    let _min = _at_2(__SPL513, 1);
    let _max = _at_2(__SPL513, 2);
    /* Statements */
    return _solidus_2(_hyphenMinus_2(_self, _min), _hyphenMinus_2(_max, _min));
  }, ["self", "a"]),
  "{ :self :a | let __SPL513 = assertIsOfSize(a, 2); let min = at(__SPL513, 1); let max = at(__SPL513, 2); /((-(self, min)), (-(max, min))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _a, _b) {
    ...
    let __SPL514 = _assertIsOfSize_2(_a, 2);
    let _min = _at_2(__SPL514, 1);
    let _max = _at_2(__SPL514, 2);
    let __SPL515 = _assertIsOfSize_2(_b, 2);
    let _yMin = _at_2(__SPL515, 1);
    let _yMax = _at_2(__SPL515, 2);
    /* Statements */
    return _plusSign_2(
      _asterisk_2(
  ...
  "{ :self :a :b | let __SPL514 = assertIsOfSize(a, 2); let min = at(__SPL514, 1); let max = at(__SPL514, 2); let __SPL515 = assertIsOfSize(b, 2); let yMin = at(__SPL515, 1); let yMax = at(__SPL515, 2); +(*((/((-(self, min)), (-(max, min)))), (-(yMax, yMin))), yMin) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL516 = _assertIsOfSize_2(_a, 2);
    let _min = _at_2(__SPL516, 1);
    let _max = _at_2(__SPL516, 2);
    let __SPL517 = _assertIsOfSize_2(_b, 2);
    let _yMin = _at_2(__SPL517, 1);
    let _yMax = _at_2(__SPL517, 2);
    /* Statements */
    return sl.annotateFunction(function (_x) {
      /* ArityCheck */
      if (arguments.length !== 1) {
  ...
  "{ :a :b | let __SPL516 = assertIsOfSize(a, 2); let min = at(__SPL516, 1); let max = at(__SPL516, 2); let __SPL517 = assertIsOfSize(b, 2); let yMin = at(__SPL517, 1); let yMax = at(__SPL517, 2); { :x | +(*((/((-(x, min)), (-(max, min)))), (-(yMax, yMin))), yMin) } }",
);
