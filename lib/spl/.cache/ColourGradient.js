...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL26 = _assertIsOfSize_2(_shape_1(_colourList_1(_self)), 2);
  ...
  "{ :self | let __SPL26 = assertIsOfSize(shape(colourList(self)), 2); let m = at(__SPL26, 1); let n = at(__SPL26, 2); &((=(n, 3)), { ifNil(positionListOrNil(self), { true }, { :p | =(size(p), m) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _c = _at_2(__SPL27, 1);
    let _p = _at_2(__SPL27, 2);
    /* Statements */
    return _ColourGradient_2(_c, _p);
  }, ["self"]),
  "{ :self | let __SPL27 = assertIsOfSize(self, 2); let c = at(__SPL27, 1); let p = at(__SPL27, 2); ColourGradient(c, p) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL28 = _assertIsOfSize_2(_splitBy_2(_self, "/"), 2);
        let _collectionName = _at_2(__SPL28, 1);
        let _gradientName = _at_2(__SPL28, 2);
        /* Statements */
