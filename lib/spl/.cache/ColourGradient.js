...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL260 = _assertIsOfSize_2(_shape_1(_colourList_1(_self)), 2);
    let _m = _at_2(__SPL260, 1);
    let _n = _at_2(__SPL260, 2);
    /* Statements */
    return _ampersand_2(
      _equalsSign_2(_n, 3),
      sl.annotateFunction(function () {
  ...
  "{ :self | let __SPL260 = assertIsOfSize(shape(colourList(self)), 2); let m = at(__SPL260, 1); let n = at(__SPL260, 2); &((=(n, 3)), { ifNil(positionListOrNil(self), { true }, { :p | =(size(p), m) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL261 = _assertIsOfSize_2(_self, 2);
    let _c = _at_2(__SPL261, 1);
    let _p = _at_2(__SPL261, 2);
    /* Statements */
    return _ColourGradient_2(_c, _p);
  }, ["self"]),
  "{ :self | let __SPL261 = assertIsOfSize(self, 2); let c = at(__SPL261, 1); let p = at(__SPL261, 2); ColourGradient(c, p) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL262 = _assertIsOfSize_2(_splitBy_2(_self, "/"), 2);
        let _collectionName = _at_2(__SPL262, 1);
        let _gradientName = _at_2(__SPL262, 2);
        /* Statements */
