...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL68 = _assertIsOfSize_2(_shape_1(_colourList_1(_self)), 2);
    let _m = _at_2(__SPL68, 1);
    let _n = _at_2(__SPL68, 2);
    /* Statements */
    return _ampersand_2(
      _equalsSign_2(_n, 3),
      sl.annotateFunction(function () {
  ...
  "{ :self | let __SPL68 = assertIsOfSize(shape(colourList(self)), 2); let m = at(__SPL68, 1); let n = at(__SPL68, 2); &((=(n, 3)), { ifNil(positionListOrNil(self), { true }, { :p | =(size(p), m) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL69 = _assertIsOfSize_2(_self, 2);
    let _c = _at_2(__SPL69, 1);
    let _p = _at_2(__SPL69, 2);
    /* Statements */
    return _ColourGradient_2(_c, _p);
  }, ["self"]),
  "{ :self | let __SPL69 = assertIsOfSize(self, 2); let c = at(__SPL69, 1); let p = at(__SPL69, 2); ColourGradient(c, p) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL70 = _assertIsOfSize_2(_splitBy_2(_self, "/"), 2);
        let _collectionName = _at_2(__SPL70, 1);
        let _gradientName = _at_2(__SPL70, 2);
        /* Statements */
