...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _joinSvg_1([_pre, _stops, _post]);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_collectionName, _paletteName) {
    ...
    return _asBlock_1(_namedColourGradient_2(_collectionName, _paletteName));
  }, ["collectionName", "paletteName"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _asBlock_1(_namedColourGradient_1(_self));
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _colourList_1(
      _resample_2(
        _asColourGradient_1(
          _at_2(_at_2(_colourGradients_1(_system), "Mathworks"), "Parula"),
        ),
        _self,
      ),
    );
