sl.addMethod(
  ...
  function (_self, _scalaModenam) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _scalaModenam"; /* console.error(errorMessage); */
        ...
        function (_libraryItem) {
          ...
          return _collect_2(_libraryItem, function (_each) {
            ...
            let __genSym123 = _assertIsOfSize_2(_each, 3),
              _zeroIndexedStartIndex = _at_2(__genSym123, 1),
              _intervals = _at_2(__genSym123, 2),
              _description = _at_2(__genSym123, 3);
            /* Statements */
            return _Scale_3(
...
sl.addMethod(
  ...
  function (_self, _smallKansas, _event) {
    ...
    return _then_2(_scalaModenam_1(_smallKansas), function (_scalaModenam) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _scalaModenam"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _addFrame_3(
