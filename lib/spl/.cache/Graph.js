...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _join_2([
      _asString_1(_at_2(_self, 1)),
      " -- ",
      _asString_1(_at_2(_self, 2)),
      ";",
    ], "");
  },
  "{ :self |\n\t\t[\n\t\t\tself[1].asString,\n\t\t\t' -- ',\n\t\t\tself[2].asString,\n\t\t\t';'\n\t\t].join('')\n\t}",
...
sl.addMethod(
  ...
  function (_self, _anEdge) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _anEdge"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aGraph) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aGraph"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _vertex) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _vertex"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _answer = [];
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    return _allSatisfy_2(_edgeList_1(_self), function (_edge) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _edge"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    return _collect_2(_vertexList_1(_self), function (_vertex) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _vertex"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self, _labels) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _labels"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_2, _isDirected, _vertexList) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_2, _isDirected, _vertexList"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _edgeList = [];
...
sl.addMethod(
  ...
  function (_vertices, _edges) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _vertices, _edges"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_dotSource, _outputFormat, _layoutEngine) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _dotSource, _outputFormat, _layoutEngine"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
    return sl.dotLayout(_dotSource, _outputFormat, _layoutEngine);
  },
