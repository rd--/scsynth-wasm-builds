  ...
  function (_self) {
    ...
    return _ampersand_2(
      _allSatisfy_2(_edges_1(_self), function (_edge) {
        ...
        /* Statements */
        return _ampersand_2(_equalsSign_2(_size_1(_edge), 2), function () {
          /* ArityCheck */
      ...
      function () {
        ...
        /* Statements */
        return _ampersand_2(
          _verticalLine_2(_isNil_1(_vertexLabels_1(_self)), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
          ...
          function () {
            ...
            /* Statements */
            return _verticalLine_2(_isNil_1(_edgeLabels_1(_self)), function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
                const errorMessage = "Arity: expected 0, ";
                console.error(errorMessage);
  ...
  function (_self) {
    ...
    return _ifNil_3(_vertexLabels_1(_self), function () {
      ...
      return _collect_2(_vertices_1(_self), function (_each) {
        ...
        /* Statements */
        return _hyphenMinusGreaterThanSign_2(_each, "");
      });
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
      ...
      return _withCollect_3(
        ...
        function (_vertex, _label) {
          ...
          /* Statements */
          return _hyphenMinusGreaterThanSign_2(_vertex, _label);
        },
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _Range_3(1, _size_1(_self), 1);
  },
  "{ :self |\n\t\tRange(1, self.size, 1)\n\t}",
);
