...
sl.addMethodToExistingTrait(
  ...
  "{ :self | isPunctuation(characterString(self)) }",
);
...
sl.addType(
  ...
  "Character",
  "Character",
  ["Object", "Comparable", "Magnitude", "Character"],
...
sl.addMethodToExistingType(
  ...
  "{ :self :anObject | compare(codePoint(self),codePoint(anObject)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | asCharacter(fromCodePoint(self)) }",
);
