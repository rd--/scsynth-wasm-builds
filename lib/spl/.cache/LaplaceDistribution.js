...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return sl.annotateFunction(function (_x) {
      ...
      let _y = _solidus_2(
        _exp_1(_solidus_2(_negated_1(_abs_1(_hyphenMinus_2(_x, _mu))), _beta)),
        2,
      );
      /* Statements */
      return _if_3(
  ...
  "{ :self | let mu = mu(self); let beta = beta(self); { :x | let y = /(exp((/(negated(abs((-(x, mu)))), beta))), 2); if((>=(x, mu)), { -(1, y) }, { y }) } }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let mu = mu(self); let beta = beta(self); { :x | /(exp((/(negated(abs((-(x, mu)))), beta))), (*(2, beta))) } }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _asterisk_2(2, _squared_1(_beta_1(_self)));
  }, ["self"]),
  "{ :self | *(2, squared(beta(self))) }",
);
