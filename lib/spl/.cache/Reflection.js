  ...
  function (_self, _aCollection) {
    ...
    return _do_2(_values_1(_traitDictionary_1(_system)), function (_trait) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _trait"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _do_2(_values_1(_methodDictionary_1(_trait)), function (_method) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _method"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _traitName, _methodName) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _traitName, _methodName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _typeName, _methodName) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _typeName, _methodName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _anySatisfy_2(
...
sl.addMethod(
  ...
  function (_self, _methodName) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _methodName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    _do_2(_traitDictionary_1(_self), function (_aTrait) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _aTrait"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _do_2(_methodDictionary_1(_aTrait), function (_aMethod) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _aMethod"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
    ...
    return _do_2(_typeDictionary_1(_self), function (_aType) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _aType"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
  ...
  function (_self, _methodName) {
    ...
    return _if_3(_isMethodName_2(_self, _methodName), function () {
      ...
      _do_2(_table, function (_dictionary) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _dictionary"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _signature) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _signature"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let __genSym131 = _assertIsOfSize_2(_parseMethodSignature_1(_signature), 2),
      _qualifiedOriginName = _at_2(__genSym131, 1),
      _qualifiedMethodName = _at_2(__genSym131, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _methodName, _arity, _typeName) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _methodName, _arity, _typeName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _at_2(
...
sl.addMethod(
  ...
  function (_self, _qualifiedMethodName) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _qualifiedMethodName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function (_self) {
    ...
    return _select_2(
      ...
      function (_methodName) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _methodName"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _packageName) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _packageName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _answer = [];
...
sl.addMethod(
  ...
  function (_self, _traitName) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _traitName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _traitOrTypeName) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _traitOrTypeName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _typeName) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _typeName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function (_self, _typeName) {
    ...
    _do_2(
      ...
      function (_traitName) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _traitName"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
        return _valuesDo_2(
