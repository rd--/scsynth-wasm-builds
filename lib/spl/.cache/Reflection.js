...
sl.addMethod(
  ...
  function (_self, _signature) {
    ...
    let __genSym228 = _assertIsOfSize_2(_parseMethodSignature_1(_signature), 2),
      _qualifiedOriginName = _at_2(__genSym228, 1),
      _qualifiedMethodName = _at_2(__genSym228, 2);
    /* Statements */
