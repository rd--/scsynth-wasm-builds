...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :signature | let __SplVar1 = assertIsOfSize(parseMethodSignature(signature), 2); let qualifiedOriginName = at(__SplVar1, 1); let qualifiedMethodName = at(__SplVar1, 2); if(isQualifiedTraitName(qualifiedOriginName), { at(methodDictionary(at(traitDictionary(self), parseQualifiedTraitName(qualifiedOriginName))), qualifiedMethodName) }, { at(methodDictionary(at(typeDictionary(self), qualifiedOriginName)), qualifiedMethodName) }) }",
);
