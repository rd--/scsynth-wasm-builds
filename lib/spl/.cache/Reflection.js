...
sl.addMethod(
  ...
  function (_self, _signature) {
    ...
    /* Temporaries */
    let __genSym132 = _assertIsOfSize_2(_parseMethodSignature_1(_signature), 2),
      _qualifiedOriginName = _at_2(__genSym132, 1),
      _qualifiedMethodName = _at_2(__genSym132, 2);
    /* Statements */
