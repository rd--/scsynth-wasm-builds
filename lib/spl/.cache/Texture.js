...
sl.addMethod(
  ...
  function (_aUgen, _sustainTime, _transitionTime) {
    ...
    let _amp = _EnvGen_6(1, 1, 0, 1, 2, _asArray_1(_env));
    /* Statements */
    return _Out_2(0, _times_2(_aUgen, _amp));
  },
...
sl.addMethod(
  ...
  function (_self_1, _sustainTime, _transitionTime, _overlap) {
    ...
    /* Temporaries */
    let _period = _dividedBy_2(
      _plus_2(_sustainTime, _times_2(_transitionTime, 2)),
      _overlap,
    );
    let _counter = 0;
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _nextTime) {
    ...
    return _schedule_3(_clock_1(_system), 0, function (_currentTime) {
      ...
      /* Statements */
      _counter = _plus_2(_counter, 1);
      _playAt_2(_cull_2(_self_1, _counter), _plus_2(_currentTime, 0.5));
  ...
  function (_self, _aCollection, _aBlock_1, _delay) {
    ...
    return _recurseEvery_4(
      ...
      function (_currentTime, _index) {
        ...
        return _if_3(_equals_2(_index, _end), function () {
          /* ArityCheck */
