...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _sort_1(_asList_1(_without_2(_answer, 2)));
  },
...
sl.addMethod(
  ...
  function (_self, _primes) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _primes"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(
      ...
      function () {
        ...
        let _pf3 = _asBag_1(_plusSignPlusSign_2(_pf1, _pf2));
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _unitVector) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _unitVector"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _sum_1(
      _withCollect_3(
        ...
        function (_count, _unit) {
          ...
          if (arguments.length !== 2) {
            const errorMessage =
              "Arity: expected 2, _count, _unit"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _latticeCoordinates_2(_self, [[20, 0], [0, 20], [4, 3], [-3, 4], [
      -1,
      2,
    ]]);
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _vertices) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _vertices"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    _combinationsAtATimeDo_3(_indices, 2, function (_each) {
      ...
      /* Temporaries */
      let __genSym98 = _assertIsOfSize_2(_each, 2),
        _i = _at_2(__genSym98, 1),
        _j = _at_2(__genSym98, 2);
      /* Statements */
      return _ifTrue_2(
        _equalsSign_2(
