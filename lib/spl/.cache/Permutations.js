...
sl.addMethodToExistingType(
  ...
  "{ :self :anInteger | if(isNegative(anInteger), { ^(inverse(self), negate(anInteger)) }, { product((#(self, anInteger))) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | cycles(collect(cycles(self), { :each | reverse(each) })) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | cycles(self, deepCopy(cycles(self))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let list = sort(copy(self)); let next = nil; let continue = true; whileTrue({ continue }, { continue := aBlock(list); ifTrue(continue, { next := nextPermutationLexicographic(list); continue := isNotNil(next) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :deleteUnaryCycles | permutationListToPermutationCycles(self,deleteUnaryCycles) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :deleteUnaryCycles | permutationListToPermutationCycles(permutationCyclesToPermutationList(self),deleteUnaryCycles) }",
);
