...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ascents_2(_self, _less_2);
  }, ["self"]),
  "{ :self |\n\t\tself.ascents(less:/2)\n\t}",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _runs_2(_self, _greater_2);
  }, ["self"]),
  "{ :self |\n\t\tself.runs(greater:/2)\n\t}",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ascents_2(_self, _greater_2);
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_p) {
    ...
    let _i = _permutationMax_1(_p);
    let _j = _permutationLength_1(_p);
    return _ampersand_2(
      _equalsSign_2(_i, _j),
      sl.annotateFunction(function () {
        /* ArityCheck */
        ...
        return _isRotation_2(
          _list_1(_p),
          _asList_1(_nonemptyRange_3(1, _i, 1)),
        );
      }, []),
    );
  }, ["p"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _inversePermutation_1(_asPermutation_1(_self));
  }, ["self"]),
  ...
  sl.annotateFunction(function (_p) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        let _k = _size_1(_p);
        let _q = _sort_1(_abs_1(_differences_1(_p)));
        return _equalsSign_2(
          _q,
          _asList_1(_nonemptyRange_3(1, _hyphenMinus_2(_k, 1), 1)),
        );
      }, []),
    );
  }, ["p"]),
  ...
  sl.annotateFunction(function (_self, _aSequence) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        return _equalsSign_2(
          _sort_1(_copy_1(_self)),
          _sort_1(_copy_1(_aSequence)),
        );
      }, []),
    );
  }, ["self", "aSequence"]),
      ...
      sl.annotateFunction(function () {
        ...
        return _ifTrue_2(
          ...
          sl.annotateFunction(function () {
            ...
            let _next = _nextPermutationLexicographic_1(_list);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _x = _hyphenMinus_2(_minimumExcludedValue_2(_self, _u), 1);
        return _collect_2(
          _rangeOrRelativeRange_3(1, _x, 1),
          sl.annotateFunction(function (_i) {
            /* ArityCheck */
            if (arguments.length !== 1) {
              const errorMessage = "Arity: expected 1, _i";
      ...
      sl.annotateFunction(function () {
        ...
        return _error_2(_self, "partialInversePermutation");
      }, []),
    );
  }, ["self"]),
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _reduce_2(_entries, _times_2);
          }, []),
        );
      }, []),
    );
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_k) {
    ...
    let _n = _hyphenMinus_2(_circumflexAccent_2(2, _k), 1);
    return _plusSign_2(
      _collect_2(
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _method) {
    ...
    let _reorder_1 = _caseOf_2(_method, [
    ...
    let _f_1 = _memoize_1(sl.annotateFunction(function (_n) {
      /* ArityCheck */
      if (arguments.length !== 1) {
          ...
          return _catenate_1(
            _collect_2(
              ...
              sl.annotateFunction(function (_x) {
                ...
                return _collect_2(
                  _reorder_1(_asList_1(_nonemptyRange_3(1, _n, 1))),
                  sl.annotateFunction(function (_i) {
                    /* ArityCheck */
                    if (arguments.length !== 1) {
                      const errorMessage = "Arity: expected 1, _i";
    ...
    return _toCollect_3(1, _self, _f_1);
  }, ["self", "method"]),
