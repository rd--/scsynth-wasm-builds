...
sl.addMethod(
  ...
  function (_self, _aPermutation) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aPermutation"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _pattern) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _pattern"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _deleteUnaryCycles) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _deleteUnaryCycles"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_rank, _degree) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _rank, _degree"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
