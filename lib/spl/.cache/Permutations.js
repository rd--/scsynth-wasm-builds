  ...
  sl.annotateFunction(function (_self, _aPermutation) {
    ...
    return _asPermutation_1(
      _ordering_1(
        _apply_2(
          _aPermutation,
          _apply_2(_self, _asList_1(_nonemptyRange_3(1, _length, 1))),
        ),
      ),
    );
  }, ["self", "aPermutation"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _v = _asList_1(_nonemptyRange_3(1, _degree_1(_self), 1));
    /* Statements */
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return [
      _asList_1(_nonemptyRange_3(1, _degree_1(_self), 1)),
      _list_1(_self),
    ];
  }, ["self"]),
  "{ :self |\n\t\t[\n\t\t\t[1 .. self.degree],\n\t\t\tself.list\n\t\t]\n\t}",
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _answer = _asList_1(_nonemptyRange_3(1, _anInteger, 1));
        /* Statements */
        _do_2(
          _self,
          sl.annotateFunction(function (_each) {
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _asPermutation_1(
          _asList_1(_nonemptyRange_3(1, _permutationDegree_1(_self), 1)),
        );
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _list = _asList_1(_nonemptyRange_3(1, _size_1(_self), 1));
    /* Statements */
    return _collect_2(
      _self,
      sl.annotateFunction(function (_each) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _heapsAlgorithm_1(_asList_1(_nonemptyRange_3(1, _self, 1)));
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _minimumChangePermutations_1(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _plainChanges_1(_asList_1(_nonemptyRange_3(1, _self, 1)));
      }, []),
    );
  }, ["self"]),
