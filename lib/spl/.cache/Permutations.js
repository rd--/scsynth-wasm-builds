...
sl.addMethodToExistingType(
  ...
  "{ :self | sort(concatenation(cycles(self))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | |(isEmpty(self), { &((=(depth(self), 3)), { let entries = concatenation(self); &(allSatisfy(entries, { :each | &(isInteger(each), { isPositive(each) }) }), { isDuplicateFree(entries,==) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isEmpty(self), { true }, { let ascending = sorted(self); &(isArithmeticSeries(ascending), { &(=(first(ascending), 1), { =(last(ascending), size(self)) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    return _whileTrue_2(function () {
      ...
      return _ifTrue_2(_continue, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _n) {
    ...
    _lexicographicPermutationsDo_2(_self, function (_each) {
      ...
      return _if_3(_equalsSign_2(_index, _n), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
  ...
  function (_self) {
    ...
    return _if_3(_isPermutationCycles_1(_self), function () {
      ...
      return _if_3(_isPermutationList_1(_self), function () {
        ...
        return _error_2(_self, "List>>permutationDegree: not a permutation");
      });
    });
  },
  "{ :self | if(isPermutationCycles(self), { if(isEmpty(self), { 0 }, { max(concatenation(self)) }) }, { if(isPermutationList(self), { max(self) }, { error(self,'List>>permutationDegree: not a permutation') }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :size | gather(subsets(self, { :each | =(size(each), size) }),permutations:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_k) {
    ...
    /* Statements */
    return _collect_2(_upOrDownTo_2(0, _hyphenMinus_2(_n, 1)), function (_i) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _i";
        throw new Error(errorMessage);
