...
sl.addMethodToExistingType(
  ...
  "{ :self | if((=(scale(self), 0)), { ++(basicPrintString(asLargeInteger(integerPart(self)),10), 'D') }, { format('%%.%D',[if(isNegative(fraction(self)), { '-' }, { '' }), basicPrintString(abs(asLargeInteger(integerPart(self))),10), basicPrintString(round((*(abs(fraction(fractionalPart(self))), (^(10, scale(self)))))),10)]) }) }",
);
