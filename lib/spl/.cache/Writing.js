...
sl.addMethodToExistingType(
  ...
  '{ :self :options | let precision = at(options, \'precision\'); let __SplVar1 = assertIsOfSize(lowerLeft(self), 2); let x = at(__SplVar1, 1); let y = at(__SplVar1, 2); [format(\'<g x="%" y="%" transform="translate(%, %) scale(1, -1)">\',[printStringToFixed(x,precision), printStringToFixed(y,precision), printStringToFixed(x,precision), printStringToFixed(y,precision)]), format(\'<text fill="black" stroke="none">%</text>\',[contents(self)]), \'</g>\'] }',
);
