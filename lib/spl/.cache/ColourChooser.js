...
sl.addMethod(
  ...
  function (_self, _initialColour, _onSelect_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _initialColour, _onSelect_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _onSelect_1) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _onSelect_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function (_self, _subject, _event) {
    ...
    return _addFrame_3(
      ...
      _ColourChooser_1(function (_aColour) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _aColour"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
