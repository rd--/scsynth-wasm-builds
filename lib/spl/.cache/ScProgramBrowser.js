      ...
      _copyWithoutDuplicates_1(
        _collect_2(
          _select_2(_contents_1(_self), function (_each) {
            ...
            /* Statements */
            return _equals_2(_at_2(_each, 1), _category);
          }),
          _second_1,
        ),
      ),
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _reject_2(
      _sort_1(
        _copyWithoutDuplicates_1(_collect_2(_contents_1(_self), _first_1)),
      ),
      function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        /* Statements */
        return _equals_2(_each, "collect");
      },
    );
  },
  ...
  function (_self, _category, _author) {
    ...
    return _sort_1(_collect_2(
      _select_2(_contents_1(_self), function (_each) {
        ...
        /* Statements */
        return _and_2(_equals_2(_at_2(_each, 1), _category), function () {
          /* ArityCheck */
          ...
          /* Statements */
          return _equals_2(_at_2(_each, 2), _author);
        });
      }),
      _third_1,
    ));
          ...
          return _caseOf_2(_size_1(_path), [
            ...
            _minusGreaterThan_2(3, function () {
              ...
              let __genSym18 = _assertIsOfSize_2(
                  _commercialAtTimes_2(_path, [1, 2, 3]),
                  3,
                ),
                _category = _at_2(__genSym18, 1),
                _author = _at_2(__genSym18, 2),
                _name = _at_2(__genSym18, 3);
              let _url = _join_1([
