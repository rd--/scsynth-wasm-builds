...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar2 = assertIsOfSize(asList(self), 2); let n = at(__SplVar2, 1); let d = at(__SplVar2, 2); lowerChristoffelWord(self,+(n, d)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar3 = assertIsOfSize(asList(self), 2); let n = at(__SplVar3, 1); let d = at(__SplVar3, 2); lowerChristoffelWord(self,+(n, d)) }",
);
