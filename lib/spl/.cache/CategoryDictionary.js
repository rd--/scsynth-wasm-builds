...
sl.addMethod(
  ...
  function (_self, _domain, _entry) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _domain, _entry"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _entry) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _entry"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _domain, _category, _entry) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _domain, _category, _entry"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _domain, _category, _entries) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _domain, _category, _entries"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _domain, _aBlock_1, _aDictionary) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _domain, _aBlock_1, _aDictionary"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _domain, _aDictionary) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _domain, _aDictionary"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _domain, _category) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _domain, _category"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _domain) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _domain"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
