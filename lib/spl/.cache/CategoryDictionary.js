...
sl.addMethod(
  ...
  function (_self, _domain, _category, _entry) {
    ...
    /* Statements */
    return _add_2(_category_3(_self, _domain, _category), _entry);
  },
...
sl.addMethod(
  ...
  function (_self, _domain, _entry) {
    ...
    return _caseOfOtherwise_3(_size_1(_all), [
      ...
      return _error_2(
        _self,
        _plusPlus_2("categoryOf: multiple categories: ", [_domain, _entry]),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self, _entry) {
    ...
    return _caseOfOtherwise_3(_size_1(_answer), [
      ...
      return _error_2(
        _self,
        _plusPlus_2("categoryOf: multiple categories: ", _entry),
      );
    });
  },
  ...
  function (_self) {
    ...
    _do_2(_domainDictionary_1(_self), function (_each) {
      ...
      return _valuesDo_2(_each, function (_item) {
        ...
        /* Statements */
        return _includeAll_2(_answer, _item);
      });
    });
    return _answer;
  },
  ...
  function (_self, _domain) {
    ...
    return _select_2(
      ...
      function (_each) {
        ...
        /* Statements */
        return _greaterThan_2(_size_1(_value_1(_each)), 1);
      },
    );
  },
