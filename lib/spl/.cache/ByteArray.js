...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _array = _ByteArray_1(_times_2(_size_1(_self), 2));
    let _index = 1;
    /* Statements */
    _do_2(_self, function (_each) {
      ...
      _atPut_3(
        _array,
        _index,
        _at_2(_map, _plus_2(_bitShiftRight_2(_each, 4), 1)),
      );
      _atPut_3(
        _array,
        _plus_2(_index, 1),
        _at_2(_map, _plus_2(_bitAnd_2(_each, 15), 1)),
      );
...
sl.addMethod(
  ...
  "ByteArray",
  "fetchByteArray",
  ["self", "resource", "options", "onErrorBlock"],
  function (_self, _resource, _options, _onErrorBlock) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _resource, _options, _onErrorBlock";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _then_2(_fetch_3(_self, _resource, _options), function (_response) {
      ...
      return _if_3(_ok_1(_response), function () {
        ...
        /* Statements */
        return _cull_2(_onErrorBlock, _ok_1(_response));
      });
    });
  },
