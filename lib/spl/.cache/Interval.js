...
sl.addMethod(
  ...
  function (_self, _anInterval) {
    ...
    /* Statements */
    return _ampersand_2(_isInterval_1(_anInterval), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _ampersand_2(
        _equalsSign_2(_start_1(_self), _start_1(_anInterval)),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          return _ampersand_2(
            _equalsSign_2(_stop_1(_self), _stop_1(_anInterval)),
            function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
                const errorMessage = "Arity: expected 0, ";
              ...
              /* Statements */
              return _equalsSign_2(_step_1(_self), _step_1(_anInterval));
            },
          );
        },
      );
...
sl.addMethod(
  ...
  function (_self, _arg) {
    ...
    return _if_3(_isSmallFloat_1(_arg), function () {
      ...
      /* Statements */
      return _Interval_3(
        _plusSign_2(_start_1(_self), _arg),
        _plusSign_2(_stop_1(_self), _arg),
        _step_1(_self),
      );
    }, function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _adaptToCollectionAndApply_3(_arg, _self, _plusSign_2);
    });
  },
...
sl.addMethod(
  ...
  function (_self, _arg) {
    ...
    return _if_3(_isSmallFloat_1(_arg), function () {
      ...
      /* Statements */
      return _Interval_3(
        _hyphenMinus_2(_start_1(_self), _arg),
        _hyphenMinus_2(_stop_1(_self), _arg),
        _step_1(_self),
      );
    }, function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _adaptToCollectionAndApply_3(_arg, _self, _hyphenMinus_2);
    });
  },
  "{ :self :arg |\n\t\targ.isSmallFloat.if {\n\t\t\tInterval(self.start - arg, self.stop - arg, self.step)\n\t\t} {\n\t\t\targ.adaptToCollectionAndApply(self, -)\n\t\t}\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self, _second, _last) {
    ...
    /* Statements */
    return _Interval_3(_self, _last, _hyphenMinus_2(_second, _self));
  },
