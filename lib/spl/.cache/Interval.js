  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _lessThanSign_2(_max_1(_self), _min_1(_operand));
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _asterisk_2(_self, _reciprocal_1(_operand));
  }, ["self", "operand"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "centeredInterval",
  ["center", "range"],
  sl.annotateFunction(function (_center, _range) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _center, _range";
      throw new Error(errorMessage);
    } /* Statements */
    return _Interval_2(
      _hyphenMinus_2(_center, _range),
      _plusSign_2(_center, _range),
    );
  }, ["center", "range"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _withCollect_3(_self, _operand, _Interval_2);
  }, ["self", "operand"]),
