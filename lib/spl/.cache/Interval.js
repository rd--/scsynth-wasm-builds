  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _adaptToIntervalAndApply_3(_operand, _self, _lessThanSign_2);
      }, []),
    );
  }, ["self", "operand"]),
...
sl.addMethodToExistingType(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _Interval_2(
              0,
              _max_2(_negate_1(_min_1(_self)), _max_1(_self)),
            );
          }, []),
        );
      }, []),
  ...
  "{ :self | if((>=(min(self), 0)), { self }, { if((<=(max(self), 0)), { negate(self) }, { Interval(0, max(negate(min(self)),max(self))) }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _dx, _n) {
    ...
    let _next = _roundDown_2(_min_1(_self), _dx);
    let _answer = [_next];
    /* Statements */
    _whileTrue_2(
      sl.annotateFunction(function () {
  ...
  "{ :self :dx :n | let step = roundUp((/((-(max(self), min(self))), (+(n, 1)))),dx); let next = roundDown(min(self),dx); let answer = [next]; whileTrue({ <(next, max(self)) }, { next := +(next, step); add(answer,next) }); answer }",
);
...
sl.addMethodToExistingType(
  ...
  "Interval",
  "isCloseToBy",
  ["self", "anInterval", "epsilon"],
  sl.annotateFunction(function (_self, _anInterval, _epsilon) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _anInterval, _epsilon";
      throw new Error(errorMessage);
    } /* Statements */
    return _ampersand_2(
      _isCloseToBy_3(_min_1(_self), _min_1(_anInterval), _epsilon),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        return _isCloseToBy_3(_max_1(_self), _max_1(_anInterval), _epsilon);
      }, []),
    );
  }, ["self", "anInterval", "epsilon"]),
  "{ :self :anInterval :epsilon | &(isCloseToBy(min(self),min(anInterval), epsilon), { isCloseToBy(max(self),max(anInterval), epsilon) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _equalsSign_2(_min_1(_self), _max_1(_self));
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anInterval) {
    ...
    return _verticalLine_2(
      _greaterThanSign_2(_max_1(_self), _min_1(_anInterval)),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        return _greaterThanSign_2(_max_1(_anInterval), _min_1(_self));
      }, []),
    );
  }, ["self", "anInterval"]),
  "{ :self :anInterval | |(>(max(self), min(anInterval)), { >(max(anInterval), min(self)) }) }",
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _solidus_2(_abs_1(_hyphenMinus_2(_max_1(_self), _min_1(_self))), 2);
  }, ["self"]),
  "{ :self | /(abs((-(max(self), min(self)))), 2) }",
);
