...
sl.addMethod(
  ...
  function (_self, _scale, _projection_1) {
    ...
    let _dots = _collect_2(_points, function (_each) {
      ...
      let __genSym194 = _assertIsOfSize_2(_each, 2),
        _x = _at_2(__genSym194, 1),
        _y = _at_2(__genSym194, 2);
      /* Statements */
    ...
    let _lines = _collect_2(_edgeList_1(_self), function (_each) {
      ...
      let __genSym195 = _assertIsOfSize_2(_each, 2),
        _i = _at_2(__genSym195, 1),
        _j = _at_2(__genSym195, 2);
      let __genSym196 = _assertIsOfSize_2(_at_2(_points, _i), 2),
        _x1 = _at_2(__genSym196, 1),
        _y1 = _at_2(__genSym196, 2);
      let __genSym197 = _assertIsOfSize_2(_at_2(_points, _j), 2),
        _x2 = _at_2(__genSym197, 1),
        _y2 = _at_2(__genSym197, 2);
      /* Statements */
      return _createSvgElement_2(
        "line",
        Object.fromEntries([
