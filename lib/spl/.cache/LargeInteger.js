...
sl.addType(
  ...
  "LargeInteger",
  "LargeInteger",
  ["Object", "Comparable", "Binary", "Magnitude", "Number", "Integer"],
  [],
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anObject | ~(asSmallFloat(self), anObject) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anObject | if(isScalarInteger(anObject), { raisedToInteger(self,anObject) }, { adaptToIntegerAndApply(anObject,self, ^) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aNumber :aBlock:/2 | if(isInteger(aNumber), { aBlock(asLargeInteger(aNumber), self) }, { aBlock(aNumber, asSmallFloat(self)) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | if(isSmallInteger(self), { asSmallFloat(self) }, { error(self,'LargeInteger>>asSmallInteger: not small integer') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anObject | <primitive: if (sl.isLargeInteger(_anObject) || sl.isSmallFloatInteger(_anObject)) {\n\t\t\treturn _self / BigInt(_anObject);\n\t\t};>\nadaptToIntegerAndApply(anObject,self, quotient:/2) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anInteger | <primitive: if (sl.isLargeInteger(_anInteger) || sl.isSmallFloatInteger(_anInteger)) {\n\t\t\treturn _self ** BigInt(_anInteger);\n\t\t}>\nerror(self,'raisedToInteger: not integer') }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    /* Statements */
    return _error_2(_self, "ramainder: not integer");
  }, ["self", "anInteger"]),
  "{ :self :anInteger | <primitive: if (sl.isLargeInteger(_anInteger) || sl.isSmallFloatInteger(_anInteger)) {\n\t\t\treturn _self % BigInt(_anInteger);\n\t\t}>\nerror(self,'ramainder: not integer') }",
);
