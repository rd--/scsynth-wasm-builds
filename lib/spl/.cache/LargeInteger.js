...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let _k = _digitLength_1(_self);
    let _h = _highBitOfMagnitude_1(_self);
...
sl.addMethod(
  ...
  function (_min, _max) {
    ...
    /* Statements */
    return _plusSign_2(_randomInteger_1(_hyphenMinus_2(_max, _min)), _min);
  },
