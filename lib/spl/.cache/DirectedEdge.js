...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL9 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _from = _at_2(__SPL9, 1);
    let _to = _at_2(__SPL9, 2);
    /* Statements */
    return _hyphenMinusGreaterThanSign_2(_from, _to);
  }, ["self"]),
  "{ :self | let __SPL9 = assertIsOfSize(vertexList(self), 2); let from = at(__SPL9, 1); let to = at(__SPL9, 2); ->(from, to) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL10 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL10, 1);
    let _j = _at_2(__SPL10, 2);
    /* Statements */
    return _UndirectedEdge_2(_i, _j);
  }, ["self"]),
  "{ :self | let __SPL10 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL10, 1); let j = at(__SPL10, 2); UndirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _isMixed) {
    ...
    let __SPL11 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _from = _at_2(__SPL11, 1);
    let _to = _at_2(__SPL11, 2);
    /* Statements */
    return _format_2("% -> %;", [_from, _to]);
  }, ["self", "isMixed"]),
  "{ :self :isMixed | let __SPL11 = assertIsOfSize(vertexList(self), 2); let from = at(__SPL11, 1); let to = at(__SPL11, 2); format('% -> %;',[from, to]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL12 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL12, 1);
    let _j = _at_2(__SPL12, 2);
    /* Statements */
    return _format_2("% --> %", [_i, _j]);
  }, ["self"]),
  "{ :self | let __SPL12 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL12, 1); let j = at(__SPL12, 2); format('% --> %',[i, j]) }",
);
