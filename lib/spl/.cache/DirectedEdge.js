...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _from = _at_2(__SPL12, 1);
    let _to = _at_2(__SPL12, 2);
    /* Statements */
    return _hyphenMinusGreaterThanSign_2(_from, _to);
  }, ["self"]),
  "{ :self | let __SPL12 = assertIsOfSize(vertexList(self), 2); let from = at(__SPL12, 1); let to = at(__SPL12, 2); ->(from, to) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL13 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL13, 1);
    let _j = _at_2(__SPL13, 2);
    /* Statements */
    return _UndirectedEdge_2(_i, _j);
  }, ["self"]),
  "{ :self | let __SPL13 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL13, 1); let j = at(__SPL13, 2); UndirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :isMixed | let __SPL14 = assertIsOfSize(vertexList(self), 2); let from = at(__SPL14, 1); let to = at(__SPL14, 2); format('% -> %;',[from, to]) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL15 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL15, 1); let j = at(__SPL15, 2); format('% --> %',[i, j]) }",
);
