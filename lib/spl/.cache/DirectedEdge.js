...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar1 = assertIsOfSize(vertexList(self), 2); let from = at(__SplVar1, 1); let to = at(__SplVar1, 2); ->(from, to) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar2 = assertIsOfSize(vertexList(self), 2); let i = at(__SplVar2, 1); let j = at(__SplVar2, 2); UndirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :isMixed | let __SplVar3 = assertIsOfSize(vertexList(self), 2); let from = at(__SplVar3, 1); let to = at(__SplVar3, 2); format('% -> %;',[from, to]) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar4 = assertIsOfSize(vertexList(self), 2); let i = at(__SplVar4, 1); let j = at(__SplVar4, 2); format('% --> %',[i, j]) }",
);
