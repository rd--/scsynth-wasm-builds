...
sl.addMethod(
  ...
  function (_self, _options) {
    ...
    /* Statements */
    _postLine_1(_plusPlus_2("Terse Guide Summary: Areas = ", _size_1(_areas)));
    _do_2(_areas, function (_area) {
      ...
      let _entries = _reject_2(_lines_1(_area), function (_line) {
        ...
        /* Statements */
        return _or_2(_isEmpty_1(_line), function () {
          /* ArityCheck */
          ...
          /* Statements */
          return _equals_2(_line, "```");
        });
      });
      let _testCount = _minus_2(_size_1(_entries), 1);
      let _failCount = 0;
      let _passCount = 0;
      /* Statements */
      _postLine_1(_at_2(_entries, 1));
      _collect_2(_to_2(2, _plus_2(_testCount, 1)), function (_index) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        return _if_3(_equals_2(_evaluate_2(_system, _test), true), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          /* Statements */
          return _passCount = _plus_2(_passCount, 1);
        }, function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          _failCount = _plus_2(_failCount, 1);
          return _postLine_1(_plusPlus_2("	Error: ", _test));
        });
      });
      _totalTestCount = _plus_2(_totalTestCount, _testCount);
      _totalPassCount = _plus_2(_totalPassCount, _passCount);
      return _postLine_1(
        _join_1([
          "	=> ",
          _passCount,
          " / ",
          _testCount,
          _if_3(_greaterThan_2(_failCount, 0), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
            ...
            /* Statements */
            return _plusPlus_2(_plusPlus_2(" (", _failCount), " Failures)");
          }, function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
    ...
    return _postLine_1(
      _plusPlus_2(
        _plusPlus_2(_plusPlus_2("Total => ", _totalPassCount), " / "),
        _totalTestCount,
      ),
    );
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _then_2(
      _fetchText_2(_asUrl_1(_self), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _error_2(_self, "terseGuideSummary: fetch failed");
      }),
      function (_text) {
        /* ArityCheck */
        if (arguments.length !== 1) {
