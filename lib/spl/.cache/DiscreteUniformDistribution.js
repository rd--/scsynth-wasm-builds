...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL1 = assertIsOfSize(if(isVector(self), { self }, { transpose(self) }), 2); let a = at(__SPL1, 1); let b = at(__SPL1, 2); initializeSlots(newDiscreteUniformDistribution(),a, b) }",
);
