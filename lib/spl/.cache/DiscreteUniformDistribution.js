...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL535 = _assertIsOfSize_2(
      _if_3(
        _isVector_1(_self),
        sl.annotateFunction(function () {
          /* ArityCheck */
    ...
    let _a = _at_2(__SPL535, 1);
    let _b = _at_2(__SPL535, 2);
    /* Statements */
    return _initializeSlots_3(_newDiscreteUniformDistribution_0(), _a, _b);
  }, ["self"]),
  "{ :self | let __SPL535 = assertIsOfSize(if(isVector(self), { self }, { transpose(self) }), 2); let a = at(__SPL535, 1); let b = at(__SPL535, 2); initializeSlots(newDiscreteUniformDistribution(),a, b) }",
);
