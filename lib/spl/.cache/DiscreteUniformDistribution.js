...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _a = _at_2(__SPL326, 1);
    let _b = _at_2(__SPL326, 2);
    /* Statements */
    return _initializeSlots_3(_newDiscreteUniformDistribution_0(), _a, _b);
  }, ["self"]),
  "{ :self | let __SPL326 = assertIsOfSize(if(isVector(self), { self }, { transposed(self) }), 2); let a = at(__SPL326, 1); let b = at(__SPL326, 2); initializeSlots(newDiscreteUniformDistribution(),a, b) }",
);
