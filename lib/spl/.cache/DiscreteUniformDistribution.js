...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL534 = _assertIsOfSize_2(
      _if_3(
        _isVector_1(_self),
        sl.annotateFunction(function () {
          /* ArityCheck */
    ...
    let _a = _at_2(__SPL534, 1);
    let _b = _at_2(__SPL534, 2);
    /* Statements */
    return _initializeSlots_3(_newDiscreteUniformDistribution_0(), _a, _b);
  }, ["self"]),
  "{ :self | let __SPL534 = assertIsOfSize(if(isVector(self), { self }, { transpose(self) }), 2); let a = at(__SPL534, 1); let b = at(__SPL534, 2); initializeSlots(newDiscreteUniformDistribution(),a, b) }",
);
