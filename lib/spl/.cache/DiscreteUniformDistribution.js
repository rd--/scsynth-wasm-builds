...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL309 = _assertIsOfSize_2(
      _if_3(
        _isVector_1(_self),
        sl.annotateFunction(function () {
          /* ArityCheck */
  ...
  "{ :self | let __SPL309 = assertIsOfSize(if(isVector(self), { self }, { transposed(self) }), 2); let a = at(__SPL309, 1); let b = at(__SPL309, 2); initializeSlots(newDiscreteUniformDistribution(),a, b) }",
);
