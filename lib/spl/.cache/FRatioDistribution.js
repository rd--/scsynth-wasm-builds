...
sl.addMethodToExistingType(
  ...
  "{ :self :r :shape | let n = randomVariate(ChiSquareDistribution(n(self)),r, shape); let d = randomVariate(ChiSquareDistribution(m(self)),r, shape); *((/(n, d)), (/(m(self), n(self)))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n :m | initializeSlots(newFRatioDistribution(),n, m) }",
);
