...
sl.addMethod(
  ...
  function (_self, _px, _py, _pz) {
    ...
    /* Temporaries */
    let _solarMass = _times_2(_times_2(4, _pi), _pi);
    /* Statements */
    _vx_2(_self, _minus_2(0.0, _dividedBy_2(_px, _solarMass)));
    _vy_2(_self, _minus_2(0.0, _dividedBy_2(_py, _solarMass)));
    return _vz_2(_self, _minus_2(0.0, _dividedBy_2(_pz, _solarMass)));
  },
...
sl.addMethod(
  ...
  function (_x, _y, _z, _vx, _vy, _vz, _mass) {
    ...
    return _initializeSlots_8(
      ...
      _y,
      _z,
      _times_2(_vx, _daysPerYear),
      _times_2(_vy, _daysPerYear),
      _times_2(_vz, _daysPerYear),
      _times_2(_mass, _solarMass),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _dt) {
    ...
    _toDo_3(1, _size_1(_bodies_1(_self)), function (_i) {
      ...
      /* Statements */
      return _toDo_3(_plus_2(_i, 1), _size_1(_bodies_1(_self)), function (_j) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        let _dx = _minus_2(_x_1(_iBody), _x_1(_jBody));
        let _dy = _minus_2(_y_1(_iBody), _y_1(_jBody));
        let _dz = _minus_2(_z_1(_iBody), _z_1(_jBody));
        let _dSquared = _plus_2(
          _plus_2(_times_2(_dx, _dx), _times_2(_dy, _dy)),
          _times_2(_dz, _dz),
        );
        let _distance = _sqrt_1(_dSquared);
        let _mag = _dividedBy_2(_dt, _times_2(_dSquared, _distance));
        /* Statements */
        _vx_2(
          _iBody,
          _minus_2(
            _vx_1(_iBody),
            _times_2(_times_2(_dx, _mass_1(_jBody)), _mag),
          ),
        );
        _vy_2(
          _iBody,
          _minus_2(
            _vy_1(_iBody),
            _times_2(_times_2(_dy, _mass_1(_jBody)), _mag),
          ),
        );
        _vz_2(
          _iBody,
          _minus_2(
            _vz_1(_iBody),
            _times_2(_times_2(_dz, _mass_1(_jBody)), _mag),
          ),
        );
        _vx_2(
          _jBody,
          _plus_2(
            _vx_1(_jBody),
            _times_2(_times_2(_dx, _mass_1(_iBody)), _mag),
          ),
        );
        _vy_2(
          _jBody,
          _plus_2(
            _vy_1(_jBody),
            _times_2(_times_2(_dy, _mass_1(_iBody)), _mag),
          ),
        );
        return _vz_2(
          _jBody,
          _plus_2(
            _vx_1(_jBody),
            _times_2(_times_2(_dz, _mass_1(_iBody)), _mag),
          ),
        );
      });
    });
    return _do_2(_bodies_1(_self), function (_body) {
      ...
      /* Statements */
      _x_2(_body, _plus_2(_x_1(_body), _times_2(_dt, _vx_1(_body))));
      _y_2(_body, _plus_2(_y_1(_body), _times_2(_dt, _vy_1(_body))));
      return _z_2(_body, _plus_2(_z_1(_body), _times_2(_dt, _vz_1(_body))));
    });
  },
  ...
  function (_self) {
    ...
    _toDo_3(1, _size_1(_bodies_1(_self)), function (_i) {
      ...
      _e = _plus_2(
        _e,
        _times_2(
          _times_2(0.5, _mass_1(_iBody)),
          _plus_2(
            _plus_2(
              _times_2(_vx_1(_iBody), _vx_1(_iBody)),
              _times_2(_vy_1(_iBody), _vy_1(_iBody)),
            ),
            _times_2(_vz_1(_iBody), _vz_1(_iBody)),
          ),
        ),
      );
      return _toDo_3(_plus_2(_i, 1), _size_1(_bodies_1(_self)), function (_j) {
        ...
        return _e = _minus_2(
          _e,
          _dividedBy_2(_times_2(_mass_1(_iBody), _mass_1(_jBody)), _distance),
        );
      });
    });
    return _e;
...
sl.addMethod(
  ...
  function () {
    ...
    _do_2(_bodies, function (_b) {
      ...
      /* Statements */
      _px = _plus_2(_px, _times_2(_vx_1(_b), _mass_1(_b)));
      _py = _plus_2(_py, _times_2(_vy_1(_b), _mass_1(_b)));
      return _pz = _plus_2(_pz, _times_2(_vz_1(_b), _mass_1(_b)));
    });
...
sl.addMethod(
  ...
  function () {
    ...
    return _Benchmark_3(
      "NBody",
      _asMap_1([
        _minusGreaterThan_2(1, -0.16907495402506745),
        _minusGreaterThan_2(250000, -0.1690859889909308),
      ]),
