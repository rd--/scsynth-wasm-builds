...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ Benchmark('NBody', Map([[1, -0.16907495402506745], [250000, -0.1690859889909308]]), { :iterations | let system = NBodySystem(); timesRepeat(iterations, { advance(system,0.01) }); energy(system) }) }",
);
