...
sl.addMethod(
  ...
  function (_self, _px, _py, _pz) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _px, _py, _pz"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _solarMass = _asterisk_2(_asterisk_2(4, _pi), _pi);
    /* Statements */
...
sl.addMethod(
  ...
  function (_x, _y, _z, _vx, _vy, _vz, _mass) {
    ...
    if (arguments.length !== 7) {
      const errorMessage =
        "Arity: expected 7, _x, _y, _z, _vx, _vy, _vz, _mass"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _dt) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _dt"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    ...
    return _do_2(_bodies_1(_self), function (_body) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _body"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function () {
    ...
    _do_2(_bodies, function (_b) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _b"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
