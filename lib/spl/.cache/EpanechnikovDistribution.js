...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _c = _c_1(_self);
    let _negativeC = _hyphenMinus_2(0, _c);
    ...
    return sl.annotateFunction(function (_x) {
      ...
      let _y = _clip_3(_x, _negativeC, _c);
      /* Statements */
  ...
  "{ :self | let c = c(self); let negativeC = -(0, c); let m = /(3, (*(4, c))); { :x | let y = clip(x,negativeC, c); -(+(0.5, (*(m, y))), (/((^(y, 3)), (*(4, (^(c, 3))))))) } }",
);
