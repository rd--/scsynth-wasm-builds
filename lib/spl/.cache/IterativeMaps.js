sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b | let alpha = 0.5; let beta = -(1, alpha); { :v | let __SPL1 = assertIsOfSize(v, 2); let x = at(__SPL1, 1); let y = at(__SPL1, 2); if((<(y, alpha)), { %([*(a, x), /(y, alpha)], 1) }, { %([+((-(1, b)), (*(b, x))), /((-(y, alpha)), beta)], 1) }) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c :d | { :v | let __SPL2 = assertIsOfSize(v, 2); let x = at(__SPL2, 1); let y = at(__SPL2, 2); [-(sin((*(a, y))), cos((*(b, x)))), -(sin((*(c, x))), cos((*(d, y))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b | { :v | let __SPL3 = assertIsOfSize(v, 2); let x = at(__SPL3, 1); let y = at(__SPL3, 2); [y, -(-((*(a, y)), (*(b, x))), (*(*(y, y), y)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a | let s = sin(a); let c = cos(a); { :v | let __SPL4 = assertIsOfSize(v, 2); let x = at(__SPL4, 1); let y = at(__SPL4, 2); let m = -(y, (*(x, x))); [-((*(x, c)), (*(m, s))), +((*(x, s)), (*(m, c)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b | { :v | let __SPL5 = assertIsOfSize(v, 2); let x = at(__SPL5, 1); let y = at(__SPL5, 2); [-(+(y, 1), (*(*(a, x), x))), *(b, x)] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :u | { :v | let __SPL6 = assertIsOfSize(v, 2); let x = at(__SPL6, 1); let y = at(__SPL6, 2); let t = -(0.4, (/(6, (+(+(1, squared(x)), squared(y)))))); [+(1, (*(u, (-((*(x, cos(t))), (*(y, sin(t)))))))), *(u, (+((*(x, sin(t))), (*(y, cos(t))))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c | { :v | let __SPL7 = assertIsOfSize(v, 2); let x = at(__SPL7, 1); let y = at(__SPL7, 2); [-(y, (*(sign(x), sqrt(abs((-(*(b, x), c))))))), -(a, x)] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :k | { :v | let __SPL8 = assertIsOfSize(v, 2); let p = at(__SPL8, 1); let theta = at(__SPL8, 2); let pPrime = %((+(p, (*(k, sin(theta))))), pi(2)); [pPrime, %((+(theta, pPrime)), pi(2))] } }",
);
