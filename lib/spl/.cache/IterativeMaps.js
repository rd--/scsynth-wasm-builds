sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    return sl.annotateFunction(function (_v) {
      ...
      let _x = _at_2(__SPL424, 1);
      let _y = _at_2(__SPL424, 2);
      /* Statements */
      return _if_3(
  ...
  "{ :a :b | let alpha = 0.5; let beta = -(1, alpha); { :v | let __SPL424 = assertIsOfSize(v, 2); let x = at(__SPL424, 1); let y = at(__SPL424, 2); if((<(y, alpha)), { %([*(a, x), /(y, alpha)], 1) }, { %([+((-(1, b)), (*(b, x))), /((-(y, alpha)), beta)], 1) }) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c :d | { :v | let __SPL425 = assertIsOfSize(v, 2); let x = at(__SPL425, 1); let y = at(__SPL425, 2); [-(sin((*(a, y))), cos((*(b, x)))), -(sin((*(c, x))), cos((*(d, y))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b | { :v | let __SPL426 = assertIsOfSize(v, 2); let x = at(__SPL426, 1); let y = at(__SPL426, 2); [y, -(-((*(a, y)), (*(b, x))), (*(*(y, y), y)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a | let s = sin(a); let c = cos(a); { :v | let __SPL427 = assertIsOfSize(v, 2); let x = at(__SPL427, 1); let y = at(__SPL427, 2); let m = -(y, (*(x, x))); [-((*(x, c)), (*(m, s))), +((*(x, s)), (*(m, c)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b | { :v | let __SPL428 = assertIsOfSize(v, 2); let x = at(__SPL428, 1); let y = at(__SPL428, 2); [-(+(y, 1), (*(*(a, x), x))), *(b, x)] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :u | { :v | let __SPL429 = assertIsOfSize(v, 2); let x = at(__SPL429, 1); let y = at(__SPL429, 2); let t = -(0.4, (/(6, (+(+(1, square(x)), square(y)))))); [+(1, (*(u, (-((*(x, cos(t))), (*(y, sin(t)))))))), *(u, (+((*(x, sin(t))), (*(y, cos(t))))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c | { :v | let __SPL430 = assertIsOfSize(v, 2); let x = at(__SPL430, 1); let y = at(__SPL430, 2); [-(y, (*(sign(x), sqrt(abs((-(*(b, x), c))))))), -(a, x)] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_k) {
    ...
    return sl.annotateFunction(function (_v) {
      ...
      let _p = _at_2(__SPL431, 1);
      let _theta = _at_2(__SPL431, 2);
  ...
  "{ :k | { :v | let __SPL431 = assertIsOfSize(v, 2); let p = at(__SPL431, 1); let theta = at(__SPL431, 2); let pPrime = %((+(p, (*(k, sin(theta))))), pi(2)); [pPrime, %((+(theta, pPrime)), pi(2))] } }",
);
