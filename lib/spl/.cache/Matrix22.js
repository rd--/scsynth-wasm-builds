...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL214 = _assertIsOfSize_2(_self, 4);
  ...
  "{ :self | let __SPL214 = assertIsOfSize(self, 4); let a = at(__SPL214, 1); let b = at(__SPL214, 2); let c = at(__SPL214, 3); let d = at(__SPL214, 4); Matrix22(a, b, c, d) }",
);
