...
sl.addMethod(
  ...
  function (_self, _aMatrix) {
    ...
    /* Statements */
    return _and_2(_isMatrix22_1(_aMatrix), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _and_2(_equals_2(_a_1(_self), _a_1(_aMatrix)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _and_2(_equals_2(_b_1(_self), _b_1(_aMatrix)), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          /* Statements */
          return _and_2(_equals_2(_c_1(_self), _c_1(_aMatrix)), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
            ...
            /* Statements */
            return _equals_2(_d_1(_self), _d_1(_aMatrix));
          });
        });
      });
    });
...
sl.addMethod(
  ...
  function (_self, _vector) {
    ...
    return _RectangularCoordinate_2(
      _plus_2(
        _times_2(_a_1(_self), _x_1(_vector)),
        _times_2(_b_1(_self), _y_1(_vector)),
      ),
      _plus_2(
        _times_2(_c_1(_self), _x_1(_vector)),
        _times_2(_d_1(_self), _y_1(_vector)),
      ),
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _minus_2(
      _times_2(_a_1(_self), _d_1(_self)),
      _times_2(_b_1(_self), _c_1(_self)),
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let _m = _dividedBy_2(1, _determinant_1(_self));
    /* Statements */
    return _initializeSlots_5(
      _self,
      _times_2(_d_1(_self), _m),
      _times_2(_negated_1(_b_1(_self)), _m),
      _times_2(_negated_1(_c_1(_self)), _m),
      _times_2(_a_1(_self), _m),
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym4 = _assertIsOfSize_2(_self, 4),
      _a = _at_2(__genSym4, 1),
      _b = _at_2(__genSym4, 2),
      _c = _at_2(__genSym4, 3),
      _d = _at_2(__genSym4, 4);
    /* Statements */
