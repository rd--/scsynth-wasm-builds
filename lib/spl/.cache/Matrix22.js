...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL213 = _assertIsOfSize_2(_self, 4);
    let _a = _at_2(__SPL213, 1);
    let _b = _at_2(__SPL213, 2);
    let _c = _at_2(__SPL213, 3);
    let _d = _at_2(__SPL213, 4);
    /* Statements */
    return _Matrix22_4(_a, _b, _c, _d);
  }, ["self"]),
  "{ :self | let __SPL213 = assertIsOfSize(self, 4); let a = at(__SPL213, 1); let b = at(__SPL213, 2); let c = at(__SPL213, 3); let d = at(__SPL213, 4); Matrix22(a, b, c, d) }",
);
