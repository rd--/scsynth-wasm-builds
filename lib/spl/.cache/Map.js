...
sl.addTraitMethod(
  ...
  function (_self, _key) {
    ...
    /* Statements */
    return _error_2(_self, _plusPlus_2("at: unknown key: ", _key));
  },
...
sl.addMethod(
  ...
  function (_self, _replacer, _space) {
    ...
    return _if_3(_allSatisfy_2(_indices_1(_self), _isString_1), function () {
      ...
      /* Statements */
      return _json_3(_asRecord_1(_self), _replacer, _space);
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      /* Statements */
      return _error_2(_self, "json: not all keys are strings");
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_storeString_1(_associations_1(_self)), ".asMap");
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _mapFromTwoElementArrays_1(_collect_2(_self, _asArray_1));
  },
