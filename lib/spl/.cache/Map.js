...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __genSym31 = _at_2(__SPL30, 1);
  ...
  "{ :self | if(isAssociationList(self), { mapFromTwoElementLists(collect(self,asList:/1)) }, { let __SPL30 = assertIsOfSize(shape(self), 2); let _ = at(__SPL30, 1); let n = at(__SPL30, 2); if((=(n, 2)), { mapFromTwoElementLists(self) }, { error(self,'List>>asMap: not association list or two column matrix') }) }) }",
);
