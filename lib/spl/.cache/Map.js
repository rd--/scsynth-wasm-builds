...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _encodeJson_3(_self, null, "");
  }, ["self"]),
  "{ :self |\n\t\tself.encodeJson(nil, '')\n\t}",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _replacer, _space) {
    ...
    return _encodeJson_3(_asRecord_1(_self), _replacer, _space);
  }, ["self", "replacer", "space"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _format_2("Map(%)", [_storeString_1(_keysAndValues_1(_self))]);
  }, ["self"]),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _uncheckedMatrixToMap_1(_collect_2(_self, _keyAndValue_1));
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                return _error_2(_self, "Map: invalid list");
              }, []),
            );
          }, []),
        );
