...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar1 = assertIsOfSize(dimensions(self), 2); let _ = at(__SplVar1, 1); let m = at(__SplVar1, 2); if((=(m, 2)), { uncheckedListToMap(self) }, { error(self,'List>>listToMap') }) }",
);
