...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    return _forSvg_2(_Line_1([_u_1(_self), _v_1(_self)]), _options);
  }, ["self", "options"]),
  "{ :self :options | forSvg(Line([u(self), v(self)]),options) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        _whileTrue_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL23 = _assertIsOfSize_2(_at_2(_self, _i), 2);
  ...
  "{ :self :eq:/2 | let answer = []; whileTrue({ not(isEmpty(self)) }, { let l = at(self, 1); let __SPL22 = assertIsOfSize(l, 2); let p = at(__SPL22, 1); let q = at(__SPL22, 2); let i = 1; removeAt(self,1); whileTrue({ <=(i, size(self)) }, { let __SPL23 = assertIsOfSize(at(self, i), 2); let a = at(__SPL23, 1); let b = at(__SPL23, 2); let matched = true; if(eq(p, a), { addFirst(l,b); p := b }, { if(eq(p, b), { addFirst(l,a); p := a }, { if(eq(q, a), { addLast(l,b); q := b }, { if(eq(q, b), { addLast(l,a); q := a }, { matched := false }) }) }) }); if(matched, { removeAt(self,i); i := 1 }, { i := +(i, 1) }) }); add(answer,l) }); answer }",
);
