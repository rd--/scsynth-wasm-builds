...
sl.addMethod(
  ...
  function (_self, _aDuration) {
    ...
    return _asTimeStamp_1(
      _plus_2(_unixTimeInMilliseconds_1(_self), _milliseconds_1(_aDuration)),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _aDuration) {
    ...
    /* Statements */
    return _asTimeStamp_1(
      _minus_2(_unixTimeInMilliseconds_1(_self), _milliseconds_1(_aDuration)),
    );
  },
  "{ :self :aDuration |\n\t\t(self.unixTimeInMilliseconds - aDuration.milliseconds).asTimeStamp\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_unixTimeInMilliseconds_1(_self), 1000);
  },
...
sl.addMethod(
  ...
  function (_self, _time) {
    ...
    return _valueAfterMilliseconds_2(
      _self,
      _minus_2(_unixTimeInMilliseconds_1(_time), _now),
    );
  },
