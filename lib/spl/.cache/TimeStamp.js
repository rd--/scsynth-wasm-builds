...
sl.addMethod(
  ...
  function (_self, _aTimeStamp) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aTimeStamp"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _time) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _time"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _time, _anObject) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _time, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _now = _unixTimeInMilliseconds_1(_system);
