...
sl.addTraitMethod(
  ...
  function (_self, _anInteger, _value) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _anInteger, _value"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_n) {
    ...
    _whileTrue_2(function () {
      ...
      return _tildeEqualsSign_2(_n, 0);
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage =
    ...
    return _cached_3(_self, "highBitPerByteTable", function () {
      ...
      return _asByteArray_1(
        _injectInto_3(_upOrDownTo_2(1, 8), [0], function (_highBits, _rank) {
          ...
          if (arguments.length !== 2) {
            const errorMessage =
              "Arity: expected 2, _highBits, _rank"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Statements */
        ...
        _allButFirst_1(
          _injectInto_3(
            ...
            function (_lowBits, _unusedRank) {
              ...
              if (arguments.length !== 2) {
                const errorMessage =
                  "Arity: expected 2, _lowBits, _unusedRank"; /* console.error(errorMessage); */
                throw new Error(errorMessage);
              }
              /* Temporaries */
