...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _fromDigits_2(_reverse_1(_integerDigits_3(_self, 2, _anInteger)), 2);
  }, ["self", "anInteger"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _bitOr_2(_self, _bitShift_2(1, _anInteger));
  }, ["self", "anInteger"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return sl.annotateFunction(function (_n) {
      ...
      _n = _bitXor_2(_n, _bitShiftLeft_2(_n, _a));
      _n = _bitXor_2(_n, _bitShiftRightUnsigned_2(_n, _b));
      _n = _bitXor_2(_n, _bitShiftLeft_2(_n, _c));
      return _n;
    }, ["n"]);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "xorShift32",
  ["n", "shape"],
  sl.annotateFunction(function (_n, _shape) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _n, _shape";
      throw new Error(errorMessage);
    } /* Temporaries */
    let _k = _product_1(_shape);
    /* Statements */
    return _reshape_2(_nestList_3(_xorShift32_1([13, 17, 5]), _n, _k), _shape);
  }, ["n", "shape"]),
