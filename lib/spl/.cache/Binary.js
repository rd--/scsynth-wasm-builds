...
sl.addTraitMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Statements */
    return _bitAnd_2(_bitShift_2(_self, _minus_2(1, _anInteger)), 1);
  },
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _at_2(_bitCountPerByteTable_1(_system), _plus_2(_self, 1));
  },
...
sl.addTraitMethod(
  ...
  function (_self, _anInteger) {
    ...
    return _if_3(_negative_1(_anInteger), function () {
      ...
      /* Statements */
      return _greaterThanGreaterThan_2(_self, _negated_1(_anInteger));
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      /* Statements */
      return _lessThanLessThan_2(_self, _anInteger);
    });
  },
...
sl.addTraitMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Statements */
    return _greaterThanGreaterThan_2(_self, _anInteger);
  },
  "{ :self :anInteger |\n\t\tself >> anInteger\n\t}",
);
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _at_2(_highBitPerByteTable_1(_system), _plus_2(_self, 1));
  },
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    _whileFalse_2(function () {
      ...
      /* Statements */
      return _lessThan_2(_shifted, 65536);
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      return _bitNo = _plus_2(_bitNo, 16);
    });
    _ifFalse_2(_lessThan_2(_shifted, 256), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      return _bitNo = _plus_2(_bitNo, 8);
    });
    return _plus_2(_bitNo, _highBitOfByte_1(_shifted));
  },
  ...
  function (_self) {
    ...
    return _if_3(_equals_2(_self, 0), function () {
      ...
      _whileTrue_2(function () {
        ...
        /* Statements */
        _result = _plus_2(_result, 8);
        return _n = _bitShift_2(_n, -8);
      });
      return _plus_2(_result, _at_2(_lowBitPerByteTable_1(_system), _lastByte));
    });
  },
    ...
    return _cached_3(_self, "bitCountPerByteTable", function () {
      ...
      return _asByteArray_1(_collect_2(_upOrDownTo_2(0, 255), function (_i) {
        ...
        _whileFalse_2(function () {
          ...
          /* Statements */
          _bitCount = _plus_2(_bitCount, 1);
          return _n = _bitAnd_2(_n, _minus_2(_n, 1));
        });
        return _bitCount;
      }));
    });
        ...
        _allButFirst_1(
          _injectInto_3(
            ...
            function (_lowBits, _unusedRank) {
              ...
              /* Statements */
              _atPut_3(_prefix, 1, _plus_2(_at_2(_lowBits, 1), 1));
              return _plusPlus_2(_prefix, _lowBits);
            },
          ),
        ),
      );
