...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n | let p = primorial(n); -(nextPrime(+(p, 1)), p) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _answer = _isPrimeTrialDivision_1(_self);
        /* Statements */
        return _answer;
      }, []),
    );
  }, ["self"]),
  "{ :self | if(isCachedPrime(system,self), { true }, { let answer = isPrimeTrialDivision(self); answer }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :extendCache | let answer = self; ifTrue(extendCache, { cachedPrimesListExtendedToPrime(system,self) }); whileFalse({ isPrime(answer) }, { answer := +(answer, 1) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | leastPrimeGreaterThanOrEqualTo(self,false) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | sum(Span(1, self, 1), { :k | moebiusMu(k) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _extendCache) {
    ...
    return _leastPrimeGreaterThanOrEqualTo_2(
      _plusSign_2(_self, 1),
      _extendCache,
    );
  }, ["self", "extendCache"]),
  "{ :self :extendCache | leastPrimeGreaterThanOrEqualTo((+(self, 1)),extendCache) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _leastPrimeGreaterThanOrEqualTo_2(_plusSign_2(_self, 1), false);
  }, ["self"]),
  "{ :self | leastPrimeGreaterThanOrEqualTo((+(self, 1)),false) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _index = _hyphenMinus_2(
      _indexOfPrime_1(_leastPrimeGreaterThanOrEqualTo_2(_self, true)),
      1,
    );
    /* Statements */
    return _at_2(_cachedPrimesList_1(_system), _index);
  }, ["self"]),
  "{ :self | let index = -(indexOfPrime(leastPrimeGreaterThanOrEqualTo(self,true)), 1); at(cachedPrimesList(system), index) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _asMultiset_1(_primeFactors_1(_self));
  }, ["self"]),
  "{ :self | asMultiset(primeFactors(self)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if((<=(self, 1)), { [] }, { valueWithReturn({ :return:/1 | let index = 1; let prime = 2; let k = self; let answer = []; repeat({ prime := prime(index); whileTrue({ =(%(k, prime), 0) }, { add(answer,prime); k := //(k, prime); ifTrue((=(k, 1)), { return(answer) }) }); ifTrue((>(square(prime), k)), { add(answer,normal(k)); return(answer) }); index := +(index, 1) }); answer }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _product_1(_collect_2(_factorInteger_1(_self), _key_1));
  }, ["self"]),
  "{ :self | product(collect(factorInteger(self),key:/1)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    /* Statements */
    return _sortBy_2(_plusSignPlusSign_2(_n, _d), _lessThanSignVerticalLine_2);
  }, ["self"]),
  "{ :self | let n = factorInteger(numerator(self)); let d = collect(factorInteger(denominator(self)), { :each | ->(key(each), negate(value(each))) }); sortBy((++(n, d)),<|) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :anInteger | let p = cachedPrimesList(self); &((>=(last(p), anInteger)), { !=(binarySearch(p,anInteger), 0) }) }",
);
