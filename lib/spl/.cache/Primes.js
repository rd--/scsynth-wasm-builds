...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    return _allSatisfy_2(
      _values_1(_asDictionary_1(_primeFactorization_1(_self))),
      function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
  ...
  "{ :self | allSatisfy(values(asDictionary(primeFactorization(self))), { :each | >(each, 1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    return _keys_1(_asDictionary_1(_primeFactorization_1(_self)));
  },
  "{ :self | keys(asDictionary(primeFactorization(self))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let _dictionary = _asDictionary_1(_primeFactorization_1(_self));
    /* Statements */
    return _collect_2(
      ...
      function (_each) {
        ...
        return _atIfAbsent_3(_dictionary, _each, function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            throw new Error(errorMessage);
  ...
  "{ :self | let dictionary = asDictionary(primeFactorization(self)); collect(primesUpTo(max(keys(dictionary))), { :each | atIfAbsent(dictionary, each, { 0 }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    return _size_1(_asDictionary_1(_primeFactorization_1(_self)));
  },
  "{ :self | size(asDictionary(primeFactorization(self))) }",
);
