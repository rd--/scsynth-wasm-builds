...
sl.addMethodToExistingType(
  ...
  "{ :self :aBB :aBool | counter(self, 0); depthLevel(self, 0); isRoot(self, false); nestingLevel(self, 0); header(self, aBB); isReducible(self, aBool); basicBlocks(self, IdentitySet()); children(self, IdentitySet()); ifNotNil(aBB, { uncheckedInclude(basicBlocks(self),aBB) }); self }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :bb | uncheckedInclude(basicBlocks(self),bb) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :loop | uncheckedInclude(children(self),loop) }",
);
