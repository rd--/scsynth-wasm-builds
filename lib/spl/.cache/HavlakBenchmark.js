...
sl.addMethod(
  ...
  function (_self, _cfg, _fromName, _toName) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _cfg, _fromName, _toName"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _to) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _to"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _from) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _from"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _edge) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _edge"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _fromName, _toName) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _fromName, _toName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _cfg, _lsg) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _cfg, _lsg"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    _cfg_2(_self, _cfg);
...
sl.addMethod(
  ...
  function (_self, _w, _v) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _w, _v"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _currentNode, _current) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _currentNode, _current"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _lastId = null;
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _do_2(_basicBlocks_1(_cfg_1(_self)), function (_bb) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _bb"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self, _nodeW, _w) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _nodeW, _w"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _ifTrue_2(_greaterThanSign_2(_numPred_1(_nodeW), 0), function () {
      ...
      return _do_2(_inEdges_1(_nodeW), function (_nodeV) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _nodeV"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Temporaries */
        ...
        return _toByDo_4(_size, 1, -1, function (_w) {
          ...
          return _ifTrue_2(_notNil_1(_nodeW), function () {
            ...
            _do_2(_nodePool, function (_niter) {
              ...
              if (arguments.length !== 1) {
                const errorMessage =
                  "Arity: expected 1, _niter"; /* console.error(errorMessage); */
                throw new Error(errorMessage);
              }
              /* Statements */
...
sl.addMethod(
  ...
  function (_self, _w, _nodePool, _workList, _x) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _w, _nodePool, _workList, _x"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _do_2(
      ...
      function (_iter) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _iter"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _w, _nodePool, _loop) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _w, _nodePool, _loop"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    ...
    return _do_2(_nodePool, function (_node) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _node"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self, _w, _nodePool) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _w, _nodePool"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _do_2(_at_2(_backPreds_1(_self), _w), function (_v) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _v"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self, _lsg) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _lsg"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _bb, _isReducible) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _bb, _isReducible"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _do_2(_loops_1(_self), function (_liter) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _liter"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self, _loop, _depth) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _loop, _depth"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _start) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _start"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _bb0 = _start;
...
sl.addMethod(
  ...
  function (_self, _start, _end) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _start, _end"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _start, _n) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _start, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (
    ...
    if (arguments.length !== 6) {
      const errorMessage =
        "Arity: expected 6, _self, _numDummyLoops, _findLoopIterations, _parLoop, _pparLoops, _ppparLoops"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _parLoops, _pparLoops, _ppparLoops) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _parLoops, _pparLoops, _ppparLoops"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _n = 3;
...
sl.addMethod(
  ...
  function (_self, _numDummyLoops) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _numDummyLoops"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _loopStructure) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _loopStructure"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _aBB, _aBool) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aBB, _aBool"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    _counter_2(_self, 0);
...
sl.addMethod(
  ...
  function (_self, _bb) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _bb"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _loop) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _loop"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _level) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _level"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _isReducible) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _isReducible"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _bb, _dfsNumber) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _bb, _dfsNumber"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _basicBlock) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _basicBlock"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function () {
    ...
    return _Benchmark_3(
      ...
      function (_iterations) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _iterations"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
