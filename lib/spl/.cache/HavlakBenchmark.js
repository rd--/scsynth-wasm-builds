...
sl.addMethod(
  ...
  function (_self, _other) {
    ...
    /* Statements */
    return _equals_2(_name_1(_self), _name_1(_other));
  },
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    /* Statements */
    _inEdges_2(_self, _Array_0());
    _outEdges_2(_self, _Array_0());
    _name_2(_self, _name);
    return _self;
  },
  "{ :self :name |\n\t\tself.inEdges := Array();\n\t\tself.outEdges := Array();\n\t\tself.name := name;\n\t\tself\n\t}",
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    _basicBlockMap_2(_self, _Array_0());
    _edgeList_2(_self, _Array_0());
    return _self;
  },
...
sl.addMethod(
  ...
  function (_self, _name) {
    ...
    _ifTrue_2(_equalsEquals_2(_numNodes_1(_self), 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _cfg, _lsg) {
    ...
    _cfg_2(_self, _cfg);
    _lsg_2(_self, _lsg);
    _nonBackPreds_2(_self, _Array_0());
    _backPreds_2(_self, _Array_0());
...
sl.addMethod(
  ...
  function (_self, _w, _v) {
    ...
    /* Statements */
    return _and_2(_lessThanEquals_2(_w, _v), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _lessThanEquals_2(_v, _at_2(_last_1(_self), _w));
    });
  },
  "{ :self :w :v |\n\t\tw <= v & {\n\t\t\tv <= self.last[w]\n\t\t}\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _currentNode, _current) {
    ...
    _toDo_3(1, _size_1(_outerBlocks), function (_i) {
      ...
      /* Statements */
      return _ifTrue_2(
        _equals_2(_at_2(_number_1(_self), _target), _unvisited_1(_self)),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          return _lastId = _doDFSCurrent_3(_self, _target, _plus_2(_lastId, 1));
        },
      );
    });
...
sl.addMethod(
  ...
  function (_self, _nodeW, _w) {
    ...
    /* Statements */
    return _ifTrue_2(_greaterThan_2(_numPred_1(_nodeW), 0), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      return _do_2(_inEdges_1(_nodeW), function (_nodeV) {
        ...
        /* Statements */
        return _ifTrue_2(_tildeEquals_2(_v, _unvisited_1(_self)), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
  ...
  function (_self) {
    ...
    return _if_3(_isNil_1(_startBasicBlock_1(_cfg_1(_self))), function () {
      ...
      return _valueWithReturn_1(function (_return_1) {
        ...
        _ifTrue_2(_greaterThan_2(_size, _maxSize_1(_self)), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          /* Statements */
          _header_2(_self, _Array_1(_size));
          _type_2(_self, _Array_1(_size));
          _last_2(_self, _Array_1(_size));
          _nodes_2(_self, _Array_1(_size));
        ...
        _toDo_3(1, _size, function (_i) {
          ...
          _addLast_2(_backPreds_1(_self), _Array_0());
        ...
        return _downToDo_3(_size, 1, function (_w) {
          /* ArityCheck */
          if (arguments.length !== 1) {
            const errorMessage = "Arity: expected 1, _w";
            console.error(errorMessage);
          ...
          return _ifTrue_2(_notNil_1(_nodeW), function () {
            ...
            _ifTrue_2(_tildeEquals_2(_size_1(_nodePool), 0), function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
                const errorMessage = "Arity: expected 0, ";
                console.error(errorMessage);
            ...
            _whileFalse_2(function () {
              ...
              /* Statements */
              _ifTrue_2(
                _greaterThan_2(_nonBackSize, _maxNonBackPreds_1(_self)),
                function () {
                  /* ArityCheck */
                  if (arguments.length !== 0) {
                    const errorMessage = "Arity: expected 0, ";
            ...
            return _ifTrue_2(
              _or_2(_greaterThan_2(_size_1(_nodePool), 0), function () {
                /* ArityCheck */
                if (arguments.length !== 0) {
                  const errorMessage = "Arity: expected 0, ";
                  console.error(errorMessage);
                ...
                /* Statements */
                return _equals_2(_at_2(_type_1(_self), _w), "BBSelf");
              }),
              function () {
                /* ArityCheck */
                if (arguments.length !== 0) {
                ...
                let _loop = _createNewLoopReducible_3(
                  _lsg_1(_self),
                  _nodeW,
                  _tildeEquals_2(_at_2(_type_1(_self), _w), "BBIrreducible"),
                );
                /* Statements */
      ...
      function (_iter) {
        ...
        return _if_3(
          ...
          function () {
            ...
            /* Statements */
            return _ifTrue_2(
              _tildeEquals_2(_dfsNumber_1(_ydash), _w),
              function () {
                /* ArityCheck */
                if (arguments.length !== 0) {
                  const errorMessage = "Arity: expected 0, ";
                ...
                return _ifFalse_2(
                  _anySatisfy_2(_nodePool, function (_each) {
                    ...
                    /* Statements */
                    return _equalsEquals_2(_each, _ydash);
                  }),
                  function () {
                    /* ArityCheck */
                    if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self, _w, _nodePool) {
    ...
    return _do_2(_at_2(_backPreds_1(_self), _w), function (_v) {
      ...
      /* Statements */
      return _if_3(_tildeEquals_2(_v, _w), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _loop, _depth) {
    ...
    return _do_2(_children_1(_loop), function (_liter) {
      ...
      /* Statements */
      _calculateNestingLevelRecDepth_3(_self, _liter, _plus_2(_depth, 1));
      return _setNestingLevel_2(
        _loop,
        _max_2(_nestingLevel_1(_loop), _plus_2(1, _nestingLevel_1(_liter))),
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self, _start) {
    ...
    let _bb0 = _start;
    /* Statements */
    _BasicBlockEdge_3(_cfg_1(_self), _bb0, _plus_2(_bb0, 1));
    _BasicBlockEdge_3(_cfg_1(_self), _bb0, _plus_2(_bb0, 2));
    _BasicBlockEdge_3(_cfg_1(_self), _plus_2(_bb0, 1), _plus_2(_bb0, 3));
    _BasicBlockEdge_3(_cfg_1(_self), _plus_2(_bb0, 2), _plus_2(_bb0, 3));
    return _plus_2(_bb0, 3);
  },
...
sl.addMethod(
  ...
  function (_self, _start, _n) {
    ...
    /* Statements */
    _toDo_3(0, _minus_2(_n, 1), function (_i) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _i";
        console.error(errorMessage);
      ...
      return _buildConnectEnd_3(
        _self,
        _plus_2(_start, _i),
        _plus_2(_plus_2(_start, _i), 1),
      );
    });
    return _plus_2(_start, _n);
  },
...
sl.addMethod(
  ...
  function (_self, _parLoops, _pparLoops, _ppparLoops) {
    ...
    return _timesRepeat_2(_parLoops, function () {
      ...
      /* Statements */
      _createNode_2(_cfg_1(_self), _plus_2(_n, 1));
      _buildConnectEnd_3(_self, 2, _plus_2(_n, 1));
      _n = _plus_2(_n, 1);
...
sl.addMethod(
  ...
  function (_self, _level) {
    ...
    return _ifTrue_2(_equals_2(_level, 0), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function () {
    ...
    return _Benchmark_3(
      "Havlak",
      _asMap_1([
        _minusGreaterThan_2(1, [1605, 5213]),
        _minusGreaterThan_2(15, [1647, 5213]),
        _minusGreaterThan_2(150, [2052, 5213]),
        _minusGreaterThan_2(1500, [6102, 5213]),
        _minusGreaterThan_2(15000, [46602, 5213]),
      ]),
