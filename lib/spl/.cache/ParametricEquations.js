...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c, _r) {
    ...
    let __SPL463 = _assertIsOfSize_2(_c, 2);
    let _x0 = _at_2(__SPL463, 1);
    let _y0 = _at_2(__SPL463, 2);
    /* Statements */
    return sl.annotateFunction(function (_t) {
      /* ArityCheck */
      if (arguments.length !== 1) {
  ...
  "{ :c :r | let __SPL463 = assertIsOfSize(c, 2); let x0 = at(__SPL463, 1); let y0 = at(__SPL463, 2); { :t | let x = +(x0, (*(r, cos(t)))); let y = +(y0, (*(r, sin(t)))); [x, y] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c, _r, _theta) {
    ...
    let __SPL464 = _assertIsOfSize_2(_r, 2);
    let _a = _at_2(__SPL464, 1);
    let _b = _at_2(__SPL464, 2);
    let __SPL465 = _assertIsOfSize_2(_c, 2);
    let _x0 = _at_2(__SPL465, 1);
    let _y0 = _at_2(__SPL465, 2);
  ...
  "{ :c :r :theta | let __SPL464 = assertIsOfSize(r, 2); let a = at(__SPL464, 1); let b = at(__SPL464, 2); let __SPL465 = assertIsOfSize(c, 2); let x0 = at(__SPL465, 1); let y0 = at(__SPL465, 2); let p = cos(theta); let q = sin(theta); { :t | let x = -(+(x0, (*(*(a, p), cos(t)))), (*(*(b, q), sin(t)))); let y = +(+(y0, (*(*(a, q), cos(t)))), (*(*(b, p), sin(t)))); [x, y] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL466 = _assertIsOfSize_2(_self, 4);
    let _a = _at_2(__SPL466, 1);
    let _b = _at_2(__SPL466, 2);
    let _c = _at_2(__SPL466, 3);
    let _d = _at_2(__SPL466, 4);
    /* Statements */
  ...
  "{ :self | let __SPL466 = assertIsOfSize(self, 4); let a = at(__SPL466, 1); let b = at(__SPL466, 2); let c = at(__SPL466, 3); let d = at(__SPL466, 4); { :x | -(-(-((/(d, x)), (*(a, square(x)))), (*(b, x))), c) } }",
);
