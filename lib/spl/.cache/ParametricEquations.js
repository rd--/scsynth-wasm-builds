...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :c :r | let __SPL1 = assertIsOfSize(c, 2); let x0 = at(__SPL1, 1); let y0 = at(__SPL1, 2); { :t | let x = +(x0, (*(r, cos(t)))); let y = +(y0, (*(r, sin(t)))); [x, y] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c, _r, _theta) {
    ...
    let __SPL2 = _assertIsOfSize_2(_r, 2);
    let _a = _at_2(__SPL2, 1);
    let _b = _at_2(__SPL2, 2);
    let __SPL3 = _assertIsOfSize_2(_c, 2);
    let _x0 = _at_2(__SPL3, 1);
    let _y0 = _at_2(__SPL3, 2);
  ...
  "{ :c :r :theta | let __SPL2 = assertIsOfSize(r, 2); let a = at(__SPL2, 1); let b = at(__SPL2, 2); let __SPL3 = assertIsOfSize(c, 2); let x0 = at(__SPL3, 1); let y0 = at(__SPL3, 2); let p = cos(theta); let q = sin(theta); { :t | let x = -(+(x0, (*(*(a, p), cos(t)))), (*(*(b, q), sin(t)))); let y = +(+(y0, (*(*(a, q), cos(t)))), (*(*(b, p), sin(t)))); [x, y] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_f, _p, _a, _d) {
    ...
    let __SPL4 = _assertIsOfSize_2(_f, 4);
    let _f1 = _at_2(__SPL4, 1);
    let _f2 = _at_2(__SPL4, 2);
    let _f3 = _at_2(__SPL4, 3);
    let _f4 = _at_2(__SPL4, 4);
    let __SPL5 = _assertIsOfSize_2(_p, 4);
    let _p1 = _at_2(__SPL5, 1);
    let _p2 = _at_2(__SPL5, 2);
    let _p3 = _at_2(__SPL5, 3);
    let _p4 = _at_2(__SPL5, 4);
    let __SPL6 = _assertIsOfSize_2(_a, 4);
    let _a1 = _at_2(__SPL6, 1);
    let _a2 = _at_2(__SPL6, 2);
    let _a3 = _at_2(__SPL6, 3);
    let _a4 = _at_2(__SPL6, 4);
    let __SPL7 = _assertIsOfSize_2(_solidus_2(_d, 100), 4);
    let _d1 = _at_2(__SPL7, 1);
    let _d2 = _at_2(__SPL7, 2);
    let _d3 = _at_2(__SPL7, 3);
    let _d4 = _at_2(__SPL7, 4);
    /* Statements */
    return sl.annotateFunction(function (_t) {
      /* ArityCheck */
      if (arguments.length !== 1) {
  ...
  "{ :f :p :a :d | let __SPL4 = assertIsOfSize(f, 4); let f1 = at(__SPL4, 1); let f2 = at(__SPL4, 2); let f3 = at(__SPL4, 3); let f4 = at(__SPL4, 4); let __SPL5 = assertIsOfSize(p, 4); let p1 = at(__SPL5, 1); let p2 = at(__SPL5, 2); let p3 = at(__SPL5, 3); let p4 = at(__SPL5, 4); let __SPL6 = assertIsOfSize(a, 4); let a1 = at(__SPL6, 1); let a2 = at(__SPL6, 2); let a3 = at(__SPL6, 3); let a4 = at(__SPL6, 4); let __SPL7 = assertIsOfSize(/(d, 100), 4); let d1 = at(__SPL7, 1); let d2 = at(__SPL7, 2); let d3 = at(__SPL7, 3); let d4 = at(__SPL7, 4); { :t | let x = (+((*(*(a1, sin(+((*(t, f1)), p1))), exp((*(*(-1, d1), t))))), (*(*(a2, sin(+((*(t, f2)), p2))), exp((*(*(-1, d2), t))))))); let y = (+((*(*(a3, sin(+((*(t, f3)), p3))), exp((*(*(-1, d3), t))))), (*(*(a4, sin(+((*(t, f4)), p4))), exp((*(*(-1, d4), t))))))); [x, y] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL8 = _assertIsOfSize_2(_self, 4);
    let _f = _at_2(__SPL8, 1);
    let _p = _at_2(__SPL8, 2);
    let _a = _at_2(__SPL8, 3);
  ...
  "{ :self | let __SPL8 = assertIsOfSize(self, 4); let f = at(__SPL8, 1); let p = at(__SPL8, 2); let a = at(__SPL8, 3); let d = at(__SPL8, 4); harmonographCurve([1, 0, f, 0], [0, 0, p, 0], [1, 0, a, 0], [d, 0, d, 0]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL9 = _assertIsOfSize_2(_self, 4);
    let _f = _at_2(__SPL9, 1);
    let _p = _at_2(__SPL9, 2);
    let _a = _at_2(__SPL9, 3);
  ...
  "{ :self | let __SPL9 = assertIsOfSize(self, 4); let f = at(__SPL9, 1); let p = at(__SPL9, 2); let a = at(__SPL9, 3); let d = at(__SPL9, 4); harmonographCurve([1, f, 1, f], [0, p, pi(Fraction(1L, 2L)), +(p, pi(Fraction(1L, 2L)))], [1, a, 1, a], [d, d, d, d]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL10 = assertIsOfSize(self, 4); let a = at(__SPL10, 1); let b = at(__SPL10, 2); let c = at(__SPL10, 3); let d = at(__SPL10, 4); { :x | -(-(-((/(d, x)), (*(a, square(x)))), (*(b, x))), c) } }",
);
