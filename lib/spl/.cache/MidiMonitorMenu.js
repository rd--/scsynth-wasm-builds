sl.addMethod(
  ...
  function (_self, _onSelect_2) {
    ...
    /* Statements */
    return _collect_2(
      _plusPlus_2(_ports_1(_inputs_1(_self)), _ports_1(_outputs_1(_self))),
      function (_each) {
        /* ArityCheck */
        ...
        /* Statements */
        return _MenuItem_3(
          _plusPlus_2(_plusPlus_2(_type_1(_each), "/"), _name_1(_each)),
          null,
          function (_event) {
            /* ArityCheck */
            if (arguments.length !== 1) {
...
sl.addMethod(
  ...
  function (_self, _midiPort, _event) {
    ...
    let _textEditor = _TextEditor_4(
      _self,
      _plusPlus_2("Midi Monitor On ", _name_1(_midiPort)),
      "text/plain",
      "",
    );
    let _messages = [];
    let _onMidiMessage_1 = function (_midiMessageEvent) {
      ...
      /* Temporaries */
      let _byteArray = _data_1(_midiMessageEvent);
      /* Statements */
      _add_2(_messages, _midiMessageEvent);
      _ifTrue_2(
        _and_2(_equals_2(_size_1(_byteArray), 3), function () {
          /* ArityCheck */
          ...
          /* Statements */
          return _equals_2(_at_2(_byteArray, 1), 176);
        }),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          return _setControl_3(
            _scSynth_1(_system),
            _plus_2(11000, _at_2(_byteArray, 2)),
            _dividedBy_2(_at_2(_byteArray, 3), 127),
          );
        },
      );
