sl.addMethod(
  ...
  function (_self, _onSelect_2) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _onSelect_2"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _midiPort, _event) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _midiPort, _event"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    let _onMidiMessage_1 = function (_midiMessageEvent) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _midiMessageEvent"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Temporaries */
        ...
        _unlines_1(
          _collect_2(
            ...
            function (_midi) {
              ...
              if (arguments.length !== 1) {
                const errorMessage =
                  "Arity: expected 1, _midi"; /* console.error(errorMessage); */
                throw new Error(errorMessage);
              }
              /* Statements */
  ...
  function (_self, _smallKansas, _event) {
    ...
    return _then_2(_midiAccess_1(_smallKansas), function (_midiAccess) {
      ...
      let _onSelect_2 = function (_midiPort, _event) {
        ...
        if (arguments.length !== 2) {
          const errorMessage =
            "Arity: expected 2, _midiPort, _event"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
