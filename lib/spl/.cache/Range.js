...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _start = _at_2(__SPL57, 1);
    let _stop = _at_2(__SPL57, 2);
    let _step = _at_2(__SPL57, 3);
    /* Statements */
    return _Range_3(_start, _stop, _step);
  }, ["self"]),
  "{ :self | let __SPL57 = assertIsOfSize(self, 3); let start = at(__SPL57, 1); let stop = at(__SPL57, 2); let step = at(__SPL57, 3); Range(start, stop, step) }",
);
