...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL60 = _assertIsOfSize_2(_self, 3);
    let _start = _at_2(__SPL60, 1);
    let _stop = _at_2(__SPL60, 2);
    let _step = _at_2(__SPL60, 3);
    /* Statements */
    return _Range_3(_start, _stop, _step);
  }, ["self"]),
  "{ :self | let __SPL60 = assertIsOfSize(self, 3); let start = at(__SPL60, 1); let stop = at(__SPL60, 2); let step = at(__SPL60, 3); Range(start, stop, step) }",
);
