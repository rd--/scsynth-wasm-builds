...
sl.extendTraitWithMethod(
  ...
  function (_start, _stop, _step) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _start, _stop, _step"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _second, _last) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _second, _last"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _stop) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _stop"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _stop, _step) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _stop, _step"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
