...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    _do_2(_self, function (_each) {
      ...
      /* Statements */
      return _sum = _plus_2(_sum, _aBlock_1(_each));
    });
    return _sum;
  },
  "{ :self :aBlock:/1 |\n\t\tlet sum = 0;\n\t\tself.do { :each |\n\t\t\tsum := sum + aBlock(each)\n\t\t};\n\t\tsum\n\t}",
  ...
  function (_self, _aBlock_1) {
    ...
    _do_2(_self, function (_each) {
      ...
      return _ifNil_3(_maxValue, function () {
        ...
        /* Statements */
        return _ifTrue_2(_greaterThan_2(_nextValue, _maxValue), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
  ...
  function (_self, _aBlock_1) {
    ...
    _do_2(_self, function (_each) {
      ...
      return _ifNil_3(_minValue, function () {
        ...
        let _nextValue = _aBlock_1(_each);
        /* Statements */
        return _ifTrue_2(_lessThan_2(_nextValue, _minValue), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1, _anItem) {
    ...
    return _do_2(_self, function (_each) {
      ...
      /* Statements */
      return _ifFalse_2(_equals_2(_anItem, _each), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _anObject) {
    ...
    return _anySatisfy_2(_self, function (_each) {
      ...
      /* Statements */
      return _equals_2(_each, _anObject);
    });
  },
...
sl.addTraitMethod(
  ...
  function (_self, _anObject) {
    ...
    _do_2(_self, function (_each) {
      ...
      /* Statements */
      return _ifTrue_2(_equals_2(_anObject, _each), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    /* Statements */
    return _equals_2(_count_2(_self, _aBlock_1), 1);
  },
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _minus_2(_max_1(_self), _min_1(_self));
  },
  "{ :self |\n\t\tself.max - self.min\n\t}",
);
