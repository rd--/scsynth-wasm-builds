...
sl.addMethodToExistingTrait(
  ...
  "{ :self | allSatisfy(self,blockValue:/1) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | anySatisfy(self,blockValue:/1) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/2 | let set = UnsortedSet(); comparator(set, aBlock:/2); do(self, { :each | include(set,each) }); size(set) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :initialValue :aBlock:/2 | injectIntoBy(self,initialValue, aBlock:/2, deepDo:/2) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | deepInjectInto(self, [Infinity, -Infinity], { :m :x | atPut(m, 1, min(at(m, 1),x)); atPut(m, 2, max(at(m, 2),x)); m }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection | &(includesAll(self,aCollection), { includesOnly(self,aCollection) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection | not(includesAny(self,aCollection)) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection | includesAll(aCollection,self) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :initialValue :aBlock:/2 :doBlock:/2 | let nextValue = initialValue; doBlock(self, { :each | nextValue := aBlock(nextValue, each) }); nextValue }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :initialValue :aBlock:/2 | injectIntoBy(self,initialValue, aBlock:/2, do:/2) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection | &(includesAll(aCollection,self), { !=(self, aCollection) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/2 | reduce(self, { :p :q | if(aBlock(p, q), { p }, { q }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/1 | injectInto(self, 1, { :i :j | *(i, aBlock(j)) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/1 | injectInto(self, 0, { :i :j | +(i, aBlock(j)) }) }",
);
