    ...
    return _injectInto_3(
      ...
      function (_answer, _each) {
        ...
        if (arguments.length !== 2) {
          const errorMessage =
            "Arity: expected 2, _answer, _each"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1, _foundBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aBlock_1, _foundBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1, _foundBlock_1, _exceptionBlock_0) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _aBlock_1, _foundBlock_1, _exceptionBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _valueWithReturn_1(function (_return_1) {
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1, _whenAbsent_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aBlock_1, _whenAbsent_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _initialValue, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _initialValue, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _injectInto_3(_self, _anyOne_1(_self), function (_answer, _each) {
      /* ArityCheck */
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _answer, _each"; /* console.error(errorMessage); */
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    return _injectInto_3(_self, _anyOne_1(_self), function (_answer, _each) {
      ...
      /* Statements */
      return _maxBy_3(_answer, _each, _aBlock_1);
    });
  },
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    return _injectInto_3(_self, _anyOne_1(_self), function (_answer, _each) {
      ...
      /* Statements */
      return _minBy_3(_answer, _each, _aBlock_1);
    });
  },
...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_2) {
    ...
    _ifTrue_2(_isFirst, function () {
      ...
      /* Statements */
      return _error_2(_self, "@Iterable>>reduce: empty collection");
    });
    return _nextValue;
  },
...
sl.addTraitMethod(
  ...
  function (_self, _rejectBlock_1, _doBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _rejectBlock_1, _doBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _do_2(_self, function (_each) {
...
sl.addTraitMethod(
  ...
  function (_self, _selectBlock_1, _doBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _selectBlock_1, _doBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _do_2(_self, function (_each) {
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _injectInto_3(_self, 0, _plusSign_2);
  },
  "{ :self |\n\t\tself.injectInto(0, +)\n\t}",
);
