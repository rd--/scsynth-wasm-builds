...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    let __SPL2 = _assertIsOfSize_2(_asList_1(_operand), 2);
  ...
  "{ :self :operand | let __SPL1 = assertIsOfSize(asList(self), 2); let a = at(__SPL1, 1); let b = at(__SPL1, 2); let __SPL2 = assertIsOfSize(asList(operand), 2); let c = at(__SPL2, 1); let d = at(__SPL2, 2); EisensteinInteger(-((*(a, c)), (*(b, d))), -(+((*(b, c)), (*(a, d))), (*(b, d)))) }",
);
