...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | let __SplVar1 = assertIsOfSize(asList(self), 2); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); let __SplVar2 = assertIsOfSize(asList(operand), 2); let c = at(__SplVar2, 1); let d = at(__SplVar2, 2); EisensteinInteger(-((*(a, c)), (*(b, d))), -(+((*(b, c)), (*(a, d))), (*(b, d)))) }",
);
