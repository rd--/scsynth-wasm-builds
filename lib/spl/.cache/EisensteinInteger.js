...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    let __SPL496 = _assertIsOfSize_2(_asList_1(_self), 2);
    let _a = _at_2(__SPL496, 1);
    let _b = _at_2(__SPL496, 2);
    let __SPL497 = _assertIsOfSize_2(_asList_1(_operand), 2);
    let _c = _at_2(__SPL497, 1);
    let _d = _at_2(__SPL497, 2);
    /* Statements */
  ...
  "{ :self :operand | let __SPL496 = assertIsOfSize(asList(self), 2); let a = at(__SPL496, 1); let b = at(__SPL496, 2); let __SPL497 = assertIsOfSize(asList(operand), 2); let c = at(__SPL497, 1); let d = at(__SPL497, 2); EisensteinInteger(-((*(a, c)), (*(b, d))), -(+((*(b, c)), (*(a, d))), (*(b, d)))) }",
);
