...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _if_3(_odd_1(_n), function () {
      ...
      /* Statements */
      return _at_2(_self, _plus_2(_dividedByDividedBy_2(_n, 2), 1));
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      /* Temporaries */
      let _i = _dividedByDividedBy_2(_n, 2);
      /* Statements */
      return _dividedBy_2(
        _plus_2(_at_2(_self, _i), _at_2(_self, _plus_2(_i, 1))),
        2,
      );
    });
  },
