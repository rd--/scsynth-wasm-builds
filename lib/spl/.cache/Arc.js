...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _m = _at_2(__SplVar12, 2);
    let _b = _at_2(__SplVar12, 3);
    let _p = _counterClockwiseVectorAngle_2([1, 0], _hyphenMinus_2(_a, _c));
    let _n = _counterClockwiseVectorAngle_2([1, 0], _hyphenMinus_2(_m, _c));
    let _q = _counterClockwiseVectorAngle_2([1, 0], _hyphenMinus_2(_b, _c));
    /* Statements */
    return _if_3(
      _greaterThanSign_2(
        _plusSign_2(
          _percentSign_2(_hyphenMinus_2(_n, _p), _pi_1(2)),
          _percentSign_2(_hyphenMinus_2(_q, _n), _pi_1(2)),
        ),
        _pi_1(2),
      ),
      sl.annotateFunction(function () {
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplUnused16 = _at_2(__SplVar15, 1);
