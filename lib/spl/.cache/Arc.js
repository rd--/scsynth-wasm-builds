...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _rx = _at_2(__SplVar2, 1);
    let _ry = _at_2(__SplVar2, 2);
    /* Statements */
    return _if_3(
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let __SplVar3 = _assertIsOfSize_2(_center_1(_self), 2);
    let _cx = _at_2(__SplVar3, 1);
    let _cy = _at_2(__SplVar3, 2);
    let __SplVar4 = _assertIsOfSize_2(_radii_1(_self), 2);
    let _rx = _at_2(__SplVar4, 1);
    let _ry = _at_2(__SplVar4, 2);
    let __SplVar5 = _assertIsOfSize_2(_angles_1(_self), 2);
    let _startAngle = _at_2(__SplVar5, 1);
    let _endAngle = _at_2(__SplVar5, 2);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar8 = _assertIsOfSize_2(_angles_1(_self), 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _theta1 = _at_2(__SplVar9, 1);
    let _theta2 = _at_2(__SplVar9, 2);
