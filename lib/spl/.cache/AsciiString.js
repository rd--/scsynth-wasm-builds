...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _asAsciiString_1(_base16Encoded_1(_contents_1(_self)));
  }, ["self"]),
  "{ :self | asAsciiString(base16Encoded(contents(self))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anInteger :ifAbsent:/0 | asCharacter(atIfAbsent(contents(self),anInteger, ifAbsent:/0)) }",
);
