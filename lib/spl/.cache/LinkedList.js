...
sl.addType(
  ...
  "LinkedList",
  "LinkedList",
  ["Object", "Iterable", "Collection", "Extensible", "Removable", "Sequence"],
  ["firstLink", "lastLink"],
);
...
sl.addMethod(
  ...
  function (_self, _aLinkOrObject) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aLinkOrObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _index, _aLink) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _index, _aLink"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    _ifFalse_2(_includesIndex_2(_self, _index), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage =
          "Arity: expected 0, "; /* console.error(errorMessage); */
    ...
    _if_3(_equalsSign_2(_index, 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage =
          "Arity: expected 0, "; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _index, _errorBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _index, _errorBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _counter = 0;
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      _linksDo_2(_self, function (_link) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _link"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
        _counter = _plusSign_2(_counter, 1);
        return _ifTrue_2(_equalsSign_2(_counter, _index), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage =
              "Arity: expected 0, "; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _anObject, _errorBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _anObject, _errorBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _valueWithReturn_1(function (_return_1) {
...
sl.addMethod(
  ...
  function (_self, _aLinkOrObject, _aBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aLinkOrObject, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _aLink, _aBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aLink, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _valueWithReturn_1(function (_return_1) {
      ...
      /* Statements */
      _if_3(_equalsSignEqualsSign_2(_aLink, _firstLink_1(_self)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage =
            "Arity: expected 0, "; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _ampersand_2(_isValueLink_1(_anObject), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage =
          "Arity: expected 0, "; /* console.error(errorMessage); */
