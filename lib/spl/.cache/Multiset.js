...
sl.addMethodToExistingTrait(
            ...
            return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
              ...
              _associationsDo_2(
                ...
                sl.annotateFunction(function (_assoc) {
                  ...
                  return _ifFalse_2(
                    _equalsSign_2(
                      _occurrencesOf_2(_aMultiset, _key_1(_assoc)),
                      _value_1(_assoc),
                    ),
                    sl.annotateFunction(function () {
                      /* ArityCheck */
  ...
  "{ :self :aMultiset | &((=(typeOf(self), typeOf(aMultiset))), { &(=(size(self), size(aMultiset)), { valueWithReturn({ :return:/1 | associationsDo(contents(self), { :assoc | ifFalse((=(occurrencesOf(aMultiset,key(assoc)), value(assoc))), { return(false) }) }); true }) }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let s = /(size(self), 100.0); let n = 0; collect(sortedCounts(self), { :a | n := +(n, key(a)); ->((/(n, round(s,0.1))), value(a)) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :operand | let answer = new(species(self)); do(associations(self), { :each | let x = key(each); let i = value(each); let j = occurrencesOf(operand,x); let k = min(i,j); ifTrue((>(k, 0)), { addWithOccurrences(answer,x, k) }) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let answer = []; associationsDo(contents(self), { :anAssociation | add(answer,->(value(anAssociation), key(anAssociation))) }); sortBy(answer,succeedsOrEqualTo:/2) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | sortByOn(associations(contents(self)),precedesOrEqualTo:/2, key:/1) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | sortByOn(associations(self),precedesOrEqualTo:/2, value:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | initializeSlots(newMultiset(),self) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let answer = Multiset(); addAll(answer,self); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let answer = Multiset(); collectInto(self,aBlock:/1, answer); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let byCount = sortedCounts(asMultiset(self)); let count = key(first(byCount)); collect(select(byCount, { :each | =(key(each), count) }),value:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | sortedElements(asMultiset(self)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | reduce(collect(self,asMultiset:/1),intersection:/2) }",
);
