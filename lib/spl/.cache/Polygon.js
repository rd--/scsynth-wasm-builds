...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aPoint) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL55 = _assertIsOfSize_2(_aPoint, 2);
        let _x = _at_2(__SPL55, 1);
        let _y = _at_2(__SPL55, 2);
        let _answer = 0;
        /* Statements */
        _toDo_3(
          1,
          ...
          sl.annotateFunction(function (_i) {
            ...
            let __SPL56 = _assertIsOfSize_2(_at_2(_self, _i), 2);
            let _x1 = _at_2(__SPL56, 1);
            let _y1 = _at_2(__SPL56, 2);
            let __SPL57 = _assertIsOfSize_2(
              _atWrap_2(_self, _plusSign_2(_i, 1)),
              2,
            );
            let _x2 = _at_2(__SPL57, 1);
            let _y2 = _at_2(__SPL57, 2);
            /* Statements */
            return _ifTrue_2(
              _ampersand_2(
                _verticalLine_2(
  ...
  "{ :self :aPoint | if(includes(self,aPoint), { 0 }, { let __SPL55 = assertIsOfSize(aPoint, 2); let x = at(__SPL55, 1); let y = at(__SPL55, 2); let answer = 0; toDo(1, size(self), { :i | let __SPL56 = assertIsOfSize(at(self,i), 2); let x1 = at(__SPL56, 1); let y1 = at(__SPL56, 2); let __SPL57 = assertIsOfSize(atWrap(self,+(i, 1)), 2); let x2 = at(__SPL57, 1); let y2 = at(__SPL57, 2); ifTrue((&((|((&((<=(y2, y)), { <(y, y1) })), { &((<=(y1, y)), { <(y, y2) }) })), { <(x, (+(/(*((-(x1, x2)), (-(y, y2))), (-(y1, y2))), x2))) })), { answer := +(answer, 1) }) }); answer }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p, _v) {
    ...
    let _v1 = _at_2(__SPL58, 1);
    let _v2 = _at_2(__SPL58, 2);
    /* Statements */
    return _Polygon_1([
      _p,
      _plusSign_2(_p, _v1),
  ...
  "{ :p :v | let __SPL58 = assertIsOfSize(v, 2); let v1 = at(__SPL58, 1); let v2 = at(__SPL58, 2); Polygon([p, +(p, v1), +(+(p, v1), v2), +(p, v2)]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aPoint) {
    ...
    let __SPL59 = _assertIsOfSize_2(_aPoint, 2);
    let _x = _at_2(__SPL59, 1);
    let _y = _at_2(__SPL59, 2);
    /* Statements */
    _toDo_3(
      1,
      _size_1(_self),
      sl.annotateFunction(function (_i) {
        ...
        let __SPL60 = _assertIsOfSize_2(_at_2(_self, _i), 2);
        let _x1 = _at_2(__SPL60, 1);
        let _y1 = _at_2(__SPL60, 2);
        let __SPL61 = _assertIsOfSize_2(
          _atWrap_2(_self, _plusSign_2(_i, 1)),
          2,
        );
        let _x2 = _at_2(__SPL61, 1);
        let _y2 = _at_2(__SPL61, 2);
        /* Statements */
        return _if_3(
          _lessThanSignEqualsSign_2(_y1, _y),
          sl.annotateFunction(function () {
  ...
  "{ :self :aPoint | let answer = 0; let isLeft = { :x1 :y1 :x2 :y2 :x :y | -((*((-(x2, x1)), (-(y, y1)))), (*((-(x, x1)), (-(y2, y1))))) }; let __SPL59 = assertIsOfSize(aPoint, 2); let x = at(__SPL59, 1); let y = at(__SPL59, 2); toDo(1, size(self), { :i | let __SPL60 = assertIsOfSize(at(self,i), 2); let x1 = at(__SPL60, 1); let y1 = at(__SPL60, 2); let __SPL61 = assertIsOfSize(atWrap(self,+(i, 1)), 2); let x2 = at(__SPL61, 1); let y2 = at(__SPL61, 2); if((<=(y1, y)), { ifTrue((&(>(y2, y), { >(isLeft(x1, y1, x2, y2, x, y), 0) })), { answer := +(answer, 1) }) }, { ifTrue((&(<=(y2, y), { <(isLeft(x1, y1, x2, y2, x, y), 0) })), { answer := -(answer, 1) }) }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r, _n) {
    ...
    let __SPL62 = _assertIsOfSize_2(_findShortestTour_1(_p), 2);
    let __genSym63 = _at_2(__SPL62, 1);
    let _i = _at_2(__SPL62, 2);
    /* Statements */
    return _Polygon_1(_commercialAtAsterisk_2(_p, _i));
  }, ["r", "n"]),
  "{ :r :n | let p = randomReal(r,[0, 1], [n, 2]); let __SPL62 = assertIsOfSize(findShortestTour(p), 2); let _ = at(__SPL62, 1); let i = at(__SPL62, 2); Polygon((@*(p, i))) }",
);
