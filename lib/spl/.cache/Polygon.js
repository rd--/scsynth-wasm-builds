...
sl.extendTypeOrTraitWithMethod(
  ...
  "trapezoid",
  ["a", "alpha", "b", "beta"],
  sl.annotateFunction(function (_a, _alpha, _b, _beta) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage = "Arity: expected 4, _a, _alpha, _b, _beta";
      throw new Error(errorMessage);
    } /* Temporaries */
    let _p = _asterisk_2(
      _asterisk_2(
        _asterisk_2(_plusSign_2(_negate_1(_a), _b), _cos_1(_alpha)),
        _csc_1(_plusSign_2(_alpha, _beta)),
      ),
      _sin_1(_beta),
    );
    let _q = _asterisk_2(
    ...
    /* Statements */
    return _Polygon_1([[0, 0], [_p, _q], [_plusSign_2(_a, _p), _q], [_b, 0]]);
  }, ["a", "alpha", "b", "beta"]),
