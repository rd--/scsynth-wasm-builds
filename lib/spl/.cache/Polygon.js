...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aPoint) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL4 = _assertIsOfSize_2(_aPoint, 2);
        ...
        _toDo_3(
          ...
          sl.annotateFunction(function (_i) {
            ...
            let __SPL5 = _assertIsOfSize_2(_at_2(_self, _i), 2);
  ...
  "{ :self :aPoint | if(includes(self,aPoint), { 0 }, { let __SPL4 = assertIsOfSize(aPoint, 2); let x = at(__SPL4, 1); let y = at(__SPL4, 2); let answer = 0; toDo(1, size(self), { :i | let __SPL5 = assertIsOfSize(at(self,i), 2); let x1 = at(__SPL5, 1); let y1 = at(__SPL5, 2); let __SPL6 = assertIsOfSize(atWrap(self,+(i, 1)), 2); let x2 = at(__SPL6, 1); let y2 = at(__SPL6, 2); ifTrue((&((|((&((<=(y2, y)), { <(y, y1) })), { &((<=(y1, y)), { <(y, y2) }) })), { <(x, (+(/(*((-(x1, x2)), (-(y, y2))), (-(y1, y2))), x2))) })), { answer := +(answer, 1) }) }); answer }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p, _v) {
    ...
    let __SPL7 = _assertIsOfSize_2(_v, 2);
    let _v1 = _at_2(__SPL7, 1);
    let _v2 = _at_2(__SPL7, 2);
    /* Statements */
    return _Polygon_1([
      _p,
      _plusSign_2(_p, _v1),
  ...
  "{ :p :v | let __SPL7 = assertIsOfSize(v, 2); let v1 = at(__SPL7, 1); let v2 = at(__SPL7, 2); Polygon([p, +(p, v1), +(+(p, v1), v2), +(p, v2)]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aPoint) {
    ...
    let __SPL8 = _assertIsOfSize_2(_aPoint, 2);
    ...
    _toDo_3(
      ...
      sl.annotateFunction(function (_i) {
        ...
        let __SPL9 = _assertIsOfSize_2(_at_2(_self, _i), 2);
        let _x1 = _at_2(__SPL9, 1);
        let _y1 = _at_2(__SPL9, 2);
        let __SPL10 = _assertIsOfSize_2(
          _atWrap_2(_self, _plusSign_2(_i, 1)),
          2,
        );
        let _x2 = _at_2(__SPL10, 1);
        let _y2 = _at_2(__SPL10, 2);
        /* Statements */
        return _if_3(
          _lessThanSignEqualsSign_2(_y1, _y),
          sl.annotateFunction(function () {
  ...
  "{ :self :aPoint | let answer = 0; let isLeft = { :x1 :y1 :x2 :y2 :x :y | -((*((-(x2, x1)), (-(y, y1)))), (*((-(x, x1)), (-(y2, y1))))) }; let __SPL8 = assertIsOfSize(aPoint, 2); let x = at(__SPL8, 1); let y = at(__SPL8, 2); toDo(1, size(self), { :i | let __SPL9 = assertIsOfSize(at(self,i), 2); let x1 = at(__SPL9, 1); let y1 = at(__SPL9, 2); let __SPL10 = assertIsOfSize(atWrap(self,+(i, 1)), 2); let x2 = at(__SPL10, 1); let y2 = at(__SPL10, 2); if((<=(y1, y)), { ifTrue((&(>(y2, y), { >(isLeft(x1, y1, x2, y2, x, y), 0) })), { answer := +(answer, 1) }) }, { ifTrue((&(<=(y2, y), { <(isLeft(x1, y1, x2, y2, x, y), 0) })), { answer := -(answer, 1) }) }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r, _n) {
    ...
    let __SPL11 = _assertIsOfSize_2(_findShortestTour_1(_p), 2);
    let __genSym12 = _at_2(__SPL11, 1);
    let _i = _at_2(__SPL11, 2);
    /* Statements */
    return _Polygon_1(_commercialAtAsterisk_2(_p, _i));
  }, ["r", "n"]),
  "{ :r :n | let p = randomReal(r,[0, 1], [n, 2]); let __SPL11 = assertIsOfSize(findShortestTour(p), 2); let _ = at(__SPL11, 1); let i = at(__SPL11, 2); Polygon((@*(p, i))) }",
);
