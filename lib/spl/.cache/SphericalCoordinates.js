...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    let _phi1 = _at_2(__SplVar9, 2);
    let __SplVar10 = _assertIsOfSize_2(_operand, 2);
    let _theta2 = _at_2(__SplVar10, 1);
    let _phi2 = _at_2(__SplVar10, 2);
    /* Statements */
    return _arcCos_1(
      _plusSign_2(
        _asterisk_2(_cos_1(_phi1), _cos_1(_phi2)),
        _asterisk_2(
          _asterisk_2(_cos_1(_hyphenMinus_2(_theta1, _theta2)), _sin_1(_phi1)),
          _sin_1(_phi2),
        ),
      ),
    );
