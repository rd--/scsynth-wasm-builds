...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _theta = _at_2(__SPL16, 2);
    let _phi = _at_2(__SPL16, 3);
    /* Statements */
    return _Record_1([["radius", _r], ["theta", _theta], ["phi", _phi]]);
  }, ["self"]),
  "{ :self | let __SPL16 = assertIsOfSize(coordinates(self), 3); let r = at(__SPL16, 1); let theta = at(__SPL16, 2); let phi = at(__SPL16, 3); Record([['radius', r], ['theta', theta], ['phi', phi]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _theta = _at_2(__SPL17, 2);
    let _phi = _at_2(__SPL17, 3);
    /* Statements */
    return _asterisk_2(_asterisk_2(_r, _cos_1(_theta)), _sin_1(_phi));
  }, ["self"]),
  "{ :self | let __SPL17 = assertIsOfSize(coordinates(self), 3); let r = at(__SPL17, 1); let theta = at(__SPL17, 2); let phi = at(__SPL17, 3); *(*(r, cos(theta)), sin(phi)) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _r = _at_2(__SPL18, 1);
    let _theta = _at_2(__SPL18, 2);
    let _phi = _at_2(__SPL18, 3);
    /* Statements */
    return _asterisk_2(_asterisk_2(_r, _sin_1(_theta)), _sin_1(_phi));
  }, ["self"]),
  "{ :self | let __SPL18 = assertIsOfSize(coordinates(self), 3); let r = at(__SPL18, 1); let theta = at(__SPL18, 2); let phi = at(__SPL18, 3); *(*(r, sin(theta)), sin(phi)) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL19 = _assertIsOfSize_2(_coordinates_1(_self), 3);
    let _r = _at_2(__SPL19, 1);
    let _theta = _at_2(__SPL19, 2);
    let _phi = _at_2(__SPL19, 3);
    /* Statements */
    return _asterisk_2(_r, _cos_1(_phi));
  }, ["self"]),
  "{ :self | let __SPL19 = assertIsOfSize(coordinates(self), 3); let r = at(__SPL19, 1); let theta = at(__SPL19, 2); let phi = at(__SPL19, 3); *(r, cos(phi)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _r = _at_2(__SPL20, 1);
    let _theta = _at_2(__SPL20, 2);
    let _phi = _at_2(__SPL20, 3);
    /* Statements */
    return _SphericalCoordinates_1([_r, _phi, _theta]);
  }, ["self"]),
  "{ :self | let __SPL20 = assertIsOfSize(self, 3); let r = at(__SPL20, 1); let theta = at(__SPL20, 2); let phi = at(__SPL20, 3); SphericalCoordinates([r, phi, theta]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _theta = _at_2(__SPL21, 2);
    let _phi = _at_2(__SPL21, 3);
    /* Statements */
    return _initializeSlots_2(_newSphericalCoordinates_0(), [_r, _theta, _phi]);
  }, ["self"]),
  "{ :self | let __SPL21 = assertIsOfSize(self, 3); let r = at(__SPL21, 1); let theta = at(__SPL21, 2); let phi = at(__SPL21, 3); initializeSlots(newSphericalCoordinates(),[r, theta, phi]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _r = _at_2(__SPL22, 1);
        let _theta = _at_2(__SPL22, 2);
        let _phi = _at_2(__SPL22, 3);
        /* Statements */
        return [
  ...
  "{ :self | if(isVector(self), { let __SPL22 = assertIsOfSize(self, 3); let r = at(__SPL22, 1); let theta = at(__SPL22, 2); let phi = at(__SPL22, 3); [*(*(r, cos(theta)), sin(phi)), *(*(r, sin(theta)), sin(phi)), *(r, cos(phi))] }, { collect(self,fromSphericalCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL23 = _assertIsOfSize_2(_self, 3);
        let _x = _at_2(__SPL23, 1);
        let _y = _at_2(__SPL23, 2);
        let _z = _at_2(__SPL23, 3);
        /* Statements */
        return [
          _sqrt_1(
            _plusSign_2(
  ...
  "{ :self | if(isVector(self), { let __SPL23 = assertIsOfSize(self, 3); let x = at(__SPL23, 1); let y = at(__SPL23, 2); let z = at(__SPL23, 3); [sqrt((+(+(square(x), square(y)), square(z)))), atan2(y,x), atan2(sqrt((+(square(x), square(y)))),z)] }, { collect(self,toSphericalCoordinates:/1) }) }",
);
