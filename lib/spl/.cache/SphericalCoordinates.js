...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    return Object.fromEntries([["radius", _r_1(_self)], [
      "theta",
      _theta_1(_self),
    ], ["phi", _phi_1(_self)]]);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym91 = _assertIsOfSize_2(_self, 3),
      _r = _at_2(__genSym91, 1),
      _theta = _at_2(__genSym91, 2),
      _phi = _at_2(__genSym91, 3);
    /* Statements */
