...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL269 = assertIsOfSize(coordinates(self), 3); let r = at(__SPL269, 1); let theta = at(__SPL269, 2); let phi = at(__SPL269, 3); Record([['radius', r], ['theta', theta], ['phi', phi]]) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL270 = assertIsOfSize(coordinates(self), 3); let r = at(__SPL270, 1); let theta = at(__SPL270, 2); let phi = at(__SPL270, 3); *(*(r, cos(theta)), sin(phi)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL271 = assertIsOfSize(coordinates(self), 3); let r = at(__SPL271, 1); let theta = at(__SPL271, 2); let phi = at(__SPL271, 3); *(*(r, sin(theta)), sin(phi)) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL272 = _assertIsOfSize_2(_coordinates_1(_self), 3);
  ...
  "{ :self | let __SPL272 = assertIsOfSize(coordinates(self), 3); let r = at(__SPL272, 1); let theta = at(__SPL272, 2); let phi = at(__SPL272, 3); *(r, cos(phi)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL273 = assertIsOfSize(self, 3); let r = at(__SPL273, 1); let theta = at(__SPL273, 2); let phi = at(__SPL273, 3); SphericalCoordinates([r, phi, theta]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL274 = assertIsOfSize(self, 3); let r = at(__SPL274, 1); let theta = at(__SPL274, 2); let phi = at(__SPL274, 3); initializeSlots(newSphericalCoordinates(),[r, theta, phi]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _r = _at_2(__SPL275, 1);
        let _theta = _at_2(__SPL275, 2);
        let _phi = _at_2(__SPL275, 3);
        /* Statements */
        return [
  ...
  "{ :self | if(isVector(self), { let __SPL275 = assertIsOfSize(self, 3); let r = at(__SPL275, 1); let theta = at(__SPL275, 2); let phi = at(__SPL275, 3); [*(*(r, cos(theta)), sin(phi)), *(*(r, sin(theta)), sin(phi)), *(r, cos(phi))] }, { collect(self,fromSphericalCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL276 = _assertIsOfSize_2(_self, 3);
        let _x = _at_2(__SPL276, 1);
        let _y = _at_2(__SPL276, 2);
        let _z = _at_2(__SPL276, 3);
        /* Statements */
        return [
          _sqrt_1(
            _plusSign_2(
  ...
  "{ :self | if(isVector(self), { let __SPL276 = assertIsOfSize(self, 3); let x = at(__SPL276, 1); let y = at(__SPL276, 2); let z = at(__SPL276, 3); [sqrt((+(+(square(x), square(y)), square(z)))), atan2(y,x), atan2(sqrt((+(square(x), square(y)))),z)] }, { collect(self,toSphericalCoordinates:/1) }) }",
);
