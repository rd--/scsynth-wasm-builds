...
sl.addMethod(
  ...
  function (_self, _aPositiveInteger) {
    ...
    /* Statements */
    return _if_3(_equals_2(_aPositiveInteger, 2), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      _ifTrue_2(
        _or_2(_not_1(_isInteger_1(_aPositiveInteger)), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
      ...
      return _if_3(_negative_1(_self), function () {
        ...
        return _if_3(_odd_1(_aPositiveInteger), function () {
          ...
          /* Statements */
          return _negated_1(
            _dividedBy_2(_raisedTo_2(_negated_1(_self), 1), _aPositiveInteger),
          );
        }, function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
        ...
        /* Statements */
        return _raisedTo_2(_self, _dividedBy_2(1, _aPositiveInteger));
      });
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _times_2(_self, _nextRandomFloat_1(_system));
  },
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Statements */
    return _floor_1(_randomFloat_2(_self, _plus_2(_anInteger, 1)));
  },
...
sl.addMethod(
  ...
  function (_self, _anInteger, _excluded) {
    ...
    /* Statements */
    return _if_3(_equals_2(_answer, _excluded), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
