...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    /* Statements */
    return _adaptToNumberAndApply_3(_anObject, _self, _bitShiftLeft_2);
  }, ["self", "anObject"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    /* Statements */
    return _adaptToNumberAndApply_3(_anObject, _self, _bitShiftRight_2);
  }, ["self", "anObject"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    /* Statements */
    return _adaptToNumberAndApply_3(_anObject, _self, _bitShiftRightUnsigned_2);
  }, ["self", "anObject"]),
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _adaptToNumberAndApply_3(_anObject, _self, _equal_2);
          }, []),
        );
      }, []),
      sl.annotateFunction(function () {
  ...
  sl.annotateFunction(function (_n) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _solidus_2(_asterisk_2(3, _n), 2);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _floor_1(_solidus_2(_plusSign_2(_asterisk_2(3, _n), 2), 4));
      }, []),
    );
  }, ["n"]),
  "{ :n |\n\t\tn.isEven.if {\n\t\t\t3 * n / 2\n\t\t} {\n\t\t\t((3 * n + 2) / 4).floor\n\t\t}\n\t}",
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _epsilon) {
    ...
    let _nearestInteger = _round_1(_self);
    /* Statements */
    return _if_3(
      _lessThanSign_2(_abs_1(_hyphenMinus_2(_self, _nearestInteger)), _epsilon),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _integerChop_2(_self, 1E-10);
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_x, _b) {
    ...
    let _k = _integerLength_2(_i, _b);
    /* Statements */
    return [_solidus_2(_x, _circumflexAccent_2(_b, _k)), _k];
  }, ["x", "b"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_y) {
    ...
    let _a = _hyphenMinus_2(
      _circumflexAccent_2(_plusSign_2(1, _mu), _abs_1(_y)),
      1,
    );
    /* Statements */
    return _asterisk_2(_sign_1(_y), _solidus_2(_a, _mu));
  }, ["y"]),
  "{ :y |\n\t\tlet mu = 255;\n\t\tlet a = ((1 + mu) ^ y.abs) - 1;\n\t\ty.sign * (a / mu)\n\t}",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_x) {
    ...
    let _mu = 255;
    let _a = _log_1(_plusSign_2(1, _asterisk_2(_mu, _abs_1(_x))));
    /* Statements */
    return _asterisk_2(
      _sign_1(_x),
      _solidus_2(_a, _log_1(_plusSign_2(1, _mu))),
    );
  }, ["x"]),
...
sl.addMethodToExistingType(
  ...
  "ramanujansSum",
  ["q", "n"],
  sl.annotateFunction(function (_q, _n) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _q, _n";
      throw new Error(errorMessage);
    } /* Statements */
    return _round_1(
      _real_1(
          ...
          sl.annotateFunction(function (_a) {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                return _exp_1(
                  _asterisk_2(
                    _asterisk_2(_i_1(_pi_1(2)), _solidus_2(_a, _q)),
                    _n,
                  ),
                );
              }, []),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _uncheckedSquareRoot_1(_self);
      }, []),
    );
  }, ["self"]),
  ...
  sl.annotateFunction(function (_x, _n) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _hyphenMinus_2(0, _surd_2(_hyphenMinus_2(0, _x), _n));
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _circumflexAccent_2(_x, _solidus_2(1, _n));
      }, []),
    );
  }, ["x", "n"]),
  "{ :x :n |\n\t\t(x < 0).if {\n\t\t\t0 - surd(0 - x, n)\n\t\t} {\n\t\t\tx ^ (1 / n)\n\t\t}\n\t}",
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _plusSign_2(
      _sum_1(
        _asterisk_2(
          _p,
          _circumflexAccent_2(60, _toBy_3(_hyphenMinus_2(_m, 1), 0, -1)),
        ),
      ),
      _sum_1(_solidus_2(_q, _circumflexAccent_2(60, _to_2(1, _n)))),
    );
  }, ["self"]),
