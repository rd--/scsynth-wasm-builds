...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL518 = _assertIsOfSize_2(_splitBy_2(_self, ";"), 2);
    let _a = _at_2(__SPL518, 1);
    let _b = _at_2(__SPL518, 2);
    let __SPL519 = _assertIsOfSize_2(
      _collect_2(
        [_a, _b],
        sl.annotateFunction(function (_each) {
          /* ArityCheck */
    ...
    let _p = _at_2(__SPL519, 1);
    let _q = _at_2(__SPL519, 2);
    let __SPL520 = _assertIsOfSize_2(_collect_2([_p, _q], _size_1), 2);
    let _m = _at_2(__SPL520, 1);
    let _n = _at_2(__SPL520, 2);
    /* Statements */
    return _plusSign_2(
      _sum_1(
        _asterisk_2(
  ...
  "{ :self | let __SPL518 = assertIsOfSize(splitBy(self,';'), 2); let a = at(__SPL518, 1); let b = at(__SPL518, 2); let __SPL519 = assertIsOfSize(collect([a, b], { :each | collect(splitBy(each,','),parseDecimalInteger:/1) }), 2); let p = at(__SPL519, 1); let q = at(__SPL519, 2); let __SPL520 = assertIsOfSize(collect([p, q],size:/1), 2); let m = at(__SPL520, 1); let n = at(__SPL520, 2); +(sum((*(p, (^(60, upOrDownTo(-(m, 1), 0)))))), sum((/(q, (^(60, Span(1, n, 1))))))) }",
);
