...
sl.addType(
  ...
  "SmallFloat",
  "SmallFloat",
  ["Object", "Comparable", "Json", "Magnitude", "Number", "Integer", "Binary"],
  [],
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL1 = _assertIsOfSize_2(_splitBy_2(_self, ";"), 2);
    ...
    let __SPL3 = _assertIsOfSize_2(_collect_2([_p, _q], _size_1), 2);
  ...
  "{ :self | let __SPL1 = assertIsOfSize(splitBy(self,';'), 2); let a = at(__SPL1, 1); let b = at(__SPL1, 2); let __SPL2 = assertIsOfSize(collect([a, b], { :each | collect(splitBy(each,','),parseDecimalInteger:/1) }), 2); let p = at(__SPL2, 1); let q = at(__SPL2, 2); let __SPL3 = assertIsOfSize(collect([p, q],size:/1), 2); let m = at(__SPL3, 1); let n = at(__SPL3, 2); +(sum((*(p, (^(60, upOrDownTo(-(m, 1), 0)))))), sum((/(q, (^(60, Span(1, n, 1))))))) }",
);
