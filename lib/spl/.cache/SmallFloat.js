...
sl.addMethodToExistingType(
  ...
  "{ :x :a :m | sum(collect(Span(1, m, 1), { :k | /(sin((*(pi((^(k, a))), x))), pi((^(k, a)))) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
          ...
          [
            _hyphenMinusGreaterThanSign_2(
              ...
              sl.annotateFunction(function () {
                ...
                return _matchesRegExp_2(_self, "^[0-1+-]+$");
              }, []),
            ),
            _hyphenMinusGreaterThanSign_2(
              4,
              sl.annotateFunction(function () {
                ...
                return _matchesRegExp_2(_self, "^[0-3+-]+$");
              }, []),
            ),
            _hyphenMinusGreaterThanSign_2(
              8,
              sl.annotateFunction(function () {
                ...
                return _matchesRegExp_2(_self, "^[0-7+-]+$");
              }, []),
            ),
            _hyphenMinusGreaterThanSign_2(
              10,
            ...
            _hyphenMinusGreaterThanSign_2(
              ...
              sl.annotateFunction(function () {
                ...
                return _matchesRegExp_2(_self, "^[0-9A-Fa-f+-]+$");
              }, []),
            ),
          ],
          sl.annotateFunction(function () {
  ...
  "{ :self :radix | if(isEmpty(self), { false }, { caseOf(radix, [->(2, { matchesRegExp(self,'^[0-1+-]+$') }), ->(4, { matchesRegExp(self,'^[0-3+-]+$') }), ->(8, { matchesRegExp(self,'^[0-7+-]+$') }), ->(10, { matchesRegExp(self,'^[0-9+-]+$') }), ->(16, { matchesRegExp(self,'^[0-9A-Fa-f+-]+$') })], { let c = asList(self); ifTrue((|(=(at(c, 1), '-'), { =(at(c, 1), '+') })), { removeAt(c,1) }); allSatisfy(collect(c,digitValue:/1), { :each | &(>=(each, 0), { <(each, radix) }) }) }) }) }",
);
