...
sl.addMethod(
  ...
  function (_x, _n) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _x, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_self, _littleEndian) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _littleEndian"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _aPositiveInteger) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aPositiveInteger"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aSmallFloat) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aSmallFloat"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
