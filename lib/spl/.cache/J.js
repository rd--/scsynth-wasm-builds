      ...
      return _if_3(_lessThanEquals_2(_depth, 0), function () {
        ...
        return _collect_2(_self, function (_each) {
          ...
          return _if_3(_isCollection_1(_each), function () {
            ...
            /* Statements */
            return _deepCollect_5(_each, _depth, _aBlock_3, _index, _rank);
          }, function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
            ...
            /* Statements */
            return _aBlock_3(_each, _index, _rank);
          });
        });
      });
    });
  ...
  function (_self, _depth, _levels) {
    ...
    return _if_3(_lessThanEquals_2(_depth, 0), function () {
      ...
      return _collect_2(_self, function (_each) {
        ...
        /* Statements */
        return _bubble_3(_each, _minus_2(_depth, 1), _levels);
      });
    });
  },
  ...
  function (_self, _depth, _levels) {
    ...
    return _if_3(_lessThanEquals_2(_depth, 0), function () {
      ...
      return _collect_2(_self, function (_each) {
        ...
        /* Statements */
        return _unbubble_3(_each, _minus_2(_depth, 1), 1);
      });
    });
  },
