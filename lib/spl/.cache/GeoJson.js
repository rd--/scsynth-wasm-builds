...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _projectionName) {
    ...
    let _f_1 = sl.annotateFunction(function (_each) {
      ...
      let __SPL429 = _assertIsOfSize_2(_degreesToRadians_1(_each), 2);
      let _phi = _at_2(__SPL429, 1);
      let _lambda = _at_2(__SPL429, 2);
      /* Statements */
  ...
  "{ :self :projectionName | let projectionFunction:/1 = namedCartographicProjection(projectionName); let f = { :each | let __SPL429 = assertIsOfSize(degreesToRadians(each), 2); let phi = at(__SPL429, 1); let lambda = at(__SPL429, 2); projectionFunction([lambda, phi]) }; collect(geometryValues(self), { :each | project(each,f:/1) }) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _collect_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        let __SPL430 = _assertIsOfSize_2(_coordinates_1(_each), 1);
        let _c = _at_2(__SPL430, 1);
        /* Statements */
        return _c;
      }, ["each"]),
    );
  }, ["self"]),
  "{ :self | collect(simplyConnectedPolygons(self), { :each | let __SPL430 = assertIsOfSize(coordinates(each), 1); let c = at(__SPL430, 1); c }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _projectionFunction_1) {
    ...
    return _collect_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        let __SPL431 = _assertIsOfSize_2(_coordinates_1(_each), 1);
        let _c = _at_2(__SPL431, 1);
        /* Statements */
        return _collect_2(
          _c,
          sl.annotateFunction(function (_each) {
            ...
            let __SPL432 = _assertIsOfSize_2(_degreesToRadians_1(_each), 2);
            let _phi = _at_2(__SPL432, 1);
            let _lambda = _at_2(__SPL432, 2);
            /* Statements */
            return _projectionFunction_1([_lambda, _phi]);
          }, ["each"]),
        );
  ...
  "{ :self :projectionFunction:/1 | collect(simplyConnectedPolygons(self), { :each | let __SPL431 = assertIsOfSize(coordinates(each), 1); let c = at(__SPL431, 1); collect(c, { :each | let __SPL432 = assertIsOfSize(degreesToRadians(each), 2); let phi = at(__SPL432, 1); let lambda = at(__SPL432, 2); projectionFunction([lambda, phi]) }) }) }",
);
