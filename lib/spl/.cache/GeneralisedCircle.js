...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar2 = _assertIsOfSize_2(_realImaginary_1(_alpha), 2);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar5 = _assertIsOfSize_2(_realImaginary_1(_alpha), 2);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar9 = _assertIsOfSize_2(_realImaginary_1(_alpha), 2);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar11 = _assertIsOfSize_2(_realImaginary_1(_alpha), 2);
