...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _json_3(_asDictionary_1(_self), null, "	");
  },
...
sl.addMethod(
  ...
  function (_self, _type, _manufacturer, _name) {
    ...
    return _detect_2(_ports_2(_self, _type), function (_port) {
      ...
      /* Statements */
      return _and_2(
        _equals_2(_manufacturer_1(_port), _manufacturer),
        function () {
          /* ArityCheck */
          ...
          /* Statements */
          return _equals_2(_name_1(_port), _name);
        },
      );
    });
  },
...
sl.addMethod(
  ...
  function (_self, _type) {
    ...
    /* Statements */
    return _if_3(_equals_2(_type, "input"), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
