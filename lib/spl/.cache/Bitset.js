...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    return _bitAnd_2(
      _bitShift_2(
        _at_2(_bytes_1(_self), _plusSign_2(_bitShift_2(_anInteger, -3), 1)),
        _hyphenMinus_2(0, _bitAnd_2(_anInteger, 7)),
      ),
      1,
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _asterisk_2(_size_1(_bytes_1(_self)), 8);
  },
  "{ :self |\n\t\tself.bytes.size * 8\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    return _ampersand_2(_isInteger_1(_anInteger), function () {
      ...
      /* Statements */
      return _ampersand_2(_lessThanSign_2(-1, _anInteger), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _ampersand_2(
          _lessThanSign_2(_anInteger, _capacity_1(_self)),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_capacity) {
    ...
    return _initializeSlots_3(
      _newBitset_0(),
      _ByteArray_1(_solidusSolidus_2(_capacity, 8)),
      0,
    );
  },
