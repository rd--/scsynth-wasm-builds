...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a) {
    ...
    let __SPL247 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _m = _at_2(__SPL247, 1);
    let _n = _at_2(__SPL247, 2);
  ...
  "{ :a | let __SPL247 = assertIsOfSize(shape(a), 2); let m = at(__SPL247, 1); let n = at(__SPL247, 2); let l = zeroMatrix(m,n); toDo(1, m, { :i | toDo(1, i, { :k | let sum = 0; toDo(1, k, { :j | sum := +(sum, (*(at(at(l, i), j), at(at(l, k), j)))) }); atPut(at(l, i), k, if((=(i, k)), { sqrt((-(at(at(a, i), i), sum))) }, { *(/(1, at(at(l, k), k)), (-(at(at(a, i), k), sum))) })) }) }); l }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :x :epsilon :n | valueWithReturn({ :return:/1 | let r = -(b, dot(a,x)); let p = copy(r); toDo(1, n, { :i | let ap = dot(a,p); let alpha = /(dot(p,r), dot(p,ap)); x := +(x, (*(alpha, p))); r := -(b, dot(a,x)); if((<(sqrt(sum((^(r, 2)))), epsilon)), { return(x) }, { let beta = /(negated(dot(r,ap)), dot(p,ap)); p := +(r, (*(beta, p))) }) }); x }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | conjugated(transposed(self)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :m :d | let k = size(m); let divisor = determinant(m); let numerators = !({ deepCopy(m) }, k); toDo(1, k, { :i | toDo(1, k, { :j | atPut(at(at(numerators, i), j), i, at(d, j)) }) }); collect(to(1, k), { :i | /(determinant(at(numerators, i)), divisor) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_m, _epsilon, _n) {
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL248 = _assertIsOfSize_2(_qrDecomposition_1(_x), 2);
        let _q = _at_2(__SPL248, 1);
        let _r = _at_2(__SPL248, 2);
        /* Statements */
        _x = _dot_2(_r, _q);
  ...
  "{ :m :epsilon :n | let x = deepCopy(m); let i = 0; whileTrue({ &(not(isUpperTriangularMatrix(x)), { <(i, n) }) }, { let __SPL248 = assertIsOfSize(qrDecomposition(x), 2); let q = at(__SPL248, 1); let r = at(__SPL248, 2); x := dot(r,q); i := +(i, 1) }); diagonal(x) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let n = -(size(self), 1); let w = /(negated(self), last(self)); table({ :i :j | if((=(i, (+(j, 1)))), { 1 }, { if((=(j, n)), { at(w, i) }, { 0 }) }) },to(1, n), to(1, n)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _sqrt_1(_sum_1(_collect_2(_ravel_1(_self), _squared_1)));
  }, ["self"]),
  "{ :self | sqrt(sum(collect(ravel(self),squared:/1))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL249 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL249, 1);
    let _n = _at_2(__SPL249, 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _dot_2(_self, _transposed_1(_self));
  }, ["self"]),
  "{ :self | dot(self,transposed(self)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL250 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _n = _at_2(__SPL250, 1);
    let _m = _at_2(__SPL250, 2);
    /* Statements */
    _toDo_3(
      1,
      _n,
  ...
  "{ :self | let a = deepCopy(self); let __SPL250 = assertIsOfSize(shape(a), 2); let n = at(__SPL250, 1); let m = at(__SPL250, 2); toDo(1, n, { :k | atPut(a, k, normalize(at(a, k))); toDo((+(k, 1)), n, { :j | atPut(a, j, -(at(a, j), (*(dot(at(a, j),at(a, k)), at(a, k))))) }) }); a }",
);
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL251 = _assertIsOfSize_2(
              _catenate_1(_contents_1(_self)),
              4,
            );
            let _a = _at_2(__SPL251, 1);
            let _b = _at_2(__SPL251, 2);
            let _c = _at_2(__SPL251, 3);
            let _d = _at_2(__SPL251, 4);
            let _r = _solidus_2(
              1,
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL252 = _assertIsOfSize_2(_shape_1(_self), 2);
        let _r = _at_2(__SPL252, 1);
        let _c = _at_2(__SPL252, 2);
        /* Statements */
  ...
  "{ :self :k | &(isMatrix(self), { let __SPL252 = assertIsOfSize(shape(self), 2); let r = at(__SPL252, 1); let c = at(__SPL252, 2); allSatisfy(to(1,-(r, k)), { :i | allSatisfy(to((+(+(i, 1), k)),c), { :j | isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL253 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _p = _at_2(__SPL253, 1);
    let _q = _at_2(__SPL253, 2);
    /* Statements */
    return _if_3(
  ...
  "{ :self | let __SPL253 = assertIsOfSize(shape(self), 2); let p = at(__SPL253, 1); let q = at(__SPL253, 2); if((>=(p, q)), { isVeryCloseTo(dot(transposed(self),self),identityMatrix(q)) }, { isVeryCloseTo(dot(self,transposed(self)),identityMatrix(p)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL254 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _p = _at_2(__SPL254, 1);
    let _q = _at_2(__SPL254, 2);
    /* Statements */
    return _if_3(
      _greaterThanSignEqualsSign_2(_p, _q),
      sl.annotateFunction(function () {
  ...
  "{ :self | let __SPL254 = assertIsOfSize(shape(self), 2); let p = at(__SPL254, 1); let q = at(__SPL254, 2); if((>=(p, q)), { isVeryCloseTo(dot(conjugateTranspose(self),self),identityMatrix(q)) }, { isVeryCloseTo(dot(self,conjugateTranspose(self)),identityMatrix(p)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL255 = _assertIsOfSize_2(_shape_1(_self), 2);
        let _r = _at_2(__SPL255, 1);
        let _c = _at_2(__SPL255, 2);
        /* Statements */
        return _allSatisfy_2(
  ...
  "{ :self :k | &(isMatrix(self), { let __SPL255 = assertIsOfSize(shape(self), 2); let r = at(__SPL255, 1); let c = at(__SPL255, 2); allSatisfy(to((-(2, k)),r), { :i | allSatisfy(to(1,+(-(i, 1), k)), { :j | isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    let __SPL256 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SPL256, 1);
    let _c = _at_2(__SPL256, 2);
    /* Statements */
    _do_2(
      _to_2(1, _hyphenMinus_2(_r, _k)),
      sl.annotateFunction(function (_i) {
  ...
  "{ :self :k | let m = assertIsMatrix(self,'List>>lowerTriangularize'); let __SPL256 = assertIsOfSize(shape(m), 2); let r = at(__SPL256, 1); let c = at(__SPL256, 2); do(to(1,-(r, k)), { :i | do(to((+(+(i, 1), k)),c), { :j | atPut(at(m, i), j, 0) }) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL257 = _assertIsOfSize_2(_kuhnMunkresAlgorithm_1(_self), 2);
    let __genSym271 = _at_2(__SPL257, 1);
    let _i = _at_2(__SPL257, 2);
    let _k = _size_1(_i);
    /* Statements */
    return _select_2(
      _transposed_1([_i, _to_2(1, _k)]),
      sl.annotateFunction(function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
  ...
  "{ :self | let __SPL257 = assertIsOfSize(kuhnMunkresAlgorithm(self), 2); let _ = at(__SPL257, 1); let i = at(__SPL257, 2); let k = size(i); select(transposed([i, to(1, k)]), { :each | ~=(at(each, 1), 0) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL258 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _n = _at_2(__SPL258, 1);
    let _p = _at_2(__SPL258, 2);
    let __SPL259 = _assertIsOfSize_2(_shape_1(_b), 2);
    let _m = _at_2(__SPL259, 1);
    let _q = _at_2(__SPL259, 2);
    let _l = _List_2(_n, 1);
    /* Statements */
  ...
  "{ :a :b | let __SPL258 = assertIsOfSize(shape(a), 2); let n = at(__SPL258, 1); let p = at(__SPL258, 2); let __SPL259 = assertIsOfSize(shape(b), 2); let m = at(__SPL259, 1); let q = at(__SPL259, 2); let l = List(n, 1); assert({ =(n, m) }); *((/(1, (-(n, 1)))), dot(transposed((-(a, (outer(*,l, mean(a)))))),conjugated((-(a, (outer(*,l, mean(a)))))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_m, _p) {
    ...
    let __SPL260 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _a = _at_2(__SPL260, 1);
    let _b = _at_2(__SPL260, 2);
    /* Statements */
    return _if_3(
      _equalsSign_2(_a, _b),
      sl.annotateFunction(function () {
  ...
  "{ :m :p | let __SPL260 = assertIsOfSize(shape(m), 2); let a = at(__SPL260, 1); let b = at(__SPL260, 2); if((=(a, b)), { let r = zeroMatrix(b,a); caseOfOtherwise(p, [->({ 0 }, { do(to(1, b), { :i | do(to(1, a), { :j | if((=(i, j)), { atPut(at(r, i), j, 1) }, { atPut(at(r, i), j, 0) }) }) }) }), ->({ 1 }, { do(to(1, b), { :i | do(to(1, a), { :j | atPut(at(r, i), j, at(at(m, i), j)) }) }) })], { r := m; do(to(2, p), { :i | r := dot(r,m) }) }); r }, { error(m,'List>>matrixPower: invalid matrix') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _i, _j) {
    ...
    let __SPL261 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL261, 1);
    let _n = _at_2(__SPL261, 2);
    /* Statements */
  ...
  "{ :self :i :j | let __SPL261 = assertIsOfSize(shape(self), 2); let m = at(__SPL261, 1); let n = at(__SPL261, 2); determinant(submatrix(self,without(asList(upOrDownTo(1, m)),i), without(asList(upOrDownTo(1, n)),j))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL262 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL262, 1);
    let _n = _at_2(__SPL262, 2);
    /* Statements */
    return _table_3(
      sl.annotateFunction(function (_i, _j) {
        /* ArityCheck */
  ...
  "{ :self | let __SPL262 = assertIsOfSize(shape(self), 2); let m = at(__SPL262, 1); let n = at(__SPL262, 2); table({ :i :j | let r = +(-(m, i), 1); let c = +(-(n, j), 1); determinant(submatrix(self,without(asList(upOrDownTo(1, m)),r), without(asList(upOrDownTo(1, n)),c))) },to(1, m), to(1, n)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL263 = _assertIsOfSize_2(_singularValueDecomposition_1(_self), 3);
    let _u = _at_2(__SPL263, 1);
    let _s = _at_2(__SPL263, 2);
    let _v = _at_2(__SPL263, 3);
    ...
    /* Statements */
    return _dot_2(_dot_2(_v, _i), _transposed_1(_u));
  }, ["self"]),
  "{ :self | let __SPL263 = assertIsOfSize(singularValueDecomposition(self), 3); let u = at(__SPL263, 1); let s = at(__SPL263, 2); let v = at(__SPL263, 3); let i = deepCollect(s, { :x | if(isZero(x), { 0 }, { /(1, x) }) }); dot(dot(v,i),transposed(u)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL264 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL264, 1);
    let _n = _at_2(__SPL264, 2);
  ...
  "{ :self | let __SPL264 = assertIsOfSize(shape(self), 2); let m = at(__SPL264, 1); let n = at(__SPL264, 2); let qr = deepCopy(self); let q = zeroMatrix(m,n); let r = zeroMatrix(m,n); toDo(1, n, { :k | let norm = 0; toDo(k, m, { :i | norm := hypotenuse(norm,at(at(qr, i), k)) }); ifFalse(isZero(norm), { ifTrue((<(at(at(qr, k), k), 0)), { norm := negated(norm) }); toDo(k, m, { :i | atPut(at(qr, i), k, /(at(at(qr, i), k), norm)) }); atPut(at(qr, k), k, +(at(at(qr, k), k), 1)); toDo((+(k, 1)), n, { :j | let s = 0; toDo(k, m, { :i | s := +(s, (*(at(at(qr, i), k), at(at(qr, i), j)))) }); s := /(negated(s), at(at(qr, k), k)); toDo(k, m, { :i | atPut(at(qr, i), j, +(at(at(qr, i), j), (*(s, at(at(qr, i), k))))); ifTrue((<(i, j)), { atPut(at(r, i), j, at(at(qr, i), j)) }) }) }) }); atPut(at(r, k), k, negated(norm)) }); toByDo(n, 1, -1, { :k | atPut(at(q, k), k, 1); toDo(k, n, { :j | ifFalse(isZero(at(at(qr, k), k)), { let s = 0; toDo(k, m, { :i | s := +(s, (*(at(at(qr, i), k), at(at(q, i), j)))) }); s := /(negated(s), at(at(qr, k), k)); toDo(k, m, { :i | atPut(at(q, i), j, +(at(at(q, i), j), (*(s, at(at(qr, i), k))))) }) }) }) }); [q, r] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :p :q | determinant(sylvesterMatrix(p,q)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      let _lead = 1;
      let __SPL265 = _assertIsOfSize_2(_shape_1(_self), 2);
      let _m = _at_2(__SPL265, 1);
      let _n = _at_2(__SPL265, 2);
      let _d = null;
      /* Statements */
      _toDo_3(
        1,
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _tolerance) {
    ...
    let _a = _self;
    let __SPL266 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _m = _at_2(__SPL266, 1);
    let _n = _at_2(__SPL266, 2);
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL267 = _qrDecomposition_1(_conjugateTranspose_1(_s));
          /* Statements */
          _q = _at_2(__SPL267, 1);
          return _s = _at_2(__SPL267, 2);
        }, [])();
        _u = _dot_2(_u, _q);
        sl.annotateFunction(function () {
          /* ArityCheck */
          ...
          let __SPL268 = _qrDecomposition_1(_conjugateTranspose_1(_s));
          /* Statements */
          _q = _at_2(__SPL268, 1);
          return _s = _at_2(__SPL268, 2);
        }, [])();
        _v = _dot_2(_v, _q);
  ...
  "{ :self :tolerance | let a = self; let __SPL266 = assertIsOfSize(shape(a), 2); let m = at(__SPL266, 1); let n = at(__SPL266, 2); let loopMax = *(100, max(m,n)); let loopCount = 0; let u = identityMatrix(m); let s = conjugateTranspose(a); let v = identityMatrix(n); let err = Infinity; let ss = nil; whileTrue({ &(>(err, tolerance), { <(loopCount, loopMax) }) }, { var q, e, f;({ let __SPL267 = qrDecomposition(conjugateTranspose(s)); q := at(__SPL267, 1); s := at(__SPL267, 2) } . ()); u := dot(u,q); ({ let __SPL268 = qrDecomposition(conjugateTranspose(s)); q := at(__SPL268, 1); s := at(__SPL268, 2) } . ()); v := dot(v,q); e := norm(catenate(upperTriangularize(deepCopy(s),1))); f := norm(diagonal(s)); err := if((||(=(f, 0), (=(f, 1)))), { 0 }, { /(e, f) }); loopCount := +(loopCount, 1) }); ss := diagonal(s); s := reshape([0],[m, n]); toDo(1, size(ss), { :n | let ssn = at(ss, n); atPut(at(s, n), n, abs(ssn)); ifTrue((<(ssn, 0)), { toDo(1, m, { :i | atPut(at(u, i), n, negated(at(at(u, i), n))) }) }) }); [u, s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL269 = _assertIsOfSize_2(
      _singularValueDecompositionGolubReinsch_1(_self),
      3,
    );
    let _u = _at_2(__SPL269, 1);
    let _q = _at_2(__SPL269, 2);
    let _v = _at_2(__SPL269, 3);
    let _s = _diagonalMatrix_3(_q, 0, _shape_1(_self));
    /* Statements */
    return [_u, _s, _v];
  }, ["self"]),
  "{ :self | let __SPL269 = assertIsOfSize(singularValueDecompositionGolubReinsch(self), 3); let u = at(__SPL269, 1); let q = at(__SPL269, 2); let v = at(__SPL269, 3); let s = diagonalMatrix(q,0, shape(self)); [u, s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :p :q | let m = -(size(p), 1); let n = -(size(q), 1); let d = +(m, n); let x = -(-(d, m), 1); let y = -(-(d, n), 1); let a = ++(reversed(p), (#(0, x))); let b = ++(reversed(q), (#(0, y))); catenate([collect(to(0, x), { :i | rotatedRight(a,i) }), collect(to(0, y), { :i | rotatedRight(b,i) })]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | if(isVector(self), { aBlock(self) }, { if(isArray(self), { let rank = rank(self); let limit = min(shape(self)); aBlock(collect(to(1, limit), { :each | atPath(self,#(each, rank)) })) }, { error(self,'List>>trace: not an Array') }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    let __SPL270 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SPL270, 1);
    let _c = _at_2(__SPL270, 2);
    /* Statements */
    _toDo_3(
      _hyphenMinus_2(2, _k),
      _r,
  ...
  "{ :self :k | let m = assertIsMatrix(self,'List>>upperTriangularize'); let __SPL270 = assertIsOfSize(shape(m), 2); let r = at(__SPL270, 1); let c = at(__SPL270, 2); toDo((-(2, k)), r, { :i | toDo(1, +(-(i, 1), k), { :j | atPut(at(m, i), j, 0) }) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let answer = zeroMatrix(self,self); do(to(1, self), { :each | atPut(at(answer, +(-(self, each), 1)), each, 1) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :m :n | table({ :i :j | /(1, (-(+(i, j), 1))) },to(1, m), to(1, n)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let n = *(2, self); [[cos(n), sin(n)], [sin(n), negated(cos(n))]] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :vector | caseOfOtherwise(vector, [->({ [1, 0, 0] }, { [[1, 0, 0], [0, cos(self), -(0, sin(self))], [0, sin(self), cos(self)]] }), ->({ [0, 1, 0] }, { [[cos(self), 0, sin(self)], [0, 1, 0], [-(0, sin(self)), 0, cos(self)]] }), ->({ [0, 0, 1] }, { [[cos(self), -(0, sin(self)), 0], [sin(self), cos(self), 0], [0, 0, 1]] })], { error(self,'rotationMatrix: vector not axis aligned') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | [[cos(self), negated(sin(self))], [sin(self), cos(self)]] }",
);
