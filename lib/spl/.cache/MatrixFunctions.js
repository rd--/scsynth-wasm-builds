...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplUnused32 = _at_2(__SplVar16, 1);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar21 = _assertIsOfSize_2(_singularValueDecomposition_1(_self), 3);
    let _u = _at_2(__SplVar21, 1);
    let _s = _at_2(__SplVar21, 2);
    let _v = _at_2(__SplVar21, 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_data, _dimension, _delay, _metric) {
    ...
    let _f = _at_2(__SplVar23, 1);
    let _g = _at_2(__SplVar23, 2);
    /* Statements */
    _toDo_3(
      1,
      _n,
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _tolerance) {
    ...
    let _a = _self;
    let __SplVar25 = _assertIsOfSize_2(_shape_1(_a), 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar28 = _assertIsOfSize_2(
      _singularValueDecompositionGolubReinsch_1(_self),
      3,
    );
    let _u = _at_2(__SplVar28, 1);
    let _q = _at_2(__SplVar28, 2);
    let _v = _at_2(__SplVar28, 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    let __SplVar31 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SplVar31, 1);
    let _c = _at_2(__SplVar31, 2);
    /* Statements */
    _toDo_3(
      _hyphenMinus_2(2, _k),
      _r,
