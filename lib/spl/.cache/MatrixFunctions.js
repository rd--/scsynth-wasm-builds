...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL24 = assertIsOfSize(shape(self), 2); let m = at(__SPL24, 1); let n = at(__SPL24, 2); let answer = []; downToDo(n, 1, { :i | let row = []; downToDo(m, 1, { :j | add(row,at(at(self, j), i)) }); add(answer,row) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a) {
    ...
    let __SPL25 = _assertIsOfSize_2(_shape_1(_a), 2);
  ...
  "{ :a | let __SPL25 = assertIsOfSize(shape(a), 2); let m = at(__SPL25, 1); let n = at(__SPL25, 2); let l = zeroMatrix([m, n]); toDo(1, m, { :i | toDo(1, i, { :k | let sum = 0; toDo(1, k, { :j | sum := +(sum, (*(at(at(l, i), j), at(at(l, k), j)))) }); atPut(at(l, i), k, if((=(i, k)), { sqrt((-(at(at(a, i), i), sum))) }, { *(/(1, at(at(l, k), k)), (-(at(at(a, i), k), sum))) })) }) }); l }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let _n = _at_2(__SPL26, 1);
    let _p = _at_2(__SPL26, 2);
    let __SPL27 = _assertIsOfSize_2(_shape_1(_b), 2);
  ...
  "{ :a :b | let __SPL26 = assertIsOfSize(shape(a), 2); let n = at(__SPL26, 1); let p = at(__SPL26, 2); let __SPL27 = assertIsOfSize(shape(b), 2); let m = at(__SPL27, 1); let q = at(__SPL27, 2); let l = List(n, 1); assert({ =(n, m) }); *((/(1, (-(n, 1)))), dot(transpose((-(a, (outer(*,l, mean(a)))))),conjugate((-(a, (outer(*,l, mean(a)))))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_m, _epsilon, _n) {
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL28 = _assertIsOfSize_2(_qrDecomposition_1(_x), 2);
        let _q = _at_2(__SPL28, 1);
        let _r = _at_2(__SPL28, 2);
        /* Statements */
        _x = _dot_2(_r, _q);
  ...
  "{ :m :epsilon :n | let x = deepCopy(m); let i = 0; whileTrue({ &(not(isUpperTriangularMatrix(x)), { <(i, n) }) }, { let __SPL28 = assertIsOfSize(qrDecomposition(x), 2); let q = at(__SPL28, 1); let r = at(__SPL28, 2); x := dot(r,q); i := +(i, 1) }); diagonal(x) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL30 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _n = _at_2(__SPL30, 1);
    let _m = _at_2(__SPL30, 2);
    /* Statements */
    _toDo_3(
      1,
      _n,
  ...
  "{ :self | let a = deepCopy(self); let __SPL30 = assertIsOfSize(shape(a), 2); let n = at(__SPL30, 1); let m = at(__SPL30, 2); toDo(1, n, { :k | atPut(a, k, normalize(at(a, k))); toDo((+(k, 1)), n, { :j | atPut(a, j, -(at(a, j), (*(dot(at(a, j),at(a, k)), at(a, k))))) }) }); a }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL31 = _assertIsOfSize_2(_catenate_1(_contents_1(_self)), 4);
            let _a = _at_2(__SPL31, 1);
            let _b = _at_2(__SPL31, 2);
            let _c = _at_2(__SPL31, 3);
            let _d = _at_2(__SPL31, 4);
            let _r = _solidus_2(
              1,
  ...
  "{ :self | if(isSquareMatrix(self), { let n = numberOfRows(self); if((=(n, 2)), { let __SPL31 = assertIsOfSize(catenate(contents(self)), 4); let a = at(__SPL31, 1); let b = at(__SPL31, 2); let c = at(__SPL31, 3); let d = at(__SPL31, 4); let r = /(1, (-((*(a, d)), (*(b, c))))); let m = [[d, -(b)], [-(c), a]]; *(r, m) }, { let m = contents(self); let i = identityMatrix(n); let e = rowReduce(((each(++) . (m, i)))); collect(e, { :each | drop(each,n) }) }) }, { error(self,'Sequence>>inverse: matrix not square') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/2 | let __SPL32 = assertIsOfSize(shape(self), 2); let m = at(__SPL32, 1); let n = at(__SPL32, 2); allSatisfy(Span(1, m, 1), { :i | let x = abs(at(at(self, i), i)); let z = sum(collect(Span(1, n, 1), { :j | if((=(j, i)), { 0 }, { abs(at(at(self, i), j)) }) })); aBlock(x, z) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :k | &(isMatrix(self), { let __SPL33 = assertIsOfSize(shape(self), 2); let r = at(__SPL33, 1); let c = at(__SPL33, 2); allSatisfy(to(1,-(r, k)), { :i | allSatisfy(to((+(+(i, 1), k)),c), { :j | isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _p = _at_2(__SPL34, 1);
    let _q = _at_2(__SPL34, 2);
    /* Statements */
    return _if_3(
  ...
  "{ :self | let __SPL34 = assertIsOfSize(shape(self), 2); let p = at(__SPL34, 1); let q = at(__SPL34, 2); if((>=(p, q)), { isVeryCloseTo(dot(transpose(self),self),identityMatrix(q)) }, { isVeryCloseTo(dot(self,transpose(self)),identityMatrix(p)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _p = _at_2(__SPL35, 1);
    let _q = _at_2(__SPL35, 2);
    /* Statements */
    return _if_3(
      _greaterThanSignEqualsSign_2(_p, _q),
      sl.annotateFunction(function () {
  ...
  "{ :self | let __SPL35 = assertIsOfSize(shape(self), 2); let p = at(__SPL35, 1); let q = at(__SPL35, 2); if((>=(p, q)), { isVeryCloseTo(dot(conjugateTranspose(self),self),identityMatrix(q)) }, { isVeryCloseTo(dot(self,conjugateTranspose(self)),identityMatrix(p)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL36 = _assertIsOfSize_2(_shape_1(_self), 2);
        let _r = _at_2(__SPL36, 1);
        let _c = _at_2(__SPL36, 2);
        /* Statements */
        return _allSatisfy_2(
  ...
  "{ :self :k | &(isMatrix(self), { let __SPL36 = assertIsOfSize(shape(self), 2); let r = at(__SPL36, 1); let c = at(__SPL36, 2); allSatisfy(to((-(2, k)),r), { :i | allSatisfy(to(1,+(-(i, 1), k)), { :j | isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    let __SPL37 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SPL37, 1);
    let _c = _at_2(__SPL37, 2);
    /* Statements */
    _do_2(
      _to_2(1, _hyphenMinus_2(_r, _k)),
      sl.annotateFunction(function (_i) {
  ...
  "{ :self :k | let m = assertIsMatrix(self,'List>>lowerTriangularize'); let __SPL37 = assertIsOfSize(shape(m), 2); let r = at(__SPL37, 1); let c = at(__SPL37, 2); do(to(1,-(r, k)), { :i | do(to((+(+(i, 1), k)),c), { :j | atPut(at(m, i), j, 0) }) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL38 = _assertIsOfSize_2(_kuhnMunkresAlgorithm_1(_self), 2);
    let __genSym53 = _at_2(__SPL38, 1);
    let _i = _at_2(__SPL38, 2);
    let _k = _size_1(_i);
    /* Statements */
    return _select_2(
  ...
  "{ :self | let __SPL38 = assertIsOfSize(kuhnMunkresAlgorithm(self), 2); let _ = at(__SPL38, 1); let i = at(__SPL38, 2); let k = size(i); select(transpose([i, Span(1, k, 1)]), { :each | !=(at(each, 1), 0) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_m, _p) {
    ...
    let __SPL39 = _assertIsOfSize_2(_shape_1(_m), 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :i :j | let __SPL40 = assertIsOfSize(shape(self), 2); let m = at(__SPL40, 1); let n = at(__SPL40, 2); determinant(submatrix(self,without(asList(upOrDownTo(1, m)),i), without(asList(upOrDownTo(1, n)),j))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL41 = _assertIsOfSize_2(_shape_1(_self), 2);
  ...
  "{ :self | let __SPL41 = assertIsOfSize(shape(self), 2); let m = at(__SPL41, 1); let n = at(__SPL41, 2); table({ :i :j | let r = +(-(m, i), 1); let c = +(-(n, j), 1); determinant(submatrix(self,without(asList(upOrDownTo(1, m)),r), without(asList(upOrDownTo(1, n)),c))) },Span(1, m, 1), Span(1, n, 1)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL42 = _assertIsOfSize_2(_singularValueDecomposition_1(_self), 3);
    let _u = _at_2(__SPL42, 1);
    let _s = _at_2(__SPL42, 2);
    let _v = _at_2(__SPL42, 3);
  ...
  "{ :self | let __SPL42 = assertIsOfSize(singularValueDecomposition(self), 3); let u = at(__SPL42, 1); let s = at(__SPL42, 2); let v = at(__SPL42, 3); let i = deepCollect(s, { :x | if(isZero(x), { 0 }, { /(1, x) }) }); dot(dot(v,i),transpose(u)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_data, _dimension, _delay, _metric) {
    ...
    let _f = _at_2(__SPL44, 1);
    let _g = _at_2(__SPL44, 2);
    /* Statements */
    _toDo_3(
      1,
      _n,
  ...
  "{ :data :dimension :delay :metric | let n = -(size(data), (*((-(dimension, 1)), delay))); let m = reshape([0],[n, n]); let __SPL44 = assertIsOfSize(caseOf(metric,[->('Manhattan', { [abs:/1, sum:/1] }), ->('Euclidean', { [square:/1, { :x | sqrt(sum(x)) }] }), ->('Supremum', { [abs:/1, max:/1] })]), 2); let f = at(__SPL44, 1); let g = at(__SPL44, 2); toDo(1, n, { :i | toDo(i, n, { :j | let x = collect(upOrDownTo(0, -(dimension, 1)), { :k | value(f,-(at(data, +(i, (*(k, delay)))), at(data, +(j, (*(k, delay)))))) }); atPut(at(m, i), j, atPut(at(m, j), i, value(g,x))) }) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _tolerance) {
    ...
    let _a = _self;
    let __SPL46 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _m = _at_2(__SPL46, 1);
    let _n = _at_2(__SPL46, 2);
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL47 = _qrDecomposition_1(_conjugateTranspose_1(_s));
          /* Statements */
          _q = _at_2(__SPL47, 1);
          return _s = _at_2(__SPL47, 2);
        }, [])();
        _u = _dot_2(_u, _q);
        sl.annotateFunction(function () {
          /* ArityCheck */
          ...
          let __SPL48 = _qrDecomposition_1(_conjugateTranspose_1(_s));
          /* Statements */
          _q = _at_2(__SPL48, 1);
          return _s = _at_2(__SPL48, 2);
        }, [])();
        _v = _dot_2(_v, _q);
  ...
  "{ :self :tolerance | let a = self; let __SPL46 = assertIsOfSize(shape(a), 2); let m = at(__SPL46, 1); let n = at(__SPL46, 2); let loopMax = *(100, max(m,n)); let loopCount = 0; let u = identityMatrix(m); let s = conjugateTranspose(a); let v = identityMatrix(n); let err = Infinity; let ss = nil; whileTrue({ &(>(err, tolerance), { <(loopCount, loopMax) }) }, { var q, e, f;({ let __SPL47 = qrDecomposition(conjugateTranspose(s)); q := at(__SPL47, 1); s := at(__SPL47, 2) } . ()); u := dot(u,q); ({ let __SPL48 = qrDecomposition(conjugateTranspose(s)); q := at(__SPL48, 1); s := at(__SPL48, 2) } . ()); v := dot(v,q); e := norm(catenate(upperTriangularize(deepCopy(s),1))); f := norm(diagonal(s)); err := if((||(=(f, 0), (=(f, 1)))), { 0 }, { /(e, f) }); loopCount := +(loopCount, 1) }); ss := diagonal(s); s := reshape([0],[m, n]); toDo(1, size(ss), { :n | let ssn = at(ss, n); atPut(at(s, n), n, abs(ssn)); ifTrue((<(ssn, 0)), { toDo(1, m, { :i | atPut(at(u, i), n, negate(at(at(u, i), n))) }) }) }); [u, s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _u = _at_2(__SPL49, 1);
    let _q = _at_2(__SPL49, 2);
    let _v = _at_2(__SPL49, 3);
    let _s = _diagonalMatrix_3(_q, 0, _shape_1(_self));
    /* Statements */
    return [_u, _s, _v];
  }, ["self"]),
  "{ :self | let __SPL49 = assertIsOfSize(singularValueDecompositionGolubReinsch(self), 3); let u = at(__SPL49, 1); let q = at(__SPL49, 2); let v = at(__SPL49, 3); let s = diagonalMatrix(q,0, shape(self)); [u, s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :i :j | let __SPL50 = assertIsOfSize(shape(self), 2); let m = at(__SPL50, 1); let n = at(__SPL50, 2); toDo(1, m, { :k | let x = at(at(self, k), i); atPut(at(self, k), i, at(at(self, k), j)); atPut(at(self, k), j, x) }); self }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :i :j | let __SPL51 = assertIsOfSize(shape(self), 2); let m = at(__SPL51, 1); let n = at(__SPL51, 2); swapWith(self,i, j) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    let __SPL52 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SPL52, 1);
    let _c = _at_2(__SPL52, 2);
    /* Statements */
    _toDo_3(
      _hyphenMinus_2(2, _k),
      _r,
  ...
  "{ :self :k | let m = assertIsMatrix(self,'List>>upperTriangularize'); let __SPL52 = assertIsOfSize(shape(m), 2); let r = at(__SPL52, 1); let c = at(__SPL52, 2); toDo((-(2, k)), r, { :i | toDo(1, +(-(i, 1), k), { :j | atPut(at(m, i), j, 0) }) }); m }",
);
