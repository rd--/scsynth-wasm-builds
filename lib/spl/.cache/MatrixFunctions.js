...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL1 = assertIsOfSize(shape(self), 2); let m = at(__SPL1, 1); let n = at(__SPL1, 2); let answer = []; downToDo(n, 1, { :i | let row = []; downToDo(m, 1, { :j | add(row,at(at(self, j), i)) }); add(answer,row) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a) {
    ...
    let __SPL2 = _assertIsOfSize_2(_shape_1(_a), 2);
  ...
  "{ :a | let __SPL2 = assertIsOfSize(shape(a), 2); let m = at(__SPL2, 1); let n = at(__SPL2, 2); let l = zeroMatrix(m,n); toDo(1, m, { :i | toDo(1, i, { :k | let sum = 0; toDo(1, k, { :j | sum := +(sum, (*(at(at(l, i), j), at(at(l, k), j)))) }); atPut(at(l, i), k, if((=(i, k)), { sqrt((-(at(at(a, i), i), sum))) }, { *(/(1, at(at(l, k), k)), (-(at(at(a, i), k), sum))) })) }) }); l }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL3 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _n = _at_2(__SPL3, 1);
    let _p = _at_2(__SPL3, 2);
    let __SPL4 = _assertIsOfSize_2(_shape_1(_b), 2);
    let _m = _at_2(__SPL4, 1);
    let _q = _at_2(__SPL4, 2);
    let _l = _List_2(_n, 1);
    /* Statements */
  ...
  "{ :a :b | let __SPL3 = assertIsOfSize(shape(a), 2); let n = at(__SPL3, 1); let p = at(__SPL3, 2); let __SPL4 = assertIsOfSize(shape(b), 2); let m = at(__SPL4, 1); let q = at(__SPL4, 2); let l = List(n, 1); assert({ =(n, m) }); *((/(1, (-(n, 1)))), dot(transposed((-(a, (outer(*,l, mean(a)))))),conjugated((-(a, (outer(*,l, mean(a)))))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_m, _epsilon, _n) {
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL5 = _assertIsOfSize_2(_qrDecomposition_1(_x), 2);
        let _q = _at_2(__SPL5, 1);
        let _r = _at_2(__SPL5, 2);
        /* Statements */
        _x = _dot_2(_r, _q);
  ...
  "{ :m :epsilon :n | let x = deepCopy(m); let i = 0; whileTrue({ &(not(isUpperTriangularMatrix(x)), { <(i, n) }) }, { let __SPL5 = assertIsOfSize(qrDecomposition(x), 2); let q = at(__SPL5, 1); let r = at(__SPL5, 2); x := dot(r,q); i := +(i, 1) }); diagonal(x) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL7 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _n = _at_2(__SPL7, 1);
    let _m = _at_2(__SPL7, 2);
    /* Statements */
    _toDo_3(
      1,
      _n,
  ...
  "{ :self | let a = deepCopy(self); let __SPL7 = assertIsOfSize(shape(a), 2); let n = at(__SPL7, 1); let m = at(__SPL7, 2); toDo(1, n, { :k | atPut(a, k, normalize(at(a, k))); toDo((+(k, 1)), n, { :j | atPut(a, j, -(at(a, j), (*(dot(at(a, j),at(a, k)), at(a, k))))) }) }); a }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL8 = _assertIsOfSize_2(_catenate_1(_contents_1(_self)), 4);
            let _a = _at_2(__SPL8, 1);
            let _b = _at_2(__SPL8, 2);
            let _c = _at_2(__SPL8, 3);
            let _d = _at_2(__SPL8, 4);
            let _r = _solidus_2(
              1,
  ...
  "{ :self | if(isSquareMatrix(self), { let n = numberOfRows(self); if((=(n, 2)), { let __SPL8 = assertIsOfSize(catenate(contents(self)), 4); let a = at(__SPL8, 1); let b = at(__SPL8, 2); let c = at(__SPL8, 3); let d = at(__SPL8, 4); let r = /(1, (-((*(a, d)), (*(b, c))))); let m = [[d, -(b)], [-(c), a]]; *(r, m) }, { let m = contents(self); let i = identityMatrix(n); let e = rowReduce(((each(++) . (m, i)))); collect(e, { :each | drop(each,n) }) }) }, { error(self,'Sequence>>inverse: matrix not square') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_2) {
    ...
    let __SPL9 = _assertIsOfSize_2(_shape_1(_self), 2);
  ...
  "{ :self :aBlock:/2 | let __SPL9 = assertIsOfSize(shape(self), 2); let m = at(__SPL9, 1); let n = at(__SPL9, 2); allSatisfy(Span(1, m, 1), { :i | let x = abs(at(at(self, i), i)); let z = sum(collect(Span(1, n, 1), { :j | if((=(j, i)), { 0 }, { abs(at(at(self, i), j)) }) })); aBlock(x, z) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        let _r = _at_2(__SPL10, 1);
        let _c = _at_2(__SPL10, 2);
        /* Statements */
        return _allSatisfy_2(
  ...
  "{ :self :k | &(isMatrix(self), { let __SPL10 = assertIsOfSize(shape(self), 2); let r = at(__SPL10, 1); let c = at(__SPL10, 2); allSatisfy(to(1,-(r, k)), { :i | allSatisfy(to((+(+(i, 1), k)),c), { :j | isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL11 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _p = _at_2(__SPL11, 1);
    let _q = _at_2(__SPL11, 2);
    /* Statements */
    return _if_3(
  ...
  "{ :self | let __SPL11 = assertIsOfSize(shape(self), 2); let p = at(__SPL11, 1); let q = at(__SPL11, 2); if((>=(p, q)), { isVeryCloseTo(dot(transposed(self),self),identityMatrix(q)) }, { isVeryCloseTo(dot(self,transposed(self)),identityMatrix(p)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _p = _at_2(__SPL12, 1);
    let _q = _at_2(__SPL12, 2);
    /* Statements */
    return _if_3(
      _greaterThanSignEqualsSign_2(_p, _q),
      sl.annotateFunction(function () {
  ...
  "{ :self | let __SPL12 = assertIsOfSize(shape(self), 2); let p = at(__SPL12, 1); let q = at(__SPL12, 2); if((>=(p, q)), { isVeryCloseTo(dot(conjugateTranspose(self),self),identityMatrix(q)) }, { isVeryCloseTo(dot(self,conjugateTranspose(self)),identityMatrix(p)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :k | &(isMatrix(self), { let __SPL13 = assertIsOfSize(shape(self), 2); let r = at(__SPL13, 1); let c = at(__SPL13, 2); allSatisfy(to((-(2, k)),r), { :i | allSatisfy(to(1,+(-(i, 1), k)), { :j | isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    let __SPL14 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SPL14, 1);
    let _c = _at_2(__SPL14, 2);
    /* Statements */
    _do_2(
      _to_2(1, _hyphenMinus_2(_r, _k)),
      sl.annotateFunction(function (_i) {
  ...
  "{ :self :k | let m = assertIsMatrix(self,'List>>lowerTriangularize'); let __SPL14 = assertIsOfSize(shape(m), 2); let r = at(__SPL14, 1); let c = at(__SPL14, 2); do(to(1,-(r, k)), { :i | do(to((+(+(i, 1), k)),c), { :j | atPut(at(m, i), j, 0) }) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL15 = _assertIsOfSize_2(_kuhnMunkresAlgorithm_1(_self), 2);
    let __genSym30 = _at_2(__SPL15, 1);
  ...
  "{ :self | let __SPL15 = assertIsOfSize(kuhnMunkresAlgorithm(self), 2); let _ = at(__SPL15, 1); let i = at(__SPL15, 2); let k = size(i); select(transposed([i, Span(1, k, 1)]), { :each | ~=(at(each, 1), 0) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_m, _p) {
    ...
    let __SPL16 = _assertIsOfSize_2(_shape_1(_m), 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :i :j | let __SPL17 = assertIsOfSize(shape(self), 2); let m = at(__SPL17, 1); let n = at(__SPL17, 2); determinant(submatrix(self,without(asList(upOrDownTo(1, m)),i), without(asList(upOrDownTo(1, n)),j))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL18 = assertIsOfSize(shape(self), 2); let m = at(__SPL18, 1); let n = at(__SPL18, 2); table({ :i :j | let r = +(-(m, i), 1); let c = +(-(n, j), 1); determinant(submatrix(self,without(asList(upOrDownTo(1, m)),r), without(asList(upOrDownTo(1, n)),c))) },Span(1, m, 1), Span(1, n, 1)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL19 = _assertIsOfSize_2(_singularValueDecomposition_1(_self), 3);
    let _u = _at_2(__SPL19, 1);
    let _s = _at_2(__SPL19, 2);
    let _v = _at_2(__SPL19, 3);
  ...
  "{ :self | let __SPL19 = assertIsOfSize(singularValueDecomposition(self), 3); let u = at(__SPL19, 1); let s = at(__SPL19, 2); let v = at(__SPL19, 3); let i = deepCollect(s, { :x | if(isZero(x), { 0 }, { /(1, x) }) }); dot(dot(v,i),transposed(u)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_data, _dimension, _delay, _metric) {
    ...
    let _f = _at_2(__SPL21, 1);
    let _g = _at_2(__SPL21, 2);
    /* Statements */
    _toDo_3(
      1,
      _n,
  ...
  "{ :data :dimension :delay :metric | let n = -(size(data), (*((-(dimension, 1)), delay))); let m = reshape([0],[n, n]); let __SPL21 = assertIsOfSize(caseOf(metric,[->('Manhattan', { [abs:/1, sum:/1] }), ->('Euclidean', { [squared:/1, { :x | sqrt(sum(x)) }] }), ->('Supremum', { [abs:/1, max:/1] })]), 2); let f = at(__SPL21, 1); let g = at(__SPL21, 2); toDo(1, n, { :i | toDo(i, n, { :j | let x = collect(upOrDownTo(0, -(dimension, 1)), { :k | value(f,-(at(data, +(i, (*(k, delay)))), at(data, +(j, (*(k, delay)))))) }); atPut(at(m, i), j, atPut(at(m, j), i, value(g,x))) }) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _tolerance) {
    ...
    let _a = _self;
    let __SPL23 = _assertIsOfSize_2(_shape_1(_a), 2);
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL24 = _qrDecomposition_1(_conjugateTranspose_1(_s));
          /* Statements */
          _q = _at_2(__SPL24, 1);
          return _s = _at_2(__SPL24, 2);
        }, [])();
        _u = _dot_2(_u, _q);
        sl.annotateFunction(function () {
          /* ArityCheck */
          ...
          let __SPL25 = _qrDecomposition_1(_conjugateTranspose_1(_s));
          /* Statements */
          _q = _at_2(__SPL25, 1);
          return _s = _at_2(__SPL25, 2);
        }, [])();
        _v = _dot_2(_v, _q);
  ...
  "{ :self :tolerance | let a = self; let __SPL23 = assertIsOfSize(shape(a), 2); let m = at(__SPL23, 1); let n = at(__SPL23, 2); let loopMax = *(100, max(m,n)); let loopCount = 0; let u = identityMatrix(m); let s = conjugateTranspose(a); let v = identityMatrix(n); let err = Infinity; let ss = nil; whileTrue({ &(>(err, tolerance), { <(loopCount, loopMax) }) }, { var q, e, f;({ let __SPL24 = qrDecomposition(conjugateTranspose(s)); q := at(__SPL24, 1); s := at(__SPL24, 2) } . ()); u := dot(u,q); ({ let __SPL25 = qrDecomposition(conjugateTranspose(s)); q := at(__SPL25, 1); s := at(__SPL25, 2) } . ()); v := dot(v,q); e := norm(catenate(upperTriangularize(deepCopy(s),1))); f := norm(diagonal(s)); err := if((||(=(f, 0), (=(f, 1)))), { 0 }, { /(e, f) }); loopCount := +(loopCount, 1) }); ss := diagonal(s); s := reshape([0],[m, n]); toDo(1, size(ss), { :n | let ssn = at(ss, n); atPut(at(s, n), n, abs(ssn)); ifTrue((<(ssn, 0)), { toDo(1, m, { :i | atPut(at(u, i), n, negated(at(at(u, i), n))) }) }) }); [u, s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL26 = _assertIsOfSize_2(
      _singularValueDecompositionGolubReinsch_1(_self),
      3,
    );
    let _u = _at_2(__SPL26, 1);
    let _q = _at_2(__SPL26, 2);
    let _v = _at_2(__SPL26, 3);
    let _s = _diagonalMatrix_3(_q, 0, _shape_1(_self));
    /* Statements */
    return [_u, _s, _v];
  }, ["self"]),
  "{ :self | let __SPL26 = assertIsOfSize(singularValueDecompositionGolubReinsch(self), 3); let u = at(__SPL26, 1); let q = at(__SPL26, 2); let v = at(__SPL26, 3); let s = diagonalMatrix(q,0, shape(self)); [u, s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :i :j | let __SPL27 = assertIsOfSize(shape(self), 2); let m = at(__SPL27, 1); let n = at(__SPL27, 2); toDo(1, m, { :k | let x = at(at(self, k), i); atPut(at(self, k), i, at(at(self, k), j)); atPut(at(self, k), j, x) }); self }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :i :j | let __SPL28 = assertIsOfSize(shape(self), 2); let m = at(__SPL28, 1); let n = at(__SPL28, 2); swapWith(self,i, j) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k) {
    ...
    let __SPL29 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SPL29, 1);
    let _c = _at_2(__SPL29, 2);
    /* Statements */
    _toDo_3(
      _hyphenMinus_2(2, _k),
      _r,
  ...
  "{ :self :k | let m = assertIsMatrix(self,'List>>upperTriangularize'); let __SPL29 = assertIsOfSize(shape(m), 2); let r = at(__SPL29, 1); let c = at(__SPL29, 2); toDo((-(2, k)), r, { :i | toDo(1, +(-(i, 1), k), { :j | atPut(at(m, i), j, 0) }) }); m }",
);
