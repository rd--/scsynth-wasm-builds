...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _zero) {
    ...
    let _answer = [];
    /* Statements */
    _withDeepIndexDo_2(_self, function (_each, _index) {
      /* ArityCheck */
      if (arguments.length !== 2) {
        const errorMessage = "Arity: expected 2, _each, _index";
        throw new Error(errorMessage);
      } /* Statements */
      return _ifFalse_2(_equalsSign_2(_each, _zero), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
        } /* Statements */
        return _add_2(_answer, _hyphenMinusGreaterThanSign_2(_index, _each));
      });
    });
    _ifTrue_2(_equalsSign_2(_atPath_2(_self, _shape), _zero), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_a) {
    ...
    let __SPL8 = _assertIsOfSize_2(_shape_1(_a), 2);
  ...
  "{ :a | let __SPL8 = assertIsOfSize(shape(a), 2); let m = at(__SPL8, 1); let n = at(__SPL8, 2); let l = zeroMatrix(m,n); toDo(1, m, { :i | toDo(1, i, { :k | let sum = 0; toDo(1, k, { :j | sum := +(sum, (*(at(at(l, i), j), at(at(l, k), j)))) }); atPut(at(l, i), k, if((=(i, k)), { sqrt((-(at(at(a, i), i), sum))) }, { *(/(1, at(at(l, k), k)), (-(at(at(a, i), k), sum))) })) }) }); l }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_m, _d) {
    ...
    return _collect_2(_to_2(1, _k), function (_i) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _i";
        throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_m, _epsilon, _n) {
    ...
    _whileTrue_2(function () {
      ...
      let __SPL9 = _assertIsOfSize_2(_qrDecomposition_1(_x), 2);
      let _q = _at_2(__SPL9, 1);
  ...
  "{ :m :epsilon :n | let x = deepCopy(m); let i = 0; whileTrue({ &(not(isUpperTriangularMatrix(x)), { <(i, n) }) }, { let __SPL9 = assertIsOfSize(qrDecomposition(x), 2); let q = at(__SPL9, 1); let r = at(__SPL9, 2); x := dot(r,q); i := +(i, 1) }); diagonal(x) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL10 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL10, 1);
    let _n = _at_2(__SPL10, 2);
    ...
    _ifTrue_2(_tildeEqualsSign_2(_m, _n), function () {
      ...
      return _error_2(_self, "List>>gaussJordanInverse: matrix is not square");
    });
    _toDo_3(1, _m, function (_i) {
      /* ArityCheck */
      if (arguments.length !== 1) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL11 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _n = _at_2(__SPL11, 1);
    let _m = _at_2(__SPL11, 2);
    /* Statements */
  ...
  "{ :self | let a = deepCopy(self); let __SPL11 = assertIsOfSize(shape(a), 2); let n = at(__SPL11, 1); let m = at(__SPL11, 2); toDo(1, n, { :k | atPut(a, k, normalize(at(a, k))); toDo((+(k, 1)), n, { :j | atPut(a, j, -(at(a, j), (*(dot(at(a, j),at(a, k)), at(a, k))))) }) }); a }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_aMatrix, _anotherMatrix) {
    /* ArityCheck */
    if (arguments.length !== 2) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isSquareMatrix(self), { let n = numberOfRows(self); if((=(n, 2)), { let __SPL12 = assertIsOfSize(concatenation(contents(self)), 4); let a = at(__SPL12, 1); let b = at(__SPL12, 2); let c = at(__SPL12, 3); let d = at(__SPL12, 4); let r = /(1, (-((*(a, d)), (*(b, c))))); let m = [[d, -(b)], [-(c), a]]; *(r, m) }, { let m = contents(self); let i = identityMatrix(n); let e = rowReduce(((each(++) . (m, i)))); collect(e, { :each | drop(each,n) }) }) }, { error(self,'Sequence>>inverse: matrix not square') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _k) {
    ...
    return _ampersand_2(_isMatrix_1(_self), function () {
      ...
      let __SPL13 = _assertIsOfSize_2(_shape_1(_self), 2);
      let _r = _at_2(__SPL13, 1);
      let _c = _at_2(__SPL13, 2);
      /* Statements */
  ...
  "{ :self :k | &(isMatrix(self), { let __SPL13 = assertIsOfSize(shape(self), 2); let r = at(__SPL13, 1); let c = at(__SPL13, 2); allSatisfy(to(1,-(r, k)), { :i | allSatisfy(to((+(+(i, 1), k)),c), { :j | isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL14 = _assertIsOfSize_2(_shape_1(_self), 2);
  ...
  "{ :self | let __SPL14 = assertIsOfSize(shape(self), 2); let p = at(__SPL14, 1); let q = at(__SPL14, 2); if((>=(p, q)), { isVeryCloseTo(dot(transposed(self),self),identityMatrix(q)) }, { isVeryCloseTo(dot(self,transposed(self)),identityMatrix(p)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL15 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _p = _at_2(__SPL15, 1);
    let _q = _at_2(__SPL15, 2);
    /* Statements */
    return _if_3(_greaterThanSignEqualsSign_2(_p, _q), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
  ...
  "{ :self | let __SPL15 = assertIsOfSize(shape(self), 2); let p = at(__SPL15, 1); let q = at(__SPL15, 2); if((>=(p, q)), { isVeryCloseTo(dot(conjugateTranspose(self),self),identityMatrix(q)) }, { isVeryCloseTo(dot(self,conjugateTranspose(self)),identityMatrix(p)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _k) {
    ...
    return _ampersand_2(_isMatrix_1(_self), function () {
      ...
      let _r = _at_2(__SPL16, 1);
      let _c = _at_2(__SPL16, 2);
      /* Statements */
  ...
  "{ :self :k | &(isMatrix(self), { let __SPL16 = assertIsOfSize(shape(self), 2); let r = at(__SPL16, 1); let c = at(__SPL16, 2); allSatisfy(to((-(2, k)),r), { :i | allSatisfy(to(1,+(-(i, 1), k)), { :j | isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _k) {
    ...
    let __SPL17 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SPL17, 1);
    let _c = _at_2(__SPL17, 2);
    /* Statements */
  ...
  "{ :self :k | let m = assertIsMatrix(self,'List>>lowerTriangularize'); let __SPL17 = assertIsOfSize(shape(m), 2); let r = at(__SPL17, 1); let c = at(__SPL17, 2); do(to(1,-(r, k)), { :i | do(to((+(+(i, 1), k)),c), { :j | atPut(at(m, i), j, 0) }) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_a, _b) {
    ...
    let __SPL18 = _assertIsOfSize_2(_shape_1(_a), 2);
    let _n = _at_2(__SPL18, 1);
    let _p = _at_2(__SPL18, 2);
    let __SPL19 = _assertIsOfSize_2(_shape_1(_b), 2);
    let _m = _at_2(__SPL19, 1);
    let _q = _at_2(__SPL19, 2);
    let _l = _List_2(_n, 1);
    /* Statements */
    _assert_1(function () {
      /* ArityCheck */
  ...
  "{ :a :b | let __SPL18 = assertIsOfSize(shape(a), 2); let n = at(__SPL18, 1); let p = at(__SPL18, 2); let __SPL19 = assertIsOfSize(shape(b), 2); let m = at(__SPL19, 1); let q = at(__SPL19, 2); let l = List(n, 1); assert({ =(n, m) }); *((/(1, (-(n, 1)))), dot(transposed((-(a, (outer(*,l, mean(a)))))),conjugated((-(a, (outer(*,l, mean(a)))))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_m, _p) {
    ...
    let __SPL20 = _assertIsOfSize_2(_shape_1(_m), 2);
    ...
    return _if_3(_equalsSign_2(_a, _b), function () {
      ...
      _caseOfOtherwise_3(_p, [
        _hyphenMinusGreaterThanSign_2(function () {
          ...
          return _do_2(_to_2(1, _b), function (_i) {
            /* ArityCheck */
            if (arguments.length !== 1) {
              const errorMessage = "Arity: expected 1, _i";
              throw new Error(errorMessage);
            } /* Statements */
            return _do_2(_to_2(1, _a), function (_j) {
              /* ArityCheck */
              if (arguments.length !== 1) {
                const errorMessage = "Arity: expected 1, _j";
                throw new Error(errorMessage);
        ...
        _r = _m;
        return _do_2(_to_2(2, _p), function (_i) {
          /* ArityCheck */
          if (arguments.length !== 1) {
            const errorMessage = "Arity: expected 1, _i";
            throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _i, _j) {
    ...
    let __SPL21 = _assertIsOfSize_2(_shape_1(_self), 2);
  ...
  "{ :self :i :j | let __SPL21 = assertIsOfSize(shape(self), 2); let m = at(__SPL21, 1); let n = at(__SPL21, 2); determinant(submatrix(self,without(asList(upOrDownTo(1, m)),i), without(asList(upOrDownTo(1, n)),j))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL22 = assertIsOfSize(shape(self), 2); let m = at(__SPL22, 1); let n = at(__SPL22, 2); table({ :i :j | let r = +(-(m, i), 1); let c = +(-(n, j), 1); determinant(submatrix(self,without(asList(upOrDownTo(1, m)),r), without(asList(upOrDownTo(1, n)),c))) },to(1, m), to(1, n)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL23 = _assertIsOfSize_2(_singularValueDecomposition_1(_self), 3);
    let _u = _at_2(__SPL23, 1);
    let _s = _at_2(__SPL23, 2);
    let _v = _at_2(__SPL23, 3);
    let _i = _deepCollect_2(_s, function (_x) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _x";
        throw new Error(errorMessage);
      } /* Statements */
      return _if_3(_isZero_1(_x), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
  ...
  "{ :self | let __SPL23 = assertIsOfSize(singularValueDecomposition(self), 3); let u = at(__SPL23, 1); let s = at(__SPL23, 2); let v = at(__SPL23, 3); let i = deepCollect(s, { :x | if(isZero(x), { 0 }, { /(1, x) }) }); dot(dot(v,i),transposed(u)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL24 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL24, 1);
    let _n = _at_2(__SPL24, 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _tolerance) {
    ...
    let _a = _self;
    let __SPL26 = _assertIsOfSize_2(_shape_1(_a), 2);
    ...
    _whileTrue_2(function () {
      ...
      (function () {
        ...
        let __SPL27 = _qrDecomposition_1(_conjugateTranspose_1(_s));
        /* Statements */
        _q = _at_2(__SPL27, 1);
        return _s = _at_2(__SPL27, 2);
      })();
      _u = _dot_2(_u, _q);
      (function () {
        /* ArityCheck */
        ...
        let __SPL28 = _qrDecomposition_1(_conjugateTranspose_1(_s));
        /* Statements */
        _q = _at_2(__SPL28, 1);
        return _s = _at_2(__SPL28, 2);
      })();
      _v = _dot_2(_v, _q);
  ...
  "{ :self :tolerance | let a = self; let __SPL26 = assertIsOfSize(shape(a), 2); let m = at(__SPL26, 1); let n = at(__SPL26, 2); let loopMax = *(100, max(m,n)); let loopCount = 0; let u = identityMatrix(m); let s = conjugateTranspose(a); let v = identityMatrix(n); let err = Infinity; let ss = nil; whileTrue({ &(>(err, tolerance), { <(loopCount, loopMax) }) }, { var q, e, f;({ let __SPL27 = qrDecomposition(conjugateTranspose(s)); q := at(__SPL27, 1); s := at(__SPL27, 2) } . ()); u := dot(u,q); ({ let __SPL28 = qrDecomposition(conjugateTranspose(s)); q := at(__SPL28, 1); s := at(__SPL28, 2) } . ()); v := dot(v,q); e := norm(concatenation(upperTriangularize(deepCopy(s),1))); f := norm(diagonal(s)); err := if((||(=(f, 0), (=(f, 1)))), { 0 }, { /(e, f) }); loopCount := +(loopCount, 1) }); ss := diagonal(s); s := reshape([0],[m, n]); toDo(1, size(ss), { :n | let ssn = at(ss, n); atPut(at(s, n), n, abs(ssn)); ifTrue((<(ssn, 0)), { toDo(1, m, { :i | atPut(at(u, i), n, negated(at(at(u, i), n))) }) }) }); [u, s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL29 = _assertIsOfSize_2(
      _singularValueDecompositionGolubReinsch_1(_self),
      3,
    );
    let _u = _at_2(__SPL29, 1);
    let _q = _at_2(__SPL29, 2);
    let _v = _at_2(__SPL29, 3);
    let _s = _diagonalMatrix_3(_q, 0, _shape_1(_self));
    /* Statements */
    return [_u, _s, _v];
  },
  "{ :self | let __SPL29 = assertIsOfSize(singularValueDecompositionGolubReinsch(self), 3); let u = at(__SPL29, 1); let q = at(__SPL29, 2); let v = at(__SPL29, 3); let s = diagonalMatrix(q,0, shape(self)); [u, s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_p, _q) {
    ...
    return _concatenation_1([
      _collect_2(_to_2(0, _x), function (_i) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _i";
          throw new Error(errorMessage);
      ...
      _collect_2(_to_2(0, _y), function (_i) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _i";
          throw new Error(errorMessage);
  ...
  "{ :p :q | let m = -(size(p), 1); let n = -(size(q), 1); let d = +(m, n); let x = -(-(d, m), 1); let y = -(-(d, n), 1); let a = ++(reversed(p), (#(0, x))); let b = ++(reversed(q), (#(0, y))); concatenation([collect(to(0, x), { :i | rotatedRight(a,i) }), collect(to(0, y), { :i | rotatedRight(b,i) })]) }",
);
  ...
  function (_self, _aBlock_1) {
    ...
    return _if_3(_isVector_1(_self), function () {
      ...
      return _if_3(_isArray_1(_self), function () {
        ...
        /* Statements */
        return _aBlock_1(_collect_2(_to_2(1, _limit), function (_each) {
          /* ArityCheck */
          if (arguments.length !== 1) {
            const errorMessage = "Arity: expected 1, _each";
            throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _k) {
    ...
    let __SPL30 = _assertIsOfSize_2(_shape_1(_m), 2);
    let _r = _at_2(__SPL30, 1);
    let _c = _at_2(__SPL30, 2);
    /* Statements */
  ...
  "{ :self :k | let m = assertIsMatrix(self,'List>>upperTriangularize'); let __SPL30 = assertIsOfSize(shape(m), 2); let r = at(__SPL30, 1); let c = at(__SPL30, 2); toDo((-(2, k)), r, { :i | toDo(1, +(-(i, 1), k), { :j | atPut(at(m, i), j, 0) }) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    _do_2(_to_2(1, _self), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        throw new Error(errorMessage);
