...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :startIndex :stopIndex :sortBlock:/2 | let size = size(self); if((|(<=(size, 1), { =(startIndex, stopIndex) })), { self }, { ifFalse((<=(1, startIndex)), { errorSubscriptBounds(self,startIndex) }); ifFalse((<=(stopIndex, size)), { errorSubscriptBounds(self,stopIndex) }); ifFalse((<(startIndex, stopIndex)), { errorSubscriptBounds(self,startIndex) }); mergeSortFromToIntoBy(copy(self),startIndex, stopIndex, self, sortBlock:/2); self }) }",
);
