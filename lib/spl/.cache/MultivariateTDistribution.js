...
sl.addMethodToExistingType(
  ...
  "{ :self :r :shape | let k = size(sigma(self)); let __SplVar1 = assertIsOfSize(shape, 1); let n = at(__SplVar1, 1); let x = /(randomVariate(ChiSquareDistribution(nu(self)),r, shape), nu(self)); let z = randomVariate(MultinormalDistribution(#(0, k), sigma(self)),r, shape); +([mu(self)], (/(z, sqrt(x)))) }",
);
