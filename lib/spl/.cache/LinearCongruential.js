...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return sl.annotateFunction(function (_n) {
      ...
      return _reverseSolidusReverseSolidus_2(
        _plusSign_2(_asterisk_2(_n, _a), _c),
        _m,
      );
    }, ["n"]);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "linearCongruential",
  ["self", "n", "shape"],
  sl.annotateFunction(function (_self, _n, _shape) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _n, _shape";
      throw new Error(errorMessage);
    } /* Temporaries */
    ...
    return _reshape_2(
      _nestList_3(
        _linearCongruentialFunction_1(_self),
        _n,
        _hyphenMinus_2(_k, 1),
      ),
      _shape,
