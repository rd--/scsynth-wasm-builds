sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n :x | if(isCollection(x), { collect(x, { :each | besselJ(n,each) }) }, { if((=(n, 0)), { besselJ0(x) }, { if((=(n, 1)), { besselJ1(x) }, { error(n,'@Integer>>besselJ: only defined for n=0 and n=1') }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      let __SPL177 = _assertIsOfSize_2(_besselAsympt0_1(_x), 2);
      let _p0 = _at_2(__SPL177, 1);
      let _q0 = _at_2(__SPL177, 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      let __SPL178 = _assertIsOfSize_2(_besselAsympt1_1(_x), 2);
      let _p0 = _at_2(__SPL178, 1);
      let _q0 = _at_2(__SPL178, 2);
