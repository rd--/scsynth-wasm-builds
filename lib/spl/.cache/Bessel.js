sl.extendTraitWithMethod(
  ...
  function (_n, _x) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _n, _x"; /* console.error(errorMessage); */
...
sl.extendTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      /* Temporaries */
      let __genSym68 = _assertIsOfSize_2(_besselAsympt0_1(_x), 2),
        _p0 = _at_2(__genSym68, 1),
        _q0 = _at_2(__genSym68, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      /* Temporaries */
      let __genSym69 = _assertIsOfSize_2(_besselAsympt1_1(_x), 2),
        _p0 = _at_2(__genSym69, 1),
        _q0 = _at_2(__genSym69, 2);
