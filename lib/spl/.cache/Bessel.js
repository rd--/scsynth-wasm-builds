...
sl.extendTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      /* Temporaries */
      let __genSym67 = _assertIsOfSize_2(_besselAsympt0_1(_x), 2),
        _p0 = _at_2(__genSym67, 1),
        _q0 = _at_2(__genSym67, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      /* Temporaries */
      let __genSym68 = _assertIsOfSize_2(_besselAsympt1_1(_x), 2),
