...
sl.extendTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      let __genSym144 = _assertIsOfSize_2(_besselAsympt0_1(_x), 2),
        _p0 = _at_2(__genSym144, 1),
        _q0 = _at_2(__genSym144, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      let __genSym145 = _assertIsOfSize_2(_besselAsympt1_1(_x), 2),
        _p0 = _at_2(__genSym145, 1),
        _q0 = _at_2(__genSym145, 2);
