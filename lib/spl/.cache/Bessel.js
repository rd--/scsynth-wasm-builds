...
sl.extendTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      let __genSym109 = _assertIsOfSize_2(_besselAsympt0_1(_x), 2),
        _p0 = _at_2(__genSym109, 1),
        _q0 = _at_2(__genSym109, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_x) {
    ...
    return _if_3(_greaterThanSign_2(_x, 8), function () {
      ...
      let __genSym110 = _assertIsOfSize_2(_besselAsympt1_1(_x), 2),
        _p0 = _at_2(__genSym110, 1),
        _q0 = _at_2(__genSym110, 2);
