...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    let _answer = [];
    /* Statements */
    _withIndexDo_2(_contents_1(_self), function (_each, _i) {
      /* ArityCheck */
...
sl.addMethodToExistingType(
  ...
  function (_self, _i) {
    ...
    let _shape = _shape_1(_self);
    /* Statements */
    return _if_3(_equalsSign_2(_size_1(_shape), 1), function () {
      /* ArityCheck */
      ...
      let _answer = [];
      /* Statements */
      _keysAndValuesDo_2(_contents_1(_self), function (_key, _value) {
        /* ArityCheck */
        if (arguments.length !== 2) {
        ...
        /* Statements */
        return _ifTrue_2(_equalsSign_2(_at_2(_c, 1), _i), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self, _linearIndex) {
    ...
    /* Statements */
    return _if_3(_includesKey_2(_map, _linearIndex), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    /* Statements */
    return _deepCollect_2(_iota_1(_shape_1(_self)), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        throw new Error(errorMessage);
      } /* Statements */
      return _if_3(_includesKey_2(_map, _each), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self, _other, _aBlock_2) {
    ...
    return _if_3(
      _verticalLine_2(
        _tildeEqualsSign_2(_rank_1(_self), _rank_1(_other)),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
      ...
      function () {
        ...
        /* Statements */
        return _SparseArray_3(
          _collect_2(_linearIndices, function (_i) {
            /* ArityCheck */
            if (arguments.length !== 1) {
              const errorMessage = "Arity: expected 1, _i";
              throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self, _elementAndIndexBlock_2) {
    ...
    return _keysAndValuesDo_2(_contents_1(_self), function (_key, _value) {
      /* ArityCheck */
      if (arguments.length !== 2) {
        const errorMessage = "Arity: expected 2, _key, _value";
        throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _shape, _unspecifiedValue) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _unspecifiedValue) {
    /* ArityCheck */
    if (arguments.length !== 2) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _shape, _unspecifiedValue) {
    ...
    _do_2(_self, function (_each) {
      ...
      let _linearIndex = _if_3(_isInteger_1(_index), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
  ...
  "{ :self :shape :unspecifiedValue | let map = Map(); do(self, { :each | let index = key(each); let linearIndex = if(isInteger(index), { index }, { linearIndex(shape,index) }); atPut(map,linearIndex, value(each)) }); SparseArray(map, shape, unspecifiedValue) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL1 = assertIsOfSize(self, 2); let m = at(__SPL1, 1); let n = at(__SPL1, 2); let k = min(m,n); SparseArray(collect(upOrDownTo(1, k), { :i | ->([i, i], 1) }), [m, n], 0) }",
);
