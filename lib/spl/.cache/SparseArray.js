...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL71 = _assertIsOfSize_2(_self, 2);
  ...
  "{ :self | let __SPL71 = assertIsOfSize(self, 2); let m = at(__SPL71, 1); let n = at(__SPL71, 2); let k = min(m,n); SparseArray(collect(upOrDownTo(1, k), { :i | ->([i, i], 1) }), [m, n], 0) }",
);
