...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL63 = _assertIsOfSize_2(_self, 2);
    let _m = _at_2(__SPL63, 1);
    let _n = _at_2(__SPL63, 2);
    let _k = _min_2(_m, _n);
    /* Statements */
    return _SparseArray_3(
      _collect_2(
  ...
  "{ :self | let __SPL63 = assertIsOfSize(self, 2); let m = at(__SPL63, 1); let n = at(__SPL63, 2); let k = min(m,n); SparseArray(collect(upOrDownTo(1, k), { :i | ->([i, i], 1) }), [m, n], 0) }",
);
