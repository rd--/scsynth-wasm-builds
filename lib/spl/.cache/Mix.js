sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_numOutputs, _inputList, _sparseMatrix) {
    ...
    _do_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        let __SPL552 = _assertIsOfSize_2(_each, 3);
        let _inputIndex = _at_2(__SPL552, 1);
        let _outputIndex = _at_2(__SPL552, 2);
        let _gain = _at_2(__SPL552, 3);
        /* Statements */
        return _atPut_3(
          _answer,
          _outputIndex,
  ...
  "{ :numOutputs :inputList :sparseMatrix | let answer = #(Dc(0), numOutputs); do(sparseMatrix, { :each | let __SPL552 = assertIsOfSize(each, 3); let inputIndex = at(__SPL552, 1); let outputIndex = at(__SPL552, 2); let gain = at(__SPL552, 3); atPut(answer, outputIndex, *(+(at(answer, outputIndex), at(inputList, inputIndex)), gain)) }); answer }",
);
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _do_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          let __SPL553 = _assertIsOfSize_2(_each, 2);
          let _name = _at_2(__SPL553, 1);
          let _busesByIndex = _at_2(__SPL553, 2);
          /* Statements */
