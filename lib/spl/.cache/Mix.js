sl.extendTraitWithMethod(
  ...
  function (_numOutputs, _inputList, _sparseMatrix) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _numOutputs, _inputList, _sparseMatrix"; /* console.error(errorMessage); */
    ...
    _do_2(_sparseMatrix, function (_each) {
      ...
      /* Temporaries */
      let __genSym125 = _assertIsOfSize_2(_each, 3),
        _inputIndex = _at_2(__genSym125, 1),
        _outputIndex = _at_2(__genSym125, 2),
        _gain = _at_2(__genSym125, 3);
      /* Statements */
      return _atPut_3(
        _answer,
        _outputIndex,
      ...
      _join_2(
        _runsAndValuesCollect_2(_runList, function (_run, _value) {
          ...
          if (arguments.length !== 2) {
            const errorMessage =
              "Arity: expected 2, _run, _value"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Statements */
...
sl.addMethod(
  ...
  function (_self, _prefix, _ruleTable) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _prefix, _ruleTable"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      _do_2(_ruleTable, function (_each) {
        ...
        /* Temporaries */
        let __genSym126 = _assertIsOfSize_2(_each, 2),
          _name = _at_2(__genSym126, 1),
          _busesByIndex = _at_2(__genSym126, 2);
        /* Statements */
...
sl.addMethod(
  ...
  function (_inList, _spread) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _inList, _spread"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  function (_input, _position) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _input, _position"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _numberOfChannels = _mainOutputs_1(_scSynth_1(_system));
