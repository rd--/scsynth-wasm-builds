sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_numOutputs, _inputList, _sparseMatrix) {
    ...
    _do_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        let __SPL324 = _assertIsOfSize_2(_each, 3);
        let _inputIndex = _at_2(__SPL324, 1);
        let _outputIndex = _at_2(__SPL324, 2);
        let _gain = _at_2(__SPL324, 3);
        /* Statements */
        return _atPut_3(
          _answer,
          _outputIndex,
  ...
  "{ :numOutputs :inputList :sparseMatrix | let answer = #(Dc(0), numOutputs); do(sparseMatrix, { :each | let __SPL324 = assertIsOfSize(each, 3); let inputIndex = at(__SPL324, 1); let outputIndex = at(__SPL324, 2); let gain = at(__SPL324, 3); atPut(answer, outputIndex, *(+(at(answer, outputIndex), at(inputList, inputIndex)), gain)) }); answer }",
);
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _do_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          let __SPL325 = _assertIsOfSize_2(_each, 2);
          let _name = _at_2(__SPL325, 1);
          let _busesByIndex = _at_2(__SPL325, 2);
          /* Statements */
