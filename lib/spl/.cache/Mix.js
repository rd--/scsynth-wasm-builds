sl.extendTraitWithMethod(
  ...
  "Mix",
  "SparseMatrixMixer",
  ["numOutputs", "inputArray", "sparseMatrix"],
  function (_numOutputs, _inputArray, _sparseMatrix) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _numOutputs, _inputArray, _sparseMatrix";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Temporaries */
    let _answer = _bang_2(_Dc_1(0), _numOutputs);
    /* Statements */
    _do_2(_sparseMatrix, function (_each) {
      ...
      /* Temporaries */
      let __genSym23 = _assertIsOfSize_2(_each, 3),
        _inputIndex = _at_2(__genSym23, 1),
        _outputIndex = _at_2(__genSym23, 2),
        _gain = _at_2(__genSym23, 3);
      /* Statements */
      return _atPut_3(
        _answer,
        _outputIndex,
    ...
    return _atIfAbsentPut_3(
      ...
      function () {
        ...
        return Object.fromEntries([[
          "2×2→1×4",
          _transposed_1([
            _asArray_1(_upOrDownTo_2(1, 4)),
            _asArray_1(_upOrDownTo_2(1, 4)),
            _bang_2(1, 4),
          ]),
        ], [
          "4×2→1×4",
          _transposed_1([_asArray_1(_upOrDownTo_2(1, 8)), [
            1,
            2,
            2,
            3,
          ...
          "4×2→1×8",
          _transposed_1([
            _asArray_1(_upOrDownTo_2(1, 8)),
            _asArray_1(_upOrDownTo_2(1, 8)),
            _bang_2(1, 8),
          ]),
        ], [
          "8×2→1×8",
          _transposed_1([_asArray_1(_upOrDownTo_2(1, 16)), [
            1,
            2,
            2,
            3,
          ...
          "8×2→2×4",
          _transposed_1([
            _asArray_1(_upOrDownTo_2(1, 16)),
            _x_1(_plus_2)([0, 4], [1, 2, 2, 3, 3, 4, 4, 1]),
            _bang_2(1, 16),
          ]),
        ], [
          "16×2→2×8",
          _transposed_1([
            _asArray_1(_upOrDownTo_2(1, 32)),
            _x_1(_plus_2)([0, 8], [
              1,
              2,
              2,
          ...
          _transposed_1([
            _asArray_1(_upOrDownTo_2(1, 32)),
            _x_1(_plus_2)([0, 4, 8, 12], [1, 2, 2, 3, 3, 4, 4, 1]),
            _bang_2(1, 32),
          ]),
        ], [
          "2×2→1×8",
          ...
          "10×2→1×2+1×8+2×4",
          _transposed_1([
            _asArray_1(_upOrDownTo_2(1, 20)),
            _concatenation_1([
              _asArray_1(_upOrDownTo_2(1, 2)),
              _x_1(_plus_2)([2, 10], _asArray_1(_upOrDownTo_2(1, 8))),
              _plus_2(2, [1, 5]),
            ]),
            _bang_2(1, 20),
          ]),
          ...
          "12×2→1×2+1×8+2×4",
          _transposed_1([
            _asArray_1(_upOrDownTo_2(1, 24)),
            _concatenation_1([
              _asArray_1(_upOrDownTo_2(1, 2)),
              _x_1(_plus_2)([2, 10], _asArray_1(_upOrDownTo_2(1, 8))),
              _plus_2(2, [1, 5, 3, 7, 4, 8]),
            ]),
            _bang_2(1, 24),
          ]),
        ], [
          "13×2→1×2+1×8+2×4",
          _transposed_1([
            _asArray_1(_upOrDownTo_2(1, 26)),
            _concatenation_1([
              _asArray_1(_upOrDownTo_2(1, 2)),
              _x_1(_plus_2)([2, 10], _asArray_1(_upOrDownTo_2(1, 8))),
              _plus_2(2, [1, 5, 3, 7, 4, 8, 2, 6]),
            ]),
            _bang_2(1, 26),
          ]),
        ], [
          ...
          _transposed_1([
            ...
            _concatenation_1([
              ...
              _x_1(_plus_2)([8, 12], [1, 2, 2, 4, 4, 3, 3, 1]),
            ]),
            _bang_2(1, 32),
          ]),
        ]]);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _runArray = _asRunArray_1(_collect_2(_self, _size_1));
    let _derivedPrefix = _plusPlus_2(
      _joinSeparatedBy_2(
        _runsAndValuesCollect_2(_runArray, function (_run, _value) {
          /* ArityCheck */
          ...
          /* Statements */
          return _join_1([_asString_1(_run), "×", _asString_1(_value)]);
        }),
        "+",
      ),
      "→",
  ...
  function (_self, _prefix, _ruleTable) {
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      _do_2(_ruleTable, function (_each) {
        ...
        /* Temporaries */
        let __genSym24 = _assertIsOfSize_2(_each, 2),
          _name = _at_2(__genSym24, 1),
          _busesByIndex = _at_2(__genSym24, 2);
        /* Statements */
        return _atIfPresent_3(
          _sparseMatrixTable,
          _plusPlus_2(_prefix, _name),
          function (_entries) {
            /* ArityCheck */
            if (arguments.length !== 1) {
...
sl.addMethod(
  ...
  "Splay",
  ["inArray", "spread"],
  function (_inArray, _spread) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _inArray, _spread";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Temporaries */
    ...
    /* Statements */
    return _if_3(
      _and_2(_equals_2(_size_1(_inArray), _numberOfChannels), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
      ...
      function () {
        ...
        /* Statements */
        return _if_3(_equals_2(_numberOfChannels, 2), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          /* Statements */
          return _Splay2_5(_inArray, _spread, 1, 0, true);
        }, function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_greaterThanEquals_2(_size_1(_self), 4), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
