sl.extendTraitWithMethod(
  ...
  function (_numOutputs, _inputList, _sparseMatrix) {
    ...
    _do_2(_sparseMatrix, function (_each) {
      ...
      let __genSym6 = _assertIsOfSize_2(_each, 3),
        _inputIndex = _at_2(__genSym6, 1),
        _outputIndex = _at_2(__genSym6, 2),
        _gain = _at_2(__genSym6, 3);
      /* Statements */
      return _atPut_3(
        _answer,
        _outputIndex,
  ...
  function (_self, _prefix, _ruleTable) {
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      _do_2(_ruleTable, function (_each) {
        ...
        let __genSym7 = _assertIsOfSize_2(_each, 2),
          _name = _at_2(__genSym7, 1),
          _busesByIndex = _at_2(__genSym7, 2);
        /* Statements */
