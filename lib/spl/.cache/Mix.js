sl.extendTraitWithMethod(
  ...
  function (_numOutputs, _inputList, _sparseMatrix) {
    ...
    /* Temporaries */
    let _answer = _exclamationMark_2(_Dc_1(0), _numOutputs);
    /* Statements */
    _do_2(_sparseMatrix, function (_each) {
      ...
      /* Temporaries */
      let __genSym26 = _assertIsOfSize_2(_each, 3),
        _inputIndex = _at_2(__genSym26, 1),
        _outputIndex = _at_2(__genSym26, 2),
        _gain = _at_2(__genSym26, 3);
      /* Statements */
      return _atPut_3(
        _answer,
        _outputIndex,
      ...
      function () {
        ...
        return Object.fromEntries([[
          ...
          _transposed_1([
            ...
            _asList_1(_upOrDownTo_2(1, 4)),
            _exclamationMark_2(1, 4),
          ]),
        ], [
          "4×2→1×4",
          _transposed_1([_asList_1(_upOrDownTo_2(1, 8)), [
            1,
            2,
            2,
            3,
            ...
            4,
            1,
          ], _exclamationMark_2(1, 8)]),
        ], [
          "4×2→1×8",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 8)),
            _asList_1(_upOrDownTo_2(1, 8)),
            _exclamationMark_2(1, 8),
          ]),
        ], [
          "8×2→1×8",
          _transposed_1([_asList_1(_upOrDownTo_2(1, 16)), [
            1,
            2,
            2,
            3,
            ...
            8,
            1,
          ], _exclamationMark_2(1, 16)]),
        ], [
          "8×2→2×4",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 16)),
          ...
          "3×2→1×8",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 6)),
            [8, 2, 7, 3, 6, 4],
            _exclamationMark_2(1, 6),
          ]),
        ], [
          "3×6→1×2+1×8+2×4",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 18)),
            _asList_1(_upOrDownTo_2(1, 18)),
            _exclamationMark_2(1, 18),
          ]),
        ], [
          "4×2→1×8",
          _transposed_1([
          ...
          "5×2→1×2+1×8",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 10)),
            _asList_1(_upOrDownTo_2(1, 10)),
            _exclamationMark_2(1, 10),
          ]),
        ], [
          "6×2→1×8+2×4",
          _transposed_1([
            ...
            _asList_1(_upOrDownTo_2(1, 12)),
            _exclamationMark_2(1, 12),
          ]),
        ], [
          "7×2→1×8+2×4",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 14)),
            _asList_1(_upOrDownTo_2(1, 14)),
            _exclamationMark_2(1, 14),
          ]),
        ], [
          "8×1→1×8",
          _transposed_1([
          ...
          "10×2→1×2+1×8+2×4",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 20)),
            _concatenation_1([
              _asList_1(_upOrDownTo_2(1, 2)),
              _x_1(_plusSign_2)([2, 10], _asList_1(_upOrDownTo_2(1, 8))),
              _plusSign_2(2, [1, 5]),
            ]),
            _exclamationMark_2(1, 20),
          ]),
        ], [
          "11×2→1×2+1×8+2×4",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 22)),
            _concatenation_1([
              _asList_1(_upOrDownTo_2(1, 2)),
              _x_1(_plusSign_2)([2, 10], _asList_1(_upOrDownTo_2(1, 8))),
              _plusSign_2(2, [1, 5, 3, 7]),
            ]),
            _exclamationMark_2(1, 22),
          ]),
        ], [
          "12×2→1×2+1×8+2×4",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 24)),
            _concatenation_1([
              _asList_1(_upOrDownTo_2(1, 2)),
              _x_1(_plusSign_2)([2, 10], _asList_1(_upOrDownTo_2(1, 8))),
              _plusSign_2(2, [1, 5, 3, 7, 4, 8]),
            ]),
            _exclamationMark_2(1, 24),
          ]),
        ], [
          "13×2→1×2+1×8+2×4",
          _transposed_1([
            _asList_1(_upOrDownTo_2(1, 26)),
            _concatenation_1([
              _asList_1(_upOrDownTo_2(1, 2)),
              _x_1(_plusSign_2)([2, 10], _asList_1(_upOrDownTo_2(1, 8))),
              _plusSign_2(2, [1, 5, 3, 7, 4, 8, 2, 6]),
            ]),
            _exclamationMark_2(1, 26),
          ]),
        ], [
          "1×8+2×4→1×8+2×4",
          _transposed_1([
  ...
  function (_self, _prefix, _ruleTable) {
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      _do_2(_ruleTable, function (_each) {
        ...
        /* Temporaries */
        let __genSym27 = _assertIsOfSize_2(_each, 2),
          _name = _at_2(__genSym27, 1),
          _busesByIndex = _at_2(__genSym27, 2);
        /* Statements */
