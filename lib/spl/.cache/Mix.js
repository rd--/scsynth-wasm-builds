sl.extendTypeOrTraitWithMethod(
  ...
  "{ :numOutputs :inputList :sparseMatrix | let answer = #(Dc(0), numOutputs); do(sparseMatrix, { :each | let __SplVar1 = assertIsOfSize(each, 3); let inputIndex = at(__SplVar1, 1); let outputIndex = at(__SplVar1, 2); let gain = at(__SplVar1, 3); atPut(answer, outputIndex, *(+(at(answer, outputIndex), at(inputList, inputIndex)), gain)) }); answer }",
);
