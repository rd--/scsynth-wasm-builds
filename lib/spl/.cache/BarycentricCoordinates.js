...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b, _c) {
    ...
    return sl.annotateFunction(function (_p) {
      ...
      let __SPL84 = _assertIsOfSize_2(
        _dot_2(_inverse_1(_t), _hyphenMinus_2(_p, _c)),
        2,
      );
      let _u = _at_2(__SPL84, 1);
      let _v = _at_2(__SPL84, 2);
      /* Statements */
      return [_u, _v, _hyphenMinus_2(_hyphenMinus_2(1, _u), _v)];
    }, ["p"]);
  }, ["a", "b", "c"]),
  "{ :a :b :c | let t = [[-(at(a, 1), at(c, 1)), -(at(b, 1), at(c, 1))], [-(at(a, 2), at(c, 2)), -(at(b, 2), at(c, 2))]]; { :p | let __SPL84 = assertIsOfSize(dot(inverse(t),-(p, c)), 2); let u = at(__SPL84, 1); let v = at(__SPL84, 2); [u, v, -(-(1, u), v)] } }",
);
