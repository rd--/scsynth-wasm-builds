...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p, _q) {
    ...
    return _sum_1(_sum_1(_table_3(
      sl.annotateFunction(function (_a, _b) {
        ...
        let __SPL32 = _assertIsOfSize_2(_a, 2);
        let _f1 = _at_2(__SPL32, 1);
        let _u1 = _at_2(__SPL32, 2);
        let __SPL33 = _assertIsOfSize_2(_b, 2);
        let _f2 = _at_2(__SPL33, 1);
        let _u2 = _at_2(__SPL33, 2);
        /* Statements */
  ...
  "{ :p :q | sum(sum(table({ :a :b | let __SPL32 = assertIsOfSize(a, 2); let f1 = at(__SPL32, 1); let u1 = at(__SPL32, 2); let __SPL33 = assertIsOfSize(b, 2); let f2 = at(__SPL33, 1); let u2 = at(__SPL33, 2); plompLeveltDissonance(f1, f2, u1, u2) },p, q))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL34 = _assertIsOfSize_2(
      _asList_1(_withoutFactorsOfTwo_1(_self)),
      2,
    );
    let _n = _at_2(__SPL34, 1);
    let _d = _at_2(__SPL34, 2);
    /* Statements */
    return _max_2(_n, _d);
  }, ["self"]),
  "{ :self | let __SPL34 = assertIsOfSize(asList(withoutFactorsOfTwo(self)), 2); let n = at(__SPL34, 1); let d = at(__SPL34, 2); max(n,d) }",
);
