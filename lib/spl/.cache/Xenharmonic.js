...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar3 = _assertIsOfSize_2(
      _numeratorDenominator_1(_withoutFactorsOfTwo_1(_self)),
      2,
    );
  ...
  "{ :self |\n\t\tlet [n, d] = self.withoutFactorsOfTwo.numeratorDenominator;\n\t\tn.max(d)\n\t}",
);
  ...
  sl.annotateFunction(function (_self, _octaveRatio) {
    ...
    _whileTrue_2(
      sl.annotateFunction(function () {
        ...
        return _lessThanSign_2(_self, 1);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _self = _asterisk_2(_self, _octaveRatio);
      }, []),
    );
    _whileTrue_2(
      sl.annotateFunction(function () {
        ...
        return _greaterThanSignEqualsSign_2(_self, _octaveRatio);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _self = _solidus_2(_self, _octaveRatio);
      }, []),
    );
    return _self;
  }, ["self", "octaveRatio"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _circumflexAccent_2(_Fraction_2(4375n, 4374n), _self);
  }, ["self"]),
  "{ :self |\n\t\t4375/4374 ^ self\n\t}",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _n = _asList_1(_nonemptyThenTo_3(1, 3, _self));
          ...
          _catenate_1(
            _collect_2(
              ...
              sl.annotateFunction(function (_n) {
                ...
                let _m = _ceiling_1(_solidus_2(_n, 2));
                /* Statements */
                return _collect_2(
                  _select_2(
                    _nonemptyRange_3(_m, _hyphenMinus_2(_n, 1), 1),
                  ...
                  sl.annotateFunction(function (_d) {
                    ...
                    return _hyphenMinusGreaterThanSign_2(
                      _solidus_2(_n, _d),
                      _solidus_1(_sqrt_1(_asterisk_2(_n, _d))),
                    );
                  }, ["d"]),
                );
              }, ["n"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_k) {
    ...
    let _s = _solidus_2(1200, _k);
    /* Statements */
    return _solidus_2(
      _sum_1(
        _collect_2(
          _yunikSwiftConsonanceTable_2(21, 50),
          sl.annotateFunction(function (_j) {
            ...
            return _sum_2(
              ...
              sl.annotateFunction(function (_i) {
                ...
                let _r = _centsToRatio_1(_asterisk_2(_s, _i));
                /* Statements */
                return _if_3(
                  _lessThanSign_2(
                    _abs_1(_relativeChange_2(_key_1(_j), _r)),
                    0.005,
                  ),
                  sl.annotateFunction(function () {
                    /* ArityCheck */
