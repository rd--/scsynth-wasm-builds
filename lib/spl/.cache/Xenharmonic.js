...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL1 = _assertIsOfSize_2(_asList_1(_withoutFactorsOfTwo_1(_self)), 2);
    let _n = _at_2(__SPL1, 1);
    let _d = _at_2(__SPL1, 2);
    /* Statements */
    return _max_2(_n, _d);
  },
  "{ :self | let __SPL1 = assertIsOfSize(asList(withoutFactorsOfTwo(self)), 2); let n = at(__SPL1, 1); let d = at(__SPL1, 2); max(n,d) }",
);
