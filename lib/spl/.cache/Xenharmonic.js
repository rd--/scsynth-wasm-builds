...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL283 = _assertIsOfSize_2(
      _asList_1(_withoutFactorsOfTwo_1(_self)),
      2,
    );
    let _n = _at_2(__SPL283, 1);
    let _d = _at_2(__SPL283, 2);
    /* Statements */
    return _max_2(_n, _d);
  }, ["self"]),
  "{ :self | let __SPL283 = assertIsOfSize(asList(withoutFactorsOfTwo(self)), 2); let n = at(__SPL283, 1); let d = at(__SPL283, 2); max(n,d) }",
);
