...
sl.extendTypeOrTraitWithMethod(
      ...
      [
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL109 = _assertIsOfSize_2(_self, 2);
            let _x = _at_2(__SPL109, "x");
            let _y = _at_2(__SPL109, "y");
            /* Statements */
  ...
  "{ :self | caseOf(size(self), [->(2, { let __SPL109 = assertIsOfSize(self, 2); let x = at(__SPL109, 'x'); let y = at(__SPL109, 'y'); CartesianCoordinates([x, y]) }), ->(3, { let __SPL110 = assertIsOfSize(self, 3); let x = at(__SPL110, 'x'); let y = at(__SPL110, 'y'); let z = at(__SPL110, 'z'); CartesianCoordinates([x, y, z]) }), ->(4, { let __SPL111 = assertIsOfSize(self, 4); let x = at(__SPL111, 'x'); let y = at(__SPL111, 'y'); let z = at(__SPL111, 'z'); let w = at(__SPL111, 'w'); CartesianCoordinates([x, y, z, w]) })], { error(self,'asCartesianCoordinates: not x,y or x,y,z or x,y,z,w') }) }",
);
