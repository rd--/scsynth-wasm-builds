...
sl.addMethodToExistingType(
  ...
  "{ :self | caseOfOtherwise(size(self), [->(2, { Record([['x', x(self)], ['y', y(self)]]) }), ->(3, { Record([['x', x(self)], ['y', y(self)], ['z', z(self)]]) }), ->(4, { Record([['x', x(self)], ['y', y(self)], ['z', z(self)], ['w', w(self)]]) })], { error(self,'asRecord: not x,y or x,y,z or x,z,y,w') }) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _caseOfOtherwise_3(
      ...
      [
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let _x = _at_2(__SPL1, "x");
            let _y = _at_2(__SPL1, "y");
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let _x = _at_2(__SPL2, "x");
            let _y = _at_2(__SPL2, "y");
            let _z = _at_2(__SPL2, "z");
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL3 = _assertIsOfSize_2(_self, 4);
            let _x = _at_2(__SPL3, "x");
            let _y = _at_2(__SPL3, "y");
            let _z = _at_2(__SPL3, "z");
            let _w = _at_2(__SPL3, "w");
            /* Statements */
      ...
      sl.annotateFunction(function () {
        ...
        return _error_2(_self, "asCartesianCoordinates: not x,y or x,y,z");
      }, []),
    );
  }, ["self"]),
  "{ :self | caseOfOtherwise(size(self), [->(2, { let __SPL1 = assertIsOfSize(self, 2); let x = at(__SPL1, 'x'); let y = at(__SPL1, 'y'); CartesianCoordinates([x, y]) }), ->(3, { let __SPL2 = assertIsOfSize(self, 3); let x = at(__SPL2, 'x'); let y = at(__SPL2, 'y'); let z = at(__SPL2, 'z'); CartesianCoordinates([x, y, z]) }), ->(4, { let __SPL3 = assertIsOfSize(self, 4); let x = at(__SPL3, 'x'); let y = at(__SPL3, 'y'); let z = at(__SPL3, 'z'); let w = at(__SPL3, 'w'); CartesianCoordinates([x, y, z, w]) })], { error(self,'asCartesianCoordinates: not x,y or x,y,z') }) }",
);
