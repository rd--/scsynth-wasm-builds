...
sl.addMethodToExistingTrait(
  ...
  "{ :self | coordinates(self, negate(coordinates(self))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | sqrt(sum(square(coordinates(self)))) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      [
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL110 = _assertIsOfSize_2(_self, 2);
            let _x = _at_2(__SPL110, "x");
            let _y = _at_2(__SPL110, "y");
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL111 = _assertIsOfSize_2(_self, 3);
            let _x = _at_2(__SPL111, "x");
            let _y = _at_2(__SPL111, "y");
            let _z = _at_2(__SPL111, "z");
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL112 = _assertIsOfSize_2(_self, 4);
            let _x = _at_2(__SPL112, "x");
            let _y = _at_2(__SPL112, "y");
            let _z = _at_2(__SPL112, "z");
            let _w = _at_2(__SPL112, "w");
            /* Statements */
  ...
  "{ :self | caseOf(size(self), [->(2, { let __SPL110 = assertIsOfSize(self, 2); let x = at(__SPL110, 'x'); let y = at(__SPL110, 'y'); CartesianCoordinates([x, y]) }), ->(3, { let __SPL111 = assertIsOfSize(self, 3); let x = at(__SPL111, 'x'); let y = at(__SPL111, 'y'); let z = at(__SPL111, 'z'); CartesianCoordinates([x, y, z]) }), ->(4, { let __SPL112 = assertIsOfSize(self, 4); let x = at(__SPL112, 'x'); let y = at(__SPL112, 'y'); let z = at(__SPL112, 'z'); let w = at(__SPL112, 'w'); CartesianCoordinates([x, y, z, w]) })], { error(self,'asCartesianCoordinates: not x,y or x,y,z or x,y,z,w') }) }",
);
