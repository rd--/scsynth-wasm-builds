  ...
  sl.annotateFunction(function (_self) {
    ...
    return _caseOf_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _error_2(
          _self,
          "CartesianCoordinates: not x,y or x,y,z or x,y,z,w",
        );
      }, []),
    );
  }, ["self"]),
  ...
  sl.annotateFunction(function (_self, _radius) {
    ...
    return _atVectorOrElementwise_2(
      ...
      sl.annotateFunction(function (_v) {
        ...
        let _d = _sqrt_1(
          _plusSign_2(_plusSign_2(_square_1(_x), _square_1(_y)), _square_1(_z)),
        );
        return [
          _solidus_2(_asterisk_2(_x, _radius), _d),
          _solidus_2(_asterisk_2(_y, _radius), _d),
        ];
      }, ["v"]),
    );
  }, ["self", "radius"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _curvilinearProjection_2(_self, 1);
  }, ["self"]),
