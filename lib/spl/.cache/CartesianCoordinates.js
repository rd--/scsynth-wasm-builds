...
sl.addMethodToExistingType(
  ...
  "{ :self | join(['CartesianCoordinates(', storeString(x(self)), ', ', storeString(y(self)), ', ', storeString(z(self)), ')'],'') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL1 = assertIsOfSize(self, 3); let x = at(__SPL1, 1); let y = at(__SPL1, 2); let z = at(__SPL1, 3); CartesianCoordinates(x, y, z) }",
);
