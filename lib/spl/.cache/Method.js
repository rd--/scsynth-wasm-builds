...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(
      _plusPlus_2(_plusPlus_2("	", _name_1(_self)), " "),
      _sourceCode_1(_self),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    return _evaluate_2(
      _system,
      _join_1(["+", _qualifiedName_1(_origin_1(_self)), "{ ", _aString, " }"]),
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_equals_2(_arity_1(_self), 2), function () {
      /* ArityCheck */
      ...
      return _valueWithReturn_1(function (_return_1) {
        ...
        _associationsDo_2(_operatorNameTable_1(_system), function (_each) {
          ...
          /* Statements */
          return _ifTrue_2(_equals_2(_value_1(_each), _name), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _join_1([_packageName_1(_self), ":", _name_1(_origin_1(_self))]);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_plusPlus_2(_name_1(_self), ":/"), _arity_1(_self));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(
      _plusPlus_2(_qualifiedName_1(_origin_1(_self)), ">>"),
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_isOperatorName_1(_self), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Primitive */
    return sl.isOperatorName(_self);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Primitive */
    return sl.operatorMethodName(_self);
  },
