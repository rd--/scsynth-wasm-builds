  ...
  sl.annotateFunction(function (_self, _i, _ifAbsent_0) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _error_2(_self, "NumericArray>>atIfAbsent");
      }, []),
    );
  }, ["self", "i", "ifAbsent:/0"]),
...
sl.addMethodToExistingType(
  ...
  "NumericArray",
  "atPathPut",
  ["self", "cartesianIndex", "x"],
  sl.annotateFunction(function (_self, _cartesianIndex, _x) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _cartesianIndex, _x";
      throw new Error(errorMessage);
    } /* Statements */
    return _atPut_3(
      _contents_1(_self),
              ...
              sl.annotateFunction(function (_i) {
                ...
                return _toDo_3(
                  ...
                  sl.annotateFunction(function (_j) {
                    ...
                    let _x = _atPath_2(_self, [_i, _j]);
                    let _y = _atPath_2(_self, [_j, _i]);
                    /* Statements */
                    _atPathPut_3(_self, [_i, _j], _y);
                    return _atPathPut_3(_self, [_j, _i], _x);
                  }, ["j"]),
                );
              }, ["i"]),
            );
