...
sl.addMethodToExistingType(
  ...
  "{ :self :i :j | if((=(rank(self), 2)), { let __SPL3 = assertIsOfSize(shape(self), 2); let m = at(__SPL3, 1); let n = at(__SPL3, 2); let linearIndex = +((*((-(i, 1)), n)), j); at(contents(self),linearIndex) }, { error(self,'NumericArray>>at') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :i :j :x | if((=(rank(self), 2)), { let __SPL4 = assertIsOfSize(shape(self), 2); let m = at(__SPL4, 1); let n = at(__SPL4, 2); let linearIndex = +((*((-(i, 1)), n)), j); atPut(contents(self),linearIndex, x) }, { error(self,'NumericArray>>atPut') }) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        let _n = _at_2(__SPL5, 1);
        let _m = _at_2(__SPL5, 2);
        /* Statements */
        return _equalsSign_2(_n, _m);
      }, []),
    );
  }, ["self"]),
  "{ :self | &((=(rank(self), 2)), { let __SPL5 = assertIsOfSize(shape(self), 2); let n = at(__SPL5, 1); let m = at(__SPL5, 2); =(n, m) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | if(isMatrix(self), { let __SPL7 = assertIsOfSize(shape(self), 2); let m = at(__SPL7, 1); let n = at(__SPL7, 2); let c = contents(self); let a = new(species(c),*(m, n)); let k = 1; toDo(1, n, { :i | toDo(1, m, { :j | atPut(a, k, at(c, +((*((-(j, 1)), n)), i))); k := +(k, 1) }) }); NumericArray(a, [n, m]) }, { error(self,'NumericArray>>transpose: not matrix') }) }",
);
