...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _i, _j) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL53 = _assertIsOfSize_2(_shape_1(_self), 2);
  ...
  "{ :self :i :j | if((=(rank(self), 2)), { let __SPL53 = assertIsOfSize(shape(self), 2); let m = at(__SPL53, 1); let n = at(__SPL53, 2); let linearIndex = +((*((-(i, 1)), n)), j); at(contents(self),linearIndex) }, { error(self,'NumericArray>>at') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :i :j :x | if((=(rank(self), 2)), { let __SPL54 = assertIsOfSize(shape(self), 2); let m = at(__SPL54, 1); let n = at(__SPL54, 2); let linearIndex = +((*((-(i, 1)), n)), j); atPut(contents(self),linearIndex, x) }, { error(self,'NumericArray>>atPut') }) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        let _n = _at_2(__SPL55, 1);
        let _m = _at_2(__SPL55, 2);
        /* Statements */
        return _equalsSign_2(_n, _m);
      }, []),
    );
  }, ["self"]),
  "{ :self | &((=(rank(self), 2)), { let __SPL55 = assertIsOfSize(shape(self), 2); let n = at(__SPL55, 1); let m = at(__SPL55, 2); =(n, m) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _m = _at_2(__SPL57, 1);
        let _n = _at_2(__SPL57, 2);
        let _c = _contents_1(_self);
  ...
  "{ :self | if(isMatrix(self), { let __SPL57 = assertIsOfSize(shape(self), 2); let m = at(__SPL57, 1); let n = at(__SPL57, 2); let c = contents(self); let a = new(species(c),*(m, n)); let k = 1; toDo(1, n, { :i | toDo(1, m, { :j | atPut(a, k, at(c, +((*((-(j, 1)), n)), i))); k := +(k, 1) }) }); NumericArray(a, [n, m]) }, { error(self,'NumericArray>>transposed: not matrix') }) }",
);
