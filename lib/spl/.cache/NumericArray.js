...
sl.addMethodToExistingType(
  ...
  "{ :self :i :j | if((=(rank(self), 2)), { let __SplVar1 = assertIsOfSize(shape(self), 2); let m = at(__SplVar1, 1); let n = at(__SplVar1, 2); let linearIndex = +((*((-(i, 1)), n)), j); at(contents(self),linearIndex) }, { error(self,'NumericArray>>at') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :i :j :x | if((=(rank(self), 2)), { let __SplVar2 = assertIsOfSize(shape(self), 2); let m = at(__SplVar2, 1); let n = at(__SplVar2, 2); let linearIndex = +((*((-(i, 1)), n)), j); atPut(contents(self),linearIndex, x) }, { error(self,'NumericArray>>atPut') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | &((=(rank(self), 2)), { let __SplVar3 = assertIsOfSize(shape(self), 2); let n = at(__SplVar3, 1); let m = at(__SplVar3, 2); =(n, m) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | if(isMatrix(self), { let __SplVar5 = assertIsOfSize(shape(self), 2); let m = at(__SplVar5, 1); let n = at(__SplVar5, 2); let c = contents(self); let a = new(species(c),*(m, n)); let k = 1; toDo(1, n, { :i | toDo(1, m, { :j | atPut(a, k, at(c, +((*((-(j, 1)), n)), i))); k := +(k, 1) }) }); NumericArray(a, [n, m]) }, { error(self,'NumericArray>>transpose: not matrix') }) }",
);
