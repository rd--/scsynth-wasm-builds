...
sl.addMethodToExistingType(
  ...
  "{ :self :i :ifAbsent:/0 | if((=(rank(self), 1)), { atIfAbsent(contents(self),i, ifAbsent:/0) }, { error(self,'NumericArray>>at') }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _i, _j) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL55 = _assertIsOfSize_2(_shape_1(_self), 2);
  ...
  "{ :self :i :j | if((=(rank(self), 2)), { let __SPL55 = assertIsOfSize(shape(self), 2); let m = at(__SPL55, 1); let n = at(__SPL55, 2); let linearIndex = +((*((-(i, 1)), n)), j); at(contents(self),linearIndex) }, { error(self,'NumericArray>>at') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :i :j :x | if((=(rank(self), 2)), { let __SPL56 = assertIsOfSize(shape(self), 2); let m = at(__SPL56, 1); let n = at(__SPL56, 2); let linearIndex = +((*((-(i, 1)), n)), j); atPut(contents(self),linearIndex, x) }, { error(self,'NumericArray>>atPut') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aBlock:/1 | NumericArray(collect(contents(self),aBlock:/1), shape(self)) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL57 = _assertIsOfSize_2(_shape_1(_self), 2);
        let _n = _at_2(__SPL57, 1);
        let _m = _at_2(__SPL57, 2);
        /* Statements */
        return _equalsSign_2(_n, _m);
      }, []),
    );
  }, ["self"]),
  "{ :self | &((=(rank(self), 2)), { let __SPL57 = assertIsOfSize(shape(self), 2); let n = at(__SPL57, 1); let m = at(__SPL57, 2); =(n, m) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _format_2("NumericArray(%, %)", [
      _contents_1(_self),
      _shape_1(_self),
    ]);
  }, ["self"]),
  "{ :self | format('NumericArray(%, %)',[contents(self), shape(self)]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL58 = _assertIsOfSize_2(_shape_1(_self), 2);
        let _m = _at_2(__SPL58, 1);
        let _n = _at_2(__SPL58, 2);
        /* Statements */
        return _if_3(
          _equalsSign_2(_n, _m),
          sl.annotateFunction(function () {
  ...
  "{ :self | if((=(rank(self), 2)), { let __SPL58 = assertIsOfSize(shape(self), 2); let m = at(__SPL58, 1); let n = at(__SPL58, 2); if((=(n, m)), { toDo(1, n, { :i | toDo((+(i, 1)), n, { :j | let x = at(self,i, j); let y = at(self,j, i); atPut(self,i, j, y); atPut(self,j, i, x) }) }) }, { let c = contents(self); let k = *(m, n); let visited = BitSet(k); let cycle = 0; whileTrue({ cycle := +(cycle, 1); ~=(cycle, k) }, { ifTrue((=(at(visited, cycle), 0)), { let a = cycle; doWhileTrue({ a := if((=(a, (-(k, 1)))), { -(k, 1) }, { %((*(a, m)), (-(k, 1))) }); swapWith(c,+(a, 1), +(cycle, 1)); atPut(visited, a, 1) }, { ~=(a, cycle) }) }) }); reverseInPlace(shape(self)) }) }, { error(self,'NumericArray>>transposeInPlace: not matrix') }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL59 = _assertIsOfSize_2(_shape_1(_self), 2);
        let _m = _at_2(__SPL59, 1);
        let _n = _at_2(__SPL59, 2);
        let _c = _contents_1(_self);
  ...
  "{ :self | if(isMatrix(self), { let __SPL59 = assertIsOfSize(shape(self), 2); let m = at(__SPL59, 1); let n = at(__SPL59, 2); let c = contents(self); let a = new(species(c),*(m, n)); let k = 1; toDo(1, n, { :i | toDo(1, m, { :j | atPut(a, k, at(c, +((*((-(j, 1)), n)), i))); k := +(k, 1) }) }); NumericArray(a, [n, m]) }, { error(self,'NumericArray>>transpose: not matrix') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :other :aBlock:/2 | if(isCommensurate(self,other), { NumericArray(withCollect(contents(self),contents(other), aBlock:/2), shape(self)) }, { error(self,'NumericArray>>withCollect: unequal shape or storage type') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | NumericArray(self, 'Float64') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :storageType | let contents = caseOf(storageType,[->('Byte', { asByteArray(ravel(self)) }), ->('Float32', { asFloat32Array(ravel(self)) }), ->('Float64', { asFloat64Array(ravel(self)) })]); NumericArray(contents, shape(self)) }",
);
