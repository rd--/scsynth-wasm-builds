...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _caseOf_3(
      ...
      [
        ...
        _hyphenMinusGreaterThanSign_2(
          _mainOutputs_1(_scSynth_1(_system)),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
  ...
  "{ :self | caseOf(size(self), [->(2, { preference(system,'ScSynth/Outputs/Stereo/BusOffset', 0) }), ->(mainOutputs(scSynth(system)), { preference(system,'ScSynth/Outputs/Main/BusOffset', 0) })], { 0 }) }",
);
