...
sl.addMethod(
  ...
  ["self", "aNumber", "aBlock"],
  function (_self, _aNumber, _aBlock) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aNumber, _aBlock"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _bus, _ugen) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _bus, _ugen"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _ugen) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _ugen"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _defaultValue) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _defaultValue"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
