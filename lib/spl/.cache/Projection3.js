...
sl.addMethod(
  ...
  function (_self, _vector) {
    ...
    /* Temporaries */
    let __genSym54 = _assertIsOfSize_2(_vector, 3),
      _x = _at_2(__genSym54, 1),
      _y = _at_2(__genSym54, 2),
      __genSym53 = _at_2(__genSym54, 3);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return (function (_aVector) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _aVector"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Temporaries */
      let __genSym56 = _assertIsOfSize_2(_dot_2(_matrix, _aVector), 3),
        _x = _at_2(__genSym56, 1),
        _y = _at_2(__genSym56, 2),
        __genSym55 = _at_2(__genSym56, 3);
      /* Statements */
      return [_x, _y];
    });
  },
