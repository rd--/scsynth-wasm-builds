...
sl.addMethod(
  ...
  function (_self, _vector) {
    ...
    /* Temporaries */
    let __genSym2 = _assertIsOfSize_2(_vector, 3),
      _x = _at_2(__genSym2, 1),
      _y = _at_2(__genSym2, 2),
      __genSym1 = _at_2(__genSym2, 3);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return (function (_aVector) {
      ...
      /* Temporaries */
      let __genSym4 = _assertIsOfSize_2(_dot_2(_matrix, _aVector), 3),
        _x = _at_2(__genSym4, 1),
        _y = _at_2(__genSym4, 2),
        __genSym3 = _at_2(__genSym4, 3);
      /* Statements */
      return [_x, _y];
    });
  },
