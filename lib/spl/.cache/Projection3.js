...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _Matrix33_9(
      _times_2(_x_1(_self), _negated_1(_cos_1(_beta_1(_self)))),
      0,
      _times_2(_z_1(_self), _cos_1(_alpha_1(_self))),
      _times_2(_x_1(_self), _sin_1(_beta_1(_self))),
      _y_1(_self),
      _times_2(_z_1(_self), _sin_1(_alpha_1(_self))),
      0,
      0,
      0,
    );
