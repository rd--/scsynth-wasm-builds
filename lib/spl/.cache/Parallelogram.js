...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL218 = _assertIsOfSize_2(_vectors_1(_self), 2);
    let _u = _at_2(__SPL218, 1);
    let _v = _at_2(__SPL218, 2);
    let _b = _at_2(_u, 1);
    let _h = _hyphenMinus_2(_at_2(_v, 2), _at_2(_o, 2));
    /* Statements */
    return _asterisk_2(_b, _h);
  }, ["self"]),
  "{ :self | let o = origin(self); let __SPL218 = assertIsOfSize(vectors(self), 2); let u = at(__SPL218, 1); let v = at(__SPL218, 2); let b = at(u, 1); let h = -(at(v, 2), at(o, 2)); *(b, h) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __genSym221 = _at_2(__SPL219, 1);
    let _v = _at_2(__SPL219, 2);
    /* Statements */
    return _hyphenMinus_2(_at_2(_v, 2), _at_2(_o, 2));
  }, ["self"]),
  "{ :self | let o = origin(self); let __SPL219 = assertIsOfSize(vectors(self), 2); let _ = at(__SPL219, 1); let v = at(__SPL219, 2); -(at(v, 2), at(o, 2)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let o = origin(self); let __SPL220 = assertIsOfSize(vectors(self), 2); let u = at(__SPL220, 1); let v = at(__SPL220, 2); let a = o; let b = +(a, u); let c = +(b, v); let d = +(a, v); [a, b, c, d] }",
);
