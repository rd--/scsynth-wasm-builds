...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar1 = _assertIsOfSize_2(_vectorList_1(_self), 2);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _o = _origin_1(_self);
    let __SplVar2 = _assertIsOfSize_2(_vectorList_1(_self), 2);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _o = _origin_1(_self);
    let __SplVar3 = _assertIsOfSize_2(_vectorList_1(_self), 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "Parallelogram",
  ["self", "vectorList"],
  sl.annotateFunction(function (_self, _vectorList) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _vectorList";
      throw new Error(errorMessage);
    } /* Statements */
    return _initializeSlots_3(_newParallelogram_0(), _self, _vectorList);
  }, ["self", "vectorList"]),
