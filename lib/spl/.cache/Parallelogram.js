...
sl.addMethodToExistingType(
  ...
  "{ :self | let o = origin(self); let __SplVar1 = assertIsOfSize(vectors(self), 2); let u = at(__SplVar1, 1); let v = at(__SplVar1, 2); let b = at(u, 1); let h = -(at(v, 2), at(o, 2)); *(b, h) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let o = origin(self); let __SplVar2 = assertIsOfSize(vectors(self), 2); let _ = at(__SplVar2, 1); let v = at(__SplVar2, 2); -(at(v, 2), at(o, 2)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let o = origin(self); let __SplVar3 = assertIsOfSize(vectors(self), 2); let u = at(__SplVar3, 1); let v = at(__SplVar3, 2); let a = o; let b = +(a, u); let c = +(b, v); let d = +(a, v); [a, b, c, d] }",
);
