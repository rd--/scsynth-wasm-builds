...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _pathDirectory_1(_pathName_1(_self));
  }, ["self"]),
...
sl.addType(
  ...
  "URL",
  "Url",
  ["Object", "Storeable", "Equatable", "Url"],
  [],
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _format_2("Url(%)", [_storeString_1(_href_1(_self))]);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _fetchThen_2(_self, _binaryLargeObject_1);
  }, ["self"]),
  "{ :self |\n\t\tself.fetchThen(\n\t\t\tbinaryLargeObject:/1\n\t\t)\n\t}",
);
              ...
              sl.annotateFunction(function (_response) {
                ...
                return _then_2(
                  ...
                  sl.annotateFunction(function (_unused) {
                    ...
                    return _uncheckedMatch_2(_cache, _self);
                  }, ["unused"]),
                );
              }, ["response"]),
              sl.annotateFunction(function (_reason) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  "Url",
  "gitHubFileUrl",
  ["userName", "projectName", "branch", "filePath"],
  sl.annotateFunction(function (_userName, _projectName, _branch, _filePath) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _userName, _projectName, _branch, _filePath";
      throw new Error(errorMessage);
    } /* Statements */
    return _Url_1(
      _format_2("https://raw.githubusercontent.com/%/%/refs/heads/%/%", [
        _userName,
        _projectName,
        _branch,
        _filePath,
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_userName, _projectName, _branch, _filePath) {
    ...
    return _Url_1(
      _format_2("https://gitlab.com/%/%/-/raw/%/%", [
        _userName,
        _projectName,
        _branch,
        _filePath,
