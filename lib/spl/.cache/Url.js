...
sl.addMethod(
  ...
  function (_self, _mimeType) {
    ...
    return _fetchThen_2(_self, function (_response) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _response"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self, _defaultText) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _defaultText"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _onSuccess_1) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _onSuccess_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _fetchThenElse_3(_self, _onSuccess_1, function (_errorCode) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _errorCode"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _error_2(
...
sl.addMethod(
  ...
  function (_self, _onSuccess_1, _onError) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _onSuccess_1, _onError"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
