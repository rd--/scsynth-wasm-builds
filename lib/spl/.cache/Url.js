...
sl.addMethod(
  ...
  function (_self, _options) {
    ...
    /* Statements */
    return _fetchBlob_3(_self, _options, function (_errorCode) {
      /* ArityCheck */
      if (arguments.length !== 1) {
      ...
      /* Statements */
      return _error_2(_self, _plusSignPlusSign_2("fetchBlob: ", _errorCode));
    });
  },
...
sl.addMethod(
  ...
  function (_self, _options, _onError) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _options, _onError";
      console.error(errorMessage);
      throw new Error(errorMessage);
    }
    /* Statements */
    return _then_2(_fetch_2(_self, _options), function (_response) {
      /* ArityCheck */
      if (arguments.length !== 1) {
...
sl.addMethod(
  ...
  function (_self, _mimeType) {
    ...
    return _fetchThen_2(_self, function (_response) {
      ...
      /* Statements */
      return _mimeType_2(_response, _mimeType);
    });
  },
...
sl.addMethod(
  ...
  function (_self, _onSuccess_1) {
    ...
    return _fetchThenElse_3(_self, _onSuccess_1, function (_errorCode) {
      ...
      return _error_2(
        _self,
        _plusSignPlusSign_2("Url>>fetchThenElse: ", _errorCode),
      );
    });
  },
