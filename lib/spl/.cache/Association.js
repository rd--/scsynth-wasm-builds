...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _and_2(_isAssociation_1(_anObject), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _and_2(_equals_2(_key_1(_self), _key_1(_anObject)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _equals_2(_value_1(_self), _value_1(_anObject));
      });
    });
  },
...
sl.addMethod(
  ...
  function (_self, _anAssociation) {
    ...
    /* Statements */
    return _lessThan_2(_key_1(_self), _key_1(_anAssociation));
  },
...
sl.addMethod(
  ...
  function (_self, _anAssociation) {
    ...
    /* Statements */
    return _lessThanEquals_2(_key_1(_self), _key_1(_anAssociation));
  },
  "{ :self :anAssociation |\n\t\tself.key <= anAssociation.key\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anAssociation) {
    ...
    /* Statements */
    return _greaterThan_2(_key_1(_self), _key_1(_anAssociation));
  },
  "{ :self :anAssociation |\n\t\tself.key > anAssociation.key\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anAssociation) {
    ...
    /* Statements */
    return _greaterThanEquals_2(_key_1(_self), _key_1(_anAssociation));
  },
  "{ :self :anAssociation |\n\t\tself.key >= anAssociation.key\n\t}",
);
