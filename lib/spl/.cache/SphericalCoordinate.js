...
sl.addTraitMethod(
  ...
  function (_self, _anObject, _aBlock_2) {
    ...
    /* Statements */
    return _ampersand_2(_isSphericalCoordinate_1(_anObject), function () {
      /* ArityCheck */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym19 = _assertIsOfSize_2(_self, 3),
      _r = _at_2(__genSym19, 1),
      _theta = _at_2(__genSym19, 2),
      _phi = _at_2(__genSym19, 3);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _if_3(_isVector_1(_self), function () {
      ...
      /* Statements */
      return _asList_1(
        _asCartesianCoordinate_1(_asSphericalCoordinate_1(_self)),
      );
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _if_3(_isVector_1(_self), function () {
      ...
      /* Statements */
      return _asList_1(
        _asSphericalCoordinate_1(_asCartesianCoordinate_1(_self)),
      );
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
