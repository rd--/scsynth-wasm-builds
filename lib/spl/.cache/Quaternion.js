  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SplVar2 = _assertIsOfSize_2(_contents_1(_self), 4);
        let _a = _at_2(__SplVar2, 1);
        let _b = _at_2(__SplVar2, 2);
        let _c = _at_2(__SplVar2, 3);
        let _d = _at_2(__SplVar2, 4);
        let __SplVar3 = _assertIsOfSize_2(_contents_1(_anObject), 4);
        let _p = _at_2(__SplVar3, 1);
        let _q = _at_2(__SplVar3, 2);
        let _r = _at_2(__SplVar3, 3);
        let _s = _at_2(__SplVar3, 4);
        /* Statements */
        return _Quaternion_1([
          _hyphenMinus_2(
            _hyphenMinus_2(
