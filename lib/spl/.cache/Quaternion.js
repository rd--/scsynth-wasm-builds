...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL1 = _assertIsOfSize_2(_contents_1(_self), 4);
        let _a = _at_2(__SPL1, 1);
        let _b = _at_2(__SPL1, 2);
        let _c = _at_2(__SPL1, 3);
        let _d = _at_2(__SPL1, 4);
        let __SPL2 = _assertIsOfSize_2(_contents_1(_anObject), 4);
  ...
  "{ :self :anObject | if(isQuaternion(anObject), { let __SPL1 = assertIsOfSize(contents(self), 4); let a = at(__SPL1, 1); let b = at(__SPL1, 2); let c = at(__SPL1, 3); let d = at(__SPL1, 4); let __SPL2 = assertIsOfSize(contents(anObject), 4); let p = at(__SPL2, 1); let q = at(__SPL2, 2); let r = at(__SPL2, 3); let s = at(__SPL2, 4); Quaternion([(-(-(-((*(a, p)), (*(b, q))), (*(c, r))), (*(d, s)))), (-(+(+((*(a, q)), (*(b, p))), (*(c, s))), (*(d, r)))), (+(+(-((*(a, r)), (*(b, s))), (*(c, p))), (*(d, q)))), (+(-(+((*(a, s)), (*(b, r))), (*(c, q))), (*(d, p))))]) }, { adaptToQuaternionAndApply(anObject,self, *) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL3 = _assertIsOfSize_2(_contents_1(_self), 4);
    let _a = _at_2(__SPL3, 1);
    let _b = _at_2(__SPL3, 2);
    let _c = _at_2(__SPL3, 3);
    let _d = _at_2(__SPL3, 4);
    /* Statements */
  ...
  "{ :self | let __SPL3 = assertIsOfSize(contents(self), 4); let a = at(__SPL3, 1); let b = at(__SPL3, 2); let c = at(__SPL3, 3); let d = at(__SPL3, 4); [[j(a,b), j(c,d)], [j(-(c),d), j(a,-(b))]] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL4 = _assertIsOfSize_2(_contents_1(_self), 4);
  ...
  "{ :self | let __SPL4 = assertIsOfSize(contents(self), 4); let a = at(__SPL4, 1); let b = at(__SPL4, 2); let c = at(__SPL4, 3); let d = at(__SPL4, 4); Quaternion([a, -(b), -(c), -(d)]) }",
);
