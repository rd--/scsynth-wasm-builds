...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL34 = _assertIsOfSize_2(_contents_1(_self), 4);
        let _a = _at_2(__SPL34, 1);
        let _b = _at_2(__SPL34, 2);
        let _c = _at_2(__SPL34, 3);
        let _d = _at_2(__SPL34, 4);
        let __SPL35 = _assertIsOfSize_2(_contents_1(_anObject), 4);
        let _p = _at_2(__SPL35, 1);
        let _q = _at_2(__SPL35, 2);
        let _r = _at_2(__SPL35, 3);
        let _s = _at_2(__SPL35, 4);
        /* Statements */
  ...
  "{ :self :anObject | if(isQuaternion(anObject), { let __SPL34 = assertIsOfSize(contents(self), 4); let a = at(__SPL34, 1); let b = at(__SPL34, 2); let c = at(__SPL34, 3); let d = at(__SPL34, 4); let __SPL35 = assertIsOfSize(contents(anObject), 4); let p = at(__SPL35, 1); let q = at(__SPL35, 2); let r = at(__SPL35, 3); let s = at(__SPL35, 4); Quaternion([(-(-(-((*(a, p)), (*(b, q))), (*(c, r))), (*(d, s)))), (-(+(+((*(a, q)), (*(b, p))), (*(c, s))), (*(d, r)))), (+(+(-((*(a, r)), (*(b, s))), (*(c, p))), (*(d, q)))), (+(-(+((*(a, s)), (*(b, r))), (*(c, q))), (*(d, p))))]) }, { adaptToQuaternionAndApply(anObject,self, *) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL36 = _assertIsOfSize_2(_contents_1(_self), 4);
    let _a = _at_2(__SPL36, 1);
    let _b = _at_2(__SPL36, 2);
    let _c = _at_2(__SPL36, 3);
    let _d = _at_2(__SPL36, 4);
    /* Statements */
  ...
  "{ :self | let __SPL36 = assertIsOfSize(contents(self), 4); let a = at(__SPL36, 1); let b = at(__SPL36, 2); let c = at(__SPL36, 3); let d = at(__SPL36, 4); [[j(a,b), j(c,d)], [j(-(c),d), j(a,-(b))]] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL37 = _assertIsOfSize_2(_contents_1(_self), 4);
    let _a = _at_2(__SPL37, 1);
    let _b = _at_2(__SPL37, 2);
    let _c = _at_2(__SPL37, 3);
    let _d = _at_2(__SPL37, 4);
    /* Statements */
    return _Quaternion_1([
      _a,
      _hyphenMinus_1(_b),
  ...
  "{ :self | let __SPL37 = assertIsOfSize(contents(self), 4); let a = at(__SPL37, 1); let b = at(__SPL37, 2); let c = at(__SPL37, 3); let d = at(__SPL37, 4); Quaternion([a, -(b), -(c), -(d)]) }",
);
