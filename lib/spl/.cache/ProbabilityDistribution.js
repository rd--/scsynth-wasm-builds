...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    /* Temporaries */
    let __genSym112 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym112, 1),
      _gamma = _at_2(__genSym112, 2);
    /* Statements */
    return _plusSign_2(
      _asterisk_2(
        _solidus_2(1, _pi),
...
sl.addMethod(
  ...
  function (_self, _shape) {
    ...
    /* Temporaries */
    let __genSym115 = _assertIsOfSize_2([_mu_1(_self), _sigma_1(_self)], 2),
      _mu = _at_2(__genSym115, 1),
      _sigma = _at_2(__genSym115, 2);
    /* Statements */
    return _exclamationMark_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    /* Temporaries */
    let __genSym116 = _assertIsOfSize_2([_min_1(_self), _max_1(_self)], 2),
      _min = _at_2(__genSym116, 1),
      _max = _at_2(__genSym116, 2);
    /* Statements */
