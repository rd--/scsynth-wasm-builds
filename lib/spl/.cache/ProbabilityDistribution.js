...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    /* Temporaries */
    let __genSym109 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym109, 1),
      _gamma = _at_2(__genSym109, 2);
    /* Statements */
    return _plusSign_2(
      _asterisk_2(
        _solidus_2(1, _pi),
...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    /* Temporaries */
    let __genSym110 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym110, 1),
      _gamma = _at_2(__genSym110, 2);
    /* Statements */
    return _solidus_2(
      1,
      _asterisk_2(
...
sl.addMethod(
  ...
  function (_self, _shape) {
    ...
    /* Temporaries */
    let __genSym111 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym111, 1),
      _gamma = _at_2(__genSym111, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _shape) {
    ...
    /* Temporaries */
    let __genSym112 = _assertIsOfSize_2([_mu_1(_self), _sigma_1(_self)], 2),
      _mu = _at_2(__genSym112, 1),
      _sigma = _at_2(__genSym112, 2);
    /* Statements */
    return _exclamationMark_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    /* Temporaries */
    let __genSym113 = _assertIsOfSize_2([_min_1(_self), _max_1(_self)], 2),
      _min = _at_2(__genSym113, 1),
      _max = _at_2(__genSym113, 2);
    /* Statements */
