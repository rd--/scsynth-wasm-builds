...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    let __genSym170 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym170, 1),
      _gamma = _at_2(__genSym170, 2);
    /* Statements */
    return _plusSign_2(
      _asterisk_2(
        _solidus_2(1, _pi),
...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    let __genSym171 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym171, 1),
      _gamma = _at_2(__genSym171, 2);
    /* Statements */
    return _solidus_2(
      1,
      _asterisk_2(
...
sl.addMethod(
  ...
  function (_self, _rng, _shape) {
    ...
    let __genSym172 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym172, 1),
      _gamma = _at_2(__genSym172, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _rng, _shape) {
    ...
    let __genSym173 = _assertIsOfSize_2([_mu_1(_self), _sigma_1(_self)], 2),
      _mu = _at_2(__genSym173, 1),
      _sigma = _at_2(__genSym173, 2);
    /* Statements */
    return _exclamationMark_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    let __genSym174 = _assertIsOfSize_2([_min_1(_self), _max_1(_self)], 2),
      _min = _at_2(__genSym174, 1),
      _max = _at_2(__genSym174, 2);
    /* Statements */
