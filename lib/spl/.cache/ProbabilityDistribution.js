...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    let __genSym213 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym213, 1),
      _gamma = _at_2(__genSym213, 2);
    /* Statements */
    return _plusSign_2(
      _asterisk_2(
...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    let __genSym214 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym214, 1),
      _gamma = _at_2(__genSym214, 2);
    /* Statements */
    return _solidus_2(
      1,
      _asterisk_2(
...
sl.addMethod(
  ...
  function (_self, _rng, _shape) {
    ...
    let __genSym215 = _assertIsOfSize_2([_x0_1(_self), _gamma_1(_self)], 2),
      _x0 = _at_2(__genSym215, 1),
      _gamma = _at_2(__genSym215, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _rng, _shape) {
    ...
    let __genSym216 = _assertIsOfSize_2([_mu_1(_self), _sigma_1(_self)], 2),
      _mu = _at_2(__genSym216, 1),
      _sigma = _at_2(__genSym216, 2);
    /* Statements */
    return _exclamationMark_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    let __genSym217 = _assertIsOfSize_2([_min_1(_self), _max_1(_self)], 2),
      _min = _at_2(__genSym217, 1),
      _max = _at_2(__genSym217, 2);
    /* Statements */
