...
sl.extendTraitWithMethod(
  ...
  function (_mu, _sigma, _x) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _mu, _sigma, _x"; /* console.error(errorMessage); */
...
sl.extendTraitWithMethod(
  ...
  function (_lambda, _x) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _lambda, _x"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _exp_1(
...
sl.extendTraitWithMethod(
  ...
  function (_self, _x1, _x2, _p1, _p2) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _x1, _x2, _p1, _p2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _mean, _spread) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _mean, _spread"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _r = 0.5;
...
sl.extendTraitWithMethod(
  ...
  function (_self, _mu, _sigma) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _mu, _sigma"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _plusSign_2(
...
sl.extendTraitWithMethod(
  ...
  function (_self, _x1, _x2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _x1, _x2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _location, _spread, _shape) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _location, _spread, _shape"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _r = 1;
...
sl.addMethod(
  ...
  function (_self, _x) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _x"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_x0, _gamma) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _x0, _gamma"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_mu, _sigma) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _mu, _sigma"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
