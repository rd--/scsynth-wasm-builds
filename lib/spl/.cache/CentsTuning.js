...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let _step = _dividedBy_2(1200, _self);
    /* Statements */
    return _CentsTuning_4(
      _plusPlus_2("ET-", _self),
      _plusPlus_2(_capitalized_1(_asWords_1(_self)), " tone equal-temperament"),
      _asArray_1(_thenTo_3(0, _step, _minus_2(1200, _step))),
      2,
    );
  },
