...
sl.addMethod(
  ...
  function (_self_1, _anObject) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_1, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _firstArg) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _firstArg"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(
...
sl.addMethod(
  ...
  function (_self, _firstArg, _secondArg) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _firstArg, _secondArg"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(
...
sl.addMethod(
  ...
  function (_self_0, _conditionBlock_0) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_0, _conditionBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _answer = null;
...
sl.addMethod(
  ...
  function (_self_2, _y0, _x0, _x1, _h) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self_2, _y0, _x0, _x1, _h"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _x = _x0;
...
sl.addMethod(
  ...
  function (_self, _errorHandlerBlock) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _errorHandlerBlock"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
    try {
...
sl.addMethod(
  ...
  function (_f_2, _p, _q, _g_2) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _f_2, _p, _q, _g_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _h_2 = _e_1(_f_2);
...
sl.addMethod(
  ...
  function (_self_1, _anObject, _anInteger) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_1, _anObject, _anInteger"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _aCollection) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_1, _aCollection"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_2, _aSequence, _anotherSequence) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_2, _aSequence, _anotherSequence"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_3, _aSequence, _anotherSequence, _aThirdSequence) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self_3, _aSequence, _anotherSequence, _aThirdSequence"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_0) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _self_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _sequence, _windowSize) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_1, _sequence, _windowSize"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _answer = [];
...
sl.addMethod(
  ...
  function (_self, _ifAbsent_0) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _ifAbsent_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _aSequence, _anotherSequence) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aSequence, _anotherSequence"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_2) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _self_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return (function (_aSequence, _anotherSequence) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _aSequence, _anotherSequence"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _aSequence) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_1, _aSequence"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_3, _aSequence, _aSecondSequence, _aThirdSequence) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self_3, _aSequence, _aSecondSequence, _aThirdSequence"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _collect_2(_aSequence, function (_i) {
...
sl.addMethod(
  ...
  function (_self_1, _p1) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_1, _p1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _self_1(_p1);
...
sl.addMethod(
  ...
  function (_self_2, _p1, _p2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_2, _p1, _p2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_3, _p1, _p2, _p3) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self_3, _p1, _p2, _p3"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_4, _p1, _p2, _p3, _p4) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self_4, _p1, _p2, _p3, _p4"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_5, _p1, _p2, _p3, _p4, _p5) {
    ...
    if (arguments.length !== 6) {
      const errorMessage =
        "Arity: expected 6, _self_5, _p1, _p2, _p3, _p4, _p5"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _argumentsList) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _argumentsList"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self_0, _aBlock_0) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_0, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
    while (!_self_0()) {
