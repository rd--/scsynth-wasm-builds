...
sl.addMethodToExistingType(
  ...
  "duplicate",
  ["self:/0", "shape"],
  sl.annotateFunction(function (_self_0, _shape) {
    /* ArityCheck */
    if (arguments.length !== 2) {
...
sl.addMethodToExistingType(
  ...
  "Block",
  "clip",
  ["aBlock:/1", "minMax", "replaceWith"],
  sl.annotateFunction(function (_aBlock_1, _minMax, _replaceWith) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _aBlock_1, _minMax, _replaceWith";
      throw new Error(errorMessage);
    } /* Statements */
    return sl.annotateFunction(function (_x) {
      ...
      return _clip_3(_aBlock_1(_x), _minMax, _replaceWith);
    }, ["x"]);
  }, ["aBlock:/1", "minMax", "replaceWith"]),
...
sl.addMethodToExistingType(
  ...
  "dirichletConvolve",
  ["f:/1", "g:/1"],
  sl.annotateFunction(function (_f_1, _g_1) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _f_1, _g_1";
      throw new Error(errorMessage);
    } /* Statements */
    return sl.annotateFunction(function (_n) {
      ...
      return _divisorSum_2(
        ...
        sl.annotateFunction(function (_d) {
          ...
          return _asterisk_2(_f_1(_d), _g_1(_solidus_2(_n, _d)));
        }, ["d"]),
      );
    }, ["n"]);
  }, ["f:/1", "g:/1"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_f_1) {
    ...
    let _i_1 = _memoize_1(sl.annotateFunction(function (_n) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _n";
        throw new Error(errorMessage);
          ...
          return _asterisk_2(
            ...
            _sum_2(
              ...
              sl.annotateFunction(function (_d) {
                ...
                return _asterisk_2(_f_1(_solidus_2(_n, _d)), _i_1(_d));
              }, ["d"]),
            ),
          );
        }, []),
...
sl.addMethodToExistingType(
  ...
  "foldList",
  ["f:/2", "y", "x"],
  sl.annotateFunction(function (_f_2, _y, _x) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _f_2, _y, _x";
      throw new Error(errorMessage);
    } /* Statements */
    return _foldList_3(_x, _y, _f_2);
  }, ["f:/2", "y", "x"]),
  "{ :f:/2 :y :x |\n\t\tx.foldList(y, f:/2)\n\t}",
);
...
sl.addMethodToExistingType(
  ...
  "foldList",
  ["f:/2", "x"],
  sl.annotateFunction(function (_f_2, _x) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _f_2, _x";
      throw new Error(errorMessage);
    } /* Statements */
    return _foldList_3(_allButFirst_1(_x), _at_2(_x, 1), _f_2);
  }, ["f:/2", "x"]),
...
sl.addMethodToExistingType(
  ...
  "foldPairList",
  ["f:/2", "y", "xList", "g:/1"],
  sl.annotateFunction(function (_f_2, _y, _xList, _g_1) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage = "Arity: expected 4, _f_2, _y, _xList, _g_1";
      throw new Error(errorMessage);
    } /* Statements */
    let _a = [];
    _do_2(
...
sl.addMethodToExistingType(
  ...
  "foldPairList",
  ["f:/2", "y", "xList"],
  sl.annotateFunction(function (_f_2, _y, _xList) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _f_2, _y, _xList";
      throw new Error(errorMessage);
    } /* Statements */
    return _foldPairList_4(_f_2, _y, _xList, _first_1);
  }, ["f:/2", "y", "xList"]),
...
sl.addMethodToExistingType(
  ...
  "foldPairList",
  ["f:/2", "xList"],
  sl.annotateFunction(function (_f_2, _xList) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _f_2, _xList";
      throw new Error(errorMessage);
    } /* Statements */
    return _foldPairList_3(_f_2, _at_2(_xList, 1), _allButFirst_1(_xList));
  }, ["f:/2", "xList"]),
...
sl.addMethodToExistingType(
  ...
  "keyMap",
  ["self:/1", "operand"],
  sl.annotateFunction(function (_self_1, _operand) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self_1, _operand";
      throw new Error(errorMessage);
    } /* Statements */
    let _answer = _new_1(_species_1(_operand));
    _keysAndValuesDo_2(
      _operand,
      sl.annotateFunction(function (_key, _value) {
        ...
        return _include_2(
          _answer,
          _hyphenMinusGreaterThanSign_2(_self_1(_key), _value),
        );
      }, ["key", "value"]),
    );
    return _answer;
...
sl.addMethodToExistingType(
  ...
  "mapIndexed",
  ["self:/2", "operand"],
  sl.annotateFunction(function (_self_2, _operand) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self_2, _operand";
      throw new Error(errorMessage);
    } /* Statements */
    return _withIndexCollect_2(_operand, _self_2);
  }, ["self:/2", "operand"]),
...
sl.addMethodToExistingType(
  ...
  "Block",
  "memoizeBinary",
  ["self:/2", "requireImmediate"],
  sl.annotateFunction(function (_self_2, _requireImmediate) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self_2, _requireImmediate";
      throw new Error(errorMessage);
    } /* Statements */
    let _f_1 = _memoizeUnary_2(
      sl.annotateFunction(function (_x) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _x";
    ...
    return _caseOf_2(_numArgs_1(_self), [
      ...
      _hyphenMinusGreaterThanSign_2(
        ...
        sl.annotateFunction(function () {
          ...
          return _memoizeBinary_2(_self, _requireImmediate);
        }, []),
      ),
    ]);
  }, ["self", "requireImmediate"]),
...
sl.addMethodToExistingType(
  ...
  "pointwise",
  ["f:/2", "p:/1", "q:/1"],
  sl.annotateFunction(function (_f_2, _p_1, _q_1) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _f_2, _p_1, _q_1";
      throw new Error(errorMessage);
    } /* Statements */
    return sl.annotateFunction(function (_x) {
      /* ArityCheck */
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self_1) {
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      let _break_0 = sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
        } /* Statements */
        return _return_1(null);
      }, []);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return sl.annotateFunction(function (_operand) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _operand";
        throw new Error(errorMessage);
      } /* Statements */
      return _collect_2(
        _self,
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _reduce_2(_self, _composeLeft_2);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _reduce_2(_self, _composeRight_2);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "predicateAnd",
  ["self:/1", "operand:/1"],
  sl.annotateFunction(function (_self_1, _operand_1) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self_1, _operand_1";
      throw new Error(errorMessage);
    } /* Statements */
    return sl.annotateFunction(function (_anObject) {
      /* ArityCheck */
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self_1) {
    ...
    return sl.annotateFunction(function (_anObject) {
      ...
      return _not_1(_self_1(_anObject));
    }, ["anObject"]);
  }, ["self:/1"]),
  "{ :self:/1 |\n\t\t{ :anObject |\n\t\t\tself(anObject).not\n\t\t}\n\t}",
);
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _caseOf_2(_name_1(_self), [
          _hyphenMinusGreaterThanSign_2(
            "cos:/1",
            sl.annotateFunction(function () {
              /* ArityCheck */
              ...
              return _cosDerivative_1(_anInteger);
            }, []),
          ),
          _hyphenMinusGreaterThanSign_2(
            "exp:/1",
          ...
          _hyphenMinusGreaterThanSign_2(
            ...
            sl.annotateFunction(function () {
              ...
              return _sinDerivative_1(_anInteger);
            }, []),
          ),
        ]);
      }, []),
