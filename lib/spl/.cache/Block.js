...
sl.addMethod(
  ...
  function (_self_2) {
    ...
    /* Statements */
    return _if_3(_equals_2(_numArgs_1(_self_2), 2), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return (function (_rhs, _lhs) {
        /* ArityCheck */
        if (arguments.length !== 2) {
          const errorMessage = "Arity: expected 2, _rhs, _lhs";
          console.error(errorMessage);
          throw Error(errorMessage);
        }
        /* Statements */
        return _self_2(_lhs, _rhs);
      });
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
      ...
      /* Statements */
      return _error_1("Block>>flip: not two argument block");
    });
  },
