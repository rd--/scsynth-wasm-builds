...
sl.addMethodToExistingType(
  ...
  "{ :self :randomNumberGenerator | let column = nextRandomInteger(randomNumberGenerator,1, size(probability(self))); let coinToss = <(nextRandomFloat(randomNumberGenerator), at(probability(self), column)); if(coinToss, { column }, { at(alias(self), column) }) }",
);
