...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _o) {
    ...
    let __SPL382 = _assertIsOfSize_2(_quartiles_2(_self, _o), 3);
    let _q1 = _at_2(__SPL382, 1);
    let _q2 = _at_2(__SPL382, 2);
    let _q3 = _at_2(__SPL382, 3);
    /* Statements */
    return _hyphenMinus_2(_q3, _q1);
  }, ["self", "o"]),
  "{ :self :o | let __SPL382 = assertIsOfSize(quartiles(self,o), 3); let q1 = at(__SPL382, 1); let q2 = at(__SPL382, 2); let q3 = at(__SPL382, 3); -(q3, q1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL383 = _assertIsOfSize_2(_quartiles_1(_self), 3);
    let _q1 = _at_2(__SPL383, 1);
    let _q2 = _at_2(__SPL383, 2);
    let _q3 = _at_2(__SPL383, 3);
    /* Statements */
    return _hyphenMinus_2(_q3, _q1);
  }, ["self"]),
  "{ :self | let __SPL383 = assertIsOfSize(quartiles(self), 3); let q1 = at(__SPL383, 1); let q2 = at(__SPL383, 2); let q3 = at(__SPL383, 3); -(q3, q1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _p, _o) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _quantile_3(_asSortedList_1(_self), _p, _o);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          ...
          sl.annotateFunction(function () {
            ...
            return _collect_2(
              ...
              sl.annotateFunction(function (_each) {
                ...
                return _quantile_3(_asSortedList_1(_each), _p, _o);
              }, ["each"]),
            );
          }, []),
          sl.annotateFunction(function () {
  ...
  "{ :self :p :o | if(isVector(self), { quantile(asSortedList(self),p, o) }, { if(isMatrix(self), { collect(transposed(self), { :each | quantile(asSortedList(each),p, o) }) }, { 'Collection>>quantile: not vector or matrix' }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _f) {
    ...
    let __SPL384 = _assertIsOfSize_2(_f, 2);
    let _f1 = _at_2(__SPL384, 1);
    let _f2 = _at_2(__SPL384, 2);
    let _n = _size_1(_self);
    /* Statements */
    return _mean_1(
      _sliceFromTo_3(
  ...
  "{ :self :f | let __SPL384 = assertIsOfSize(f, 2); let f1 = at(__SPL384, 1); let f2 = at(__SPL384, 2); let n = size(self); mean(sliceFromTo(sorted(self),+(1, floor((*(f1, n)))), -(n, floor((*(f2, n)))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _f) {
    ...
    let __SPL385 = _assertIsOfSize_2(_f, 2);
    let _f1 = _at_2(__SPL385, 1);
    let _f2 = _at_2(__SPL385, 2);
    let _n = _size_1(_self);
  ...
  "{ :self :f | let __SPL385 = assertIsOfSize(f, 2); let f1 = at(__SPL385, 1); let f2 = at(__SPL385, 2); let n = size(self); let z1 = rankedMin(self,+(1, floor((*(f1, n))))); let z2 = rankedMax(self,+(1, floor((*(f2, n))))); mean(clip(self,[z1, z2])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :v :w | if(isMatrix(v), { crossCovarianceMatrix(v,w) }, { let n = size(v); let m = size(w); if((=(n, m)), { *((/(1, (-(n, 1)))), dot((-(v, mean(v))),conjugated((-(w, mean(w)))))) }, { error([v, w],'@Sequenceable>>covariance: vectors must be equal') }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_x, _r) {
    ...
    let _k = _collect_2(
      _asList_1(_upOrDownTo_2(_negated_1(_r), _r)),
  ...
  "{ :x :r | let sigma = /(r, 2); let k = collect(asList(upOrDownTo(negated(r), r)),gaussianKernel(sigma)); let y = convolve(k,x); removeFirst(y,r); removeLast(y,r); y }",
);
