...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _Fraction_2(_sum_1(_self), _size_1(_self));
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_1) {
    ...
    return _mean_1(_abs_1(_hyphenMinus_2(_self, _aBlock_1(_self))));
  }, ["self", "aBlock:/1"]),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _median_1(_abs_1(_hyphenMinus_2(_self, _median_1(_self))));
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _collect_2(_transpose_1(_self), _medianDeviation_1);
          }, []),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
            ...
            return _error_2(_self, "medianDeviation");
          }, []),
        );
      }, []),
    );
  ...
  sl.annotateFunction(function (_self, _p, _o) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _quantile_3(_asSortedList_2(_self, _lessEqual_2), _p, _o);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          ...
          sl.annotateFunction(function () {
            ...
            return _collect_2(
              ...
              sl.annotateFunction(function (_each) {
                ...
                return _quantile_3(
                  _asSortedList_2(_each, _lessEqual_2),
                  _p,
                  _o,
                );
              }, ["each"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _median_1(_asSortedList_2(_self, _lessEqual_2));
  }, ["self"]),
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _solidus_2(
          ...
          _hyphenMinus_2(_log_1(_x), _log_1(_y)),
        );
      }, []),
    );
  }, ["x", "y"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "stolarskyMean",
  ["p", "x", "y"],
  sl.annotateFunction(function (_p, _x, _y) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _p, _x, _y";
      throw new Error(errorMessage);
    } /* Statements */
    return _if_3(
      _equalsSign_2(_x, _y),
      ...
      sl.annotateFunction(function () {
        ...
        let _a = _hyphenMinus_2(
          _circumflexAccent_2(_x, _p),
          _circumflexAccent_2(_y, _p),
        );
        let _b = _asterisk_2(_p, _hyphenMinus_2(_x, _y));
        let _c = _solidus_2(1, _hyphenMinus_2(_p, 1));
        return _circumflexAccent_2(_solidus_2(_a, _b), _c);
      }, []),
    );
  }, ["p", "x", "y"]),
  "{ :p :x :y |\n\t\t(x = y).if {\n\t\t\tx\n\t\t} {\n\t\t\tlet a = (x ^ p) - (y ^ p);\n\t\t\tlet b = p * (x - y);\n\t\t\tlet c = 1 / (p - 1);\n\t\t\t(a / b) ^ c\n\t\t}\n\t}",
