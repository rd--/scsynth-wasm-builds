...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _o) {
    ...
    let __SPL1 = _assertIsOfSize_2(_quartiles_2(_self, _o), 3);
  ...
  "{ :self :o | let __SPL1 = assertIsOfSize(quartiles(self,o), 3); let q1 = at(__SPL1, 1); let q2 = at(__SPL1, 2); let q3 = at(__SPL1, 3); -(q3, q1) }",
);
