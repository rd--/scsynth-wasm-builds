...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _o) {
    ...
    let __SPL470 = _assertIsOfSize_2(_quartiles_2(_self, _o), 3);
  ...
  "{ :self :o | let __SPL470 = assertIsOfSize(quartiles(self,o), 3); let q1 = at(__SPL470, 1); let q2 = at(__SPL470, 2); let q3 = at(__SPL470, 3); -(q3, q1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL471 = _assertIsOfSize_2(_quartiles_1(_self), 3);
    let _q1 = _at_2(__SPL471, 1);
    let _q2 = _at_2(__SPL471, 2);
    let _q3 = _at_2(__SPL471, 3);
    /* Statements */
    return _hyphenMinus_2(_q3, _q1);
  }, ["self"]),
  "{ :self | let __SPL471 = assertIsOfSize(quartiles(self), 3); let q1 = at(__SPL471, 1); let q2 = at(__SPL471, 2); let q3 = at(__SPL471, 3); -(q3, q1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :f | let __SPL472 = assertIsOfSize(f, 2); let f1 = at(__SPL472, 1); let f2 = at(__SPL472, 2); let n = size(self); mean(sliceFromTo(sorted(self),+(1, floor((*(f1, n)))), -(n, floor((*(f2, n)))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _f) {
    ...
    let __SPL473 = _assertIsOfSize_2(_f, 2);
    let _f1 = _at_2(__SPL473, 1);
    let _f2 = _at_2(__SPL473, 2);
    let _n = _size_1(_self);
  ...
  "{ :self :f | let __SPL473 = assertIsOfSize(f, 2); let f1 = at(__SPL473, 1); let f2 = at(__SPL473, 2); let n = size(self); let z1 = rankedMin(self,+(1, floor((*(f1, n))))); let z2 = rankedMax(self,+(1, floor((*(f2, n))))); mean(clip(self,[z1, z2])) }",
);
