...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isMatrix(self), { collect(self,PlanarCoordinates:/1) }, { let __SplVar1 = assertIsOfSize(self, 2); let x = at(__SplVar1, 1); let y = at(__SplVar1, 2); initializeSlots(newPlanarCoordinates(),[x, y]) }) }",
);
