...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isMatrix(self), { collect(self,PlanarCoordinates:/1) }, { let __SPL4 = assertIsOfSize(self, 2); let x = at(__SPL4, 1); let y = at(__SPL4, 2); initializeSlots(newPlanarCoordinates(),[x, y]) }) }",
);
