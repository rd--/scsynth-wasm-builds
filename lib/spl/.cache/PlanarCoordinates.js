...
sl.addMethod(
  ...
  function (_self, _inversionCenter, _inversionRadius) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _inversionCenter, _inversionRadius"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _x = _x_1(_self);
...
sl.addMethod(
  ...
  function (_self, _delta) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _delta"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aPlanarCoordinates, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aPlanarCoordinates, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_x, _y) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _x, _y"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_n, _r, _theta) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _n, _r, _theta"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
