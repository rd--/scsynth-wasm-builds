...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isMatrix(self), { collect(self,PlanarCoordinates:/1) }, { let __SPL15 = assertIsOfSize(self, 2); let x = at(__SPL15, 1); let y = at(__SPL15, 2); initializeSlots(newPlanarCoordinates(),[x, y]) }) }",
);
