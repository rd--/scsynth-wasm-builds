...
sl.extendTypeOrTraitWithMethod(
      ...
      [
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL473 = _assertIsOfSize_2(_self, 3);
            let _c = _at_2(__SPL473, 1);
            let _b = _at_2(__SPL473, 2);
            let _a = _at_2(__SPL473, 3);
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL474 = _assertIsOfSize_2(_self, 4);
            let _d = _at_2(__SPL474, 1);
            let _c = _at_2(__SPL474, 2);
            let _b = _at_2(__SPL474, 3);
            let _a = _at_2(__SPL474, 4);
            /* Statements */
            return _plusSign_2(
              _hyphenMinus_2(
                _hyphenMinus_2(
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL475 = _assertIsOfSize_2(_self, 5);
            let _e = _at_2(__SPL475, 1);
            let _d = _at_2(__SPL475, 2);
            let _c = _at_2(__SPL475, 3);
            let _b = _at_2(__SPL475, 4);
            let _a = _at_2(__SPL475, 5);
            /* Statements */
            return _sum_1([
  ...
  "{ :self | caseOf((-(size(self), 1)), [->(1, { 1 }), ->(2, { let __SPL473 = assertIsOfSize(self, 3); let c = at(__SPL473, 1); let b = at(__SPL473, 2); let a = at(__SPL473, 3); -(square(b), (*(*(4, a), c))) }), ->(3, { let __SPL474 = assertIsOfSize(self, 4); let d = at(__SPL474, 1); let c = at(__SPL474, 2); let b = at(__SPL474, 3); let a = at(__SPL474, 4); +(-(-(-((*(square(b), square(c))), (*(*(4, a), cube(c)))), (*(*(4, cube(b)), d))), (*(*(27, square(a)), square(d)))), (*(*(*(*(18, a), b), c), d))) }), ->(4, { let __SPL475 = assertIsOfSize(self, 5); let e = at(__SPL475, 1); let d = at(__SPL475, 2); let c = at(__SPL475, 3); let b = at(__SPL475, 4); let a = at(__SPL475, 5); sum([*(*(256, cube(a)), cube(e)), *(*(*(*(-192, square(a)), b), d), square(e)), *(*(*(-128, square(a)), square(c)), square(e)), *(*(*(*(144, square(a)), c), square(d)), e), *(*(-27, square(a)), (^(d, 4))), *(*(*(*(144, a), square(b)), c), square(e)), *(*(*(*(-6, a), square(b)), square(d)), e), *(*(*(*(*(-80, a), b), square(c)), d), e), *(*(*(*(18, a), b), c), cube(d)), *(*(*(16, a), (^(c, 4))), e), *(*(*(-4, a), cube(c)), square(d)), *(*(-27, (^(b, 4))), square(e)), *(*(*(*(18, cube(b)), c), d), e), *(*(-4, cube(b)), cube(d)), *(*(*(-4, square(b)), cube(c)), e), *(*(*(1, square(b)), square(c)), square(d))]) })], { error(self,'discriminant: degree≠{1,2,3,4}') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c) {
    ...
    let _n = _size_1(_c);
    let __SPL476 = _assertIsOfSize_2(_transpose_1(_c), 2);
    let _x = _at_2(__SPL476, 1);
    let _y = _at_2(__SPL476, 2);
  ...
  "{ :c | let n = size(c); let __SPL476 = assertIsOfSize(transpose(c), 2); let x = at(__SPL476, 1); let y = at(__SPL476, 2); let p = List(n, UnivariatePolynomial([1])); toDo(1, n, { :i | toDo(1, n, { :j | ifFalse((=(i, j)), { let q = UnivariatePolynomial([-(0, at(x, j)), 1]); atPut(p, i, *(at(p, i), q)) }) }); atPut(p, i, *(at(p, i), (/(1, at(at(p, i),at(x, i)))))) }); sum((*(p, y))) }",
);
