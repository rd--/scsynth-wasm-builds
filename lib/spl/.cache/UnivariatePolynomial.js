...
sl.extendTypeOrTraitWithMethod(
      ...
      [
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL2 = _assertIsOfSize_2(_self, 4);
            let _d = _at_2(__SPL2, 1);
            let _c = _at_2(__SPL2, 2);
            let _b = _at_2(__SPL2, 3);
            let _a = _at_2(__SPL2, 4);
            /* Statements */
            return _plusSign_2(
              _hyphenMinus_2(
                _hyphenMinus_2(
                  _hyphenMinus_2(
                    _asterisk_2(_squared_1(_b), _squared_1(_c)),
                    _asterisk_2(_asterisk_2(4, _a), _cubed_1(_c)),
                  ),
                  _asterisk_2(_asterisk_2(4, _cubed_1(_b)), _d),
                ),
                _asterisk_2(_asterisk_2(27, _squared_1(_a)), _squared_1(_d)),
              ),
              _asterisk_2(
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL3 = _assertIsOfSize_2(_self, 5);
            let _e = _at_2(__SPL3, 1);
            let _d = _at_2(__SPL3, 2);
            let _c = _at_2(__SPL3, 3);
            let _b = _at_2(__SPL3, 4);
            let _a = _at_2(__SPL3, 5);
            /* Statements */
            return _sum_1([
              _asterisk_2(_asterisk_2(256, _cubed_1(_a)), _cubed_1(_e)),
              _asterisk_2(
                _asterisk_2(
                  _asterisk_2(_asterisk_2(-192, _squared_1(_a)), _b),
                  _d,
                ),
                _squared_1(_e),
              ),
              _asterisk_2(
                _asterisk_2(_asterisk_2(-128, _squared_1(_a)), _squared_1(_c)),
                _squared_1(_e),
              ),
              _asterisk_2(
                _asterisk_2(
                  _asterisk_2(_asterisk_2(144, _squared_1(_a)), _c),
                  _squared_1(_d),
                ),
                _e,
              ),
              _asterisk_2(
                _asterisk_2(-27, _squared_1(_a)),
                _circumflexAccent_2(_d, 4),
              ),
              _asterisk_2(
                _asterisk_2(
                  _asterisk_2(_asterisk_2(144, _a), _squared_1(_b)),
                  _c,
                ),
                _squared_1(_e),
              ),
              _asterisk_2(
                _asterisk_2(
                  _asterisk_2(_asterisk_2(-6, _a), _squared_1(_b)),
                  _squared_1(_d),
                ),
                _e,
              ),
              ...
              _asterisk_2(
                _asterisk_2(_asterisk_2(_asterisk_2(18, _cubed_1(_b)), _c), _d),
                _e,
              ),
              _asterisk_2(_asterisk_2(-4, _cubed_1(_b)), _cubed_1(_d)),
              _asterisk_2(
                _asterisk_2(_asterisk_2(-4, _squared_1(_b)), _cubed_1(_c)),
                _e,
              ),
              _asterisk_2(
                _asterisk_2(_asterisk_2(1, _squared_1(_b)), _squared_1(_c)),
                _squared_1(_d),
              ),
            ]);
          }, []),
  ...
  "{ :self | caseOf((-(size(self), 1)), [->(1, { 1 }), ->(2, { let __SPL1 = assertIsOfSize(self, 3); let c = at(__SPL1, 1); let b = at(__SPL1, 2); let a = at(__SPL1, 3); -(squared(b), (*(*(4, a), c))) }), ->(3, { let __SPL2 = assertIsOfSize(self, 4); let d = at(__SPL2, 1); let c = at(__SPL2, 2); let b = at(__SPL2, 3); let a = at(__SPL2, 4); +(-(-(-((*(squared(b), squared(c))), (*(*(4, a), cubed(c)))), (*(*(4, cubed(b)), d))), (*(*(27, squared(a)), squared(d)))), (*(*(*(*(18, a), b), c), d))) }), ->(4, { let __SPL3 = assertIsOfSize(self, 5); let e = at(__SPL3, 1); let d = at(__SPL3, 2); let c = at(__SPL3, 3); let b = at(__SPL3, 4); let a = at(__SPL3, 5); sum([*(*(256, cubed(a)), cubed(e)), *(*(*(*(-192, squared(a)), b), d), squared(e)), *(*(*(-128, squared(a)), squared(c)), squared(e)), *(*(*(*(144, squared(a)), c), squared(d)), e), *(*(-27, squared(a)), (^(d, 4))), *(*(*(*(144, a), squared(b)), c), squared(e)), *(*(*(*(-6, a), squared(b)), squared(d)), e), *(*(*(*(*(-80, a), b), squared(c)), d), e), *(*(*(*(18, a), b), c), cubed(d)), *(*(*(16, a), (^(c, 4))), e), *(*(*(-4, a), cubed(c)), squared(d)), *(*(-27, (^(b, 4))), squared(e)), *(*(*(*(18, cubed(b)), c), d), e), *(*(-4, cubed(b)), cubed(d)), *(*(*(-4, squared(b)), cubed(c)), e), *(*(*(1, squared(b)), squared(c)), squared(d))]) })], { error(self,'discriminant: degree≠{1,2,3,4}') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c) {
    ...
    let _n = _size_1(_c);
    let __SPL4 = _assertIsOfSize_2(_transposed_1(_c), 2);
  ...
  "{ :c | let n = size(c); let __SPL4 = assertIsOfSize(transposed(c), 2); let x = at(__SPL4, 1); let y = at(__SPL4, 2); let p = List(n, UnivariatePolynomial([1])); toDo(1, n, { :i | toDo(1, n, { :j | ifFalse((=(i, j)), { let q = UnivariatePolynomial([-(0, at(x, j)), 1]); atPut(p, i, *(at(p, i), q)) }) }); atPut(p, i, *(at(p, i), (/(1, at(at(p, i),at(x, i)))))) }); sum((*(p, y))) }",
);
