...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | &(isUnivariatePolynomial(operand), { ~(coefficientList(self), coefficientList(operand)) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | let c1 = coefficientList(self); let c2 = coefficientList(operand); let n = max(size(c1),size(c2)); UnivariatePolynomial(+(padRight(c1,[n], 0), padRight(c2,[n], 0))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | let a = coefficientList(self); if(isUnivariatePolynomial(operand), { let b = coefficientList(operand); let m = size(a); let n = size(b); let c = List(-(+(m, n), 1), 0); toDo(1, m, { :i | toDo(1, n, { :j | atPut(c, -(+(i, j), 1), +(at(c, -(+(i, j), 1)), (*(at(a, i), at(b, j))))) }) }); UnivariatePolynomial(c) }, { UnivariatePolynomial(*(a, operand)) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let c = coefficientList(self); { :x | evaluateUnivariatePolynomial(c,x) } }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | ifFalse(isNormal(self), { error(self,'assertIsNormal: not normal') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | discriminant(coefficientList(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | let a = self; let b = operand; whileFalse({ isZero(b) }, { let r = remainder(a,b); a := b; b := r }); a }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | monicPolynomial(euclideanAlgorithm(self,operand)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | |(isSymbolic(self), { let c = coefficientList(self); |((=(size(c), 0)), { !=(last(c), 0) }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | allSatisfy(coefficientList(self),isSymbol:/1) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | isEmpty(coefficientList(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | last(coefficientList(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :modulus | UnivariatePolynomial(%(coefficientList(self), modulus)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | *(self, reciprocal(leadingCoefficient(self))) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | ifTrue(not(isSymbolic(self)), { let c = coefficientList(self); whileTrue({ &(>(size(c), 0), { =(last(c), 0) }) }, { removeLast(c) }) }); self }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | quotient(self,operand) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | quotientRemainder(self,operand) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | remainder(self,operand) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | coefficientList(self, copy(coefficientList(self))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_numerator, _denominator) {
    ...
    let _q = _at_2(__SPL1, 1);
    let __genSym7 = _at_2(__SPL1, 2);
    /* Statements */
    return _q;
  }, ["numerator", "denominator"]),
  "{ :numerator :denominator | let __SPL1 = assertIsOfSize(quotientRemainder(numerator,denominator), 2); let q = at(__SPL1, 1); let _ = at(__SPL1, 2); q }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_numerator, _denominator) {
    ...
    let _remainder = _deepCopy_1(_numerator);
  ...
  "{ :numerator :denominator | let quotient = UnivariatePolynomial([]); let remainder = deepCopy(numerator); let denominatorDegree = degree(denominator); let denominatorLeadingCoefficient = leadingCoefficient(denominator); whileTrue({ >=(degree(remainder), denominatorDegree) }, { let exponent = -(degree(remainder), denominatorDegree); let coefficient = /(leadingCoefficient(remainder), denominatorLeadingCoefficient); let temporary = UnivariatePolynomial(Map([[exponent, coefficient]])); quotient := +(quotient, temporary); remainder := -(remainder, (*(temporary, denominator))) }); [quotient, remainder] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_numerator, _denominator) {
    ...
    let __genSym8 = _at_2(__SPL2, 1);
    let _r = _at_2(__SPL2, 2);
    /* Statements */
    return _r;
  }, ["numerator", "denominator"]),
  "{ :numerator :denominator | let __SPL2 = assertIsOfSize(quotientRemainder(numerator,denominator), 2); let _ = at(__SPL2, 1); let r = at(__SPL2, 2); r }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :operand | resultant(coefficientList(self),coefficientList(operand)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let answer = Map(); withIndexDo(coefficientList(self), { :c :i | ifTrue((!=(c, 0)), { add(answer,->((-(i, 1)), c)) }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      [
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let _c = _at_2(__SPL3, 1);
            let _b = _at_2(__SPL3, 2);
            let _a = _at_2(__SPL3, 3);
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL4 = _assertIsOfSize_2(_self, 4);
            let _d = _at_2(__SPL4, 1);
            let _c = _at_2(__SPL4, 2);
            let _b = _at_2(__SPL4, 3);
            let _a = _at_2(__SPL4, 4);
            /* Statements */
            return _plusSign_2(
              _hyphenMinus_2(
                _hyphenMinus_2(
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL5 = _assertIsOfSize_2(_self, 5);
            let _e = _at_2(__SPL5, 1);
            let _d = _at_2(__SPL5, 2);
            let _c = _at_2(__SPL5, 3);
            let _b = _at_2(__SPL5, 4);
            let _a = _at_2(__SPL5, 5);
            /* Statements */
            return _sum_1([
  ...
  "{ :self | caseOf((-(size(self), 1)), [->(1, { 1 }), ->(2, { let __SPL3 = assertIsOfSize(self, 3); let c = at(__SPL3, 1); let b = at(__SPL3, 2); let a = at(__SPL3, 3); -(square(b), (*(*(4, a), c))) }), ->(3, { let __SPL4 = assertIsOfSize(self, 4); let d = at(__SPL4, 1); let c = at(__SPL4, 2); let b = at(__SPL4, 3); let a = at(__SPL4, 4); +(-(-(-((*(square(b), square(c))), (*(*(4, a), cube(c)))), (*(*(4, cube(b)), d))), (*(*(27, square(a)), square(d)))), (*(*(*(*(18, a), b), c), d))) }), ->(4, { let __SPL5 = assertIsOfSize(self, 5); let e = at(__SPL5, 1); let d = at(__SPL5, 2); let c = at(__SPL5, 3); let b = at(__SPL5, 4); let a = at(__SPL5, 5); sum([*(*(256, cube(a)), cube(e)), *(*(*(*(-192, square(a)), b), d), square(e)), *(*(*(-128, square(a)), square(c)), square(e)), *(*(*(*(144, square(a)), c), square(d)), e), *(*(-27, square(a)), (^(d, 4))), *(*(*(*(144, a), square(b)), c), square(e)), *(*(*(*(-6, a), square(b)), square(d)), e), *(*(*(*(*(-80, a), b), square(c)), d), e), *(*(*(*(18, a), b), c), cube(d)), *(*(*(16, a), (^(c, 4))), e), *(*(*(-4, a), cube(c)), square(d)), *(*(-27, (^(b, 4))), square(e)), *(*(*(*(18, cube(b)), c), d), e), *(*(-4, cube(b)), cube(d)), *(*(*(-4, square(b)), cube(c)), e), *(*(*(1, square(b)), square(c)), square(d))]) })], { error(self,'discriminant: degree≠{1,2,3,4}') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :coefficientList :x | let c = reverse(coefficientList); let n = size(coefficientList); if((=(n, 0)), { 0 }, { let answer = *(at(c, 1), (^(x, (-(n, 1))))); toDo(2, n, { :i | let m = at(c, i); let j = -(n, i); let t = if((=(j, 0)), { 1 }, { if((=(j, 1)), { x }, { ^(x, (-(n, i))) }) }); let f:/2 = if((<(m, 0)), { - }, { + }); ifTrue((!=(m, 0)), { answer := f(answer, if((=(m, 1)), { t }, { if((==(t, 1)), { abs(m) }, { *(abs(m), t) }) })) }) }); answer }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c) {
    ...
    let _n = _size_1(_c);
    let __SPL6 = _assertIsOfSize_2(_transpose_1(_c), 2);
    let _x = _at_2(__SPL6, 1);
    let _y = _at_2(__SPL6, 2);
  ...
  "{ :c | let n = size(c); let __SPL6 = assertIsOfSize(transpose(c), 2); let x = at(__SPL6, 1); let y = at(__SPL6, 2); let p = List(n, UnivariatePolynomial([1])); toDo(1, n, { :i | toDo(1, n, { :j | ifFalse((=(i, j)), { let q = UnivariatePolynomial([-(0, at(x, j)), 1]); atPut(p, i, *(at(p, i), q)) }) }); atPut(p, i, *(at(p, i), (/(1, at(at(p, i),at(x, i)))))) }); sum((*(p, y))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | normalize(initializeSlots(newUnivariatePolynomial(),self)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | caseOf(keyType(self), [->('SmallFloat', { UnivariatePolynomial(self) }), ->('List', { BivariatePolynomial(self) })], { error(self,'Polynomial: invalid coefficient dictionary') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let n = max(keys(self)); let c = collect(Span(0, n, 1), { :i | atIfAbsent(self, i, { 0 }) }); UnivariatePolynomial(c) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let c = caseOf(self, [->(0, { [1] }), ->(1, { [2, 0] }), ->(2, { [4, 0, -1] }), ->(3, { [8, 0, -4, 0] }), ->(4, { [16, 0, -12, 0, 1] }), ->(5, { [32, 0, -32, 0, 6, 0] }), ->(6, { [64, 0, -80, 0, 24, 0, -1] }), ->(7, { [128, 0, -192, 0, 80, 0, -8, 0] }), ->(8, { [256, 0, -448, 0, 240, 0, -40, 0, 1] }), ->(9, { [512, 0, -1024, 0, 672, 0, -160, 0, 10, 0] }), ->(10, { [1024, 0, -2304, 0, 1792, 0, -560, 0, 60, 0, -1] }), ->(11, { [2048, 0, -5120, 0, 4608, 0, -1792, 0, 280, 0, -12, 0] })], { error(self,'chebyshevU: not implemented') }); UnivariatePolynomial(reverse(c)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c | let d = sqrt(-((^(b, 2)), (*(*(4, a), c)))); if((<(0, b)), { [/((*(2, c)), (-(-(0, b), d))), /((-(-(0, b), d)), (*(2, a)))] }, { [/((+(-(0, b), d)), (*(2, a))), /((*(2, c)), (+(-(0, b), d)))] }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { UnivariatePolynomial(self) }, { if(isMatrix(self), { BivariatePolynomial(self) }, { error(self,'Polynomial: not vector or matrix') }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :operand | coefficientList(gcd(UnivariatePolynomial(self),UnivariatePolynomial(operand))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :operand | coefficientList(mod(UnivariatePolynomial(self),operand)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :operand | coefficientList(quotient(UnivariatePolynomial(self),UnivariatePolynomial(operand))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :operand | collect(quotientRemainder(UnivariatePolynomial(self),UnivariatePolynomial(operand)),coefficientList:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :operand | coefficientList(remainder(UnivariatePolynomial(self),UnivariatePolynomial(operand))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | cached(self, 'cyclotomic', { Map([[1, UnivariatePolynomial([-1, 1])]]) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let c = cachedCyclotomic(system); if(includesKey(c,self), { at(c,self) }, { let p = if(isPrime(self), { UnivariatePolynomial(#(1, self)) }, { let p = UnivariatePolynomial(++(++([-1], (#(0, (-(self, 1))))), [1])); do(allButLast(divisors(self)), { :d | p := quotient(p,cyclotomic(d)) }); p }); add(c,->(self, p)); p }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | caseOf(self, [->(0, { UnivariatePolynomial([1]) }), ->(1, { UnivariatePolynomial([0, 1]) })], { let n = -(self, 1); let a = UnivariatePolynomial([0, +((*(2, n)), 1)]); let b = legendreP(n); let c = legendreP(-(n, 1)); let d = /(1, (+(n, 1))); *((-((*(a, b)), (*(c, n)))), d) }) }",
);
