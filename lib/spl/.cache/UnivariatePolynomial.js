...
sl.addMethodToExistingType(
  ...
  "{ :numerator :denominator | let __SplVar1 = assertIsOfSize(quotientRemainder(numerator,denominator), 2); let q = at(__SplVar1, 1); let _ = at(__SplVar1, 2); q }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :numerator :denominator | let __SplVar2 = assertIsOfSize(quotientRemainder(numerator,denominator), 2); let _ = at(__SplVar2, 1); let r = at(__SplVar2, 2); r }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | caseOf((-(size(self), 1)), [->(1, { 1 }), ->(2, { let __SplVar3 = assertIsOfSize(self, 3); let c = at(__SplVar3, 1); let b = at(__SplVar3, 2); let a = at(__SplVar3, 3); -(square(b), (*(*(4, a), c))) }), ->(3, { let __SplVar4 = assertIsOfSize(self, 4); let d = at(__SplVar4, 1); let c = at(__SplVar4, 2); let b = at(__SplVar4, 3); let a = at(__SplVar4, 4); +(-(-(-((*(square(b), square(c))), (*(*(4, a), cube(c)))), (*(*(4, cube(b)), d))), (*(*(27, square(a)), square(d)))), (*(*(*(*(18, a), b), c), d))) }), ->(4, { let __SplVar5 = assertIsOfSize(self, 5); let e = at(__SplVar5, 1); let d = at(__SplVar5, 2); let c = at(__SplVar5, 3); let b = at(__SplVar5, 4); let a = at(__SplVar5, 5); sum([*(*(256, cube(a)), cube(e)), *(*(*(*(-192, square(a)), b), d), square(e)), *(*(*(-128, square(a)), square(c)), square(e)), *(*(*(*(144, square(a)), c), square(d)), e), *(*(-27, square(a)), (^(d, 4))), *(*(*(*(144, a), square(b)), c), square(e)), *(*(*(*(-6, a), square(b)), square(d)), e), *(*(*(*(*(-80, a), b), square(c)), d), e), *(*(*(*(18, a), b), c), cube(d)), *(*(*(16, a), (^(c, 4))), e), *(*(*(-4, a), cube(c)), square(d)), *(*(-27, (^(b, 4))), square(e)), *(*(*(*(18, cube(b)), c), d), e), *(*(-4, cube(b)), cube(d)), *(*(*(-4, square(b)), cube(c)), e), *(*(*(1, square(b)), square(c)), square(d))]) })], { error(self,'discriminant: degree≠{1,2,3,4}') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :c | let n = size(c); let __SplVar6 = assertIsOfSize(transpose(c), 2); let x = at(__SplVar6, 1); let y = at(__SplVar6, 2); let p = List(n, UnivariatePolynomial([1])); toDo(1, n, { :i | toDo(1, n, { :j | ifFalse((=(i, j)), { let q = UnivariatePolynomial([-(0, at(x, j)), 1]); atPut(p, i, *(at(p, i), q)) }) }); atPut(p, i, *(at(p, i), (/(1, at(at(p, i),at(x, i)))))) }); sum((*(p, y))) }",
);
