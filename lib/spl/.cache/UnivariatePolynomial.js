...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_numerator, _denominator) {
    ...
    let __SplUnused8 = _at_2(__SplVar1, 2);
    /* Statements */
    return _q;
  }, ["numerator", "denominator"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    let __SplVar2 = _assertIsOfSize_2(_operand, 1);
    let _indices = _at_2(__SplVar2, 1);
    /* Statements */
    return _collect_2(
      _indices,
      sl.annotateFunction(function (_each) {
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_numerator, _denominator) {
    ...
    let __SplUnused9 = _at_2(__SplVar3, 1);
      ...
      [
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SplVar6 = _assertIsOfSize_2(_self, 5);
            let _e = _at_2(__SplVar6, 1);
            let _d = _at_2(__SplVar6, 2);
            let _c = _at_2(__SplVar6, 3);
            let _b = _at_2(__SplVar6, 4);
            let _a = _at_2(__SplVar6, 5);
            /* Statements */
            return _sum_1([
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_c) {
    ...
    let _n = _size_1(_c);
    let __SplVar7 = _assertIsOfSize_2(_transpose_1(_c), 2);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _cached_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _Map_1([
          _hyphenMinusGreaterThanSign_2(1, _UnivariatePolynomial_1([-1, 1])),
        ]);
      }, []),
    );
  }, ["self"]),
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                return _UnivariatePolynomial_1(_List_2(_self, 1));
              }, []),
              sl.annotateFunction(function () {
                /* ArityCheck */
                if (arguments.length !== 0) {
                ...
                let _p = _UnivariatePolynomial_1(
                  _plusSignPlusSign_2(
                    _plusSignPlusSign_2(
                      [-1],
                      _List_2(_hyphenMinus_2(_self, 1), 0),
                    ),
                    [1],
                  ),
                );
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let _a = _lucasPolynomial_1(_hyphenMinus_2(_n, 1));
            let _b = _lucasPolynomial_1(_hyphenMinus_2(_n, 2));
            /* Statements */
            return _plusSign_2(_asterisk_2(_a, _Polynomial_1([0, 1])), _b);
          }, []),
        );
      }, []),
    );
