...
sl.addMethodToExistingType(
  ...
  "{ :self :operand :aBlock:/2 | &(isUnivariatePolynomial(operand), { aBlock(coefficientList(self), coefficientList(operand)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :kind | caseOf(self, [->(0, { UnivariatePolynomial([1]) }), ->(1, { UnivariatePolynomial([0, kind]) })], { let n = -(self, 1); let a = UnivariatePolynomial([0, 2]); let b = chebyshevPolynomial(n, kind); let c = chebyshevPolynomial(-(n, 1), kind); -((*(a, b)), c) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | chebyshevPolynomial(self,1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | chebyshevPolynomial(self,2) }",
);
