...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_directoryName, _answerPredicate_1) {
    ...
    /* Statements */
    _do_2(
      _readDirectoryFileNames_2(_system, _directoryName),
      sl.annotateFunction(function (_fileName) {
        ...
        let _fileText = _readTextFile_2(_system, _fileName);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(
    function (_directoryName, _options, _testName, _aBlock_2) {
      ...
      let _fileNameList = _readDirectoryFileNames_2(_system, _directoryName);
      ...
      let _textList = _readTextFileList_2(_system, _helpFileNameList);
      /* Statements */
      _withIndexDo_2(
        _textList,
