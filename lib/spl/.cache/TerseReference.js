...
sl.addMethod(
  ...
  function (_directoryName) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _directoryName"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_directoryName, _options) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _directoryName, _options"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    _withIndexDo_2(_textList, function (_text, _index) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _text, _index"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Temporaries */
      ...
      /* Statements */
      return _ifTrue_2(
        _greaterThanSign_2(_size_1(_documentTests_1(_helpFile)), 0),
        function () {
          /* ArityCheck */
