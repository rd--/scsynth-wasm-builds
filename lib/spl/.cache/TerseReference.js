...
sl.addMethod(
  ...
  function (_self) {
    ...
    _do_2(_lines_1(_self), function (_current) {
      ...
      /* Statements */
      _ifTrue_2(
        _ampersand_2(_beginsWith_2(_current, ">>> "), function () {
          /* ArityCheck */
      ...
      _ifTrue_2(
        _ampersand_2(
          _verticalLine_2(_isEmpty_1(_current), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
        ...
        return _then_2(
          ...
          function (_textList) {
            ...
            _withIndexDo_2(_textList, function (_text, _index) {
              ...
              /* Temporaries */
              let __genSym17 = _assertIsOfSize_2(
                ...
                _testCount = _at_2(__genSym17, 1),
                _passCount = _at_2(__genSym17, 2);
              /* Statements */
              _ifTrue_2(
...
sl.addMethod(
  ...
  function (_self, _name, _options) {
    ...
    _do_2(
      _concatenation_1(_parseMarkdownIndentedCodeBlocks_1(_self)),
      function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        return _if_3(_evaluate_2(_system, _each), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
    ...
    _do_2(_parseTerseDoctestBlocks_1(_self), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        console.error(errorMessage);
      ...
      /* Temporaries */
      let _test = _formatTerseDoctestEntry_1(_each);
      /* Statements */
      _testCount = _plusSign_2(_testCount, 1);
      _ifTrue_2(_at_2(_options, "verbose"), function () {
        /* ArityCheck */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let _lhs = _unwords_1(_collect_2(_allButLast_1(_self), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        console.error(errorMessage);
    ...
    let _rhs = _last_1(_self);
    /* Statements */
    return _plusSignPlusSign_2(_plusSignPlusSign_2(_lhs, " ~ "), _rhs);
  },
