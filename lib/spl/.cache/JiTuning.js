...
sl.addMethod(
  ...
  "JiTuning",
  "JiTuning",
  ["name", "description", "ratiosOrIntegers", "octave", "limit"],
  function (_name, _description, _ratiosOrIntegers, _octave, _limit) {
    /* ArityCheck */
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _name, _description, _ratiosOrIntegers, _octave, _limit"; /* console.error(errorMessage); */
    ...
    return _if_3(
      ...
      function () {
        ...
        /* Statements */
        return _limit_2(
          _IntegerTuning_4(_name, _description, _ratiosOrIntegers, _octave),
          _limit,
        );
      },
      function () {
        ...
        return _if_3(
          ...
          function () {
            ...
            /* Statements */
            return _error_2(_name, "JiTuning: not ratios or integers");
          },
        );
      },
    );
