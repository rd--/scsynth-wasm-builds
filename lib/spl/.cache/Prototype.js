sl.extendTraitWithMethod(
  ...
  function (_self, _key, _delegateKey, _aBlock_0) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _key, _delegateKey, _aBlock_0"; /* console.error(errorMessage); */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _key, _delegateKey) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _key, _delegateKey"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _key, _value, _delegateKey, _aBlock_0) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _key, _value, _delegateKey, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _key, _value, _delegateKey) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _key, _value, _delegateKey"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _atPutDelegateToIfAbsent_5(
...
sl.extendTraitWithMethod(
  ...
  function (_self, _selector, _delegateKey, _argumentsList) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _selector, _delegateKey, _argumentsList"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
