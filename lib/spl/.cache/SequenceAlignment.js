    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _powerSetDo_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          return _ifFalse_2(
            _isArithmeticProgression_3(_each, 1, _equal_2),
            sl.annotateFunction(function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
                const errorMessage = "Arity: expected 0, ";
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _do_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          _i = _indexOfStartingAtBy_4(_self, _each, _i, _equal_2);
          return _ifTrue_2(
            _equalsSign_2(_i, 0),
            sl.annotateFunction(function () {
              /* ArityCheck */
  ...
  sl.annotateFunction(function (_a, _b) {
          ...
          sl.annotateFunction(function (_y, _j) {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                return _atPut_3(
                  _at_2(_lengths, _plusSign_2(_i, 1)),
                  _plusSign_2(_j, 1),
                  _plusSign_2(_at_2(_at_2(_lengths, _i), _j), 1),
                );
              }, []),
              sl.annotateFunction(function () {
                /* ArityCheck */
                ...
                return _atPut_3(
                  ...
                  _plusSign_2(_j, 1),
                  _max_2(
                    _at_2(_at_2(_lengths, _plusSign_2(_i, 1)), _j),
                    _at_2(_at_2(_lengths, _i), _plusSign_2(_j, 1)),
                  ),
                );
              }, []),
            );
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          _equalsSign_2(
            _at_2(_at_2(_lengths, _m), _n),
            _at_2(_at_2(_lengths, _hyphenMinus_2(_m, 1)), _n),
          ),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              _equalsSign_2(
                _at_2(_at_2(_lengths, _m), _n),
                _at_2(_at_2(_lengths, _m), _hyphenMinus_2(_n, 1)),
              ),
              sl.annotateFunction(function () {
                /* ArityCheck */
                if (arguments.length !== 0) {
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _k = _at_2(_m, _plusSign_2(_l, 1));
        _timesRepeat_2(
          _l,
          sl.annotateFunction(function () {
            /* ArityCheck */
