      ...
      function () {
        ...
        return _allSatisfy_2(_keyList, function (_key) {
          ...
          if (arguments.length !== 1) {
            const errorMessage =
              "Arity: expected 1, _key"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _key, _aBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _key, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _atIfPresentIfAbsent_4(_self, _key, function (_value) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _value"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _key, _value) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _key, _value"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
    _self[_key] = _value;
...
sl.addTraitMethod(
  ...
  function (_self, _key, _aDictionary) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _key, _aDictionary"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_includesIndex_2(_self, _key), function () {
  ...
  function (_self, _aCollection, _aBlock_1) {
    ...
    return _if_3(_isDictionary_1(_aCollection), function () {
      ...
      return _associationsDo_2(_aCollection, function (_association) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _association"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
        return _atPut_3(
...
sl.addTraitMethod(
  ...
  function (_self, _value, _exceptionBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _value, _exceptionBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _valueWithReturn_1(function (_return_1) {
...
sl.addTraitMethod(
  ...
  function (_self, _keyValueBlock_2) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _keyValueBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _keys) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _keys"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _oldObject, _anExceptionBlock_0) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _oldObject, _anExceptionBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_self, _oldObject) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _oldObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
