...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _aDictionary) {
    ...
    return _hasEqualElements_3(_self, _aDictionary, _equal_2);
  }, ["self", "aDictionary"]),
      ...
      sl.annotateFunction(function (_key, _value) {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _error_2(
              _self,
              "keysAndEachValueDo: value not a collection",
            );
          }, []),
        );
      }, ["key", "value"]),
...
sl.addMethodToExistingTrait(
  ...
  "Dictionary",
  "keysAndValuesRemove",
  ["self", "keyAndValueBlock:/2"],
  sl.annotateFunction(function (_self, _keyAndValueBlock_2) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _keyAndValueBlock_2";
      throw new Error(errorMessage);
    } /* Statements */
    return _associationsRemove_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        return _keyAndValueBlock_2(_key_1(_each), _value_1(_each));
      }, ["each"]),
    );
  }, ["self", "keyAndValueBlock:/2"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _format_2("Dictionary(%)", [_associations_1(_self)]);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function () {
    ...
    return _initializeSlots_4(_newDictionary_0(), [], [], _equal_2);
  }, []),
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _listToDictionary_1(_collect_2(_self, _keyAndValue_1));
          }, []),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _keys = _at_2(__SplVar3, 1);
        let _values = _at_2(__SplVar3, 2);
