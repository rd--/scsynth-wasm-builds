...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _aDictionary) {
    ...
    return _equalBy_3(_self, _aDictionary, _equalsSign_2);
  }, ["self", "aDictionary"]),
  "{ :self :aDictionary | equalBy(self,aDictionary, =) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _aDictionary) {
    ...
    return _equalBy_3(_self, _aDictionary, _tilde_2);
  }, ["self", "aDictionary"]),
  "{ :self :aDictionary | equalBy(self,aDictionary, ~) }",
);
      ...
      sl.annotateFunction(function () {
        ...
        return _allSatisfy_2(
          ...
          sl.annotateFunction(function (_key) {
            ...
            return _aBlock_2(_at_2(_self, _key), _at_2(_aDictionary, _key));
          }, ["key"]),
        );
      }, []),
    );
  }, ["self", "aDictionary", "aBlock:/2"]),
  "{ :self :aDictionary :aBlock:/2 | &((=(size(self), size(aDictionary))), { allSatisfy(keys(self), { :key | aBlock(at(self, key), at(aDictionary, key)) }) }) }",
);
