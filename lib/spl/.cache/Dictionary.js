...
sl.addMethodToExistingTrait(
  ...
  "{ :self :key :ifAbsent:/0 | typeResponsibility(self,'@Dictionary>>atIfAbsent') }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :key :value | typeResponsibility(self,'@Dictionary>>atPut') }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aDictionary :aBlock:/2 | &(=(typeOf(self), typeOf(aDictionary)), { hasEqualElements(self,aDictionary, aBlock:/2) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aDictionary :aBlock:/2 | if((=(size(self), size(aDictionary))), { allSatisfy(keys(self), { :key | atIfPresentIfAbsent(aDictionary, key, { :value | aBlock(at(self, key), value) }, { false }) }) }, { false }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aDictionary | hasEqualElements(self,aDictionary, =) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aCollection | allSatisfy(aCollection, { :each | includesKey(self,each) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/2 | typeResponsibility(self,'@Dictionary>>keysAndValuesDo') }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/1 | keysAndValuesDo(self, { :key :value | aBlock(key) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/1 | let answer = new(species(self)); associationsDo(self, { :each | ifTrue(aBlock(key(each)), { add(answer,copy(each)) }) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | sortOn(associations(self),key:/1) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :oldObject :anExceptionBlock:/0 | shouldNotImplement(self,'removeIfAbsent') }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/1 | keysDo(self, { :key | atPut(self, key, aBlock(at(self, key))) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | typeResponsibility(self,'@Dictionary>>size') }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :empty :open :close :formatKey:/1 :join :formatValue:/1 | if(isEmpty(self), { empty }, { format('%%%',[open, commaSeparated(collect(associations(self), { :each | format('%%%',[formatKey(key(each)), join, formatValue(value(each))]) })), close]) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aBlock:/1 | keysAndValuesDo(self, { :key :value | aBlock(value) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let keys = intersection(collect(self,keys:/1)); collect(self, { :each | let item = new(species(each)); do(keys, { :key | add(item,->(key, at(each,key))) }); item }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :blockOrDictionary | let keys = Set(); let aBlock:/1 = if(isBlock(blockOrDictionary), { blockOrDictionary }, { { :key | at(blockOrDictionary,key) } }); do(self, { :each | includeAll(keys,keys(each)) }); collect(self, { :each | let copy = copy(each); do(keys, { :key | ifFalse(includesKey(copy,key), { add(copy,->(key, aBlock(key))) }) }); copy }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | keyUnion(self, { :key | Missing('KeyAbsent', key) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let keys = union(collect(self,keys:/1)); let values = collect(keys, { :key | let list = []; do(self, { :each | ifTrue(includesKey(each,key), { add(list,at(each,key)) }) }); list }); let answer = new(species(anyOne(self))); withDo(keys, values, { :key :value | add(answer,->(key, aBlock(value))) }); answer }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aBlock:/2 | let keys = keys(self); let values = values(self); let size = size(keys); toDo(1, size, { :index | aBlock(at(keys, index), at(values, index)) }); nil }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | keys(self, copy(keys(self))); values(self, copy(values(self))) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _listToDictionary_1(_collect_2(_self, _asList_1));
          }, []),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
  ...
  "{ :self | if(isEmpty(self), { Dictionary() }, { if(isAssociationList(self), { listToDictionary(collect(self,asList:/1)) }, { listToDictionary(self) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL2 = _assertIsOfSize_2(_transpose_1(_self), 2);
        let _keys = _at_2(__SPL2, 1);
        let _values = _at_2(__SPL2, 2);
  ...
  "{ :self | let __SPL1 = assertIsOfSize(dimensions(self), 2); let _ = at(__SPL1, 1); let m = at(__SPL1, 2); if((=(m, 2)), { let __SPL2 = assertIsOfSize(transpose(self), 2); let keys = at(__SPL2, 1); let values = at(__SPL2, 2); let answer = Dictionary(); keys(answer, keys); values(answer, values); answer }, { error(self,'List>>listToDictionary') }) }",
);
