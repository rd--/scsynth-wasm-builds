...
sl.addTraitMethod(
  ...
  function (_self, _aBlock_1, _whenFound_1, _whenNone_0) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _aBlock_1, _whenFound_1, _whenNone_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addTraitMethod(
  ...
  function (_self, _anObject, _index) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _anObject, _index"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addTraitMethod(
  ...
  function (_self, _keyBlock_1, _compareBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _keyBlock_1, _compareBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
    return _self.sort(function (p, q) {
