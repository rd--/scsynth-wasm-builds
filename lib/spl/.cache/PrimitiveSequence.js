...
sl.addMethodToExistingTrait(
  ...
  "{ :self :index :ifAbsent:/0 | <primitive: if(sl.arrayCheckIndex(_self, _index)) {\n\t\t\treturn _self[_index - 1];\n\t\t}\n\t\treturn _ifAbsent_0();>\n }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :sortBlock:/2 | <primitive: return _self.sort(function(p, q) {\n\t\t\treturn _sortBlock_2(p, q) ? -1 : 1\n\t\t});>\n }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :sortBlock:/2 :keyBlock:/1 | <primitive: return _self.sort(function(p, q) {\n\t\t\treturn _sortBlock_2(_keyBlock_1(p), _keyBlock_1(q)) ? -1 : 1\n\t\t});>\n }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | format('%(%)',[typeOf(self), storeString(asList(self))]) }",
);
