...
sl.addMethod(
  ...
  function (_self, _subject, _event, _delay, _aBlock_0) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _subject, _event, _delay, _aBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    _addEventListener_3(_frame, "close", function (_unusedEvent) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _unusedEvent"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self, _subject, _event) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _subject, _event"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.addMethod(
  ...
  "browserOn",
  ["self", "name", "event"],
  function (_self, _name, _event) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _name, _event"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_isTypeName_2(_system, _name), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage =
          "Arity: expected 0, "; /* console.error(errorMessage); */
      ...
      /* Statements */
      return _if_3(_isTraitName_2(_system, _name), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage =
            "Arity: expected 0, "; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _aColour) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aColour"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aString, _event) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aString, _event"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _fontName) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _fontName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _setProperty_4(
...
sl.addMethod(
  ...
  function (_self, _subject) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _subject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _collect_2([
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _fontName"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _MenuItem_3(_key_1(_fontName), null, function (_unusedEvent) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _unusedEvent"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _subject, _isTransient, _event) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _subject, _isTransient, _event"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _menu_5(
...
sl.addMethod(
  ...
  function (_self, _fontSize) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _fontSize"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _setProperty_4(
  ...
  function (_self, _subject) {
    ...
    return _collect_2(
      ...
      function (_fontSize) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _fontSize"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _addEventListener_3(_container_1(_self), "contextmenu", function (_event) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _event"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _ifTrue_2(
...
sl.addMethod(
  ...
  function (_self, _frame) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _frame"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    return _thenElse_3(_midiAccess_1(_self), function (_midiAccess) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _midiAccess"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _message"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _warning_2(
