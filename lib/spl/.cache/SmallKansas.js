...
sl.addMethod(
  ...
  function (_self, _subject, _event) {
    ...
    _zIndex_2(_frame, _plus_2(_max_1(_zIndices_1(_self)), 1));
    ...
    _add_2(_frameSet_1(_self), _frame);
  ...
  function (_self, _path, _event) {
    ...
    return _if_3(_isTypeName_2(_system, _at_2(_path, 1)), function () {
      ...
      return _if_3(_isTraitName_2(_system, _at_2(_path, 1)), function () {
        ...
        return _warning_2(
          _self,
          _plusPlus_2("browserOn: not type or trait: ", _at_2(_path, 1)),
        );
      });
    });
  },
...
sl.addMethod(
  ...
  function (_self, _subject, _event) {
    ...
    _setProperty_4(
      _style_1(_dialog),
      "left",
      _plusPlus_2(_asString_1(_x_1(_event)), "px"),
      "",
    );
    _setProperty_4(
      _style_1(_dialog),
      "top",
      _plusPlus_2(_asString_1(_y_1(_event)), "px"),
      "",
    );
...
sl.addMethod(
  ...
  function (_self, _subject, _event) {
    ...
    /* Temporaries */
    let _bracketedSubject = _plusPlus_2(_plusPlus_2(">>", _subject), ":/");
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _addEventListener_3(_container_1(_self), "contextmenu", function (_event) {
      ...
      /* Statements */
      return _ifTrue_2(
        _equalsEquals_2(_target_1(_event), _container_1(_self)),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    return _thenElse_3(_midiAccess_1(_self), function (_midiAccess) {
      ...
      return _warning_2(
        _self,
        _plus_2("withMidiAccess: no midiAccess: ", _message),
      );
    });
  },
