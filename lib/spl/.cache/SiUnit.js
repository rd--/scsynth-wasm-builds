...
sl.addMethod(
  ...
  function (_self, _anSiUnit) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _anSiUnit"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _symbolOrName) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _symbolOrName"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _name, _dimension, _quantity) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _name, _dimension, _quantity"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _exceptionBlock_0) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _exceptionBlock_0"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
