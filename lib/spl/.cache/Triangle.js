...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL5 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
  ...
  "{ :self | let __SPL5 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL5, 1); let b = at(__SPL5, 2); let c = at(__SPL5, 3); [fromTrilinearCoordinates(self,[/(c, b), /(a, c), /(b, a)]), fromTrilinearCoordinates(self,[/(b, c), /(c, a), /(a, b)]), triangleCentreL(self, { :a :b :c | ^(a, -3) })] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p) {
    ...
    let __SPL6 = _assertIsOfSize_2(_toTrilinearCoordinates_2(_self, _p), 3);
    let _alpha = _at_2(__SPL6, 1);
    let _beta = _at_2(__SPL6, 2);
    let _gamma = _at_2(__SPL6, 3);
    /* Statements */
  ...
  "{ :self :p | let __SPL6 = assertIsOfSize(toTrilinearCoordinates(self,p), 3); let alpha = at(__SPL6, 1); let beta = at(__SPL6, 2); let gamma = at(__SPL6, 3); fromTrilinearVertexMatrix(self,[[0, beta, gamma], [alpha, 0, gamma], [alpha, beta, 0]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL7 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
  ...
  "{ :self | let __SPL7 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL7, 1); let b = at(__SPL7, 2); let c = at(__SPL7, 3); let x = tan(a); let y = tan(b); let z = tan(c); fromTrilinearVertexMatrix(self,[[+(+((*(2, x)), y), z), *(sin(a), sec(b)), *(sin(a), sec(c))], [*(sin(b), sec(a)), +(+(x, (*(2, y))), z), *(sin(b), sec(c))], [*(sin(c), sec(a)), *(sin(c), sec(b)), +(+(x, y), (*(2, z)))]]) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL8 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL8, 1); let b = at(__SPL8, 2); let c = at(__SPL8, 3); let i = +(+(+(+(+(+((*(square(a), b)), (*(a, square(b)))), (*(square(a), c))), (*(*(a, b), c))), (*(square(b), c))), (*(a, square(c)))), (*(b, square(c)))); let r = /(sqrt((/(i, (+(+(a, b), a))))), 2); Circle(spiekerCenter(self), r) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _f_1 = sl.annotateFunction(function (_x) {
      ...
      let __SPL9 = _assertIsOfSize_2(_x, 3);
  ...
  "{ :self | let s = semiperimeter(self); let l = sideLengths(self); let f = { :x | let __SPL9 = assertIsOfSize(x, 3); let a = at(__SPL9, 1); let b = at(__SPL9, 2); let c = at(__SPL9, 3); sqrt((/((*(*(s, (-(s, b))), (-(s, c)))), (-(s, a))))) }; collect([0, 2, 1], { :r | f(rotate(l,r)) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL10 = _assertIsOfSize_2(_cos_1(_interiorAngles_1(_self)), 3);
  ...
  "{ :self | let __SPL10 = assertIsOfSize(cos(interiorAngles(self)), 3); let x = at(__SPL10, 1); let y = at(__SPL10, 2); let z = at(__SPL10, 3); fromTrilinearVertexMatrix(self,[[-(0, (+(x, 1))), +(x, z), +(x, y)], [+(y, z), -(0, (+(y, 1))), +(y, x)], [+(z, y), +(z, x), -(0, (+(z, 1)))]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL11 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
  ...
  "{ :self | let __SPL11 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL11, 1); let b = at(__SPL11, 2); let c = at(__SPL11, 3); fromTrilinearCoordinates(self,[/(c, b), /(a, c), /(b, a)]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL12 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
  ...
  "{ :self | let __SPL12 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL12, 1); let b = at(__SPL12, 2); let c = at(__SPL12, 3); fromTrilinearVertexMatrix(self,[[*(*(a, b), c), cube(c), cube(b)], [cube(c), *(*(a, b), c), cube(a)], [cube(b), cube(a), *(*(a, b), c)]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL13 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
  ...
  "{ :self | let __SPL13 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL13, 1); let b = at(__SPL13, 2); let c = at(__SPL13, 3); let s = *((+(+(a, b), c)), 0.5); sqrt((*(*(*(s, (-(s, a))), (-(s, b))), (-(s, c))))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL14 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
  ...
  "{ :self | let __SPL14 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL14, 1); let b = at(__SPL14, 2); let c = at(__SPL14, 3); let s = *((+(+(a, b), c)), 0.5); sqrt((/((*(*((-(s, a)), (-(s, b))), (-(s, c)))), s))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL15 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL15, 1);
    let _b = _at_2(__SPL15, 2);
    let _c = _at_2(__SPL15, 3);
    /* Statements */
    return _collect_2(
      [[
        _asterisk_2(
  ...
  "{ :self | let __SPL15 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL15, 1); let b = at(__SPL15, 2); let c = at(__SPL15, 3); collect([[*(*(-1, (+(-(a, b), c))), b), *((+(+(-(0, a), b), c)), a), 0], [0, *(*(-1, (-(+(a, b), c))), c), *((+(-(a, b), c)), b)], [*((-(+(a, b), c)), c), 0, *(*(-1, a), (+(+(-(0, a), b), c)))]], { :each | fromTrilinearCoordinates(self,each) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL16 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL16, 1); let b = at(__SPL16, 2); let c = at(__SPL16, 3); fromTrilinearVertexMatrix(self,[[0, sec(b), sec(c)], [sec(a), 0, sec(c)], [sec(a), sec(b), 0]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p) {
    ...
    let __SPL17 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SPL17, 1);
    let _b = _at_2(__SPL17, 2);
    let _c = _at_2(__SPL17, 3);
    let __SPL18 = _assertIsOfSize_2(_toTrilinearCoordinates_2(_self, _p), 3);
    let _alpha = _at_2(__SPL18, 1);
    let _beta = _at_2(__SPL18, 2);
    let _gamma = _at_2(__SPL18, 3);
    /* Statements */
    return _fromTrilinearVertexMatrix_2(_self, [[
      0,
      _plusSign_2(_beta, _asterisk_2(_alpha, _cos_1(_c))),
  ...
  "{ :self :p | let __SPL17 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL17, 1); let b = at(__SPL17, 2); let c = at(__SPL17, 3); let __SPL18 = assertIsOfSize(toTrilinearCoordinates(self,p), 3); let alpha = at(__SPL18, 1); let beta = at(__SPL18, 2); let gamma = at(__SPL18, 3); fromTrilinearVertexMatrix(self,[[0, +(beta, (*(alpha, cos(c)))), +(gamma, (*(alpha, cos(b))))], [+(alpha, (*(beta, cos(c)))), 0, +(gamma, (*(beta, cos(a))))], [+(alpha, (*(gamma, cos(b)))), +(beta, (*(gamma, cos(a)))), 0]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL19 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL19, 1);
    let _b = _at_2(__SPL19, 2);
    let _c = _at_2(__SPL19, 3);
    let __SPL20 = _assertIsOfSize_2(_medialTriangle_1([_a, _b, _c]), 3);
    let _p = _at_2(__SPL20, 1);
    let _q = _at_2(__SPL20, 2);
    let _r = _at_2(__SPL20, 3);
    /* Statements */
  ...
  "{ :self | let __SPL19 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL19, 1); let b = at(__SPL19, 2); let c = at(__SPL19, 3); let __SPL20 = assertIsOfSize(medialTriangle([a, b, c]), 3); let p = at(__SPL20, 1); let q = at(__SPL20, 2); let r = at(__SPL20, 3); Circle([p, q, r], [norm((-(p, a))), norm((-(q, b))), norm((-(r, c)))]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL21 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
  ...
  "{ :self | let __SPL21 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL21, 1); let b = at(__SPL21, 2); let c = at(__SPL21, 3); fromTrilinearCoordinates(self,[/(b, c), /(c, a), /(a, b)]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL22 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL22, 1);
    let _b = _at_2(__SPL22, 2);
    let _c = _at_2(__SPL22, 3);
    let __SPL23 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _alpha = _at_2(__SPL23, 1);
    let _beta = _at_2(__SPL23, 2);
    let _gamma = _at_2(__SPL23, 3);
    /* Statements */
    return _fromTrilinearVertexMatrix_2(_self, [[
  ...
  "{ :self | let __SPL22 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL22, 1); let b = at(__SPL22, 2); let c = at(__SPL22, 3); let __SPL23 = assertIsOfSize(interiorAngles(self), 3); let alpha = at(__SPL23, 1); let beta = at(__SPL23, 2); let gamma = at(__SPL23, 3); fromTrilinearVertexMatrix(self,[[*(*(*(2, b), c), cos(alpha)), *(a, b), *(a, c)], [*(a, b), *(*(*(2, a), c), cos(beta)), *(b, c)], [*(a, c), *(b, c), *(*(*(2, a), b), cos(gamma))]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL24 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL24, 1);
    let _b = _at_2(__SPL24, 2);
    let _c = _at_2(__SPL24, 3);
    /* Statements */
    return [
  ...
  "{ :self | let __SPL24 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL24, 1); let b = at(__SPL24, 2); let c = at(__SPL24, 3); [euclideanDistance(b,c), euclideanDistance(c,a), euclideanDistance(a,b)] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL25 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
  ...
  "{ :self | let __SPL25 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL25, 1); let b = at(__SPL25, 2); let c = at(__SPL25, 3); *(cross((-(b, a)),-(c, b)), 0.5) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL26 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _p1 = _at_2(__SPL26, 1);
    let _p2 = _at_2(__SPL26, 2);
    let _p3 = _at_2(__SPL26, 3);
    let _u = _hyphenMinus_2(_p2, _p1);
    let _v = _hyphenMinus_2(_p3, _p1);
    /* Statements */
    return _cross_2(_u, _v);
  }, ["self"]),
  "{ :self | let __SPL26 = assertIsOfSize(vertexCoordinates(self), 3); let p1 = at(__SPL26, 1); let p2 = at(__SPL26, 2); let p3 = at(__SPL26, 3); let u = -(p2, p1); let v = -(p3, p1); cross(u,v) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL27 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL27, 1);
    let _b = _at_2(__SPL27, 2);
    let _c = _at_2(__SPL27, 3);
    /* Statements */
  ...
  "{ :self | let __SPL27 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL27, 1); let b = at(__SPL27, 2); let c = at(__SPL27, 3); fromTrilinearVertexMatrix(self,[[0, b, c], [a, 0, c], [a, b, 0]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL28 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL28, 1);
    let _b = _at_2(__SPL28, 2);
    let _c = _at_2(__SPL28, 3);
    let __SPL29 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _p = _at_2(__SPL29, 1);
    let _q = _at_2(__SPL29, 2);
    let _r = _at_2(__SPL29, 3);
    /* Statements */
    return [
      _Circle_2(
        _p,
  ...
  "{ :self | let __SPL28 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL28, 1); let b = at(__SPL28, 2); let c = at(__SPL28, 3); let __SPL29 = assertIsOfSize(vertexCoordinates(self), 3); let p = at(__SPL29, 1); let q = at(__SPL29, 2); let r = at(__SPL29, 3); [Circle(p, /((+(+(-(0, a), b), c)), 2)), Circle(q, /((+(-(a, b), c)), 2)), Circle(r, /((-(+(a, b), c)), 2))] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL30 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SPL30, 1);
    let _b = _at_2(__SPL30, 2);
    let _c = _at_2(__SPL30, 3);
    /* Statements */
    return _fromTrilinearVertexMatrix_2(_self, [
  ...
  "{ :self | let __SPL30 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL30, 1); let b = at(__SPL30, 2); let c = at(__SPL30, 3); fromTrilinearVertexMatrix(self,[[-(0, a), b, c], [a, -(0, b), c], [a, b, -(0, c)]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL31 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL31, 1);
    let _b = _at_2(__SPL31, 2);
    let _c = _at_2(__SPL31, 3);
    /* Statements */
    return _toBarycentricCoordinates_3(_a, _b, _c);
  }, ["self"]),
  "{ :self | let __SPL31 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL31, 1); let b = at(__SPL31, 2); let c = at(__SPL31, 3); toBarycentricCoordinates(a, b, c) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL32 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL32, 1);
    let _b = _at_2(__SPL32, 2);
    let _c = _at_2(__SPL32, 3);
  ...
  "{ :self | let __SPL32 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL32, 1); let b = at(__SPL32, 2); let c = at(__SPL32, 3); let v = sideLengths(self); let f:/1 = toBarycentricCoordinates(a, b, c); { :x | /(f(x), v) } }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p_1, _f_3) {
    ...
    let __SPL33 = _assertIsOfSize_2(_p_1(_self), 3);
    let _a = _at_2(__SPL33, 1);
    let _b = _at_2(__SPL33, 2);
    let _c = _at_2(__SPL33, 3);
  ...
  "{ :self :p:/1 :f:/3 | let __SPL33 = assertIsOfSize(p(self), 3); let a = at(__SPL33, 1); let b = at(__SPL33, 2); let c = at(__SPL33, 3); let alpha = f(a, b, c); let beta = f(b, c, a); let gamma = f(c, a, b); fromTrilinearCoordinates(self,[alpha, beta, gamma]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL34 = _assertIsOfSize_2(_self, 3);
    let __genSym41 = _at_2(__SPL34, 1);
    let _p = _at_2(__SPL34, 2);
    let __genSym42 = _at_2(__SPL34, 3);
    let _a = _planarAngle_1(_self);
    /* Statements */
    return _InfiniteLine_2(_p, _fromPolarCoordinates_1([1, _solidus_2(_a, 2)]));
  }, ["self"]),
  "{ :self | let __SPL34 = assertIsOfSize(self, 3); let _ = at(__SPL34, 1); let p = at(__SPL34, 2); let _ = at(__SPL34, 3); let a = planarAngle(self); InfiniteLine(p, fromPolarCoordinates([1, /(a, 2)])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL35 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SPL35, 1);
    let _b = _at_2(__SPL35, 2);
    let _c = _at_2(__SPL35, 3);
    let __SPL36 = _assertIsOfSize_2(_a, 2);
    let _ax = _at_2(__SPL36, 1);
    let _ay = _at_2(__SPL36, 2);
    let __SPL37 = _assertIsOfSize_2(_b, 2);
    let _bx = _at_2(__SPL37, 1);
    let _by = _at_2(__SPL37, 2);
    let __SPL38 = _assertIsOfSize_2(_c, 2);
    let _cx = _at_2(__SPL38, 1);
    let _cy = _at_2(__SPL38, 2);
  ...
  "{ :self | let __SPL35 = assertIsOfSize(self, 3); let a = at(__SPL35, 1); let b = at(__SPL35, 2); let c = at(__SPL35, 3); let __SPL36 = assertIsOfSize(a, 2); let ax = at(__SPL36, 1); let ay = at(__SPL36, 2); let __SPL37 = assertIsOfSize(b, 2); let bx = at(__SPL37, 1); let by = at(__SPL37, 2); let __SPL38 = assertIsOfSize(c, 2); let cx = at(__SPL38, 1); let cy = at(__SPL38, 2); let ad = +((*(ax, ax)), (*(ay, ay))); let bd = +((*(bx, bx)), (*(by, by))); let cd = +((*(cx, cx)), (*(cy, cy))); let d = *(2, (+(+((*(ax, (-(by, cy)))), (*(bx, (-(cy, ay))))), (*(cx, (-(ay, by))))))); let center = [*(/(1, d), (+(+((*(ad, (-(by, cy)))), (*(bd, (-(cy, ay))))), (*(cd, (-(ay, by))))))), *(/(1, d), (+(+((*(ad, (-(cx, bx)))), (*(bd, (-(ax, cx))))), (*(cd, (-(bx, ax)))))))]; let radius = euclideanDistance(center,anyOne(self)); Circle(center, radius) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL39 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SPL39, 1);
    let _b = _at_2(__SPL39, 2);
    let _c = _at_2(__SPL39, 3);
    /* Statements */
    return [
      _midpoint_1([_b, _c]),
      _midpoint_1([_c, _a]),
  ...
  "{ :self | let __SPL39 = assertIsOfSize(self, 3); let a = at(__SPL39, 1); let b = at(__SPL39, 2); let c = at(__SPL39, 3); [midpoint([b, c]), midpoint([c, a]), midpoint([a, b])] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL40 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SPL40, 1);
    let _b = _at_2(__SPL40, 2);
    let _c = _at_2(__SPL40, 3);
    /* Statements */
    return _sssTriangle_3(_a, _b, _c);
  }, ["self"]),
  "{ :self | let __SPL40 = assertIsOfSize(self, 3); let a = at(__SPL40, 1); let b = at(__SPL40, 2); let c = at(__SPL40, 3); sssTriangle(a, b, c) }",
);
