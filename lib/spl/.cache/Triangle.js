...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    let __SPL1 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _p1 = _at_2(__SPL1, 1);
    let _p2 = _at_2(__SPL1, 2);
    let _p3 = _at_2(__SPL1, 3);
    let _u = _hyphenMinus_2(_p2, _p1);
    let _v = _hyphenMinus_2(_p3, _p1);
    /* Statements */
    return _cross_2(_u, _v);
  },
  "{ :self | let __SPL1 = assertIsOfSize(vertexCoordinates(self), 3); let p1 = at(__SPL1, 1); let p2 = at(__SPL1, 2); let p3 = at(__SPL1, 3); let u = -(p2, p1); let v = -(p3, p1); cross(u,v) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL2 = assertIsOfSize(self, 3); let a = at(__SPL2, 1); let b = at(__SPL2, 2); let c = at(__SPL2, 3); Triangle(a, b, c) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL4 = _assertIsOfSize_2(_a, 2);
    let _ax = _at_2(__SPL4, 1);
    let _ay = _at_2(__SPL4, 2);
    let __SPL5 = _assertIsOfSize_2(_b, 2);
    let _bx = _at_2(__SPL5, 1);
    let _by = _at_2(__SPL5, 2);
    let __SPL6 = _assertIsOfSize_2(_c, 2);
    let _cx = _at_2(__SPL6, 1);
    let _cy = _at_2(__SPL6, 2);
  ...
  "{ :self | let __SPL3 = assertIsOfSize(self, 3); let a = at(__SPL3, 1); let b = at(__SPL3, 2); let c = at(__SPL3, 3); let __SPL4 = assertIsOfSize(a, 2); let ax = at(__SPL4, 1); let ay = at(__SPL4, 2); let __SPL5 = assertIsOfSize(b, 2); let bx = at(__SPL5, 1); let by = at(__SPL5, 2); let __SPL6 = assertIsOfSize(c, 2); let cx = at(__SPL6, 1); let cy = at(__SPL6, 2); let ad = +((*(ax, ax)), (*(ay, ay))); let bd = +((*(bx, bx)), (*(by, by))); let cd = +((*(cx, cx)), (*(cy, cy))); let d = *(2, (+(+((*(ax, (-(by, cy)))), (*(bx, (-(cy, ay))))), (*(cx, (-(ay, by))))))); let center = [*(/(1, d), (+(+((*(ad, (-(by, cy)))), (*(bd, (-(cy, ay))))), (*(cd, (-(ay, by))))))), *(/(1, d), (+(+((*(ad, (-(cx, bx)))), (*(bd, (-(ax, cx))))), (*(cd, (-(bx, ax)))))))]; let radius = euclideanDistance(center,anyOne(self)); Circle(center, radius) }",
);
