...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL64 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL64, 1);
    let _b = _at_2(__SPL64, 2);
    let _c = _at_2(__SPL64, 3);
  ...
  "{ :self | let __SPL64 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL64, 1); let b = at(__SPL64, 2); let c = at(__SPL64, 3); let s = *((+(+(a, b), c)), 0.5); sqrt((*(*(*(s, (-(s, a))), (-(s, b))), (-(s, c))))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL65 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL65, 1);
    let _b = _at_2(__SPL65, 2);
    let _c = _at_2(__SPL65, 3);
    let _s = _asterisk_2(_plusSign_2(_plusSign_2(_a, _b), _c), 0.5);
    /* Statements */
    return _sqrt_1(
      _solidus_2(
  ...
  "{ :self | let __SPL65 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL65, 1); let b = at(__SPL65, 2); let c = at(__SPL65, 3); let s = *((+(+(a, b), c)), 0.5); sqrt((/((*(*((-(s, a)), (-(s, b))), (-(s, c)))), s))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL66 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL66, 1);
    let _b = _at_2(__SPL66, 2);
    let _c = _at_2(__SPL66, 3);
    /* Statements */
    return [
  ...
  "{ :self | let __SPL66 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL66, 1); let b = at(__SPL66, 2); let c = at(__SPL66, 3); [euclideanDistance(b,c), euclideanDistance(c,a), euclideanDistance(a,b)] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL67 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL67, 1);
    let _b = _at_2(__SPL67, 2);
    let _c = _at_2(__SPL67, 3);
    /* Statements */
    return _asterisk_2(
  ...
  "{ :self | let __SPL67 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL67, 1); let b = at(__SPL67, 2); let c = at(__SPL67, 3); *(cross((-(b, a)),-(c, b)), 0.5) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL68 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _p1 = _at_2(__SPL68, 1);
    let _p2 = _at_2(__SPL68, 2);
    let _p3 = _at_2(__SPL68, 3);
    let _u = _hyphenMinus_2(_p2, _p1);
    let _v = _hyphenMinus_2(_p3, _p1);
    /* Statements */
    return _cross_2(_u, _v);
  }, ["self"]),
  "{ :self | let __SPL68 = assertIsOfSize(vertexCoordinates(self), 3); let p1 = at(__SPL68, 1); let p2 = at(__SPL68, 2); let p3 = at(__SPL68, 3); let u = -(p2, p1); let v = -(p3, p1); cross(u,v) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL69 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL69, 1);
    let _b = _at_2(__SPL69, 2);
    let _c = _at_2(__SPL69, 3);
    /* Statements */
    return _toBarycentricCoordinates_3(_a, _b, _c);
  }, ["self"]),
  "{ :self | let __SPL69 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL69, 1); let b = at(__SPL69, 2); let c = at(__SPL69, 3); toBarycentricCoordinates(a, b, c) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL70 = _assertIsOfSize_2(_self, 3);
    let __genSym76 = _at_2(__SPL70, 1);
    let _p = _at_2(__SPL70, 2);
    let __genSym77 = _at_2(__SPL70, 3);
    let _a = _planarAngle_1(_self);
    /* Statements */
    return _InfiniteLine_2(_p, _fromPolarCoordinates_1([1, _solidus_2(_a, 2)]));
  }, ["self"]),
  "{ :self | let __SPL70 = assertIsOfSize(self, 3); let _ = at(__SPL70, 1); let p = at(__SPL70, 2); let _ = at(__SPL70, 3); let a = planarAngle(self); InfiniteLine(p, fromPolarCoordinates([1, /(a, 2)])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL71 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SPL71, 1);
    let _b = _at_2(__SPL71, 2);
    let _c = _at_2(__SPL71, 3);
    let __SPL72 = _assertIsOfSize_2(_a, 2);
    let _ax = _at_2(__SPL72, 1);
    let _ay = _at_2(__SPL72, 2);
    let __SPL73 = _assertIsOfSize_2(_b, 2);
    let _bx = _at_2(__SPL73, 1);
    let _by = _at_2(__SPL73, 2);
    let __SPL74 = _assertIsOfSize_2(_c, 2);
    let _cx = _at_2(__SPL74, 1);
    let _cy = _at_2(__SPL74, 2);
  ...
  "{ :self | let __SPL71 = assertIsOfSize(self, 3); let a = at(__SPL71, 1); let b = at(__SPL71, 2); let c = at(__SPL71, 3); let __SPL72 = assertIsOfSize(a, 2); let ax = at(__SPL72, 1); let ay = at(__SPL72, 2); let __SPL73 = assertIsOfSize(b, 2); let bx = at(__SPL73, 1); let by = at(__SPL73, 2); let __SPL74 = assertIsOfSize(c, 2); let cx = at(__SPL74, 1); let cy = at(__SPL74, 2); let ad = +((*(ax, ax)), (*(ay, ay))); let bd = +((*(bx, bx)), (*(by, by))); let cd = +((*(cx, cx)), (*(cy, cy))); let d = *(2, (+(+((*(ax, (-(by, cy)))), (*(bx, (-(cy, ay))))), (*(cx, (-(ay, by))))))); let center = [*(/(1, d), (+(+((*(ad, (-(by, cy)))), (*(bd, (-(cy, ay))))), (*(cd, (-(ay, by))))))), *(/(1, d), (+(+((*(ad, (-(cx, bx)))), (*(bd, (-(ax, cx))))), (*(cd, (-(bx, ax)))))))]; let radius = euclideanDistance(center,anyOne(self)); Circle(center, radius) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL75 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SPL75, 1);
    let _b = _at_2(__SPL75, 2);
    let _c = _at_2(__SPL75, 3);
    /* Statements */
    return [
      _midpoint_1([_a, _b]),
      _midpoint_1([_a, _c]),
  ...
  "{ :self | let __SPL75 = assertIsOfSize(self, 3); let a = at(__SPL75, 1); let b = at(__SPL75, 2); let c = at(__SPL75, 3); [midpoint([a, b]), midpoint([a, c]), midpoint([b, c])] }",
);
