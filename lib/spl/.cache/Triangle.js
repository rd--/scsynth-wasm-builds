...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL278 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL278, 1);
    let _b = _at_2(__SPL278, 2);
    let _c = _at_2(__SPL278, 3);
    let __SPL279 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _p = _at_2(__SPL279, 1);
    let _q = _at_2(__SPL279, 2);
    let _r = _at_2(__SPL279, 3);
    /* Statements */
    return [
  ...
  "{ :self | let __SPL278 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL278, 1); let b = at(__SPL278, 2); let c = at(__SPL278, 3); let __SPL279 = assertIsOfSize(interiorAngles(self), 3); let p = at(__SPL279, 1); let q = at(__SPL279, 2); let r = at(__SPL279, 3); [*(b, sin(r)), *(c, sin(p)), *(a, sin(q))] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p) {
    ...
    let __SPL280 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SPL280, 1);
    let _b = _at_2(__SPL280, 2);
    let _c = _at_2(__SPL280, 3);
    let __SPL281 = _assertIsOfSize_2(_toTrilinearCoordinates_2(_self, _p), 3);
    let _alpha = _at_2(__SPL281, 1);
    let _beta = _at_2(__SPL281, 2);
    let _gamma = _at_2(__SPL281, 3);
    /* Statements */
  ...
  "{ :self :p | let __SPL280 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL280, 1); let b = at(__SPL280, 2); let c = at(__SPL280, 3); let __SPL281 = assertIsOfSize(toTrilinearCoordinates(self,p), 3); let alpha = at(__SPL281, 1); let beta = at(__SPL281, 2); let gamma = at(__SPL281, 3); fromTrilinearVertexMatrix(self,[[*(-(0, (+(beta, (*(alpha, cos(c)))))), (+(gamma, (*(alpha, cos(b)))))), *((+(gamma, (*(alpha, cos(b))))), (+(alpha, (*(beta, cos(c)))))), *((+(beta, (*(alpha, cos(c))))), (+(alpha, (*(gamma, cos(b))))))], [*((+(gamma, (*(beta, cos(a))))), (+(beta, (*(alpha, cos(c)))))), *(-(0, (+(gamma, (*(beta, cos(a)))))), (+(alpha, (*(beta, cos(c)))))), *((+(alpha, (*(beta, cos(c))))), (+(beta, (*(gamma, cos(a))))))], [*((+(beta, (*(gamma, cos(a))))), (+(gamma, (*(alpha, cos(b)))))), *((+(alpha, (*(gamma, cos(b))))), (+(gamma, (*(beta, cos(a)))))), *(-(0, (+(alpha, (*(gamma, cos(b)))))), (+(beta, (*(gamma, cos(a))))))]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL282 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL282, 1);
    let _b = _at_2(__SPL282, 2);
    let _c = _at_2(__SPL282, 3);
    /* Statements */
    return [
  ...
  "{ :self | let __SPL282 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL282, 1); let b = at(__SPL282, 2); let c = at(__SPL282, 3); [fromTrilinearCoordinates(self,[/(c, b), /(a, c), /(b, a)]), fromTrilinearCoordinates(self,[/(b, c), /(c, a), /(a, b)]), triangleCentreL(self, { :a :b :c | ^(a, -3) })] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p) {
    ...
    let __SPL283 = _assertIsOfSize_2(_toTrilinearCoordinates_2(_self, _p), 3);
    let _alpha = _at_2(__SPL283, 1);
    let _beta = _at_2(__SPL283, 2);
    let _gamma = _at_2(__SPL283, 3);
    /* Statements */
  ...
  "{ :self :p | let __SPL283 = assertIsOfSize(toTrilinearCoordinates(self,p), 3); let alpha = at(__SPL283, 1); let beta = at(__SPL283, 2); let gamma = at(__SPL283, 3); fromTrilinearVertexMatrix(self,[[0, beta, gamma], [alpha, 0, gamma], [alpha, beta, 0]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL284 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SPL284, 1);
    let _b = _at_2(__SPL284, 2);
    let _c = _at_2(__SPL284, 3);
    let _x = _tan_1(_a);
    let _y = _tan_1(_b);
    let _z = _tan_1(_c);
    /* Statements */
  ...
  "{ :self | let __SPL284 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL284, 1); let b = at(__SPL284, 2); let c = at(__SPL284, 3); let x = tan(a); let y = tan(b); let z = tan(c); fromTrilinearVertexMatrix(self,[[+(+((*(2, x)), y), z), *(sin(a), sec(b)), *(sin(a), sec(c))], [*(sin(b), sec(a)), +(+(x, (*(2, y))), z), *(sin(b), sec(c))], [*(sin(c), sec(a)), *(sin(c), sec(b)), +(+(x, y), (*(2, z)))]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL285 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL285, 1);
    let _b = _at_2(__SPL285, 2);
    let _c = _at_2(__SPL285, 3);
    let _i = _plusSign_2(
      _plusSign_2(
        _plusSign_2(
          _plusSign_2(
  ...
  "{ :self | let __SPL285 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL285, 1); let b = at(__SPL285, 2); let c = at(__SPL285, 3); let i = +(+(+(+(+(+((*(square(a), b)), (*(a, square(b)))), (*(square(a), c))), (*(*(a, b), c))), (*(square(b), c))), (*(a, square(c)))), (*(b, square(c)))); let r = /(sqrt((/(i, (+(+(a, b), a))))), 2); Circle(spiekerCenter(self), r) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _f_1 = sl.annotateFunction(function (_x) {
      ...
      let __SPL286 = _assertIsOfSize_2(_x, 3);
      let _a = _at_2(__SPL286, 1);
      let _b = _at_2(__SPL286, 2);
      let _c = _at_2(__SPL286, 3);
      /* Statements */
      return _sqrt_1(
        _solidus_2(
          _asterisk_2(
  ...
  "{ :self | let s = semiperimeter(self); let l = sideLengths(self); let f = { :x | let __SPL286 = assertIsOfSize(x, 3); let a = at(__SPL286, 1); let b = at(__SPL286, 2); let c = at(__SPL286, 3); sqrt((/((*(*(s, (-(s, b))), (-(s, c)))), (-(s, a))))) }; collect([0, 2, 1], { :r | f(rotate(l,r)) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL287 = _assertIsOfSize_2(_cos_1(_interiorAngles_1(_self)), 3);
    let _x = _at_2(__SPL287, 1);
    let _y = _at_2(__SPL287, 2);
    let _z = _at_2(__SPL287, 3);
    /* Statements */
    return _fromTrilinearVertexMatrix_2(_self, [[
  ...
  "{ :self | let __SPL287 = assertIsOfSize(cos(interiorAngles(self)), 3); let x = at(__SPL287, 1); let y = at(__SPL287, 2); let z = at(__SPL287, 3); fromTrilinearVertexMatrix(self,[[-(0, (+(x, 1))), +(x, z), +(x, y)], [+(y, z), -(0, (+(y, 1))), +(y, x)], [+(z, y), +(z, x), -(0, (+(z, 1)))]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL288 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL288, 1);
    let _b = _at_2(__SPL288, 2);
    let _c = _at_2(__SPL288, 3);
    /* Statements */
  ...
  "{ :self | let __SPL288 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL288, 1); let b = at(__SPL288, 2); let c = at(__SPL288, 3); fromTrilinearCoordinates(self,[/(c, b), /(a, c), /(b, a)]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL289 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL289, 1);
    let _b = _at_2(__SPL289, 2);
    let _c = _at_2(__SPL289, 3);
    /* Statements */
    return _fromTrilinearVertexMatrix_2(_self, [
  ...
  "{ :self | let __SPL289 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL289, 1); let b = at(__SPL289, 2); let c = at(__SPL289, 3); fromTrilinearVertexMatrix(self,[[*(*(a, b), c), cube(c), cube(b)], [cube(c), *(*(a, b), c), cube(a)], [cube(b), cube(a), *(*(a, b), c)]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL290 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL290, 1);
    let _b = _at_2(__SPL290, 2);
    let _c = _at_2(__SPL290, 3);
  ...
  "{ :self | let __SPL290 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL290, 1); let b = at(__SPL290, 2); let c = at(__SPL290, 3); let s = *((+(+(a, b), c)), 0.5); sqrt((*(*(*(s, (-(s, a))), (-(s, b))), (-(s, c))))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL291 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL291, 1);
    let _b = _at_2(__SPL291, 2);
    let _c = _at_2(__SPL291, 3);
    let _s = _asterisk_2(_plusSign_2(_plusSign_2(_a, _b), _c), 0.5);
    /* Statements */
    return _sqrt_1(
      _solidus_2(
  ...
  "{ :self | let __SPL291 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL291, 1); let b = at(__SPL291, 2); let c = at(__SPL291, 3); let s = *((+(+(a, b), c)), 0.5); sqrt((/((*(*((-(s, a)), (-(s, b))), (-(s, c)))), s))) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _allSatisfy_2(
      ...
      sl.annotateFunction(function (_x) {
        ...
        return _lessThanSign_2(_x, _pi_1(_Fraction_2(1n, 2n)));
      }, ["x"]),
    );
  }, ["self"]),
  "{ :self | allSatisfy(interiorAngles(self), { :x | <(x, pi(Fraction(1L, 2L))) }) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _anySatisfy_2(
      ...
      sl.annotateFunction(function (_x) {
        ...
        return _greaterThanSign_2(_x, _pi_1(_Fraction_2(1n, 2n)));
      }, ["x"]),
    );
  }, ["self"]),
  "{ :self | anySatisfy(interiorAngles(self), { :x | >(x, pi(Fraction(1L, 2L))) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL292 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL292, 1);
    let _b = _at_2(__SPL292, 2);
    let _c = _at_2(__SPL292, 3);
    /* Statements */
    return _collect_2(
      [[
        _asterisk_2(
  ...
  "{ :self | let __SPL292 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL292, 1); let b = at(__SPL292, 2); let c = at(__SPL292, 3); collect([[*(*(-1, (+(-(a, b), c))), b), *((+(+(-(0, a), b), c)), a), 0], [0, *(*(-1, (-(+(a, b), c))), c), *((+(-(a, b), c)), b)], [*((-(+(a, b), c)), c), 0, *(*(-1, a), (+(+(-(0, a), b), c)))]], { :each | fromTrilinearCoordinates(self,each) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL293 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SPL293, 1);
    let _b = _at_2(__SPL293, 2);
    let _c = _at_2(__SPL293, 3);
    /* Statements */
  ...
  "{ :self | let __SPL293 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL293, 1); let b = at(__SPL293, 2); let c = at(__SPL293, 3); fromTrilinearVertexMatrix(self,[[0, sec(b), sec(c)], [sec(a), 0, sec(c)], [sec(a), sec(b), 0]]) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let a = area(self); let r1 = inradius(self); let r2 = circumradius(self); let s = semiperimeter(self); let r = /(a, (-(+((*(4, r2)), r1), (*(2, s))))); let c = if((>(r, 0)), { equalDetourPoint(self) }, { isoperimetricPoint(self) }); postLine([c, r]); Circle(c, abs(r)) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p) {
    ...
    let __SPL294 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SPL294, 1);
    let _b = _at_2(__SPL294, 2);
    let _c = _at_2(__SPL294, 3);
    let __SPL295 = _assertIsOfSize_2(_toTrilinearCoordinates_2(_self, _p), 3);
    let _alpha = _at_2(__SPL295, 1);
    let _beta = _at_2(__SPL295, 2);
    let _gamma = _at_2(__SPL295, 3);
    /* Statements */
    return _fromTrilinearVertexMatrix_2(_self, [[
      0,
      _plusSign_2(_beta, _asterisk_2(_alpha, _cos_1(_c))),
  ...
  "{ :self :p | let __SPL294 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL294, 1); let b = at(__SPL294, 2); let c = at(__SPL294, 3); let __SPL295 = assertIsOfSize(toTrilinearCoordinates(self,p), 3); let alpha = at(__SPL295, 1); let beta = at(__SPL295, 2); let gamma = at(__SPL295, 3); fromTrilinearVertexMatrix(self,[[0, +(beta, (*(alpha, cos(c)))), +(gamma, (*(alpha, cos(b))))], [+(alpha, (*(beta, cos(c)))), 0, +(gamma, (*(beta, cos(a))))], [+(alpha, (*(gamma, cos(b)))), +(beta, (*(gamma, cos(a)))), 0]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL296 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL296, 1);
    let _b = _at_2(__SPL296, 2);
    let _c = _at_2(__SPL296, 3);
    let __SPL297 = _assertIsOfSize_2(_medialTriangle_1([_a, _b, _c]), 3);
    let _p = _at_2(__SPL297, 1);
    let _q = _at_2(__SPL297, 2);
    let _r = _at_2(__SPL297, 3);
    /* Statements */
  ...
  "{ :self | let __SPL296 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL296, 1); let b = at(__SPL296, 2); let c = at(__SPL296, 3); let __SPL297 = assertIsOfSize(medialTriangle([a, b, c]), 3); let p = at(__SPL297, 1); let q = at(__SPL297, 2); let r = at(__SPL297, 3); Circle([p, q, r], [norm((-(p, a))), norm((-(q, b))), norm((-(r, c)))]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL298 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL298, 1);
    let _b = _at_2(__SPL298, 2);
    let _c = _at_2(__SPL298, 3);
    /* Statements */
    return _fromTrilinearCoordinates_2(_self, [
      _solidus_2(_b, _c),
      _solidus_2(_c, _a),
  ...
  "{ :self | let __SPL298 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL298, 1); let b = at(__SPL298, 2); let c = at(__SPL298, 3); fromTrilinearCoordinates(self,[/(b, c), /(c, a), /(a, b)]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL299 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL299, 1);
    let _b = _at_2(__SPL299, 2);
    let _c = _at_2(__SPL299, 3);
    let __SPL300 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _alpha = _at_2(__SPL300, 1);
    let _beta = _at_2(__SPL300, 2);
    let _gamma = _at_2(__SPL300, 3);
    /* Statements */
    return _fromTrilinearVertexMatrix_2(_self, [[
  ...
  "{ :self | let __SPL299 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL299, 1); let b = at(__SPL299, 2); let c = at(__SPL299, 3); let __SPL300 = assertIsOfSize(interiorAngles(self), 3); let alpha = at(__SPL300, 1); let beta = at(__SPL300, 2); let gamma = at(__SPL300, 3); fromTrilinearVertexMatrix(self,[[*(*(*(2, b), c), cos(alpha)), *(a, b), *(a, c)], [*(a, b), *(*(*(2, a), c), cos(beta)), *(b, c)], [*(a, c), *(b, c), *(*(*(2, a), b), cos(gamma))]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL301 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL301, 1);
    let _b = _at_2(__SPL301, 2);
    let _c = _at_2(__SPL301, 3);
    /* Statements */
    return [
  ...
  "{ :self | let __SPL301 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL301, 1); let b = at(__SPL301, 2); let c = at(__SPL301, 3); [euclideanDistance(b,c), euclideanDistance(c,a), euclideanDistance(a,b)] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL302 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL302, 1);
    let _b = _at_2(__SPL302, 2);
    let _c = _at_2(__SPL302, 3);
    /* Statements */
    return _asterisk_2(
  ...
  "{ :self | let __SPL302 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL302, 1); let b = at(__SPL302, 2); let c = at(__SPL302, 3); *(cross((-(b, a)),-(c, b)), 0.5) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL303 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _p1 = _at_2(__SPL303, 1);
    let _p2 = _at_2(__SPL303, 2);
    let _p3 = _at_2(__SPL303, 3);
    let _u = _hyphenMinus_2(_p2, _p1);
    let _v = _hyphenMinus_2(_p3, _p1);
    /* Statements */
    return _cross_2(_u, _v);
  }, ["self"]),
  "{ :self | let __SPL303 = assertIsOfSize(vertexCoordinates(self), 3); let p1 = at(__SPL303, 1); let p2 = at(__SPL303, 2); let p3 = at(__SPL303, 3); let u = -(p2, p1); let v = -(p3, p1); cross(u,v) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL304 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL304, 1);
    let _b = _at_2(__SPL304, 2);
    let _c = _at_2(__SPL304, 3);
    /* Statements */
  ...
  "{ :self | let __SPL304 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL304, 1); let b = at(__SPL304, 2); let c = at(__SPL304, 3); fromTrilinearVertexMatrix(self,[[0, b, c], [a, 0, c], [a, b, 0]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL305 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SPL305, 1);
    let _b = _at_2(__SPL305, 2);
    let _c = _at_2(__SPL305, 3);
    let __SPL306 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _p = _at_2(__SPL306, 1);
    let _q = _at_2(__SPL306, 2);
    let _r = _at_2(__SPL306, 3);
    /* Statements */
    return [
      _Circle_2(
        _p,
  ...
  "{ :self | let __SPL305 = assertIsOfSize(sideLengths(self), 3); let a = at(__SPL305, 1); let b = at(__SPL305, 2); let c = at(__SPL305, 3); let __SPL306 = assertIsOfSize(vertexCoordinates(self), 3); let p = at(__SPL306, 1); let q = at(__SPL306, 2); let r = at(__SPL306, 3); [Circle(p, /((+(+(-(0, a), b), c)), 2)), Circle(q, /((+(-(a, b), c)), 2)), Circle(r, /((-(+(a, b), c)), 2))] }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL307 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SPL307, 1);
    let _b = _at_2(__SPL307, 2);
    let _c = _at_2(__SPL307, 3);
    /* Statements */
    return _fromTrilinearVertexMatrix_2(_self, [
  ...
  "{ :self | let __SPL307 = assertIsOfSize(interiorAngles(self), 3); let a = at(__SPL307, 1); let b = at(__SPL307, 2); let c = at(__SPL307, 3); fromTrilinearVertexMatrix(self,[[-(0, a), b, c], [a, -(0, b), c], [a, b, -(0, c)]]) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL308 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL308, 1);
    let _b = _at_2(__SPL308, 2);
    let _c = _at_2(__SPL308, 3);
    /* Statements */
    return _toBarycentricCoordinates_3(_a, _b, _c);
  }, ["self"]),
  "{ :self | let __SPL308 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL308, 1); let b = at(__SPL308, 2); let c = at(__SPL308, 3); toBarycentricCoordinates(a, b, c) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL309 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SPL309, 1);
    let _b = _at_2(__SPL309, 2);
    let _c = _at_2(__SPL309, 3);
  ...
  "{ :self | let __SPL309 = assertIsOfSize(vertexCoordinates(self), 3); let a = at(__SPL309, 1); let b = at(__SPL309, 2); let c = at(__SPL309, 3); let v = sideLengths(self); let f:/1 = toBarycentricCoordinates(a, b, c); { :x | /(f(x), v) } }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p_1, _f_3) {
    ...
    let __SPL310 = _assertIsOfSize_2(_p_1(_self), 3);
    let _a = _at_2(__SPL310, 1);
    let _b = _at_2(__SPL310, 2);
    let _c = _at_2(__SPL310, 3);
  ...
  "{ :self :p:/1 :f:/3 | let __SPL310 = assertIsOfSize(p(self), 3); let a = at(__SPL310, 1); let b = at(__SPL310, 2); let c = at(__SPL310, 3); let alpha = f(a, b, c); let beta = f(b, c, a); let gamma = f(c, a, b); fromTrilinearCoordinates(self,[alpha, beta, gamma]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL311 = _assertIsOfSize_2(_self, 3);
    let __genSym318 = _at_2(__SPL311, 1);
    let _p = _at_2(__SPL311, 2);
    let __genSym319 = _at_2(__SPL311, 3);
    let _a = _planarAngle_1(_self);
    /* Statements */
    return _InfiniteLine_2(_p, _fromPolarCoordinates_1([1, _solidus_2(_a, 2)]));
  }, ["self"]),
  "{ :self | let __SPL311 = assertIsOfSize(self, 3); let _ = at(__SPL311, 1); let p = at(__SPL311, 2); let _ = at(__SPL311, 3); let a = planarAngle(self); InfiniteLine(p, fromPolarCoordinates([1, /(a, 2)])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL312 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SPL312, 1);
    let _b = _at_2(__SPL312, 2);
    let _c = _at_2(__SPL312, 3);
    let __SPL313 = _assertIsOfSize_2(_a, 2);
    let _ax = _at_2(__SPL313, 1);
    let _ay = _at_2(__SPL313, 2);
    let __SPL314 = _assertIsOfSize_2(_b, 2);
    let _bx = _at_2(__SPL314, 1);
    let _by = _at_2(__SPL314, 2);
    let __SPL315 = _assertIsOfSize_2(_c, 2);
    let _cx = _at_2(__SPL315, 1);
    let _cy = _at_2(__SPL315, 2);
  ...
  "{ :self | let __SPL312 = assertIsOfSize(self, 3); let a = at(__SPL312, 1); let b = at(__SPL312, 2); let c = at(__SPL312, 3); let __SPL313 = assertIsOfSize(a, 2); let ax = at(__SPL313, 1); let ay = at(__SPL313, 2); let __SPL314 = assertIsOfSize(b, 2); let bx = at(__SPL314, 1); let by = at(__SPL314, 2); let __SPL315 = assertIsOfSize(c, 2); let cx = at(__SPL315, 1); let cy = at(__SPL315, 2); let ad = +((*(ax, ax)), (*(ay, ay))); let bd = +((*(bx, bx)), (*(by, by))); let cd = +((*(cx, cx)), (*(cy, cy))); let d = *(2, (+(+((*(ax, (-(by, cy)))), (*(bx, (-(cy, ay))))), (*(cx, (-(ay, by))))))); let center = [*(/(1, d), (+(+((*(ad, (-(by, cy)))), (*(bd, (-(cy, ay))))), (*(cd, (-(ay, by))))))), *(/(1, d), (+(+((*(ad, (-(cx, bx)))), (*(bd, (-(ax, cx))))), (*(cd, (-(bx, ax)))))))]; let radius = euclideanDistance(center,anyOne(self)); Circle(center, radius) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL316 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SPL316, 1);
    let _b = _at_2(__SPL316, 2);
    let _c = _at_2(__SPL316, 3);
    /* Statements */
    return [
      _midpoint_1([_b, _c]),
      _midpoint_1([_c, _a]),
  ...
  "{ :self | let __SPL316 = assertIsOfSize(self, 3); let a = at(__SPL316, 1); let b = at(__SPL316, 2); let c = at(__SPL316, 3); [midpoint([b, c]), midpoint([c, a]), midpoint([a, b])] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL317 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SPL317, 1);
    let _b = _at_2(__SPL317, 2);
    let _c = _at_2(__SPL317, 3);
    /* Statements */
    return _sssTriangle_3(_a, _b, _c);
  }, ["self"]),
  "{ :self | let __SPL317 = assertIsOfSize(self, 3); let a = at(__SPL317, 1); let b = at(__SPL317, 2); let c = at(__SPL317, 3); sssTriangle(a, b, c) }",
);
