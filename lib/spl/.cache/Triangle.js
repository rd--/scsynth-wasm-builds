...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _f_1 = sl.annotateFunction(function (_x) {
      ...
      return _csc_1(_asterisk_2(_solidus_2(1, 3), _x));
    }, ["x"]);
    let _m = [[
      _f_1(_hyphenMinus_2(_c, _b)),
      _f_1(_plusSign_2(_b, _asterisk_2(2, _c))),
      _hyphenMinus_2(0, _f_1(_plusSign_2(_c, _asterisk_2(2, _b)))),
    ], [
      _hyphenMinus_2(0, _f_1(_plusSign_2(_a, _asterisk_2(2, _c)))),
      _f_1(_hyphenMinus_2(_a, _c)),
      _f_1(_plusSign_2(_c, _asterisk_2(2, _a))),
    ], [
      _f_1(_plusSign_2(_a, _asterisk_2(2, _b))),
      _hyphenMinus_2(0, _f_1(_plusSign_2(_b, _asterisk_2(2, _a)))),
      _f_1(_hyphenMinus_2(_b, _a)),
    ]];
    return _fromTrilinearVertexMatrix_2(_self, _m);
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar8 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar9 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _f_1 = sl.annotateFunction(function (_x) {
      ...
      let __SplVar10 = _assertIsOfSize_2(_x, 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar11 = _assertIsOfSize_2(_cos_1(_interiorAngles_1(_self)), 3);
    let _x = _at_2(__SplVar11, 1);
    let _y = _at_2(__SplVar11, 2);
    let _z = _at_2(__SplVar11, 3);
    return _fromTrilinearVertexMatrix_2(_self, [[
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar16 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SplVar16, 1);
    let _b = _at_2(__SplVar16, 2);
    let _c = _at_2(__SplVar16, 3);
    let _f_3 = sl.annotateFunction(function (_i, _j, _k) {
      /* ArityCheck */
      if (arguments.length !== 3) {
      ...
      return _plusSign_2(
        _plusSign_2(
          _asterisk_2(_i, _square_1(_a)),
          _asterisk_2(_j, _square_1(_b)),
        ),
        _asterisk_2(_k, _square_1(_c)),
      );
    }, ["i", "j", "k"]);
    return _fromTrilinearVertexMatrix_2(_self, [[
      0,
      _solidus_2(_asterisk_2(_a, _c), _f_3(-2, 1, -2)),
      _solidus_2(_asterisk_2(_a, _b), _f_3(-2, -2, 1)),
    ], [
      _solidus_2(_asterisk_2(_a, _c), _f_3(1, -2, -2)),
      0,
      _solidus_2(_asterisk_2(_a, _b), _f_3(-2, -2, 1)),
    ], [
      _solidus_2(_asterisk_2(_a, _c), _f_3(1, -2, -2)),
      _solidus_2(_asterisk_2(_a, _b), _f_3(-2, 1, -2)),
      0,
    ]]);
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar17 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar18 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SplVar18, 1);
    let _b = _at_2(__SplVar18, 2);
    let _c = _at_2(__SplVar18, 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p) {
    ...
    let __SplVar19 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _a = _at_2(__SplVar19, 1);
    let _b = _at_2(__SplVar19, 2);
    let _c = _at_2(__SplVar19, 3);
    let __SplVar20 = _assertIsOfSize_2(_toTrilinearCoordinates_2(_self, _p), 3);
    let _alpha = _at_2(__SplVar20, 1);
    let _beta = _at_2(__SplVar20, 2);
    let _gamma = _at_2(__SplVar20, 3);
    return _fromTrilinearVertexMatrix_2(_self, [[
      0,
      _plusSign_2(_beta, _asterisk_2(_alpha, _cos_1(_c))),
      _plusSign_2(_gamma, _asterisk_2(_alpha, _cos_1(_b))),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar21 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SplVar21, 1);
    let _b = _at_2(__SplVar21, 2);
    let _c = _at_2(__SplVar21, 3);
    let __SplVar22 = _assertIsOfSize_2(_medialTriangle_1([_a, _b, _c]), 3);
    let _p = _at_2(__SplVar22, 1);
    let _q = _at_2(__SplVar22, 2);
    let _r = _at_2(__SplVar22, 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar23 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SplVar23, 1);
    let _b = _at_2(__SplVar23, 2);
    let _c = _at_2(__SplVar23, 3);
    return _fromTrilinearCoordinates_2(_self, [
      _solidus_2(_b, _c),
      _solidus_2(_c, _a),
      _solidus_2(_a, _b),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar24 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SplVar24, 1);
    let _b = _at_2(__SplVar24, 2);
    let _c = _at_2(__SplVar24, 3);
    let __SplVar25 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
    let _alpha = _at_2(__SplVar25, 1);
    let _beta = _at_2(__SplVar25, 2);
    let _gamma = _at_2(__SplVar25, 3);
    return _fromTrilinearVertexMatrix_2(_self, [[
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar27 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar28 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _p1 = _at_2(__SplVar28, 1);
    let _p2 = _at_2(__SplVar28, 2);
    let _p3 = _at_2(__SplVar28, 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar29 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    let _a = _at_2(__SplVar29, 1);
    let _b = _at_2(__SplVar29, 2);
    let _c = _at_2(__SplVar29, 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar30 = _assertIsOfSize_2(_sideLengths_1(_self), 3);
    ...
    let _p = _at_2(__SplVar31, 1);
    let _q = _at_2(__SplVar31, 2);
    let _r = _at_2(__SplVar31, 3);
    return [
      _Circle_2(
        _p,
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar32 = _assertIsOfSize_2(_interiorAngles_1(_self), 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar33 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar34 = _assertIsOfSize_2(_vertexCoordinates_1(_self), 3);
    let _a = _at_2(__SplVar34, 1);
    let _b = _at_2(__SplVar34, 2);
    let _c = _at_2(__SplVar34, 3);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _p_1, _f_3) {
    ...
    let __SplVar35 = _assertIsOfSize_2(_p_1(_self), 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar36 = _assertIsOfSize_2(_self, 3);
    let __SplUnused43 = _at_2(__SplVar36, 1);
    let _p = _at_2(__SplVar36, 2);
    let __SplUnused44 = _at_2(__SplVar36, 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar37 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SplVar37, 1);
    let _b = _at_2(__SplVar37, 2);
    let _c = _at_2(__SplVar37, 3);
    let __SplVar38 = _assertIsOfSize_2(_a, 2);
    let _ax = _at_2(__SplVar38, 1);
    let _ay = _at_2(__SplVar38, 2);
    let __SplVar39 = _assertIsOfSize_2(_b, 2);
    let _bx = _at_2(__SplVar39, 1);
    let _by = _at_2(__SplVar39, 2);
    let __SplVar40 = _assertIsOfSize_2(_c, 2);
    let _cx = _at_2(__SplVar40, 1);
    let _cy = _at_2(__SplVar40, 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar41 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SplVar41, 1);
    let _b = _at_2(__SplVar41, 2);
    let _c = _at_2(__SplVar41, 3);
    return [
      _midpoint_1([_b, _c]),
      _midpoint_1([_c, _a]),
      _midpoint_1([_a, _b]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar42 = _assertIsOfSize_2(_self, 3);
    let _a = _at_2(__SplVar42, 1);
    let _b = _at_2(__SplVar42, 2);
    let _c = _at_2(__SplVar42, 3);
  ...
  sl.annotateFunction(function (_self) {
    ...
    _whileTrue_2(
      sl.annotateFunction(function () {
        ...
        return _greaterThanSign_2(_size_1(_next), 1);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        _next = _partitionCollect_4(
          ...
          sl.annotateFunction(function (_each) {
            ...
            return _percentSign_2(
              _plusSign_2(_at_2(_each, 2), _at_2(_each, 1)),
              2,
            );
          }, ["each"]),
        );
