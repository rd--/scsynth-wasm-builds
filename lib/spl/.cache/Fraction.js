          ...
          _whileTrue_2(function () {
            ...
            return _if_3(_greaterThanSign_2(_q2, _maxDenominator), function () {
              ...
              return /* List Assignment */ (function () {
                ...
                _p0 = _at_2(__genSym23, 1);
                _q0 = _at_2(__genSym23, 2);
                _p1 = _at_2(__genSym23, 3);
                _q1 = _at_2(__genSym23, 4);
                _n = _at_2(__genSym23, 5);
                _d = _at_2(__genSym23, 6);
              })();
            });
          });
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym24 = _assertIsOfSize_2(_self, 2),
      _numerator = _at_2(__genSym24, 1),
      _denominator = _at_2(__genSym24, 2);
    /* Statements */
    return _Fraction_2(_numerator, _denominator);
  },
