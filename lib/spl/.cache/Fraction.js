...
sl.addMethodToExistingType(
  ...
  "{ :self | asInteger(asLargeInteger(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | if(isInteger(self), { numerator(self) }, { error(self,'Fraction>>asLargeInteger: not integer') }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | asSmallInteger(asLargeInteger(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let i = integerPart(self); let f = -(self, i); if(isNegative(self), { let answer = continuedFraction((+(1, f))); atPut(answer, 1, -(+(at(answer, 1), i), 1)); answer }, { let answer = []; whileTrue({ !=(f, 0) }, { add(answer,i); f := /(1, f); i := integerPart(f); f := -(f, i) }); add(answer,i); answer }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :x | let a = []; whileTrue({ !=(x, 0) }, { let y = ceiling((/(1, x))); add(a,y); x := -(*(x, y), 1) }); a }",
);
...
sl.addMethodToExistingType(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _ampersand_2(
              _equalsSignEqualsSign_2(
                _numerator_1(_self),
                _numerator_1(_anObject),
              ),
              sl.annotateFunction(function () {
                /* ArityCheck */
                if (arguments.length !== 0) {
  ...
  "{ :self :anObject :aBlock:/2 | if(isNumber(anObject), { if(isFraction(anObject), { &(==(numerator(self), numerator(anObject)), { ==(denominator(self), denominator(anObject)) }) }, { adaptToFractionAndApply(anObject,self, aBlock:/2) }) }, { false }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | isPowerOfTwo(denominator(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aFraction) {
    ...
    let __SplVar2 = _assertIsOfSize_2(_asList_1(_aFraction), 2);
  ...
  "{ :self :aFraction | let __SplVar1 = assertIsOfSize(asList(self), 2); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); let __SplVar2 = assertIsOfSize(asList(aFraction), 2); let c = at(__SplVar2, 1); let d = at(__SplVar2, 2); =(-((*(b, c)), (*(a, d))), 1) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :maxDenominator | if((<(maxDenominator, 1)), { error(self,'limitDenominator: illegal maxDenominator') }, { if((<=(denominator(self), maxDenominator)), { self }, { let p0 = 0; let q0 = 1; let p1 = 1; let q1 = 0; let n = numerator(self); let d = denominator(self); let continue = true; let k = nil; let bound1 = nil; let bound2 = nil; whileTrue({ continue }, { let a = //(n, d); let q2 = +(q0, (*(a, q1))); if((>(q2, maxDenominator)), { continue := false }, { ({ let __SplVar3 = [p1, q1, +(p0, (*(a, p1))), q2, d, -(n, (*(a, d)))]; p0 := at(__SplVar3, 1); q0 := at(__SplVar3, 2); p1 := at(__SplVar3, 3); q1 := at(__SplVar3, 4); n := at(__SplVar3, 5); d := at(__SplVar3, 6) } . ()) }) }); k := //((-(maxDenominator, q0)), q1); bound1 := ReducedFraction(+(p0, (*(k, p1))), +(q0, (*(k, q1)))); bound2 := ReducedFraction(p1, q1); if((<=(abs((-(bound2, self))), abs((-(bound1, self))))), { bound2 }, { bound1 }) }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let a = continuedFraction(self); let a0 = removeFirst(a); let m = size(a); +(a0, (*(2, sum(asList(upOrDownTo(1L, m)), { :n | /((^(-1, (+(n, 1)))), (^(2, sum(take(a,n))))) })))) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _a = [];
    let __SplVar4 = _assertIsOfSize_2(_parts_1(_self), 2);
  ...
  "{ :self | let a = []; let __SplVar4 = assertIsOfSize(parts(self), 2); let x = at(__SplVar4, 1); let y = at(__SplVar4, 2); if((|(=(x, 0), { =(y, 0) })), { [] }, { whileTrue({ !=(x, 0) }, { let z = ceiling((/(y, x))); add(a,[1, z]); x := -(*(x, z), y); y := *(y, z) }); collect(a,Fraction:/1) }) }",
);
