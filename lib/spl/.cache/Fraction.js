...
sl.addMethod(
  ...
  function (_self, _aFraction) {
    ...
    let __genSym199 = _assertIsOfSize_2(_asTuple_1(_self), 2),
      _a = _at_2(__genSym199, 1),
      _b = _at_2(__genSym199, 2);
    let __genSym200 = _assertIsOfSize_2(_asTuple_1(_aFraction), 2),
      _c = _at_2(__genSym200, 1),
      _d = _at_2(__genSym200, 2);
    /* Statements */
    return _equalsSign_2(
          ...
          _whileTrue_2(function () {
            ...
            return _if_3(_greaterThanSign_2(_q2, _maxDenominator), function () {
              ...
              return /* List Assignment */ (function () {
                ...
                _p0 = _at_2(__genSym201, 1);
                _q0 = _at_2(__genSym201, 2);
                _p1 = _at_2(__genSym201, 3);
                _q1 = _at_2(__genSym201, 4);
                _n = _at_2(__genSym201, 5);
                _d = _at_2(__genSym201, 6);
              })();
            });
          });
