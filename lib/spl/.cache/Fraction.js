sl.addType(
  ...
  "Fraction",
  "Fraction",
  ["Object", "Storeable", "Equatable", "Comparable", "Magnitude", "Number"],
  ...
  sl.annotateFunction(function (_n) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _negate_1(_arithmeticDerivative_1(_negate_1(_n)));
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        let _f = _factorInteger_1(_n);
        let _a = _sum_1(_collect_2(
          _f,
          sl.annotateFunction(function (_x) {
            ...
            return _Fraction_2(_at_2(_x, 2), _at_2(_x, 1));
          }, ["x"]),
        ));
        return _asterisk_2(_a, _n);
      }, []),
    );
  }, ["n"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _places) {
    ...
    return _allButLast_1(
      _decimalExpansion_1(_Decimal_2(_self, _plusSign_2(_places, 1))),
    );
  }, ["self", "places"]),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        return _isEven_1(_numerator_1(_self));
      }, []),
    );
  }, ["self"]),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        return _isOdd_1(_numerator_1(_self));
      }, []),
    );
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _greaterThanSign_2(_decimalPeriod_1(_self), 0);
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _equalsSign_2(_decimalPeriod_1(_self), 0);
  }, ["self"]),
  "{ :self |\n\t\tself.decimalPeriod = 0\n\t}",
);
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let _k = _solidusSolidus_2(
              _hyphenMinus_2(_maxDenominator, _q0),
              _q1,
            );
            let _bound1 = _ReducedFraction_2(
              _plusSign_2(_p0, _asterisk_2(_k, _p1)),
              _plusSign_2(_q0, _asterisk_2(_k, _q1)),
            );
            let _bound2 = _ReducedFraction_2(_p1, _q1);
            return _if_3(
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _base) {
    ...
    return _log_2(_asFloat_1(_self), _base);
  }, ["self", "base"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_x, _b) {
    ...
    return _log_2(_asFloat_1(_abs_1(_x)), _b);
  }, ["x", "b"]),
  "{ :x :b |\n\t\tx.abs.asFloat.log(b)\n\t}",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _normal_1(_sum_1(_continuedFraction_1(_self)));
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      _equalsSign_2(_self, _Fraction_2(1n, 1n)),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
      ...
      sl.annotateFunction(function () {
        ...
        let _c = _continuedFraction_1(_self);
        let _n = _size_1(_c);
        _atPut_3(_c, _n, _hyphenMinus_2(_at_2(_c, _n), 1));
        return _fromContinuedFraction_1(_c);
      }, []),
    );
  }, ["self"]),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _nestWhileList_3(
      ...
      sl.annotateFunction(function (_x) {
        ...
        return _exclamationMarkEqualsSign_2(_x, _Fraction_2(1n, 1n));
      }, ["x"]),
    );
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _scale) {
    ...
    return _asFractionOver_2(_self, _circumflexAccent_2(10n, _scale));
  }, ["self", "scale"]),
  ...
  sl.annotateFunction(function (_self, _denominator) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _ReducedFraction_2(_asLargeInteger_1(_self), 1n);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_x, _n) {
    ...
    let _p = _Fraction_2(_floor_1(_x), 1);
    let _q = _plusSign_2(_p, 1);
    let _a = [_p, _q];
    _timesRepeat_2(
      _hyphenMinus_2(_n, 2),
      sl.annotateFunction(function () {
        ...
        let _p = _detectLast_2(
          ...
          sl.annotateFunction(function (_y) {
            ...
            return _lessThanSign_2(_y, _x);
          }, ["y"]),
        );
        let _q = _detectLast_2(
          _a,
          sl.annotateFunction(function (_y) {
            /* ArityCheck */
            if (arguments.length !== 1) {
            ...
            return _greaterThanSign_2(_y, _x);
          }, ["y"]),
        );
        return _add_2(_a, _mediant_2(_p, _q));
      }, []),
    );
    return _a;
  }, ["x", "n"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_x, _n) {
    ...
    let _d9 = 1;
    let _f = 0;
    let _fp = _fractionalPart_1(_x);
    let _a = [
      _Fraction_2(
        _if_3(
          _greaterThanSign_2(_asterisk_2(2, _fp), 1),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
    ...
    _whileTrue_2(
      sl.annotateFunction(function () {
        ...
        return _lessThanSign_2(_plusSign_2(_d1, _d9), _n);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        let _a1 = _Fraction_2(_n1, _d1);
        let _a9 = _Fraction_2(_n9, _d9);
        let _n0 = _plusSign_2(_n1, _n9);
        let _d0 = _plusSign_2(_d1, _d9);
        let _a0 = _Fraction_2(_n0, _d0);
        _if_3(
          _lessThanSign_2(_a0, _fp),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
        ...
        return _ifTrue_2(
          _greaterThanSign_2(
            _abs_1(_hyphenMinus_2(_fp, _f)),
            _abs_1(_hyphenMinus_2(_fp, _a0)),
          ),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
            ...
            _f = _a0;
            return _add_2(_a, _plusSign_2(_a0, _integerPart_1(_x)));
          }, []),
        );
      }, []),
    );
