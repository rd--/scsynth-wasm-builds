...
sl.addMethod(
  ...
  function (_self, _aFraction) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aFraction"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aNumber, _epsilon) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aNumber, _epsilon"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _maxDenominator) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _maxDenominator"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
          ...
          _whileTrue_2(function () {
            ...
            return _if_3(_greaterThanSign_2(_q2, _maxDenominator), function () {
              ...
              return /* List Assignment */ (function () {
                ...
                _p0 = _at_2(__genSym101, 1);
                _q0 = _at_2(__genSym101, 2);
                _p1 = _at_2(__genSym101, 3);
                _q1 = _at_2(__genSym101, 4);
                _n = _at_2(__genSym101, 5);
                _d = _at_2(__genSym101, 6);
              })();
            });
          });
...
sl.addMethod(
  ...
  function (_self, _aFraction, _m, _n) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _aFraction, _m, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aFraction, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aFraction, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_numerator, _denominator) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _numerator, _denominator"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _denominator) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _denominator"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(_isInteger_1(_self), function () {
...
sl.addMethod(
  ...
  function (_self, _separator) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _separator"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
