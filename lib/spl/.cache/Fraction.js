...
sl.addMethodToExistingType(
  ...
  "{ :self :aNumber | if(isScalarInteger(aNumber), { ReducedFraction(-(numerator(self), (*(denominator(self), asLargeInteger(aNumber)))), denominator(self)) }, { if(isFraction(aNumber), { +(self, negated(aNumber)) }, { adaptToFractionAndApply(aNumber,self, -) }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aNumber | if(isScalarInteger(aNumber), { raisedToInteger(self,asInteger(aNumber)) }, { if(isFraction(aNumber), { raisedToFraction(self,aNumber) }, { adaptToFractionAndApply(aNumber,self, ^) }) }) }",
);
