          ...
          _whileTrue_2(function () {
            ...
            return _if_3(_greaterThanSign_2(_q2, _maxDenominator), function () {
              ...
              return /* List Assignment */ (function () {
                ...
                _p0 = _at_2(__genSym28, 1);
                _q0 = _at_2(__genSym28, 2);
                _p1 = _at_2(__genSym28, 3);
                _q1 = _at_2(__genSym28, 4);
                _n = _at_2(__genSym28, 5);
                _d = _at_2(__genSym28, 6);
              })();
            });
          });
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym29 = _assertIsOfSize_2(_self, 2),
      _numerator = _at_2(__genSym29, 1),
      _denominator = _at_2(__genSym29, 2);
    /* Statements */
    return _Fraction_2(_numerator, _denominator);
  },
...
sl.addMethod(
  ...
  function (_self, _epsilon) {
    ...
    /* Temporaries */
    let _c = _continuedFraction_2(_self, 16);
