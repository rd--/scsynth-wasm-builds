  ...
  function (_self, _aNumber) {
    ...
    return _if_3(_isInteger_1(_aNumber), function () {
      ...
      return _if_3(_isFraction_1(_aNumber), function () {
        ...
        return _circumflexAccent_2(_asFloat_1(_self), _asFloat_1(_aNumber));
      }, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _aFraction) {
    ...
    let __genSym156 = _assertIsOfSize_2(_asTuple_1(_self), 2),
      _a = _at_2(__genSym156, 1),
      _b = _at_2(__genSym156, 2);
    let __genSym157 = _assertIsOfSize_2(_asTuple_1(_aFraction), 2),
      _c = _at_2(__genSym157, 1),
      _d = _at_2(__genSym157, 2);
    /* Statements */
    return _equalsSign_2(
          ...
          _whileTrue_2(function () {
            ...
            return _if_3(_greaterThanSign_2(_q2, _maxDenominator), function () {
              ...
              return /* List Assignment */ (function () {
                ...
                _p0 = _at_2(__genSym158, 1);
                _q0 = _at_2(__genSym158, 2);
                _p1 = _at_2(__genSym158, 3);
                _q1 = _at_2(__genSym158, 4);
                _n = _at_2(__genSym158, 5);
                _d = _at_2(__genSym158, 6);
              })();
            });
          });
