...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_mu, _sigma, _rho) {
    ...
    let __SPL311 = _assertIsOfSize_2(_sigma, 2);
    let _i = _at_2(__SPL311, 1);
    let _j = _at_2(__SPL311, 2);
    /* Statements */
  ...
  "{ :mu :sigma :rho | let __SPL311 = assertIsOfSize(sigma, 2); let i = at(__SPL311, 1); let j = at(__SPL311, 2); MultinormalDistribution(mu, [[*(i, i), *(*(rho, i), j)], [*(*(rho, i), j), *(j, j)]]) }",
);
