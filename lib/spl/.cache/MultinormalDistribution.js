...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_mu, _sigma, _rho) {
    ...
    let __SPL537 = _assertIsOfSize_2(_sigma, 2);
    let _i = _at_2(__SPL537, 1);
    let _j = _at_2(__SPL537, 2);
    /* Statements */
  ...
  "{ :mu :sigma :rho | let __SPL537 = assertIsOfSize(sigma, 2); let i = at(__SPL537, 1); let j = at(__SPL537, 2); MultinormalDistribution(mu, [[*(i, i), *(*(rho, i), j)], [*(*(rho, i), j), *(j, j)]]) }",
);
