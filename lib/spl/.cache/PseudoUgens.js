...
sl.extendTraitWithMethod(
  ...
  function (_numChan) {
    ...
    if (arguments.length !== 1) {
      const errorMessage = "Arity: expected 1, _numChan";
...
sl.addMethod(
  ...
  function (_freq, _width) {
    ...
    return _minus_2(
      _SawDpw_2(_freq, 0),
      _SawDpw_2(_freq, _Wrap_3(_plus_2(_width, _width), -1, 1)),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _inMin, _inMax, _outMin, _outMax, _curve) {
    ...
    let _a = _dividedBy_2(_minus_2(_outMax, _outMin), _minus_2(1, _grow));
    let _b = _plus_2(_outMin, _a);
    let _scaled = _dividedBy_2(
      _minus_2(_Clip_3(_self, _inMin, _inMax), _inMin),
      _minus_2(_inMax, _inMin),
    );
    let _curvedResult = _minus_2(_b, _times_2(_a, _raisedTo_2(_grow, _scaled)));
    /* Statements */
    return _if_3(_isNumber_1(_curve), function () {
      ...
      /* Statements */
      return _Select2_3(
        _greaterThanEquals_2(_Abs_1(_curve), 0.125),
        _curvedResult,
...
sl.addMethod(
  ...
  "HoldSequence",
  ["inArray", "dur"],
  function (_inArray, _dur) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _inArray, _dur";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Temporaries */
    ...
    let _index = _Stepper_6(_trig, 1, 0, _minus_2(_size_1(_inArray), 1), 1, 0);
    /* Statements */
    return _Latch_2(_Multiplexer_2(_index, _inArray), _trig);
  },
...
sl.addMethod(
  ...
  function (_inArray, _dur) {
    ...
    /* Statements */
    return _Trig1_2(_HoldSequence_2(_inArray, _dur), _SampleDur_0());
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _lessThanBang_2(_self, _ClearBuf_1(_self));
  },
  "{ :self |\n\t\tself <! ClearBuf(self)\n\t}",
);
...
sl.addMethod(
  ...
  "PseudoUgens",
  "Distances",
  ["x", "y", "z", "coordinateArray"],
  function (_x, _y, _z, _coordinateArray) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage = "Arity: expected 4, _x, _y, _z, _coordinateArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _WDistances_5(1, _x, _y, _z, _coordinateArray);
  },
...
sl.addMethod(
  ...
  "PseudoUgens",
  "KNearest",
  ["numChannels", "x", "y", "z", "coordinateArray"],
  function (_numChannels, _x, _y, _z, _coordinateArray) {
    /* ArityCheck */
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _numChannels, _x, _y, _z, _coordinateArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _WkNearest_6(_numChannels, 1, _x, _y, _z, _coordinateArray);
  },
        ...
        return _times_2(
          _Max_2(
            _minus_2(
              1,
              _times_2(
                _ModDif_3(_which, _minus_2(_index, 1), _size_1(_array)),
                _focus,
              ),
            ),
            0,
      ...
      return _withIndexCollect_2(_array, function (_input, _index) {
        ...
        return _times_2(
          _Max_2(
            _minus_2(
              1,
              _times_2(_AbsDif_2(_which, _minus_2(_index, 1)), _focus),
            ),
            0,
          ),
          _input,
...
sl.addMethod(
  ...
  function (_tr, _buf) {
    ...
    return _BufRd_5(
      1,
      _buf,
      _TiRand_3(0, _minus_2(_BufFrames_1(_buf), 1), _tr),
      0,
      1,
    );
  },
...
sl.addMethod(
  ...
  "Choose",
  ["tr", "inArray"],
  function (_tr, _inArray) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _tr, _inArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _if_3(
      _equals_2(_elementType_1(_inArray), "SmallFloat"),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        /* Statements */
        return _TBufChoose_2(_tr, _asLocalBuf_1(_inArray));
      },
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        /* Statements */
        return _if_3(_isMatrixOf_2(_inArray, "SmallFloat"), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          /* Statements */
          return _TBufChoose_2(_tr, _asLocalBufferArray_1(_inArray));
        }, function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          return _TChoose_2(_tr, _inArray);
        });
      },
    );
  },
...
sl.addMethod(
  ...
  "AudioOut",
  ["channelsArray"],
  function (_channelsArray) {
    /* ArityCheck */
    if (arguments.length !== 1) {
      const errorMessage = "Arity: expected 1, _channelsArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _Out_2(0, _channelsArray);
  },
  "{ :channelsArray |\n\t\tOut(0, channelsArray)\n\t}",
);
...
sl.addMethod(
  ...
  function (_index) {
    ...
    /* Statements */
    return _ControlIn_2(1, _minus_2(_plus_2(11000, _index), 1));
  },
...
sl.addMethod(
  ...
  function (_breakPointArray, _curves) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _breakPointArray, _curves";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Temporaries */
    let _n = _size_1(_breakPointArray);
    /* Statements */
    return _Env_6(
      _collect_2(_thenTo_3(1, 3, _n), function (_index) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _index";
          console.error(errorMessage);
        ...
        /* Statements */
        return _at_2(_breakPointArray, _index);
      }),
      _differentiate_1(
        _collect_2(_thenTo_3(2, 4, _minus_2(_n, 1)), function (_index) {
          /* ArityCheck */
          if (arguments.length !== 1) {
            const errorMessage = "Arity: expected 1, _index";
            console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _trig) {
    ...
    /* Statements */
    return _times_2(_Sequencer_2(_self, _trig), _Trig_2(_trig, _SampleDur_0()));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _IRand_2(_minus_2(0, _self), _self);
  },
  "{ :self |\n\t\tIRand(0 - self, self)\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _srcLo, _srcHi, _dstLo, _dstHi) {
    ...
    /* Temporaries */
    let _mul = _dividedBy_2(_minus_2(_dstHi, _dstLo), _minus_2(_srcHi, _srcLo));
    let _add = _minus_2(_dstLo, _times_2(_mul, _srcLo));
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _Rand_2(_minus_2(0, _self), _self);
  },
  "{ :self |\n\t\tRand(0 - self, self)\n\t}",
);
...
sl.addMethod(
  ...
  "Sequencer",
  ["inArray", "trig"],
  function (_inArray, _trig) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _inArray, _trig";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _Multiplexer_2(
      _Stepper_6(_trig, 1, 0, _minus_2(_size_1(_inArray), 1), 1, 0),
      _inArray,
    );
  },
...
sl.addMethod(
  ...
  function (_numChannels) {
    ...
    /* Statements */
    return _if_3(_equalsEquals_2(_numChannels, 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _bang_2(_Dc_1(0), _numChannels);
    });
  },
  "{ :numChannels |\n\t\t(numChannels == 1).if {\n\t\t\tDc(0)\n\t\t} {\n\t\t\tDc(0) ! numChannels\n\t\t}\n\t}",
);
...
sl.addMethod(
  ...
  function (
    ...
    if (arguments.length !== 8) {
      const errorMessage =
        "Arity: expected 8, _numChannels, _inArray, _spread, _level, _width, _center, _orientation, _levelComp";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Temporaries */
    let _n = _max_2(1, _size_1(_inArray));
    let _pos = _if_3(_equals_2(_n, 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Temporaries */
      let _normalizedSpread = _times_2(
        _spread,
        _dividedBy_2(_minus_2(_n, 1), _n),
      );
      /* Statements */
      return _resamp1_2([
        _minus_2(_center, _normalizedSpread),
        _plus_2(_center, _normalizedSpread),
      ], _n);
    });
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aNumber) {
    ...
    /* Statements */
    return _raisedTo_2(_self, _aNumber);
  },
...
sl.addMethod(
  ...
  function (_channelsArray) {
    ...
    /* Primitive */
    return sc.AudioIn(_channelsArray);
  },
  "{ :channelsArray | <primitive: return sc.AudioIn(_channelsArray);> }",
);
...
sl.addMethod(
  ...
  function (_bufnum, _reset, _inputArray) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _bufnum, _reset, _inputArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.BufRec(_bufnum, _reset, _inputArray);
  },
  "{ :bufnum :reset :inputArray | <primitive: return sc.BufRec(_bufnum, _reset, _inputArray);> }",
);
...
sl.addMethod(
  ...
  function (_bufnum, _phase, _loop, _inputArray) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _bufnum, _phase, _loop, _inputArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.BufWrite(_bufnum, _phase, _loop, _inputArray);
  },
  "{ :bufnum :phase :loop :inputArray | <primitive: return sc.BufWrite(_bufnum, _phase, _loop, _inputArray);> }",
);
...
sl.addMethod(
  ...
  "ControlOut",
  ["bus", "channelsArray"],
  function (_bus, _channelsArray) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _bus, _channelsArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.ControlOut(_bus, _channelsArray);
  },
  "{ :bus :channelsArray | <primitive: return sc.ControlOut(_bus, _channelsArray);> }",
);
...
sl.addMethod(
  ...
  "LinSeg",
  ["gate", "coordArray"],
  function (_gate, _coordArray) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _gate, _coordArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.LinSeg(_gate, _coordArray);
  },
  "{ :gate :coordArray | <primitive: return sc.LinSeg(_gate, _coordArray);> }",
);
...
sl.addMethod(
  ...
  "PseudoUgens",
  "MultiTapDelay",
  ["timesArray", "levelsArray", "input"],
  function (_timesArray, _levelsArray, _input) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _timesArray, _levelsArray, _input";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.MultiTapDelay(_timesArray, _levelsArray, _input);
  },
  "{ :timesArray :levelsArray :input | <primitive: return sc.MultiTapDelay(_timesArray, _levelsArray, _input);> }",
);
...
sl.addMethod(
  ...
  "SfDur",
  ["sfBufferArray"],
  function (_sfBufferArray) {
    /* ArityCheck */
    if (arguments.length !== 1) {
      const errorMessage = "Arity: expected 1, _sfBufferArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.SfDur(_sfBufferArray);
  },
  "{ :sfBufferArray |<primitive: return sc.SfDur(_sfBufferArray);> }",
);
...
sl.addMethod(
  ...
  function (_sfBufferArray) {
    ...
    /* Primitive */
    return sc.SfFrames(_sfBufferArray);
  },
  "{ :sfBufferArray |<primitive: return sc.SfFrames(_sfBufferArray);> }",
);
...
sl.addMethod(
  ...
  "PseudoUgens",
  "SfPlay",
  ["sfBufferArray", "rate", "trigger", "startPos", "loop"],
  function (_sfBufferArray, _rate, _trigger, _startPos, _loop) {
    /* ArityCheck */
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _sfBufferArray, _rate, _trigger, _startPos, _loop";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.SfPlay(_sfBufferArray, _rate, _trigger, _startPos, _loop);
  },
  "{ :sfBufferArray :rate :trigger :startPos :loop |<primitive: return sc.SfPlay(_sfBufferArray, _rate, _trigger, _startPos, _loop);> }",
);
...
sl.addMethod(
  ...
  function (_sfBufferArray) {
    ...
    /* Primitive */
    return sc.SfRateScale(_sfBufferArray);
  },
  "{ :sfBufferArray |<primitive: return sc.SfRateScale(_sfBufferArray);> }",
);
...
sl.addMethod(
  ...
  "PseudoUgens",
  "SfRead",
  ["sfBufferArray", "phase", "loop", "interpolation"],
  function (_sfBufferArray, _phase, _loop, _interpolation) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _sfBufferArray, _phase, _loop, _interpolation";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.SfRead(_sfBufferArray, _phase, _loop, _interpolation);
  },
  "{ :sfBufferArray :phase :loop :interpolation |<primitive: return sc.SfRead(_sfBufferArray, _phase, _loop, _interpolation);> }",
);
...
sl.addMethod(
  ...
  function (_sfBufferArray) {
    ...
    /* Primitive */
    return sc.SfSampleRate(_sfBufferArray);
  },
  "{ :sfBufferArray |<primitive: return sc.SfSampleRate(_sfBufferArray);> }",
);
...
sl.addMethod(
  ...
  function (_inArray, _spread, _level, _center, _levelComp) {
    /* ArityCheck */
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _inArray, _spread, _level, _center, _levelComp";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.Splay(_inArray, _spread, _level, _center, _levelComp);
  },
  "{ :inArray :spread :level :center :levelComp | <primitive: return sc.Splay(_inArray, _spread, _level, _center, _levelComp);> }",
);
...
sl.addMethod(
  ...
  function (_inArray) {
    /* ArityCheck */
    if (arguments.length !== 1) {
      const errorMessage = "Arity: expected 1, _inArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Primitive */
    return sc.Splay2(_inArray);
  },
  "{ :inArray | <primitive: return sc.Splay2(_inArray);> }",
);
