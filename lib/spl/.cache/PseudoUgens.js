...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :breakPointList :curves | let n = size(breakPointList); let m = -(n, 1); Env(collect(thenTo(1, 3, n), { :index | at(breakPointList, index) }), differentiate(collect(thenTo(2, 4, m), { :index | at(breakPointList, index) })), curves, nil, nil, 0) }",
);
