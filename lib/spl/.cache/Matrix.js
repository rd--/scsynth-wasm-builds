...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | &(isMatrix(self), { let __SPL1 = assertIsOfSize(shape(self), 2); let m = at(__SPL1, 1); let n = at(__SPL1, 2); =(m, n) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL2 = _assertIsOfSize_2(_dimensions_2(_self, 2), 2);
    let _m = _at_2(__SPL2, 1);
    let __genSym23 = _at_2(__SPL2, 2);
    /* Statements */
    return _m;
  }, ["self"]),
  "{ :self | let __SPL2 = assertIsOfSize(dimensions(self,2), 2); let m = at(__SPL2, 1); let _ = at(__SPL2, 2); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL3 = _assertIsOfSize_2(_dimensions_2(_self, 2), 2);
    let __genSym24 = _at_2(__SPL3, 1);
    let _n = _at_2(__SPL3, 2);
    /* Statements */
    return _n;
  }, ["self"]),
  "{ :self | let __SPL3 = assertIsOfSize(dimensions(self,2), 2); let _ = at(__SPL3, 1); let n = at(__SPL3, 2); n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _z = _solidus_2(
      ...
      _asterisk_2(_squared_1(_factorial_1(_n)), _circumflexAccent_2(2, _n)),
    );
    /* Statements */
    return _sqrt_1(
  ...
  "{ :self | let n = -(size(self), 1); let z = /((^(-1, (+(n, 1)))), (*(squared(factorial(n)), (^(2, n))))); sqrt(abs((*(z, determinant(cayleyMengerMatrix(self)))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    let __SPL4 = _assertIsOfSize_2(_shape_1(_self), 2);
  ...
  "{ :self :anInteger | let __SPL4 = assertIsOfSize(shape(self), 2); let m = at(__SPL4, 1); let n = at(__SPL4, 2); if(betweenAnd(anInteger,1, n), { collect(upOrDownTo(1, m), { :i | at(at(self, i), anInteger) }) }, { error(self,'List>>column: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aList) {
    ...
    let __SPL5 = _assertIsOfSize_2(_shape_1(_self), 2);
  ...
  "{ :self :aList | let __SPL5 = assertIsOfSize(shape(self), 2); let m = at(__SPL5, 1); let n = at(__SPL5, 2); if(allSatisfy(aList, { :each | betweenAnd(each,1, n) }), { collect(upOrDownTo(1, m), { :i | collect(aList, { :j | at(at(self, i), j) }) }) }, { error(self,'List>>columns: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _allSatisfy_2(
          ...
          sl.annotateFunction(function (_index) {
            ...
            let __SPL6 = _assertIsOfSize_2(_index, 2);
  ...
  "{ :self :k | &((=(rank(self), 2)), { allSatisfy(deepIndices(self), { :index | let __SPL6 = assertIsOfSize(index, 2); let i = at(__SPL6, 1); let j = at(__SPL6, 2); |((=(+(i, k), j)), { isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let __SPL7 = assertIsOfSize(shape(self), 2); let m = at(__SPL7, 1); let n = at(__SPL7, 2); collect(Span(1, n, 1), { :i | aBlock(column(self,i)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :k | caseOf(k, [->(1, { transposed(collect(self,reversed:/1)) }), ->(2, { reversed(collect(self,reversed:/1)) }), ->(3, { collect(transposed(self),reversed:/1) })], { error(self,'List>>matrixRotate: k not 1,2,3') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :anInteger | let __SPL9 = assertIsOfSize(shape(self), 2); let m = at(__SPL9, 1); let n = at(__SPL9, 2); if(betweenAnd(anInteger,1, m), { at(self, anInteger) }, { error(self,'List>>row: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aList | let __SPL10 = assertIsOfSize(shape(self), 2); let m = at(__SPL10, 1); let n = at(__SPL10, 2); if(allSatisfy(aList, { :each | betweenAnd(each,1, m) }), { atAll(self,aList) }, { error(self,'List>>rows: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k, _shape) {
    ...
    let __SPL11 = _assertIsOfSize_2(_shape, 2);
    let _m = _at_2(__SPL11, 1);
    let _n = _at_2(__SPL11, 2);
  ...
  "{ :self :k :shape | let __SPL11 = assertIsOfSize(shape, 2); let m = at(__SPL11, 1); let n = at(__SPL11, 2); let r = abs(min(k,0)); let c = max(k,0); let answer = zeroMatrix([m, n]); toDo(1, size(self), { :each | atPut(at(answer, +(each, r)), +(each, c), at(self, each)) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r, _sigma) {
    ...
    let __SPL12 = _assertIsOfSize_2(_r, 2);
    let _r1 = _at_2(__SPL12, 1);
    let _r2 = _at_2(__SPL12, 2);
    let __SPL13 = _assertIsOfSize_2(_sigma, 2);
    let _sigma1 = _at_2(__SPL13, 1);
    let _sigma2 = _at_2(__SPL13, 2);
    let _p = _exp_1(
      _solidus_2(
        _asterisk_2(
          -0.5,
          _squared_1(_asList_1(_upOrDownTo_2(_hyphenMinus_1(_r1), _r1))),
        ),
        _squared_1(_sigma1),
      ),
    );
    let _q = _exp_1(
      _solidus_2(
        _asterisk_2(
          -0.5,
          _squared_1(_asList_1(_upOrDownTo_2(_hyphenMinus_1(_r2), _r2))),
        ),
        _squared_1(_sigma2),
      ),
    );
  ...
  "{ :r :sigma | let __SPL12 = assertIsOfSize(r, 2); let r1 = at(__SPL12, 1); let r2 = at(__SPL12, 2); let __SPL13 = assertIsOfSize(sigma, 2); let sigma1 = at(__SPL13, 1); let sigma2 = at(__SPL13, 2); let p = exp((/(*(-0.5, squared(asList(upOrDownTo(-(r1), r1)))), squared(sigma1)))); let q = exp((/(*(-0.5, squared(asList(upOrDownTo(-(r2), r2)))), squared(sigma2)))); let k = outerProduct(p,q); /(k, deepSum(k)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_shape) {
    ...
    let __SPL14 = _assertIsOfSize_2(_shape, 2);
    let _m = _at_2(__SPL14, 1);
    let _n = _at_2(__SPL14, 2);
    let _answer = _zeroMatrix_1([_m, _n]);
    /* Statements */
    _toDo_3(
      1,
  ...
  "{ :shape | let __SPL14 = assertIsOfSize(shape, 2); let m = at(__SPL14, 1); let n = at(__SPL14, 2); let answer = zeroMatrix([m, n]); toDo(1, min(n,m), { :each | atPut(at(answer, each), each, 1) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_shape) {
    ...
    let __SPL15 = _assertIsOfSize_2(_shape, 2);
  ...
  "{ :shape | let __SPL15 = assertIsOfSize(shape, 2); let m = at(__SPL15, 1); let n = at(__SPL15, 2); collect(upOrDownTo(1, m), { :unused | List(n, 0) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_shape) {
    ...
    let __SPL16 = _assertIsOfSize_2(_shape, 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r, _sigma) {
    ...
    let _k = _exp_1(
      _solidus_2(
        _asterisk_2(
          -0.5,
          _squared_1(_asList_1(_upOrDownTo_2(_hyphenMinus_1(_r), _r))),
        ),
        _squared_1(_sigma),
      ),
    );
  ...
  "{ :r :sigma | let k = exp((/(*(-0.5, squared(asList(upOrDownTo(-(r), r)))), squared(sigma)))); /(k, sum(k)) }",
);
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _symmetricSwap_2 = sl.annotateFunction(function (_m, _l) {
          ...
          let _j = [_take_2(_i, _k), _take_2(_reversed_1(_i), _k)];
          /* Statements */
          return _swapAllWith_2(_m, _transposed_1(_j));
        }, ["m", "l"]);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let __SPL17 = _assertIsOfSize_2([1, 0], 2);
    let _dx = _at_2(__SPL17, 1);
    let _dy = _at_2(__SPL17, 2);
    let __SPL18 = _assertIsOfSize_2([1, 1], 2);
    ...
    _toDo_3(
      ...
      sl.annotateFunction(function (_i) {
        ...
        let __SPL19 = _assertIsOfSize_2([
          _plusSign_2(_x, _dx),
          _plusSign_2(_y, _dy),
        ], 2);
        let _nx = _at_2(__SPL19, 1);
        let _ny = _at_2(__SPL19, 2);
        /* Statements */
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            sl.annotateFunction(function () {
              ...
              let __SPL21 = [_hyphenMinus_1(_dy), _dx];
              /* Statements */
              _dx = _at_2(__SPL21, 1);
              return _dy = _at_2(__SPL21, 2);
            }, [])();
            return (sl.annotateFunction(function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
              ...
              let __SPL22 = [_plusSign_2(_x, _dx), _plusSign_2(_y, _dy)];
              /* Statements */
              _x = _at_2(__SPL22, 1);
              return _y = _at_2(__SPL22, 2);
            }, [])());
          }, []),
        );
      }, ["i"]),
  ...
  "{ :n | let __SPL17 = assertIsOfSize([1, 0], 2); let dx = at(__SPL17, 1); let dy = at(__SPL17, 2); let __SPL18 = assertIsOfSize([1, 1], 2); let x = at(__SPL18, 1); let y = at(__SPL18, 2); let answer = !({ !(nil, n) }, n); toDo(1, ^(n, 2), { :i | let __SPL19 = assertIsOfSize([+(x, dx), +(y, dy)], 2); let nx = at(__SPL19, 1); let ny = at(__SPL19, 2); atPut(at(answer, x), y, i); if(&([{ <=(1, nx) }, { <=(nx, n) }, { <=(1, ny) }, { <=(ny, n) }, { =(at(at(answer, nx), ny), nil) }]), { ({ let __SPL20 = [nx, ny]; x := at(__SPL20, 1); y := at(__SPL20, 2) } . ()) }, { ({ let __SPL21 = [-(dy), dx]; dx := at(__SPL21, 1); dy := at(__SPL21, 2) } . ()); ({ let __SPL22 = [+(x, dx), +(y, dy)]; x := at(__SPL22, 1); y := at(__SPL22, 2) } . ()) }) }); answer }",
);
