...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    return _if_3(_isArray_1(_self), function () {
      ...
      /* Temporaries */
      let __genSym70 = _assertIsOfSize_2(_take_2(_shape_1(_self), 4), 4),
        _r = _at_2(__genSym70, 1),
        _c = _at_2(__genSym70, 2),
        _i = _at_2(__genSym70, 3),
        _j = _at_2(__genSym70, 4);
      ...
      _toDo_3(1, _r, function (_w) {
        ...
        return _toDo_3(1, _i, function (_x) {
          ...
          return _toDo_3(1, _c, function (_y) {
            ...
            if (arguments.length !== 1) {
              const errorMessage =
                "Arity: expected 1, _y"; /* console.error(errorMessage); */
              throw new Error(errorMessage);
            }
            /* Statements */
            return _toDo_3(1, _j, function (_z) {
              ...
              if (arguments.length !== 1) {
                const errorMessage =
                  "Arity: expected 1, _z"; /* console.error(errorMessage); */
                throw new Error(errorMessage);
              }
              /* Statements */
              _atPut_3(
...
sl.extendTraitWithMethod(
  ...
  function (_self, _zero) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _zero"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let __genSym71 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym71, 1),
      _n = _at_2(__genSym71, 2);
    let _answer = [];
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _context) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _context"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_a) {
    ...
    /* Temporaries */
    let __genSym72 = _assertIsOfSize_2(_shape_1(_a), 2),
      _m = _at_2(__genSym72, 1),
      _n = _at_2(__genSym72, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_a, _b, _x, _epsilon, _n) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _a, _b, _x, _epsilon, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    /* Temporaries */
    let __genSym73 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym73, 1),
      _n = _at_2(__genSym73, 2);
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_m, _d) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _m, _d"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _k = _size_1(_m);
...
sl.extendTraitWithMethod(
  ...
  function (_u, _v, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _u, _v, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_m, _epsilon, _n) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _m, _epsilon, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    _whileTrue_2(function () {
      ...
      /* Temporaries */
      let __genSym74 = _assertIsOfSize_2(_qrDecomposition_1(_x), 2),
        _q = _at_2(__genSym74, 1),
        _r = _at_2(__genSym74, 2);
      /* Statements */
      _x = _dot_2(_r, _q);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym75 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym75, 1),
      _n = _at_2(__genSym75, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_m, _v) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _m, _v"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    _withIndexDo_2(_a, function (_each, _i) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _each, _i"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    let __genSym76 = _assertIsOfSize_2(_shape_1(_a), 2),
      _n = _at_2(__genSym76, 1),
      _m = _at_2(__genSym76, 2);
    /* Statements */
  ...
  function (_self) {
    ...
    return _if_3(_isSquareMatrix_1(_self), function () {
      ...
      return _if_3(_equalsSign_2(_n, 2), function () {
        ...
        /* Temporaries */
        let __genSym77 = _assertIsOfSize_2(
            _concatenation_1(_contents_1(_self)),
            4,
          ),
          _a = _at_2(__genSym77, 1),
          _b = _at_2(__genSym77, 2),
          _c = _at_2(__genSym77, 3),
          _d = _at_2(__genSym77, 4);
        let _r = _solidus_2(
          1,
...
sl.extendTraitWithMethod(
  ...
  function (_self, _k) {
    ...
    return _ampersand_2(_isMatrix_1(_self), function () {
      ...
      /* Temporaries */
      let __genSym78 = _assertIsOfSize_2(_shape_1(_self), 2),
        _r = _at_2(__genSym78, 1),
        _c = _at_2(__genSym78, 2);
      /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym79 = _assertIsOfSize_2(_shape_1(_self), 2),
      _p = _at_2(__genSym79, 1),
      _q = _at_2(__genSym79, 2);
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym80 = _assertIsOfSize_2(_shape_1(_self), 2),
      _p = _at_2(__genSym80, 1),
      _q = _at_2(__genSym80, 2);
    /* Statements */
    return _if_3(_greaterThanSignEqualsSign_2(_p, _q), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.extendTraitWithMethod(
  ...
  function (_self, _k) {
    ...
    return _ampersand_2(_isMatrix_1(_self), function () {
      ...
      /* Temporaries */
      let __genSym81 = _assertIsOfSize_2(_shape_1(_self), 2),
        _r = _at_2(__genSym81, 1),
        _c = _at_2(__genSym81, 2);
      /* Statements */
      ...
      return _toDo_3(1, _n, function (_j) {
        ...
        return _toDo_3(1, _p, function (_k) {
          ...
          return _toDo_3(1, _q, function (_l) {
            ...
            if (arguments.length !== 1) {
              const errorMessage =
                "Arity: expected 1, _l"; /* console.error(errorMessage); */
              throw new Error(errorMessage);
            }
            /* Statements */
            return _atPut_3(
...
sl.extendTraitWithMethod(
  ...
  function (_self, _k) {
    ...
    let __genSym82 = _assertIsOfSize_2(_shape_1(_m), 2),
      _r = _at_2(__genSym82, 1),
      _c = _at_2(__genSym82, 2);
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Temporaries */
    let __genSym83 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym83, 1),
      _n = _at_2(__genSym83, 2);
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_a, _b) {
    ...
    /* Temporaries */
    let __genSym84 = _assertIsOfSize_2(_shape_1(_a), 2),
      _n = _at_2(__genSym84, 1),
      _p = _at_2(__genSym84, 2);
    let __genSym85 = _assertIsOfSize_2(_shape_1(_b), 2),
      _m = _at_2(__genSym85, 1),
      _q = _at_2(__genSym85, 2);
    let _l = _List_2(_n, 1);
    /* Statements */
    _assert_1(function () {
      /* ArityCheck */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _anInteger) {
    ...
    /* Temporaries */
    let __genSym86 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym86, 1),
      _n = _at_2(__genSym86, 2);
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _decimalPlaces) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _decimalPlaces"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let __genSym87 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym87, 1),
      _n = _at_2(__genSym87, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_m, _p) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _m, _p"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let __genSym88 = _assertIsOfSize_2(_shape_1(_m), 2),
...
sl.extendTraitWithMethod(
  ...
  function (_self, _i, _j) {
    ...
    /* Temporaries */
    let __genSym89 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym89, 1),
      _n = _at_2(__genSym89, 2);
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym90 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym90, 1),
      _n = _at_2(__genSym90, 2);
    /* Statements */
    return _table_3(
      function (_i, _j) {
        /* ArityCheck */
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym91 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym91, 1),
      _n = _at_2(__genSym91, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      /* Temporaries */
      let _lead = 1;
      let __genSym92 = _assertIsOfSize_2(_shape_1(_self), 2),
        _m = _at_2(__genSym92, 1),
        _n = _at_2(__genSym92, 2);
      let _d = null;
      /* Statements */
        ...
        _toDo_3(1, _m, function (_i) {
          ...
          return _ifTrue_2(_tildeEqualsSign_2(_i, _r), function () {
            ...
            return _toDo_3(1, _n, function (_c) {
              ...
              if (arguments.length !== 1) {
                const errorMessage =
                  "Arity: expected 1, _c"; /* console.error(errorMessage); */
                throw new Error(errorMessage);
              }
              /* Statements */
              return _atPut_3(
...
sl.extendTraitWithMethod(
  ...
  function (_self, _tolerance) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _tolerance"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _a = _self;
    let __genSym93 = _assertIsOfSize_2(_shape_1(_a), 2),
      _m = _at_2(__genSym93, 1),
      _n = _at_2(__genSym93, 2);
    ...
    _whileTrue_2(function () {
      ...
      /* List Assignment */ (function () {
        const __genSym94 = _qrDecomposition_1(_conjugateTranspose_1(_s));
        _q = _at_2(__genSym94, 1);
        _s = _at_2(__genSym94, 2);
      })();
      _u = _dot_2(_u, _q); /* List Assignment */
      (function () {
        const __genSym95 = _qrDecomposition_1(_conjugateTranspose_1(_s));
        _q = _at_2(__genSym95, 1);
        _s = _at_2(__genSym95, 2);
      })();
      _v = _dot_2(_v, _q);
...
sl.extendTraitWithMethod(
  ...
  function (_a) {
    ...
    /* Temporaries */
    let _tol = 1e-4;
    let __genSym96 = _assertIsOfSize_2(_shape_1(_a), 2),
      _n = _at_2(__genSym96, 1),
      _m = _at_2(__genSym96, 2);
...
sl.extendTraitWithMethod(
  ...
  function (_self, _r, _c) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _r, _c"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _table_3(
...
sl.extendTraitWithMethod(
  ...
  function (_c, _r) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _c, _r"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _table_3(
...
sl.extendTraitWithMethod(
  ...
  function (_self, _k) {
    ...
    let __genSym97 = _assertIsOfSize_2(_shape_1(_m), 2),
      _r = _at_2(__genSym97, 1),
      _c = _at_2(__genSym97, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _anArray, _anInteger) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_1, _anArray, _anInteger"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
