...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_lessThanSign_2(_m, _n), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        /* console.error(errorMessage); */
      ...
      return _dot_2(_inverse_1(_gramMatrix_1(_self)), _transposed_1(_self));
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      return _dot_2(_transposed_1(_self), _inverse_1(_gramMatrix_1(_self)));
    });
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym25 = _assertIsOfSize_2(_singularValueDecomposition_1(_self), 3),
      _u = _at_2(__genSym25, 1),
      _s = _at_2(__genSym25, 2),
      _v = _at_2(__genSym25, 3);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym31 = _assertIsOfSize_2(
        _singularValueDecompositionGolubReinsch_1(_self),
        3,
      ),
      _u = _at_2(__genSym31, 1),
      _q = _at_2(__genSym31, 2),
      _v = _at_2(__genSym31, 3);
...
sl.extendTraitWithMethod(
  ...
  function (_n) {
    ...
    let __genSym33 = _assertIsOfSize_2([1, 0], 2),
      _dx = _at_2(__genSym33, 1),
      _dy = _at_2(__genSym33, 2);
    let __genSym34 = _assertIsOfSize_2([1, 1], 2),
      _x = _at_2(__genSym34, 1),
      _y = _at_2(__genSym34, 2);
    let _answer = _exclamationMark_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
    ...
    _toDo_3(1, _circumflexAccent_2(_n, 2), function (_i) {
      ...
      let __genSym35 = _assertIsOfSize_2([
          _plusSign_2(_x, _dx),
          _plusSign_2(_y, _dy),
        ], 2),
        _nx = _at_2(__genSym35, 1),
        _ny = _at_2(__genSym35, 2);
      /* Statements */
      ...
      return _if_3(
        ...
        function () {
          ...
          return /* List Assignment */ (function () {
            const __genSym36 = [_nx, _ny];
            _x = _at_2(__genSym36, 1);
            _y = _at_2(__genSym36, 2);
          })();
        },
        function () {
          /* ArityCheck */
          ...
          /* List Assignment */ (function () {
            const __genSym37 = [_hyphenMinus_1(_dy), _dx];
            _dx = _at_2(__genSym37, 1);
            _dy = _at_2(__genSym37, 2);
          })();
          return /* List Assignment */ (function () {
            const __genSym38 = [_plusSign_2(_x, _dx), _plusSign_2(_y, _dy)];
            _x = _at_2(__genSym38, 1);
            _y = _at_2(__genSym38, 2);
          })();
        },
      );
    });
