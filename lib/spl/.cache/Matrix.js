...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _ravel_1(_contents_1(_self));
  },
  "{ :self |\n\t\tself.contents.ravel\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _if_3(_isArray_1(_self), function () {
      ...
      let __genSym1 = _assertIsOfSize_2(_take_2(_shape_1(_self), 4), 4),
        _r = _at_2(__genSym1, 1),
        _c = _at_2(__genSym1, 2),
        _i = _at_2(__genSym1, 3),
        _j = _at_2(__genSym1, 4);
  ...
  function (_d) {
    ...
    _toDo_3(1, _n, function (_i) {
      ...
      return _toDo_3(1, _size_1(_at_2(_d, _i)), function (_j) {
        ...
        return _add_2(
          _answer,
          _concatenation_1(_collect_2(_to_2(1, _n), function (_k) {
            /* ArityCheck */
            if (arguments.length !== 1) {
...
sl.addMethod(
  ...
  function (_a) {
    ...
    let __genSym3 = _assertIsOfSize_2(_shape_1(_a), 2),
      _m = _at_2(__genSym3, 1),
      _n = _at_2(__genSym3, 2);
...
sl.addMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    let __genSym4 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym4, 1),
      _n = _at_2(__genSym4, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _k, _shape) {
    ...
    let __genSym5 = _assertIsOfSize_2(_shape, 2),
      _m = _at_2(__genSym5, 1),
      _n = _at_2(__genSym5, 2);
...
sl.addMethod(
  ...
  function (_m, _epsilon, _n) {
    ...
    _whileTrue_2(function () {
      ...
      let __genSym6 = _assertIsOfSize_2(_qrDecomposition_1(_x), 2),
        _q = _at_2(__genSym6, 1),
        _r = _at_2(__genSym6, 2);
      /* Statements */
      _x = _dot_2(_r, _q);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym7 = _assertIsOfSize_2(_shape_1(_self), 2),
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym8 = _assertIsOfSize_2(_shape_1(_a), 2),
      _n = _at_2(__genSym8, 1),
      _m = _at_2(__genSym8, 2);
    /* Statements */
  ...
  function (_self) {
    ...
    return _if_3(_isSquareMatrix_1(_self), function () {
      ...
      return _if_3(_equalsSign_2(_n, 2), function () {
        ...
        let __genSym9 = _assertIsOfSize_2(
  ...
  function (_self, _k) {
    ...
    return _ampersand_2(_isMatrix_1(_self), function () {
      ...
      let __genSym10 = _assertIsOfSize_2(_shape_1(_self), 2),
        _r = _at_2(__genSym10, 1),
        _c = _at_2(__genSym10, 2);
      /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym11 = _assertIsOfSize_2(_shape_1(_self), 2),
      _p = _at_2(__genSym11, 1),
      _q = _at_2(__genSym11, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym12 = _assertIsOfSize_2(_shape_1(_self), 2),
      _p = _at_2(__genSym12, 1),
      _q = _at_2(__genSym12, 2);
    /* Statements */
    return _if_3(_greaterThanSignEqualsSign_2(_p, _q), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self, _k) {
    ...
    let __genSym14 = _assertIsOfSize_2(_shape_1(_m), 2),
      _r = _at_2(__genSym14, 1),
      _c = _at_2(__genSym14, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    let __genSym15 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym15, 1),
      _n = _at_2(__genSym15, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aList) {
    ...
    let __genSym16 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym16, 1),
      _n = _at_2(__genSym16, 2);
    /* Statements */
    return _if_3(
      ...
      function () {
        ...
        return _error_2(_self, "@Sequence>>matrixColumns: illegal index");
      },
    );
  },
...
sl.addMethod(
  ...
  function (_a, _b) {
    ...
    let __genSym17 = _assertIsOfSize_2(_shape_1(_a), 2),
      _n = _at_2(__genSym17, 1),
      _p = _at_2(__genSym17, 2);
    let __genSym18 = _assertIsOfSize_2(_shape_1(_b), 2),
      _m = _at_2(__genSym18, 1),
      _q = _at_2(__genSym18, 2);
    let _l = _List_2(_n, 1);
    /* Statements */
    _assert_1(function () {
      /* ArityCheck */
...
sl.addMethod(
  ...
  function (_self, _anInteger) {
    ...
    let __genSym19 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym19, 1),
      _n = _at_2(__genSym19, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _decimalPlaces) {
    ...
    let __genSym20 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym20, 1),
      _n = _at_2(__genSym20, 2);
...
sl.addMethod(
  ...
  function (_m, _p) {
    ...
    let __genSym21 = _assertIsOfSize_2(_shape_1(_m), 2),
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym23 = _assertIsOfSize_2(_shape_1(_self), 2),
      _m = _at_2(__genSym23, 1),
      _n = _at_2(__genSym23, 2);
    /* Statements */
    return _table_3(
      function (_i, _j) {
        /* ArityCheck */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym24 = _assertIsOfSize_2(_singularValueDecomposition_1(_self), 3),
      _u = _at_2(__genSym24, 1),
      _s = _at_2(__genSym24, 2),
      _v = _at_2(__genSym24, 3);
...
sl.addMethod(
  ...
  function (_self, _tolerance) {
    ...
    let _a = _self;
    let __genSym27 = _assertIsOfSize_2(_shape_1(_a), 2),
    ...
    _whileTrue_2(function () {
      ...
      /* List Assignment */ (function () {
        const __genSym28 = _qrDecomposition_1(_conjugateTranspose_1(_s));
        _q = _at_2(__genSym28, 1);
        _s = _at_2(__genSym28, 2);
      })();
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym30 = _assertIsOfSize_2(
        _singularValueDecompositionGolubReinsch_1(_self),
        3,
      ),
      _u = _at_2(__genSym30, 1),
      _q = _at_2(__genSym30, 2),
      _v = _at_2(__genSym30, 3);
...
sl.addMethod(
  ...
  function (_self, _k) {
    ...
    let __genSym31 = _assertIsOfSize_2(_shape_1(_m), 2),
      _r = _at_2(__genSym31, 1),
      _c = _at_2(__genSym31, 2);
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _other) {
    ...
    return _collect_2(_to_2(1, _self), function (_unused) {
      /* ArityCheck */
      if (arguments.length !== 1) {
...
sl.extendTraitWithMethod(
  ...
  function (_n) {
    ...
    let __genSym32 = _assertIsOfSize_2([1, 0], 2),
      _dx = _at_2(__genSym32, 1),
      _dy = _at_2(__genSym32, 2);
    let __genSym33 = _assertIsOfSize_2([1, 1], 2),
      _x = _at_2(__genSym33, 1),
      _y = _at_2(__genSym33, 2);
    let _answer = _exclamationMark_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
    ...
    _toDo_3(1, _circumflexAccent_2(_n, 2), function (_i) {
      ...
      let __genSym34 = _assertIsOfSize_2([
          _plusSign_2(_x, _dx),
          _plusSign_2(_y, _dy),
        ], 2),
        _nx = _at_2(__genSym34, 1),
        _ny = _at_2(__genSym34, 2);
      /* Statements */
      ...
      return _if_3(
        ...
        function () {
          ...
          /* List Assignment */ (function () {
            const __genSym36 = [_hyphenMinus_1(_dy), _dx];
            _dx = _at_2(__genSym36, 1);
            _dy = _at_2(__genSym36, 2);
          })();
          return /* List Assignment */ (function () {
            const __genSym37 = [_plusSign_2(_x, _dx), _plusSign_2(_y, _dy)];
            _x = _at_2(__genSym37, 1);
            _y = _at_2(__genSym37, 2);
          })();
        },
      );
    });
