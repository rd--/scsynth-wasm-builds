...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _allSatisfy_2(
          ...
          sl.annotateFunction(function (_index) {
            ...
            let __SPL4 = _assertIsOfSize_2(_index, 2);
  ...
  "{ :self :k | &((=(rank(self), 2)), { allSatisfy(deepIndices(self), { :index | let __SPL4 = assertIsOfSize(index, 2); let i = at(__SPL4, 1); let j = at(__SPL4, 2); |((=(+(i, k), j)), { isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let __SPL5 = assertIsOfSize(shape(self), 2); let m = at(__SPL5, 1); let n = at(__SPL5, 2); collect(Span(1, n, 1), { :i | aBlock(matrixColumn(self,i)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :anInteger | let __SPL6 = assertIsOfSize(shape(self), 2); let m = at(__SPL6, 1); let n = at(__SPL6, 2); if(betweenAnd(anInteger,1, n), { collect(upOrDownTo(1, m), { :i | at(at(self, i), anInteger) }) }, { error(self,'List>>matrixColumn: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aList | let __SPL7 = assertIsOfSize(shape(self), 2); let m = at(__SPL7, 1); let n = at(__SPL7, 2); if(allSatisfy(aList, { :each | betweenAnd(each,1, n) }), { collect(upOrDownTo(1, m), { :i | collect(aList, { :j | at(at(self, i), j) }) }) }, { error(self,'List>>matrixColumns: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :anInteger | let __SPL8 = assertIsOfSize(shape(self), 2); let m = at(__SPL8, 1); let n = at(__SPL8, 2); if(betweenAnd(anInteger,1, m), { at(self, anInteger) }, { error(self,'List>>matrixRow: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :d | let n = size(d); let s = collect(d,shape:/1); let answer = []; toDo(1, n, { :i | toDo(1, size(at(d, i)), { :j | add(answer,gather(Span(1, n, 1), { :k | if((=(i, k)), { at(at(d, i), j) }, { #(0, at(at(s, k), 2)) }) })) }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function (_i) {
        ...
        return _toDo_3(
          ...
          sl.annotateFunction(function (_j) {
            ...
            return _add_2(
              _answer,
              _aBlock_2(_at_2(_self, _i), _at_2(_self, _j)),
            );
          }, ["j"]),
        );
      }, ["i"]),
  ...
  "{ :self :aBlock:/2 | let k = size(self); let answer = []; toDo(1, k, { :i | toDo((+(i, 1)), k, { :j | add(answer,aBlock(at(self, i), at(self, j))) }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k, _shape) {
    ...
    let __SPL10 = _assertIsOfSize_2(_shape, 2);
  ...
  "{ :self :k :shape | let __SPL10 = assertIsOfSize(shape, 2); let m = at(__SPL10, 1); let n = at(__SPL10, 2); let r = abs(min(k,0)); let c = max(k,0); let answer = zeroMatrix(m,n); toDo(1, size(self), { :each | atPut(at(answer, +(each, r)), +(each, c), at(self, each)) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r, _sigma) {
    ...
    let __SPL11 = _assertIsOfSize_2(_r, 2);
    let _r1 = _at_2(__SPL11, 1);
    let _r2 = _at_2(__SPL11, 2);
    let __SPL12 = _assertIsOfSize_2(_sigma, 2);
    let _sigma1 = _at_2(__SPL12, 1);
    let _sigma2 = _at_2(__SPL12, 2);
    let _p = _exp_1(
      _solidus_2(
        _asterisk_2(
          -0.5,
  ...
  "{ :r :sigma | let __SPL11 = assertIsOfSize(r, 2); let r1 = at(__SPL11, 1); let r2 = at(__SPL11, 2); let __SPL12 = assertIsOfSize(sigma, 2); let sigma1 = at(__SPL12, 1); let sigma2 = at(__SPL12, 2); let p = exp((/(*(-0.5, squared(asList(upOrDownTo(-(r1), r1)))), squared(sigma1)))); let q = exp((/(*(-0.5, squared(asList(upOrDownTo(-(r2), r2)))), squared(sigma2)))); let k = outerProduct(p,q); /(k, deepSum(k)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let __SPL13 = _assertIsOfSize_2([1, 0], 2);
    let _dx = _at_2(__SPL13, 1);
    let _dy = _at_2(__SPL13, 2);
    let __SPL14 = _assertIsOfSize_2([1, 1], 2);
    ...
    _toDo_3(
      ...
      sl.annotateFunction(function (_i) {
        ...
        let __SPL15 = _assertIsOfSize_2([
          _plusSign_2(_x, _dx),
          _plusSign_2(_y, _dy),
        ], 2);
        let _nx = _at_2(__SPL15, 1);
        let _ny = _at_2(__SPL15, 2);
        /* Statements */
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            sl.annotateFunction(function () {
              ...
              let __SPL17 = [_hyphenMinus_1(_dy), _dx];
              /* Statements */
              _dx = _at_2(__SPL17, 1);
              return _dy = _at_2(__SPL17, 2);
            }, [])();
            return (sl.annotateFunction(function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
              ...
              let __SPL18 = [_plusSign_2(_x, _dx), _plusSign_2(_y, _dy)];
              /* Statements */
              _x = _at_2(__SPL18, 1);
              return _y = _at_2(__SPL18, 2);
            }, [])());
          }, []),
        );
      }, ["i"]),
  ...
  "{ :n | let __SPL13 = assertIsOfSize([1, 0], 2); let dx = at(__SPL13, 1); let dy = at(__SPL13, 2); let __SPL14 = assertIsOfSize([1, 1], 2); let x = at(__SPL14, 1); let y = at(__SPL14, 2); let answer = !({ !(nil, n) }, n); toDo(1, ^(n, 2), { :i | let __SPL15 = assertIsOfSize([+(x, dx), +(y, dy)], 2); let nx = at(__SPL15, 1); let ny = at(__SPL15, 2); atPut(at(answer, x), y, i); if(&([{ <=(1, nx) }, { <=(nx, n) }, { <=(1, ny) }, { <=(ny, n) }, { =(at(at(answer, nx), ny), nil) }]), { ({ let __SPL16 = [nx, ny]; x := at(__SPL16, 1); y := at(__SPL16, 2) } . ()) }, { ({ let __SPL17 = [-(dy), dx]; dx := at(__SPL17, 1); dy := at(__SPL17, 2) } . ()); ({ let __SPL18 = [+(x, dx), +(y, dy)]; x := at(__SPL18, 1); y := at(__SPL18, 2) } . ()) }) }); answer }",
);
