...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let __SPL6 = assertIsOfSize(shape(self), 2); let m = at(__SPL6, 1); let n = at(__SPL6, 2); collect(submatrix(self,asList(upOrDownTo(1, m)), asList(upOrDownTo(1, -(n, 1)))), { :each | ++([1], aBlock(each)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _allSatisfy_2(
          ...
          sl.annotateFunction(function (_index) {
            ...
            let __SPL7 = _assertIsOfSize_2(_index, 2);
  ...
  "{ :self :k | &((=(rank(self), 2)), { allSatisfy(deepIndices(self), { :index | let __SPL7 = assertIsOfSize(index, 2); let i = at(__SPL7, 1); let j = at(__SPL7, 2); |((=(+(i, k), j)), { isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let __SPL8 = assertIsOfSize(shape(self), 2); let m = at(__SPL8, 1); let n = at(__SPL8, 2); collect(Span(1, n, 1), { :i | aBlock(column(self,i)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :anInteger | let __SPL10 = assertIsOfSize(shape(self), 2); let m = at(__SPL10, 1); let n = at(__SPL10, 2); if(betweenAnd(anInteger,1, m), { at(self, anInteger) }, { error(self,'List>>row: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aList | let __SPL11 = assertIsOfSize(shape(self), 2); let m = at(__SPL11, 1); let n = at(__SPL11, 2); if(allSatisfy(aList, { :each | betweenAnd(each,1, m) }), { atAll(self,aList) }, { error(self,'List>>rows: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k, _shape) {
    ...
    let __SPL12 = _assertIsOfSize_2(_shape, 2);
  ...
  "{ :self :k :shape | let __SPL12 = assertIsOfSize(shape, 2); let m = at(__SPL12, 1); let n = at(__SPL12, 2); let r = abs(min(k,0)); let c = max(k,0); let answer = zeroMatrix([m, n]); toDo(1, size(self), { :each | atPut(at(answer, +(each, r)), +(each, c), at(self, each)) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_r, _sigma) {
    ...
    let __SPL13 = _assertIsOfSize_2(_r, 2);
    let _r1 = _at_2(__SPL13, 1);
    let _r2 = _at_2(__SPL13, 2);
    let __SPL14 = _assertIsOfSize_2(_sigma, 2);
    let _sigma1 = _at_2(__SPL14, 1);
    let _sigma2 = _at_2(__SPL14, 2);
    let _p = _exp_1(
      _solidus_2(
        _asterisk_2(
          -0.5,
  ...
  "{ :r :sigma | let __SPL13 = assertIsOfSize(r, 2); let r1 = at(__SPL13, 1); let r2 = at(__SPL13, 2); let __SPL14 = assertIsOfSize(sigma, 2); let sigma1 = at(__SPL14, 1); let sigma2 = at(__SPL14, 2); let p = exp((/(*(-0.5, square(asList(upOrDownTo(-(r1), r1)))), square(sigma1)))); let q = exp((/(*(-0.5, square(asList(upOrDownTo(-(r2), r2)))), square(sigma2)))); let k = outerProduct(p,q); /(k, deepSum(k)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :shape | let __SPL15 = assertIsOfSize(shape, 2); let m = at(__SPL15, 1); let n = at(__SPL15, 2); let answer = zeroMatrix([m, n]); toDo(1, min(n,m), { :each | atPut(at(answer, each), each, 1) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :shape | let __SPL16 = assertIsOfSize(shape, 2); let m = at(__SPL16, 1); let n = at(__SPL16, 2); collect(upOrDownTo(1, m), { :unused | List(n, 0) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_shape) {
    ...
    let __SPL17 = _assertIsOfSize_2(_shape, 2);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let __SPL18 = _assertIsOfSize_2([1, 0], 2);
    let _dx = _at_2(__SPL18, 1);
    let _dy = _at_2(__SPL18, 2);
    let __SPL19 = _assertIsOfSize_2([1, 1], 2);
    ...
    _toDo_3(
      ...
      sl.annotateFunction(function (_i) {
        ...
        let _nx = _at_2(__SPL20, 1);
        let _ny = _at_2(__SPL20, 2);
        /* Statements */
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            sl.annotateFunction(function () {
              ...
              let __SPL22 = [_hyphenMinus_1(_dy), _dx];
              /* Statements */
              _dx = _at_2(__SPL22, 1);
              return _dy = _at_2(__SPL22, 2);
            }, [])();
            return (sl.annotateFunction(function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
              ...
              let __SPL23 = [_plusSign_2(_x, _dx), _plusSign_2(_y, _dy)];
              /* Statements */
              _x = _at_2(__SPL23, 1);
              return _y = _at_2(__SPL23, 2);
            }, [])());
          }, []),
        );
      }, ["i"]),
  ...
  "{ :n | let __SPL18 = assertIsOfSize([1, 0], 2); let dx = at(__SPL18, 1); let dy = at(__SPL18, 2); let __SPL19 = assertIsOfSize([1, 1], 2); let x = at(__SPL19, 1); let y = at(__SPL19, 2); let answer = !({ !(nil, n) }, n); toDo(1, ^(n, 2), { :i | let __SPL20 = assertIsOfSize([+(x, dx), +(y, dy)], 2); let nx = at(__SPL20, 1); let ny = at(__SPL20, 2); atPut(at(answer, x), y, i); if(&([{ <=(1, nx) }, { <=(nx, n) }, { <=(1, ny) }, { <=(ny, n) }, { =(at(at(answer, nx), ny), nil) }]), { ({ let __SPL21 = [nx, ny]; x := at(__SPL21, 1); y := at(__SPL21, 2) } . ()) }, { ({ let __SPL22 = [-(dy), dx]; dx := at(__SPL22, 1); dy := at(__SPL22, 2) } . ()); ({ let __SPL23 = [+(x, dx), +(y, dy)]; x := at(__SPL23, 1); y := at(__SPL23, 2) } . ()) }) }); answer }",
);
