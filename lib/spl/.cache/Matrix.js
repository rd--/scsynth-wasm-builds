...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | &(isMatrix(self), { let __SplVar1 = assertIsOfSize(shape(self), 2); let m = at(__SplVar1, 1); let n = at(__SplVar1, 2); =(m, n) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar2 = assertIsOfSize(dimensions(self,2), 2); let m = at(__SplVar2, 1); let _ = at(__SplVar2, 2); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar3 = assertIsOfSize(dimensions(self,2), 2); let _ = at(__SplVar3, 1); let n = at(__SplVar3, 2); n }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :anInteger | let __SplVar4 = assertIsOfSize(shape(self), 2); let m = at(__SplVar4, 1); let n = at(__SplVar4, 2); if(betweenAnd(anInteger,1, n), { collect(upOrDownTo(1, m), { :i | at(at(self, i), anInteger) }) }, { error(self,'List>>column: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aList | let __SplVar5 = assertIsOfSize(shape(self), 2); let m = at(__SplVar5, 1); let n = at(__SplVar5, 2); if(allSatisfy(aList, { :each | betweenAnd(each,1, n) }), { collect(upOrDownTo(1, m), { :i | collect(aList, { :j | at(at(self, i), j) }) }) }, { error(self,'List>>columns: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let __SplVar6 = assertIsOfSize(shape(self), 2); let m = at(__SplVar6, 1); let n = at(__SplVar6, 2); collect(submatrix(self,asList(upOrDownTo(1, m)), asList(upOrDownTo(1, -(n, 1)))), { :each | ++([1], aBlock(each)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :k | &((=(rank(self), 2)), { allSatisfy(deepIndices(self), { :index | let __SplVar7 = assertIsOfSize(index, 2); let i = at(__SplVar7, 1); let j = at(__SplVar7, 2); |((=(+(i, k), j)), { isVeryCloseTo(at(at(self, i), j),0) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | let __SplVar8 = assertIsOfSize(shape(self), 2); let m = at(__SplVar8, 1); let n = at(__SplVar8, 2); collect(Span(1, n, 1), { :i | aBlock(column(self,i)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :anInteger | let __SplVar10 = assertIsOfSize(shape(self), 2); let m = at(__SplVar10, 1); let n = at(__SplVar10, 2); if(betweenAnd(anInteger,1, m), { at(self, anInteger) }, { error(self,'List>>row: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aList | let __SplVar11 = assertIsOfSize(shape(self), 2); let m = at(__SplVar11, 1); let n = at(__SplVar11, 2); if(allSatisfy(aList, { :each | betweenAnd(each,1, m) }), { atAll(self,aList) }, { error(self,'List>>rows: illegal index') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :k :shape | let __SplVar12 = assertIsOfSize(shape, 2); let m = at(__SplVar12, 1); let n = at(__SplVar12, 2); let r = abs(min(k,0)); let c = max(k,0); let answer = zeroMatrix([m, n]); toDo(1, size(self), { :each | atPut(at(answer, +(each, r)), +(each, c), at(self, each)) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :r :sigma | let __SplVar13 = assertIsOfSize(r, 2); let r1 = at(__SplVar13, 1); let r2 = at(__SplVar13, 2); let __SplVar14 = assertIsOfSize(sigma, 2); let sigma1 = at(__SplVar14, 1); let sigma2 = at(__SplVar14, 2); let p = exp((/(*(-0.5, square(asList(upOrDownTo(-(r1), r1)))), square(sigma1)))); let q = exp((/(*(-0.5, square(asList(upOrDownTo(-(r2), r2)))), square(sigma2)))); let k = outerProduct(p,q); /(k, deepSum(k)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :shape | let __SplVar15 = assertIsOfSize(shape, 2); let m = at(__SplVar15, 1); let n = at(__SplVar15, 2); let answer = zeroMatrix([m, n]); toDo(1, min(n,m), { :each | atPut(at(answer, each), each, 1) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :shape | let __SplVar16 = assertIsOfSize(shape, 2); let m = at(__SplVar16, 1); let n = at(__SplVar16, 2); collect(upOrDownTo(1, m), { :unused | List(n, 0) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n | let __SplVar18 = assertIsOfSize([1, 0], 2); let dx = at(__SplVar18, 1); let dy = at(__SplVar18, 2); let __SplVar19 = assertIsOfSize([1, 1], 2); let x = at(__SplVar19, 1); let y = at(__SplVar19, 2); let answer = !({ !(nil, n) }, n); toDo(1, ^(n, 2), { :i | let __SplVar20 = assertIsOfSize([+(x, dx), +(y, dy)], 2); let nx = at(__SplVar20, 1); let ny = at(__SplVar20, 2); atPut(at(answer, x), y, i); if(&([{ <=(1, nx) }, { <=(nx, n) }, { <=(1, ny) }, { <=(ny, n) }, { =(at(at(answer, nx), ny), nil) }]), { ({ let __SplVar21 = [nx, ny]; x := at(__SplVar21, 1); y := at(__SplVar21, 2) } . ()) }, { ({ let __SplVar22 = [-(dy), dx]; dx := at(__SplVar22, 1); dy := at(__SplVar22, 2) } . ()); ({ let __SplVar23 = [+(x, dx), +(y, dy)]; x := at(__SplVar23, 1); y := at(__SplVar23, 2) } . ()) }) }); answer }",
);
