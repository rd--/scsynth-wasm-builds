...
sl.addMethodToExistingType(
  ...
  "{ :self :index :newObject | shouldNotImplement(self,'atPut') }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :anObject :aBlock:/2 | |(==(self, anObject), { &(isHeap(anObject), { &(=(size(anObject), size(self)), { &(=(sortBlock(anObject), sortBlock(self)), { equalBy(sort(array(self),sortBlock(self)),sort(array(anObject),sortBlock(self)), aBlock:/2) }) }) }) }) }",
);
