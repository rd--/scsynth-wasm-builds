...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    return _or_2(_equalsEquals_2(_self, _anObject), function () {
      ...
      /* Statements */
      return _and_2(_isHeap_1(_anObject), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _and_2(
          _equals_2(_size_1(_anObject), _size_1(_self)),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
            ...
            /* Statements */
            return _and_2(
              _equals_2(_sortBlock_1(_anObject), _sortBlock_1(_self)),
              function () {
                /* ArityCheck */
                if (arguments.length !== 0) {
                  const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _anItem, _anotherItem) {
    ...
    return _ifNil_3(_sortBlock_1(_self), function () {
      ...
      /* Statements */
      return _lessThanEquals_2(_anItem, _anotherItem);
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _anIndex) {
    ...
    /* Temporaries */
    let _childIndex, _childValue, _index, _value;
    /* Statements */
    _index = _anIndex;
    _value = _at_2(_array_1(_self), _anIndex);
    _whileFalse_2(function () {
      ...
      /* Statements */
      return _or_2(
        _greaterThanEquals_2(_childIndex = _times_2(2, _index), _size_1(_self)),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          _ifTrue_2(
            _compare_3(
              _self,
              _at_2(_array_1(_self), _plus_2(_childIndex, 1)),
              _childValue,
            ),
            function () {
              /* ArityCheck */
              ...
              /* Statements */
              _childIndex = _plus_2(_childIndex, 1);
    ...
    _ifTrue_2(_equals_2(_childIndex, _size_1(_self)), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _index) {
    ...
    /* Statements */
    _if_3(_equals_2(_index, _size_1(_array_1(_self))), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      return _if_3(
        _lessThanEquals_2(_times_2(2, _index), _size_1(_self)),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _oldObject, _aBlock_0) {
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      /* Statements */
      _upToDo_3(1, _size_1(_self), function (_i) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        /* Statements */
        return _ifTrue_2(
          _equals_2(_at_2(_array_1(_self), _i), _oldObject),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    /* Statements */
    _upToDo_3(1, _size_1(_self), function (_index) {
      /* ArityCheck */
      if (arguments.length !== 1) {
...
sl.addMethod(
  ...
  function (_self, _anIndex) {
    ...
    /* Statements */
    return _if_3(_equals_2(_anIndex, 1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      _whileTrue_2(function () {
        ...
        /* Statements */
        return _and_2(_greaterThan_2(_index, 1), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _asHeap_1(_asArray_1(_self));
  },
  "{ :self |\n\t\tself.asArray.asHeap\n\t}",
);
