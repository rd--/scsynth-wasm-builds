...
sl.addMethodToExistingType(
  ...
  "{ :self :mimeType :onError | caseOf(mimeType, [->('application/json', { json(self) }), ->('application/octet-stream', { byteArray(self) }), ->('text/plain', { text(self) })], { cull(onError,Error(++('Response>>asMimeType: unknown mimeType: ', mimeType))) }) }",
);
