...
sl.addMethod(
  ...
  function (_self, _jiMeta) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _jiMeta"; /* console.error(errorMessage); */
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    return _then_2(_jiScala_1(_self), function (_jiScala) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _jiScala"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
        ...
        _LibraryItem_4(
          ...
          function (_libraryItem) {
            ...
            return _collect_2(_libraryItem, function (_each) {
              ...
              /* Statements */
              return _select_2(
                _collect_2(_each, function (_aName) {
                  /* ArityCheck */
                  if (arguments.length !== 1) {
                    const errorMessage =
                      "Arity: expected 1, _aName"; /* console.error(errorMessage); */
                    throw new Error(errorMessage);
                  }
                  /* Statements */
...
sl.addMethod(
  ...
  function (_self, _smallKansas, _event) {
    ...
    return _then_2(_jiMeta_1(_smallKansas), function (_jiMeta) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _jiMeta"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _addFrame_3(
