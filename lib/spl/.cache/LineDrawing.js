...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _precision = _also_2(
      _max_2(_hyphenMinus_2(3, _rounded_1(_log10_1(_yRange))), 0),
      function (_x) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        return _postLine_1(["RANGE/PREC", _yRange, _x]);
      },
    );
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _asPerspectiveDrawing_2(
      _self,
      _asBlock_1(
        _AxonometricProjection_5(_solidus_2(_pi, 6), 0, 1, 1, _solidus_2(1, 2)),
      ),
    );
  },
