...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isMatrix(self), { let __SPL78 = assertIsOfSize(shape(self), 2); let m = at(__SPL78, 1); let n = at(__SPL78, 2); if((=(n, 2)), { asLineDrawing(Line(self)) }, { error(self,'asLineDrawing') }) }, { LineDrawing(self) }) }",
);
