...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isMatrix(self), { let __SPL12 = assertIsOfSize(shape(self), 2); let m = at(__SPL12, 1); let n = at(__SPL12, 2); if((=(n, 2)), { asLineDrawing(Line(self)) }, { error(self,'asLineDrawing') }) }, { LineDrawing(self) }) }",
);
