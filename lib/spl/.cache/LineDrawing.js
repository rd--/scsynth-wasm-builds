...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isMatrix(self), { let __SplVar1 = assertIsOfSize(shape(self), 2); let m = at(__SplVar1, 1); let n = at(__SplVar1, 2); if((=(n, 2)), { asLineDrawing(Line(self)) }, { error(self,'asLineDrawing') }) }, { LineDrawing(self) }) }",
);
