...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL254 = _assertIsOfSize_2(_coordinates_1(_self), 2);
    let _r = _at_2(__SPL254, 1);
    let _theta = _at_2(__SPL254, 2);
    /* Statements */
    return _asterisk_2(_r, _cos_1(_theta));
  }, ["self"]),
  "{ :self | let __SPL254 = assertIsOfSize(coordinates(self), 2); let r = at(__SPL254, 1); let theta = at(__SPL254, 2); *(r, cos(theta)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL255 = assertIsOfSize(coordinates(self), 2); let r = at(__SPL255, 1); let theta = at(__SPL255, 2); *(r, sin(theta)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL256 = _assertIsOfSize_2(_self, 2);
  ...
  "{ :self | if(isVector(self), { let __SPL256 = assertIsOfSize(self, 2); let r = at(__SPL256, 1); let theta = at(__SPL256, 2); initializeSlots(newPolarCoordinates(),[r, theta]) }, { collect(self,PolarCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let __SPL257 = assertIsOfSize(self, 2); let r = at(__SPL257, 1); let theta = at(__SPL257, 2); [*(r, cos(theta)), *(r, sin(theta))] }, { collect(self,fromPolarCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let __SPL258 = assertIsOfSize(self, 2); let x = at(__SPL258, 1); let y = at(__SPL258, 2); [sqrt((+(square(x), square(y)))), atan2(y, x)] }, { collect(self,toPolarCoordinates:/1) }) }",
);
