...
sl.extendTraitWithMethod(
  ...
  function (_r, _theta) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _r, _theta"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym52 = _assertIsOfSize_2(_self, 2),
      _r = _at_2(__genSym52, 1),
      _theta = _at_2(__genSym52, 2);
    /* Statements */
...
sl.addMethod(
  ...
  function (_radius, _theta) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _radius, _theta"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
