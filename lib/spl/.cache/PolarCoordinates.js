...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar1 = assertIsOfSize(coordinates(self), 2); let r = at(__SplVar1, 1); let theta = at(__SplVar1, 2); *(r, cos(theta)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SplVar2 = assertIsOfSize(coordinates(self), 2); let r = at(__SplVar2, 1); let theta = at(__SplVar2, 2); *(r, sin(theta)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let __SplVar3 = assertIsOfSize(self, 2); let r = at(__SplVar3, 1); let theta = at(__SplVar3, 2); initializeSlots(newPolarCoordinates(),[r, theta]) }, { collect(self,PolarCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let __SplVar4 = assertIsOfSize(self, 2); let r = at(__SplVar4, 1); let theta = at(__SplVar4, 2); [*(r, cos(theta)), *(r, sin(theta))] }, { collect(self,fromPolarCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let __SplVar5 = assertIsOfSize(self, 2); let x = at(__SplVar5, 1); let y = at(__SplVar5, 2); [sqrt((+(square(x), square(y)))), atan2(y, x)] }, { collect(self,toPolarCoordinates:/1) }) }",
);
