...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL1 = _assertIsOfSize_2(_coordinates_1(_self), 2);
    let _r = _at_2(__SPL1, 1);
    let _theta = _at_2(__SPL1, 2);
    /* Statements */
    return _asterisk_2(_r, _cos_1(_theta));
  }, ["self"]),
  "{ :self | let __SPL1 = assertIsOfSize(coordinates(self), 2); let r = at(__SPL1, 1); let theta = at(__SPL1, 2); *(r, cos(theta)) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL2 = _assertIsOfSize_2(_coordinates_1(_self), 2);
    let _r = _at_2(__SPL2, 1);
    let _theta = _at_2(__SPL2, 2);
    /* Statements */
    return _asterisk_2(_r, _sin_1(_theta));
  }, ["self"]),
  "{ :self | let __SPL2 = assertIsOfSize(coordinates(self), 2); let r = at(__SPL2, 1); let theta = at(__SPL2, 2); *(r, sin(theta)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let __SPL3 = assertIsOfSize(self, 2); let r = at(__SPL3, 1); let theta = at(__SPL3, 2); initializeSlots(newPolarCoordinates(),[r, theta]) }, { collect(self,PolarCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL4 = _assertIsOfSize_2(_self, 2);
        let _r = _at_2(__SPL4, 1);
        let _theta = _at_2(__SPL4, 2);
        /* Statements */
        return [
  ...
  "{ :self | if(isVector(self), { let __SPL4 = assertIsOfSize(self, 2); let r = at(__SPL4, 1); let theta = at(__SPL4, 2); [*(r, cos(theta)), *(r, sin(theta))] }, { collect(self,fromPolarCoordinates:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let __SPL5 = assertIsOfSize(self, 2); let x = at(__SPL5, 1); let y = at(__SPL5, 2); [sqrt((+(squared(x), squared(y)))), atan2(y, x)] }, { collect(self,toPolarCoordinates:/1) }) }",
);
