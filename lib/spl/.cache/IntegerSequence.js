...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let __SPL407 = _assertIsOfSize_2([0, 1, 1, _n], 4);
    let _a = _at_2(__SPL407, 1);
    let _b = _at_2(__SPL407, 2);
    let _c = _at_2(__SPL407, 3);
    let _d = _at_2(__SPL407, 4);
  ...
  "{ :n | let __SPL407 = assertIsOfSize([0, 1, 1, n], 4); let a = at(__SPL407, 1); let b = at(__SPL407, 2); let c = at(__SPL407, 3); let d = at(__SPL407, 4); let answer = [Fraction(a, b)]; whileTrue({ <=(c, n) }, { let k = floor((/((+(n, b)), d))); ({ let __SPL408 = [c, d, -(*(k, c), a), -(*(k, d), b)]; a := at(__SPL408, 1); b := at(__SPL408, 2); c := at(__SPL408, 3); d := at(__SPL408, 4) } . ()); add(answer,Fraction(a, b)) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL409 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SPL409, 1);
    let _y = _at_2(__SPL409, 2);
    let _z = _at_2(__SPL409, 3);
    /* Statements */
    return _sort_1([
      _x,
      _y,
  ...
  "{ :self | let __SPL409 = assertIsOfSize(self, 3); let x = at(__SPL409, 1); let y = at(__SPL409, 2); let z = at(__SPL409, 3); sort([x, y, -(*(*(3, x), y), z)]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL410 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SPL410, 1);
    let _y = _at_2(__SPL410, 2);
    let _z = _at_2(__SPL410, 3);
    /* Statements */
    return _nub_1([
  ...
  "{ :self | let __SPL410 = assertIsOfSize(self, 3); let x = at(__SPL410, 1); let y = at(__SPL410, 2); let z = at(__SPL410, 3); nub([nextMarkovTriple([x, y, z]), nextMarkovTriple([x, z, y]), nextMarkovTriple([z, y, x])]) }",
);
