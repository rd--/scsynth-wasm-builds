...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let __SPL68 = _assertIsOfSize_2([0, 1, 1, _n], 4);
    let _a = _at_2(__SPL68, 1);
    let _b = _at_2(__SPL68, 2);
    let _c = _at_2(__SPL68, 3);
    let _d = _at_2(__SPL68, 4);
  ...
  "{ :n | let __SPL68 = assertIsOfSize([0, 1, 1, n], 4); let a = at(__SPL68, 1); let b = at(__SPL68, 2); let c = at(__SPL68, 3); let d = at(__SPL68, 4); let answer = [Fraction(a, b)]; whileTrue({ <=(c, n) }, { let k = floor((/((+(n, b)), d))); ({ let __SPL69 = [c, d, -(*(k, c), a), -(*(k, d), b)]; a := at(__SPL69, 1); b := at(__SPL69, 2); c := at(__SPL69, 3); d := at(__SPL69, 4) } . ()); add(answer,Fraction(a, b)) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _x = _at_2(__SPL70, 1);
    let _y = _at_2(__SPL70, 2);
    let _z = _at_2(__SPL70, 3);
    /* Statements */
    return _sort_1([
      _x,
      _y,
  ...
  "{ :self | let __SPL70 = assertIsOfSize(self, 3); let x = at(__SPL70, 1); let y = at(__SPL70, 2); let z = at(__SPL70, 3); sort([x, y, -(*(*(3, x), y), z)]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _x = _at_2(__SPL71, 1);
    let _y = _at_2(__SPL71, 2);
    let _z = _at_2(__SPL71, 3);
    /* Statements */
    return _nub_1([
  ...
  "{ :self | let __SPL71 = assertIsOfSize(self, 3); let x = at(__SPL71, 1); let y = at(__SPL71, 2); let z = at(__SPL71, 3); nub([nextMarkovTriple([x, y, z]), nextMarkovTriple([x, z, y]), nextMarkovTriple([z, y, x])]) }",
);
