...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    /* Statements */
    return _collect_2(_upOrDownTo_2(0, _hyphenMinus_2(_n, 1)), _a_1);
  }, ["n"]),
  "{ :n | let a:/1 = memoize({ :i | if((<(i, 2)), { 1 }, { let k = i; whileTrue({ =((%(k, 4)), 0) }, { k := /(k, 4) }); if(isOdd(k), { a(/((-(k, 1)), 2)) }, { 0 }) }) },true); collect(upOrDownTo(0, -(n, 1)),a:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :k | let a = List(k); let b = List(k); toDo(0, -(k, 1), { :n | atPut(a, +(n, 1), Fraction(1, +(n, 1))); toByDo(n, 1, -1, { :j | atPut(a, j, *(j, (-(at(a, j), at(a, +(j, 1)))))) }); atPut(b, +(n, 1), at(a, 1)) }); ifTrue((>(k, 1)), { atPut(b, 2, Fraction(-1L, 2L)) }); b }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let answer = []; let n = 0; whileTrue({ <(size(answer), self) }, { ifTrue((=(digitCount(n,3, 1), 0)), { add(answer,n) }); n := +(n, 1) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    _whileTrue_2(
      sl.annotateFunction(function () {
        ...
        /* Statements */
        return _lessThanSignEqualsSign_2(_key_1(_at_2(_z, 1)), _n);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
  ...
  "{ :n | let m = +(n, 2); whileTrue({ let z = factorInteger(binomial(m, n)); <=(key(at(z, 1)), n) }, { m := +(m, 1) }); m }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n | let __SplVar1 = assertIsOfSize([0, 1, 1, n], 4); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); let c = at(__SplVar1, 3); let d = at(__SplVar1, 4); let answer = [Fraction(a, b)]; whileTrue({ <=(c, n) }, { let k = floor((/((+(n, b)), d))); ({ let __SplVar2 = [c, d, -(*(k, c), a), -(*(k, d), b)]; a := at(__SplVar2, 1); b := at(__SplVar2, 2); c := at(__SplVar2, 3); d := at(__SplVar2, 4) } . ()); add(answer,Fraction(a, b)) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function (_n) {
        ...
        _whileTrue_2(
          ...
          sl.annotateFunction(function () {
            ...
            let _p = _hyphenMinus_2(_n, _i);
            let _q = _hyphenMinus_2(_n, _asterisk_2(2, _i));
            /* Statements */
            _include_2(
              _b,
              _hyphenMinus_2(
                _asterisk_2(2, _at_2(_a, _plusSign_2(_p, 1))),
                _at_2(_a, _plusSign_2(_q, 1)),
              ),
            );
            _i = _plusSign_2(_i, 1);
            return _whileTrue_2(
  ...
  "{ :self | let a = []; toDo(0, self, { :n | let i = 1; let j = 1; let b = IdentitySet(); whileTrue({ >=(-(n, (*(2, i))), 0) }, { let p = -(n, i); let q = -(n, (*(2, i))); include(b,-(*(2, at(a, +(p, 1))), at(a, +(q, 1)))); i := +(i, 1); whileTrue({ includes(b,j) }, { remove(b,j); j := +(j, 1) }) }); add(a,j) }); a }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :d :n | if((=(d, 2)), { collect(upOrDownTo(1, n), { :i | [vanDerCorputNumber(i,2), Fraction(i, n)] }) }, { unimplementedCase(d,'hammersleyPointSet') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n :k | if((=(k, 2)), { fromDigits(rotateLeft(integerDigits(n, 2), 1), 2) }, { if((<=(n, 1)), { n }, { let m = mod(+(josephusProblem(-(n, 1), k), k), n); if((!=(m, 0)), { m }, { n }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n :k | let z = []; iterate({ :x | let y = rotateLeft(x,k); add(z,removeLast(y)); y },asList(upOrDownTo(1, n)), n); z }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :terms | let number = 0; let answer = [0]; let inventory = asIdentityMultiset([0]); do(upOrDownTo(2, terms), { :n | let count = occurrencesOf(inventory,number); number := if((=(count, 0)), { 0 }, { +(number, 1) }); add(answer,count); add(inventory,count) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :base | divisible(self,sum(integerDigits(self,base))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | &(isPositive(self), { not(isPowerOfTwo(self)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let _p = _keys_1(_factors);
            let _e = _values_1(_factors);
            let _i = 1;
            let _ok = true;
            /* Statements */
            _whileTrue_2(
  ...
  "{ :n | let product = 1; if((|(<(n, 1), { &(>(n, 1), { isOdd(n) }) })), { false }, { if((=(n, 1)), { true }, { let factors = factorInteger(n); let p = keys(factors); let e = values(factors); let i = 1; let ok = true; whileTrue({ &(ok, { <=(i, size(p)) }) }, { if((>(at(p, i), (+(1, divisorSigma(1, product))))), { ok := false }, { product := *(product, (^(at(p, i), at(e, i)))); i := +(i, 1) }) }); ok }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :base :fixedLength | let d = integerDigits(self,base); ifNotNil(fixedLength, { d := padLeft(d,[fixedLength], 0) }); -(fromDigits(sort(d,>),base), fromDigits(sort(d,<),base)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :base :fixedLength | let answer = []; whileFalse({ includes(answer,self) }, { add(answer,self); self := kaprekarSequenceStep(self,base, fixedLength) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | kaprekarSequence(self,10, nil) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | at([2, 3, 5, 7, 13, 17, 19, 31, 61, 89, 107, 127, 521, 607, 1279, 2203, 2281, 3217, 4253, 4423, 9689, 9941, 11213, 19937, 21701, 23209, 44497, 86243, 110503, 132049, 216091, 756839, 859433, 1257787, 1398269, 2976221, 3021377, 6972593, 13466917, 20996011, 24036583, 25964951, 30402457, 32582657, 37156667, 42643801, 43112609, 57885161, 74207281, 77232917],self) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n | let k = ceiling(log(n,2)); first(last(substitutionSystem([->(0, [0, 1]), ->(1, [0, 0])],[0, 1], k)),n) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n | max((-(count(divisors(n),isOdd:/1), 1)),0) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n | let m = ceiling(log(n,2)); +(-((*(n, m)), (^(2, m))), 1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let answer = []; let n = 0; whileTrue({ <(size(answer), self) }, { ifTrue((=(digitCount(n,3, 2), 0)), { add(answer,n) }); n := +(n, 1) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | collect(upOrDownTo(0, -(self, 1)), { :n | +(fromDigits(integerDigits(n, 2), 3), 1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_s1, _m) {
    ...
    let _t1 = _size_1(_s1);
    let _mmm = 1000;
    let _s2 = _flatten_1(_exclamationMark_2(_s1, _plusSign_2(_t1, _m)));
  ...
  "{ :s1 :m | let t1 = size(s1); let mmm = 1000; let s2 = flatten((!(s1, (+(t1, m))))); let chvec = List(+(mmm, 1), 0); let swi = nil; toDo(1, t1, { :i | atPut(chvec, +(at(s2, i), 1), 1) }); toDo((+(t1, 1)), +(t1, m), { :n | toDoWithBreak((+(at(s2, -(n, 1)), 1)), mmm, { :i :break:/0 | swi := -1; toDoWithBreak(1, -(n, 2), { :j :break:/0 | let p = at(s2, -(n, j)); let k = -(*(2, p), i); ifTrue((<(k, 0)), { break() }); ifTrue((&(<=(k, mmm), { =(at(chvec, +(k, 1)), 1) })), { swi := 1; break() }) }); ifTrue((=(swi, -1)), { atPut(s2, n, i); atPut(chvec, +(i, 1), 1); break() }) }); ifTrue((=(swi, 1)), { warning(s1,++('stanleySequence: no solution at n=', n)) }) }); first(s2,m) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar3 = assertIsOfSize(self, 3); let x = at(__SplVar3, 1); let y = at(__SplVar3, 2); let z = at(__SplVar3, 3); sort([x, y, -(*(*(3, x), y), z)]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar4 = assertIsOfSize(self, 3); let x = at(__SplVar4, 1); let y = at(__SplVar4, 2); let z = at(__SplVar4, 3); nub([nextMarkovTriple([x, y, z]), nextMarkovTriple([x, z, y]), nextMarkovTriple([z, y, x])]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let u = markovNumberSequence(100); if((>(self, max(u))), { unimplementedCase(self,'isMarkovNumber') }, { includes(u,self) }) }",
);
