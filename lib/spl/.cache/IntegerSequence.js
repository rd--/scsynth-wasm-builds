    ...
    return _collect_2(
      ...
      sl.annotateFunction(function (_n) {
        ...
        return _hyphenMinus_2(
          _plusSign_2(
            _asterisk_2(2, _upOrDownTo_2(1, _plusSign_2(_n, 1))),
...
sl.extendTypeOrTraitWithMethod(
  ...
  "jugglerSequence",
  ["a1"],
  sl.annotateFunction(function (_a1) {
    /* ArityCheck */
    if (arguments.length !== 1) {
      const errorMessage = "Arity: expected 1, _a1";
      throw new Error(errorMessage);
    } /* Statements */
    return _if_3(
      _lessThanSign_2(_a1, 1),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
      ...
      sl.annotateFunction(function () {
        ...
        _whileTrue_2(
          sl.annotateFunction(function () {
            ...
            return _exclamationMarkEqualsSign_2(_ak, 1);
          }, []),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
            ...
            /* Statements */
            _ak = _floor_1(_circumflexAccent_2(_ak, _e));
            return _add_2(_a, _ak);
          }, []),
        );
        return _a;
      }, []),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    /* Statements */
    return _collect_2(_upOrDownTo_2(0, _hyphenMinus_2(_self, 1)), _a_1);
  }, ["self"]),
