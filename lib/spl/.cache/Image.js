...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _maxDepth) {
    ...
    return _unlines_1(_plusSignPlusSign_2(_header, _rows));
  }, ["self", "maxDepth"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _fileName) {
    ...
    return _writeTextFile_3(_system, _fileName, _encodePpm_2(_self, 255));
  }, ["self", "fileName"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    return _Image_1(_constantArray_2(_shape, [_self, _self, _self]));
  }, ["self", "shape"]),
  "{ :self :shape |\n\t\tshape.constantArray(\n\t\t\t[self, self, self]\n\t\t).Image\n\t}",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    return _Image_1(_constantArray_2(_shape, _self));
  }, ["self", "shape"]),
  "{ :self :shape |\n\t\tshape.constantArray(\n\t\t\tself\n\t\t).Image\n\t}",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    return _constantImage_2(_rgb_1(_self), _shape);
  }, ["self", "shape"]),
