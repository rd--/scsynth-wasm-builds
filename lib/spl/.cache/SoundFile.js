...
sl.addMethod(
  ...
  function (_self, _bufferNumber) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _bufferNumber"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _interleavedData, _numberOfChannels, _numberOfFrames, _sampleRate, _urlOrNil"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
