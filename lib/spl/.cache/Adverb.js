...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self:/2 | { :u :v | if(isMatrix(u), { let __SplVar1 = assertIsOfSize(shape(u), 2); let m = at(__SplVar1, 1); let n = at(__SplVar1, 2); table({ :i :j | *(at(at(u, i), j), v) },Span(1, m, 1), Span(1, n, 1)) }, { collect(u, { :alpha | collect(v, { :beta | self(alpha, beta) }) }) }) } }",
);
