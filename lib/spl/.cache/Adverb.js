sl.addMethod(
  ...
  function (_self_2, _aBlock_1) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_2, _aBlock_1"; /* console.error(errorMessage); */
    ...
    return (function (_anObject, _anotherObject) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _anObject, _anotherObject"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.addMethod(
  ...
  function (_self_2, _anObject) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_2, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_2) {
    ...
    return (function (_alpha, _beta) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _alpha, _beta"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
  ...
  function (_self) {
    ...
    return _if_3(_equalsSign_2(_numArgs_1(_self), 1), function () {
      ...
      return (function (_aCollection) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _aCollection"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self_2, _aBlock_2) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_2, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
  ...
  function (_self_2) {
    ...
    return (function (_u, _v) {
      ...
      return _if_3(_isMatrix_1(_u), function () {
        ...
        /* Temporaries */
        let __genSym1 = _assertIsOfSize_2(_shape_1(_u), 2),
          _m = _at_2(__genSym1, 1),
          _n = _at_2(__genSym1, 2);
        /* Statements */
        return _table_3(
          function (_i, _j) {
            /* ArityCheck */
        ...
        return _collect_2(_u, function (_alpha) {
          ...
          if (arguments.length !== 1) {
            const errorMessage =
              "Arity: expected 1, _alpha"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Statements */
          return _collect_2(_v, function (_beta) {
            ...
            if (arguments.length !== 1) {
              const errorMessage =
                "Arity: expected 1, _beta"; /* console.error(errorMessage); */
              throw new Error(errorMessage);
            }
            /* Statements */
...
sl.addMethod(
  ...
  function (_f_2, _g_1) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _f_2, _g_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return (function (_p, _q) {
...
sl.addMethod(
  ...
  function (_self_1, _count) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_1, _count"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return (function (_each) {
