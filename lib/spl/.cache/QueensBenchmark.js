...
sl.addMethod(
  ...
  function (_self) {
    ...
    _toDo_3(1, 10, function (_i) {
      ...
      /* Statements */
      return _result = _and_2(_result, function () {
        /* ArityCheck */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    _freeRows_2(_self, _Array_2(8, true));
    _freeMaxs_2(_self, _Array_2(16, true));
    _freeMins_2(_self, _Array_2(16, true));
    _queenRows_2(_self, _Array_2(8, -1));
    ...
    return _valueWithReturn_1(function (_return_1) {
      ...
      _toDo_3(1, 8, function (_r) {
        ...
        return _ifTrue_2(_rowColumn_3(_self, _r, _c), function () {
          ...
          _ifTrue_2(_equals_2(_c, 8), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
          ...
          _ifTrue_2(_placeQueen_2(_self, _plus_2(_c, 1)), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _r, _c) {
    ...
    /* Statements */
    return _and_2(_at_2(_freeRows_1(_self), _r), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _and_2(_at_2(_freeMaxs_1(_self), _plus_2(_c, _r)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _at_2(_freeMins_1(_self), _plus_2(_minus_2(_c, _r), 8));
      });
    });
  },
  "{ :self :r :c |\n\t\tself.freeRows[r] & {\n\t\t\tself.freeMaxs[c + r] & {\n\t\t\t\tself.freeMins[c - r + 8]\n\t\t\t}\n\t\t}\n\t}",
...
sl.addMethod(
  ...
  function (_self, _r, _c, _v) {
    ...
    _atPut_3(_freeMaxs_1(_self), _plus_2(_c, _r), _v);
    return _atPut_3(_freeMins_1(_self), _plus_2(_minus_2(_c, _r), 8), _v);
  },
