...
sl.addMethod(
  ...
  function (_self, _child) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _child"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _i, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _i, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _deepWithIndicesDo_2(_self, function (_unused, _index) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _unused, _index"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_value, _subTrees) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _value, _subTrees"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_anInteger, _anObject, _aBlock_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _anInteger, _anObject, _aBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_n, _r) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _n, _r"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _unfoldTree_3(_n, _r, function (_each) {
      ...
      /* Temporaries */
      let __genSym14 = _assertIsOfSize_2([
          _numerator_1(_each),
          _denominator_1(_each),
        ], 2),
        _a = _at_2(__genSym14, 1),
        _b = _at_2(__genSym14, 2);
      /* Statements */
      return [
...
sl.extendTraitWithMethod(
  ...
  function (_depth) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _depth"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
