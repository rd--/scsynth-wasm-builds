...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n :r | unfoldTree(n, r, { :each | let __SPL79 = assertIsOfSize([numerator(each), denominator(each)], 2); let a = at(__SPL79, 1); let b = at(__SPL79, 2); [Fraction(a, +(a, b)), Fraction(+(a, b), b)] }) }",
);
