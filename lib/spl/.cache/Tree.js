sl.addType(
  ...
  "Tree",
  "Tree",
  ["Object", "Storeable", "Equatable", "Iterable", "Indexable"],
  ["value", "subTrees"],
);
  ...
  sl.annotateFunction(function (_self, _anObject) {
    ...
    return _anySatisfy_2(
      ...
      sl.annotateFunction(function (_each) {
        ...
        return _equalsSign_2(_value_1(_each), _anObject);
      }, ["each"]),
    );
  }, ["self", "anObject"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _k = _depth_1(_self);
    let _a = _exclamationMark_2(
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
    ...
    _withLevelDo_2(
      ...
      sl.annotateFunction(function (_x, _i) {
        ...
        return _add_2(_at_2(_a, _plusSign_2(_i, 1)), _value_1(_x));
      }, ["x", "i"]),
    );
    return _a;
  }, ["self"]),
      ...
      sl.annotateFunction(function () {
        ...
        return _product_2(
          ...
          sl.annotateFunction(function (_t) {
            ...
            return _prime_1(_matulaGoebelNumber_1(_t));
          }, ["t"]),
        );
      }, []),
    );
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let _p = _primePi_1(_primeFactors_1(_n));
    return _Tree_2(_n, _collect_2(_p, _matulaGoebelTree_1));
  }, ["n"]),
  ...
  sl.annotateFunction(function (_n, _r) {
    ...
    return _unfoldTree_3(
      ...
      sl.annotateFunction(function (_each) {
        ...
        return _sternBrocotChildren_1(_each);
      }, ["each"]),
    );
  }, ["n", "r"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _first_1(_subTrees_1(_sternBrocotTree_1(_plusSign_2(_self, 1))));
  }, ["self"]),
  "{ :self |\n\t\t(self + 1)\n\t\t.sternBrocotTree\n\t\t.subTrees\n\t\t.first\n\t}",
);
  ...
  sl.annotateFunction(function (_self, _depth) {
    ...
    return _unfoldTree_3(
      ...
      sl.annotateFunction(function (_p) {
        ...
        return [[_hyphenMinus_2(_asterisk_2(2, _m), _n), _m], [
          _plusSign_2(_asterisk_2(2, _m), _n),
          _m,
        ], [_plusSign_2(_m, _asterisk_2(2, _n)), _n]];
      }, ["p"]),
    );
  }, ["self", "depth"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _collect_2(_self, _matulaGoebelTree_1);
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _collect_2(_self, _matulaGoebelNumber_1);
  }, ["self"]),
