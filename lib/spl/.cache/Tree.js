...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    let _nodeId = 1;
    let _vertexLabels = [];
    let _labeledTree = _collect_2(_self, function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
    ...
    let _edgeList = [];
    /* Statements */
    _do_2(_labeledTree, function (_i) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _i";
        throw new Error(errorMessage);
      } /* Statements */
      return _collect_2(_subTrees_1(_i), function (_j) {
        /* ArityCheck */
        if (arguments.length !== 1) {
    ...
    return _also_2(_asGraph_1(_edgeList), function (_graph) {
      /* ArityCheck */
      if (arguments.length !== 1) {
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    let _subLists = _collect_2(_subTrees_1(_self), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        throw new Error(errorMessage);
    ...
    /* Statements */
    return _ifNil_3(_value_1(_self), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _verticalLine_2(_isEmpty_1(_subTrees_1(_self)), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self, _count) {
    ...
    return _if_3(_lessThanSignEqualsSign_2(_count, 0), function () {
      ...
      return _gather_2(_subTrees_1(_self), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
          throw new Error(errorMessage);
  ...
  "{ :self :count | if((<=(count, 0)), { [self] }, { gather(subTrees(self), { :each | level(each,-(count, 1)) }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    let _answer = [];
    /* Statements */
    _collect_2(_to_2(0, _hyphenMinus_2(_depth_1(_self), 1)), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        throw new Error(errorMessage);
      } /* Statements */
      return _addAll_2(_answer, _collect_2(_level_2(_self, _each), _value_1));
    });
    return _answer;
  },
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    let _answer = [];
    /* Statements */
    _postOrderDo_2(_self, function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        throw new Error(errorMessage);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _join_2([
      ...
      ", ",
      _storeString_1(_subTrees_1(_self)),
      ")",
    ], "");
  },
  "{ :self | join(['Tree(', storeString(value(self)), ', ', storeString(subTrees(self)), ')'],'') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    _ifTrue_2(_isList_1(_at_2(_self, 1)), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
    ...
    return _Tree_2(
      _at_2(_self, 1),
      _collect_2(_allButFirst_1(_self), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
          throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    return _Tree_2(
      _key_1(_self),
      _collect_2(_value_1(_self), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
          throw new Error(errorMessage);
        } /* Statements */
        return _if_3(_isAssociation_1(_each), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_n, _r) {
    ...
    return _unfoldTree_3(_n, _r, function (_each) {
      ...
      let _a = _at_2(__SPL45, 1);
      let _b = _at_2(__SPL45, 2);
      /* Statements */
      return [
  ...
  "{ :n :r | unfoldTree(n, r, { :each | let __SPL45 = assertIsOfSize([numerator(each), denominator(each)], 2); let a = at(__SPL45, 1); let b = at(__SPL45, 2); [Fraction(a, +(a, b)), Fraction(+(a, b), b)] }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_n, _k) {
    ...
    let _t = _Tree_2(null, []);
    let _f_2 = function (_l, _i) {
      /* ArityCheck */
      if (arguments.length !== 2) {
        const errorMessage = "Arity: expected 2, _l, _i";
        throw new Error(errorMessage);
      } /* Statements */
      _do_2(_level_2(_t, _l), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
          throw new Error(errorMessage);
        ...
        return _ifTrue_2(
          _ampersand_2(_greaterThanSign_2(_i, 0), function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_depth) {
    ...
    return _unfoldTree_3(_depth, _Fraction_2(1n, 1n), function (_each) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _each";
        throw new Error(errorMessage);
      } /* Statements */
      return _if_3(_equalsSign_2(_each, _Fraction_2(1n, 1n)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_aBlock_1, _aTree, _depth) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _aBlock_1, _aTree, _depth";
      throw new Error(errorMessage);
    } /* Statements */
    return _if_3(_equalsSign_2(_depth, 0), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
      ...
      return _if_3(_isLeaf_1(_aTree), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          throw new Error(errorMessage);
        ...
        return _Tree_2(
          _value_1(_aTree),
          _collect_2(_aBlock_1(_value_1(_aTree)), function (_each) {
            /* ArityCheck */
            if (arguments.length !== 1) {
              const errorMessage = "Arity: expected 1, _each";
              throw new Error(errorMessage);
        ...
        return _nestTree_3(
          ...
          _Tree_2(
            _value_1(_aTree),
            _collect_2(_subTrees_1(_aTree), function (_each) {
              /* ArityCheck */
              if (arguments.length !== 1) {
                const errorMessage = "Arity: expected 1, _each";
                throw new Error(errorMessage);
    ...
    let _f_2 = function (_l, _i) {
      ...
      _do_2(_level_2(_t, _l), function (_each) {
        ...
        return _ifTrue_2(_greaterThanSign_2(_i, 0), function () {
          ...
          let _j = _randomInteger_4(_r, 1, _i, []);
          /* Statements */
          _subTrees_2(
            _each,
            _collect_2(_removeFirst_2(_p, _j), function (_m) {
              /* ArityCheck */
              if (arguments.length !== 1) {
