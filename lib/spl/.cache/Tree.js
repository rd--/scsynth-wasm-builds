...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n, _r) {
    ...
    return _unfoldTree_3(
      ...
      sl.annotateFunction(function (_each) {
        ...
        let __SPL82 = _assertIsOfSize_2([
          _numerator_1(_each),
          _denominator_1(_each),
        ], 2);
        let _a = _at_2(__SPL82, 1);
        let _b = _at_2(__SPL82, 2);
        /* Statements */
        return [
  ...
  "{ :n :r | unfoldTree(n, r, { :each | let __SPL82 = assertIsOfSize([numerator(each), denominator(each)], 2); let a = at(__SPL82, 1); let b = at(__SPL82, 2); [Fraction(a, +(a, b)), Fraction(+(a, b), b)] }) }",
);
