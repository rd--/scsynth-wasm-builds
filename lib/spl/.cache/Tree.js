...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n :r | unfoldTree(n, r, { :each | let __SplVar1 = assertIsOfSize([numerator(each), denominator(each)], 2); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); [Fraction(a, +(a, b)), Fraction(+(a, b), b)] }) }",
);
