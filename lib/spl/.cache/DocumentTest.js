...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _DocumentTest_3(_prefix, _program, _expectedAnswer);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _do_2(_self, function (_currentLine) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _currentLine"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      _ifTrue_2(
...
sl.addMethod(
  ...
  function (_prefix, _program, _expectedAnswer) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _prefix, _program, _expectedAnswer"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
