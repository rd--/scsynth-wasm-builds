  ...
  function (_self) {
    ...
    return _Promise_1(function (_resolve_1, _reject_1) {
      ...
      if (arguments.length !== 2) {
        const errorMessage =
          "Arity: expected 2, _resolve_1, _reject_1"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _ifNotNil_3(_value_1(_self), function (_answer) {
        ...
        return _if_3(
          ...
          function () {
            ...
            /* Statements */
            return _thenElse_3(
              _fetchMimeType_2(_url_1(_self), _mimeType_1(_self)),
              function (_answer) {
                /* ArityCheck */
                if (arguments.length !== 1) {
                  const errorMessage =
...
sl.addMethod(
  ...
  function (_name, _url, _mimeType, _parser) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _name, _url, _mimeType, _parser"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _libraryItem) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _libraryItem"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _if_3(
...
sl.extendTraitWithMethod(
  ...
  function (_self, _names) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _names"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
