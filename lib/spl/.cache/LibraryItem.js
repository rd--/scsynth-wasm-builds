...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(
      _plusPlus_2("sl/library/", _hostname_1(_url_1(_self))),
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    _postLine_1(_plusPlus_2("LibraryItem>>require", _name_1(_self)));
            ...
            return _thenElse_3(
              _fetchMimeType_5(
                ...
                function () {
                  ...
                  return _error_2(
                    _self,
                    _plusPlus_2("Fetch failed: ", _url_1(_self)),
                  );
                },
              ),
              function (_answer) {
  ...
  function (_self, _libraryItem) {
    ...
    return _if_3(
      ...
      function () {
        ...
        return _warning_2(
          _self,
          _plusPlus_2("addLibraryItem: item exists: ", _name_1(_libraryItem)),
        );
      },
      function () {
        /* ArityCheck */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _name) {
    ...
    return _if_3(_includesLibraryItem_2(_self, _name), function () {
      ...
      return _error_2(
        _self,
        _plusPlus_2("@Cache>>requireLibraryItem: does not exist: ", _name),
      );
    });
  },
