...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString) {
    ...
    return _uncheckedExec_2(_self, _aString);
  }, ["self", "aString"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString) {
    ...
    _assertIsString_1(_aString);
    return _uncheckedExecIndices_2(_self, _aString);
  }, ["self", "aString"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString) {
    ...
    _assertIsString_1(_aString);
    return _uncheckedMatchAll_2(_self, _aString);
  }, ["self", "aString"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString, _replacementString) {
    ...
    return _uncheckedReplaceWith_3(_self, _aString, _replacementString);
  }, ["self", "aString", "replacementString"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString, _aBlock_1) {
    ...
    _assertIsString_1(_aString);
    return _uncheckedReplaceWith_3(
      _self,
      _aString,
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString, _replacementString) {
    ...
    _assertIsString_1(_aString);
    _assertIsString_1(_replacementString);
    return _uncheckedReplaceAllWith_3(_self, _aString, _replacementString);
  }, ["self", "aString", "replacementString"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString, _aBlock_1) {
    ...
    _assertIsString_1(_aString);
    return _uncheckedReplaceAllWith_3(
      _self,
      _aString,
      sl.annotateFunction(function (_match, _offset, _string) {
        /* ArityCheck */
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString) {
    ...
    _assertIsString_1(_aString);
    return _uncheckedSearch_2(_self, _aString);
  }, ["self", "aString"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aString) {
    ...
    _assertIsString_1(_aString);
    return _uncheckedSplit_2(_self, _aString);
  }, ["self", "aString"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _collect_2(
      _sortedCounts_1(_Multiset_1(_words_1(_self))),
      sl.annotateFunction(function (_each) {
        ...
        return _hyphenMinusGreaterThanSign_2(_value_1(_each), _key_1(_each));
      }, ["each"]),
    );
  }, ["self"]),
