...
return _if_3(_isArray_1(_self), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Temporaries */
let __SplVar1 = _assertIsOfSize_2(_take_2(_shape_1(_self), 4), 4);let _r = _at_2(__SplVar1, 1);let _c = _at_2(__SplVar1, 2);let _i = _at_2(__SplVar1, 3);let _j = _at_2(__SplVar1, 4);let _n = _asterisk_2(_r, _i);let _m = _asterisk_2(_c, _j);let _p = 1;let _answer = _List_1(_n);
/* Statements */
_toDo_3(1, _r, sl.annotateFunction(function(_w) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _w';
	throw new Error(errorMessage);
}/* Statements */
return _toDo_3(1, _i, sl.annotateFunction(function(_x) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _x';
	throw new Error(errorMessage);
}/* Temporaries */
let _row = _List_1(_m);let _q = 1;
/* Statements */
_atPut_3(_answer, _p, _row); _p = _plusSign_2(_p, 1); return _toDo_3(1, _c, sl.annotateFunction(function(_y) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _y';
	throw new Error(errorMessage);
}/* Statements */
return _toDo_3(1, _j, sl.annotateFunction(function(_z) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _z';
	throw new Error(errorMessage);
}/* Statements */
_atPut_3(_row, _q, _at_2(_at_2(_at_2(_at_2(_self, _w), _y), _x), _z)); return _q = _plusSign_2(_q, 1);;
}, ["z"]));
}, ["y"]));;;
}, ["x"]));
}, ["w"])); return _answer;;
...
return _assert_2(_self, sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
let __SplVar2 = _assertIsOfSize_2(_shape_1(_bounds), 2);let _m = _at_2(__SplVar2, 1);let _n = _at_2(__SplVar2, 2);
/* Statements */
...
return _tuplesArray_1(_withCollect_3(((_each_1(_plusSign_2)(_rangeList, _offset))), _stepList, sl.annotateFunction(function(_range, _step) {
/* ArityCheck */
if(arguments.length !== 2) {
	const errorMessage = 'Arity: expected 2, _range, _step';
	throw new Error(errorMessage);
}/* Temporaries */
let __SplVar3 = _assertIsOfSize_2(_range, 2);let _l = _at_2(__SplVar3, 1);let _r = _at_2(__SplVar3, 2);
/* Statements */
...
return _tuples_1(_withCollect_3(((_each_1(_plusSign_2)(_rangeList, _offset))), _stepList, sl.annotateFunction(function(_range, _step) {
/* ArityCheck */
if(arguments.length !== 2) {
	const errorMessage = 'Arity: expected 2, _range, _step';
	throw new Error(errorMessage);
}/* Temporaries */
let __SplVar4 = _assertIsOfSize_2(_range, 2);let _l = _at_2(__SplVar4, 1);let _r = _at_2(__SplVar4, 2);
/* Statements */
return _asList_1(_nonemptyThenTo_3(_l, _plusSign_2(_l, _step), _r));
}, ["range","step"])));
}, ["rangeList","stepList","offset"]),
...
return _if_3((_lessThanSign_2(_anInteger, 1)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
let _answer = [];
/* Statements */
_add_2(_answer, _size_1(_self)); _ifTrue_2((_ampersand_2(_isNotEmpty_1(_self), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
/* Statements */
return _ifTrue_2(_allSatisfy_2(_self, sl.annotateFunction(function(_each) {
/* ArityCheck */
if(arguments.length !== 1) {
...
}, ["each"])), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Statements */
return _addAll_2(_answer, _dimensions_2(_anyOne_1(_self), _hyphenMinus_2(_anInteger, 1)));
}, []));
}, [])); return _answer;;;
}, []));
}, ["self","anInteger"]),
...
return _if_3(_isVector_1(_self), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _if_3(_isMatrix_1(_self), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
/* Statements */
_toDo_3(1, _hyphenMinus_2(_depth_1(_self), 2), sl.annotateFunction(function(_i) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _i';
	throw new Error(errorMessage);
}/* Statements */
return _add_2(_answer, _max_1(_collect_2(_level_2(_self, [_i]), sl.annotateFunction(function(_each) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _each';
	throw new Error(errorMessage);
...
/* Statements */
return _ampersand_2(_isNotNil_1(_rho), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Statements */
return _ampersand_2(_equalsSign_2(_size_1(_rho), _depth), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _ampersand_2(_equalsSign_2(_shape_1(_self), _shape_1(_other)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _ampersand_2(_equalsSign_2(_arrayDepth_1(_self), 2), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _allSatisfy_2(_self, sl.annotateFunction(function(_each) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _each';
	throw new Error(errorMessage);
}/* Statements */
return _ampersand_2(_not_1(_isList_1(_each)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
let _affix = _List_2(_hyphenMinus_2(_abs_1(_at_2(_shape, 1)), _size_1(_self)), _anObject);let _next = _if_3(_isNegative_1(_at_2(_shape, 1)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
/* Statements */
return _if_3((_equalsSign_2(_size_1(_shape), 1)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
/* Statements */
return _collect_2(_next, sl.annotateFunction(function(_each) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _each';
	throw new Error(errorMessage);
...
return _if_3((_verticalLine_2(_isEmpty_1(_self), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
let _next = _collect_2(_to_2(1, _at_2(_shape, 1)), sl.annotateFunction(function(_i) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _i';
	throw new Error(errorMessage);
...
/* Statements */
return _if_3((_equalsSign_2(_shape, _collect_2(_indices, _size_1))), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Temporaries */
let _i = _tuples_1(_indices);let _j = _tuples_1(_collect_2(_shape, sl.annotateFunction(function(_n) {
/* ArityCheck */
if(arguments.length !== 1) {
...
/* Statements */
return _withDo_3(_i, _j, sl.annotateFunction(function(_p, _q) {
/* ArityCheck */
if(arguments.length !== 2) {
...
_reverseDo_2(_allButFirst_1(_shape), sl.annotateFunction(function(_n) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _n';
	throw new Error(errorMessage);
...
return _if_3((_equalsSign_2(_size_1(_self), 0)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
let _type = _typeOf_1(_self);let _elementTypes = _elementTypes_1(_self);
/* Statements */
return _if_3(_allSatisfy_2(_elementTypes, sl.annotateFunction(function(_each) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _each';
	throw new Error(errorMessage);
...
/* Statements */
return _if_3((_equalsSign_2(_size_1(_nub_1(_elementShapes)), 1)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Statements */
return _plusSignPlusSign_2([_size_1(_self)], _first_1(_elementShapes));
}, []), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
...
return _if_3(_includes_2(_elementTypes, _type), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _ifNil_3(_shapeOrNil_1(_self), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _if_3(_isEmpty_1(_self), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
/* Statements */
return _if_3(_isList_1(_leftmost), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Statements */
return _plusSignPlusSign_2([_size_1(_self)], _shapeUnchecked_1(_leftmost));
}, []), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
...
let _k = _size_1(_indices);let _i = _at_2(_indices, 1);let _a = _atAll_2(_self, _i);
/* Statements */
return _if_3((_equalsSign_2(_k, 1)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
/* Statements */
return _collect_2(_a, sl.annotateFunction(function(_each) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _each';
	throw new Error(errorMessage);
...
let __SplVar5 = _assertIsOfSize_2(_z, 2);let _m = _at_2(__SplVar5, 1);let _n = _at_2(__SplVar5, 2);let _k = _size_1(_self);
/* Statements */
return _collect_2(_to_2(1, _plusSign_2(_k, _sum_1(_z))), sl.annotateFunction(function(_i) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _i';
	throw new Error(errorMessage);
...
/* Statements */
return _if_3(_betweenAnd_3(_d, 1, _k), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
let __SplVar6 = _assertIsOfSize_2(_z, 2);let _m = _at_2(__SplVar6, 1);let _n = _at_2(__SplVar6, 2);let __SplVar7 = _assertIsOfSize_2(_shape_1(_self), 2);let _a = _at_2(__SplVar7, 1);let _b = _at_2(__SplVar7, 2);let _p = _plusSign_2(_sum_1(_m), _a);let _q = _plusSign_2(_sum_1(_n), _b);
/* Statements */
return _table_3(sl.annotateFunction(function(_i, _j) {
/* ArityCheck */
if(arguments.length !== 2) {
	const errorMessage = 'Arity: expected 2, _i, _j';
	throw new Error(errorMessage);
}/* Temporaries */
let _d = _hyphenMinus_2(_i, _at_2(_m, 1));let _e = _hyphenMinus_2(_j, _at_2(_n, 1));
/* Statements */
return _if_3((_ampersand_2(_betweenAnd_3(_d, 1, _a), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
	...
	'Array',
	'arrayReshape',
	["self","shape","missingValue"],
	sl.annotateFunction(function(_self, _shape, _missingValue) {
/* ArityCheck */
if(arguments.length !== 3) {
	const errorMessage = 'Arity: expected 3, _self, _shape, _missingValue';
	throw new Error(errorMessage);
}/* Temporaries */
let _m = _size_1(_self);let _n = _product_1(_shape);
/* Statements */
return _if_3((_equalsSign_2(_m, _n)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Statements */
return _reshape_2(_self, _shape);
}, []), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
...
return _if_3((_lessThanSign_2(_m, _n)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Statements */
return _reshape_2((_plusSignPlusSign_2(_flatten_1(_self), _List_2(_hyphenMinus_2(_n, _m), _missingValue))), _shape);
}, []), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
...
return _error_2(_self, 'arrayReshape');
}, []));
}, []));
}, ["self","shape","missingValue"]),
...
return _arrayReshape_3(_self, _shape, null);
}, ["self","shape"]),
...
let _m = _size_1(_a);let _t = _triangularArray_2(_to_2(1, _m), sl.annotateFunction(function(_i, _j) {
/* ArityCheck */
if(arguments.length !== 2) {
	const errorMessage = 'Arity: expected 2, _i, _j';
	throw new Error(errorMessage);
...
/* Statements */
_triangularArrayDo_3(_to_2(1, _m), sl.annotateFunction(function(_k, _n) {
/* ArityCheck */
if(arguments.length !== 2) {
	const errorMessage = 'Arity: expected 2, _k, _n';
	throw new Error(errorMessage);
}/* Statements */
return _ifTrue_2((_exclamationMarkEqualsSign_2(_n, 1)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Statements */
return _atPut_3(_at_2(_t, _k), _n, _plusSign_2(_at_2(_at_2(_t, _k), _hyphenMinus_2(_n, 1)), _at_2(_at_2(_t, _hyphenMinus_2(_k, 1)), _plusSign_2(_hyphenMinus_2(_k, _n), 1))));
}, []));
}, ["k","n"]), 0); return _t;;
}, ["a"]),
...
let _count = _product_1(_shape);let _end = _plusSign_2(_start, (_asterisk_2(_hyphenMinus_2(_count, 1), _step)));
/* Statements */
...
return _ampersand_2(_isVector_1(_self), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _ifEmpty_3(_shape, sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _reshapeList_2(_wrapExtend_2(_flatten_1(_self), _product_1(_shape)), _shape);
}, []));
}, ["self","shape"]),
...
let _index = 1;let _items = _flatten_1(_self);
/* Statements */
return _deepCollect_2(_another, sl.annotateFunction(function(_unusedItem) {
/* ArityCheck */
if(arguments.length !== 1) {
...
/* Statements */
_index = _plusSign_2(_index, 1); return _item;;
}, ["unusedItem"]));
}, ["self","another"]),
...
sl.extendTypeOrTraitWithMethod(
	...
	'antidiagonalArray',
	["n","f:/2"],
	sl.annotateFunction(function(_n, _f_2) {
/* ArityCheck */
if(arguments.length !== 2) {
	const errorMessage = 'Arity: expected 2, _n, _f_2';
	throw new Error(errorMessage);
}/* Statements */
...
return _collect_2(_rangeOrRelativeRange_3(1, _i, 1), sl.annotateFunction(function(_j) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _j';
	throw new Error(errorMessage);
}/* Statements */
return _f_2(_j, _plusSign_2(_hyphenMinus_2(_i, _j), 1));
}, ["j"]));
}, ["i"]));
}, ["n","f:/2"]),
	"{ :n :f:/2 |\n\t\t1:n.collect { :i |\n\t\t\t1:i.collect { :j |\n\t\t\t\tf(j, i - j + 1)\n\t\t\t}\n\t\t}\n\t}"
...
let _end = _plusSign_2(_start, (_asterisk_2(_hyphenMinus_2(_count, 1), _step)));
/* Statements */
...
let _size = _plusSign_2(_asterisk_2(_range, 2), 1);let _length = _hyphenMinus_2((_circumflexAccent_2(_size, _dimensions)), 1);let _neighbors = [];
/* Statements */
_toDo_3(0, _hyphenMinus_2(_length, 1), sl.annotateFunction(function(_i) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _i';
	throw new Error(errorMessage);
}/* Temporaries */
let _neighbor = _List_1(_dimensions);let _index = _if_3((_lessThanSign_2(_i, (_solidus_2(_length, 2)))), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
/* Statements */
_add_2(_neighbors, _neighbor); return _toDo_3(1, _dimensions, sl.annotateFunction(function(_d) {
/* ArityCheck */
if(arguments.length !== 1) {
...
/* Statements */
_atPut_3(_neighbor, _d, _hyphenMinus_2(_solidus_2(_value, (_circumflexAccent_2(_size, (_hyphenMinus_2(_d, 1))))), _range)); return _index = _hyphenMinus_2(_index, _value);;
}, ["d"]));;
}, ["i"])); return _neighbors;;
}, ["dimensions","range"]),
...
let _size = _plusSign_2(_asterisk_2(_range, 2), 1);let _iterations = _circumflexAccent_2(_size, _dimensions);let _center = _solidus_2((_hyphenMinus_2(_iterations, 1)), 2);let _neighbors = [];
/* Statements */
_toDo_3(0, _hyphenMinus_2(_iterations, 1), sl.annotateFunction(function(_i) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _i';
	throw new Error(errorMessage);
}/* Statements */
return _ifFalse_2((_equalsSign_2(_i, _center)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
}/* Temporaries */
let _neighbor = _List_1(_dimensions);let _distance = 0;let _remaining = _i;
/* Statements */
_toDo_3(0, _hyphenMinus_2(_dimensions, 1), sl.annotateFunction(function(_d) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _d';
	throw new Error(errorMessage);
}/* Temporaries */
let _remainder = _percentSign_2(_remaining, (_circumflexAccent_2(_size, (_plusSign_2(_d, 1)))));let _value = _hyphenMinus_2(_solidus_2(_remainder, (_circumflexAccent_2(_size, _d))), _range);
/* Statements */
_atPut_3(_neighbor, _plusSign_2(_d, 1), _value); _distance = _plusSign_2(_distance, _abs_1(_value)); return _remaining = _hyphenMinus_2(_remaining, _remainder);;;
}, ["d"])); return _ifTrue_2((_lessThanSignEqualsSign_2(_distance, _range)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _if_3((_equalsSign_2(_anInteger, 1)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _if_3((_equalsSign_2(_anInteger, 2)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
return _if_3((_equalsSign_2(_k, 0)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
...
/* Statements */
return _do_2(_self, sl.annotateFunction(function(_n) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _n';
	throw new Error(errorMessage);
}/* Statements */
return _toDo_3(_a, _max_2(_a, _plusSign_2(_n, _k)), sl.annotateFunction(function(_m) {
/* ArityCheck */
if(arguments.length !== 1) {
...
let _a = _at_2(_self, 1);
/* Statements */
return _collect_2(_self, sl.annotateFunction(function(_n) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _n';
	throw new Error(errorMessage);
}/* Statements */
return _collect_2(_to_2(_a, _max_2(_a, _plusSign_2(_n, _k))), sl.annotateFunction(function(_m) {
/* ArityCheck */
if(arguments.length !== 1) {
	const errorMessage = 'Arity: expected 1, _m';
	throw new Error(errorMessage);
...
let _k = _size_1(_self);let _l = _collect_2(_self, _size_1);
/* Statements */
return _verticalLine_2(_hasEqualElements_2(_l, _Range_3(1, _k, 1)), sl.annotateFunction(function() {
/* ArityCheck */
if(arguments.length !== 0) {
	const errorMessage = 'Arity: expected 0, ';
	throw new Error(errorMessage);
