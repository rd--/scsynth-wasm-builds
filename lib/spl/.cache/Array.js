...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _z, _o) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL2 = _assertIsOfSize_2(_z, 2);
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL3 = _assertIsOfSize_2(_z, 2);
  ...
  "{ :self :z :o | if(isVector(self), { let __SPL2 = assertIsOfSize(z, 2); let m = at(__SPL2, 1); let n = at(__SPL2, 2); let k = size(self); collect(upOrDownTo(1, +(k, sum(z))), { :i | let d = -(i, m); if(betweenAnd(d,1, k), { at(self, d) }, { o }) }) }, { if(isMatrix(self), { let __SPL3 = assertIsOfSize(z, 2); let m = at(__SPL3, 1); let n = at(__SPL3, 2); let __SPL4 = assertIsOfSize(shape(self), 2); let a = at(__SPL4, 1); let b = at(__SPL4, 2); let p = +(sum(m), a); let q = +(sum(n), b); table({ :i :j | let d = -(i, at(m, 1)); let e = -(j, at(n, 1)); if((&(betweenAnd(d,1, a), { betweenAnd(e,1, b) })), { at(at(self, d), e) }, { o }) },Span(1, p, 1), Span(1, q, 1)) }, { error(self,'arrayPad') }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_bounds, _steps, _offset) {
    ...
    let __SPL5 = _assertIsOfSize_2(_shape_1(_bounds), 2);
    let _m = _at_2(__SPL5, 1);
    let _n = _at_2(__SPL5, 2);
    /* Statements */
    return _coordinateBoundsArray_3(_transpose_1(_bounds), _steps, _offset);
  }, ["bounds", "steps", "offset"]),
  "{ :bounds :steps :offset | let __SPL5 = assertIsOfSize(shape(bounds), 2); let m = at(__SPL5, 1); let n = at(__SPL5, 2); coordinateBoundsArray(transpose(bounds),steps, offset) }",
);
...
sl.extendTypeOrTraitWithMethod(
    ...
    return _tuplesArray_1(
      _withCollect_3(
        ...
        sl.annotateFunction(function (_range, _step) {
          ...
          let __SPL6 = _assertIsOfSize_2(_range, 2);
          let _l = _at_2(__SPL6, 1);
  ...
  "{ :rangeList :stepList :offset | tuplesArray(withCollect(((each(+) . (rangeList, offset))), stepList, { :range :step | let __SPL6 = assertIsOfSize(range, 2); let l = at(__SPL6, 1); let r = at(__SPL6, 2); asList(thenTo(l, +(l, step), r)) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
    ...
    return _tuples_1(
      _withCollect_3(
        ...
        sl.annotateFunction(function (_range, _step) {
          ...
          let __SPL7 = _assertIsOfSize_2(_range, 2);
  ...
  "{ :rangeList :stepList :offset | tuples(withCollect(((each(+) . (rangeList, offset))), stepList, { :range :step | let __SPL7 = assertIsOfSize(range, 2); let l = at(__SPL7, 1); let r = at(__SPL7, 2); asList(thenTo(l, +(l, step), r)) })) }",
);
