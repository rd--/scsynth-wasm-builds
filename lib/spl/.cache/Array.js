...
sl.extendTypeOrTraitWithMethod(
    ...
    return _tuples_1(
      _withCollect_3(
        ...
        sl.annotateFunction(function (_range, _step) {
          ...
          let __SPL5 = _assertIsOfSize_2(_range, 2);
          let _l = _at_2(__SPL5, 1);
  ...
  "{ :rangeList :stepList :offset | tuples(withCollect(((each(+) . (rangeList, offset))), stepList, { :range :step | let __SPL5 = assertIsOfSize(range, 2); let l = at(__SPL5, 1); let r = at(__SPL5, 2); asList(thenTo(l, +(l, step), r)) })) }",
);
