    ...
    return _ampersand_2(
      ...
      sl.annotateFunction(function () {
        ...
        return _allSatisfy_2(
          _triangularDifferenceTable_1(_self),
          _isDuplicateFree_1,
        );
      }, []),
    );
  ...
  sl.annotateFunction(function (_self, _shape, _anObject) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _length = _abs_1(_at_2(_shape, 1));
        let _affixSize = _max_2(_hyphenMinus_2(_length, _size_1(_self)), 0);
        let _affix = _List_2(_affixSize, _anObject);
        let _prefix = _if_3(
          _lessThanSign_2(_length, _size_1(_self)),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
        ...
        let _next = _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _plusSignPlusSign_2(_affix, _prefix);
          }, []),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
            ...
            return _plusSignPlusSign_2(_prefix, _affix);
          }, []),
        );
        return _if_3(
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    _assertIsOfSize_2(_self, _product_1(_shape));
    _reverseDo_2(
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _anInteger) {
    ...
    return _reshape_2(_self, _rotateLeft_2(_shape_1(_self), _anInteger));
  }, ["self", "anInteger"]),
  ...
  sl.annotateFunction(function (_a) {
    ...
    return _toCollect_3(
      ...
      sl.annotateFunction(function (_c) {
        ...
        return _toCollect_3(
          1,
          _plusSign_2(_hyphenMinus_2(_k, _c), 1),
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _reshape_2(
              _plusSignPlusSign_2(
                _flatten_1(_self),
                _List_2(_hyphenMinus_2(_n, _m), _missingValue),
              ),
              _shape,
            );
          }, []),
  ...
  sl.annotateFunction(function (_n, _f_2) {
    ...
    return _collect_2(
      ...
      sl.annotateFunction(function (_i) {
        ...
        return _collect_2(
          _rangeOrRelativeRange_3(1, _i, 1),
  ...
  sl.annotateFunction(function (_self, _f_2) {
    ...
    return _collect_2(
      ...
      sl.annotateFunction(function (_i) {
        ...
        return _collect_2(
          _rangeOrRelativeRange_3(_a, _i, 1),
          sl.annotateFunction(function (_j) {
            /* ArityCheck */
            if (arguments.length !== 1) {
              const errorMessage = "Arity: expected 1, _j";
            ...
            return _f_2(_j, _plusSign_2(_hyphenMinus_2(_i, _j), _a));
          }, ["j"]),
        );
      }, ["i"]),
    );
