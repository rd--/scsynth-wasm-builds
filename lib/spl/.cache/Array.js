...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _z, _o) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SplVar2 = _assertIsOfSize_2(_z, 2);
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SplVar3 = _assertIsOfSize_2(_z, 2);
  ...
  "{ :self :z :o | if(isVector(self), { let __SplVar2 = assertIsOfSize(z, 2); let m = at(__SplVar2, 1); let n = at(__SplVar2, 2); let k = size(self); collect(upOrDownTo(1, +(k, sum(z))), { :i | let d = -(i, m); if(betweenAnd(d,1, k), { at(self, d) }, { o }) }) }, { if(isMatrix(self), { let __SplVar3 = assertIsOfSize(z, 2); let m = at(__SplVar3, 1); let n = at(__SplVar3, 2); let __SplVar4 = assertIsOfSize(shape(self), 2); let a = at(__SplVar4, 1); let b = at(__SplVar4, 2); let p = +(sum(m), a); let q = +(sum(n), b); table({ :i :j | let d = -(i, at(m, 1)); let e = -(j, at(n, 1)); if((&(betweenAnd(d,1, a), { betweenAnd(e,1, b) })), { at(at(self, d), e) }, { o }) },Span(1, p, 1), Span(1, q, 1)) }, { error(self,'arrayPad') }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_bounds, _steps, _offset) {
    ...
    let __SplVar5 = _assertIsOfSize_2(_shape_1(_bounds), 2);
    let _m = _at_2(__SplVar5, 1);
    let _n = _at_2(__SplVar5, 2);
    /* Statements */
    return _coordinateBoundsArray_3(_transpose_1(_bounds), _steps, _offset);
  }, ["bounds", "steps", "offset"]),
  "{ :bounds :steps :offset | let __SplVar5 = assertIsOfSize(shape(bounds), 2); let m = at(__SplVar5, 1); let n = at(__SplVar5, 2); coordinateBoundsArray(transpose(bounds),steps, offset) }",
);
...
sl.extendTypeOrTraitWithMethod(
    ...
    return _tuplesArray_1(
      _withCollect_3(
        ...
        sl.annotateFunction(function (_range, _step) {
          ...
          let __SplVar6 = _assertIsOfSize_2(_range, 2);
  ...
  "{ :rangeList :stepList :offset | tuplesArray(withCollect(((each(+) . (rangeList, offset))), stepList, { :range :step | let __SplVar6 = assertIsOfSize(range, 2); let l = at(__SplVar6, 1); let r = at(__SplVar6, 2); asList(thenTo(l, +(l, step), r)) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
    ...
    return _tuples_1(
      _withCollect_3(
        ...
        sl.annotateFunction(function (_range, _step) {
          ...
          let __SplVar7 = _assertIsOfSize_2(_range, 2);
  ...
  "{ :rangeList :stepList :offset | tuples(withCollect(((each(+) . (rangeList, offset))), stepList, { :range :step | let __SplVar7 = assertIsOfSize(range, 2); let l = at(__SplVar7, 1); let r = at(__SplVar7, 2); asList(thenTo(l, +(l, step), r)) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :anInteger | if((<(anInteger, 1)), { [] }, { let answer = []; add(answer,size(self)); ifTrue((&(isNotEmpty(self), { allSatisfy(self,isSequenceable:/1) })), { let k = size(anyOne(self)); ifTrue(allSatisfy(self, { :each | =(size(each), k) }), { addAll(answer,dimensions(anyOne(self),-(anInteger, 1))) }) }); answer }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :depth :aBlock:/1 | let rho = shapeOrNil(self); &(isNotNil(rho), { &(=(size(rho), depth), { deepAllSatisfy(self,aBlock:/1) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :depth | let rho = shapeOrNil(self); &(isNotNil(rho), { =(size(rho), depth) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/1 | isArray(self,2, aBlock:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isEmpty(self), { 1 }, { foldRight(self,outerProduct:/2) }) }",
);
