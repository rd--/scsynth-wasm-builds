...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_bounds, _steps, _offset) {
    ...
    /* Statements */
    return _coordinateBoundsArray_3(_transposed_1(_bounds), _steps, _offset);
  }, ["bounds", "steps", "offset"]),
  "{ :bounds :steps :offset | let __SPL5 = assertIsOfSize(shape(bounds), 2); let m = at(__SPL5, 1); let n = at(__SPL5, 2); coordinateBoundsArray(transposed(bounds),steps, offset) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _collect_2(_self, _reversed_1);
          }, []),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
  ...
  "{ :self | if(isVector(self), { reversed(self) }, { if(isMatrix(self), { collect(self,reversed:/1) }, { collect(self,flipLeftRight:/1) }) }) }",
);
