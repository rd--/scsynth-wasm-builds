...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    /* Statements */
    return _error_2(_self, _plusPlus_2("at: unknown key: ", _aString));
  },
...
sl.addMethod(
  ...
  function (_self, _aString, _anObject) {
    ...
    return _error_2(
      _self,
      _plusPlus_2("atPut key not a string: ", _typeOf_1(_aString)),
    );
  },
  ...
  function (_self) {
    ...
    return _if_3(
      ...
      function () {
        ...
        /* Statements */
        return _recordFromTwoElementArrays_1(_collect_2(_self, _asArray_1));
      },
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        /* Statements */
        return _error_2(_self, "Array>>asRecord: not all keys are strings");
      },
    );
  },
