...
sl.addMethodToExistingType(
  ...
  "{ :self :fractionalHour | let theta = *(/(-(fractionalHour, 3), 12), pi(2)); p2(hourHand(self), PolarCoordinates([55, negate(theta)])) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :minute | let theta = *(/(-(minute, 15), 60), pi(2)); p2(minuteHand(self), PolarCoordinates([80, negate(theta)])) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :second | let theta = *(/(-(second, 15), 60), pi(2)); p2(secondHand(self), PolarCoordinates([85, negate(theta)])) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | let dateAndTime = asDateAndTime(now(system)); moveHourHand(self,+(hour(dateAndTime), (/(minute(dateAndTime), 60)))); moveMinuteHand(self,minute(dateAndTime)); moveSecondHand(self,second(dateAndTime)) }",
);
