...
sl.addMethod(
  ...
  function (_self, _fractionalHour) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _fractionalHour"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _theta = _asterisk_2(
...
sl.addMethod(
  ...
  function (_self, _minute) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _minute"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _theta = _asterisk_2(
...
sl.addMethod(
  ...
  function (_self, _second) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _second"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _theta = _asterisk_2(
      _asterisk_2(_solidus_2(_hyphenMinus_2(_second, 15), 60), 2),
      _pi,
    );
    /* Statements */
    return _p2_2(
