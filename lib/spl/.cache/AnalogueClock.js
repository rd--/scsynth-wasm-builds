...
sl.addMethod(
  ...
  function (_self) {
    ...
    _appendChildren_2(
      _group,
      _collect_2(_asArray_1(_upOrDownTo_2(1, 12)), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        /* Temporaries */
        let _theta = _times_2(
          _times_2(_dividedBy_2(_minus_2(_each, 3), 12), 2),
          _pi,
        );
        let _point = _PolarCoordinate_2(80, _theta);
...
sl.addMethod(
  ...
  function (_self, _fractionalHour) {
    ...
    /* Temporaries */
    let _theta = _times_2(
      _times_2(_dividedBy_2(_minus_2(_fractionalHour, 3), 12), 2),
      _pi,
    );
    /* Statements */
    return _p2_2(
      _hourHand_1(_self),
      _PolarCoordinate_2(55, _negated_1(_theta)),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _minute) {
    ...
    /* Temporaries */
    let _theta = _times_2(
      _times_2(_dividedBy_2(_minus_2(_minute, 15), 60), 2),
      _pi,
    );
    /* Statements */
    return _p2_2(
      _minuteHand_1(_self),
      _PolarCoordinate_2(80, _negated_1(_theta)),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _minute) {
    ...
    return _p2_2(
      _secondHand_1(_self),
      _PolarCoordinate_2(85, _negated_1(_theta)),
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let _dateAndTime = _Date_1(_system);
    /* Statements */
    _moveHourHand_2(
      _self,
      _plus_2(
        _hours_1(_dateAndTime),
        _dividedBy_2(_minutes_1(_dateAndTime), 60),
      ),
    );
    _moveMinuteHand_2(_self, _minutes_1(_dateAndTime));
    return _moveSecondHand_2(_self, _seconds_1(_dateAndTime));
  },
