    ...
    _appendChildren_2(
      ...
      _collect_2(_asList_1(_upOrDownTo_2(1, 12)), function (_each) {
        ...
        let _theta = _asterisk_2(
          _asterisk_2(_solidus_2(_hyphenMinus_2(_each, 3), 12), 2),
          _pi,
        );
...
sl.addMethod(
  ...
  function (_self, _fractionalHour) {
    ...
    /* Temporaries */
    let _theta = _asterisk_2(
      _asterisk_2(_solidus_2(_hyphenMinus_2(_fractionalHour, 3), 12), 2),
      _pi,
    );
    /* Statements */
    return _p2_2(
...
sl.addMethod(
  ...
  function (_self, _minute) {
    ...
    /* Temporaries */
    let _theta = _asterisk_2(
      _asterisk_2(_solidus_2(_hyphenMinus_2(_minute, 15), 60), 2),
      _pi,
    );
    /* Statements */
    return _p2_2(
  ...
  function (_self) {
    ...
    _moveHourHand_2(
      ...
      _plusSign_2(
        ...
        _solidus_2(_minutes_1(_dateAndTime), 60),
      ),
    );
