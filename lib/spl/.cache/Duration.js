...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym7 = _assertIsOfSize_2(_parseIso8601DurationAsList_1(_self), 7),
      _years = _at_2(__genSym7, 1),
      _months = _at_2(__genSym7, 2),
      _weeks = _at_2(__genSym7, 3),
      _days = _at_2(__genSym7, 4),
      _hours = _at_2(__genSym7, 5),
      _minutes = _at_2(__genSym7, 6),
      _seconds = _at_2(__genSym7, 7);
    /* Statements */
    return _if_3(
