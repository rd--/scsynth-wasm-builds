...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym54 = _assertIsOfSize_2(_parseIso8601DurationAsList_1(_self), 7),
      _years = _at_2(__genSym54, 1),
      _months = _at_2(__genSym54, 2),
      _weeks = _at_2(__genSym54, 3),
      _days = _at_2(__genSym54, 4),
      _hours = _at_2(__genSym54, 5),
      _minutes = _at_2(__genSym54, 6),
      _seconds = _at_2(__genSym54, 7);
    /* Statements */
    return _if_3(
