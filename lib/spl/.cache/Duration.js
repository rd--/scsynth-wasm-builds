...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym14 = _assertIsOfSize_2(_parseIso8601DurationAsList_1(_self), 7),
      _years = _at_2(__genSym14, 1),
      _months = _at_2(__genSym14, 2),
      _weeks = _at_2(__genSym14, 3),
      _days = _at_2(__genSym14, 4),
      _hours = _at_2(__genSym14, 5),
      _minutes = _at_2(__genSym14, 6),
      _seconds = _at_2(__genSym14, 7);
    /* Statements */
    return _if_3(
