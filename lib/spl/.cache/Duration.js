...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym230 = _assertIsOfSize_2(
        _parseIso8601DurationAsList_1(_self),
        7,
      ),
      _years = _at_2(__genSym230, 1),
      _months = _at_2(__genSym230, 2),
      _weeks = _at_2(__genSym230, 3),
      _days = _at_2(__genSym230, 4),
      _hours = _at_2(__genSym230, 5),
      _minutes = _at_2(__genSym230, 6),
      _seconds = _at_2(__genSym230, 7);
    /* Statements */
    return _if_3(
