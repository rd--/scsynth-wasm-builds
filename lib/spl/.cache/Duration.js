...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    return _ampersand_2(_isDuration_1(_anObject), function () {
      ...
      /* Statements */
      return _equalsSign_2(_seconds_1(_self), _seconds_1(_anObject));
    });
  },
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    return _ampersand_2(_isDuration_1(_anObject), function () {
      ...
      /* Statements */
      return _tilde_2(_seconds_1(_self), _seconds_1(_anObject));
    });
  },
  "{ :self :anObject |\n\t\tanObject.isDuration & {\n\t\t\tself.seconds ~ anObject.seconds\n\t\t}\n\t}",
);
...
sl.addMethod(
  ...
  function (_self_0, _delay) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self_0, _delay"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _delay, _anObject) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_1, _delay, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym133 = _assertIsOfSize_2(
        _parseIso8601DurationAsList_1(_self),
        7,
      ),
      _years = _at_2(__genSym133, 1),
      _months = _at_2(__genSym133, 2),
      _weeks = _at_2(__genSym133, 3),
      _days = _at_2(__genSym133, 4),
      _hours = _at_2(__genSym133, 5),
      _minutes = _at_2(__genSym133, 6),
      _seconds = _at_2(__genSym133, 7);
    /* Statements */
    return _if_3(
