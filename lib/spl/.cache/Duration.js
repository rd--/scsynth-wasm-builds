...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym134 = _assertIsOfSize_2(
        _parseIso8601DurationAsList_1(_self),
        7,
      ),
      _years = _at_2(__genSym134, 1),
      _months = _at_2(__genSym134, 2),
      _weeks = _at_2(__genSym134, 3),
      _days = _at_2(__genSym134, 4),
      _hours = _at_2(__genSym134, 5),
      _minutes = _at_2(__genSym134, 6),
      _seconds = _at_2(__genSym134, 7);
    /* Statements */
    return _if_3(
