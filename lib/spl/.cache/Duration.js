...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym34 = _assertIsOfSize_2(_parseIso8601DurationAsList_1(_self), 7),
      _years = _at_2(__genSym34, 1),
      _months = _at_2(__genSym34, 2),
      _weeks = _at_2(__genSym34, 3),
      _days = _at_2(__genSym34, 4),
      _hours = _at_2(__genSym34, 5),
      _minutes = _at_2(__genSym34, 6),
      _seconds = _at_2(__genSym34, 7);
    /* Statements */
    return _if_3(
