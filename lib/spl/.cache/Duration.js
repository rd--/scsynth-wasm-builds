...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _and_2(_isDuration_1(_anObject), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _equals_2(_milliseconds_1(_self), _milliseconds_1(_anObject));
    });
  },
...
sl.addMethod(
  ...
  function (_self, _aNumber) {
    ...
    /* Statements */
    return _milliseconds_1(_times_2(_milliseconds_1(_self), _aNumber));
  },
...
sl.addMethod(
  ...
  function (_self, _aNumber) {
    ...
    /* Statements */
    return _milliseconds_1(_dividedBy_2(_milliseconds_1(_self), _aNumber));
  },
  "{ :self :aNumber |\n\t\t(self.milliseconds / aNumber).milliseconds\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_milliseconds_1(_self), 10);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_hours_1(_self), 24);
  },
  "{ :self |\n\t\tself.hours / 24\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_minutes_1(_self), 60);
  },
  "{ :self |\n\t\tself.minutes / 60\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _equals_2(_milliseconds_1(_self), 0);
  },
  "{ :self |\n\t\tself.milliseconds = 0\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_seconds_1(_self), 60);
  },
  "{ :self |\n\t\tself.seconds / 60\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_milliseconds_1(_self), 1000);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_storeString_1(_milliseconds_1(_self)), ".milliseconds");
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_days_1(_self), 7);
  },
  "{ :self |\n\t\tself.days / 7\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 27.554551));
  },
  "{ :self |\n\t\t(self * 27.554551).days\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 365.259636));
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _milliseconds_1(_times_2(_self, 10));
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _hours_1(_times_2(_self, 24));
  },
  "{ :self |\n\t\t(self * 24).hours\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _minutes_1(_times_2(_self, 60));
  },
  "{ :self |\n\t\t(self * 60).minutes\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 365.25));
  },
  "{ :self |\n\t\t(self * 365.25).days\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _seconds_1(_times_2(_self, 60));
  },
  "{ :self |\n\t\t(self * 60).seconds\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _milliseconds_1(_times_2(_self, 1000));
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 27.321661));
  },
  "{ :self |\n\t\t(self * 27.321661).days\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 365.256363004));
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 27.321582));
  },
  "{ :self |\n\t\t(self * 27.321582).days\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 365.24219));
  },
  "{ :self |\n\t\t(self * 365.24219).days\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 29.53059));
  },
  "{ :self |\n\t\t(self * 29.53059).days\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _days_1(_times_2(_self, 7));
  },
  "{ :self |\n\t\t(self * 7).days\n\t}",
);
...
sl.addMethod(
  ...
  function (_self_0, _delay) {
    ...
    return _valueAfterMilliseconds_2(
      _self_0,
      _times_2(_asSeconds_1(_delay), 1000),
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym31 = _assertIsOfSize_2(
        _parseIso8601DurationAsArray_1(_self),
        7,
      ),
      _years = _at_2(__genSym31, 1),
      _months = _at_2(__genSym31, 2),
      _weeks = _at_2(__genSym31, 3),
      _days = _at_2(__genSym31, 4),
      _hours = _at_2(__genSym31, 5),
      _minutes = _at_2(__genSym31, 6),
      _seconds = _at_2(__genSym31, 7);
    /* Statements */
    return _if_3(_greaterThan_2(_plus_2(_years, _months), 0), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      return _plus_2(
        _plus_2(
          _plus_2(_plus_2(_weeks_1(_weeks), _days_1(_days)), _hours_1(_hours)),
          _minutes_1(_minutes),
        ),
        _seconds_1(_seconds),
      );
