...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _asSvg_1(_asDiscreteColourGradient_1(_self));
  },
  "{ :self | asSvg(asDiscreteColourGradient(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _draw_1(_asDiscreteColourGradient_1(_self));
  },
  "{ :self | draw(asDiscreteColourGradient(self)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    return _if_3(_includes_2(_self, "/"), function () {
      ...
      let __SPL151 = _assertIsOfSize_2(_splitBy_2(_self, "/"), 2);
      let _collectionName = _at_2(__SPL151, 1);
      let _paletteName = _at_2(__SPL151, 2);
      /* Statements */
      ...
      let _answer = [];
      /* Statements */
      _do_2(_colourPalettes_1(_system), function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
      ...
      return _caseOfOtherwise_3(_size_1(_answer), [
        _hyphenMinusGreaterThanSign_2(function () {
          ...
          return _error_2(_self, "namedColourPalette: unknown colour palette");
        }),
        _hyphenMinusGreaterThanSign_2(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
  ...
  "{ :self | if(includes(self,'/'), { let __SPL151 = assertIsOfSize(splitBy(self,'/'), 2); let collectionName = at(__SPL151, 1); let paletteName = at(__SPL151, 2); namedColourPalette(collectionName,paletteName) }, { let answer = []; do(colourPalettes(system), { :each | keysAndValuesDo(each, { :key :value | ifTrue((=(key, self)), { add(answer,value) }) }) }); caseOfOtherwise(size(answer), [->({ 0 }, { error(self,'namedColourPalette: unknown colour palette') }), ->({ 1 }, { ColourPalette(at(answer, 1)) })], { error(self,'namedColourPalette: multiple matches') }) }) }",
);
      ...
      ["parser", function (_libraryItem) {
        ...
        return _collect_2(_libraryItem, function (_i) {
          ...
          return _collect_2(_i, function (_j) {
            ...
            return _collect_2(_j, function (_k) {
              /* ArityCheck */
              if (arguments.length !== 1) {
