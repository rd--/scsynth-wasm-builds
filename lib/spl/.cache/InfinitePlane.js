...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL108 = _assertIsOfSize_2(_terms_1(_self), 4);
    let _a = _at_2(__SPL108, 1);
    let _b = _at_2(__SPL108, 2);
    let _c = _at_2(__SPL108, 3);
    let _d = _at_2(__SPL108, 4);
    let _z = _sqrt_1(
      _plusSign_2(
  ...
  "{ :self | let __SPL108 = assertIsOfSize(terms(self), 4); let a = at(__SPL108, 1); let b = at(__SPL108, 2); let c = at(__SPL108, 3); let d = at(__SPL108, 4); let z = sqrt((+(+((*(a, a)), (*(b, b))), (*(c, c))))); let n = /([a, b, c], z); let p = /(d, z); [n, p] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL109 = _assertIsOfSize_2(_self, 4);
        let _a = _at_2(__SPL109, 1);
        let _b = _at_2(__SPL109, 2);
        let _c = _at_2(__SPL109, 3);
        let _d = _at_2(__SPL109, 4);
        /* Statements */
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL110 = _assertIsOfSize_2(_self, 3);
            let _p1 = _at_2(__SPL110, 1);
            let _p2 = _at_2(__SPL110, 2);
            let _p3 = _at_2(__SPL110, 3);
            /* Statements */
  ...
  "{ :self | if((=(size(self), 4)), { let __SPL109 = assertIsOfSize(self, 4); let a = at(__SPL109, 1); let b = at(__SPL109, 2); let c = at(__SPL109, 3); let d = at(__SPL109, 4); InfinitePlane(a, b, c, d) }, { if((=(size(self), 3)), { let __SPL110 = assertIsOfSize(self, 3); let p1 = at(__SPL110, 1); let p2 = at(__SPL110, 2); let p3 = at(__SPL110, 3); InfinitePlane(p1, p2, p2) }, { error(self,'List>>asInfinitePlane') }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p1, _p2, _p3) {
    ...
    let __SPL111 = _assertIsOfSize_2(_p1, 3);
    let _x1 = _at_2(__SPL111, 1);
    let _y1 = _at_2(__SPL111, 2);
    let _z1 = _at_2(__SPL111, 3);
    let __SPL112 = _assertIsOfSize_2(_p2, 3);
    let _x2 = _at_2(__SPL112, 1);
    let _y2 = _at_2(__SPL112, 2);
    let _z2 = _at_2(__SPL112, 3);
    let __SPL113 = _assertIsOfSize_2(_p3, 3);
    let _x3 = _at_2(__SPL113, 1);
    let _y3 = _at_2(__SPL113, 2);
    let _z3 = _at_2(__SPL113, 3);
    let _a = _plusSign_2(
      _plusSign_2(
    ...
    _ifTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        return (sl.annotateFunction(function () {
          ...
          let __SPL114 = _solidus_2([_a, _b, _c, _d], _z);
          /* Statements */
          _a = _at_2(__SPL114, 1);
          _b = _at_2(__SPL114, 2);
          _c = _at_2(__SPL114, 3);
          return _d = _at_2(__SPL114, 4);
        }, [])());
      }, []),
    );
    _ifTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        return (sl.annotateFunction(function () {
          ...
          let __SPL115 = _negated_1([_a, _b, _c, _d]);
          /* Statements */
          _a = _at_2(__SPL115, 1);
          _b = _at_2(__SPL115, 2);
          _c = _at_2(__SPL115, 3);
          return _d = _at_2(__SPL115, 4);
        }, [])());
      }, []),
    );
    return _InfinitePlane_4(_a, _b, _c, _d);
  }, ["p1", "p2", "p3"]),
  "{ :p1 :p2 :p3 | let __SPL111 = assertIsOfSize(p1, 3); let x1 = at(__SPL111, 1); let y1 = at(__SPL111, 2); let z1 = at(__SPL111, 3); let __SPL112 = assertIsOfSize(p2, 3); let x2 = at(__SPL112, 1); let y2 = at(__SPL112, 2); let z2 = at(__SPL112, 3); let __SPL113 = assertIsOfSize(p3, 3); let x3 = at(__SPL113, 1); let y3 = at(__SPL113, 2); let z3 = at(__SPL113, 3); let a = +(+((*(y1, (-(z2, z3)))), (*(y2, (-(z3, z1))))), (*(y3, (-(z1, z2))))); let b = +(+((*(z1, (-(x2, x3)))), (*(z2, (-(x3, x1))))), (*(z3, (-(x1, x2))))); let c = +(+((*(x1, (-(y2, y3)))), (*(x2, (-(y3, y1))))), (*(x3, (-(y1, y2))))); let d = negated(sum((*([a, b, c], p1)))); ifTrue(allSatisfy([a, b, c],isInteger:/1), { let z = gcd([a, b, c]); ({ let __SPL114 = /([a, b, c, d], z); a := at(__SPL114, 1); b := at(__SPL114, 2); c := at(__SPL114, 3); d := at(__SPL114, 4) } . ()) }); ifTrue(allSatisfy([a, b, c],isNonPositive:/1), { ({ let __SPL115 = negated([a, b, c, d]); a := at(__SPL115, 1); b := at(__SPL115, 2); c := at(__SPL115, 3); d := at(__SPL115, 4) } . ()) }); InfinitePlane(a, b, c, d) }",
);
