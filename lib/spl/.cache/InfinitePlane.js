...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL192 = _assertIsOfSize_2(_terms_1(_self), 4);
  ...
  "{ :self | let __SPL192 = assertIsOfSize(terms(self), 4); let a = at(__SPL192, 1); let b = at(__SPL192, 2); let c = at(__SPL192, 3); let d = at(__SPL192, 4); let z = sqrt((+(+((*(a, a)), (*(b, b))), (*(c, c))))); let n = /([a, b, c], z); let p = /(d, z); [n, p] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL193 = _assertIsOfSize_2(_self, 4);
        let _a = _at_2(__SPL193, 1);
        let _b = _at_2(__SPL193, 2);
        let _c = _at_2(__SPL193, 3);
        let _d = _at_2(__SPL193, 4);
        /* Statements */
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL194 = _assertIsOfSize_2(_self, 3);
            let _p1 = _at_2(__SPL194, 1);
            let _p2 = _at_2(__SPL194, 2);
            let _p3 = _at_2(__SPL194, 3);
            /* Statements */
  ...
  "{ :self | if((=(size(self), 4)), { let __SPL193 = assertIsOfSize(self, 4); let a = at(__SPL193, 1); let b = at(__SPL193, 2); let c = at(__SPL193, 3); let d = at(__SPL193, 4); InfinitePlane(a, b, c, d) }, { if((=(size(self), 3)), { let __SPL194 = assertIsOfSize(self, 3); let p1 = at(__SPL194, 1); let p2 = at(__SPL194, 2); let p3 = at(__SPL194, 3); InfinitePlane(p1, p2, p2) }, { error(self,'List>>asInfinitePlane') }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_p1, _p2, _p3) {
    ...
    let __SPL195 = _assertIsOfSize_2(_p1, 3);
    let _x1 = _at_2(__SPL195, 1);
    let _y1 = _at_2(__SPL195, 2);
    let _z1 = _at_2(__SPL195, 3);
    let __SPL196 = _assertIsOfSize_2(_p2, 3);
    let _x2 = _at_2(__SPL196, 1);
    let _y2 = _at_2(__SPL196, 2);
    let _z2 = _at_2(__SPL196, 3);
    let __SPL197 = _assertIsOfSize_2(_p3, 3);
    let _x3 = _at_2(__SPL197, 1);
    let _y3 = _at_2(__SPL197, 2);
    let _z3 = _at_2(__SPL197, 3);
    let _a = _plusSign_2(
      _plusSign_2(
    ...
    _ifTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        return (sl.annotateFunction(function () {
          ...
          let __SPL198 = _solidus_2([_a, _b, _c, _d], _z);
          /* Statements */
          _a = _at_2(__SPL198, 1);
          _b = _at_2(__SPL198, 2);
          _c = _at_2(__SPL198, 3);
    ...
    _ifTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        return (sl.annotateFunction(function () {
          ...
          let __SPL199 = _negate_1([_a, _b, _c, _d]);
          /* Statements */
          _a = _at_2(__SPL199, 1);
          _b = _at_2(__SPL199, 2);
          _c = _at_2(__SPL199, 3);
          return _d = _at_2(__SPL199, 4);
        }, [])());
      }, []),
    );
    return _InfinitePlane_4(_a, _b, _c, _d);
  }, ["p1", "p2", "p3"]),
  "{ :p1 :p2 :p3 | let __SPL195 = assertIsOfSize(p1, 3); let x1 = at(__SPL195, 1); let y1 = at(__SPL195, 2); let z1 = at(__SPL195, 3); let __SPL196 = assertIsOfSize(p2, 3); let x2 = at(__SPL196, 1); let y2 = at(__SPL196, 2); let z2 = at(__SPL196, 3); let __SPL197 = assertIsOfSize(p3, 3); let x3 = at(__SPL197, 1); let y3 = at(__SPL197, 2); let z3 = at(__SPL197, 3); let a = +(+((*(y1, (-(z2, z3)))), (*(y2, (-(z3, z1))))), (*(y3, (-(z1, z2))))); let b = +(+((*(z1, (-(x2, x3)))), (*(z2, (-(x3, x1))))), (*(z3, (-(x1, x2))))); let c = +(+((*(x1, (-(y2, y3)))), (*(x2, (-(y3, y1))))), (*(x3, (-(y1, y2))))); let d = negate(sum((*([a, b, c], p1)))); ifTrue(allSatisfy([a, b, c],isInteger:/1), { let z = gcd([a, b, c]); ({ let __SPL198 = /([a, b, c, d], z); a := at(__SPL198, 1); b := at(__SPL198, 2); c := at(__SPL198, 3); d := at(__SPL198, 4) } . ()) }); ifTrue(allSatisfy([a, b, c],isNonPositive:/1), { ({ let __SPL199 = negate([a, b, c, d]); a := at(__SPL199, 1); b := at(__SPL199, 2); c := at(__SPL199, 3); d := at(__SPL199, 4) } . ()) }); InfinitePlane(a, b, c, d) }",
);
