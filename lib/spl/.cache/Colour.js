...
sl.addMethod(
  ...
  function (_self, _aColour, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aColour, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym58 = _assertIsOfSize_2([
        _red_1(_self),
        _green_1(_self),
        _blue_1(_self),
      ], 3),
...
sl.addMethod(
  ...
  function (_self, _g, _b) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _g, _b"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _g, _b, _a) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _g, _b, _a"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_level, _alpha) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _level, _alpha"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_hue, _saturation, _brightness) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _hue, _saturation, _brightness"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
  ...
  function (_self) {
    ...
    return _caseOf_2(_size_1(_self), [
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        /* Temporaries */
        let __genSym59 = _assertIsOfSize_2(_self, 3),
      ...
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        /* Temporaries */
        let __genSym60 = _assertIsOfSize_2(_self, 4),
          _r = _at_2(__genSym60, 1),
          _g = _at_2(__genSym60, 2),
          _b = _at_2(__genSym60, 3),
          _a = _at_2(__genSym60, 4);
        /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym61 = _assertIsOfSize_2(_asFloat_1(_self), 3),
      _h = _at_2(__genSym61, 1),
      _s = _at_2(__genSym61, 2),
      _v = _at_2(__genSym61, 3);
    let __genSym62 = _assertIsOfSize_2(_asList_1(_Hsv_3(_h, _s, _v)), 4),
      _r = _at_2(__genSym62, 1),
      _g = _at_2(__genSym62, 2),
      _b = _at_2(__genSym62, 3),
      _a = _at_2(__genSym62, 4);
    /* Statements */
    return [_r, _g, _b];
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym63 = _assertIsOfSize_2(_asFloat_1(_self), 3),
      _r = _at_2(__genSym63, 1),
      _g = _at_2(__genSym63, 2),
      _b = _at_2(__genSym63, 3);
    /* Statements */
