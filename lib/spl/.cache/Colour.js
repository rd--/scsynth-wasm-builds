...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL240 = _assertIsOfSize_2(
          _rounded_1(_asterisk_2(_rgb_1(_self), 255)),
          3,
        );
        let _r = _at_2(__SPL240, 1);
        let _g = _at_2(__SPL240, 2);
        let _b = _at_2(__SPL240, 3);
  ...
  "{ :self | if(isValid(self), { let __SPL240 = assertIsOfSize(rounded((*(rgb(self), 255))), 3); let r = at(__SPL240, 1); let g = at(__SPL240, 2); let b = at(__SPL240, 3); let alpha = alpha(self); if((=(alpha, 1)), { format('rgb(%,%,%)',[r, g, b]) }, { format('rgba(%,%,%,%)',[r, g, b, alpha]) }) }, { 'rgba(255,255,255,0)' }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL241 = _assertIsOfSize_2(_asFloat_1(_self), 3);
    let _hue = _at_2(__SPL241, 1);
    let _saturation = _at_2(__SPL241, 2);
    let _brightness = _at_2(__SPL241, 3);
  ...
  "{ :self | let __SPL241 = assertIsOfSize(asFloat(self), 3); let hue = at(__SPL241, 1); let saturation = at(__SPL241, 2); let brightness = at(__SPL241, 3); let s = max(min(saturation,1),0); let v = max(min(brightness,1),0); let h = %((*(hue, 360)), 360); let i = //(h, 60); let f = /((%(h, 60)), 60); let p = *((-(1, s)), v); let q = *((-(1, (*(s, f)))), v); let t = *((-(1, (*(s, (-(1, f)))))), v); caseOf(i, [->(0, { [v, t, p] }), ->(1, { [q, v, p] }), ->(2, { [p, v, t] }), ->(3, { [p, q, v] }), ->(4, { [t, p, v] }), ->(5, { [v, p, q] })], { error('hsvToRgb','implementation error') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL242 = _assertIsOfSize_2(_asFloat_1(_self), 3);
    let _r = _at_2(__SPL242, 1);
    let _g = _at_2(__SPL242, 2);
    let _b = _at_2(__SPL242, 3);
  ...
  "{ :self | let __SPL242 = assertIsOfSize(asFloat(self), 3); let r = at(__SPL242, 1); let g = at(__SPL242, 2); let b = at(__SPL242, 3); let v = max([r, g, b]); let c = -(v, min([r, g, b])); let s = if((=(v, 0)), { 0 }, { /(c, v) }); let h = if((=(c, 0)), { 0 }, { if((=(v, r)), { *(60, (%(/((-(g, b)), c), 6))) }, { if((=(v, g)), { *(60, (+(/((-(b, r)), c), 2))) }, { *(60, (+(/((-(r, g)), c), 4))) }) }) }); [/(h, 360), s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL243 = _assertIsOfSize_2(_self, 3);
    let _h = _at_2(__SPL243, 1);
    let _s = _at_2(__SPL243, 2);
    let _l = _at_2(__SPL243, 3);
    let _v = _plusSign_2(
      _l,
  ...
  "{ :self | let __SPL243 = assertIsOfSize(self, 3); let h = at(__SPL243, 1); let s = at(__SPL243, 2); let l = at(__SPL243, 3); let v = +(l, (*(s, min(l,-(1, l))))); [h, if((=(v, 0)), { 0 }, { *(2, (-(1, (/(l, v))))) }), v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL244 = _assertIsOfSize_2(_self, 3);
    let _hUnit = _at_2(__SPL244, 1);
    let _s = _at_2(__SPL244, 2);
    let _l = _at_2(__SPL244, 3);
  ...
  "{ :self | let __SPL244 = assertIsOfSize(self, 3); let hUnit = at(__SPL244, 1); let s = at(__SPL244, 2); let l = at(__SPL244, 3); let h = *(hUnit, 360); let a = *(s, min(l,-(1, l))); collect([0, 8, 4], { :n | let k = %((+(n, (/(h, 30)))), 12); -(l, (*(a, max(-1,min([-(k, 3), -(9, k), 1]))))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL245 = _assertIsOfSize_2(_self, 3);
    let _h = _at_2(__SPL245, 1);
    let _s = _at_2(__SPL245, 2);
    let _v = _at_2(__SPL245, 3);
  ...
  "{ :self | let __SPL245 = assertIsOfSize(self, 3); let h = at(__SPL245, 1); let s = at(__SPL245, 2); let v = at(__SPL245, 3); let l = *(v, (-(1, (/(s, 2))))); [h, if(includes([0, 1],l), { 0 }, { /((-(v, l)), min(l,-(1, l))) }), l] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL246 = _assertIsOfSize_2(_self, 3);
    let _l = _at_2(__SPL246, 1);
    let _a = _at_2(__SPL246, 2);
    let _b = _at_2(__SPL246, 3);
    let __SPL247 = _assertIsOfSize_2(_toPolarCoordinates_1([_a, _b]), 2);
    let _c = _at_2(__SPL247, 1);
    let _h = _at_2(__SPL247, 2);
    /* Statements */
    return [_l, _c, _percentSign_2(_radiansToDegrees_1(_h), 360)];
  }, ["self"]),
  "{ :self | let __SPL246 = assertIsOfSize(self, 3); let l = at(__SPL246, 1); let a = at(__SPL246, 2); let b = at(__SPL246, 3); let __SPL247 = assertIsOfSize(toPolarCoordinates([a, b]), 2); let c = at(__SPL247, 1); let h = at(__SPL247, 2); [l, c, %(radiansToDegrees(h), 360)] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL248 = _assertIsOfSize_2(_self, 3);
    let _j = _at_2(__SPL248, 1);
    let _c = _at_2(__SPL248, 2);
    let _h = _at_2(__SPL248, 3);
  ...
  "{ :self | let __SPL248 = assertIsOfSize(self, 3); let j = at(__SPL248, 1); let c = at(__SPL248, 2); let h = at(__SPL248, 3); let hRadians = degree(h); let a = *(c, cos(hRadians)); let b = *(c, sin(hRadians)); [j, a, b] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    let __SPL249 = _assertIsOfSize_2(_self, 3);
    let _l = _at_2(__SPL249, 1);
    let _a = _at_2(__SPL249, 2);
    let _b = _at_2(__SPL249, 3);
    let __SPL250 = _assertIsOfSize_2(_reference, 3);
    let _rx = _at_2(__SPL250, 1);
    let _ry = _at_2(__SPL250, 2);
    let _rz = _at_2(__SPL250, 3);
  ...
  "{ :self :reference | let __SPL249 = assertIsOfSize(self, 3); let l = at(__SPL249, 1); let a = at(__SPL249, 2); let b = at(__SPL249, 3); let __SPL250 = assertIsOfSize(reference, 3); let rx = at(__SPL250, 1); let ry = at(__SPL250, 2); let rz = at(__SPL250, 3); let delta = /(6, 29); let epsilon = cubed(delta); let kappa = /(8, epsilon); let fy = /((+(l, 16)), 116); let fx = +((/(a, 500)), fy); let fz = -(fy, (/(b, 200))); let fx3 = cubed(fx); let fz3 = cubed(fz); let x = if((>(fx3, epsilon)), { fx3 }, { /((-(*(116, fx), 16)), kappa) }); let y = if((>(l, (*(kappa, epsilon)))), { cubed((/((+(l, 16)), 116))) }, { /(l, kappa) }); let z = if((>(fz3, epsilon)), { fz3 }, { /((-(*(116, fz), 16)), kappa) }); /([*(x, rx), *(y, ry), *(z, rz)], 100) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    let __SPL251 = _assertIsOfSize_2(_self, 3);
    let _l = _at_2(__SPL251, 1);
    let _u = _at_2(__SPL251, 2);
    let _v = _at_2(__SPL251, 3);
    let __SPL252 = _assertIsOfSize_2(_reference, 3);
    let _rx = _at_2(__SPL252, 1);
    let _ry = _at_2(__SPL252, 2);
    let _rz = _at_2(__SPL252, 3);
  ...
  "{ :self :reference | let __SPL251 = assertIsOfSize(self, 3); let l = at(__SPL251, 1); let u = at(__SPL251, 2); let v = at(__SPL251, 3); let __SPL252 = assertIsOfSize(reference, 3); let rx = at(__SPL252, 1); let ry = at(__SPL252, 2); let rz = at(__SPL252, 3); let epsilon = /(216, 24389); let kappa = /(24389, 27); let u0 = /((*(4, rx)), (+(+(rx, (*(15, ry))), (*(3, rz))))); let v0 = /((*(9, ry)), (+(+(rx, (*(15, ry))), (*(3, rz))))); let y = if((>(l, (*(kappa, epsilon)))), { ^((/((+(l, 16)), 116)), 3) }, { /(l, kappa) }); let a = if((=(l, 0)), { 0 }, { /((-((/((*(52, l)), (+(u, (*(*(13, l), u0)))))), 1)), 3) }); let b = *(-5, y); let c = /(-1, 3); let d = if((=(l, 0)), { 0 }, { *(y, (-((/((*(39, l)), (+(v, (*(*(13, l), v0)))))), 5))) }); let x = /((-(d, b)), (-(a, c))); let z = +((*(x, a)), b); [x, y, z] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL253 = _assertIsOfSize_2(_self, 4);
    let _a = _at_2(__SPL253, 1);
    let _b = _at_2(__SPL253, 2);
    let _c = _at_2(__SPL253, 3);
    let _d = _at_2(__SPL253, 4);
    /* Statements */
  ...
  "{ :self | let __SPL253 = assertIsOfSize(self, 4); let a = at(__SPL253, 1); let b = at(__SPL253, 2); let c = at(__SPL253, 3); let d = at(__SPL253, 4); { :t | +(a, (*(b, cos((*(pi(2), (+((*(c, t)), d)))))))) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    let __SPL254 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SPL254, 1);
    let _y = _at_2(__SPL254, 2);
    let _z = _at_2(__SPL254, 3);
    let __SPL255 = _assertIsOfSize_2(_reference, 3);
    let _rx = _at_2(__SPL255, 1);
    let _ry = _at_2(__SPL255, 2);
    let _rz = _at_2(__SPL255, 3);
    let _delta = _solidus_2(6, 29);
    let _epsilon = _cubed_1(_delta);
    let _kappa = _solidus_2(8, _epsilon);
  ...
  "{ :self :reference | let __SPL254 = assertIsOfSize(self, 3); let x = at(__SPL254, 1); let y = at(__SPL254, 2); let z = at(__SPL254, 3); let __SPL255 = assertIsOfSize(reference, 3); let rx = at(__SPL255, 1); let ry = at(__SPL255, 2); let rz = at(__SPL255, 3); let delta = /(6, 29); let epsilon = cubed(delta); let kappa = /(8, epsilon); let f = { :tu | let t = *(tu, 100); if((>(t, epsilon)), { cubeRoot(t) }, { /((+((*(kappa, t)), 16)), 116) }) }; let fX = f(/(x, rx)); let fY = f(/(y, ry)); let fZ = f(/(z, rz)); [-((*(116, fY)), 16), *(500, (-(fX, fY))), *(200, (-(fY, fZ)))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL256 = _assertIsOfSize_2(_self, 3);
        let _x = _at_2(__SPL256, 1);
        let _y = _at_2(__SPL256, 2);
        let _z = _at_2(__SPL256, 3);
        let __SPL257 = _assertIsOfSize_2(_reference, 3);
        let _rx = _at_2(__SPL257, 1);
        let _ry = _at_2(__SPL257, 2);
        let _rz = _at_2(__SPL257, 3);
        let _epsilon = _solidus_2(216, 24389);
        let _kappa = _solidus_2(24389, 27);
  ...
  "{ :self :reference | if((=(self, [0, 0, 0])), { [0, 0, 0] }, { let __SPL256 = assertIsOfSize(self, 3); let x = at(__SPL256, 1); let y = at(__SPL256, 2); let z = at(__SPL256, 3); let __SPL257 = assertIsOfSize(reference, 3); let rx = at(__SPL257, 1); let ry = at(__SPL257, 2); let rz = at(__SPL257, 3); let epsilon = /(216, 24389); let kappa = /(24389, 27); let yr = *((/(y, ry)), 100); let xyz = +(+(x, (*(15, y))), (*(3, z))); let rxryrz = +(+(rx, (*(15, ry))), (*(3, rz))); let u1 = /((*(4, x)), xyz); let v1 = /((*(9, y)), xyz); let ur = /((*(4, rx)), rxryrz); let vr = /((*(9, ry)), rxryrz); let l = if((>(yr, epsilon)), { -((*(116, cubeRoot(yr))), 16) }, { *(kappa, yr) }); let u = *(*(13, l), (-(u1, ur))); let v = *(*(13, l), (-(v1, vr))); [l, u, v] }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL258 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SPL258, 1);
    let _y1 = _at_2(__SPL258, 2);
    let _y2 = _at_2(__SPL258, 3);
    /* Statements */
    return _if_3(
      _equalsSign_2(_y1, 0),
      sl.annotateFunction(function () {
  ...
  "{ :self | let __SPL258 = assertIsOfSize(self, 3); let x = at(__SPL258, 1); let y1 = at(__SPL258, 2); let y2 = at(__SPL258, 3); if((=(y1, 0)), { [0, 0, 0] }, { [/((*(x, y2)), y1), y2, /((*((-(-(1, x), y1)), y2)), y1)] }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL259 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SPL259, 1);
    let _y = _at_2(__SPL259, 2);
    let _z = _at_2(__SPL259, 3);
  ...
  "{ :self | let __SPL259 = assertIsOfSize(self, 3); let x = at(__SPL259, 1); let y = at(__SPL259, 2); let z = at(__SPL259, 3); let n = +(+(x, y), z); if((=(n, 0)), { [1, 1, 1] }, { let m = /(1, n); [*(x, m), *(y, m), y] }) }",
);
