...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym1 = _assertIsOfSize_2([
      ...
      _g = _at_2(__genSym1, 2),
      _b = _at_2(__genSym1, 3);
    ...
    return _caseOf_2(_size_1(_self), [
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        let __genSym2 = _assertIsOfSize_2(_self, 3),
          _r = _at_2(__genSym2, 1),
          _g = _at_2(__genSym2, 2),
          _b = _at_2(__genSym2, 3);
        /* Statements */
      ...
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        let __genSym3 = _assertIsOfSize_2(_self, 4),
          _r = _at_2(__genSym3, 1),
          _g = _at_2(__genSym3, 2),
          _b = _at_2(__genSym3, 3),
          _a = _at_2(__genSym3, 4);
        /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym4 = _assertIsOfSize_2(_asFloat_1(_self), 3),
      _h = _at_2(__genSym4, 1),
      _s = _at_2(__genSym4, 2),
      _v = _at_2(__genSym4, 3);
    let __genSym5 = _assertIsOfSize_2(_asList_1(_Hsv_3(_h, _s, _v)), 4),
      _r = _at_2(__genSym5, 1),
      _g = _at_2(__genSym5, 2),
      _b = _at_2(__genSym5, 3),
      _a = _at_2(__genSym5, 4);
    /* Statements */
    return [_r, _g, _b];
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym6 = _assertIsOfSize_2(_asFloat_1(_self), 3),
      _r = _at_2(__genSym6, 1),
      _g = _at_2(__genSym6, 2),
      _b = _at_2(__genSym6, 3);
    /* Statements */
