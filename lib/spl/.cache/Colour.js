...
sl.addMethodToExistingTrait(
  ...
  "{ :self | let c = if((=(alpha(self), 1)), { rgb(self) }, { rgba(self) }); ++('#', stringCatenate(collect(c, { :each | byteHexString(round((*(each, 255)))) }))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL321 = _assertIsOfSize_2(
          _round_1(_asterisk_2(_rgb_1(_self), 255)),
          3,
        );
        let _r = _at_2(__SPL321, 1);
        let _g = _at_2(__SPL321, 2);
        let _b = _at_2(__SPL321, 3);
  ...
  "{ :self | if(isValid(self), { let __SPL321 = assertIsOfSize(round((*(rgb(self), 255))), 3); let r = at(__SPL321, 1); let g = at(__SPL321, 2); let b = at(__SPL321, 3); let alpha = alpha(self); if((=(alpha, 1)), { format('rgb(%,%,%)',[r, g, b]) }, { format('rgba(%,%,%,%)',[r, g, b, alpha]) }) }, { 'rgba(255,255,255,0)' }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | caseOf(size(self), [->(3, { RgbColour(self, 1) }), ->(4, { RgbColour(take(self,3), at(self, 4)) })], { error(self,'asColour') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL322 = _assertIsOfSize_2(_asFloat_1(_self), 3);
    let _hue = _at_2(__SPL322, 1);
    let _saturation = _at_2(__SPL322, 2);
    let _brightness = _at_2(__SPL322, 3);
  ...
  "{ :self | let __SPL322 = assertIsOfSize(asFloat(self), 3); let hue = at(__SPL322, 1); let saturation = at(__SPL322, 2); let brightness = at(__SPL322, 3); let s = max(min(saturation,1),0); let v = max(min(brightness,1),0); let h = %((*(hue, 360)), 360); let i = //(h, 60); let f = /((%(h, 60)), 60); let p = *((-(1, s)), v); let q = *((-(1, (*(s, f)))), v); let t = *((-(1, (*(s, (-(1, f)))))), v); caseOf(i, [->(0, { [v, t, p] }), ->(1, { [q, v, p] }), ->(2, { [p, v, t] }), ->(3, { [p, q, v] }), ->(4, { [t, p, v] }), ->(5, { [v, p, q] })], { error('hsvToRgb','implementation error') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL323 = _assertIsOfSize_2(_asFloat_1(_self), 3);
    let _r = _at_2(__SPL323, 1);
    let _g = _at_2(__SPL323, 2);
    let _b = _at_2(__SPL323, 3);
  ...
  "{ :self | let __SPL323 = assertIsOfSize(asFloat(self), 3); let r = at(__SPL323, 1); let g = at(__SPL323, 2); let b = at(__SPL323, 3); let v = max([r, g, b]); let c = -(v, min([r, g, b])); let s = if((=(v, 0)), { 0 }, { /(c, v) }); let h = if((=(c, 0)), { 0 }, { if((=(v, r)), { *(60, (%(/((-(g, b)), c), 6))) }, { if((=(v, g)), { *(60, (+(/((-(b, r)), c), 2))) }, { *(60, (+(/((-(r, g)), c), 4))) }) }) }); [/(h, 360), s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL324 = _assertIsOfSize_2(_self, 3);
    let _h = _at_2(__SPL324, 1);
    let _s = _at_2(__SPL324, 2);
    let _l = _at_2(__SPL324, 3);
    let _v = _plusSign_2(
      _l,
  ...
  "{ :self | let __SPL324 = assertIsOfSize(self, 3); let h = at(__SPL324, 1); let s = at(__SPL324, 2); let l = at(__SPL324, 3); let v = +(l, (*(s, min(l,-(1, l))))); [h, if((=(v, 0)), { 0 }, { *(2, (-(1, (/(l, v))))) }), v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL325 = _assertIsOfSize_2(_self, 3);
    let _hUnit = _at_2(__SPL325, 1);
    let _s = _at_2(__SPL325, 2);
    let _l = _at_2(__SPL325, 3);
  ...
  "{ :self | let __SPL325 = assertIsOfSize(self, 3); let hUnit = at(__SPL325, 1); let s = at(__SPL325, 2); let l = at(__SPL325, 3); let h = *(hUnit, 360); let a = *(s, min(l,-(1, l))); collect([0, 8, 4], { :n | let k = %((+(n, (/(h, 30)))), 12); -(l, (*(a, max(-1,min([-(k, 3), -(9, k), 1]))))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL326 = _assertIsOfSize_2(_self, 3);
    let _h = _at_2(__SPL326, 1);
    let _s = _at_2(__SPL326, 2);
    let _v = _at_2(__SPL326, 3);
  ...
  "{ :self | let __SPL326 = assertIsOfSize(self, 3); let h = at(__SPL326, 1); let s = at(__SPL326, 2); let v = at(__SPL326, 3); let l = *(v, (-(1, (/(s, 2))))); [h, if(includes([0, 1],l), { 0 }, { /((-(v, l)), min(l,-(1, l))) }), l] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL327 = _assertIsOfSize_2(_self, 3);
    let _l = _at_2(__SPL327, 1);
    let _a = _at_2(__SPL327, 2);
    let _b = _at_2(__SPL327, 3);
    let __SPL328 = _assertIsOfSize_2(_toPolarCoordinates_1([_a, _b]), 2);
    let _c = _at_2(__SPL328, 1);
    let _h = _at_2(__SPL328, 2);
    /* Statements */
    return [_l, _c, _percentSign_2(_radiansToDegrees_1(_h), 360)];
  }, ["self"]),
  "{ :self | let __SPL327 = assertIsOfSize(self, 3); let l = at(__SPL327, 1); let a = at(__SPL327, 2); let b = at(__SPL327, 3); let __SPL328 = assertIsOfSize(toPolarCoordinates([a, b]), 2); let c = at(__SPL328, 1); let h = at(__SPL328, 2); [l, c, %(radiansToDegrees(h), 360)] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL329 = _assertIsOfSize_2(_self, 3);
    let _j = _at_2(__SPL329, 1);
    let _c = _at_2(__SPL329, 2);
    let _h = _at_2(__SPL329, 3);
  ...
  "{ :self | let __SPL329 = assertIsOfSize(self, 3); let j = at(__SPL329, 1); let c = at(__SPL329, 2); let h = at(__SPL329, 3); let hRadians = degree(h); let a = *(c, cos(hRadians)); let b = *(c, sin(hRadians)); [j, a, b] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    let __SPL330 = _assertIsOfSize_2(_self, 3);
    let _l = _at_2(__SPL330, 1);
    let _a = _at_2(__SPL330, 2);
    let _b = _at_2(__SPL330, 3);
    let __SPL331 = _assertIsOfSize_2(_reference, 3);
    let _rx = _at_2(__SPL331, 1);
    let _ry = _at_2(__SPL331, 2);
    let _rz = _at_2(__SPL331, 3);
  ...
  "{ :self :reference | let __SPL330 = assertIsOfSize(self, 3); let l = at(__SPL330, 1); let a = at(__SPL330, 2); let b = at(__SPL330, 3); let __SPL331 = assertIsOfSize(reference, 3); let rx = at(__SPL331, 1); let ry = at(__SPL331, 2); let rz = at(__SPL331, 3); let delta = /(6, 29); let epsilon = cube(delta); let kappa = /(8, epsilon); let fy = /((+(l, 16)), 116); let fx = +((/(a, 500)), fy); let fz = -(fy, (/(b, 200))); let fx3 = cube(fx); let fz3 = cube(fz); let x = if((>(fx3, epsilon)), { fx3 }, { /((-(*(116, fx), 16)), kappa) }); let y = if((>(l, (*(kappa, epsilon)))), { cube((/((+(l, 16)), 116))) }, { /(l, kappa) }); let z = if((>(fz3, epsilon)), { fz3 }, { /((-(*(116, fz), 16)), kappa) }); /([*(x, rx), *(y, ry), *(z, rz)], 100) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    let __SPL332 = _assertIsOfSize_2(_self, 3);
    let _l = _at_2(__SPL332, 1);
    let _u = _at_2(__SPL332, 2);
    let _v = _at_2(__SPL332, 3);
    let __SPL333 = _assertIsOfSize_2(_reference, 3);
    let _rx = _at_2(__SPL333, 1);
    let _ry = _at_2(__SPL333, 2);
    let _rz = _at_2(__SPL333, 3);
  ...
  "{ :self :reference | let __SPL332 = assertIsOfSize(self, 3); let l = at(__SPL332, 1); let u = at(__SPL332, 2); let v = at(__SPL332, 3); let __SPL333 = assertIsOfSize(reference, 3); let rx = at(__SPL333, 1); let ry = at(__SPL333, 2); let rz = at(__SPL333, 3); let epsilon = /(216, 24389); let kappa = /(24389, 27); let u0 = /((*(4, rx)), (+(+(rx, (*(15, ry))), (*(3, rz))))); let v0 = /((*(9, ry)), (+(+(rx, (*(15, ry))), (*(3, rz))))); let y = if((>(l, (*(kappa, epsilon)))), { ^((/((+(l, 16)), 116)), 3) }, { /(l, kappa) }); let a = if((=(l, 0)), { 0 }, { /((-((/((*(52, l)), (+(u, (*(*(13, l), u0)))))), 1)), 3) }); let b = *(-5, y); let c = /(-1, 3); let d = if((=(l, 0)), { 0 }, { *(y, (-((/((*(39, l)), (+(v, (*(*(13, l), v0)))))), 5))) }); let x = /((-(d, b)), (-(a, c))); let z = +((*(x, a)), b); [x, y, z] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let labToLms = [[1.0, 0.3963377922, 0.2158037581], [1.0, -0.1055613423, -0.0638541748], [1.0, -0.0894841821, -1.2914855379]]; let lmsToXyz = [[1.2270138511, -0.5577999807, 0.2812561490], [-0.0405801784, 1.1122568696, -0.0716766787], [-0.0763812845, -0.4214819784, 1.5861632204]]; let lms = dot(labToLms,self); dot(lmsToXyz,cube(lms)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL334 = _assertIsOfSize_2(_self, 4);
    let _a = _at_2(__SPL334, 1);
    let _b = _at_2(__SPL334, 2);
    let _c = _at_2(__SPL334, 3);
    let _d = _at_2(__SPL334, 4);
    /* Statements */
  ...
  "{ :self | let __SPL334 = assertIsOfSize(self, 4); let a = at(__SPL334, 1); let b = at(__SPL334, 2); let c = at(__SPL334, 3); let d = at(__SPL334, 4); { :t | +(a, (*(b, cos((*(pi(2), (+((*(c, t)), d)))))))) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    let __SPL335 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SPL335, 1);
    let _y = _at_2(__SPL335, 2);
    let _z = _at_2(__SPL335, 3);
    let __SPL336 = _assertIsOfSize_2(_reference, 3);
    let _rx = _at_2(__SPL336, 1);
    let _ry = _at_2(__SPL336, 2);
    let _rz = _at_2(__SPL336, 3);
    let _delta = _solidus_2(6, 29);
    let _epsilon = _cube_1(_delta);
    let _kappa = _solidus_2(8, _epsilon);
  ...
  "{ :self :reference | let __SPL335 = assertIsOfSize(self, 3); let x = at(__SPL335, 1); let y = at(__SPL335, 2); let z = at(__SPL335, 3); let __SPL336 = assertIsOfSize(reference, 3); let rx = at(__SPL336, 1); let ry = at(__SPL336, 2); let rz = at(__SPL336, 3); let delta = /(6, 29); let epsilon = cube(delta); let kappa = /(8, epsilon); let f = { :tu | let t = *(tu, 100); if((>(t, epsilon)), { cubeRoot(t) }, { /((+((*(kappa, t)), 16)), 116) }) }; let fX = f(/(x, rx)); let fY = f(/(y, ry)); let fZ = f(/(z, rz)); [-((*(116, fY)), 16), *(500, (-(fX, fY))), *(200, (-(fY, fZ)))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL337 = _assertIsOfSize_2(_self, 3);
        let _x = _at_2(__SPL337, 1);
        let _y = _at_2(__SPL337, 2);
        let _z = _at_2(__SPL337, 3);
        let __SPL338 = _assertIsOfSize_2(_reference, 3);
        let _rx = _at_2(__SPL338, 1);
        let _ry = _at_2(__SPL338, 2);
        let _rz = _at_2(__SPL338, 3);
        let _epsilon = _solidus_2(216, 24389);
        let _kappa = _solidus_2(24389, 27);
  ...
  "{ :self :reference | if((=(self, [0, 0, 0])), { [0, 0, 0] }, { let __SPL337 = assertIsOfSize(self, 3); let x = at(__SPL337, 1); let y = at(__SPL337, 2); let z = at(__SPL337, 3); let __SPL338 = assertIsOfSize(reference, 3); let rx = at(__SPL338, 1); let ry = at(__SPL338, 2); let rz = at(__SPL338, 3); let epsilon = /(216, 24389); let kappa = /(24389, 27); let yr = *((/(y, ry)), 100); let xyz = +(+(x, (*(15, y))), (*(3, z))); let rxryrz = +(+(rx, (*(15, ry))), (*(3, rz))); let u1 = /((*(4, x)), xyz); let v1 = /((*(9, y)), xyz); let ur = /((*(4, rx)), rxryrz); let vr = /((*(9, ry)), rxryrz); let l = if((>(yr, epsilon)), { -((*(116, cubeRoot(yr))), 16) }, { *(kappa, yr) }); let u = *(*(13, l), (-(u1, ur))); let v = *(*(13, l), (-(v1, vr))); [l, u, v] }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL339 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SPL339, 1);
    let _y1 = _at_2(__SPL339, 2);
    let _y2 = _at_2(__SPL339, 3);
    /* Statements */
    return _if_3(
      _equalsSign_2(_y1, 0),
      sl.annotateFunction(function () {
  ...
  "{ :self | let __SPL339 = assertIsOfSize(self, 3); let x = at(__SPL339, 1); let y1 = at(__SPL339, 2); let y2 = at(__SPL339, 3); if((=(y1, 0)), { [0, 0, 0] }, { [/((*(x, y2)), y1), y2, /((*((-(-(1, x), y1)), y2)), y1)] }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL340 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SPL340, 1);
    let _y = _at_2(__SPL340, 2);
    let _z = _at_2(__SPL340, 3);
  ...
  "{ :self | let __SPL340 = assertIsOfSize(self, 3); let x = at(__SPL340, 1); let y = at(__SPL340, 2); let z = at(__SPL340, 3); let n = +(+(x, y), z); if((=(n, 0)), { [1, 1, 1] }, { let m = /(1, n); [*(x, m), *(y, m), y] }) }",
);
