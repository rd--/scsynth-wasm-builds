...
sl.addMethodToExistingTrait(
  ...
  "{ :self | if(isValid(self), { let __SplVar1 = assertIsOfSize(round((*(rgb(self), 255))), 3); let r = at(__SplVar1, 1); let g = at(__SplVar1, 2); let b = at(__SplVar1, 3); let alpha = alpha(self); if((=(alpha, 1)), { format('rgb(%,%,%)',[r, g, b]) }, { format('rgba(%,%,%,%)',[r, g, b, alpha]) }) }, { 'rgba(255,255,255,0)' }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar2 = assertIsOfSize(self, 3); let h = at(__SplVar2, 1); let s = at(__SplVar2, 2); let l = at(__SplVar2, 3); let v = +(l, (*(s, min(l,-(1, l))))); [h, if((=(v, 0)), { 0 }, { *(2, (-(1, (/(l, v))))) }), v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar3 = assertIsOfSize(self, 3); let hUnit = at(__SplVar3, 1); let s = at(__SplVar3, 2); let l = at(__SplVar3, 3); let h = *(hUnit, 360); let a = *(s, min(l,-(1, l))); collect([0, 8, 4], { :n | let k = %((+(n, (/(h, 30)))), 12); -(l, (*(a, max(-1,min([-(k, 3), -(9, k), 1]))))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar4 = assertIsOfSize(self, 3); let h = at(__SplVar4, 1); let s = at(__SplVar4, 2); let v = at(__SplVar4, 3); let l = *(v, (-(1, (/(s, 2))))); [h, if(includes([0, 1],l), { 0 }, { /((-(v, l)), min(l,-(1, l))) }), l] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar5 = assertIsOfSize(self, 3); let l = at(__SplVar5, 1); let a = at(__SplVar5, 2); let b = at(__SplVar5, 3); let __SplVar6 = assertIsOfSize(toPolarCoordinates([a, b]), 2); let c = at(__SplVar6, 1); let h = at(__SplVar6, 2); [l, c, %(radiansToDegrees(h), 360)] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar7 = assertIsOfSize(self, 3); let j = at(__SplVar7, 1); let c = at(__SplVar7, 2); let h = at(__SplVar7, 3); let hRadians = degree(h); let a = *(c, cos(hRadians)); let b = *(c, sin(hRadians)); [j, a, b] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :reference | let __SplVar8 = assertIsOfSize(self, 3); let l = at(__SplVar8, 1); let a = at(__SplVar8, 2); let b = at(__SplVar8, 3); let __SplVar9 = assertIsOfSize(reference, 3); let rx = at(__SplVar9, 1); let ry = at(__SplVar9, 2); let rz = at(__SplVar9, 3); let delta = /(6, 29); let epsilon = cube(delta); let kappa = /(8, epsilon); let fy = /((+(l, 16)), 116); let fx = +((/(a, 500)), fy); let fz = -(fy, (/(b, 200))); let fx3 = cube(fx); let fz3 = cube(fz); let x = if((>(fx3, epsilon)), { fx3 }, { /((-(*(116, fx), 16)), kappa) }); let y = if((>(l, (*(kappa, epsilon)))), { cube((/((+(l, 16)), 116))) }, { /(l, kappa) }); let z = if((>(fz3, epsilon)), { fz3 }, { /((-(*(116, fz), 16)), kappa) }); /([*(x, rx), *(y, ry), *(z, rz)], 100) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :reference | let __SplVar10 = assertIsOfSize(self, 3); let l = at(__SplVar10, 1); let u = at(__SplVar10, 2); let v = at(__SplVar10, 3); let __SplVar11 = assertIsOfSize(reference, 3); let rx = at(__SplVar11, 1); let ry = at(__SplVar11, 2); let rz = at(__SplVar11, 3); let epsilon = /(216, 24389); let kappa = /(24389, 27); let u0 = /((*(4, rx)), (+(+(rx, (*(15, ry))), (*(3, rz))))); let v0 = /((*(9, ry)), (+(+(rx, (*(15, ry))), (*(3, rz))))); let y = if((>(l, (*(kappa, epsilon)))), { ^((/((+(l, 16)), 116)), 3) }, { /(l, kappa) }); let a = if((=(l, 0)), { 0 }, { /((-((/((*(52, l)), (+(u, (*(*(13, l), u0)))))), 1)), 3) }); let b = *(-5, y); let c = /(-1, 3); let d = if((=(l, 0)), { 0 }, { *(y, (-((/((*(39, l)), (+(v, (*(*(13, l), v0)))))), 5))) }); let x = /((-(d, b)), (-(a, c))); let z = +((*(x, a)), b); [x, y, z] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar12 = assertIsOfSize(self, 4); let a = at(__SplVar12, 1); let b = at(__SplVar12, 2); let c = at(__SplVar12, 3); let d = at(__SplVar12, 4); { :t | +(a, (*(b, cos((*(pi(2), (+((*(c, t)), d)))))))) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar13 = assertIsOfSize(asFloat(self), 3); let hue = at(__SplVar13, 1); let saturation = at(__SplVar13, 2); let brightness = at(__SplVar13, 3); let s = max(min(saturation,1),0); let v = max(min(brightness,1),0); let h = %((*(hue, 360)), 360); let i = //(h, 60); let f = /((%(h, 60)), 60); let p = *((-(1, s)), v); let q = *((-(1, (*(s, f)))), v); let t = *((-(1, (*(s, (-(1, f)))))), v); caseOf(i, [->(0, { [v, t, p] }), ->(1, { [q, v, p] }), ->(2, { [p, v, t] }), ->(3, { [p, q, v] }), ->(4, { [t, p, v] }), ->(5, { [v, p, q] })], { unimplementedCase(self,'hsvToRgb') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar14 = assertIsOfSize(asFloat(self), 3); let r = at(__SplVar14, 1); let g = at(__SplVar14, 2); let b = at(__SplVar14, 3); let v = max([r, g, b]); let c = -(v, min([r, g, b])); let s = if((=(v, 0)), { 0 }, { /(c, v) }); let h = if((=(c, 0)), { 0 }, { if((=(v, r)), { *(60, (%(/((-(g, b)), c), 6))) }, { if((=(v, g)), { *(60, (+(/((-(b, r)), c), 2))) }, { *(60, (+(/((-(r, g)), c), 4))) }) }) }); [/(h, 360), s, v] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :reference | let __SplVar15 = assertIsOfSize(self, 3); let x = at(__SplVar15, 1); let y = at(__SplVar15, 2); let z = at(__SplVar15, 3); let __SplVar16 = assertIsOfSize(reference, 3); let rx = at(__SplVar16, 1); let ry = at(__SplVar16, 2); let rz = at(__SplVar16, 3); let delta = /(6, 29); let epsilon = cube(delta); let kappa = /(8, epsilon); let f = { :tu | let t = *(tu, 100); if((>(t, epsilon)), { cubeRoot(t) }, { /((+((*(kappa, t)), 16)), 116) }) }; let fX = f(/(x, rx)); let fY = f(/(y, ry)); let fZ = f(/(z, rz)); [-((*(116, fY)), 16), *(500, (-(fX, fY))), *(200, (-(fY, fZ)))] }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :reference | if((=(self, [0, 0, 0])), { [0, 0, 0] }, { let __SplVar17 = assertIsOfSize(self, 3); let x = at(__SplVar17, 1); let y = at(__SplVar17, 2); let z = at(__SplVar17, 3); let __SplVar18 = assertIsOfSize(reference, 3); let rx = at(__SplVar18, 1); let ry = at(__SplVar18, 2); let rz = at(__SplVar18, 3); let epsilon = /(216, 24389); let kappa = /(24389, 27); let yr = *((/(y, ry)), 100); let xyz = +(+(x, (*(15, y))), (*(3, z))); let rxryrz = +(+(rx, (*(15, ry))), (*(3, rz))); let u1 = /((*(4, x)), xyz); let v1 = /((*(9, y)), xyz); let ur = /((*(4, rx)), rxryrz); let vr = /((*(9, ry)), rxryrz); let l = if((>(yr, epsilon)), { -((*(116, cubeRoot(yr))), 16) }, { *(kappa, yr) }); let u = *(*(13, l), (-(u1, ur))); let v = *(*(13, l), (-(v1, vr))); [l, u, v] }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar19 = assertIsOfSize(self, 3); let x = at(__SplVar19, 1); let y1 = at(__SplVar19, 2); let y2 = at(__SplVar19, 3); if((=(y1, 0)), { [0, 0, 0] }, { [/((*(x, y2)), y1), y2, /((*((-(-(1, x), y1)), y2)), y1)] }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar20 = assertIsOfSize(self, 3); let x = at(__SplVar20, 1); let y = at(__SplVar20, 2); let z = at(__SplVar20, 3); let n = +(+(x, y), z); if((=(n, 0)), { [1, 1, 1] }, { let m = /(1, n); [*(x, m), *(y, m), y] }) }",
);
