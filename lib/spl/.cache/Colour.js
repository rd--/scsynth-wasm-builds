    ...
    return _caseOf_2(_size_1(_self), [
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        let __genSym20 = _assertIsOfSize_2(_self, 3),
          _r = _at_2(__genSym20, 1),
          _g = _at_2(__genSym20, 2),
          _b = _at_2(__genSym20, 3);
        /* Statements */
      ...
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        /* Temporaries */
        let __genSym21 = _assertIsOfSize_2(_self, 4),
          _r = _at_2(__genSym21, 1),
          _g = _at_2(__genSym21, 2),
          _b = _at_2(__genSym21, 3),
          _a = _at_2(__genSym21, 4);
        /* Statements */
