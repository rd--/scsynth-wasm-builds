...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym84 = _assertIsOfSize_2([
        _red_1(_self),
        _green_1(_self),
        _blue_1(_self),
      ], 3),
      _r = _at_2(__genSym84, 1),
      _g = _at_2(__genSym84, 2),
      _b = _at_2(__genSym84, 3);
...
sl.addMethod(
  ...
  function (_r, _g, _b) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _r, _g, _b";
      /* console.error(errorMessage); */
      throw new Error(errorMessage);
    } /* Statements */
...
sl.addMethod(
  ...
  "Colour",
  ["r", "g", "b", "a"],
  function (_r, _g, _b, _a) {
    /* ArityCheck */
    if (arguments.length !== 4) {
      const errorMessage = "Arity: expected 4, _r, _g, _b, _a";
      /* console.error(errorMessage); */
      throw new Error(errorMessage);
    } /* Statements */
    return _initializeSlots_5(_newColour_0(), _r, _g, _b, _a);
  },
...
sl.addMethod(
  ...
  function (_hue, _saturation, _brightness) {
    ...
    return _caseOfOtherwise_3(_i, [
      ...
      return _error_2("Hsv", "implementation error");
    });
  },
  ...
  function (_self) {
    ...
    return _caseOf_2(_size_1(_self), [
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        let __genSym85 = _assertIsOfSize_2(_self, 3),
          _r = _at_2(__genSym85, 1),
          _g = _at_2(__genSym85, 2),
          _b = _at_2(__genSym85, 3);
        /* Statements */
        return _Colour_4(_r, _g, _b, 1);
      }),
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        let __genSym86 = _assertIsOfSize_2(_self, 4),
          _r = _at_2(__genSym86, 1),
          _g = _at_2(__genSym86, 2),
          _b = _at_2(__genSym86, 3),
          _a = _at_2(__genSym86, 4);
        /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym87 = _assertIsOfSize_2(_asFloat_1(_self), 3),
      _h = _at_2(__genSym87, 1),
      _s = _at_2(__genSym87, 2),
      _v = _at_2(__genSym87, 3);
    let __genSym88 = _assertIsOfSize_2(_asList_1(_Hsv_3(_h, _s, _v)), 4),
      _r = _at_2(__genSym88, 1),
      _g = _at_2(__genSym88, 2),
      _b = _at_2(__genSym88, 3),
      _a = _at_2(__genSym88, 4);
    /* Statements */
    return [_r, _g, _b];
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym89 = _assertIsOfSize_2(_asFloat_1(_self), 3),
      _r = _at_2(__genSym89, 1),
      _g = _at_2(__genSym89, 2),
      _b = _at_2(__genSym89, 3);
    /* Statements */
