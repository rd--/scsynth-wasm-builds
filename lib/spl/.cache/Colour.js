  ...
  sl.annotateFunction(function (_ryb, _alpha) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _RgbColour_2(_rybToRgb_1(_ryb), _alpha);
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _collect_2(
          ...
          sl.annotateFunction(function (_each) {
            ...
            return _RybColour_2(_each, _alpha);
          }, ["each"]),
        );
      }, []),
    );
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _l = _at_2(__SplVar6, 1);
    let _a = _at_2(__SplVar6, 2);
    let _b = _at_2(__SplVar6, 3);
    let __SplVar7 = _assertIsOfSize_2(_toPolarCoordinates_1([_a, _b]), 2);
    let _c = _at_2(__SplVar7, 1);
    let _h = _at_2(__SplVar7, 2);
    /* Statements */
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _j = _at_2(__SplVar8, 1);
    let _c = _at_2(__SplVar8, 2);
    let _h = _at_2(__SplVar8, 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    let _l = _at_2(__SplVar9, 1);
    let _a = _at_2(__SplVar9, 2);
    let _b = _at_2(__SplVar9, 3);
    let __SplVar10 = _assertIsOfSize_2(_reference, 3);
    let _rx = _at_2(__SplVar10, 1);
    let _ry = _at_2(__SplVar10, 2);
    let _rz = _at_2(__SplVar10, 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    let __SplVar11 = _assertIsOfSize_2(_self, 3);
    let _l = _at_2(__SplVar11, 1);
    let _u = _at_2(__SplVar11, 2);
    let _v = _at_2(__SplVar11, 3);
    let __SplVar12 = _assertIsOfSize_2(_reference, 3);
    let _rx = _at_2(__SplVar12, 1);
    let _ry = _at_2(__SplVar12, 2);
    let _rz = _at_2(__SplVar12, 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_ryb, _colourTable) {
    ...
    let __SplVar14 = _assertIsOfSize_2(_ryb, 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar15 = _assertIsOfSize_2(_asFloat_1(_self), 3);
    let _hue = _at_2(__SplVar15, 1);
    let _saturation = _at_2(__SplVar15, 2);
    let _brightness = _at_2(__SplVar15, 3);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _r = _at_2(__SplVar16, 1);
    let _g = _at_2(__SplVar16, 2);
    let _b = _at_2(__SplVar16, 3);
  ...
  sl.annotateFunction(function (_self, _reference) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _z = _at_2(__SplVar19, 3);
        let __SplVar20 = _assertIsOfSize_2(_reference, 3);
        let _rx = _at_2(__SplVar20, 1);
        let _ry = _at_2(__SplVar20, 2);
        let _rz = _at_2(__SplVar20, 3);
        let _epsilon = _solidus_2(216, 24389);
        let _kappa = _solidus_2(24389, 27);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar21 = _assertIsOfSize_2(_self, 3);
    let _x = _at_2(__SplVar21, 1);
    let _y1 = _at_2(__SplVar21, 2);
    let _y2 = _at_2(__SplVar21, 3);
    /* Statements */
    return _if_3(
      _equalsSign_2(_y1, 0),
      sl.annotateFunction(function () {
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _y = _at_2(__SplVar22, 2);
    let _z = _at_2(__SplVar22, 3);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SplVar23 = _assertIsOfSize_2(_splitBy_2(_self, "/"), 2);
        let _catalogueName = _at_2(__SplVar23, 1);
        let _colourName = _at_2(__SplVar23, 2);
        /* Statements */
