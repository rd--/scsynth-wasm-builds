...
sl.addMethod(
  ...
  function (_self, _aColour) {
    ...
    /* Statements */
    return _and_2(_isColour_1(_aColour), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _and_2(_equals_2(_red_1(_self), _red_1(_aColour)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _and_2(
          _equals_2(_green_1(_self), _green_1(_aColour)),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
            ...
            /* Statements */
            return _and_2(
              _equals_2(_blue_1(_self), _blue_1(_aColour)),
              function () {
                /* ArityCheck */
                if (arguments.length !== 0) {
                  const errorMessage = "Arity: expected 0, ";
                ...
                /* Statements */
                return _equals_2(_alpha_1(_self), _alpha_1(_aColour));
              },
            );
          },
        );
      ...
      _join_1(
        _collect_2(
          ...
          function (_each) {
            ...
            /* Statements */
            return _byteHexString_1(_rounded_1(_times_2(_each, 255)));
          },
        ),
      ),
    );
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _and_2(
      _greaterThan_2(_blue_1(_self), _plus_2(_green_1(_self), 0.3)),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        /* Statements */
        return _and_2(
          _greaterThan_2(_blue_1(_self), _plus_2(_red_1(_self), 0.3)),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
            ...
            /* Statements */
            return _lessThan_2(
              _abs_1(_minus_2(_green_1(_self), _red_1(_self))),
              0.4,
            );
          },
        );
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _and_2(_lessThan_2(_red_1(_self), 0.05), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _and_2(
        _greaterThan_2(_min_2(_green_1(_self), _blue_1(_self)), 0.5),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          return _lessThan_2(
            _abs_1(_minus_2(_green_1(_self), _blue_1(_self))),
            0.2,
          );
        },
      );
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _and_2(
      _greaterThan_2(_green_1(_self), _plus_2(_blue_1(_self), 0.3)),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        /* Statements */
        return _greaterThan_2(_green_1(_self), _plus_2(_red_1(_self), 0.3));
      },
    );
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _and_2(_equals_2(_green_1(_self), _value), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _and_2(_equals_2(_blue_1(_self), _value), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _and_2(_tildeEquals_2(_value, 1), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            console.error(errorMessage);
          ...
          /* Statements */
          return _tildeEquals_2(_value, 0);
        });
      });
    });
  },
...
sl.addMethod(
  ...
  function (_self, _value) {
    ...
    /* Statements */
    return _and_2(_equals_2(_red_1(_self), _value), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      return _and_2(_equals_2(_green_1(_self), _value), function () {
        ...
        /* Statements */
        return _equals_2(_blue_1(_self), _value);
      });
    });
  },
  "{ :self :value |\n\t\tself.red = value & {\n\t\t\tself.green = value & {\n\t\t\t\tself.blue = value\n\t\t\t}\n\t\t}\n\t}",
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _and_2(_lessThan_2(_green_1(_self), 0.05), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _and_2(
        _greaterThan_2(_min_2(_red_1(_self), _blue_1(_self)), 0.4),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          return _lessThan_2(
            _abs_1(_minus_2(_red_1(_self), _blue_1(_self))),
            0.3,
          );
        },
      );
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _equals_2(_alpha_1(_self), 1);
  },
  "{ :self |\n\t\tself.alpha = 1\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _and_2(
      _greaterThan_2(_red_1(_self), _plus_2(_green_1(_self), 0.4)),
      function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        /* Statements */
        return _and_2(
          _greaterThan_2(_red_1(_self), _plus_2(_blue_1(_self), 0.6)),
          function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _equals_2(_alpha_1(_self), 0);
  },
  "{ :self |\n\t\tself.alpha = 0\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _and_2(_lessThan_2(_blue_1(_self), 0.1), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      /* Statements */
      return _and_2(
        _greaterThan_2(_min_2(_red_1(_self), _green_1(_self)), 0.5),
        function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
          ...
          /* Statements */
          return _lessThan_2(
            _abs_1(_minus_2(_red_1(_self), _green_1(_self))),
            0.2,
          );
        },
      );
...
sl.addMethod(
  ...
  function (_self, _aColour) {
    ...
    let _alpha = _minus_2(
      1,
      _times_2(_minus_2(1, _alpha_1(_aColour)), _minus_2(1, _alpha_1(_self))),
    );
    /* Statements */
    return _Colour_4(
      _plus_2(
        _dividedBy_2(_times_2(_red_1(_aColour), _alpha_1(_aColour)), _alpha),
        _dividedBy_2(
          _times_2(
            _times_2(_red_1(_self), _alpha_1(_self)),
            _minus_2(1, _alpha_1(_aColour)),
          ),
          _alpha,
        ),
      ),
      _plus_2(
        _dividedBy_2(_times_2(_green_1(_aColour), _alpha_1(_aColour)), _alpha),
        _dividedBy_2(
          _times_2(
            _times_2(_green_1(_self), _alpha_1(_self)),
            _minus_2(1, _alpha_1(_aColour)),
          ),
          _alpha,
        ),
      ...
      _plus_2(
        _dividedBy_2(_times_2(_blue_1(_aColour), _alpha_1(_aColour)), _alpha),
        _dividedBy_2(
          _times_2(
            _times_2(_blue_1(_self), _alpha_1(_self)),
            _minus_2(1, _alpha_1(_aColour)),
          ),
          _alpha,
        ),
...
sl.addMethod(
  ...
  function (_self, _saturation, _brightness) {
    ...
    let _hf = _modulo_2(_self, 360);
    let _i = _dividedByDividedBy_2(_hf, 60);
    let _f = _dividedBy_2(_modulo_2(_hf, 60), 60);
    let _p = _times_2(_minus_2(1, _s), _v);
    let _q = _times_2(_minus_2(1, _times_2(_s, _f)), _v);
    let _t = _times_2(_minus_2(1, _times_2(_s, _minus_2(1, _f))), _v);
    /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _if_3(_equals_2(_self, 1), function () {
      ...
      /* Statements */
      return _if_3(_lessThanEquals_2(_self, 0.0031308), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _minus_2(
          _times_2(_plus_2(1, _a), _raisedTo_2(_self, _dividedBy_2(1, 2.4))),
          _a,
        );
      });
    });
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return _if_3(_equals_2(_self, 1), function () {
      ...
      /* Statements */
      return _if_3(_lessThanEquals_2(_self, 0.04045), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _dividedBy_2(_self, 12.92);
      }, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        /* Statements */
        return _raisedTo_2(
          _dividedBy_2(_plus_2(_self, _a), _plus_2(1, _a)),
          2.4,
        );
      });
    });
  ...
  function (_self) {
    ...
    return _caseOf_2(_size_1(_self), [
      _minusGreaterThan_2(function () {
        ...
        /* Temporaries */
        let __genSym12 = _assertIsOfSize_2(_self, 3),
          _r = _at_2(__genSym12, 1),
          _g = _at_2(__genSym12, 2),
          _b = _at_2(__genSym12, 3);
        /* Statements */
      ...
      _minusGreaterThan_2(function () {
        ...
        /* Temporaries */
        let __genSym13 = _assertIsOfSize_2(_self, 4),
          _r = _at_2(__genSym13, 1),
          _g = _at_2(__genSym13, 2),
          _b = _at_2(__genSym13, 3),
          _a = _at_2(__genSym13, 4);
        /* Statements */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _if_3(_equals_2(_size_1(_self), 7), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      return _Colour_1(_collect_2([_r, _g, _b, "ff"], function (_each) {
        ...
        /* Statements */
        return _dividedBy_2(_parseInteger_2(_each, 16), 255);
      }));
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
    ...
    return _cached_3(_self, "colourNameTable", function () {
      ...
      return Object.fromEntries([
        ...
        [
          "paleBuff",
          _Colour_3(
            _dividedBy_2(254, 255),
            _dividedBy_2(250, 255),
            _dividedBy_2(235, 255),
          ),
        ],
        [
          "paleBlue",
          _Colour_3(
            _dividedBy_2(222, 255),
            _dividedBy_2(249, 255),
            _dividedBy_2(254, 255),
          ),
        ],
        [
          "paleYellow",
          _Colour_3(
            _dividedBy_2(255, 255),
            _dividedBy_2(255, 255),
            _dividedBy_2(217, 255),
          ),
        ],
        [
          "paleGreen",
          _Colour_3(
            _dividedBy_2(223, 255),
            _dividedBy_2(255, 255),
            _dividedBy_2(213, 255),
          ),
        ],
        [
          "paleRed",
        ...
        [
          ...
          _Colour_3(
            _dividedBy_2(235, 255),
            _dividedBy_2(224, 255),
            _dividedBy_2(199, 255),
          ),
        ],
        [
          "paleMagenta",
        ...
        [
          "paleOrange",
          _Colour_3(
            _dividedBy_2(253, 255),
            _dividedBy_2(237, 255),
            _dividedBy_2(215, 255),
          ),
        ],
        [
          "palePeach",
        ...
        [
          "pantonePurple",
          _Colour_3(
            _dividedBy_2(193, 255),
            _dividedBy_2(81, 255),
            _dividedBy_2(184, 255),
          ),
        ],
      ]);
    });
