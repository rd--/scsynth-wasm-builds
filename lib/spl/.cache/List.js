...
sl.addMethod(
  ...
  function (_self, _separator) {
    ...
    /* Temporaries */
    let _type = _elementType_1(_self);
    /* Statements */
    return _caseOfOtherwise_3(_type, [
      _hyphenMinusGreaterThanSign_2("List", function () {
        ...
        /* Statements */
        return _concatenationSeparatedBy_2(
          _self,
          _questionMark_2(_separator, function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
              const errorMessage = "Arity: expected 0, ";
              console.error(errorMessage);
  ...
  function (_self) {
    ...
    return _caseOfOtherwise_3(_size_1(_self), [
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        /* Temporaries */
        let __genSym6 = _assertIsOfSize_2(_self, 2),
          _a = _at_2(__genSym6, 1),
          _b = _at_2(__genSym6, 2);
        /* Statements */
        return [[
      ...
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        /* Temporaries */
        let __genSym7 = _assertIsOfSize_2(_self, 3),
