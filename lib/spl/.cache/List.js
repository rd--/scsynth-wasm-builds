...
sl.addMethodToExistingType(
  ...
  "{ :self :n | transpose(partition(self,n, n)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | flatten(transposeIrregular(self)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | self := /(self, norm(self)); caseOf(size(self), [->(2, { let __SplVar1 = assertIsOfSize(self, 2); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); [[-(square(a), square(b)), *(*(2, a), b)], [*(*(2, a), b), -(square(b), square(a))]] }), ->(3, { let __SplVar2 = assertIsOfSize(self, 3); let a = at(__SplVar2, 1); let b = at(__SplVar2, 2); let c = at(__SplVar2, 3); [[-(1, (*(2, square(a)))), *(*(-2, a), b), *(*(-2, a), c)], [*(*(-2, a), b), -(1, (*(2, square(b)))), *(*(-2, b), c)], [*(*(-2, a), c), *(*(-2, b), c), -(1, (*(2, square(c))))]] })], { error('List>>reflectionMatrix: not two or three list') }) }",
);
