...
sl.addMethodToExistingType(
      ...
      [
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL24 = _assertIsOfSize_2(_self, 2);
  ...
  "{ :self | self := /(self, norm(self)); caseOfOtherwise(size(self), [->({ 2 }, { let __SPL24 = assertIsOfSize(self, 2); let a = at(__SPL24, 1); let b = at(__SPL24, 2); [[-(squared(a), squared(b)), *(*(2, a), b)], [*(*(2, a), b), -(squared(b), squared(a))]] }), ->({ 3 }, { let __SPL25 = assertIsOfSize(self, 3); let a = at(__SPL25, 1); let b = at(__SPL25, 2); let c = at(__SPL25, 3); [[-(1, (*(2, squared(a)))), *(*(-2, a), b), *(*(-2, a), c)], [*(*(-2, a), b), -(1, (*(2, squared(b)))), *(*(-2, b), c)], [*(*(-2, a), c), *(*(-2, b), c), -(1, (*(2, squared(c))))]] })], { error('List>>reflectionMatrix: not two or three list') }) }",
);
