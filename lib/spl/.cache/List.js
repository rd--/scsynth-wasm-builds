  ...
  function (_self, _separator) {
    ...
    return _if_3(
      ...
      function () {
        ...
        /* Statements */
        return _error_2(_self, "List>>join: heterogenous list");
      },
    );
  },
  ...
  function (_self) {
    ...
    return _caseOfOtherwise_3(_size_1(_self), [
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        /* Temporaries */
        let __genSym7 = _assertIsOfSize_2(_self, 2),
      ...
      _hyphenMinusGreaterThanSign_2(function () {
        ...
        /* Temporaries */
        let __genSym8 = _assertIsOfSize_2(_self, 3),
...
sl.extendTraitWithMethod(
  ...
  function (_self, _start, _step) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _start, _step"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_size) {
    ...
    if (arguments.length !== 1) {
      const errorMessage =
        "Arity: expected 1, _size"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.extendTraitWithMethod(
  ...
  function (_size, _anObject) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _size, _anObject"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_x1, _x2, _n) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _x1, _x2, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
...
sl.extendTraitWithMethod(
  ...
  function (_a, _b, _n) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _a, _b, _n"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_shape, _aBlock_1) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _shape, _aBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
