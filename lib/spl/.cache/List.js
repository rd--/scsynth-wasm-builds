...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _duplicate_2(_self, _anObject);
  },
...
sl.addMethod(
  ...
  "duplicateInteger",
  ["self:/0", "anInteger"],
  function (_self_0, _anInteger) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self_0, _anInteger";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  "duplicate",
  ["self:/0", "anObject"],
  function (_self_0, _anObject) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self_0, _anObject";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _if_3(_isSequence_1(_anObject), function () {
      ...
      /* Statements */
      return _duplicateShape_2(_self_0, _anObject);
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      /* Statements */
      return _duplicateInteger_2(_self_0, _anObject);
    });
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self, _anObject) {
    ...
    return _if_3(_isSequence_1(_anObject), function () {
      ...
      /* Statements */
      return _replicateShape_2(_self, _anObject);
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
...
sl.extendTraitWithMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _replicate_2(_self, _anObject);
  },
