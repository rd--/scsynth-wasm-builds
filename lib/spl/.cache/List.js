      ...
      sl.annotateFunction(function (_x) {
        ...
        let _i = _detectIndex_2(
          ...
          sl.annotateFunction(function (_y) {
            ...
            return _equalsSign_2(_k, _key_1(_y));
          }, ["y"]),
        );
        /* Statements */
        return _ifNil_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _add_2(_a, _hyphenMinusGreaterThanSign_2(_k, [_x]));
          }, []),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
            ...
            return _add_2(_value_1(_at_2(_a, _i)), _x);
          }, []),
        );
      }, ["x"]),
    );
    return _collect_2(_a, _value_1);
  }, ["self", "aBlock:/1"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aBlock_2) {
    ...
    return _second_1(_recordValuesAndPositions_2(_self, _aBlock_2));
  }, ["self", "aBlock:/2"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _recordPositions_2(_self, _greaterThanSign_2);
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _aBlock_2) {
    ...
    return _first_1(_recordValuesAndPositions_2(_self, _aBlock_2));
  }, ["self", "aBlock:/2"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _recordValues_2(_self, _greaterThanSign_2);
  }, ["self"]),
  "{ :self |\n\t\tself.recordValues(>)\n\t}",
);
      ...
      sl.annotateFunction(function (_i) {
        ...
        return _ifFalse_2(
          ...
          sl.annotateFunction(function () {
            ...
            return _add_2(_answer, _at_2(_self, _i));
          }, []),
        );
      }, ["i"]),
    );
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _indices) {
    ...
    let _uniqueIndices = _unique_1(_indices);
    let _indexCount = _size_1(_uniqueIndices);
    let _removed = _atAll_2(_self, _uniqueIndices);
    /* Statements */
    _toDo_3(
      1,
      _indexCount,
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _error_2(_self, "unenclose: not one element list");
      }, []),
    );
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _Fraction_2(1, _to_2(1, _self));
  }, ["self"]),
