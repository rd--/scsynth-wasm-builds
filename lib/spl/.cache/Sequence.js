...
sl.addTraitMethod(
  ...
  function (_u) {
    ...
    let __genSym12 = _assertIsOfSize_2(_u, 2),
      _x = _at_2(__genSym12, 1),
      _y = _at_2(__genSym12, 2);
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_u, _v) {
    ...
    let __genSym13 = _assertIsOfSize_2(_u, 3),
      _ux = _at_2(__genSym13, 1),
      _uy = _at_2(__genSym13, 2),
      _uz = _at_2(__genSym13, 3);
    let __genSym14 = _assertIsOfSize_2(_v, 3),
      _vx = _at_2(__genSym14, 1),
      _vy = _at_2(__genSym14, 2),
      _vz = _at_2(__genSym14, 3);
    /* Statements */
    return [
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    let __genSym15 = _assertIsOfSize_2(_cos_1(_self), 3),
      _ca = _at_2(__genSym15, 1),
      _cb = _at_2(__genSym15, 2),
      _cc = _at_2(__genSym15, 3);
    let __genSym16 = _assertIsOfSize_2(_sin_1(_self), 3),
      _sa = _at_2(__genSym16, 1),
      _sb = _at_2(__genSym16, 2),
      _sc = _at_2(__genSym16, 3);
    /* Statements */
    return [[
      _hyphenMinus_2(
...
sl.addTraitMethod(
  ...
  function (_self, _aSequence) {
    ...
    return _indicesOfSubstringStartingAt_3(_self, _aSequence, 1);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _aSequence, _anotherSequence, _aBlock_3) {
    ...
    _isOfSameSizeCheck_2(_self, _aSequence);
    _isOfSameSizeCheck_2(_self, _anotherSequence);
    return _indicesDo_2(_self, function (_index) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _index";
