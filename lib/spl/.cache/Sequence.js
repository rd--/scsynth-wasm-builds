...
sl.addTraitMethod(
  ...
  function (_u) {
    ...
    /* Temporaries */
    let __genSym3 = _assertIsOfSize_2(_u, 2),
...
sl.addTraitMethod(
  ...
  function (_u, _v) {
    ...
    /* Temporaries */
    let __genSym4 = _assertIsOfSize_2(_u, 3),
      _ux = _at_2(__genSym4, 1),
      _uy = _at_2(__genSym4, 2),
      _uz = _at_2(__genSym4, 3);
    let __genSym5 = _assertIsOfSize_2(_v, 3),
      _vx = _at_2(__genSym5, 1),
      _vy = _at_2(__genSym5, 2),
      _vz = _at_2(__genSym5, 3);
    /* Statements */
    return [
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym6 = _assertIsOfSize_2(_cos_1(_self), 3),
      _ca = _at_2(__genSym6, 1),
      _cb = _at_2(__genSym6, 2),
      _cc = _at_2(__genSym6, 3);
    let __genSym7 = _assertIsOfSize_2(_sin_1(_self), 3),
      _sa = _at_2(__genSym7, 1),
      _sb = _at_2(__genSym7, 2),
      _sc = _at_2(__genSym7, 3);
    /* Statements */
    return [[
      _hyphenMinus_2(
