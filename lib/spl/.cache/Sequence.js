...
sl.addTraitMethod(
  ...
  function (_self, _k) {
    ...
    return _ampersand_2(_isMatrix_1(_self), function () {
      ...
      /* Temporaries */
      let __genSym1 = _assertIsOfSize_2(_shape_1(_self), 2),
      ...
      return _allSatisfy_2(_to_2(1, _hyphenMinus_2(_r, _k)), function (_i) {
        ...
        return _allSatisfy_2(
          ...
          function (_j) {
            ...
            /* Statements */
            return _equalsSign_2(_at_2(_at_2(_self, _i), _j), 0);
          },
        );
      });
    });
...
sl.addTraitMethod(
  ...
  function (_m, _p) {
    ...
    /* Temporaries */
    let __genSym3 = _assertIsOfSize_2(_shape_1(_m), 2),
      _a = _at_2(__genSym3, 1),
      _b = _at_2(__genSym3, 2);
    /* Statements */
...
sl.addTraitMethod(
  ...
  "cliPlot",
  ["self", "isDiscrete"],
  function (_self, _isDiscrete) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _isDiscrete";
      console.error(errorMessage);
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    return _then_2(
      ...
      function (_unused) {
        ...
        return _systemCommand_3(_system, "hsc3-plot", [
          ...
          _plusSignPlusSign_2(
            "--impulse=",
            _capitalized_1(_asString_1(_isDiscrete)),
          ),
          _fileName,
          "0",
        ]);
