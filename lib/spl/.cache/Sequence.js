...
sl.addTraitMethod(
  ...
  function (_u) {
    ...
    /* Temporaries */
    let __genSym8 = _assertIsOfSize_2(_u, 2),
      _x = _at_2(__genSym8, 1),
      _y = _at_2(__genSym8, 2);
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_u, _v) {
    ...
    /* Temporaries */
    let __genSym9 = _assertIsOfSize_2(_u, 3),
      _ux = _at_2(__genSym9, 1),
      _uy = _at_2(__genSym9, 2),
      _uz = _at_2(__genSym9, 3);
    let __genSym10 = _assertIsOfSize_2(_v, 3),
      _vx = _at_2(__genSym10, 1),
      _vy = _at_2(__genSym10, 2),
      _vz = _at_2(__genSym10, 3);
    /* Statements */
    return [
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym11 = _assertIsOfSize_2(_cos_1(_self), 3),
      _ca = _at_2(__genSym11, 1),
      _cb = _at_2(__genSym11, 2),
      _cc = _at_2(__genSym11, 3);
    let __genSym12 = _assertIsOfSize_2(_sin_1(_self), 3),
      _sa = _at_2(__genSym12, 1),
      _sb = _at_2(__genSym12, 2),
      _sc = _at_2(__genSym12, 3);
    /* Statements */
    return [[
      _hyphenMinus_2(
