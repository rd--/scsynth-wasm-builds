...
sl.addTraitMethod(
  ...
  function (_u) {
    ...
    let __genSym15 = _assertIsOfSize_2(_u, 2),
      _x = _at_2(__genSym15, 1),
      _y = _at_2(__genSym15, 2);
    /* Statements */
...
sl.addTraitMethod(
  ...
  function (_u, _v) {
    ...
    let __genSym16 = _assertIsOfSize_2(_u, 3),
      _ux = _at_2(__genSym16, 1),
      _uy = _at_2(__genSym16, 2),
      _uz = _at_2(__genSym16, 3);
    let __genSym17 = _assertIsOfSize_2(_v, 3),
      _vx = _at_2(__genSym17, 1),
      _vy = _at_2(__genSym17, 2),
      _vz = _at_2(__genSym17, 3);
    /* Statements */
    return [
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    let __genSym18 = _assertIsOfSize_2(_cos_1(_self), 3),
      _ca = _at_2(__genSym18, 1),
      _cb = _at_2(__genSym18, 2),
      _cc = _at_2(__genSym18, 3);
    let __genSym19 = _assertIsOfSize_2(_sin_1(_self), 3),
      _sa = _at_2(__genSym19, 1),
      _sb = _at_2(__genSym19, 2),
      _sc = _at_2(__genSym19, 3);
    /* Statements */
    return [[
      _hyphenMinus_2(
