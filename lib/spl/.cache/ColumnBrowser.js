...
sl.addMethod(
  ...
  function (
    ...
    _columnLists_2(
      _self,
      _collect_2(
        _upOrDownTo_2(Number("1").toString(), _numberOfColumns_1(_self)),
        function (_index) {
          /* ArityCheck */
          ...
          return _ListChooser_3(
            _ampersand_2(_withFilter, function () {
              ...
              /* Statements */
              return _equalsSign_2(_index, Number("1").toString());
            }),
            null,
            _listSize,
          );
...
sl.addMethod(
  ...
  function (
    ...
    _setColumnEntries_3(_self, Number("1").toString(), _onChange_2(_self, []));
...
sl.addMethod(
  ...
  function (_self, _size) {
    ...
    /* Statements */
    return _collect_2(
      _upOrDownTo_2(Number("1").toString(), _size),
      function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
  ...
  function (_self, _index, _onChange_2) {
    ...
    return _if_3(_equalsSign_2(_index, _numberOfColumns_1(_self)), function () {
      ...
      _toDo_3(
        Number("1").toString(),
        _hyphenMinus_2(
          _hyphenMinus_2(_numberOfColumns_1(_self), _index),
          Number("1").toString(),
        ),
        function (_each) {
          /* ArityCheck */
          ...
          return _removeAll_1(
            _select_1(
              _at_2(
                ...
                _plusSign_2(_plusSign_2(_index, _each), Number("1").toString()),
              ),
            ),
          );
        },
      );
      return _setColumnEntries_3(
        _self,
        _plusSign_2(_index, Number("1").toString()),
        _next,
      );
    });
  },
