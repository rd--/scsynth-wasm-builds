...
sl.addMethod(
  ...
  function (
    ...
    if (arguments.length !== 6) {
      const errorMessage =
        "Arity: expected 6, _self, _mimeType, _withFilter, _withStatus, _columnProportions, _listSize"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    _browserPane_2(
...
sl.addMethod(
  ...
  function (
    ...
    if (arguments.length !== 10) {
      const errorMessage =
        "Arity: expected 10, _self, _smallKansas, _title, _mimeType, _withFilter, _withStatus, _columnProportions, _clientKeyBindings, _onAccept_1, _onChange_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _index, _onChange_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _index, _onChange_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    ...
    return _if_3(_equalsSign_2(_index, _numberOfColumns_1(_self)), function () {
      ...
      return _then_2(_next, function (_view) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _view"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _index, _entries) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _index, _entries"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _onChange_2) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _onChange_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (
    ...
    if (arguments.length !== 9) {
      const errorMessage =
        "Arity: expected 9, _self, _title, _mimeType, _withFilter, _withStatus, _columnProportions, _clientKeyBindings, _onAccept_1, _onChange_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
