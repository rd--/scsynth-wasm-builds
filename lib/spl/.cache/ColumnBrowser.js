...
sl.addMethod(
  ...
  function (_self, _index, _onChange_2) {
    ...
    /* Statements */
    return _if_3(_equals_2(_index, _numberOfColumns_1(_self)), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      _toDo_3(
        1,
        _minus_2(_minus_2(_numberOfColumns_1(_self), _index), 1),
        function (_each) {
          /* ArityCheck */
          if (arguments.length !== 1) {
            const errorMessage = "Arity: expected 1, _each";
          ...
          return _removeAll_1(
            _select_1(
              _at_2(_columnLists_1(_self), _plus_2(_plus_2(_index, _each), 1)),
            ),
          );
        },
      );
      return _setColumnEntries_3(_self, _plus_2(_index, 1), _next);
    });
  },
