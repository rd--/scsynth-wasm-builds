  ...
  sl.annotateFunction(function (_self, _from, _to, _sortBlock_2) {
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      return _repeatForever_1(sl.annotateFunction(function () {
        ...
        let _di = _at_2(_self, _i);
        let _dj = _at_2(_self, _j);
        _ifFalse_2(
        ...
        let _n = _hyphenMinus_2(_plusSign_2(_j, 1), _i);
        _ifTrue_2(
        ...
        let _ij = _solidusSolidus_2(_plusSign_2(_i, _j), 2);
        let _dij = _at_2(_self, _ij);
        _if_3(
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _quickSortBy_2(_self, _lessEqual_2);
  }, ["self"]),
