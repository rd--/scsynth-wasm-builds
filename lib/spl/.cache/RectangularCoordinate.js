...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _compareBy_3(_self, _anObject, _lessThan_2);
  },
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _compareBy_3(_self, _anObject, _lessThanEquals_2);
  },
  "{ :self :anObject |\n\t\tself.compareBy(anObject, <=)\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _applyBinaryOperator_3(_self, _anObject, _plus_2);
  },
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _applyBinaryOperator_3(_self, _anObject, _minus_2);
  },
  "{ :self :anObject |\n\t\tself.applyBinaryOperator(anObject, -)\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _applyBinaryOperator_3(_self, _anObject, _times_2);
  },
  "{ :self :anObject |\n\t\tself.applyBinaryOperator(anObject, *)\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _applyBinaryOperator_3(_self, _anObject, _dividedBy_2);
  },
  "{ :self :anObject |\n\t\tself.applyBinaryOperator(anObject, /)\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _applyBinaryOperator_3(_self, _anObject, _dividedByDividedBy_2);
  },
  "{ :self :anObject |\n\t\tself.applyBinaryOperator(anObject, //)\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _applyBinaryOperator_3(_self, _anObject, _modulo_2);
  },
  "{ :self :anObject |\n\t\tself.applyBinaryOperator(anObject, %)\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _Tuple_2(_x_1(_self), _y_1(_self));
  },
  "{ :self |\n\t\t(self.x, self.y)\n\t}",
);
...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Temporaries */
    let _dx = _minus_2(_x_1(_anObject), _x_1(_self));
    let _dy = _minus_2(_y_1(_anObject), _y_1(_self));
    /* Statements */
    return _sqrt_1(_plus_2(_times_2(_dx, _dx), _times_2(_dy, _dy)));
  },
...
sl.addMethod(
  ...
  function (_self, _anObject, _aBlock_2) {
    ...
    /* Statements */
    return _and_2(_isRectangularCoordinate_1(_anObject), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
  ...
  function (_self, _inversionCenter, _inversionRadius) {
    ...
    return _RectangularCoordinate_2(
      _plus_2(
        _x0,
        _dividedBy_2(
          _times_2(_squared_1(_k), _minus_2(_x, _x0)),
          _plus_2(_squared_1(_minus_2(_x, _x0)), _squared_1(_minus_2(_y, _y0))),
        ),
      ),
      _plus_2(
        _y0,
        _dividedBy_2(
          _times_2(_squared_1(_k), _minus_2(_y, _y0)),
          _plus_2(_squared_1(_minus_2(_x, _x0)), _squared_1(_minus_2(_y, _y0))),
        ),
      ),
    );
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _sqrt_1(_plus_2(_squared_1(_x_1(_self)), _squared_1(_y_1(_self))));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_self, _norm_1(_self));
  },
  "{ :self |\n\t\tself / self.norm\n\t}",
);
