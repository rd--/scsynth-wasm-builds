...
sl.addMethod(
  ...
  function (_onNext, _onReset) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _onNext, _onReset"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _anObject, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_1, _anObject, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _anObject, _count) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_1, _anObject, _count"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self_1, _anObject, _aBlock_1) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self_1, _anObject, _aBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_lhs, _rhs) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _lhs, _rhs"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aStream, _aBlock_2) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aStream, _aBlock_2"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _atEnd = false;
...
sl.extendTraitWithMethod(
  ...
  function (_input, _count) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _input, _count"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _repeats) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _repeats"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
    let _repeat = 1;
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aBlock_1) {
    ...
    return _BlockStream_2(function () {
      ...
      /* Statements */
      return _if_3(_aBlock_1(_answer), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage =
            "Arity: expected 0, "; /* console.error(errorMessage); */
...
sl.extendTraitWithMethod(
  ...
  function (_self, _aStream, _anotherStream, _aBlock_3) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _aStream, _anotherStream, _aBlock_3"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _BlockStream_2(function () {
