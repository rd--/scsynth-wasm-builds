sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :sortBlock:/2 | let h = Heap(sortBlock:/2); let l = []; let k = size(self); addAll(h,self); timesRepeat(k, { add(l,removeFirst(h)) }); l }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _heapSort_2(_self, _lessThanSignEqualsSign_2);
  }, ["self"]),
  "{ :self | heapSort(self,<=) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _sort_2(_self, _precedes_2);
  }, ["self"]),
  "{ :self | sort(self,precedes:/2) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :sortBlock:/2 :keyBlock:/1 | ifNil(keyBlock:/1, { sortBy(self,?(sortBlock:/2, { <= })) }, { sortByOn(self,?(sortBlock:/2, { <= }), keyBlock:/1) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :sortBlock:/2 | sortBy(self,?(sortBlock:/2, { <= })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _keyBlock_1) {
    ...
    return _sortByOn_3(_self, _lessThanSignEqualsSign_2, _keyBlock_1);
  }, ["self", "keyBlock:/1"]),
  "{ :self :keyBlock:/1 | sortByOn(self,<=, keyBlock:/1) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :sortBlock:/2 | sortBy(copy(self),sortBlock:/2) }",
);
