...
sl.extendTypeOrTraitWithMethod(
  ...
  "SymbolicExpression",
  "isNumericConstant",
  ["unused", "unusedOperand"],
  sl.annotateFunction(function (_unused, _unusedOperand) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _unused, _unusedOperand";
      throw new Error(errorMessage);
    } /* Statements */
    return false;
  }, ["unused", "unusedOperand"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _if_3(
      _isNumericConstant_2(_operand, 1),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _if_3(
      _isNumericConstant_2(_operand, 0),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _receiver, _aBlock_2) {
    ...
    /* Statements */
    return _simplifyConstantMath_1(
      _SymbolicExpression_2(
        _questionMark_2(
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _symbolicPrimitive_2("sec", [_self]);
  }, ["self"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _symbolicPrimitive_2("sech", [_self]);
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      _equalsSign_2(_size_1(_operands_1(_self)), 2),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
        ...
        let __SplVar1 = _assertIsOfSize_2(_operands_1(_self), 2);
        let _p = _at_2(__SplVar1, 1);
        let _q = _at_2(__SplVar1, 2);
        let _simplify_1 = sl.annotateFunction(function (_k) {
          /* ArityCheck */
          if (arguments.length !== 1) {
