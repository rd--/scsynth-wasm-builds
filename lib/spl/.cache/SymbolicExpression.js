...
sl.addMethodToExistingTrait(
  ...
  "{ :self :receiver :aBlock:/2 | let name = unqualifiedName(aBlock:/2); SymbolicExpression(?(splOperatorNameToken(name), { name }), [receiver, self]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | symbolicPrimitive('conjugate',[self]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | symbolicPrimitive('cot',[self]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | symbolicPrimitive('csc',[self]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | symbolicPrimitive('gamma',[self]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :operand | symbolicPrimitive('quotient',[self, operand]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :operand | symbolicPrimitive('remainder',[self, operand]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | symbolicPrimitive('truncate',[self]) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aBlock:/2 | let all = UnsortedSet(); let common = UnsortedSet(); comparator(all, aBlock:/2); comparator(common, aBlock:/2); do(self, { :each | ifTrue(isSymbolicExpression(each), { if(includes(all,each), { uncheckedInclude(common,each) }, { uncheckedInclude(all,each) }) }) }); asList(common) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | caseOf(self, [->(pi(1), { Symbol('π') }), ->(pi(2), { *(2, Symbol('π')) })], { self }) }",
);
