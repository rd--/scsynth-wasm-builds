...
sl.addMethod(
  ...
  function (_self, _subject) {
    ...
    /* Temporaries */
    let _currentSelection_0 = function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
      ...
      _ifTrue_2(_isEmpty_1(_text), function () {
        ...
        /* Statements */
        return _text = _currentText_1(_subject);
      });
      return _text;
    };
    /* Statements */
    return [
      ...
      _MenuItem_3("Browse It", "b", function (_event) {
        ...
        return _browserOn_3(
          _self,
          [_currentWord_1(_window_1(_system))],
          _event,
        );
      }),
      _MenuItem_3("Do It", "d", function (_event) {
        ...
        /* Statements */
        return _evaluate_3(_self, _currentSelection_0(), _event);
      }),
      _MenuItem_3("Help For It", "h", function (_event) {
        ...
        return _helpFor_3(
          _self,
          _asMethodName_1(_currentWord_1(_window_1(_system))),
          _event,
        );
      }),
      ...
      _MenuItem_3("Inspect It", "i", function (_event) {
        ...
        return _inspectorOn_3(
          _self,
          _evaluate_3(_self, _currentWord_1(_window_1(_system)), _event),
          _event,
        );
      }),
      _MenuItem_3("Play It", "Enter", function (_event) {
        ...
        let _text = _plusSignPlusSign_2(
          _plusSignPlusSign_2("{ ", _currentSelection_0()),
          " }.value.play",
        );
        /* Statements */
        _postLine_1(_text);
      ...
      _MenuItem_3("Print It", "p", function (_event) {
        ...
        return _insertText_2(
          ...
          _plusSignPlusSign_2(
            " ",
            _asString_1(_evaluate_3(_self, _currentSelection_0(), _event)),
          ),
        );
      }),
      ...
      _MenuItem_3("Require It", null, function (_event) {
        ...
        /* Statements */
        return _then_2(
          _require_1(_package_2(_system, _currentWord_1(_window_1(_system)))),
          function (_unused) {
            /* ArityCheck */
            if (arguments.length !== 1) {
