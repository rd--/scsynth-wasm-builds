...
sl.addMethod(
  ...
  function (_self) {
    ...
    _editorText_2(
      _self,
      _if_3(_equals_2(_mimeType_1(_self), "text/plain"), function () {
        /* ArityCheck */
      ...
      function (_event) {
        ...
        let _bindingsArray = _collect_2(
          ...
          function (_menuItem) {
            ...
            /* Statements */
            return _minusGreaterThan_2(_accessKey_1(_menuItem), function () {
              /* ArityCheck */
              if (arguments.length !== 0) {
                const errorMessage = "Arity: expected 0, ";
                console.error(errorMessage);
...
sl.addMethod(
  ...
  function (_self, _aString) {
    ...
    return _caseOfOtherwise_3(_mimeType_1(_self), [
      _minusGreaterThan_2("text/html", function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
      ...
      _minusGreaterThan_2("text/markdown", function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
      ...
      return _warning_2(
        _self,
        _plusPlus_2("setEditorText: unkown mimeType: ", _mimeType_1(_self)),
      );
    });
  },
  ...
  function (_self, _subject) {
    ...
    return [
      ...
      _MenuItem_3("Play It", "Enter", function (_event) {
        ...
        /* Temporaries */
        let _text = _plusPlus_2(
          _plusPlus_2("{ ", _currentSelection_1(_subject)),
          " }.value.play",
        );
        /* Statements */
        _postLine_1(_text);
