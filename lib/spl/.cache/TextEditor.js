...
sl.addMethod(
  ...
  function (_self, _smallKansas, _title, _mimeType, _contents) {
    ...
    if (arguments.length !== 5) {
      const errorMessage =
        "Arity: expected 5, _self, _smallKansas, _title, _mimeType, _contents"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _title, _mimeType, _contents) {
    ...
    if (arguments.length !== 4) {
      const errorMessage =
        "Arity: expected 4, _self, _title, _mimeType, _contents"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
