sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_d, _x, _y, _z, _drawContour_6) {
    ...
    let __SPL1 = _assertIsOfSize_2(_shape_1(_d), 2);
