sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_d, _x, _y, _z, _drawContour_6) {
    ...
    let __SPL123 = _assertIsOfSize_2(_shape_1(_d), 2);
    let _m = _at_2(__SPL123, 1);
    let _n = _at_2(__SPL123, 2);
    /* Statements */
