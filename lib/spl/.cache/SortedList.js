...
sl.addMethodToExistingType(
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                let __SPL69 = _assertIsOfSize_2(_at_2(_o, 1), 2);
                let _a = _at_2(__SPL69, 1);
                let _b = _at_2(__SPL69, 2);
                let __SPL70 = _assertIsOfSize_2(_at_2(_o, 2), 2);
                let _c = _at_2(__SPL70, 1);
                let _d = _at_2(__SPL70, 2);
  ...
  "{ :self :p :o | if(isCollection(p), { collect(p, { :each | quantile(self,each, o) }) }, { let y = self; let n = size(y); if((=(p, 0)), { at(y, 1) }, { if((=(p, 1)), { at(y, n) }, { let __SPL69 = assertIsOfSize(at(o, 1), 2); let a = at(__SPL69, 1); let b = at(__SPL69, 2); let __SPL70 = assertIsOfSize(at(o, 2), 2); let c = at(__SPL70, 1); let d = at(__SPL70, 2); let r = +(a, (*((+(n, b)), p))); let f = fractionPart(r); let i0 = max(floor(r),1); let i1 = min(ceiling(r),n); +(at(y, i0), (*((-(at(y, i1), at(y, i0))), (+(c, (*(d, f))))))) }) }) }) }",
);
