...
sl.addMethodToExistingType(
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                let __SPL72 = _assertIsOfSize_2(_at_2(_o, 1), 2);
                let _a = _at_2(__SPL72, 1);
                let _b = _at_2(__SPL72, 2);
                let __SPL73 = _assertIsOfSize_2(_at_2(_o, 2), 2);
                let _c = _at_2(__SPL73, 1);
                let _d = _at_2(__SPL73, 2);
  ...
  "{ :self :p :o | if(isCollection(p), { collect(p, { :each | quantile(self,each, o) }) }, { let y = self; let n = size(y); if((=(p, 0)), { at(y, 1) }, { if((=(p, 1)), { at(y, n) }, { let __SPL72 = assertIsOfSize(at(o, 1), 2); let a = at(__SPL72, 1); let b = at(__SPL72, 2); let __SPL73 = assertIsOfSize(at(o, 2), 2); let c = at(__SPL73, 1); let d = at(__SPL73, 2); let r = +(a, (*((+(n, b)), p))); let f = fractionalPart(r); let i0 = max(floor(r),1); let i1 = min(ceiling(r),n); +(at(y, i0), (*((-(at(y, i1), at(y, i0))), (+(c, (*(d, f))))))) }) }) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      _equalsSign_2(_sortBlock_1(_self), _lessThanSignEqualsSign_2),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
  ...
  "{ :self | if((=(sortBlock(self), <=)), { format('SortedList(%)',[contents(self)]) }, { format('SortedList(%, %)',[contents(self)], name(sortBlock(self))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _SortedList_1(_sorted_1(_self));
  }, ["self"]),
  "{ :self | SortedList(sorted(self)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _SortedList_2(_self, _sortBlock_2);
  }, ["self"]),
  "{ :self | SortedList(self, sortBlock:/2) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :sortBlock:/2 | initializeSlots(newSortedList(),sorted(self), <=) }",
);
