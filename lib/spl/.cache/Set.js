...
sl.addMethodToExistingTrait(
  ...
  "{ :self :anObject | if(includes(self,anObject), { error(self,'set includes item') }, { include(self,anObject) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :anObject | removeIfAbsent(self, anObject, { error(self,'remove: item does not exist') }) }",
);
