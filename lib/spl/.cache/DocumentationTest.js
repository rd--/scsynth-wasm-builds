  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        _then_2(
          _result,
          sl.annotateFunction(function (_deferredResult) {
            /* ArityCheck */
            if (arguments.length !== 1) {
              const errorMessage = "Arity: expected 1, _deferredResult";
              throw new Error(errorMessage);
            } /* Statements */
            return _ifFalse_2(
              _deferredResult,
      ...
      sl.annotateFunction(function (_currentLine) {
        ...
        _ifTrue_2(
          ...
          sl.annotateFunction(function () {
            ...
            _add_2(_answer, _parseDocumentationTest_1(_block));
            _removeAll_1(_block);
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    return _then_2(
      ...
      sl.annotateFunction(function (_answer) {
        ...
        return _tilde_2(_answer, _operand);
      }, ["answer"]),
    );
  }, ["self", "operand"]),
  "{ :self :operand |\n\t\tself.then { :answer |\n\t\t\tanswer ~ operand\n\t\t}\n\t}",
