...
sl.addMethodToExistingType(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL274 = _assertIsOfSize_2(_octave, 2);
            let _numerator = _at_2(__SPL274, 1);
            let _denominator = _at_2(__SPL274, 2);
            /* Statements */
  ...
  "{ :self | let octave = at(contents(self), 'octave'); if(isNumber(octave), { centsToRatio(octave) }, { if(isList(octave), { let __SPL274 = assertIsOfSize(octave, 2); let numerator = at(__SPL274, 1); let denominator = at(__SPL274, 2); Fraction(numerator, denominator) }, { error(self,'octave: invalid octave') }) }) }",
);
...
sl.addMethodToExistingType(
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                let __SPL275 = _assertIsOfSize_2(_each, 2);
                let _numerator = _at_2(__SPL275, 1);
                let _denominator = _at_2(__SPL275, 2);
                /* Statements */
                return _Fraction_2(_numerator, _denominator);
              }, []),
              sl.annotateFunction(function () {
  ...
  "{ :self | collect(at(contents(self), 'pitches'), { :each | if(isNumber(each), { each }, { if(isList(each), { let __SPL275 = assertIsOfSize(each, 2); let numerator = at(__SPL275, 1); let denominator = at(__SPL275, 2); Fraction(numerator, denominator) }, { error(self,'pitches: invalid pitch') }) }) }) }",
);
        ...
        sl.annotateFunction(function (_libraryItem) {
          ...
          return _collect_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL276 = _assertIsOfSize_2(_each, 3);
              let _zeroIndexedStartIndex = _at_2(__SPL276, 1);
              let _intervals = _at_2(__SPL276, 2);
              let _description = _at_2(__SPL276, 3);
              /* Statements */
              return _Scale_3(
        ...
        sl.annotateFunction(function (_libraryItem) {
          ...
          _keysAndValuesDo_2(
            ...
            sl.annotateFunction(function (_key, _value) {
              ...
              let __SPL277 = _assertIsOfSize_2(_value, 2);
              let _n = _at_2(__SPL277, 1);
              let _d = _at_2(__SPL277, 2);
              /* Statements */
              return _add_2(
                _answer,
