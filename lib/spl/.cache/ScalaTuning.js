...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    return _if_3(_isNumber_1(_octave), function () {
      ...
      return _if_3(_isList_1(_octave), function () {
        ...
        let __SPL209 = _assertIsOfSize_2(_octave, 2);
        let _numerator = _at_2(__SPL209, 1);
        let _denominator = _at_2(__SPL209, 2);
        /* Statements */
  ...
  "{ :self | let octave = at(contents(self), 'octave'); if(isNumber(octave), { centsToRatio(octave) }, { if(isList(octave), { let __SPL209 = assertIsOfSize(octave, 2); let numerator = at(__SPL209, 1); let denominator = at(__SPL209, 2); Fraction(numerator, denominator) }, { error(self,'octave: invalid octave') }) }) }",
);
...
sl.addMethodToExistingType(
    ...
    return _collect_2(_at_2(_contents_1(_self), "pitches"), function (_each) {
      ...
      return _if_3(_isNumber_1(_each), function () {
        ...
        return _if_3(_isList_1(_each), function () {
          ...
          let __SPL210 = _assertIsOfSize_2(_each, 2);
          let _numerator = _at_2(__SPL210, 1);
          let _denominator = _at_2(__SPL210, 2);
          /* Statements */
          return _Fraction_2(_numerator, _denominator);
        }, function () {
          /* ArityCheck */
  ...
  "{ :self | collect(at(contents(self), 'pitches'), { :each | if(isNumber(each), { each }, { if(isList(each), { let __SPL210 = assertIsOfSize(each, 2); let numerator = at(__SPL210, 1); let denominator = at(__SPL210, 2); Fraction(numerator, denominator) }, { error(self,'pitches: invalid pitch') }) }) }) }",
);
    ...
    _Record_1([
      ...
      ["parser", function (_libraryItem) {
        ...
        return _collect_2(_libraryItem, function (_each) {
          ...
          let __SPL211 = _assertIsOfSize_2(_each, 3);
          let _zeroIndexedStartIndex = _at_2(__SPL211, 1);
          let _intervals = _at_2(__SPL211, 2);
          let _description = _at_2(__SPL211, 3);
          /* Statements */
          return _Scale_3(
    ...
    _Record_1([
      ...
      ["parser", function (_libraryItem) {
        ...
        _keysAndValuesDo_2(_libraryItem, function (_key, _value) {
          ...
          let __SPL212 = _assertIsOfSize_2(_value, 2);
          let _n = _at_2(__SPL212, 1);
          let _d = _at_2(__SPL212, 2);
          /* Statements */
          return _add_2(
            _answer,
