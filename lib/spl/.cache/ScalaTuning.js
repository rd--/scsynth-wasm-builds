  ...
  function (_self) {
    ...
    return _if_3(_isNumber_1(_octave), function () {
      ...
      return _if_3(_isList_1(_octave), function () {
        ...
        let __genSym184 = _assertIsOfSize_2(_octave, 2),
          _numerator = _at_2(__genSym184, 1),
          _denominator = _at_2(__genSym184, 2);
        /* Statements */
    ...
    return _collect_2(_at_2(_contents_1(_self), "pitches"), function (_each) {
      ...
      return _if_3(_isNumber_1(_each), function () {
        ...
        return _if_3(_isList_1(_each), function () {
          ...
          let __genSym185 = _assertIsOfSize_2(_each, 2),
            _numerator = _at_2(__genSym185, 1),
            _denominator = _at_2(__genSym185, 2);
          /* Statements */
          return _Fraction_2(_numerator, _denominator);
        }, function () {
          /* ArityCheck */
    ...
    Object.fromEntries([
      ...
      ["parser", function (_libraryItem) {
        ...
        return _collect_2(_libraryItem, function (_each) {
          ...
          let __genSym186 = _assertIsOfSize_2(_each, 3),
            _zeroIndexedStartIndex = _at_2(__genSym186, 1),
            _intervals = _at_2(__genSym186, 2),
            _description = _at_2(__genSym186, 3);
          /* Statements */
          return _Scale_3(
    ...
    Object.fromEntries([
      ...
      ["parser", function (_libraryItem) {
        ...
        _keysAndValuesDo_2(_libraryItem, function (_key, _value) {
          ...
          let __genSym187 = _assertIsOfSize_2(_value, 2),
            _n = _at_2(__genSym187, 1),
            _d = _at_2(__genSym187, 2);
          /* Statements */
          return _add_2(
            _answer,
