...
sl.addMethodToExistingType(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL1 = _assertIsOfSize_2(_octave, 2);
            let _numerator = _at_2(__SPL1, 1);
            let _denominator = _at_2(__SPL1, 2);
            /* Statements */
  ...
  "{ :self | let octave = at(contents(self), 'octave'); if(isNumber(octave), { centsToRatio(octave) }, { if(isList(octave), { let __SPL1 = assertIsOfSize(octave, 2); let numerator = at(__SPL1, 1); let denominator = at(__SPL1, 2); Fraction(numerator, denominator) }, { error(self,'octave: invalid octave') }) }) }",
);
...
sl.addMethodToExistingType(
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                let __SPL2 = _assertIsOfSize_2(_each, 2);
                let _numerator = _at_2(__SPL2, 1);
                let _denominator = _at_2(__SPL2, 2);
                /* Statements */
                return _Fraction_2(_numerator, _denominator);
              }, []),
              sl.annotateFunction(function () {
  ...
  "{ :self | collect(at(contents(self), 'pitches'), { :each | if(isNumber(each), { each }, { if(isList(each), { let __SPL2 = assertIsOfSize(each, 2); let numerator = at(__SPL2, 1); let denominator = at(__SPL2, 2); Fraction(numerator, denominator) }, { error(self,'pitches: invalid pitch') }) }) }) }",
);
        ...
        sl.annotateFunction(function (_libraryItem) {
          ...
          return _collect_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL3 = _assertIsOfSize_2(_each, 3);
              let _zeroIndexedStartIndex = _at_2(__SPL3, 1);
              let _intervals = _at_2(__SPL3, 2);
              let _description = _at_2(__SPL3, 3);
              /* Statements */
              return _Scale_3(
        ...
        sl.annotateFunction(function (_libraryItem) {
          ...
          _keysAndValuesDo_2(
            ...
            sl.annotateFunction(function (_key, _value) {
              ...
              let __SPL4 = _assertIsOfSize_2(_value, 2);
