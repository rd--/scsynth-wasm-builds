...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _replaceApostropheWithRightSingleQuotationMark_1(
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _archive = _scalaIntervalArchive_1(_system);
    /* Statements */
      ...
      sl.annotateFunction(function () {
        ...
        return _detectIfFoundIfNone_4(
          ...
          sl.annotateFunction(function (_key) {
            ...
            return _includes_2(_splitBy_2(_key, ", "), _self);
          }, ["key"]),
          sl.annotateFunction(function (_key) {
            /* ArityCheck */
            if (arguments.length !== 1) {
        ...
        sl.annotateFunction(function (_libraryItem) {
          ...
          _keysAndValuesDo_2(
            ...
            sl.annotateFunction(function (_key, _value) {
              ...
              return _add_2(
                _answer,
                _hyphenMinusGreaterThanSign_2(_key, _Fraction_2(_n, _d)),
              );
            }, ["key", "value"]),
          );
          return _answer;
