...
sl.addMethodToExistingType(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL478 = _assertIsOfSize_2(_octave, 2);
  ...
  "{ :self | let octave = at(contents(self), 'octave'); if(isNumber(octave), { centsToRatio(octave) }, { if(isList(octave), { let __SPL478 = assertIsOfSize(octave, 2); let numerator = at(__SPL478, 1); let denominator = at(__SPL478, 2); Fraction(numerator, denominator) }, { error(self,'octave: invalid octave') }) }) }",
);
...
sl.addMethodToExistingType(
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                let __SPL479 = _assertIsOfSize_2(_each, 2);
                let _numerator = _at_2(__SPL479, 1);
                let _denominator = _at_2(__SPL479, 2);
                /* Statements */
                return _Fraction_2(_numerator, _denominator);
              }, []),
              sl.annotateFunction(function () {
  ...
  "{ :self | collect(at(contents(self), 'pitches'), { :each | if(isNumber(each), { each }, { if(isList(each), { let __SPL479 = assertIsOfSize(each, 2); let numerator = at(__SPL479, 1); let denominator = at(__SPL479, 2); Fraction(numerator, denominator) }, { error(self,'pitches: invalid pitch') }) }) }) }",
);
        ...
        sl.annotateFunction(function (_libraryItem) {
          ...
          return _collect_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL480 = _assertIsOfSize_2(_each, 3);
              let _zeroIndexedStartIndex = _at_2(__SPL480, 1);
              let _intervals = _at_2(__SPL480, 2);
              let _description = _at_2(__SPL480, 3);
              /* Statements */
              return _Scale_3(
        ...
        sl.annotateFunction(function (_libraryItem) {
          ...
          _keysAndValuesDo_2(
            ...
            sl.annotateFunction(function (_key, _value) {
              ...
              let __SPL481 = _assertIsOfSize_2(_value, 2);
              let _n = _at_2(__SPL481, 1);
              let _d = _at_2(__SPL481, 2);
              /* Statements */
              return _add_2(
                _answer,
