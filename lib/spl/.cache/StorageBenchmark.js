...
sl.addMethod(
  ...
  function (_self, _depth, _random) {
    ...
    /* Statements */
    _count_2(_self, _plus_2(_count_1(_self), 1));
    return _if_3(_equals_2(_depth, 1), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _Array_1(_plus_2(_modulo_2(_next_1(_random), 10), 1));
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      /* Statements */
      return _fillWith_2(_Array_1(4), function (_unusedIndex) {
        /* ArityCheck */
        if (arguments.length !== 1) {
        ...
        /* Statements */
        return _buildTreeDepthWith_3(_self, _minus_2(_depth, 1), _random);
      });
    });
  },
