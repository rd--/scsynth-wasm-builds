sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c :d :e :f | { :t :v | let __SplVar1 = assertIsOfSize(v, 3); let x = at(__SplVar1, 1); let y = at(__SplVar1, 2); let z = at(__SplVar1, 3); [-((*((-(z, b)), x)), (*(d, y))), +((*(d, x)), (*((-(z, b)), y))), +(-(-(+(c, (*(a, z))), (/(cube(z), 3))), (*((+(square(x), square(y))), (+(1, (*(e, z))))))), (*(*(f, z), cube(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c | { :t :v | let __SplVar2 = assertIsOfSize(v, 3); let x = at(__SplVar2, 1); let y = at(__SplVar2, 2); let z = at(__SplVar2, 3); [y, z, +(-(-(-(0, (*(a, x))), (*(b, y))), z), (*(c, cube(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c :d | { :t :v | let __SplVar3 = assertIsOfSize(v, 3); let x = at(__SplVar3, 1); let y = at(__SplVar3, 2); let z = at(__SplVar3, 3); [y, z, +(+(+((*(a, x)), (*(b, y))), (*(c, z))), (*(d, cube(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :c :d :e :k :f | { :t :v | let __SplVar4 = assertIsOfSize(v, 3); let x = at(__SplVar4, 1); let y = at(__SplVar4, 2); let z = at(__SplVar4, 3); [+((*(a, (-(y, x)))), (*(*(d, x), z))), -(+((*(k, x)), (*(f, y))), (*(x, z))), -(+((*(c, z)), (*(x, y))), (*(*(e, x), x)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :gamma :delta :omega | { :t :v | let __SplVar8 = assertIsOfSize(v, 2); let x = at(__SplVar8, 1); let y = at(__SplVar8, 2); [y, +(-(-(x, (^(x, 3))), (*(delta, y))), (*(gamma, cos((*(omega, t))))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :lambda | { :t :v | let __SplVar9 = assertIsOfSize(v, 4); let x = at(__SplVar9, 1); let y = at(__SplVar9, 2); let px = at(__SplVar9, 3); let py = at(__SplVar9, 4); [px, py, -(-(0, x), (*(*(*(lambda, 2), x), y))), -(-(0, y), (*(lambda, (-((*(x, x)), (*(y, y)))))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :rho :sigma :beta | { :t :v | let __SplVar10 = assertIsOfSize(v, 3); let x = at(__SplVar10, 1); let y = at(__SplVar10, 2); let z = at(__SplVar10, 3); [*(sigma, (-(y, x))), -(*(x, (-(rho, z))), y), -((*(x, y)), (*(beta, z)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :alpha :beta :gamma :delta | { :t :v | let __SplVar11 = assertIsOfSize(v, 2); let x = at(__SplVar11, 1); let y = at(__SplVar11, 2); [-((*(alpha, x)), (*(*(beta, x), y))), +(-(0, (*(gamma, y))), (*(*(delta, x), y)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :alpha | { :t :v | let __SplVar12 = assertIsOfSize(v, 3); let x = at(__SplVar12, 1); let y = at(__SplVar12, 2); let z = at(__SplVar12, 3); [+(-(0, y), (*(x, z))), x, *(alpha, (-((*(x, x)), 1)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :g :l :m :b :a :k | { :t :v | let __SplVar13 = assertIsOfSize(v, 2); let theta1 = at(__SplVar13, 1); let theta2 = at(__SplVar13, 2); let mll = *(*(m, l), l); let z1 = *(negate((/(g, l))), sin(theta1)); let z2 = -(z1, (*((/(b, mll)), theta2))); let z3 = +(z2, (*((/(a, mll)), cos(*(k, t))))); [theta2, z3] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c | { :t :v | let __SplVar14 = assertIsOfSize(v, 3); let x = at(__SplVar14, 1); let y = at(__SplVar14, 2); let z = at(__SplVar14, 3); [-(-(0, y), z), +(x, (*(a, y))), +(b, (*(z, (-(x, c)))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :k :a | { :t :v | let __SplVar15 = assertIsOfSize(v, 3); let x = at(__SplVar15, 1); let y = at(__SplVar15, 2); let z = at(__SplVar15, 3); [-(+(-(0, (*(k, x))), (*(a, y))), (*(y, z))), x, +(-(0, z), (*(y, y)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :mu | { :t :v | let __SplVar16 = assertIsOfSize(v, 2); let x = at(__SplVar16, 1); let y = at(__SplVar16, 2); [y, -((*(*(mu, (-(1, (^(x, 2))))), y)), x)] } }",
);
