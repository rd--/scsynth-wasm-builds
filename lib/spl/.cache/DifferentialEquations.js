sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c :d :e :f | { :t :v | let __SPL1 = assertIsOfSize(v, 3); let x = at(__SPL1, 1); let y = at(__SPL1, 2); let z = at(__SPL1, 3); [-((*((-(z, b)), x)), (*(d, y))), +((*(d, x)), (*((-(z, b)), y))), +(-(-(+(c, (*(a, z))), (/(cubed(z), 3))), (*((+(squared(x), squared(y))), (+(1, (*(e, z))))))), (*(*(f, z), cubed(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c | { :t :v | let __SPL2 = assertIsOfSize(v, 3); let x = at(__SPL2, 1); let y = at(__SPL2, 2); let z = at(__SPL2, 3); [y, z, +(-(-(-(0, (*(a, x))), (*(b, y))), z), (*(c, cubed(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c :d | { :t :v | let __SPL3 = assertIsOfSize(v, 3); let x = at(__SPL3, 1); let y = at(__SPL3, 2); let z = at(__SPL3, 3); [y, z, +(+(+((*(a, x)), (*(b, y))), (*(c, z))), (*(d, cubed(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :gamma :delta :omega | { :t :v | let __SPL5 = assertIsOfSize(v, 2); let x = at(__SPL5, 1); let y = at(__SPL5, 2); [y, +(-(-(x, (^(x, 3))), (*(delta, y))), (*(gamma, cos((*(omega, t))))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_lambda) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL6 = _assertIsOfSize_2(_v, 4);
      let _x = _at_2(__SPL6, 1);
      let _y = _at_2(__SPL6, 2);
      let _px = _at_2(__SPL6, 3);
      let _py = _at_2(__SPL6, 4);
      /* Statements */
      return [
        _px,
        _py,
  ...
  "{ :lambda | { :t :v | let __SPL6 = assertIsOfSize(v, 4); let x = at(__SPL6, 1); let y = at(__SPL6, 2); let px = at(__SPL6, 3); let py = at(__SPL6, 4); [px, py, -(-(0, x), (*(*(*(lambda, 2), x), y))), -(-(0, y), (*(lambda, (-((*(x, x)), (*(y, y)))))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :rho :sigma :beta | { :t :v | let __SPL7 = assertIsOfSize(v, 3); let x = at(__SPL7, 1); let y = at(__SPL7, 2); let z = at(__SPL7, 3); [*(sigma, (-(y, x))), -(*(x, (-(rho, z))), y), -((*(x, y)), (*(beta, z)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :alpha :beta :gamma :delta | { :t :v | let __SPL8 = assertIsOfSize(v, 2); let x = at(__SPL8, 1); let y = at(__SPL8, 2); [-((*(alpha, x)), (*(*(beta, x), y))), +(-(0, (*(gamma, y))), (*(*(delta, x), y)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_alpha) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL9 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL9, 1);
      let _y = _at_2(__SPL9, 2);
      let _z = _at_2(__SPL9, 3);
      /* Statements */
      return [
  ...
  "{ :alpha | { :t :v | let __SPL9 = assertIsOfSize(v, 3); let x = at(__SPL9, 1); let y = at(__SPL9, 2); let z = at(__SPL9, 3); [+(-(0, y), (*(x, z))), x, *(alpha, (-((*(x, x)), 1)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :a :b :c | { :t :v | let __SPL10 = assertIsOfSize(v, 3); let x = at(__SPL10, 1); let y = at(__SPL10, 2); let z = at(__SPL10, 3); [-(-(0, y), z), +(x, (*(a, y))), +(b, (*(z, (-(x, c)))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_k, _a) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL11 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL11, 1);
      let _y = _at_2(__SPL11, 2);
      let _z = _at_2(__SPL11, 3);
      /* Statements */
      return [
        _hyphenMinus_2(
          _plusSign_2(
  ...
  "{ :k :a | { :t :v | let __SPL11 = assertIsOfSize(v, 3); let x = at(__SPL11, 1); let y = at(__SPL11, 2); let z = at(__SPL11, 3); [-(+(-(0, (*(k, x))), (*(a, y))), (*(y, z))), x, +(-(0, z), (*(y, y)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_mu) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL12 = _assertIsOfSize_2(_v, 2);
  ...
  "{ :mu | { :t :v | let __SPL12 = assertIsOfSize(v, 2); let x = at(__SPL12, 1); let y = at(__SPL12, 2); [y, -((*(*(mu, (-(1, (^(x, 2))))), y)), x)] } }",
);
