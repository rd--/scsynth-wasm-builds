sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b, _c, _d, _e, _f) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL384 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL384, 1);
      let _y = _at_2(__SPL384, 2);
      let _z = _at_2(__SPL384, 3);
      /* Statements */
      return [
        _hyphenMinus_2(
  ...
  "{ :a :b :c :d :e :f | { :t :v | let __SPL384 = assertIsOfSize(v, 3); let x = at(__SPL384, 1); let y = at(__SPL384, 2); let z = at(__SPL384, 3); [-((*((-(z, b)), x)), (*(d, y))), +((*(d, x)), (*((-(z, b)), y))), +(-(-(+(c, (*(a, z))), (/(cube(z), 3))), (*((+(square(x), square(y))), (+(1, (*(e, z))))))), (*(*(f, z), cube(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b, _c) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL385 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL385, 1);
      let _y = _at_2(__SPL385, 2);
      let _z = _at_2(__SPL385, 3);
      /* Statements */
      return [
        _y,
        _z,
  ...
  "{ :a :b :c | { :t :v | let __SPL385 = assertIsOfSize(v, 3); let x = at(__SPL385, 1); let y = at(__SPL385, 2); let z = at(__SPL385, 3); [y, z, +(-(-(-(0, (*(a, x))), (*(b, y))), z), (*(c, cube(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b, _c, _d) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL386 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL386, 1);
      let _y = _at_2(__SPL386, 2);
      let _z = _at_2(__SPL386, 3);
      /* Statements */
      return [
        _y,
        _z,
  ...
  "{ :a :b :c :d | { :t :v | let __SPL386 = assertIsOfSize(v, 3); let x = at(__SPL386, 1); let y = at(__SPL386, 2); let z = at(__SPL386, 3); [y, z, +(+(+((*(a, x)), (*(b, y))), (*(c, z))), (*(d, cube(x))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _c, _d, _e, _k, _f) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL387 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL387, 1);
      let _y = _at_2(__SPL387, 2);
      let _z = _at_2(__SPL387, 3);
      /* Statements */
      return [
        _plusSign_2(
  ...
  "{ :a :c :d :e :k :f | { :t :v | let __SPL387 = assertIsOfSize(v, 3); let x = at(__SPL387, 1); let y = at(__SPL387, 2); let z = at(__SPL387, 3); [+((*(a, (-(y, x)))), (*(*(d, x), z))), -(+((*(k, x)), (*(f, y))), (*(x, z))), -(+((*(c, z)), (*(x, y))), (*(*(e, x), x)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_g, _l, _m) {
    ...
    let __SPL388 = _assertIsOfSize_2(_l, 2);
    let _l1 = _at_2(__SPL388, 1);
    let _l2 = _at_2(__SPL388, 2);
    let __SPL389 = _assertIsOfSize_2(_m, 2);
    let _m1 = _at_2(__SPL389, 1);
    let _m2 = _at_2(__SPL389, 2);
    /* Statements */
    return sl.annotateFunction(function (_t, _v) {
      /* ArityCheck */
      if (arguments.length !== 2) {
      ...
      let __SPL390 = _assertIsOfSize_2(_v, 4);
      let _theta1 = _at_2(__SPL390, 1);
      let _omega1 = _at_2(__SPL390, 2);
      let _theta2 = _at_2(__SPL390, 3);
      let _omega2 = _at_2(__SPL390, 4);
      let _a = _asterisk_2(
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_gamma, _delta, _omega) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL391 = _assertIsOfSize_2(_v, 2);
      let _x = _at_2(__SPL391, 1);
      let _y = _at_2(__SPL391, 2);
      /* Statements */
      return [
        _y,
        _plusSign_2(
  ...
  "{ :gamma :delta :omega | { :t :v | let __SPL391 = assertIsOfSize(v, 2); let x = at(__SPL391, 1); let y = at(__SPL391, 2); [y, +(-(-(x, (^(x, 3))), (*(delta, y))), (*(gamma, cos((*(omega, t))))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_lambda) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL392 = _assertIsOfSize_2(_v, 4);
      let _x = _at_2(__SPL392, 1);
      let _y = _at_2(__SPL392, 2);
      let _px = _at_2(__SPL392, 3);
      let _py = _at_2(__SPL392, 4);
      /* Statements */
      return [
        _px,
        _py,
  ...
  "{ :lambda | { :t :v | let __SPL392 = assertIsOfSize(v, 4); let x = at(__SPL392, 1); let y = at(__SPL392, 2); let px = at(__SPL392, 3); let py = at(__SPL392, 4); [px, py, -(-(0, x), (*(*(*(lambda, 2), x), y))), -(-(0, y), (*(lambda, (-((*(x, x)), (*(y, y)))))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_rho, _sigma, _beta) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL393 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL393, 1);
      let _y = _at_2(__SPL393, 2);
      let _z = _at_2(__SPL393, 3);
      /* Statements */
      return [
  ...
  "{ :rho :sigma :beta | { :t :v | let __SPL393 = assertIsOfSize(v, 3); let x = at(__SPL393, 1); let y = at(__SPL393, 2); let z = at(__SPL393, 3); [*(sigma, (-(y, x))), -(*(x, (-(rho, z))), y), -((*(x, y)), (*(beta, z)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_alpha, _beta, _gamma, _delta) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL394 = _assertIsOfSize_2(_v, 2);
      let _x = _at_2(__SPL394, 1);
      let _y = _at_2(__SPL394, 2);
      /* Statements */
      return [
        _hyphenMinus_2(
  ...
  "{ :alpha :beta :gamma :delta | { :t :v | let __SPL394 = assertIsOfSize(v, 2); let x = at(__SPL394, 1); let y = at(__SPL394, 2); [-((*(alpha, x)), (*(*(beta, x), y))), +(-(0, (*(gamma, y))), (*(*(delta, x), y)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_alpha) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL395 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL395, 1);
      let _y = _at_2(__SPL395, 2);
      let _z = _at_2(__SPL395, 3);
      /* Statements */
      return [
  ...
  "{ :alpha | { :t :v | let __SPL395 = assertIsOfSize(v, 3); let x = at(__SPL395, 1); let y = at(__SPL395, 2); let z = at(__SPL395, 3); [+(-(0, y), (*(x, z))), x, *(alpha, (-((*(x, x)), 1)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_a, _b, _c) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL396 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL396, 1);
      let _y = _at_2(__SPL396, 2);
      let _z = _at_2(__SPL396, 3);
      /* Statements */
      return [
  ...
  "{ :a :b :c | { :t :v | let __SPL396 = assertIsOfSize(v, 3); let x = at(__SPL396, 1); let y = at(__SPL396, 2); let z = at(__SPL396, 3); [-(-(0, y), z), +(x, (*(a, y))), +(b, (*(z, (-(x, c)))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_k, _a) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL397 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL397, 1);
      let _y = _at_2(__SPL397, 2);
      let _z = _at_2(__SPL397, 3);
      /* Statements */
      return [
        _hyphenMinus_2(
          _plusSign_2(
  ...
  "{ :k :a | { :t :v | let __SPL397 = assertIsOfSize(v, 3); let x = at(__SPL397, 1); let y = at(__SPL397, 2); let z = at(__SPL397, 3); [-(+(-(0, (*(k, x))), (*(a, y))), (*(y, z))), x, +(-(0, z), (*(y, y)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_mu) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL398 = _assertIsOfSize_2(_v, 2);
      let _x = _at_2(__SPL398, 1);
      let _y = _at_2(__SPL398, 2);
      /* Statements */
      return [
        _y,
        _hyphenMinus_2(
  ...
  "{ :mu | { :t :v | let __SPL398 = assertIsOfSize(v, 2); let x = at(__SPL398, 1); let y = at(__SPL398, 2); [y, -((*(*(mu, (-(1, (^(x, 2))))), y)), x)] } }",
);
