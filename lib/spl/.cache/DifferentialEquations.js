sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_rho, _sigma, _beta) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL231 = _assertIsOfSize_2(_v, 3);
      let _x = _at_2(__SPL231, 1);
      let _y = _at_2(__SPL231, 2);
      let _z = _at_2(__SPL231, 3);
      /* Statements */
      return [
  ...
  "{ :rho :sigma :beta | { :t :v | let __SPL231 = assertIsOfSize(v, 3); let x = at(__SPL231, 1); let y = at(__SPL231, 2); let z = at(__SPL231, 3); [*(sigma, (-(y, x))), -(*(x, (-(rho, z))), y), -((*(x, y)), (*(beta, z)))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_gamma, _delta, _omega) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL232 = _assertIsOfSize_2(_v, 2);
      let _x = _at_2(__SPL232, 1);
      let _y = _at_2(__SPL232, 2);
      /* Statements */
      return [
        _y,
        _plusSign_2(
  ...
  "{ :gamma :delta :omega | { :t :v | let __SPL232 = assertIsOfSize(v, 2); let x = at(__SPL232, 1); let y = at(__SPL232, 2); [y, +(-(-(x, (^(x, 3))), (*(delta, y))), (*(gamma, cos(*(omega, t)))))] } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_mu) {
    ...
    return sl.annotateFunction(function (_t, _v) {
      ...
      let __SPL233 = _assertIsOfSize_2(_v, 2);
      let _x = _at_2(__SPL233, 1);
      let _y = _at_2(__SPL233, 2);
      /* Statements */
      return [
        _y,
        _hyphenMinus_2(
  ...
  "{ :mu | { :t :v | let __SPL233 = assertIsOfSize(v, 2); let x = at(__SPL233, 1); let y = at(__SPL233, 2); [y, -((*(*(mu, (-(1, (^(x, 2))))), y)), x)] } }",
);
