          ...
          return sl.annotateFunction(function (_p) {
            ...
            return _collect_2(
              ...
              sl.annotateFunction(function (_each) {
                ...
                let __SPL33 = _assertIsOfSize_2(_each, 2);
                let _x = _at_2(__SPL33, 1);
                let _y = _at_2(__SPL33, 2);
                /* Statements */
...
sl.addMethodToExistingType(
        ...
        let _t_1 = sl.annotateFunction(function (_list) {
          ...
          return _collect_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL34 = _assertIsOfSize_2(_each, 3);
              let _x = _at_2(__SPL34, 1);
              let _y = _at_2(__SPL34, 2);
              let _z = _at_2(__SPL34, 3);
              /* Statements */
  ...
  "{ :self | if((=(format(self), 'line')), { let p:/1 = asUnaryBlock(AxonometricProjection(pi(Fraction(1L, 6L)), 0, 0, 0.5, 1, 1)); let r = [[-1, -1, 0], [+1, -1, 0], [+1, +1, 0], [-1, +1, 0]]; let t = { :list | collect(list, { :each | let __SPL34 = assertIsOfSize(each, 3); let x = at(__SPL34, 1); let y = at(__SPL34, 2); let z = at(__SPL34, 3); p([negate(x), z, negate(y)]) }) }; let l = collect(pages(self), { :each | Line(t(each)) }); LineDrawing([l]) }, { error(self,'n×3 matrix: format must be line') }) }",
);
...
sl.addMethodToExistingType(
          ...
          sl.annotateFunction(function (_each) {
            ...
            return _withIndexCollect_2(
              ...
              sl.annotateFunction(function (_item, _x) {
                ...
                let __SPL35 = _assertIsOfSize_2(_item, 1);
                let _y = _at_2(__SPL35, 1);
                /* Statements */
                return [_x, _y];
              }, ["item", "x"]),
            );
  ...
  "{ :self | asLineDrawing(Plot(collect(pages(self), { :each | withIndexCollect(each, { :item :x | let __SPL35 = assertIsOfSize(item, 1); let y = at(__SPL35, 1); [x, y] }) }), format(self))) }",
);
...
sl.addMethodToExistingType(
    ...
    let _counts = _nub_1(
      _collect_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          let __SPL36 = _assertIsOfSize_2(_shape_1(_each), 2);
          let _rowCount = _at_2(__SPL36, 1);
          let _columnCount = _at_2(__SPL36, 2);
          /* Statements */
          return _columnCount;
        }, ["each"]),
      ),
  ...
  "{ :self | let counts = nub(collect(pages(self), { :each | let __SPL36 = assertIsOfSize(shape(each), 2); let rowCount = at(__SPL36, 1); let columnCount = at(__SPL36, 2); columnCount })); if((=(size(counts), 1)), { anyOne(counts) }, { error(self,'columnCount: pages have differing column counts') }) }",
);
...
sl.addMethodToExistingType(
      ...
      [
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL37 = _assertIsOfSize_2(_pages_1(_self), 1);
            let _contents = _at_2(__SPL37, 1);
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL38 = _assertIsOfSize_2(_pages_1(_self), 1);
            let _graph = _at_2(__SPL38, 1);
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL39 = _assertIsOfSize_2(_pages_1(_self), 1);
            let _contents = _at_2(__SPL39, 1);
            /* Statements */
  ...
  "{ :self | caseOf(format(self), [->('array', { let __SPL37 = assertIsOfSize(pages(self), 1); let contents = at(__SPL37, 1); asColourSvg(contents) }), ->('graph', { let __SPL38 = assertIsOfSize(pages(self), 1); let graph = at(__SPL38, 1); dotDrawing(graph,options(self)) }), ->('matrix', { let __SPL39 = assertIsOfSize(pages(self), 1); let contents = at(__SPL39, 1); asGreyscaleSvg(contents) })], { drawing(asLineDrawing(self)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k, _aBlock_1) {
    ...
    let _min = _at_2(__SPL40, 1);
    let _max = _at_2(__SPL40, 2);
  ...
  "{ :self :k :aBlock:/1 | let __SPL40 = assertIsOfSize(self, 2); let min = at(__SPL40, 1); let max = at(__SPL40, 2); let colourFunction:/1 = asBlock(asColourGradient(at(colourGradients(system), 'Kovesi', 'Cyclic-Mygbm-30-95-C78S25'))); let r = subdivide((--(real(min), real(max))),k); let i = subdivide((--(imaginary(min), imaginary(max))),k); Image(reverse(table({ :x :y | let z = Complex(y, x); colourFunction(+(/(arg(aBlock(z)), pi(2)), 0.5)) },i, r))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_d) {
    ...
    let __SPL41 = _assertIsOfSize_2(_minMax_1(_d), 2);
    let _p = _at_2(__SPL41, 1);
    let _q = _at_2(__SPL41, 2);
    let __SPL42 = _assertIsOfSize_2(_p, 2);
    let _x1 = _at_2(__SPL42, 1);
    let _y1 = _at_2(__SPL42, 2);
    let __SPL43 = _assertIsOfSize_2(_q, 2);
    let _x2 = _at_2(__SPL43, 1);
    let _y2 = _at_2(__SPL43, 2);
    let _k = 11;
  ...
  "{ :d | let __SPL41 = assertIsOfSize(minMax(d), 2); let p = at(__SPL41, 1); let q = at(__SPL41, 2); let __SPL42 = assertIsOfSize(p, 2); let x1 = at(__SPL42, 1); let y1 = at(__SPL42, 2); let __SPL43 = assertIsOfSize(q, 2); let x2 = at(__SPL43, 1); let y2 = at(__SPL43, 2); let k = 11; let x3 = /((-(x2, x1)), k); let y3 = /((-(y2, y1)), k); let b1 = [x1, +(x2, x3), x3]; let b2 = [y1, +(y2, y3), y3]; densityHistogramPlot(d, b1, b2) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL44 = _assertIsOfSize_2(_self, 2);
    let _b = _at_2(__SPL44, 1);
    let _y = _at_2(__SPL44, 2);
  ...
  "{ :self | let __SPL44 = assertIsOfSize(self, 2); let b = at(__SPL44, 1); let y = at(__SPL44, 2); let x = adjacentPairsCollect(b, { :i :j | +(i, (/((-(j, i)), 2))) }); discretePlot(transpose([x, y])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL45 = _assertIsOfSize_2(_shape_1(_self), 2);
      ...
      sl.annotateFunction(function () {
        ...
        let _r = _collect_2(
          ...
          sl.annotateFunction(function (_each) {
            ...
            let __SPL46 = _assertIsOfSize_2(_each, 3);
            let _t = _at_2(__SPL46, 1);
            let _d = _at_2(__SPL46, 2);
            let _p = _at_2(__SPL46, 3);
            /* Statements */
  ...
  "{ :self | let __SPL45 = assertIsOfSize(shape(self), 2); let m = at(__SPL45, 1); let n = at(__SPL45, 2); if((>=(n, 3)), { let tMax = injectInto(self, 0, { :z :each | max(z,+(at(each, 1), at(each, 2))) }); let tScale = /(100, max(tMax,20)); let r = collect(self, { :each | let __SPL46 = assertIsOfSize(each, 3); let t = at(__SPL46, 1); let d = at(__SPL46, 2); let p = at(__SPL46, 3); Rectangle([*(t, tScale), p], [*((+(t, d)), tScale), (+(p, 1))]) }); LineDrawing([PointCloud([[0, 32], [0, 60], [0, 84], [*(tMax, tScale), 60]]), r]) }, { error(self,'pianoRollPlot: not at least three-column matrix') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let __SPL47 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL47, 1);
    let _n = _at_2(__SPL47, 2);
    let __SPL48 = _assertIsOfSize_2(_deepMinMax_1(_self), 2);
    let _z0 = _at_2(__SPL48, 1);
    let _z1 = _at_2(__SPL48, 2);
  ...
  "{ :self :options | let __SPL47 = assertIsOfSize(shape(self), 2); let m = at(__SPL47, 1); let n = at(__SPL47, 2); let __SPL48 = assertIsOfSize(deepMinMax(self), 2); let z0 = at(__SPL48, 1); let z1 = at(__SPL48, 2); let colourFunction = { :z | hslToRgb([z, 0.75, 0.75]) }; let data = table({ :i :j | colourFunction(rescale(at(at(self, i), j),[z0, z1], [0, 1])) },Span(1, m, 1), Span(1, n, 1)); ifFalse(at(options, 'dataReversed'), { reverse(data) }); Image(data) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_y, _i) {
    ...
    let __SPL49 = _assertIsOfSize_2(_minMax_1(_i), 2);
    let _a = _at_2(__SPL49, 1);
    let _b = _at_2(__SPL49, 2);
  ...
  "{ :y :i | let __SPL49 = assertIsOfSize(minMax(i), 2); let a = at(__SPL49, 1); let b = at(__SPL49, 2); let c = -(b, a); if(isVector(y), { linePlot(y) }, { let n = size(y); let z = 1.15; linePlot(withIndexCollect(y, { :each :i | +(each, (*(*((-(n, i)), c), z))) })) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let _m = _at_2(__SPL50, 1);
            let _n = _at_2(__SPL50, 2);
            /* Statements */
            return _if_3(
              _equalsSign_2(_n, 2),
              sl.annotateFunction(function () {
                ...
                _do_2(
                  ...
                  sl.annotateFunction(function (_each) {
                    ...
                    let __SPL51 = _assertIsOfSize_2(_each, 2);
                    let _x2 = _at_2(__SPL51, 1);
                    let _y = _at_2(__SPL51, 2);
                    /* Statements */
  ...
  "{ :self | if(isVector(self), { let answer = []; withIndexDo(self, { :each :index | add(answer,[index, each]); add(answer,[+(index, 1), each]) }); answer }, { if(isMatrix(self), { let __SPL50 = assertIsOfSize(shape(self), 2); let m = at(__SPL50, 1); let n = at(__SPL50, 2); if((=(n, 2)), { let x1 = at(at(self, 1), 1); let answer = []; do(self, { :each | let __SPL51 = assertIsOfSize(each, 2); let x2 = at(__SPL51, 1); let y = at(__SPL51, 2); add(answer,[x1, y]); add(answer,[x2, y]); x1 := x2 }); answer }, { collect(self,stepPlotLineData:/1) }) }, { collect(self,stepPlotLineData:/1) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k, _aBlock_2) {
    ...
    let __SPL52 = _assertIsOfSize_2(_self, 2);
    let _u = _at_2(__SPL52, 1);
    let _v = _at_2(__SPL52, 2);
    let __SPL53 = _assertIsOfSize_2(_k, 2);
    let _m = _at_2(__SPL53, 1);
    let _n = _at_2(__SPL53, 2);
    let _i = _subdivide_2(
  ...
  "{ :self :k :aBlock:/2 | let __SPL52 = assertIsOfSize(self, 2); let u = at(__SPL52, 1); let v = at(__SPL52, 2); let __SPL53 = assertIsOfSize(k, 2); let m = at(__SPL53, 1); let n = at(__SPL53, 2); let i = subdivide((--(min(u), max(u))),m); let j = subdivide((--(min(v), max(v))),n); surfacePlot(table(aBlock:/2, i, j)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL54 = _assertIsOfSize_2(_shape_1(_self), 2);
        let _m = _at_2(__SPL54, 1);
        let _n = _at_2(__SPL54, 2);
        /* Statements */
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL55 = _assertIsOfSize_2(_shape_1(_self), 3);
        let _m = _at_2(__SPL55, 1);
        let _n = _at_2(__SPL55, 2);
        let __genSym66 = _at_2(__SPL55, 3);
        let _p = _collect_2(
          _Span_3(1, _m, 1),
          sl.annotateFunction(function (_i) {
            /* ArityCheck */
  ...
  "{ :self | if(isMatrix(self), { let __SPL54 = assertIsOfSize(shape(self), 2); let m = at(__SPL54, 1); let n = at(__SPL54, 2); surfacePlot(table({ :i :j | [i, j, at(self, i, j)] },Span(1, m, 1), Span(1, n, 1))) }, { let __SPL55 = assertIsOfSize(shape(self), 3); let m = at(__SPL55, 1); let n = at(__SPL55, 2); let _ = at(__SPL55, 3); let p = collect(Span(1, m, 1), { :i | collect(Span(1, n, 1), { :j | at(at(self, i), j) }) }); let q = collect(Span(1, n, 1), { :j | collect(Span(1, m, 1), { :i | at(at(self, i), j) }) }); linePlot((++(p, q))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                let __SPL56 = _assertIsOfSize_2(_shape_1(_self), 2);
                let _m = _at_2(__SPL56, 1);
                let _n = _at_2(__SPL56, 2);
                /* Statements */
                return _if_3(
  ...
  "{ :self :format | self := asFloat(self); if(isVector(self), { typedVectorPlot([self],format) }, { if(isColumnVector(self), { typedVectorPlot([catenate(self)],format) }, { if(isSmallFloatMatrix(self), { let __SPL56 = assertIsOfSize(shape(self), 2); let m = at(__SPL56, 1); let n = at(__SPL56, 2); if((<=(n, 3)), { Plot([self],format) }, { typedVectorPlot(self,format) }) }, { Plot(self,format) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _operand) {
    ...
    let _k = 100;
    let __SPL57 = _assertIsOfSize_2(_log_1(_minMax_1(_self)), 2);
    let _a = _at_2(__SPL57, 1);
    let _b = _at_2(__SPL57, 2);
  ...
  "{ :self :operand | let k = 100; let __SPL57 = assertIsOfSize(log(minMax(self)), 2); let a = at(__SPL57, 1); let b = at(__SPL57, 2); let h = /((-(b, a)), (-(k, 1))); let x = collect(upOrDownTo(0, -(k, 1)), { :i | exp((+(a, (*(i, h))))) }); linePlot(collect(nest(operand), { :aBlock:/1 | collect(x, { :each | aBlock(each) }) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_f_2, _v, _n) {
    ...
    let __SPL58 = _assertIsOfSize_2(_v, 2);
    let _a = _at_2(__SPL58, 1);
    let _b = _at_2(__SPL58, 2);
    let __SPL59 = _assertIsOfSize_2(_n, 2);
    let _i = _at_2(__SPL59, 1);
    let _j = _at_2(__SPL59, 2);
  ...
  "{ :f:/2 :v :n | let __SPL58 = assertIsOfSize(v, 2); let a = at(__SPL58, 1); let b = at(__SPL58, 2); let __SPL59 = assertIsOfSize(n, 2); let i = at(__SPL59, 1); let j = at(__SPL59, 2); let aR = resample(a,i); let bR = resample(b,j); linePlot(catenate([collect(a, { :p | collect(bR, { :q | f(p, q) }) }), collect(b, { :q | collect(aR, { :p | f(p, q) }) })])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_f_1, _v, _m, _n) {
    ...
    let __SPL60 = _assertIsOfSize_2(_v, 2);
    let _p = _at_2(__SPL60, 1);
    let _q = _at_2(__SPL60, 2);
    let __SPL61 = _assertIsOfSize_2(_m, 2);
    let _i = _at_2(__SPL61, 1);
    let _j = _at_2(__SPL61, 2);
    /* Statements */
  ...
  "{ :f:/1 :v :m :n | let __SPL60 = assertIsOfSize(v, 2); let p = at(__SPL60, 1); let q = at(__SPL60, 2); let __SPL61 = assertIsOfSize(m, 2); let i = at(__SPL61, 1); let j = at(__SPL61, 2); carpetPlot({ :a :b | realImaginary(f(Complex(a, b))) },[asList(discretize((--(real(p), real(q))),i)), asList(discretize((--(imaginary(p), imaginary(q))),j))], n) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _xInterval, _yInterval) {
    ...
    let __SPL62 = _assertIsOfSize_2(_minMax_1(_xInterval), 2);
    let _x1 = _at_2(__SPL62, 1);
    let _x2 = _at_2(__SPL62, 2);
    let __SPL63 = _assertIsOfSize_2(_minMax_1(_yInterval), 2);
    let _y1 = _at_2(__SPL63, 1);
    let _y2 = _at_2(__SPL63, 2);
    let _n = 16;
  ...
  "{ :self :xInterval :yInterval | let __SPL62 = assertIsOfSize(minMax(xInterval), 2); let x1 = at(__SPL62, 1); let x2 = at(__SPL62, 2); let __SPL63 = assertIsOfSize(minMax(yInterval), 2); let y1 = at(__SPL63, 1); let y2 = at(__SPL63, 2); let n = 16; let xStep = /((-(x2, x1)), n); let yStep = /((-(y2, y1)), n); let minStep = min(xStep,yStep); let coordinateList = flatten(table({ :i :j | let x = +((+(x1, (*(i, xStep)))), (*((%(j, 2)), (/(xStep, 2))))); let y = +(y1, (*(j, yStep))); [x, y] },asList(upOrDownTo(0, -(n, 1))), asList(upOrDownTo(0, -(n, 1)))),1); vectorPlot(coordinateList,self, *(minStep, 0.35)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_2, _scalar) {
    ...
    return _LineDrawing_1(_collect_2(
      ...
      sl.annotateFunction(function (_xy) {
        ...
        let __SPL64 = _assertIsOfSize_2(_xy, 2);
        let _x = _at_2(__SPL64, 1);
        let _y = _at_2(__SPL64, 2);
  ...
  "{ :self :aBlock:/2 :scalar | LineDrawing(collect(self, { :xy | let __SPL64 = assertIsOfSize(xy, 2); let x = at(__SPL64, 1); let y = at(__SPL64, 2); let uv = *(normalize(aBlock(x, y)), scalar); [Point(+(xy, uv)), Line([-(xy, uv), +(xy, uv)])] })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _timesList) {
    ...
    let __SPL65 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _n = _at_2(__SPL65, 1);
    let _m = _at_2(__SPL65, 2);
    /* Statements */
    return _if_3(
      _equalsSign_2(_m, 2),
      sl.annotateFunction(function () {
