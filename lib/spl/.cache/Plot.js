...
sl.addMethodToExistingType(
  ...
  "{ :self | caseOf(format(self), [->('array', { let __SPL5 = assertIsOfSize(pages(self), 1); let contents = at(__SPL5, 1); draw(asColourSvg(contents)) }), ->('graph', { let __SPL6 = assertIsOfSize(pages(self), 1); let graph = at(__SPL6, 1); draw(dotDrawing(graph,options(self))) }), ->('matrix', { let __SPL7 = assertIsOfSize(pages(self), 1); let contents = at(__SPL7, 1); draw(asGreyscaleSvg(contents)) })], { draw(asLineDrawing(self)) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :fileName | caseOf(format(self), [->('array', { let __SPL8 = assertIsOfSize(pages(self), 1); let contents = at(__SPL8, 1); writeSvg(asColourSvg(contents),fileName) }), ->('graph', { let __SPL9 = assertIsOfSize(pages(self), 1); let graph = at(__SPL9, 1); writeSvg(dotDrawing(graph,options(self)),fileName) }), ->('matrix', { let __SPL10 = assertIsOfSize(pages(self), 1); let contents = at(__SPL10, 1); writeSvg(asGreyscaleSvg(contents),fileName) })], { writeSvg(asLineDrawing(self),fileName) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_1) {
    ...
    let __SPL11 = _assertIsOfSize_2(_self, 2);
    let _min = _at_2(__SPL11, 1);
    let _max = _at_2(__SPL11, 2);
  ...
  "{ :self :aBlock:/1 | let __SPL11 = assertIsOfSize(self, 2); let min = at(__SPL11, 1); let max = at(__SPL11, 2); let colourFunction:/1 = asBlock(asColourGradient(at(colourGradients(system), 'Kovesi', 'Cyclic-Mygbm-30-95-C78S25'))); let k = 100; let r = subdivide((--(real(min), real(max))),k); let i = subdivide((--(imaginary(min), imaginary(max))),k); Image(reversed(table({ :x :y | let z = Complex(y, x); colourFunction(+(/(arg(aBlock(z)), pi(2)), 0.5)) },i, r))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_d) {
    ...
    let __SPL12 = _assertIsOfSize_2(_minMax_1(_d), 2);
    let _p = _at_2(__SPL12, 1);
    let _q = _at_2(__SPL12, 2);
    let __SPL13 = _assertIsOfSize_2(_p, 2);
    let _x1 = _at_2(__SPL13, 1);
    let _y1 = _at_2(__SPL13, 2);
    let __SPL14 = _assertIsOfSize_2(_q, 2);
    let _x2 = _at_2(__SPL14, 1);
    let _y2 = _at_2(__SPL14, 2);
    let _k = 11;
  ...
  "{ :d | let __SPL12 = assertIsOfSize(minMax(d), 2); let p = at(__SPL12, 1); let q = at(__SPL12, 2); let __SPL13 = assertIsOfSize(p, 2); let x1 = at(__SPL13, 1); let y1 = at(__SPL13, 2); let __SPL14 = assertIsOfSize(q, 2); let x2 = at(__SPL14, 1); let y2 = at(__SPL14, 2); let k = 11; let x3 = /((-(x2, x1)), k); let y3 = /((-(y2, y1)), k); let b1 = [x1, +(x2, x3), x3]; let b2 = [y1, +(y2, y3), y3]; densityHistogramPlot(d, b1, b2) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_x, _n) {
    ...
    let _response = _abs_1(_fftShift_1(_solidus_2(_a, _max_1(_abs_1(_a)))));
    let _scaledResponse = _asterisk_2(
      20,
      _log_2(_abs_1(_max_2(_response, 1E-6)), 10),
    );
    /* Statements */
    return _linePlot_1(_scaledResponse);
  }, ["x", "n"]),
  "{ :x :n | let a = /(fft(x,n), (/(size(x), 2))); let response = abs(fftShift((/(a, max(abs(a)))))); let scaledResponse = *(20, log(abs((max(response,1E-6))),10)); linePlot(scaledResponse) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let __SPL19 = _assertIsOfSize_2(_deepMinMax_1(_self), 2);
    let _z0 = _at_2(__SPL19, 1);
    let _z1 = _at_2(__SPL19, 2);
  ...
  "{ :self :options | let __SPL18 = assertIsOfSize(shape(self), 2); let m = at(__SPL18, 1); let n = at(__SPL18, 2); let __SPL19 = assertIsOfSize(deepMinMax(self), 2); let z0 = at(__SPL19, 1); let z1 = at(__SPL19, 2); let colourFunction = { :z | hslToRgb([z, 0.75, 0.75]) }; let data = table({ :i :j | colourFunction(rescale(at(at(self, i), j),z0, z1, 0, 1)) },Span(1, m, 1), Span(1, n, 1)); ifFalse(at(options, 'dataReversed'), { reverse(data) }); Image(data) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __genSym28 = _at_2(__SPL23, 3);
        let _p = _collect_2(
          _Span_3(1, _m, 1),
          sl.annotateFunction(function (_i) {
            /* ArityCheck */
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _xInterval, _yInterval) {
    ...
    let __SPL25 = _assertIsOfSize_2(_minMax_1(_xInterval), 2);
    let _x1 = _at_2(__SPL25, 1);
    let _x2 = _at_2(__SPL25, 2);
    let __SPL26 = _assertIsOfSize_2(_minMax_1(_yInterval), 2);
    let _y1 = _at_2(__SPL26, 1);
    let _y2 = _at_2(__SPL26, 2);
    let _n = 16;
  ...
  "{ :self :xInterval :yInterval | let __SPL25 = assertIsOfSize(minMax(xInterval), 2); let x1 = at(__SPL25, 1); let x2 = at(__SPL25, 2); let __SPL26 = assertIsOfSize(minMax(yInterval), 2); let y1 = at(__SPL26, 1); let y2 = at(__SPL26, 2); let n = 16; let xStep = /((-(x2, x1)), n); let yStep = /((-(y2, y1)), n); let minStep = min(xStep,yStep); let coordinateList = flatten(table({ :i :j | let x = +((+(x1, (*(i, xStep)))), (*((%(j, 2)), (/(xStep, 2))))); let y = +(y1, (*(j, yStep))); [x, y] },asList(upOrDownTo(0, -(n, 1))), asList(upOrDownTo(0, -(n, 1)))),1); vectorPlot(coordinateList,self, *(minStep, 0.35)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_2, _scalar) {
    ...
    return _LineDrawing_1(_collect_2(
      ...
      sl.annotateFunction(function (_xy) {
        ...
        let __SPL27 = _assertIsOfSize_2(_xy, 2);
  ...
  "{ :self :aBlock:/2 :scalar | LineDrawing(collect(self, { :xy | let __SPL27 = assertIsOfSize(xy, 2); let x = at(__SPL27, 1); let y = at(__SPL27, 2); let uv = *(normalize(aBlock(x, y)), scalar); [Point(+(xy, uv)), Line([-(xy, uv), +(xy, uv)])] })) }",
);
