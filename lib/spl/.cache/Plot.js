...
sl.addMethodToExistingType(
              ...
              return sl.annotateFunction(function (_p) {
                ...
                return _collect_2(
                  ...
                  sl.annotateFunction(function (_each) {
                    ...
                    let __SPL267 = _assertIsOfSize_2(_each, 2);
                    let _x = _at_2(__SPL267, 1);
                    let _y = _at_2(__SPL267, 2);
                    /* Statements */
                ...
                let _t_1 = sl.annotateFunction(function (_list) {
                  ...
                  return _collect_2(
                    ...
                    sl.annotateFunction(function (_each) {
                      ...
                      let __SPL268 = _assertIsOfSize_2(_each, 3);
                      let _x = _at_2(__SPL268, 1);
                      let _y = _at_2(__SPL268, 2);
                      let _z = _at_2(__SPL268, 3);
                      /* Statements */
                      ...
                      sl.annotateFunction(function (_each) {
                        ...
                        return _withIndexCollect_2(
                          ...
                          sl.annotateFunction(function (_item, _x) {
                            ...
                            let __SPL269 = _assertIsOfSize_2(_item, 1);
                            let _y = _at_2(__SPL269, 1);
                            /* Statements */
                            return [_x, _y];
                          }, ["item", "x"]),
                        );
  ...
  "{ :self | let columnCount = columnCount(self); if((=(columnCount, 2)), { let r = asRectangle(coordinateBoundingBox(catenate(pages(self)))); let w = width(r); let h = height(r); let dataRatio = (/(w, h)); let aspectRatio = if((<(abs((-(dataRatio, 1))), 0.075)), { dataRatio }, { goldenRatio(1) }); let xScalar = /(aspectRatio, (/(w, h))); let scaledPages = collect(pages(self), { :each | *(each, [[xScalar, 1]]) }); let items = []; let gen:/1 = caseOf(format(self),[->('line', { { :p | [Line(p)] } }), ->('scatter', { { :p | [PointCloud(p)] } }), ->('discrete', { { :p | collect(p, { :each | let __SPL267 = assertIsOfSize(each, 2); let x = at(__SPL267, 1); let y = at(__SPL267, 2); Line([[x, 0], [x, y]]) }) } })]); let includesXAxis = &(<=(lower(r), 0), { >=(upper(r), 0) }); let includesYAxis = &(<=(left(r), 0), { >=(right(r), 0) }); ifTrue(includesXAxis, { add(items,Point([*(left(r), xScalar), 0])) }); ifTrue(includesYAxis, { add(items,Point([0, upper(r)])) }); do(scaledPages, { :each | addAll(items,gen(each)) }); LineDrawing(items) }, { if((=(columnCount, 3)), { if((=(format(self), 'line')), { let p:/1 = asUnaryBlock(AxonometricProjection(pi(Fraction(1L, 6L)), 0, 0, 0.5, 1, 1)); let r = [[-1, -1, 0], [+1, -1, 0], [+1, +1, 0], [-1, +1, 0]]; let t = { :list | collect(list, { :each | let __SPL268 = assertIsOfSize(each, 3); let x = at(__SPL268, 1); let y = at(__SPL268, 2); let z = at(__SPL268, 3); p([negated(x), z, negated(y)]) }) }; let l = collect(pages(self), { :each | Line(t(each)) }); LineDrawing([l]) }, { error(self,'n×3 matrix: format must be line') }) }, { if((=(columnCount, 1)), { asLineDrawing(Plot(collect(pages(self), { :each | withIndexCollect(each, { :item :x | let __SPL269 = assertIsOfSize(item, 1); let y = at(__SPL269, 1); [x, y] }) }), format(self))) }, { error(self,++('Multiple plots not implemented: ', columnCount)) }) }) }) }",
);
...
sl.addMethodToExistingType(
    ...
    let _counts = _nub_1(
      _collect_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          let __SPL270 = _assertIsOfSize_2(_shape_1(_each), 2);
          let _rowCount = _at_2(__SPL270, 1);
          let _columnCount = _at_2(__SPL270, 2);
          /* Statements */
          return _columnCount;
        }, ["each"]),
      ),
  ...
  "{ :self | let counts = nub(collect(pages(self), { :each | let __SPL270 = assertIsOfSize(shape(each), 2); let rowCount = at(__SPL270, 1); let columnCount = at(__SPL270, 2); columnCount })); if((=(size(counts), 1)), { anyOne(counts) }, { error(self,'columnCount: pages have differing column counts') }) }",
);
...
sl.addMethodToExistingType(
      ...
      [
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL271 = _assertIsOfSize_2(_pages_1(_self), 1);
            let _contents = _at_2(__SPL271, 1);
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL272 = _assertIsOfSize_2(_pages_1(_self), 1);
            let _graph = _at_2(__SPL272, 1);
            /* Statements */
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL273 = _assertIsOfSize_2(_pages_1(_self), 1);
            let _contents = _at_2(__SPL273, 1);
            /* Statements */
  ...
  "{ :self | caseOf(format(self), [->('array', { let __SPL271 = assertIsOfSize(pages(self), 1); let contents = at(__SPL271, 1); asColourSvg(contents) }), ->('graph', { let __SPL272 = assertIsOfSize(pages(self), 1); let graph = at(__SPL272, 1); dotDrawing(graph,options(self)) }), ->('matrix', { let __SPL273 = assertIsOfSize(pages(self), 1); let contents = at(__SPL273, 1); asGreyscaleSvg(contents) })], { drawing(asLineDrawing(self)) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _scatterPlot_1(_realImaginary_1(_self));
  }, ["self"]),
  "{ :self | scatterPlot(realImaginary(self)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k, _aBlock_1) {
    ...
    let __SPL274 = _assertIsOfSize_2(_self, 2);
    let _min = _at_2(__SPL274, 1);
    let _max = _at_2(__SPL274, 2);
  ...
  "{ :self :k :aBlock:/1 | let __SPL274 = assertIsOfSize(self, 2); let min = at(__SPL274, 1); let max = at(__SPL274, 2); let colourFunction:/1 = asBlock(asColourGradient(at(colourGradients(system), 'Kovesi', 'Cyclic-Mygbm-30-95-C78S25'))); let r = subdivide((--(real(min), real(max))),k); let i = subdivide((--(imaginary(min), imaginary(max))),k); Image(reversed(table({ :x :y | let z = Complex(y, x); colourFunction(+(/(arg(aBlock(z)), pi(2)), 0.5)) },i, r))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_d, _b1, _b2) {
    ...
    return _matrixPlot_1(
      _reversed_1(_transposed_1(_binCounts_3(_d, _b1, _b2))),
    );
  }, ["d", "b1", "b2"]),
  "{ :d :b1 :b2 | matrixPlot(reversed(transposed(binCounts(d,b1, b2)))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_d) {
    ...
    let __SPL275 = _assertIsOfSize_2(_minMax_1(_d), 2);
    let _p = _at_2(__SPL275, 1);
    let _q = _at_2(__SPL275, 2);
    let __SPL276 = _assertIsOfSize_2(_p, 2);
    let _x1 = _at_2(__SPL276, 1);
    let _y1 = _at_2(__SPL276, 2);
    let __SPL277 = _assertIsOfSize_2(_q, 2);
    let _x2 = _at_2(__SPL277, 1);
    let _y2 = _at_2(__SPL277, 2);
    let _k = 11;
  ...
  "{ :d | let __SPL275 = assertIsOfSize(minMax(d), 2); let p = at(__SPL275, 1); let q = at(__SPL275, 2); let __SPL276 = assertIsOfSize(p, 2); let x1 = at(__SPL276, 1); let y1 = at(__SPL276, 2); let __SPL277 = assertIsOfSize(q, 2); let x2 = at(__SPL277, 1); let y2 = at(__SPL277, 2); let k = 11; let x3 = /((-(x2, x1)), k); let y3 = /((-(y2, y1)), k); let b1 = [x1, +(x2, x3), x3]; let b2 = [y1, +(y2, y3), y3]; densityHistogramPlot(d, b1, b2) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL278 = _assertIsOfSize_2(_self, 2);
    let _b = _at_2(__SPL278, 1);
    let _y = _at_2(__SPL278, 2);
  ...
  "{ :self | let __SPL278 = assertIsOfSize(self, 2); let b = at(__SPL278, 1); let y = at(__SPL278, 2); let x = adjacentPairsCollect(b, { :i :j | +(i, (/((-(j, i)), 2))) }); discretePlot(transposed([x, y])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _d) {
    ...
    /* Statements */
    return _scatterPlot_1(_transposed_1([_x, _y]));
  }, ["self", "d"]),
  "{ :self :d | let k = size(self); let n = -(k, d); let y = copyFromTo(self,1, n); let x = copyFromTo(self,+(1, d), k); scatterPlot(transposed([x, y])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL279 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL279, 1);
    let _n = _at_2(__SPL279, 2);
    /* Statements */
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let _r = _collect_2(
          ...
          sl.annotateFunction(function (_each) {
            ...
            let __SPL280 = _assertIsOfSize_2(_each, 3);
            let _t = _at_2(__SPL280, 1);
            let _d = _at_2(__SPL280, 2);
            let _p = _at_2(__SPL280, 3);
            /* Statements */
  ...
  "{ :self | let __SPL279 = assertIsOfSize(shape(self), 2); let m = at(__SPL279, 1); let n = at(__SPL279, 2); if((>=(n, 3)), { let tMax = injectInto(self, 0, { :z :each | max(z,+(at(each, 1), at(each, 2))) }); let tScale = /(100, max(tMax,20)); let r = collect(self, { :each | let __SPL280 = assertIsOfSize(each, 3); let t = at(__SPL280, 1); let d = at(__SPL280, 2); let p = at(__SPL280, 3); Rectangle([*(t, tScale), p], [*((+(t, d)), tScale), (+(p, 1))]) }); LineDrawing([PointCloud([[0, 32], [0, 60], [0, 84], [*(tMax, tScale), 60]]), r]) }, { error(self,'pianoRollPlot: not at least three-column matrix') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _options) {
    ...
    let __SPL281 = _assertIsOfSize_2(_shape_1(_self), 2);
    let _m = _at_2(__SPL281, 1);
    let _n = _at_2(__SPL281, 2);
    let __SPL282 = _assertIsOfSize_2(_deepMinMax_1(_self), 2);
    let _z0 = _at_2(__SPL282, 1);
    let _z1 = _at_2(__SPL282, 2);
    ...
    let _data = _table_3(
      sl.annotateFunction(function (_i, _j) {
        ...
        return _colourFunction_1(
          _rescale_5(_at_2(_at_2(_self, _i), _j), _z0, _z1, 0, 1),
        );
      }, ["i", "j"]),
      _Span_3(1, _m, 1),
      _Span_3(1, _n, 1),
  ...
  "{ :self :options | let __SPL281 = assertIsOfSize(shape(self), 2); let m = at(__SPL281, 1); let n = at(__SPL281, 2); let __SPL282 = assertIsOfSize(deepMinMax(self), 2); let z0 = at(__SPL282, 1); let z1 = at(__SPL282, 2); let colourFunction = { :z | hslToRgb([z, 0.75, 0.75]) }; let data = table({ :i :j | colourFunction(rescale(at(at(self, i), j),z0, z1, 0, 1)) },Span(1, m, 1), Span(1, n, 1)); ifFalse(at(options, 'dataReversed'), { reverse(data) }); Image(data) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_y, _i) {
    ...
    let __SPL283 = _assertIsOfSize_2(_minMax_1(_i), 2);
    let _a = _at_2(__SPL283, 1);
    let _b = _at_2(__SPL283, 2);
  ...
  "{ :y :i | let __SPL283 = assertIsOfSize(minMax(i), 2); let a = at(__SPL283, 1); let b = at(__SPL283, 2); let c = -(b, a); if(isVector(y), { linePlot(y) }, { let n = size(y); let z = 1.15; linePlot(withIndexCollect(y, { :each :i | +(each, (*(*((-(n, i)), c), z))) })) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _k = _size_1(_self);
    let _r = _rounded_1(_asterisk_2(0.025, _k));
    let _n = _nextPowerOfTwo_1(_k);
    let _d = _padRight_3(_self, [_n], 0);
    let _p = _absSquared_1(
  ...
  "{ :self | let k = size(self); let r = rounded((*(0.025, k))); let n = nextPowerOfTwo(k); let d = padRight(self,[n], 0); let p = absSquared(take((/(fft(d), n)),/(n, 2))); atPut(p, 1, 0); linePlot(gaussianFilter((*(p, 10)),r)) }",
);
...
sl.extendTypeOrTraitWithMethod(
      ...
      sl.annotateFunction(function () {
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            let __SPL284 = _assertIsOfSize_2(_shape_1(_self), 2);
            let _m = _at_2(__SPL284, 1);
            let _n = _at_2(__SPL284, 2);
            /* Statements */
            return _if_3(
              _equalsSign_2(_n, 2),
              sl.annotateFunction(function () {
                ...
                _do_2(
                  ...
                  sl.annotateFunction(function (_each) {
                    ...
                    let __SPL285 = _assertIsOfSize_2(_each, 2);
                    let _x2 = _at_2(__SPL285, 1);
                    let _y = _at_2(__SPL285, 2);
                    /* Statements */
  ...
  "{ :self | if(isVector(self), { let answer = []; withIndexDo(self, { :each :index | add(answer,[index, each]); add(answer,[+(index, 1), each]) }); answer }, { if(isMatrix(self), { let __SPL284 = assertIsOfSize(shape(self), 2); let m = at(__SPL284, 1); let n = at(__SPL284, 2); if((=(n, 2)), { let x1 = at(at(self, 1), 1); let answer = []; do(self, { :each | let __SPL285 = assertIsOfSize(each, 2); let x2 = at(__SPL285, 1); let y = at(__SPL285, 2); add(answer,[x1, y]); add(answer,[x2, y]); x1 := x2 }); answer }, { collect(self,stepPlotLineData:/1) }) }, { collect(self,stepPlotLineData:/1) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _k, _aBlock_2) {
    ...
    let __SPL286 = _assertIsOfSize_2(_self, 2);
    let _u = _at_2(__SPL286, 1);
    let _v = _at_2(__SPL286, 2);
    let __SPL287 = _assertIsOfSize_2(_k, 2);
    let _m = _at_2(__SPL287, 1);
    let _n = _at_2(__SPL287, 2);
    let _i = _subdivide_2(
  ...
  "{ :self :k :aBlock:/2 | let __SPL286 = assertIsOfSize(self, 2); let u = at(__SPL286, 1); let v = at(__SPL286, 2); let __SPL287 = assertIsOfSize(k, 2); let m = at(__SPL287, 1); let n = at(__SPL287, 2); let i = subdivide((--(min(u), max(u))),m); let j = subdivide((--(min(v), max(v))),n); surfacePlot(table(aBlock:/2, i, j)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL288 = _assertIsOfSize_2(_shape_1(_self), 2);
        let _m = _at_2(__SPL288, 1);
        let _n = _at_2(__SPL288, 2);
        /* Statements */
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL289 = _assertIsOfSize_2(_shape_1(_self), 3);
        let _m = _at_2(__SPL289, 1);
        let _n = _at_2(__SPL289, 2);
        let __genSym295 = _at_2(__SPL289, 3);
        let _p = _collect_2(
          _Span_3(1, _m, 1),
          sl.annotateFunction(function (_i) {
            /* ArityCheck */
  ...
  "{ :self | if(isMatrix(self), { let __SPL288 = assertIsOfSize(shape(self), 2); let m = at(__SPL288, 1); let n = at(__SPL288, 2); surfacePlot(table({ :i :j | [i, j, at(self, i, j)] },Span(1, m, 1), Span(1, n, 1))) }, { let __SPL289 = assertIsOfSize(shape(self), 3); let m = at(__SPL289, 1); let n = at(__SPL289, 2); let _ = at(__SPL289, 3); let p = collect(Span(1, m, 1), { :i | collect(Span(1, n, 1), { :j | at(at(self, i), j) }) }); let q = collect(Span(1, n, 1), { :j | collect(Span(1, m, 1), { :i | at(at(self, i), j) }) }); linePlot((++(p, q))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
          ...
          sl.annotateFunction(function () {
            ...
            return _if_3(
              ...
              sl.annotateFunction(function () {
                ...
                let __SPL290 = _assertIsOfSize_2(_shape_1(_self), 2);
                let _m = _at_2(__SPL290, 1);
                let _n = _at_2(__SPL290, 2);
                /* Statements */
                return _if_3(
  ...
  "{ :self :format | self := asFloat(self); if(isVector(self), { typedVectorPlot([self],format) }, { if(isColumnVector(self), { typedVectorPlot([catenate(self)],format) }, { if(isSmallFloatMatrix(self), { let __SPL290 = assertIsOfSize(shape(self), 2); let m = at(__SPL290, 1); let n = at(__SPL290, 2); if((<=(n, 3)), { Plot([self],format) }, { typedVectorPlot(self,format) }) }, { Plot(self,format) }) }) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_1) {
    ...
    let _k = 100;
    let __SPL291 = _assertIsOfSize_2(_log_1(_minMax_1(_self)), 2);
  ...
  "{ :self :aBlock:/1 | let k = 100; let __SPL291 = assertIsOfSize(log(minMax(self)), 2); let a = at(__SPL291, 1); let b = at(__SPL291, 2); let h = /((-(b, a)), (-(k, 1))); let x = collect(upOrDownTo(0, -(k, 1)), { :i | exp((+(a, (*(i, h))))) }); let y = collect(x, { :each | aBlock(each) }); linePlot(y) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _xInterval, _yInterval) {
    ...
    let __SPL292 = _assertIsOfSize_2(_minMax_1(_xInterval), 2);
    let _x1 = _at_2(__SPL292, 1);
    let _x2 = _at_2(__SPL292, 2);
    let __SPL293 = _assertIsOfSize_2(_minMax_1(_yInterval), 2);
    let _y1 = _at_2(__SPL293, 1);
    let _y2 = _at_2(__SPL293, 2);
    let _n = 16;
  ...
  "{ :self :xInterval :yInterval | let __SPL292 = assertIsOfSize(minMax(xInterval), 2); let x1 = at(__SPL292, 1); let x2 = at(__SPL292, 2); let __SPL293 = assertIsOfSize(minMax(yInterval), 2); let y1 = at(__SPL293, 1); let y2 = at(__SPL293, 2); let n = 16; let xStep = /((-(x2, x1)), n); let yStep = /((-(y2, y1)), n); let minStep = min(xStep,yStep); let coordinateList = flatten(table({ :i :j | let x = +((+(x1, (*(i, xStep)))), (*((%(j, 2)), (/(xStep, 2))))); let y = +(y1, (*(j, yStep))); [x, y] },asList(upOrDownTo(0, -(n, 1))), asList(upOrDownTo(0, -(n, 1)))),1); vectorPlot(coordinateList,self, *(minStep, 0.35)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_2, _scalar) {
    ...
    return _LineDrawing_1(_collect_2(
      ...
      sl.annotateFunction(function (_xy) {
        ...
        let __SPL294 = _assertIsOfSize_2(_xy, 2);
        let _x = _at_2(__SPL294, 1);
        let _y = _at_2(__SPL294, 2);
  ...
  "{ :self :aBlock:/2 :scalar | LineDrawing(collect(self, { :xy | let __SPL294 = assertIsOfSize(xy, 2); let x = at(__SPL294, 1); let y = at(__SPL294, 2); let uv = *(normalize(aBlock(x, y)), scalar); [Point(+(xy, uv)), Line([-(xy, uv), +(xy, uv)])] })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _discretePlot_1(_transposed_1([_key_1(_self), _value_1(_self)]));
  }, ["self"]),
  "{ :self | discretePlot(transposed([key(self), value(self)])) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _linePlot_1(_transposed_1([_key_1(_self), _value_1(_self)]));
  }, ["self"]),
  "{ :self | linePlot(transposed([key(self), value(self)])) }",
);
