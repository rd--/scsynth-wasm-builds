    ...
    let _plotData = _if_3(_equalsSign_2(_format, "matrix"), function () {
      ...
      return _if_3(_equalsSign_2(_d, 1), function () {
        ...
        return _if_3(_equalsSign_2(_d, 2), function () {
          ...
          /* Temporaries */
          let __genSym64 = _assertIsOfSize_2(_shape, 2),
            _m = _at_2(__genSym64, 1),
            _n = _at_2(__genSym64, 2);
          /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_domain, _functionBlock_1) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _domain, _functionBlock_1"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
