...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _theta = _solidus_2(_pi_1(2), _n);
    /* Statements */
    return _LineDrawing_1(_table_3(
      sl.annotateFunction(function (_i, _j) {
        ...
        return _AnnulusSector_3([0, 0], [_i, _plusSign_2(_i, 1)], [
          _asterisk_2(_theta, _j),
          _asterisk_2(_theta, _plusSign_2(_j, 1)),
        ]);
      }, ["i", "j"]),
      _Span_3(1, _m, 1),
      _Span_3(1, _n, 1),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_y, _i) {
    ...
    let __SplVar18 = _assertIsOfSize_2(_minMax_1(_i), 2);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SplUnused36 = _at_2(__SplVar24, 3);
        let _p = _collect_2(
          _Span_3(1, _m, 1),
          sl.annotateFunction(function (_i) {
            /* ArityCheck */
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _modulus) {
    ...
    let _circleR = 16;
    let _dotR = 1;
    let _i = _percentSign_2(_hyphenMinus_2(_modulus, _self), _modulus);
    let _p = _circlePoints_4(
      _modulus,
      [0, 0],
      _circleR,
    ...
    let _e = _collect_2(
      _to_2(0, _hyphenMinus_2(_modulus, 1)),
      sl.annotateFunction(function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
        ...
        return _if_3(
          ...
          sl.annotateFunction(function () {
            ...
            return _Disk_2(_at_2(_p, _plusSign_2(_each, 1)), _dotR);
          }, []),
          sl.annotateFunction(function () {
            /* ArityCheck */
            if (arguments.length !== 0) {
            ...
            return _Circle_2(_at_2(_p, _plusSign_2(_each, 1)), _dotR);
          }, []),
        );
      }, ["each"]),
    );
