...
sl.addMethod(
  ...
  "PngViewer",
  ["self", "pngData"],
  function (_self, _pngData) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _pngData";
      console.error(errorMessage);
      throw new Error(errorMessage);
    }
    /* Statements */
    return _initialize_3(_newPngViewer_0(), _self, _pngData);
  },
...
sl.addMethod(
  ...
  "PngViewer",
  ["self", "title", "png"],
  function (_self, _title, _png) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _title, _png";
      console.error(errorMessage);
      throw new Error(errorMessage);
    }
    /* Statements */
    return _addFrame_3(_self, _PngViewer_2(_title, _png), null);
  },
