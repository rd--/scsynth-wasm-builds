...
sl.addTraitMethod(
  ...
  function (_k) {
    ...
    /* Statements */
    return _last_1(_bernoulliList_1(_k));
  },
...
sl.addTraitMethod(
  ...
  function (_k) {
    ...
    _do_2(_upOrDownTo_2(0, _k), function (_n) {
      ...
      _do_2(_thenTo_3(_n, _hyphenMinus_2(_n, 1), 1), function (_j) {
        /* ArityCheck */
        if (arguments.length !== 1) {
...
sl.addTraitMethod(
  ...
  function (_a, _b) {
    ...
    /* Temporaries */
    let __genSym30 = _assertIsOfSize_2([_a, _b], 2),
      _r0 = _at_2(__genSym30, 1),
      _r = _at_2(__genSym30, 2);
    let __genSym31 = _assertIsOfSize_2([1, 0], 2),
      _s0 = _at_2(__genSym31, 1),
      _s = _at_2(__genSym31, 2);
    let __genSym32 = _assertIsOfSize_2([0, 1], 2),
      _t0 = _at_2(__genSym32, 1),
      _t = _at_2(__genSym32, 2);
    /* Statements */
    _whileTrue_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
      ...
      /* List Assignment */ (function () {
        ...
        _r0 = _at_2(__genSym33, 1);
        _r = _at_2(__genSym33, 2);
      })(); /* List Assignment */
      (function () {
        const __genSym34 = [
          _s,
        ...
        _s0 = _at_2(__genSym34, 1);
        _s = _at_2(__genSym34, 2);
      })();
      return /* List Assignment */ (function () {
        ...
        _t0 = _at_2(__genSym35, 1);
        _t = _at_2(__genSym35, 2);
      })();
    });
...
sl.addTraitMethod(
  ...
  function (_n) {
    ...
    /* Temporaries */
    let __genSym36 = _assertIsOfSize_2([0, 1, 1, _n], 4),
      _a = _at_2(__genSym36, 1),
      _b = _at_2(__genSym36, 2),
      _c = _at_2(__genSym36, 3),
      _d = _at_2(__genSym36, 4);
    ...
    _whileTrue_2(function () {
      ...
      /* List Assignment */ (function () {
        ...
        _a = _at_2(__genSym37, 1);
        _b = _at_2(__genSym37, 2);
        _c = _at_2(__genSym37, 3);
        _d = _at_2(__genSym37, 4);
      })();
  ...
  function (_a, _n) {
    ...
    _whileTrue_2(function () {
      ...
      /* List Assignment */ (function () {
        ...
        _t = _at_2(__genSym38, 1);
        _t1 = _at_2(__genSym38, 2);
      })();
      return /* List Assignment */ (function () {
        const __genSym39 = [
          _r1,
        ...
        _r = _at_2(__genSym39, 1);
        _r1 = _at_2(__genSym39, 2);
      })();
    });
