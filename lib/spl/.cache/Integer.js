...
sl.addMethodToExistingTrait(
  ...
  "{ :n :letters | let __SplVar1 = assertIsOfSize(letters, 2); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); let f = { :x :i :n0 :n1 | let d0 = { f(++(x, [a]), +(i, 1), +(n0, 1), n1) }; let d1 = { f(++(x, [b]), +(i, 1), n0, +(n1, 1)) }; if((&&(&&((<(n0, n)), (<(n1, n))), (>(n0, n1)))), { ++(d0(), d1()) }, { if((||((&&(&&((<(n0, n)), (<(n1, n))), (=(n0, n1)))), (&&((<(n0, n)), (=(n1, n)))))), { d0() }, { if((&&((=(n0, n)), (<(n1, n)))), { d1() }, { if((&&((=(n0, n1)), (=(n1, n)))), { [x] }, { error(n,'Integer>>dyckWords') }) }) }) }) }; f([a], 1, 1, 0) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :a :b | let __SplVar2 = assertIsOfSize([a, b], 2); let r0 = at(__SplVar2, 1); let r = at(__SplVar2, 2); let __SplVar3 = assertIsOfSize([1, 0], 2); let s0 = at(__SplVar3, 1); let s = at(__SplVar3, 2); let __SplVar4 = assertIsOfSize([0, 1], 2); let t0 = at(__SplVar4, 1); let t = at(__SplVar4, 2); whileTrue({ !=(r, 0) }, { let quotient = //(r0, r); ({ let __SplVar5 = [r, -(r0, (*(quotient, r)))]; r0 := at(__SplVar5, 1); r := at(__SplVar5, 2) } . ()); ({ let __SplVar6 = [s, -(s0, (*(quotient, s)))]; s0 := at(__SplVar6, 1); s := at(__SplVar6, 2) } . ()); ({ let __SplVar7 = [t, -(t0, (*(quotient, t)))]; t0 := at(__SplVar7, 1); t := at(__SplVar7, 2) } . ()) }); if((<(r0, 0)), { [-(r0), -([s0, t0])] }, { [r0, [s0, t0]] }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :a :n | let t = 0; let t1 = 1; let r = if((<(n, 0)), { negate(n) }, { n }); let r1 = if((<(a, 0)), { %((-(n, (%(negate(a), n)))), n) }, { %(a, n) }); whileTrue({ !=(r1, 0) }, { let quotient = //(r, r1); ({ let __SplVar8 = [t1, -(t, (*(quotient, t1)))]; t := at(__SplVar8, 1); t1 := at(__SplVar8, 2) } . ()); ({ let __SplVar9 = [r1, -(r, (*(quotient, r1)))]; r := at(__SplVar9, 1); r1 := at(__SplVar9, 2) } . ()) }); if((>(r, 1)), { error('@Integer>>modularInverse: not invertible') }, { ifTrue((<(t, 0)), { t := +(t, n) }); ifTrue((<(n, 0)), { t := +(t, n) }); t }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar10 = assertIsOfSize(self, 2); let m = at(__SplVar10, 1); let n = at(__SplVar10, 2); isAmicablePair(m, n) }",
);
