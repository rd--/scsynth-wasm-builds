...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL12 = _assertIsOfSize_2([_a, _b], 2);
    let _r0 = _at_2(__SPL12, 1);
    let _r = _at_2(__SPL12, 2);
    let __SPL13 = _assertIsOfSize_2([1, 0], 2);
    let _s0 = _at_2(__SPL13, 1);
    let _s = _at_2(__SPL13, 2);
    let __SPL14 = _assertIsOfSize_2([0, 1], 2);
    let _t0 = _at_2(__SPL14, 1);
    let _t = _at_2(__SPL14, 2);
    /* Statements */
    _whileTrue_2(
      sl.annotateFunction(function () {
        /* ArityCheck */
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL15 = [_r, _hyphenMinus_2(_r0, _asterisk_2(_quotient, _r))];
          /* Statements */
          _r0 = _at_2(__SPL15, 1);
          return _r = _at_2(__SPL15, 2);
        }, [])();
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL16 = [_s, _hyphenMinus_2(_s0, _asterisk_2(_quotient, _s))];
          /* Statements */
          _s0 = _at_2(__SPL16, 1);
          return _s = _at_2(__SPL16, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          ...
          let __SPL17 = [_t, _hyphenMinus_2(_t0, _asterisk_2(_quotient, _t))];
          /* Statements */
          _t0 = _at_2(__SPL17, 1);
          return _t = _at_2(__SPL17, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :b | let __SPL12 = assertIsOfSize([a, b], 2); let r0 = at(__SPL12, 1); let r = at(__SPL12, 2); let __SPL13 = assertIsOfSize([1, 0], 2); let s0 = at(__SPL13, 1); let s = at(__SPL13, 2); let __SPL14 = assertIsOfSize([0, 1], 2); let t0 = at(__SPL14, 1); let t = at(__SPL14, 2); whileTrue({ ~=(r, 0) }, { let quotient = //(r0, r); ({ let __SPL15 = [r, -(r0, (*(quotient, r)))]; r0 := at(__SPL15, 1); r := at(__SPL15, 2) } . ()); ({ let __SPL16 = [s, -(s0, (*(quotient, s)))]; s0 := at(__SPL16, 1); s := at(__SPL16, 2) } . ()); ({ let __SPL17 = [t, -(t0, (*(quotient, t)))]; t0 := at(__SPL17, 1); t := at(__SPL17, 2) } . ()) }); if((<(r0, 0)), { [-(r0), -([s0, t0])] }, { [r0, [s0, t0]] }) }",
);
...
sl.addMethodToExistingTrait(
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL18 = [_t1, _hyphenMinus_2(_t, _asterisk_2(_quotient, _t1))];
          /* Statements */
          _t = _at_2(__SPL18, 1);
          return _t1 = _at_2(__SPL18, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL19 = [_r1, _hyphenMinus_2(_r, _asterisk_2(_quotient, _r1))];
          /* Statements */
          _r = _at_2(__SPL19, 1);
          return _r1 = _at_2(__SPL19, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :n | let t = 0; let t1 = 1; let r = if((<(n, 0)), { negated(n) }, { n }); let r1 = if((<(a, 0)), { %((-(n, (%(negated(a), n)))), n) }, { %(a, n) }); whileTrue({ ~=(r1, 0) }, { let quotient = //(r, r1); ({ let __SPL18 = [t1, -(t, (*(quotient, t1)))]; t := at(__SPL18, 1); t1 := at(__SPL18, 2) } . ()); ({ let __SPL19 = [r1, -(r, (*(quotient, r1)))]; r := at(__SPL19, 1); r1 := at(__SPL19, 2) } . ()) }); if((>(r, 1)), { error('@Integer>>modularInverse: not invertible') }, { if((<(t, 0)), { +(t, n) }, { t }) }) }",
);
