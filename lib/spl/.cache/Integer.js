...
sl.addMethodToExistingTrait(
  ...
  "{ :x :b | let digitSum = { :x :b | let total = 0; whileTrue({ >(x, 0) }, { total := +(total, (%(x, b))); x := //(x, b) }); total }; let seen = IdentitySet(); whileFalse({ includes(seen,x) }, { add(seen,x); x := digitSum(x, b) }); [x, seen] }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base | sum(integerDigits(self,base)) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :x | let u = floor(sqrt(x)); -(*(2, sum(upOrDownTo(1, u), { :k | floor((/(x, k))) })), square(u)) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_n, _letters) {
    ...
    let __SPL1 = _assertIsOfSize_2(_letters, 2);
  ...
  "{ :n :letters | let __SPL1 = assertIsOfSize(letters, 2); let a = at(__SPL1, 1); let b = at(__SPL1, 2); let f = { :x :i :n0 :n1 | let d0 = { f(++(x, [a]), +(i, 1), +(n0, 1), n1) }; let d1 = { f(++(x, [b]), +(i, 1), n0, +(n1, 1)) }; if((&&(&&((<(n0, n)), (<(n1, n))), (>(n0, n1)))), { ++(d0(), d1()) }, { if((||((&&(&&((<(n0, n)), (<(n1, n))), (=(n0, n1)))), (&&((<(n0, n)), (=(n1, n)))))), { d0() }, { if((&&((=(n0, n)), (<(n1, n)))), { d1() }, { if((&&((=(n0, n1)), (=(n1, n)))), { [x] }, { error(n,'Integer>>dyckWords') }) }) }) }) }; f([a], 1, 1, 0) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :m :n :k | let a = *(k, (-(square(m), square(n)))); let b = *(*(*(k, 2), m), n); let c = *(k, (+(square(m), square(n)))); [a, b, c] }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL2 = _assertIsOfSize_2([_a, _b], 2);
    let _r0 = _at_2(__SPL2, 1);
    let _r = _at_2(__SPL2, 2);
    let __SPL3 = _assertIsOfSize_2([1, 0], 2);
    let _s0 = _at_2(__SPL3, 1);
    let _s = _at_2(__SPL3, 2);
    let __SPL4 = _assertIsOfSize_2([0, 1], 2);
    let _t0 = _at_2(__SPL4, 1);
    let _t = _at_2(__SPL4, 2);
    /* Statements */
    _whileTrue_2(
      sl.annotateFunction(function () {
        /* ArityCheck */
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL5 = [_r, _hyphenMinus_2(_r0, _asterisk_2(_quotient, _r))];
          /* Statements */
          _r0 = _at_2(__SPL5, 1);
          return _r = _at_2(__SPL5, 2);
        }, [])();
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL6 = [_s, _hyphenMinus_2(_s0, _asterisk_2(_quotient, _s))];
          /* Statements */
          _s0 = _at_2(__SPL6, 1);
          return _s = _at_2(__SPL6, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          ...
          let __SPL7 = [_t, _hyphenMinus_2(_t0, _asterisk_2(_quotient, _t))];
          /* Statements */
          _t0 = _at_2(__SPL7, 1);
          return _t = _at_2(__SPL7, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :b | let __SPL2 = assertIsOfSize([a, b], 2); let r0 = at(__SPL2, 1); let r = at(__SPL2, 2); let __SPL3 = assertIsOfSize([1, 0], 2); let s0 = at(__SPL3, 1); let s = at(__SPL3, 2); let __SPL4 = assertIsOfSize([0, 1], 2); let t0 = at(__SPL4, 1); let t = at(__SPL4, 2); whileTrue({ !=(r, 0) }, { let quotient = //(r0, r); ({ let __SPL5 = [r, -(r0, (*(quotient, r)))]; r0 := at(__SPL5, 1); r := at(__SPL5, 2) } . ()); ({ let __SPL6 = [s, -(s0, (*(quotient, s)))]; s0 := at(__SPL6, 1); s := at(__SPL6, 2) } . ()); ({ let __SPL7 = [t, -(t0, (*(quotient, t)))]; t0 := at(__SPL7, 1); t := at(__SPL7, 2) } . ()) }); if((<(r0, 0)), { [-(r0), -([s0, t0])] }, { [r0, [s0, t0]] }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n :kList :aBlock:/1 | do(kList, { :k | integerCompositionsExactlyDo(n,k, aBlock:/1) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n :aBlock:/1 | integerCompositionsDo(n, Span(1, n, 1), aBlock:/1) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n :k | let answer = []; integerCompositionsExactlyDo(n, k, { :each | add(answer,copy(each)) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n | integerCompositionsWeak(n, Span(1, n, 1)) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n :kList | let answer = []; do(kList, { :k | integerCompositionsWeakExactlyDo(n, k, { :each | add(answer,copy(each)) }) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n :k | let answer = []; integerCompositionsWeakExactlyDo(n, k, { :each | add(answer,copy(each)) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base | assertIsInteger(self,'@Integer>>integerDigits'); if(isScalarInteger(base), { let numDigits = if(isZero(self), { 1 }, { +(truncate((+(/(log(abs(self)), log(base)), 0.0000000001))), 1) }); integerDigits(self,base, numDigits) }, { adaptToNumberAndApply(base,self, integerDigits:/2) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :radix | if(isZero(self), { 0 }, { let n = 1; let m = abs(self); whileTrue({ >=(m, (^(radix, n))) }, { n := +(n, 1) }); n }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n | let answer = []; integerPartitionsDescendingDo(n, { :each | add(answer,each) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n :k | ++(collect(k, { :each | integerPartitionsExactly(n,each) })) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | select(integerPartitions(self), { :each | allSatisfy(each,isOdd:/1) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n | collectCatenate(Span(1, n, 1), { :k | integerPartitionsExactly(n,k) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | select(integerPartitions(self),isDuplicateFree:/1) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base | fromDigits(reverse(integerDigits(self,base)),base) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :radix | basicPrintString(self,radix) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n | if((>(n, 224403121196654400L)), { error(n,'isColossallyAbundantNumber: domain error') }, { includes([2, 6, 12, 60, 120, 360, 2520, 5040, 55440, 720720, 1441440, 4324320, 21621600, 367567200, 6983776800, 160626866400, 321253732800, 9316358251200, 288807105787200, 2021649740510400, 6064949221531200, 224403121196654400L],n) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | =(last(perfectDigitalInvariantSequence(self,10, 2)), 1) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n | isInteger(/(*(n, divisorSigma(0, n)), divisorSigma(1, n))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base :power | let n = integerLength(self,base); let d = integerDigits((^(self, power)),base); let p = fromDigits(last(d,n),base); let q = fromDigits(dropLast(d,n),base); =((+(p, q)), self) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | isKaprekarNumber(self,10, 2) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base | let power = integerLength(self,base); =(sum((^(integerDigits(self,base), power))), self) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | isNarcissisticNumber(self,10) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | isPalindrome(integerDigits(self)) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base :power | =(perfectDigitalInvariantFunction(self,base, power), self) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :a :b :c | &(allSatisfy([a, b, c],isInteger:/1), { &(isCoprime(a,b), { &(=(sum(boole(collect([a, b],isOdd:/1))), 1), { =((+(square(a), square(b))), square(c)) }) }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :a :b | isPrimitivePythagoreanTriple(a, b, sqrt((+(square(a), square(b))))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :a :b :c | &(allSatisfy([a, b, c],isInteger:/1), { =((+(square(a), square(b))), square(c)) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :a :b | isPythagoreanTriple(a, b, sqrt((+(square(a), square(b))))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base | let d = integerDigits(self,base); =((*(sum(d), product(d))), self) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | isSumProductNumber(self,10) }",
);
...
sl.addMethodToExistingTrait(
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL8 = [_t1, _hyphenMinus_2(_t, _asterisk_2(_quotient, _t1))];
          /* Statements */
          _t = _at_2(__SPL8, 1);
          return _t1 = _at_2(__SPL8, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL9 = [_r1, _hyphenMinus_2(_r, _asterisk_2(_quotient, _r1))];
          /* Statements */
          _r = _at_2(__SPL9, 1);
          return _r1 = _at_2(__SPL9, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :n | let t = 0; let t1 = 1; let r = if((<(n, 0)), { negate(n) }, { n }); let r1 = if((<(a, 0)), { %((-(n, (%(negate(a), n)))), n) }, { %(a, n) }); whileTrue({ !=(r1, 0) }, { let quotient = //(r, r1); ({ let __SPL8 = [t1, -(t, (*(quotient, t1)))]; t := at(__SPL8, 1); t1 := at(__SPL8, 2) } . ()); ({ let __SPL9 = [r1, -(r, (*(quotient, r1)))]; r := at(__SPL9, 1); r1 := at(__SPL9, 2) } . ()) }); if((>(r, 1)), { error('@Integer>>modularInverse: not invertible') }, { ifTrue((<(t, 0)), { t := +(t, n) }); ifTrue((<(n, 0)), { t := +(t, n) }); t }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base :power | let sum = 0; whileTrue({ >(self, 0) }, { sum := +(sum, (^((%(self, base)), power))); self := //(self, base) }); sum }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :base :power | let answer = []; whileFalse({ includes(answer,self) }, { add(answer,self); self := perfectDigitalInvariantFunction(self,base, power) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | if(isZero(self), { 'N' }, { asciiStringStreamContents({ :stream | romanDigitsOn(self, stream) }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n :p | if((!=(legendreSymbol(n, p), 1)), { error([n, p],'tonelliShanksAlgorithm: not square') }, { let q = -(p, 1); let s = 0; whileTrue({ isEven(q) }, { q := /(q, 2); s := +(s, 1) }); if((=(s, 1)), { powerMod(n, /((+(p, 1)), 4), p) }, { let z = 2; let m = s; let c = nil; let r = nil; let t = nil; whileTrue({ &(<(z, p), { !=(legendreSymbol(z, p), -1) }) }, { z := +(z, 1) }); c := powerMod(z, q, p); r := powerMod(n, /((+(q, 1)), 2), p); t := powerMod(n, q, p); whileTrue({ !=(%((-(t, 1)), p), 0) }, { let t2 = %((^(t, 2)), p); let i = 1; let b = nil; whileTrue({ &(<(i, m), { !=(%((-(t2, 1)), p), 0) }) }, { t2 := %((^(t2, 2)), p); i := +(i, 1) }); b := powerMod(c, ^(2, (-(-(m, i), 1))), p); r := %((*(r, b)), p); c := %((^(b, 2)), p); t := %((*(t, c)), p); m := i }); r }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n | let a = cubeRoot((+(19, (*(3, sqrt(33)))))); let b = cubeRoot((+(586, (*(102, sqrt(33)))))); let c = cubeRoot((-(19, (*(3, sqrt(33)))))); let d = ^((*((/(1, 3)), (+(+(a, c), 1)))), (-(n, 1))); let e = +(-(square(b), (*(2, b))), 4); round((*((*(3, b)), (/(d, e))))) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let answer = []; let j = size(self); let done = false; if((<=(j, 0)), { answer }, { whileFalse({ done }, { add(answer,j); whileTrue({ &(not(done), { >=(size(answer), at(self, j)) }) }, { j := -(j, 1); ifTrue((=(j, 0)), { done := true }) }) }) }); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let m = size(self); LineDrawing(collect(upOrDownTo(0, -(m, 1)), { :i | collect(upOrDownTo(1, at(self, -(m, i))), { :j | Disk([j, i], 0.25) }) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL10 = assertIsOfSize(self, 2); let m = at(__SPL10, 1); let n = at(__SPL10, 2); isAmicablePair(m, n) }",
);
