...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL292 = _assertIsOfSize_2([_a, _b], 2);
    let _r0 = _at_2(__SPL292, 1);
    let _r = _at_2(__SPL292, 2);
    let __SPL293 = _assertIsOfSize_2([1, 0], 2);
    let _s0 = _at_2(__SPL293, 1);
    let _s = _at_2(__SPL293, 2);
    let __SPL294 = _assertIsOfSize_2([0, 1], 2);
    let _t0 = _at_2(__SPL294, 1);
    let _t = _at_2(__SPL294, 2);
    /* Statements */
    _whileTrue_2(
      sl.annotateFunction(function () {
        /* ArityCheck */
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL295 = [_r, _hyphenMinus_2(_r0, _asterisk_2(_quotient, _r))];
          /* Statements */
          _r0 = _at_2(__SPL295, 1);
          return _r = _at_2(__SPL295, 2);
        }, [])();
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL296 = [_s, _hyphenMinus_2(_s0, _asterisk_2(_quotient, _s))];
          /* Statements */
          _s0 = _at_2(__SPL296, 1);
          return _s = _at_2(__SPL296, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          ...
          let __SPL297 = [_t, _hyphenMinus_2(_t0, _asterisk_2(_quotient, _t))];
          /* Statements */
          _t0 = _at_2(__SPL297, 1);
          return _t = _at_2(__SPL297, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :b | let __SPL292 = assertIsOfSize([a, b], 2); let r0 = at(__SPL292, 1); let r = at(__SPL292, 2); let __SPL293 = assertIsOfSize([1, 0], 2); let s0 = at(__SPL293, 1); let s = at(__SPL293, 2); let __SPL294 = assertIsOfSize([0, 1], 2); let t0 = at(__SPL294, 1); let t = at(__SPL294, 2); whileTrue({ ~=(r, 0) }, { let quotient = //(r0, r); ({ let __SPL295 = [r, -(r0, (*(quotient, r)))]; r0 := at(__SPL295, 1); r := at(__SPL295, 2) } . ()); ({ let __SPL296 = [s, -(s0, (*(quotient, s)))]; s0 := at(__SPL296, 1); s := at(__SPL296, 2) } . ()); ({ let __SPL297 = [t, -(t0, (*(quotient, t)))]; t0 := at(__SPL297, 1); t := at(__SPL297, 2) } . ()) }); if((<(r0, 0)), { [-(r0), -([s0, t0])] }, { [r0, [s0, t0]] }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :n | let __SPL298 = assertIsOfSize([0, 1, 1, n], 4); let a = at(__SPL298, 1); let b = at(__SPL298, 2); let c = at(__SPL298, 3); let d = at(__SPL298, 4); let answer = [Fraction(a, b)]; whileTrue({ <=(c, n) }, { let k = floor((/((+(n, b)), d))); ({ let __SPL299 = [c, d, -(*(k, c), a), -(*(k, d), b)]; a := at(__SPL299, 1); b := at(__SPL299, 2); c := at(__SPL299, 3); d := at(__SPL299, 4) } . ()); add(answer,Fraction(a, b)) }); answer }",
);
...
sl.addMethodToExistingTrait(
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL300 = [_t1, _hyphenMinus_2(_t, _asterisk_2(_quotient, _t1))];
          /* Statements */
          _t = _at_2(__SPL300, 1);
          return _t1 = _at_2(__SPL300, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL301 = [_r1, _hyphenMinus_2(_r, _asterisk_2(_quotient, _r1))];
          /* Statements */
          _r = _at_2(__SPL301, 1);
          return _r1 = _at_2(__SPL301, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :n | let t = 0; let t1 = 1; let r = if((<(n, 0)), { negated(n) }, { n }); let r1 = if((<(a, 0)), { %((-(n, (%(negated(a), n)))), n) }, { %(a, n) }); whileTrue({ ~=(r1, 0) }, { let quotient = //(r, r1); ({ let __SPL300 = [t1, -(t, (*(quotient, t1)))]; t := at(__SPL300, 1); t1 := at(__SPL300, 2) } . ()); ({ let __SPL301 = [r1, -(r, (*(quotient, r1)))]; r := at(__SPL301, 1); r1 := at(__SPL301, 2) } . ()) }); if((>(r, 1)), { error('@Integer>>modularInverse: not invertible') }, { if((<(t, 0)), { +(t, n) }, { t }) }) }",
);
