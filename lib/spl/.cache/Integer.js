...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL501 = _assertIsOfSize_2([_a, _b], 2);
    let _r0 = _at_2(__SPL501, 1);
    let _r = _at_2(__SPL501, 2);
    let __SPL502 = _assertIsOfSize_2([1, 0], 2);
    let _s0 = _at_2(__SPL502, 1);
    let _s = _at_2(__SPL502, 2);
    let __SPL503 = _assertIsOfSize_2([0, 1], 2);
    let _t0 = _at_2(__SPL503, 1);
    let _t = _at_2(__SPL503, 2);
    /* Statements */
    _whileTrue_2(
      sl.annotateFunction(function () {
        /* ArityCheck */
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL504 = [_r, _hyphenMinus_2(_r0, _asterisk_2(_quotient, _r))];
          /* Statements */
          _r0 = _at_2(__SPL504, 1);
          return _r = _at_2(__SPL504, 2);
        }, [])();
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL505 = [_s, _hyphenMinus_2(_s0, _asterisk_2(_quotient, _s))];
          /* Statements */
          _s0 = _at_2(__SPL505, 1);
          return _s = _at_2(__SPL505, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          ...
          let __SPL506 = [_t, _hyphenMinus_2(_t0, _asterisk_2(_quotient, _t))];
          /* Statements */
          _t0 = _at_2(__SPL506, 1);
          return _t = _at_2(__SPL506, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :b | let __SPL501 = assertIsOfSize([a, b], 2); let r0 = at(__SPL501, 1); let r = at(__SPL501, 2); let __SPL502 = assertIsOfSize([1, 0], 2); let s0 = at(__SPL502, 1); let s = at(__SPL502, 2); let __SPL503 = assertIsOfSize([0, 1], 2); let t0 = at(__SPL503, 1); let t = at(__SPL503, 2); whileTrue({ ~=(r, 0) }, { let quotient = //(r0, r); ({ let __SPL504 = [r, -(r0, (*(quotient, r)))]; r0 := at(__SPL504, 1); r := at(__SPL504, 2) } . ()); ({ let __SPL505 = [s, -(s0, (*(quotient, s)))]; s0 := at(__SPL505, 1); s := at(__SPL505, 2) } . ()); ({ let __SPL506 = [t, -(t0, (*(quotient, t)))]; t0 := at(__SPL506, 1); t := at(__SPL506, 2) } . ()) }); if((<(r0, 0)), { [-(r0), -([s0, t0])] }, { [r0, [s0, t0]] }) }",
);
...
sl.addMethodToExistingTrait(
    ...
    _whileTrue_2(
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL507 = [_t1, _hyphenMinus_2(_t, _asterisk_2(_quotient, _t1))];
          /* Statements */
          _t = _at_2(__SPL507, 1);
          return _t1 = _at_2(__SPL507, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL508 = [_r1, _hyphenMinus_2(_r, _asterisk_2(_quotient, _r1))];
          /* Statements */
          _r = _at_2(__SPL508, 1);
          return _r1 = _at_2(__SPL508, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :n | let t = 0; let t1 = 1; let r = if((<(n, 0)), { negate(n) }, { n }); let r1 = if((<(a, 0)), { %((-(n, (%(negate(a), n)))), n) }, { %(a, n) }); whileTrue({ ~=(r1, 0) }, { let quotient = //(r, r1); ({ let __SPL507 = [t1, -(t, (*(quotient, t1)))]; t := at(__SPL507, 1); t1 := at(__SPL507, 2) } . ()); ({ let __SPL508 = [r1, -(r, (*(quotient, r1)))]; r := at(__SPL508, 1); r1 := at(__SPL508, 2) } . ()) }); if((>(r, 1)), { error('@Integer>>modularInverse: not invertible') }, { ifTrue((<(t, 0)), { t := +(t, n) }); ifTrue((<(n, 0)), { t := +(t, n) }); t }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_n, _p) {
    ...
    return _if_3(
      _tildeEqualsSign_2(_legendreSymbol_2(_n, _p), 1),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
              ...
              sl.annotateFunction(function () {
                ...
                return _ampersand_2(
                  ...
                  sl.annotateFunction(function () {
                    ...
                    return _tildeEqualsSign_2(_legendreSymbol_2(_z, _p), -1);
                  }, []),
                );
              }, []),
              sl.annotateFunction(function () {
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL509 = _assertIsOfSize_2(_self, 2);
    let _m = _at_2(__SPL509, 1);
    let _n = _at_2(__SPL509, 2);
    /* Statements */
    return _isAmicablePair_2(_m, _n);
  }, ["self"]),
  "{ :self | let __SPL509 = assertIsOfSize(self, 2); let m = at(__SPL509, 1); let n = at(__SPL509, 2); isAmicablePair(m, n) }",
);
