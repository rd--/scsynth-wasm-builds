...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_n, _letters) {
    ...
    let __SPL7 = _assertIsOfSize_2(_letters, 2);
  ...
  "{ :n :letters | let __SPL7 = assertIsOfSize(letters, 2); let a = at(__SPL7, 1); let b = at(__SPL7, 2); let f = { :x :i :n0 :n1 | let d0 = { f(++(x, [a]), +(i, 1), +(n0, 1), n1) }; let d1 = { f(++(x, [b]), +(i, 1), n0, +(n1, 1)) }; if((&&(&&((<(n0, n)), (<(n1, n))), (>(n0, n1)))), { ++(d0(), d1()) }, { if((||((&&(&&((<(n0, n)), (<(n1, n))), (=(n0, n1)))), (&&((<(n0, n)), (=(n1, n)))))), { d0() }, { if((&&((=(n0, n)), (<(n1, n)))), { d1() }, { if((&&((=(n0, n1)), (=(n1, n)))), { [x] }, { error(n,'Integer>>dyckWords') }) }) }) }) }; f([a], 1, 1, 0) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_a, _b) {
    ...
    let __SPL8 = _assertIsOfSize_2([_a, _b], 2);
    let _r0 = _at_2(__SPL8, 1);
    let _r = _at_2(__SPL8, 2);
    let __SPL9 = _assertIsOfSize_2([1, 0], 2);
    let _s0 = _at_2(__SPL9, 1);
    let _s = _at_2(__SPL9, 2);
    let __SPL10 = _assertIsOfSize_2([0, 1], 2);
    let _t0 = _at_2(__SPL10, 1);
    let _t = _at_2(__SPL10, 2);
    /* Statements */
    _whileTrue_2(
      sl.annotateFunction(function () {
        /* ArityCheck */
      ...
      sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          let __SPL11 = [_r, _hyphenMinus_2(_r0, _asterisk_2(_quotient, _r))];
          /* Statements */
          _r0 = _at_2(__SPL11, 1);
          return _r = _at_2(__SPL11, 2);
        }, [])();
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
          ...
          let __SPL12 = [_s, _hyphenMinus_2(_s0, _asterisk_2(_quotient, _s))];
          /* Statements */
          _s0 = _at_2(__SPL12, 1);
          return _s = _at_2(__SPL12, 2);
        }, [])();
        return (sl.annotateFunction(function () {
          ...
          let __SPL13 = [_t, _hyphenMinus_2(_t0, _asterisk_2(_quotient, _t))];
          /* Statements */
          _t0 = _at_2(__SPL13, 1);
          return _t = _at_2(__SPL13, 2);
        }, [])());
      }, []),
    );
    return _if_3(
  ...
  "{ :a :b | let __SPL8 = assertIsOfSize([a, b], 2); let r0 = at(__SPL8, 1); let r = at(__SPL8, 2); let __SPL9 = assertIsOfSize([1, 0], 2); let s0 = at(__SPL9, 1); let s = at(__SPL9, 2); let __SPL10 = assertIsOfSize([0, 1], 2); let t0 = at(__SPL10, 1); let t = at(__SPL10, 2); whileTrue({ !=(r, 0) }, { let quotient = //(r0, r); ({ let __SPL11 = [r, -(r0, (*(quotient, r)))]; r0 := at(__SPL11, 1); r := at(__SPL11, 2) } . ()); ({ let __SPL12 = [s, -(s0, (*(quotient, s)))]; s0 := at(__SPL12, 1); s := at(__SPL12, 2) } . ()); ({ let __SPL13 = [t, -(t0, (*(quotient, t)))]; t0 := at(__SPL13, 1); t := at(__SPL13, 2) } . ()) }); if((<(r0, 0)), { [-(r0), -([s0, t0])] }, { [r0, [s0, t0]] }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :limit | let answer = IdentitySet(); let step = { :n | ifTrue((<=(n, limit)), { ifFalse(includes(answer,n), { uncheckedInclude(answer,n); step(*(n, 2)); step(*(n, 3)); step(*(n, 5)) }) }) }; step(self); contents(asSortedList(answer)) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :a :n | let t = 0; let t1 = 1; let r = if((<(n, 0)), { negate(n) }, { n }); let r1 = if((<(a, 0)), { %((-(n, (%(negate(a), n)))), n) }, { %(a, n) }); whileTrue({ !=(r1, 0) }, { let quotient = //(r, r1); ({ let __SPL14 = [t1, -(t, (*(quotient, t1)))]; t := at(__SPL14, 1); t1 := at(__SPL14, 2) } . ()); ({ let __SPL15 = [r1, -(r, (*(quotient, r1)))]; r := at(__SPL15, 1); r1 := at(__SPL15, 2) } . ()) }); if((>(r, 1)), { error('@Integer>>modularInverse: not invertible') }, { ifTrue((<(t, 0)), { t := +(t, n) }); ifTrue((<(n, 0)), { t := +(t, n) }); t }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL16 = _assertIsOfSize_2(_self, 2);
    let _m = _at_2(__SPL16, 1);
    let _n = _at_2(__SPL16, 2);
    /* Statements */
    return _isAmicablePair_2(_m, _n);
  }, ["self"]),
  "{ :self | let __SPL16 = assertIsOfSize(self, 2); let m = at(__SPL16, 1); let n = at(__SPL16, 2); isAmicablePair(m, n) }",
);
