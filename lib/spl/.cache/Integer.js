...
sl.addTraitMethod(
  ...
  function (_a, _b) {
    ...
    /* Temporaries */
    let __genSym3 = _assertIsOfSize_2([_a, _b], 2),
      _r0 = _at_2(__genSym3, 1),
      _r = _at_2(__genSym3, 2);
    let __genSym4 = _assertIsOfSize_2([1, 0], 2),
      _s0 = _at_2(__genSym4, 1),
      _s = _at_2(__genSym4, 2);
    let __genSym5 = _assertIsOfSize_2([0, 1], 2),
      _t0 = _at_2(__genSym5, 1),
      _t = _at_2(__genSym5, 2);
    /* Statements */
    _whileTrue_2(function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
      ...
      /* List Assignment */ (function () {
        const __genSym6 = [_r, _hyphenMinus_2(_r0, _asterisk_2(_quotient, _r))];
        _r0 = _at_2(__genSym6, 1);
        _r = _at_2(__genSym6, 2);
      })(); /* List Assignment */
      (function () {
        const __genSym7 = [_s, _hyphenMinus_2(_s0, _asterisk_2(_quotient, _s))];
        _s0 = _at_2(__genSym7, 1);
        _s = _at_2(__genSym7, 2);
      })();
      return /* List Assignment */ (function () {
        const __genSym8 = [_t, _hyphenMinus_2(_t0, _asterisk_2(_quotient, _t))];
        _t0 = _at_2(__genSym8, 1);
        _t = _at_2(__genSym8, 2);
      })();
    });
    return [_r0, [_s0, _t0]];
  },
  ...
  function (_a, _n) {
    ...
    _whileTrue_2(function () {
      ...
      /* List Assignment */ (function () {
        ...
        _t = _at_2(__genSym9, 1);
        _t1 = _at_2(__genSym9, 2);
      })();
      return /* List Assignment */ (function () {
        const __genSym10 = [
          _r1,
