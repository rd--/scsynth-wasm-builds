...
sl.addMethodToExistingTrait(
  ...
  "{ :self :aList | valueWithReturn({ :return:/1 | powerSetDo(to(1,size(self)), { :each | ifFalse(isArithmeticProgression(each,1, =), { ifTrue((=(@*(self, each), aList)), { return(true) }) }) }); false }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self | if((<=(size(self), 1)), { true }, { isArithmeticProgression(self,-(second(self), first(self)), =) }) }",
);
