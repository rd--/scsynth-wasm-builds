...
sl.addTraitMethod(
  ...
  function (_self, _index) {
    ...
    /* Statements */
    return _at_2(_self, _foldBetweenAnd_3(_index, 1, _size_1(_self)));
  },
...
sl.addTraitMethod(
  ...
  function (_self, _random) {
    ...
    /* Statements */
    return _at_2(_self, _randomInteger_3(_random, 1, _size_1(_self)));
  },
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _atRandomBy_2(_self, _system);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _random) {
    ...
    /* Statements */
    _downToDo_3(_size_1(_self), 2, function (_item) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _item";
        console.error(errorMessage);
      ...
      /* Statements */
      return _swapWith_3(_self, _item, _randomInteger_3(_random, 1, _item));
    });
    return _self;
  },
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _fisherYatesShuffleBy_2(_self, _system);
  },
  ...
  function (_self) {
    ...
    _do_2(_self, function (_item) {
      ...
      return _if_3(_isCollection_1(_item), function () {
        ...
        /* Statements */
        return _addAll_2(_answer, _flattened_1(_item));
      }, function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addTraitMethod(
  ...
  function (_self, _startIndex, _endIndex, _anObject) {
    ...
    _if_3(_greaterThan_2(_startIndex, _endIndex), function () {
      ...
      _whileTrue_2(_lessThan_2(_written, _toWrite), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _random) {
    ...
    /* Statements */
    return _fisherYatesShuffleBy_2(_self, _random);
  },
