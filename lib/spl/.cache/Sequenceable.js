    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _equispacedTriplesDo_2(
        ...
        sl.annotateFunction(function (_i, _j, _k) {
          ...
          let __SplVar6 = _assertIsOfSize_2(_atAll_2(_self, [_i, _j, _k]), 3);
          let _p = _at_2(__SplVar6, 1);
          let _q = _at_2(__SplVar6, 2);
          let _r = _at_2(__SplVar6, 3);
          /* Statements */
          return _ifTrue_2(
            _aBlock_3(_p, _q, _r),
            sl.annotateFunction(function () {
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar7 = _assertIsOfSize_2(_cos_1(_self), 3);
    let _ca = _at_2(__SplVar7, 1);
    let _cb = _at_2(__SplVar7, 2);
    let _cc = _at_2(__SplVar7, 3);
    let __SplVar8 = _assertIsOfSize_2(_sin_1(_self), 3);
    let _sa = _at_2(__SplVar8, 1);
    let _sb = _at_2(__SplVar8, 2);
    let _sc = _at_2(__SplVar8, 3);
    /* Statements */
    return [[
      _hyphenMinus_2(
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _equalsSign_2(_self, _lexicographicallyLeastRotation_1(_self));
  }, ["self"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_x, _rOrW) {
    ...
    let _r = _at_2(__SplVar9, 1);
    let _w = _at_2(__SplVar9, 2);
    let _wSum = _sum_1(_w);
    /* Statements */
    _toDo_3(
      1,
        ...
        sl.annotateFunction(function () {
          ...
          return _do_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SplVar11 = _assertIsOfSize_2(_each, 2);
              let _i = _at_2(__SplVar11, 1);
              let _j = _at_2(__SplVar11, 2);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SplVar12 = _assertIsOfSize_2(_dimensions_2(_self, 2), 2);
