...
sl.addMethodToExistingTrait(
  ...
  "{ :u | let __SPL3 = assertIsOfSize(u, 2); let x = at(__SPL3, 1); let y = at(__SPL3, 2); [-(y), x] }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_u, _v) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL4 = _assertIsOfSize_2(_u, 2);
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL6 = _assertIsOfSize_2(_u, 3);
        let _ux = _at_2(__SPL6, 1);
        let _uy = _at_2(__SPL6, 2);
        let _uz = _at_2(__SPL6, 3);
        let __SPL7 = _assertIsOfSize_2(_v, 3);
        let _vx = _at_2(__SPL7, 1);
        let _vy = _at_2(__SPL7, 2);
        let _vz = _at_2(__SPL7, 3);
        /* Statements */
        return [
  ...
  "{ :u :v | let k = size(u); if((=(k, 2)), { let __SPL4 = assertIsOfSize(u, 2); let ux = at(__SPL4, 1); let uy = at(__SPL4, 2); let __SPL5 = assertIsOfSize(v, 2); let vx = at(__SPL5, 1); let vy = at(__SPL5, 2); -((*(ux, vy)), (*(uy, vx))) }, { let __SPL6 = assertIsOfSize(u, 3); let ux = at(__SPL6, 1); let uy = at(__SPL6, 2); let uz = at(__SPL6, 3); let __SPL7 = assertIsOfSize(v, 3); let vx = at(__SPL7, 1); let vy = at(__SPL7, 2); let vz = at(__SPL7, 3); [-((*(uy, vz)), (*(uz, vy))), -((*(uz, vx)), (*(ux, vz))), -((*(ux, vy)), (*(uy, vx)))] }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL8 = _assertIsOfSize_2(_cos_1(_self), 3);
    let _ca = _at_2(__SPL8, 1);
    let _cb = _at_2(__SPL8, 2);
    let _cc = _at_2(__SPL8, 3);
    let __SPL9 = _assertIsOfSize_2(_sin_1(_self), 3);
    let _sa = _at_2(__SPL9, 1);
    let _sb = _at_2(__SPL9, 2);
    let _sc = _at_2(__SPL9, 3);
    /* Statements */
    return [[
      _hyphenMinus_2(
  ...
  "{ :self | let __SPL8 = assertIsOfSize(cos(self), 3); let ca = at(__SPL8, 1); let cb = at(__SPL8, 2); let cc = at(__SPL8, 3); let __SPL9 = assertIsOfSize(sin(self), 3); let sa = at(__SPL9, 1); let sb = at(__SPL9, 2); let sc = at(__SPL9, 3); [[-((*(*(ca, cb), cc)), (*(sa, sc))), -(-(0, (*(cc, sa))), (*(*(ca, cb), sc))), *(ca, sb)], [+((*(*(cb, cc), sa)), (*(ca, sc))), -((*(ca, cc)), (*(*(cb, sa), sc))), *(sa, sb)], [-(0, (*(cc, sb))), *(sb, sc), cb]] }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :x :rOrW | let answer = []; let __SPL10 = assertIsOfSize(if(isList(rOrW), { [size(rOrW), rOrW] }, { [rOrW, #(1, rOrW)] }), 2); let r = at(__SPL10, 1); let w = at(__SPL10, 2); let wSum = sum(w); toDo(1, +(-(size(x), r), 1), { :i | let n = 0; toDo(1, r, { :j | n := +(n, (*(at(x, -(+(i, j), 1)), at(w, j)))) }); add(answer,/(n, wSum)) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _aList) {
    ...
    return _exclamationMarkEqualsSign_2(_compare_2(_self, _aList), 1);
  }, ["self", "aList"]),
  "{ :self :aList | !=(compare(self,aList), 1) }",
);
...
sl.addMethodToExistingTrait(
        ...
        sl.annotateFunction(function () {
          ...
          return _do_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL11 = _assertIsOfSize_2(_each, 2);
        ...
        sl.annotateFunction(function () {
          ...
          return _do_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL12 = _assertIsOfSize_2(_each, 2);
              let _i = _at_2(__SPL12, 1);
              let _j = _at_2(__SPL12, 2);
  ...
  "{ :self :indices | caseOf(rank(indices),[->(2, { do(indices, { :each | let __SPL11 = assertIsOfSize(each, 2); let i = at(__SPL11, 1); let j = at(__SPL11, 2); let x = at(self, i); atPut(self, i, at(self, j)); atPut(self, j, x) }) }), ->(3, { do(indices, { :each | let __SPL12 = assertIsOfSize(each, 2); let i = at(__SPL12, 1); let j = at(__SPL12, 2); let x = atPath(self,i); atPathPut(self,i, atPath(self,j)); atPathPut(self,j, x) }) })]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL13 = _assertIsOfSize_2(_dimensions_2(_self, 2), 2);
  ...
  "{ :self | let __SPL13 = assertIsOfSize(dimensions(self,2), 2); let m = at(__SPL13, 1); let n = at(__SPL13, 2); toAsCollect(1, n, species(at(self, 1)), { :index | collect(self, { :row | at(row, index) }) }) }",
);
