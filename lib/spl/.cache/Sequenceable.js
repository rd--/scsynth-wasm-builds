...
sl.addTraitMethod(
  ...
  "Sequenceable",
  "atAllUsing",
  ["self", "indexArray", "aBlock:/2"],
  function (_self, _indexArray, _aBlock_2) {
    /* ArityCheck */
    if (arguments.length !== 3) {
      const errorMessage = "Arity: expected 3, _self, _indexArray, _aBlock_2";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Temporaries */
    ...
    _indicesDo_2(_indexArray, function (_index) {
      ...
      return _atPut_3(
        _answer,
        _index,
        _aBlock_2(_self, _at_2(_indexArray, _index)),
      );
    });
    return _answer;
  },
...
sl.addTraitMethod(
  ...
  function (_self, _indexArray) {
    ...
    /* Statements */
    return _atAllUsing_3(_self, _indexArray, _at_2);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _indexArray) {
    ...
    /* Statements */
    return _atAllUsing_3(_self, _indexArray, _atFold_2);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _indexArray) {
    ...
    /* Statements */
    return _atAllUsing_3(_self, _indexArray, _atPin_2);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _indexArray) {
    ...
    /* Statements */
    return _atAllUsing_3(_self, _indexArray, _atWrap_2);
  },
...
sl.addTraitMethod(
  ...
  function (_self, _count, _aBlock_2) {
    ...
    return _ifEmpty_3(_self, function () {
      ...
      /* Statements */
      _upTo_3(2, _size_1(_self), function (_index) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _index";
          console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self, _count, _aBlock_2) {
    ...
    return _ifEmpty_3(_self, function () {
      ...
      /* Statements */
      _toByDo_4(_minus_2(_count, 1), 1, -1, function (_index) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _index";
          console.error(errorMessage);
...
sl.addTraitMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _median_1(_asSortedArray_1(_self));
  },
...
sl.addTraitMethod(
  ...
  function (_self, _counts, _aBlock_1) {
    ...
    /* Statements */
    return _if_3(_tildeEquals_2(_size_1(_self), _size_1(_counts)), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        console.error(errorMessage);
