...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_u) {
    ...
    let __SPL61 = _assertIsOfSize_2(_u, 2);
    let _x = _at_2(__SPL61, 1);
    let _y = _at_2(__SPL61, 2);
    /* Statements */
    return [_hyphenMinus_1(_y), _x];
  }, ["u"]),
  "{ :u | let __SPL61 = assertIsOfSize(u, 2); let x = at(__SPL61, 1); let y = at(__SPL61, 2); [-(y), x] }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_u, _v) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL62 = _assertIsOfSize_2(_u, 2);
        let _ux = _at_2(__SPL62, 1);
        let _uy = _at_2(__SPL62, 2);
        let __SPL63 = _assertIsOfSize_2(_v, 2);
        let _vx = _at_2(__SPL63, 1);
        let _vy = _at_2(__SPL63, 2);
        /* Statements */
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL64 = _assertIsOfSize_2(_u, 3);
        let _ux = _at_2(__SPL64, 1);
        let _uy = _at_2(__SPL64, 2);
        let _uz = _at_2(__SPL64, 3);
        let __SPL65 = _assertIsOfSize_2(_v, 3);
        let _vx = _at_2(__SPL65, 1);
        let _vy = _at_2(__SPL65, 2);
        let _vz = _at_2(__SPL65, 3);
        /* Statements */
        return [
  ...
  "{ :u :v | let k = size(u); if((=(k, 2)), { let __SPL62 = assertIsOfSize(u, 2); let ux = at(__SPL62, 1); let uy = at(__SPL62, 2); let __SPL63 = assertIsOfSize(v, 2); let vx = at(__SPL63, 1); let vy = at(__SPL63, 2); -((*(ux, vy)), (*(uy, vx))) }, { let __SPL64 = assertIsOfSize(u, 3); let ux = at(__SPL64, 1); let uy = at(__SPL64, 2); let uz = at(__SPL64, 3); let __SPL65 = assertIsOfSize(v, 3); let vx = at(__SPL65, 1); let vy = at(__SPL65, 2); let vz = at(__SPL65, 3); [-((*(uy, vz)), (*(uz, vy))), -((*(uz, vx)), (*(ux, vz))), -((*(ux, vy)), (*(uy, vx)))] }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL66 = _assertIsOfSize_2(_cos_1(_self), 3);
    let _ca = _at_2(__SPL66, 1);
    let _cb = _at_2(__SPL66, 2);
    let _cc = _at_2(__SPL66, 3);
    let __SPL67 = _assertIsOfSize_2(_sin_1(_self), 3);
    let _sa = _at_2(__SPL67, 1);
    let _sb = _at_2(__SPL67, 2);
    let _sc = _at_2(__SPL67, 3);
    /* Statements */
    return [[
      _hyphenMinus_2(
  ...
  "{ :self | let __SPL66 = assertIsOfSize(cos(self), 3); let ca = at(__SPL66, 1); let cb = at(__SPL66, 2); let cc = at(__SPL66, 3); let __SPL67 = assertIsOfSize(sin(self), 3); let sa = at(__SPL67, 1); let sb = at(__SPL67, 2); let sc = at(__SPL67, 3); [[-((*(*(ca, cb), cc)), (*(sa, sc))), -(-(0, (*(cc, sa))), (*(*(ca, cb), sc))), *(ca, sb)], [+((*(*(cb, cc), sa)), (*(ca, sc))), -((*(ca, cc)), (*(*(cb, sa), sc))), *(sa, sb)], [-(0, (*(cc, sb))), *(sb, sc), cb]] }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_x, _rOrW) {
    ...
    let _r = _at_2(__SPL68, 1);
    let _w = _at_2(__SPL68, 2);
    let _wSum = _sum_1(_w);
    /* Statements */
    _toDo_3(
      1,
  ...
  "{ :x :rOrW | let answer = []; let __SPL68 = assertIsOfSize(if(isList(rOrW), { [size(rOrW), rOrW] }, { [rOrW, #(1, rOrW)] }), 2); let r = at(__SPL68, 1); let w = at(__SPL68, 2); let wSum = sum(w); toDo(1, +(-(size(x), r), 1), { :i | let n = 0; toDo(1, r, { :j | n := +(n, (*(at(x, -(+(i, j), 1)), at(w, j)))) }); add(answer,/(n, wSum)) }); answer }",
);
...
sl.addMethodToExistingTrait(
        ...
        sl.annotateFunction(function () {
          ...
          return _do_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL69 = _assertIsOfSize_2(_each, 2);
              let _i = _at_2(__SPL69, 1);
              let _j = _at_2(__SPL69, 2);
        ...
        sl.annotateFunction(function () {
          ...
          return _do_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL70 = _assertIsOfSize_2(_each, 2);
              let _i = _at_2(__SPL70, 1);
              let _j = _at_2(__SPL70, 2);
  ...
  "{ :self :indices | caseOf(rank(indices),[->(2, { do(indices, { :each | let __SPL69 = assertIsOfSize(each, 2); let i = at(__SPL69, 1); let j = at(__SPL69, 2); let x = at(self, i); atPut(self, i, at(self, j)); atPut(self, j, x) }) }), ->(3, { do(indices, { :each | let __SPL70 = assertIsOfSize(each, 2); let i = at(__SPL70, 1); let j = at(__SPL70, 2); let x = atPath(self,i); atPathPut(self,i, atPath(self,j)); atPathPut(self,j, x) }) })]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL71 = _assertIsOfSize_2(_dimensions_2(_self, 2), 2);
    let _m = _at_2(__SPL71, 1);
    let _n = _at_2(__SPL71, 2);
    /* Statements */
    return _toAsCollect_4(
      1,
      _n,
  ...
  "{ :self | let __SPL71 = assertIsOfSize(dimensions(self,2), 2); let m = at(__SPL71, 1); let n = at(__SPL71, 2); toAsCollect(1, n, species(at(self, 1)), { :index | collect(self, { :row | at(row, index) }) }) }",
);
