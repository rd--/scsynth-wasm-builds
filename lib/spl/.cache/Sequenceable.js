...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _indexList) {
    ...
    return _atAllUsing_3(_self, _indexList, _atNil_2);
  }, ["self", "indexList"]),
  "{ :self :indexList | atAllUsing(self,indexList, atNil:/2) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_u, _v) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL2 = _assertIsOfSize_2(_u, 2);
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL4 = _assertIsOfSize_2(_u, 3);
        let _ux = _at_2(__SPL4, 1);
        let _uy = _at_2(__SPL4, 2);
        let _uz = _at_2(__SPL4, 3);
        let __SPL5 = _assertIsOfSize_2(_v, 3);
        let _vx = _at_2(__SPL5, 1);
        let _vy = _at_2(__SPL5, 2);
        let _vz = _at_2(__SPL5, 3);
        /* Statements */
        return [
  ...
  "{ :u :v | let k = size(u); if((=(k, 2)), { let __SPL2 = assertIsOfSize(u, 2); let ux = at(__SPL2, 1); let uy = at(__SPL2, 2); let __SPL3 = assertIsOfSize(v, 2); let vx = at(__SPL3, 1); let vy = at(__SPL3, 2); -((*(ux, vy)), (*(uy, vx))) }, { let __SPL4 = assertIsOfSize(u, 3); let ux = at(__SPL4, 1); let uy = at(__SPL4, 2); let uz = at(__SPL4, 3); let __SPL5 = assertIsOfSize(v, 3); let vx = at(__SPL5, 1); let vy = at(__SPL5, 2); let vz = at(__SPL5, 3); [-((*(uy, vz)), (*(uz, vy))), -((*(uz, vx)), (*(ux, vz))), -((*(ux, vy)), (*(uy, vx)))] }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_y, _h) {
    ...
    _addFirst_2(_a, _lhs);
    _addLast_2(_a, _rhs);
    return _solidus_2(_a, _asterisk_2(4, _squared_1(_h)));
  }, ["y", "h"]),
  "{ :y :h | let a = differences(y,2); let n = size(a); let lhs = +(at(a, 1), (-(at(a, 1), at(a, 2)))); let rhs = +(at(a, n), (-(at(a, n), at(a, -(n, 1))))); addFirst(a,lhs); addLast(a,rhs); /(a, (*(4, squared(h)))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL6 = _assertIsOfSize_2(_cos_1(_self), 3);
    let _ca = _at_2(__SPL6, 1);
    let _cb = _at_2(__SPL6, 2);
    let _cc = _at_2(__SPL6, 3);
    let __SPL7 = _assertIsOfSize_2(_sin_1(_self), 3);
    let _sa = _at_2(__SPL7, 1);
    let _sb = _at_2(__SPL7, 2);
    let _sc = _at_2(__SPL7, 3);
    /* Statements */
    return [[
      _hyphenMinus_2(
  ...
  "{ :self | let __SPL6 = assertIsOfSize(cos(self), 3); let ca = at(__SPL6, 1); let cb = at(__SPL6, 2); let cc = at(__SPL6, 3); let __SPL7 = assertIsOfSize(sin(self), 3); let sa = at(__SPL7, 1); let sb = at(__SPL7, 2); let sc = at(__SPL7, 3); [[-((*(*(ca, cb), cc)), (*(sa, sc))), -(-(0, (*(cc, sa))), (*(*(ca, cb), sc))), *(ca, sb)], [+((*(*(cb, cc), sa)), (*(ca, sc))), -((*(ca, cc)), (*(*(cb, sa), sc))), *(sa, sb)], [-(0, (*(cc, sb))), *(sb, sc), cb]] }",
);
...
sl.addMethodToExistingTrait(
      ...
      sl.annotateFunction(function () {
        ...
        return _allSatisfy_2(
          ...
          sl.annotateFunction(function (_i) {
            ...
            let _x = _lessThanSignEqualsSignGreaterThanSign_2(
              _at_2(_self, _hyphenMinus_2(_i, 1)),
              _at_2(_self, _i),
            );
  ...
  "{ :self :z | let k = size(self); if((<(k, 2)), { false }, { ifFalse(includes([-1, 1],z), { error(self,'isAlternating: invalid z') }); allSatisfy(upOrDownTo(2, k), { :i | let x = <=>(at(self, -(i, 1)), at(self, i)); let r = =((-(0, x)), z); z := x; r }) }) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :x :rOrW | let answer = []; let __SPL8 = assertIsOfSize(if(isList(rOrW), { [size(rOrW), rOrW] }, { [rOrW, #(1, rOrW)] }), 2); let r = at(__SPL8, 1); let w = at(__SPL8, 2); let wSum = sum(w); toDo(1, +(-(size(x), r), 1), { :i | let n = 0; toDo(1, r, { :j | n := +(n, (*(at(x, -(+(i, j), 1)), at(w, j)))) }); add(answer,/(n, wSum)) }); answer }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _sqrt_1(_dotProduct_2(_self, _conjugated_1(_self)));
  }, ["self"]),
  "{ :self | sqrt((dotProduct(self,conjugated(self)))) }",
);
...
sl.addMethodToExistingTrait(
  ...
  "{ :self :anObject | if((<(size(self), 2)), { self }, { if(isSequenceable(anObject), { let k = size(self); if((>=(size(anObject), k)), { error(self,'riffle: too many items to insert') }, { let answer = []; toDo(1, -(k, 1), { :i | add(answer,at(self, i)); add(answer,atWrap(anObject,i)) }); add(answer,last(self)); answer }) }, { intersperse(self,anObject) }) }) }",
);
...
sl.addMethodToExistingTrait(
        ...
        sl.annotateFunction(function () {
          ...
          return _do_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL9 = _assertIsOfSize_2(_each, 2);
              let _i = _at_2(__SPL9, 1);
              let _j = _at_2(__SPL9, 2);
        ...
        sl.annotateFunction(function () {
          ...
          return _do_2(
            ...
            sl.annotateFunction(function (_each) {
              ...
              let __SPL10 = _assertIsOfSize_2(_each, 2);
              let _i = _at_2(__SPL10, 1);
              let _j = _at_2(__SPL10, 2);
  ...
  "{ :self :indices | caseOf(rank(indices),[->(2, { do(indices, { :each | let __SPL9 = assertIsOfSize(each, 2); let i = at(__SPL9, 1); let j = at(__SPL9, 2); let x = at(self, i); atPut(self, i, at(self, j)); atPut(self, j, x) }) }), ->(3, { do(indices, { :each | let __SPL10 = assertIsOfSize(each, 2); let i = at(__SPL10, 1); let j = at(__SPL10, 2); let x = atPath(self,i); atPathPut(self,i, atPath(self,j)); atPathPut(self,j, x) }) })]) }",
);
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL11 = _assertIsOfSize_2(_dimensions_2(_self, 2), 2);
  ...
  "{ :self | let __SPL11 = assertIsOfSize(dimensions(self,2), 2); let m = at(__SPL11, 1); let n = at(__SPL11, 2); toAsCollect(1, n, species(at(self, 1)), { :index | collect(self, { :row | at(row, index) }) }) }",
);
