...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _collect_2(
      _toBy_3(1, _hyphenMinus_2(_size_1(_self), 1), 2),
  ...
  sl.annotateFunction(function (_u, _v) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _error_1("listConvolve: invalid vector");
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
            ...
            _toDo_3(
              ...
              sl.annotateFunction(function (_j) {
                ...
                return _x = _plusSign_2(
                  _x,
                  _asterisk_2(
                    _at_2(_v, _hyphenMinus_2(_plusSign_2(_i, _m), _j)),
                    _at_2(_u, _j),
                  ),
                );
              }, ["j"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_u, _v) {
    ...
    return _listConvolve_2(_reverse_1(_u), _v);
  }, ["u", "v"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let _d = _collect_2(_to_2(0, _hyphenMinus_2(_n, 1)), _dirichletKernel_1);
    /* Statements */
    return sl.annotateFunction(function (_x) {
      /* ArityCheck */
      if (arguments.length !== 1) {
  ...
  sl.annotateFunction(function (_n, _d) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _solidus_2(
          _plusSignPlusSign_2(
            _asList_1(_nonemptyRange_3(0, _hyphenMinus_2(_m, 1), 1)),
            _asList_1(_nonemptyRange_3(_hyphenMinus_2(0, _m), -1, 1)),
          ),
          _asterisk_2(_d, _n),
        );
      }, []),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n) {
    ...
    let _l = _to_2(0, _hyphenMinus_2(_n, 1));
    /* Statements */
    return _table_3(
