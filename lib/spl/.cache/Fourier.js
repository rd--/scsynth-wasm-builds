...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n, _p) {
    ...
    let __SPL406 = _assertIsOfSize_2(_p, 2);
    let _a = _at_2(__SPL406, 1);
    let _b = _at_2(__SPL406, 2);
    let _m = _solidus_2(
      1,
  ...
  "{ :n :p | let __SPL406 = assertIsOfSize(p, 2); let a = at(__SPL406, 1); let b = at(__SPL406, 2); let m = /(1, (^(n, (/((-(1, a)), 2))))); let v = /(*(asList(upOrDownTo(0, -(n, 1))), (*(i(pi(2)), b))), n); *(vandermondeMatrix(exp(v)), m) }",
);
