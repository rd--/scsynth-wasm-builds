...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n, _p) {
    ...
    let __SPL2 = _assertIsOfSize_2(_p, 2);
  ...
  "{ :n :p | let __SPL2 = assertIsOfSize(p, 2); let a = at(__SPL2, 1); let b = at(__SPL2, 2); let m = /(1, (^(n, (/((-(1, a)), 2))))); let v = /(*(asList(upOrDownTo(0, -(n, 1))), (*(i(pi(2)), b))), n); *(vandermondeMatrix(exp(v)), m) }",
);
