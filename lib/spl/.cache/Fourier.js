...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let n = size(self); let m = //(n, 2); ++(copyFromTo(self,+(m, 1), n), copyFromTo(self,1, m)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _solidus_2(_absSquared_1(_fft_1(_self)), _size_1(_self));
  }, ["self"]),
  "{ :self | /(absSquared(fft(self)), size(self)) }",
);
    ...
    return _average_1(
      _collect_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          return _solidus_2(_absSquared_1(_fft_1(_each)), _n);
        }, ["each"]),
      ),
    );
  }, ["self", "n"]),
  "{ :self :n | average(collect(partition(self,n), { :each | /(absSquared(fft(each)), n) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :n :d | average(collect(partition(self,n, d), { :each | /(absSquared(fft(each)), n) })) }",
);
    ...
    return _average_1(
      _collect_2(
        ...
        sl.annotateFunction(function (_each) {
          ...
          return _absSquared_1(_fft_1(_asterisk_2(_each, _wN)));
        }, ["each"]),
      ),
    );
  }, ["self", "n", "d", "w"]),
  "{ :self :n :d :w | let wN = normalize(w); average(collect(partition(self,n, d), { :each | absSquared(fft((*(each, wN)))) })) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_n, _p) {
    ...
    let __SPL1 = _assertIsOfSize_2(_p, 2);
  ...
  "{ :n :p | let __SPL1 = assertIsOfSize(p, 2); let a = at(__SPL1, 1); let b = at(__SPL1, 2); let m = /(1, (^(n, (/((-(1, a)), 2))))); let v = /(*(asList(upOrDownTo(0, -(n, 1))), (*(i(pi(2)), b))), n); *(vandermondeMatrix(exp(v)), m) }",
);
...
sl.extendTypeOrTraitWithMethod(
          ...
          return _if_3(
            ...
            sl.annotateFunction(function () {
              ...
              return _solidus_2(
                ...
                _asterisk_2(_squared_1(_pi_1(1)), _squared_1(_x)),
              );
            }, []),
            sl.annotateFunction(function () {
              /* ArityCheck */
  ...
  "{ :a | { :x | if((=(x, 0)), { 1 }, { if(betweenAnd(x,-(a), a), { /((*(*(a, sin(pi(x))), sin((/(pi(x), a))))), (*(squared(pi(1)), squared(x)))) }, { 0 }) }) } }",
);
