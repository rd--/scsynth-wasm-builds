...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n :p | let __SplVar1 = assertIsOfSize(p, 2); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); let m = /(1, (^(n, (/((-(1, a)), 2))))); let v = /(*(asList(upOrDownTo(0, -(n, 1))), (*(i(pi(2)), b))), n); *(vandermondeMatrix(exp(v)), m) }",
);
