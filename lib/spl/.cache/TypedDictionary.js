...
sl.addMethodToExistingType(
  ...
  "{ :self :key | at(contents(self),typeCheckKey(self,key)) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :key :value | atPut(contents(self),typeCheckKey(self,key), value) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :aBlock:/2 | keysAndValuesDo(contents(self),aBlock:/2) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self :key | if((=(typeOf(key), keyType(self))), { key }, { error(self,'invalid key', key) }) }",
);
...
sl.addMethodToExistingType(
  ...
  "{ :self | format('%.asTypedDictionary(%)',[associations(contents(self)), storeString(keyType(self))]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let contents = which([->({ =(self, 'String') }, { Record() }), ->({ isImmediateType(self) }, { Map() }), ->({ true }, { Dictionary() })]); initializeSlots(newTypedDictionary(),contents, self) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :typeName | let answer = TypedDictionary(typeName); addAll(answer,self); answer }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | asTypedDictionary(self,keyType(self)) }",
);
