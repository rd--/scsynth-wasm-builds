...
sl.addMethod(
  ...
  function (_self) {
    ...
    let __genSym1 = _assertIsOfSize_2(_terms_1(_self), 4),
  ...
  function (_self) {
    ...
    return _if_3(_equalsSign_2(_size_1(_self), 4), function () {
      ...
      return _if_3(_equalsSign_2(_size_1(_self), 3), function () {
        ...
        let __genSym3 = _assertIsOfSize_2(_self, 3),
          _p1 = _at_2(__genSym3, 1),
          _p2 = _at_2(__genSym3, 2),
          _p3 = _at_2(__genSym3, 3);
        /* Statements */
...
sl.extendTraitWithMethod(
  ...
  function (_p1, _p2, _p3) {
    ...
    let __genSym4 = _assertIsOfSize_2(_p1, 3),
      _x1 = _at_2(__genSym4, 1),
      _y1 = _at_2(__genSym4, 2),
      _z1 = _at_2(__genSym4, 3);
    let __genSym5 = _assertIsOfSize_2(_p2, 3),
      _x2 = _at_2(__genSym5, 1),
      _y2 = _at_2(__genSym5, 2),
      _z2 = _at_2(__genSym5, 3);
    let __genSym6 = _assertIsOfSize_2(_p3, 3),
      _x3 = _at_2(__genSym6, 1),
      _y3 = _at_2(__genSym6, 2),
      _z3 = _at_2(__genSym6, 3);
    let _a = _plusSign_2(
      _plusSign_2(
    ...
    _ifTrue_2(_allSatisfy_2([_a, _b, _c], _isInteger_1), function () {
      ...
      return /* List Assignment */ (function () {
        const __genSym7 = _solidus_2([_a, _b, _c, _d], _z);
    ...
    _ifTrue_2(_allSatisfy_2([_a, _b, _c], _isNonPositive_1), function () {
      ...
      return /* List Assignment */ (function () {
        const __genSym8 = _negated_1([_a, _b, _c, _d]);
...
sl.extendTraitWithMethod(
  ...
  function (_plane, _point) {
    ...
    let __genSym9 = _assertIsOfSize_2(_plane, 4),
      _a = _at_2(__genSym9, 1),
      _b = _at_2(__genSym9, 2),
      _c = _at_2(__genSym9, 3),
      _d = _at_2(__genSym9, 4);
    let __genSym10 = _assertIsOfSize_2(_point, 3),
