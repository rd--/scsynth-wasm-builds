...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :plane :point | let __SplVar1 = assertIsOfSize(plane, 4); let a = at(__SplVar1, 1); let b = at(__SplVar1, 2); let c = at(__SplVar1, 3); let d = at(__SplVar1, 4); let __SplVar2 = assertIsOfSize(point, 3); let x = at(__SplVar2, 1); let y = at(__SplVar2, 2); let z = at(__SplVar2, 3); /((+(+(+((*(a, x)), (*(b, y))), (*(c, z))), d)), sqrt((+(+((*(a, a)), (*(b, b))), (*(c, c)))))) }",
);
