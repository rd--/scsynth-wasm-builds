...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let __genSym25 = _assertIsOfSize_2(_terms_1(_self), 4),
      _a = _at_2(__genSym25, 1),
      _b = _at_2(__genSym25, 2),
      _c = _at_2(__genSym25, 3),
      _d = _at_2(__genSym25, 4);
    let _z = _sqrt_1(
      _plusSign_2(
...
sl.extendTraitWithMethod(
  ...
  function (_p1, _p2, _p3) {
    ...
    /* Temporaries */
    let __genSym28 = _assertIsOfSize_2(_p1, 3),
      _x1 = _at_2(__genSym28, 1),
      _y1 = _at_2(__genSym28, 2),
      _z1 = _at_2(__genSym28, 3);
    let __genSym29 = _assertIsOfSize_2(_p2, 3),
      _x2 = _at_2(__genSym29, 1),
      _y2 = _at_2(__genSym29, 2),
      _z2 = _at_2(__genSym29, 3);
    let __genSym30 = _assertIsOfSize_2(_p3, 3),
      _x3 = _at_2(__genSym30, 1),
      _y3 = _at_2(__genSym30, 2),
      _z3 = _at_2(__genSym30, 3);
    let _a = _plusSign_2(
      _plusSign_2(
    ...
    _ifTrue_2(_allSatisfy_2([_a, _b, _c], _isInteger_1), function () {
      ...
      return /* List Assignment */ (function () {
        const __genSym31 = _solidus_2([_a, _b, _c, _d], _z);
        _a = _at_2(__genSym31, 1);
        _b = _at_2(__genSym31, 2);
        _c = _at_2(__genSym31, 3);
        _d = _at_2(__genSym31, 4);
      })();
    });
    _ifTrue_2(_allSatisfy_2([_a, _b, _c], _isNonPositive_1), function () {
      ...
      /* Statements */
      return /* List Assignment */ (function () {
        const __genSym32 = _negated_1([_a, _b, _c, _d]);
