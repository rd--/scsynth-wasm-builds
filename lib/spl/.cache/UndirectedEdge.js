...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL2 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL2, 1); let j = at(__SPL2, 2); DirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _isMixed) {
    ...
    let _i = _at_2(__SPL3, 1);
    let _j = _at_2(__SPL3, 2);
    /* Statements */
    return _if_3(
      _isMixed,
      sl.annotateFunction(function () {
  ...
  "{ :self :isMixed | let __SPL3 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL3, 1); let j = at(__SPL3, 2); if(isMixed, { format('% -> % [dir=none];',[i, j]) }, { format('% -- %;',[i, j]) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL5 = assertIsOfSize(self, 2); let i = at(__SPL5, 1); let j = at(__SPL5, 2); UndirectedEdge(i, j) }",
);
