...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    let __SPL46 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL46, 1);
    let _j = _at_2(__SPL46, 2);
    /* Statements */
    return _DirectedEdge_2(_i, _j);
  },
  "{ :self | let __SPL46 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL46, 1); let j = at(__SPL46, 2); DirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  function (_self, _isMixed) {
    ...
    let __SPL47 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL47, 1);
    let _j = _at_2(__SPL47, 2);
    /* Statements */
  ...
  "{ :self :isMixed | let __SPL47 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL47, 1); let j = at(__SPL47, 2); if(isMixed, { format('% -> % [dir=none];',[i, j]) }, { format('% -- %;',[i, j]) }) }",
);
...
sl.addMethodToExistingType(
  ...
  function (_self) {
    ...
    let __SPL48 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL48, 1);
    let _j = _at_2(__SPL48, 2);
    /* Statements */
    return _format_2("% --- %", [_i, _j]);
  },
  "{ :self | let __SPL48 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL48, 1); let j = at(__SPL48, 2); format('% --- %',[i, j]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self) {
    ...
    let __SPL49 = _assertIsOfSize_2(_self, 2);
    let _i = _at_2(__SPL49, 1);
    let _j = _at_2(__SPL49, 2);
    /* Statements */
    return _UndirectedEdge_2(_i, _j);
  },
  "{ :self | let __SPL49 = assertIsOfSize(self, 2); let i = at(__SPL49, 1); let j = at(__SPL49, 2); UndirectedEdge(i, j) }",
);
