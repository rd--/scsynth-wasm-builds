...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL5 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL5, 1);
    let _j = _at_2(__SPL5, 2);
    /* Statements */
    return _DirectedEdge_2(_i, _j);
  }, ["self"]),
  "{ :self | let __SPL5 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL5, 1); let j = at(__SPL5, 2); DirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _isMixed) {
    ...
    let __SPL6 = _assertIsOfSize_2(_vertexList_1(_self), 2);
  ...
  "{ :self :isMixed | let __SPL6 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL6, 1); let j = at(__SPL6, 2); if(isMixed, { format('% -> % [dir=none];',[i, j]) }, { format('% -- %;',[i, j]) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL7 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL7, 1);
    let _j = _at_2(__SPL7, 2);
    /* Statements */
    return _format_2("% --- %", [_i, _j]);
  }, ["self"]),
  "{ :self | let __SPL7 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL7, 1); let j = at(__SPL7, 2); format('% --- %',[i, j]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SPL8 = assertIsOfSize(self, 2); let i = at(__SPL8, 1); let j = at(__SPL8, 2); UndirectedEdge(i, j) }",
);
