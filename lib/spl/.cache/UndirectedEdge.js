...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL78 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL78, 1);
    let _j = _at_2(__SPL78, 2);
    /* Statements */
    return _DirectedEdge_2(_i, _j);
  }, ["self"]),
  "{ :self | let __SPL78 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL78, 1); let j = at(__SPL78, 2); DirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _isMixed) {
    ...
    let __SPL79 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL79, 1);
    let _j = _at_2(__SPL79, 2);
    /* Statements */
    return _if_3(
      _isMixed,
      sl.annotateFunction(function () {
  ...
  "{ :self :isMixed | let __SPL79 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL79, 1); let j = at(__SPL79, 2); if(isMixed, { format('% -> % [dir=none];',[i, j]) }, { format('% -- %;',[i, j]) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL80 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL80, 1);
    let _j = _at_2(__SPL80, 2);
    /* Statements */
    return _format_2("% --- %", [_i, _j]);
  }, ["self"]),
  "{ :self | let __SPL80 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL80, 1); let j = at(__SPL80, 2); format('% --- %',[i, j]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL81 = _assertIsOfSize_2(_self, 2);
    let _i = _at_2(__SPL81, 1);
    let _j = _at_2(__SPL81, 2);
    /* Statements */
    return _UndirectedEdge_2(_i, _j);
  }, ["self"]),
  "{ :self | let __SPL81 = assertIsOfSize(self, 2); let i = at(__SPL81, 1); let j = at(__SPL81, 2); UndirectedEdge(i, j) }",
);
