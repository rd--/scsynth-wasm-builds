...
sl.addMethodToExistingType(
  ...
  "{ :self | let __SPL80 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL80, 1); let j = at(__SPL80, 2); DirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _isMixed) {
    ...
    let __SPL81 = _assertIsOfSize_2(_vertexList_1(_self), 2);
  ...
  "{ :self :isMixed | let __SPL81 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL81, 1); let j = at(__SPL81, 2); if(isMixed, { format('% -> % [dir=none];',[i, j]) }, { format('% -- %;',[i, j]) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL82 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL82, 1);
    let _j = _at_2(__SPL82, 2);
    /* Statements */
    return _format_2("% --- %", [_i, _j]);
  }, ["self"]),
  "{ :self | let __SPL82 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL82, 1); let j = at(__SPL82, 2); format('% --- %',[i, j]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL83 = _assertIsOfSize_2(_self, 2);
    let _i = _at_2(__SPL83, 1);
    let _j = _at_2(__SPL83, 2);
    /* Statements */
    return _UndirectedEdge_2(_i, _j);
  }, ["self"]),
  "{ :self | let __SPL83 = assertIsOfSize(self, 2); let i = at(__SPL83, 1); let j = at(__SPL83, 2); UndirectedEdge(i, j) }",
);
