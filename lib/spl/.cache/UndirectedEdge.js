...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL83 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL83, 1);
    let _j = _at_2(__SPL83, 2);
    /* Statements */
    return _DirectedEdge_2(_i, _j);
  }, ["self"]),
  "{ :self | let __SPL83 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL83, 1); let j = at(__SPL83, 2); DirectedEdge(i, j) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _isMixed) {
    ...
    let __SPL84 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL84, 1);
    let _j = _at_2(__SPL84, 2);
    /* Statements */
    return _if_3(
      _isMixed,
      sl.annotateFunction(function () {
  ...
  "{ :self :isMixed | let __SPL84 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL84, 1); let j = at(__SPL84, 2); if(isMixed, { format('% -> % [dir=none];',[i, j]) }, { format('% -- %;',[i, j]) }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL85 = _assertIsOfSize_2(_vertexList_1(_self), 2);
    let _i = _at_2(__SPL85, 1);
    let _j = _at_2(__SPL85, 2);
    /* Statements */
    return _format_2("% --- %", [_i, _j]);
  }, ["self"]),
  "{ :self | let __SPL85 = assertIsOfSize(vertexList(self), 2); let i = at(__SPL85, 1); let j = at(__SPL85, 2); format('% --- %',[i, j]) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL86 = _assertIsOfSize_2(_self, 2);
    let _i = _at_2(__SPL86, 1);
    let _j = _at_2(__SPL86, 2);
    /* Statements */
    return _UndirectedEdge_2(_i, _j);
  }, ["self"]),
  "{ :self | let __SPL86 = assertIsOfSize(self, 2); let i = at(__SPL86, 1); let j = at(__SPL86, 2); UndirectedEdge(i, j) }",
);
