...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    /* Statements */
    return _if_3(
      _greaterThanSign_2(_abs_1(_n), 0.5),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
      ...
      sl.annotateFunction(function () {
        ...
        return _plusSign_2(
          _plusSign_2(
            _plusSign_2(
              _a0,
              _asterisk_2(_a1, _cos_1(_asterisk_2(_pi_1(2), _n))),
            ),
            _asterisk_2(_a2, _cos_1(_asterisk_2(_pi_1(4), _n))),
          ),
          _asterisk_2(_a3, _cos_1(_asterisk_2(_pi_1(6), _n))),
        );
      }, []),
    );
  }, ["self"]),
  "{ :self | let n = self; if((>(abs(n), 0.5)), { 0 }, { let a0 = 0.35875; let a1 = 0.48829; let a2 = 0.14128; let a3 = 0.01168; +(+(+(a0, (*(a1, cos((*(pi(2), n)))))), (*(a2, cos((*(pi(4), n)))))), (*(a3, cos((*(pi(6), n)))))) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
    ...
    return _which_1([
      ...
      _hyphenMinusGreaterThanSign_2(
        ...
        sl.annotateFunction(function () {
          ...
          return _asterisk_2(
            -2,
            _cubed_1(_hyphenMinus_2(_asterisk_2(2, _x), 1)),
          );
        }, []),
      ),
      _hyphenMinusGreaterThanSign_2(
        ...
        sl.annotateFunction(function () {
          ...
          return _asterisk_2(2, _cubed_1(_plusSign_2(_asterisk_2(2, _x), 1)));
        }, []),
      ),
      _hyphenMinusGreaterThanSign_2(
        sl.annotateFunction(function () {
        ...
        sl.annotateFunction(function () {
          ...
          return _plusSign_2(
            _hyphenMinus_2(
              _hyphenMinus_2(0, _asterisk_2(48, _cubed_1(_x))),
              _asterisk_2(24, _squared_1(_x)),
            ),
            1,
          );
        }, []),
  ...
  "{ :x | which([->({ >(abs(x), 0.5) }, { 0 }), ->({ between(x,--(0.25, 0.5)) }, { *(-2, cubed((-((*(2, x)), 1)))) }), ->({ between(x,--(-0.5, -0.25)) }, { *(2, cubed((+((*(2, x)), 1)))) }), ->({ between(x,--(-0.25, 0)) }, { +(-(-(0, (*(48, cubed(x)))), (*(24, squared(x)))), 1) }), ->({ between(x,--(0, 0.25)) }, { +(-((*(48, cubed(x))), (*(24, squared(x)))), 1) })]) }",
);
