...
sl.addMethod(
  ...
  function (_self, _scale, _projection_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _scale, _projection_1"; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self) {
    ...
    let _scaledDrawing_1 = function (_projection_1) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _projection_1"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
    ...
    _appendChildren_2(_projectionsA, [
      ...
      _scaledDrawing_1(function (_each) {
        ...
        /* Temporaries */
        let __genSym120 = _assertIsOfSize_2(_each, 3),
          _x = _at_2(__genSym120, 1),
          _y = _at_2(__genSym120, 2),
          _z = _at_2(__genSym120, 3);
        /* Statements */
        return [_x, _z];
      }),
    ]);
      ...
      _withCollect_3(
        ...
        function (_label, _coordinates) {
          ...
          if (arguments.length !== 2) {
            const errorMessage =
              "Arity: expected 2, _label, _coordinates"; /* console.error(errorMessage); */
            throw new Error(errorMessage);
          }
          /* Statements */
...
sl.addMethod(
  ...
  function (_self, _structures) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _structures"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
