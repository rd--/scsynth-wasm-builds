...
sl.addMethod(
  ...
  function (_self) {
    ...
    return Object.fromEntries([["address", _address_1(_self)], [
      "args",
      _collect_2(_parameterArray_1(_self), _asRecord_1),
    ]]);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    return Object.fromEntries([[
      "timeTag",
      Object.fromEntries([["native", _times_2(_time_1(_self), 1000)]]),
    ], ["packets", _collect_2(_messageArray_1(_self), _asRecord_1)]]);
  },
...
sl.addMethod(
  ...
  "OscBundle",
  ["self", "messageArray"],
  function (_self, _messageArray) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _messageArray";
      console.error(errorMessage);
      throw Error(errorMessage);
    }
    /* Statements */
    return _initializeSlots_3(_newOscBundle_0(), _self, _messageArray);
  },
