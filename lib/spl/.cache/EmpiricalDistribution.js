...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :d | initializeSlots(newEmpiricalDistribution(),asIdentityMultiset(d), size(d)) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let b = IdentityMultiset(self); initializeSlots(newEmpiricalDistribution(),b, sum(b)) }",
);
