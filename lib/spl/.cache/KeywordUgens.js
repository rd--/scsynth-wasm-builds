...
sl.addMethod(
  ...
  function (_d) {
    ...
    return _GrainBuf_10(
      ...
      _at_2(_d, "interp"),
      _at_2(_d, "pan"),
      _query_2(_at_2(_d, "envBufNum"), -1.0),
      _at_2(_d, "maxGrains"),
    );
  },
...
sl.addMethod(
  ...
  function (_d) {
    ...
    /* Statements */
    return _LocalOut_1(_at_2(_d, "channelsArray"));
  },
  "{ :d | LocalOut(d::channelsArray) }",
);
...
sl.addMethod(
  ...
  function (_d) {
    ...
    /* Statements */
    return _Out_2(_at_2(_d, "bus"), _at_2(_d, "channelsArray"));
  },
  "{ :d | Out(d::bus, d::channelsArray) }",
);
...
sl.addMethod(
  ...
  "{ :d | MiClouds(d::pit, d::pos, d::size, d::dens, d::tex, d::dryWet, d::inGain, d::spread, d::rvb, d::fb, d::freeze, d::mode, d::lofi, d::trig, d::inputArray) }",
);
...
sl.addMethod(
  ...
  function (_d) {
    ...
    /* Statements */
    return _Seq_2(_query_2(_at_2(_d, "repeats"), _inf), _at_2(_d, "list"));
  },
