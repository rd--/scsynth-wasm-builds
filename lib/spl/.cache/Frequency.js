...
sl.addMethod(
  ...
  function (_self, _anObject) {
    ...
    /* Statements */
    return _and_2(_isFrequency_1(_anObject), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _equals_2(_hertz_1(_self), _hertz_1(_anObject));
    });
  },
...
sl.addMethod(
  ...
  function (_self, _aFrequency) {
    ...
    /* Statements */
    return _lessThan_2(_hertz_1(_self), _hertz_1(_aFrequency));
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _times_2(_hertz_1(_self), 60);
  },
  "{ :self |\n\t\tself.hertz * 60\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_hertz_1(_self), 1000);
  },
  "{ :self |\n\t\tself.hertz / 1000\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _dividedBy_2(_hertz_1(_self), 1000000);
  },
  "{ :self |\n\t\tself.hertz / 1000000\n\t}",
);
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_storeString_1(_hertz_1(_self)), ".hertz");
  },
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _hertz_1(_times_2(_self, 1000));
  },
  "{ :self |\n\t\t(self * 1000).hertz\n\t}",
);
...
sl.extendTraitWithMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _hertz_1(_times_2(_self, 1000000));
  },
  "{ :self |\n\t\t(self * 1000000).hertz\n\t}",
);
