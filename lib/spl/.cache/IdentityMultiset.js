...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _IdentitySet_1(_keys_1(_contents_1(_self)));
  }, ["self"]),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _IdentityMultiset_1(_Map_1(_self));
      }, []),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
        ...
        return _collectionToIdentityMultiset_1(_self);
      }, []),
    );
  }, ["self"]),
