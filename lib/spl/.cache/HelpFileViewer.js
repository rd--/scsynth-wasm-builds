...
sl.addMethodToExistingType(
  ...
  "showHelpFile",
  ["self", "helpFile"],
  sl.annotateFunction(function (_self, _helpFile) {
    /* ArityCheck */
    if (arguments.length !== 2) {
    ...
    let _nonCodeRanges = _asRangeList_1(
      _differenceAll_2(_to_2(1, _size_1(_lines)), _codeRanges),
    );
    ...
    let _place_1 = sl.annotateFunction(function (_item) {
      /* ArityCheck */
      if (arguments.length !== 1) {
              ...
              sl.annotateFunction(function (_codeBlock) {
                ...
                return _if_3(
                  ...
                  sl.annotateFunction(function () {
                    ...
                    return _place_1(
                      _asSmallProgram_2(
                        _parseDocumentationTest_1(_codeBlock),
