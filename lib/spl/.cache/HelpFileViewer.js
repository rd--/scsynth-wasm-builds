...
sl.addMethod(
  ...
  function (_self, _helpFile) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _helpFile"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
      ...
      return _if_3(_isCodeFence_1(_first_1(_each)), function () {
        ...
        return _do_2(
          ...
          function (_codeBlock) {
            ...
            if (arguments.length !== 1) {
              const errorMessage =
                "Arity: expected 1, _codeBlock"; /* console.error(errorMessage); */
              throw new Error(errorMessage);
            }
            /* Statements */
            return _if_3(
...
sl.addMethod(
  ...
  function (_self, _topic, _event) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _topic, _event"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _then_2(_helpIndex_1(_self), function (_helpIndex) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _helpIndex"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _then_2(_fetchFor_2(_helpIndex, _topic), function (_aString) {
        ...
        if (arguments.length !== 1) {
          const errorMessage =
            "Arity: expected 1, _aString"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
