  ...
  function (_self, _scale, _derivePoint_1) {
    ...
    let _lines = _collect_2(_edgeList_1(_self), function (_each) {
      ...
      let __genSym122 = _assertIsOfSize_2(_each, 2),
        _i = _at_2(__genSym122, 1),
        _j = _at_2(__genSym122, 2);
      /* Statements */
      return _createSvgElement_2(
        "line",
        Object.fromEntries([
        ...
        function (_libraryItem) {
          ...
          return _collect_2(_libraryItem, function (_each) {
            ...
            _if_3(_includesKey_2(_each, "octave"), function () {
              ...
              /* Temporaries */
              let __genSym123 = _assertIsOfSize_2(_at_2(_each, "octave"), 2),
                _numerator = _at_2(__genSym123, 1),
                _denominator = _at_2(__genSym123, 2);
              /* Statements */
              return _atPut_3(
                _each,
                "octave",
