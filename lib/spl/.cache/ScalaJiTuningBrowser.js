sl.addMethod(
  ...
  function (_self, _scale, _derivePoint_1) {
    ...
    let _lines = _collect_2(_edges_1(_self), function (_each) {
      ...
      /* Temporaries */
      let __genSym35 = _assertIsOfSize_2(_each, 2),
        _i = _at_2(__genSym35, 1),
        _j = _at_2(__genSym35, 2);
      /* Statements */
      return _createSvgElement_2(
        "line",
        Object.fromEntries([
        ...
        _join_1([
          _plusSignPlusSign_2(
            _plusSignPlusSign_2(
              ...
              _plusSign_2(
                _height_1(_bbox),
                _asterisk_2(2, _y_1(_origin_1(_bbox))),
              ),
            ),
            ")",
          ),
        ...
        function (_libraryItem) {
          ...
          return _collect_2(_libraryItem, function (_each) {
            ...
            _if_3(_includesKey_2(_each, "octave"), function () {
              ...
              /* Temporaries */
              let __genSym36 = _assertIsOfSize_2(_at_2(_each, "octave"), 2),
                _numerator = _at_2(__genSym36, 1),
                _denominator = _at_2(__genSym36, 2);
              /* Statements */
              return _atPut_3(
                _each,
                "octave",
