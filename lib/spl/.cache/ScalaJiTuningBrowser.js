sl.addMethod(
  ...
  function (_self, _scale, _derivePoint_1) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _scale, _derivePoint_1"; /* console.error(errorMessage); */
    ...
    let _lines = _collect_2(_edgeList_1(_self), function (_each) {
      ...
      /* Temporaries */
      let __genSym121 = _assertIsOfSize_2(_each, 2),
        _i = _at_2(__genSym121, 1),
        _j = _at_2(__genSym121, 2);
      /* Statements */
      return _createSvgElement_2(
        "line",
        Object.fromEntries([
...
sl.addMethod(
  ...
  function (_self, _jiTunings) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _jiTunings"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Temporaries */
        ...
        function (_libraryItem) {
          ...
          return _collect_2(_libraryItem, function (_each) {
            ...
            _if_3(_includesKey_2(_each, "octave"), function () {
              ...
              /* Temporaries */
              let __genSym122 = _assertIsOfSize_2(_at_2(_each, "octave"), 2),
                _numerator = _at_2(__genSym122, 1),
                _denominator = _at_2(__genSym122, 2);
              /* Statements */
              return _atPut_3(
                _each,
                "octave",
...
sl.addMethod(
  ...
  function (_self, _smallKansas, _event) {
    ...
    return _then_2(_jiScala_1(_smallKansas), function (_jiTuning) {
      ...
      if (arguments.length !== 1) {
        const errorMessage =
          "Arity: expected 1, _jiTuning"; /* console.error(errorMessage); */
        throw new Error(errorMessage);
      }
      /* Statements */
      return _addFrame_3(
