    ...
    return _useLibraryItem_2(
      ...
      _LibraryItem_4(
        ...
        function (_item) {
          ...
          /* Statements */
          return _collect_2(_item, function (_each) {
            /* ArityCheck */
            if (arguments.length !== 1) {
              const errorMessage = "Arity: expected 1, _each";
              console.error(errorMessage);
            ...
            _if_3(_includesKey_2(_each, "octave"), function () {
              ...
              /* Temporaries */
              let __genSym21 = _assertIsOfSize_2(_at_2(_each, "octave"), 2),
                _numerator = _at_2(__genSym21, 1),
                _denominator = _at_2(__genSym21, 2);
              /* Statements */
              return _atPut_3(
                _each,
                "octave",
