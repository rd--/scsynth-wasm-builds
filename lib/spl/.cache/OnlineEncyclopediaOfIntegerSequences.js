...
sl.addTrait("OeisSequence", "OnlineEncyclopediaOfIntegerSequences");
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _includes_2(_keywords_1(_self), "full");
  }, ["self"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _includes_2(_keywords_1(_self), "easy");
  }, ["self"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _collect_2(
      _splitBy_2(_offsetText_1(_self), ","),
...
sl.addMethodToExistingTrait(
  ...
  "readSequenceFile",
  ["self", "directoryName"],
  sl.annotateFunction(function (_self, _directoryName) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _directoryName";
      throw new Error(errorMessage);
    } /* Statements */
    return _readTextFile_2(_system, _sequenceFileName_2(_self, _directoryName));
  }, ["self", "directoryName"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self, _directoryName) {
    ...
    let _k = _identifier_1(_self);
    let _j = _first_2(_k, 4);
    return _format_2("%/seq/%/%.seq", [_directoryName, _j, _k]);
  }, ["self", "directoryName"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _withoutUnstableOeisKeywords_1(_keywords_1(_self));
  }, ["self"]),
...
sl.addMethodToExistingTrait(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _at_2(_offset_1(_self), 1);
  }, ["self"]),
  "{ :self |\n\t\tself.offset.at(1)\n\t}",
);
...
sl.addType(
  ...
  "OeisEntry",
  "OnlineEncyclopediaOfIntegerSequences",
  ["Object", "Storeable", "Equatable", "OeisSequence"],
  ["identifier", "contents", "bFileCache"],
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _ifNil_3(
      ...
      sl.annotateFunction(function (_bFileData) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _bFileData";
          throw new Error(errorMessage);
        } /* Statements */
        return _bFileData;
      }, ["bFileData"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _data = _bFileData_1(_self);
    let _k = _size_1(_data);
    let _indices = _column_2(_data, 1);
    let _i = _subscriptOfFirstTerm_1(_self);
    return _equalsSign_2(
      _indices,
      _asList_1(
        _nonemptyRange_3(_i, _hyphenMinus_2(_plusSign_2(_i, _k), 1), 1),
      ),
    );
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _column_2(_bFileData_1(_self), 2);
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _lookupField_2(_self, "data");
  }, ["self"]),
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _then_2(
      ...
      sl.annotateFunction(function (_data) {
        ...
        _bFileCache_2(_self, _oeisParseBFile_1(_data));
        return _self;
      }, ["data"]),
    );
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _lookupField_2(_self, "offset");
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let _s = _uniqueField_2(_self, "%S");
    let _t = _uniqueFieldOrNil_2(_self, "%T");
    let _u = _uniqueFieldOrNil_2(_self, "%U");
    return _stringCatenate_1(_deleteMissing_1([_s, _t, _u]));
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  "field",
  ["self", "code"],
  sl.annotateFunction(function (_self, _code) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _code";
      throw new Error(errorMessage);
    } /* Statements */
    let _prefix = _format_2("% % ", [_code, _identifier_1(_self)]);
    return _collect_2(
      _select_2(
        _contents_1(_self),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _splitBy_2(_uniqueField_2(_self, "%K"), ",");
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _parseDecimalInteger_1(_allButFirst_1(_identifier_1(_self)));
  }, ["self"]),
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _code) {
    ...
    let __SplVar3 = _assertIsOfSize_2(_field_2(_self, _code), 1);
    let _e = _at_2(__SplVar3, 1);
    return _e;
  }, ["self", "code"]),
  ...
  sl.annotateFunction(function (_self, _code) {
    ...
    return _caseOf_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _error_2(_self, "uniqueFieldOrNil");
      }, []),
    );
  }, ["self", "code"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _directoryName) {
    ...
    return _initializeSlots_3(
      _newOeisSequenceFile_0(),
      _self,
      _lines_1(_readSequenceFile_2(_OeisEntry_1(_self), _directoryName)),
    );
  }, ["self", "directoryName"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _OeisSequenceFile_2(
      _self,
      _environmentVariable_2(_system, "OEIS_DATA"),
    );
  }, ["self"]),
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _requireLibraryItem_2(_self, "OeisBFileData");
  }, ["self"]),
...
_addLibraryItem_2(
  ...
  _asLibraryItem_1(
    _Record_1([
      ...
      [
        "url",
        "https://rohandrape.net/sw/hsc3-data/data/oeis/OeisBFileData.json",
      ],
