...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | let __SplVar1 = assertIsOfSize(self, 6); let year = at(__SplVar1, 1); let month = at(__SplVar1, 2); let dayOfMonth = at(__SplVar1, 3); let hour = at(__SplVar1, 4); let minute = at(__SplVar1, 5); let second = at(__SplVar1, 6); DateAndTime(year, month, dayOfMonth, hour, minute, second) }",
);
