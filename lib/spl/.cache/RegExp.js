...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _matchesRegExp_2(_self, "^[0-9A-F]+$");
  }, ["self"]),
  "{ :self | matchesRegExp(self,'^[0-9A-F]+$') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | matchesRegExp(self,'^[0-9A-Za-z+/]+$') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _matchesRegExp_2(_self, "^[01]+$");
  }, ["self"]),
  "{ :self | matchesRegExp(self,'^[01]+$') }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _matchesRegExp_2(_self, "^[-+]?[0-9]+([.][0-9]+)?[eE][+-]?[0-9]+$");
  }, ["self"]),
  "{ :self | matchesRegExp(self,'^[-+]?[0-9]+([.][0-9]+)?[eE][+-]?[0-9]+$') }",
);
