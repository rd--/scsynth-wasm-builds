...
sl.addMethod(
  ...
  function (_self, _aString, _replacementString) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _aString, _replacementString"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
  ...
  function (_self, _aString, _aBlock_1) {
    ...
    return _basicReplaceWith_3(
      ...
      function (_match, _offset, _string) {
        ...
        if (arguments.length !== 3) {
          const errorMessage =
            "Arity: expected 3, _match, _offset, _string"; /* console.error(errorMessage); */
          throw new Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _aRegExp) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _aRegExp"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _regExpToFind, _stringToReplaceWith) {
    ...
    if (arguments.length !== 3) {
      const errorMessage =
        "Arity: expected 3, _self, _regExpToFind, _stringToReplaceWith"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
...
sl.addMethod(
  ...
  function (_self, _flags) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _flags"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Primitive */
...
sl.addMethod(
  ...
  function (_self, _index) {
    ...
    return _if_3(_includesIndex_2(_self, _index), function () {
      ...
      /* Temporaries */
      let _before = _if_3(_equalsSign_2(_index, 1), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage =
            "Arity: expected 0, "; /* console.error(errorMessage); */
...
sl.addMethod(
  ...
  function (_self, _separators) {
    ...
    if (arguments.length !== 2) {
      const errorMessage =
        "Arity: expected 2, _self, _separators"; /* console.error(errorMessage); */
      throw new Error(errorMessage);
    }
    /* Statements */
    return _reject_2(
