...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _coordinateArrayForEnvGen_1(_self);
  },
...
sl.addMethod(
  ...
  function (_self, _gate) {
    ...
    /* Statements */
    return _EnvGen_6(_gate, 1, 0, 1, 0, _coordinateArrayForEnvGen_1(_self));
  },
...
sl.addMethod(
  ...
  function (_self, _gate, _doneAction) {
    ...
    return _EnvGen_6(
      ...
      1,
      _doneAction,
      _coordinateArrayForEnvGen_1(_self),
    );
  },
...
sl.addMethod(
  ...
  function (_self, _timeFromLastToFirst, _curve) {
    ...
    _if_3(_isNil_1(_releaseNode_1(_self)), function () {
      ...
      /* Statements */
      _levels_2(_self, _plusPlus_2(_plusPlus_2([0], _levels_1(_self)), [0]));
      _curves_2(
        _self,
        _plusPlus_2(
          _plusPlus_2(
      ...
      _times_2(
        ...
        _plusPlus_2(
          _plusPlus_2(
            [_times_2(_first0Then1, _timeFromLastToFirst)],
            _times_1(_self),
          ),
          [_inf],
        ),
      );
      return _releaseNode_2(_self, _minus_2(_size_1(_levels_1(_self)), 2));
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
      ...
      /* Statements */
      _levels_2(_self, _plusPlus_2([0], _levels_1(_self)));
      _curves_2(
        _self,
        _plusPlus_2(
          [_curve],
          _wrapExtend_2(_asArray_1(_curves_1(_self)), _size_1(_times_1(_self))),
        ),
      );
      _times_2(
        _self,
