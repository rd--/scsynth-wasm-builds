...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _r, _t, _n) {
    ...
    let __SPL312 = _assertIsOfSize_2(_t, 2);
    let _tMin = _at_2(__SPL312, 1);
    let _tMax = _at_2(__SPL312, 2);
    /* Statements */
    return _timeSeriesRandomFunction_3(_asStream_3(_self, _r, _tMin), _t, _n);
  }, ["self", "r", "t", "n"]),
  "{ :self :r :t :n | let __SPL312 = assertIsOfSize(t, 2); let tMin = at(__SPL312, 1); let tMax = at(__SPL312, 2); timeSeriesRandomFunction(asStream(self,r, tMin),t, n) }",
);
