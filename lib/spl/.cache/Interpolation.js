...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _method) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL6 = _assertIsOfSize_2(_transposed_1(_self), 2);
  ...
  "{ :self :method | let f:/2 = namedInterpolatorFunction(method); if(isVector(self), { let y = self; let x = asList(upOrDownTo(1, size(y))); f(x, y) }, { let __SPL6 = assertIsOfSize(transposed(self), 2); let x = at(__SPL6, 1); let y = at(__SPL6, 2); f(x, y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/6 | let __SPL7 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL7, 1); let n = at(__SPL7, 2); { :x :y | let i1 = integerPart(x); let j1 = integerPart(y); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); aBlock(at(at(self, i1), j1), at(at(self, i2), j1), at(at(self, i1), j2), at(at(self, i2), j2), fractionPart(x), fractionPart(y)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/11 | let __SPL8 = assertIsOfSize(shape(self), 3); let m = at(__SPL8, 1); let n = at(__SPL8, 2); let o = at(__SPL8, 3); { :x :y :z | let i1 = integerPart(x); let j1 = integerPart(y); let k1 = integerPart(z); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); let k2 = min(o,+(k1, 1)); aBlock(at(at(at(self, i1), j1), k1), at(at(at(self, i2), j1), k1), at(at(at(self, i1), j2), k1), at(at(at(self, i2), j2), k1), at(at(at(self, i1), j1), k2), at(at(at(self, i2), j1), k2), at(at(at(self, i1), j2), k2), at(at(at(self, i2), j2), k2), fractionPart(x), fractionPart(y), fractionPart(z)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    let _p = _at_2(__SPL10, 1);
    let _q = _at_2(__SPL10, 2);
  ...
  "{ :self :shape | let __SPL9 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL9, 1); let n = at(__SPL9, 2); let __SPL10 = assertIsOfSize(shape, 2); let p = at(__SPL10, 1); let q = at(__SPL10, 2); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); table(matrixInterpolation(self,bilinearInterpolation:/6),i, j) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    let __SPL11 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL11, 1);
    let _n = _at_2(__SPL11, 2);
    let _o = _at_2(__SPL11, 3);
    let __SPL12 = _assertIsOfSize_2(_shape, 3);
    let _p = _at_2(__SPL12, 1);
    let _q = _at_2(__SPL12, 2);
    let _r = _at_2(__SPL12, 3);
    let _i = _discretize_2(_hyphenMinusHyphenMinus_2(1, _m), _p);
    let _j = _discretize_2(_hyphenMinusHyphenMinus_2(1, _n), _q);
  ...
  "{ :self :shape | let __SPL11 = assertIsOfSize(shape(self), 3); let m = at(__SPL11, 1); let n = at(__SPL11, 2); let o = at(__SPL11, 3); let __SPL12 = assertIsOfSize(shape, 3); let p = at(__SPL12, 1); let q = at(__SPL12, 2); let r = at(__SPL12, 3); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); let k = discretize((--(1, o)),r); table(volumeInterpolation(self,trilinearInterpolation:/11),i, j, k) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL13 = _assertIsOfSize_2(_transposed_1(_self), 2);
