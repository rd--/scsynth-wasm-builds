...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _method) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL1 = _assertIsOfSize_2(_transpose_1(_self), 2);
  ...
  "{ :self :method | let f:/2 = namedInterpolatorFunction(method); if(isVector(self), { let y = self; let x = asList(upOrDownTo(1, size(y))); f(x, y) }, { let __SPL1 = assertIsOfSize(transpose(self), 2); let x = at(__SPL1, 1); let y = at(__SPL1, 2); f(x, y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/6 | let __SPL2 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL2, 1); let n = at(__SPL2, 2); { :x :y | let i1 = integerPart(x); let j1 = integerPart(y); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); aBlock(at(at(self, i1), j1), at(at(self, i2), j1), at(at(self, i1), j2), at(at(self, i2), j2), fractionalPart(x), fractionalPart(y)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/11 | let __SPL3 = assertIsOfSize(shape(self), 3); let m = at(__SPL3, 1); let n = at(__SPL3, 2); let o = at(__SPL3, 3); { :x :y :z | let i1 = integerPart(x); let j1 = integerPart(y); let k1 = integerPart(z); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); let k2 = min(o,+(k1, 1)); aBlock(at(at(at(self, i1), j1), k1), at(at(at(self, i2), j1), k1), at(at(at(self, i1), j2), k1), at(at(at(self, i2), j2), k1), at(at(at(self, i1), j1), k2), at(at(at(self, i2), j1), k2), at(at(at(self, i1), j2), k2), at(at(at(self, i2), j2), k2), fractionalPart(x), fractionalPart(y), fractionalPart(z)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL8 = _assertIsOfSize_2(_transpose_1(_self), 2);
  ...
  "{ :self | if(isVector(self), { let x = asList(upOrDownTo(1, size(self))); let y = self; simpleLinearRegression(x,y) }, { let __SPL8 = assertIsOfSize(transpose(self), 2); let x = at(__SPL8, 1); let y = at(__SPL8, 2); simpleLinearRegression(x,y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL9 = _assertIsOfSize_2(_transpose_1(_self), 2);
  ...
  "{ :self | if(isVector(self), { theilSenEstimator(asList(upOrDownTo(1, size(self))), self) }, { let __SPL9 = assertIsOfSize(transpose(self), 2); let x = at(__SPL9, 1); let y = at(__SPL9, 2); theilSenEstimator(x, y) }) }",
);
