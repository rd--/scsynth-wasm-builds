  ...
  sl.annotateFunction(function (_self, _method) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL332 = _assertIsOfSize_2(_transposed_1(_self), 2);
        let _x = _at_2(__SPL332, 1);
        let _y = _at_2(__SPL332, 2);
        /* Statements */
        return _f_2(_x, _y);
      }, []),
    );
  }, ["self", "method"]),
  "{ :self :method | let f:/2 = namedInterpolatorFunction(method); if(isVector(self), { let y = self; let x = asList(upOrDownTo(1, size(y))); f(x, y) }, { let __SPL332 = assertIsOfSize(transposed(self), 2); let x = at(__SPL332, 1); let y = at(__SPL332, 2); f(x, y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_6) {
    ...
    let __SPL333 = _assertIsOfSize_2([
      _numberOfRows_1(_self),
      _numberOfColumns_1(_self),
    ], 2);
    let _m = _at_2(__SPL333, 1);
    let _n = _at_2(__SPL333, 2);
    /* Statements */
  ...
  "{ :self :aBlock:/6 | let __SPL333 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL333, 1); let n = at(__SPL333, 2); { :x :y | let i1 = integerPart(x); let j1 = integerPart(y); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); aBlock(at(at(self, i1), j1), at(at(self, i2), j1), at(at(self, i1), j2), at(at(self, i2), j2), fractionPart(x), fractionPart(y)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_11) {
    ...
    let __SPL334 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL334, 1);
    let _n = _at_2(__SPL334, 2);
    let _o = _at_2(__SPL334, 3);
    /* Statements */
  ...
  "{ :self :aBlock:/11 | let __SPL334 = assertIsOfSize(shape(self), 3); let m = at(__SPL334, 1); let n = at(__SPL334, 2); let o = at(__SPL334, 3); { :x :y :z | let i1 = integerPart(x); let j1 = integerPart(y); let k1 = integerPart(z); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); let k2 = min(o,+(k1, 1)); aBlock(at(at(at(self, i1), j1), k1), at(at(at(self, i2), j1), k1), at(at(at(self, i1), j2), k1), at(at(at(self, i2), j2), k1), at(at(at(self, i1), j1), k2), at(at(at(self, i2), j1), k2), at(at(at(self, i1), j2), k2), at(at(at(self, i2), j2), k2), fractionPart(x), fractionPart(y), fractionPart(z)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    let __SPL335 = _assertIsOfSize_2([
      _numberOfRows_1(_self),
      _numberOfColumns_1(_self),
    ], 2);
    let _m = _at_2(__SPL335, 1);
    let _n = _at_2(__SPL335, 2);
    let __SPL336 = _assertIsOfSize_2(_shape, 2);
    let _p = _at_2(__SPL336, 1);
    let _q = _at_2(__SPL336, 2);
  ...
  "{ :self :shape | let __SPL335 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL335, 1); let n = at(__SPL335, 2); let __SPL336 = assertIsOfSize(shape, 2); let p = at(__SPL336, 1); let q = at(__SPL336, 2); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); table(matrixInterpolation(self,bilinearInterpolation:/6),i, j) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    let __SPL337 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL337, 1);
    let _n = _at_2(__SPL337, 2);
    let _o = _at_2(__SPL337, 3);
    let __SPL338 = _assertIsOfSize_2(_shape, 3);
    let _p = _at_2(__SPL338, 1);
    let _q = _at_2(__SPL338, 2);
    let _r = _at_2(__SPL338, 3);
    let _i = _discretize_2(_hyphenMinusHyphenMinus_2(1, _m), _p);
    let _j = _discretize_2(_hyphenMinusHyphenMinus_2(1, _n), _q);
  ...
  "{ :self :shape | let __SPL337 = assertIsOfSize(shape(self), 3); let m = at(__SPL337, 1); let n = at(__SPL337, 2); let o = at(__SPL337, 3); let __SPL338 = assertIsOfSize(shape, 3); let p = at(__SPL338, 1); let q = at(__SPL338, 2); let r = at(__SPL338, 3); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); let k = discretize((--(1, o)),r); table(volumeInterpolation(self,trilinearInterpolation:/11),i, j, k) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL339 = _assertIsOfSize_2(_transposed_1(_self), 2);
        let _x = _at_2(__SPL339, 1);
        let _y = _at_2(__SPL339, 2);
        /* Statements */
        return _simpleLinearRegression_2(_x, _y);
      }, []),
    );
  }, ["self"]),
  "{ :self | if(isVector(self), { let x = asList(upOrDownTo(1, size(self))); let y = self; simpleLinearRegression(x,y) }, { let __SPL339 = assertIsOfSize(transposed(self), 2); let x = at(__SPL339, 1); let y = at(__SPL339, 2); simpleLinearRegression(x,y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL340 = _assertIsOfSize_2(_transposed_1(_self), 2);
  ...
  "{ :self | if(isVector(self), { theilSenEstimator(asList(upOrDownTo(1, size(self))), self) }, { let __SPL340 = assertIsOfSize(transposed(self), 2); let x = at(__SPL340, 1); let y = at(__SPL340, 2); theilSenEstimator(x, y) }) }",
);
