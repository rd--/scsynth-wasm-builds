  ...
  sl.annotateFunction(function (_self, _method) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL415 = _assertIsOfSize_2(_transpose_1(_self), 2);
        let _x = _at_2(__SPL415, 1);
        let _y = _at_2(__SPL415, 2);
        /* Statements */
        return _f_2(_x, _y);
      }, []),
    );
  }, ["self", "method"]),
  "{ :self :method | let f:/2 = namedInterpolatorFunction(method); if(isVector(self), { let y = self; let x = asList(upOrDownTo(1, size(y))); f(x, y) }, { let __SPL415 = assertIsOfSize(transpose(self), 2); let x = at(__SPL415, 1); let y = at(__SPL415, 2); f(x, y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock | let k = size(self); caseOf(numArgs(aBlock), [->(3, { { :x | let i = integerPart(x); if((=(i, k)), { last(self) }, { aBlock . (at(self, i), at(self, +(i, 1)), fractionalPart(x)) }) } }), ->(5, { { :x | let i = integerPart(x); if((=(i, k)), { last(self) }, { aBlock . (at(self, max((-(i, 1)),1)), at(self, i), at(self, +(i, 1)), at(self, min((+(i, 2)),k)), fractionalPart(x)) }) } })], { error(self,'listInterpolation: not 3- or 5- argument block') }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_6) {
    ...
    let __SPL416 = _assertIsOfSize_2([
      _numberOfRows_1(_self),
      _numberOfColumns_1(_self),
    ], 2);
    let _m = _at_2(__SPL416, 1);
    let _n = _at_2(__SPL416, 2);
    /* Statements */
  ...
  "{ :self :aBlock:/6 | let __SPL416 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL416, 1); let n = at(__SPL416, 2); { :x :y | let i1 = integerPart(x); let j1 = integerPart(y); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); aBlock(at(at(self, i1), j1), at(at(self, i2), j1), at(at(self, i1), j2), at(at(self, i2), j2), fractionalPart(x), fractionalPart(y)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_11) {
    ...
    let __SPL417 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL417, 1);
    let _n = _at_2(__SPL417, 2);
    let _o = _at_2(__SPL417, 3);
    /* Statements */
  ...
  "{ :self :aBlock:/11 | let __SPL417 = assertIsOfSize(shape(self), 3); let m = at(__SPL417, 1); let n = at(__SPL417, 2); let o = at(__SPL417, 3); { :x :y :z | let i1 = integerPart(x); let j1 = integerPart(y); let k1 = integerPart(z); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); let k2 = min(o,+(k1, 1)); aBlock(at(at(at(self, i1), j1), k1), at(at(at(self, i2), j1), k1), at(at(at(self, i1), j2), k1), at(at(at(self, i2), j2), k1), at(at(at(self, i1), j1), k2), at(at(at(self, i2), j1), k2), at(at(at(self, i1), j2), k2), at(at(at(self, i2), j2), k2), fractionalPart(x), fractionalPart(y), fractionalPart(z)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :threshold | if(isVector(self), { basicDownsampleSteinarsson(transpose([indices(self), self]),threshold) }, { basicDownsampleSteinarsson(self,threshold) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    let __SPL418 = _assertIsOfSize_2([
      _numberOfRows_1(_self),
      _numberOfColumns_1(_self),
    ], 2);
    let _m = _at_2(__SPL418, 1);
    let _n = _at_2(__SPL418, 2);
    let __SPL419 = _assertIsOfSize_2(_shape, 2);
    let _p = _at_2(__SPL419, 1);
    let _q = _at_2(__SPL419, 2);
  ...
  "{ :self :shape | let __SPL418 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL418, 1); let n = at(__SPL418, 2); let __SPL419 = assertIsOfSize(shape, 2); let p = at(__SPL419, 1); let q = at(__SPL419, 2); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); table(matrixInterpolation(self,bilinearInterpolation:/6),i, j) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    let __SPL420 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL420, 1);
    let _n = _at_2(__SPL420, 2);
    let _o = _at_2(__SPL420, 3);
    let __SPL421 = _assertIsOfSize_2(_shape, 3);
    let _p = _at_2(__SPL421, 1);
    let _q = _at_2(__SPL421, 2);
    let _r = _at_2(__SPL421, 3);
    let _i = _discretize_2(_hyphenMinusHyphenMinus_2(1, _m), _p);
    let _j = _discretize_2(_hyphenMinusHyphenMinus_2(1, _n), _q);
  ...
  "{ :self :shape | let __SPL420 = assertIsOfSize(shape(self), 3); let m = at(__SPL420, 1); let n = at(__SPL420, 2); let o = at(__SPL420, 3); let __SPL421 = assertIsOfSize(shape, 3); let p = at(__SPL421, 1); let q = at(__SPL421, 2); let r = at(__SPL421, 3); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); let k = discretize((--(1, o)),r); table(volumeInterpolation(self,trilinearInterpolation:/11),i, j, k) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :n | { :x | let answer = 0; toDo(0, n, { :i | let p = binomialPascal(-(negate(n), 1), i); let q = binomialPascal(+(*(2, n), 1), -(n, i)); let r = ^(x, (+(+(n, i), 1))); answer := +(answer, (*(*(p, q), r))) }); answer } }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL422 = _assertIsOfSize_2(_transpose_1(_self), 2);
        let _x = _at_2(__SPL422, 1);
        let _y = _at_2(__SPL422, 2);
        /* Statements */
        return _simpleLinearRegression_2(_x, _y);
      }, []),
    );
  }, ["self"]),
  "{ :self | if(isVector(self), { let x = asList(upOrDownTo(1, size(self))); let y = self; simpleLinearRegression(x,y) }, { let __SPL422 = assertIsOfSize(transpose(self), 2); let x = at(__SPL422, 1); let y = at(__SPL422, 2); simpleLinearRegression(x,y) }) }",
);
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL423 = _assertIsOfSize_2(_transpose_1(_self), 2);
        let _x = _at_2(__SPL423, 1);
        let _y = _at_2(__SPL423, 2);
        /* Statements */
        return _theilSenEstimator_2(_x, _y);
      }, []),
    );
  }, ["self"]),
  "{ :self | if(isVector(self), { theilSenEstimator(asList(upOrDownTo(1, size(self))), self) }, { let __SPL423 = assertIsOfSize(transpose(self), 2); let x = at(__SPL423, 1); let y = at(__SPL423, 2); theilSenEstimator(x, y) }) }",
);
