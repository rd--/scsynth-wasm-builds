...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :method | let f:/2 = namedInterpolatorFunction(method); if(isVector(self), { let y = self; let x = asList(upOrDownTo(1, size(y))); f(x, y) }, { let __SplVar1 = assertIsOfSize(transpose(self), 2); let x = at(__SplVar1, 1); let y = at(__SplVar1, 2); f(x, y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/6 | let __SplVar2 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SplVar2, 1); let n = at(__SplVar2, 2); { :x :y | let i1 = integerPart(x); let j1 = integerPart(y); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); aBlock(at(at(self, i1), j1), at(at(self, i2), j1), at(at(self, i1), j2), at(at(self, i2), j2), fractionalPart(x), fractionalPart(y)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/11 | let __SplVar3 = assertIsOfSize(shape(self), 3); let m = at(__SplVar3, 1); let n = at(__SplVar3, 2); let o = at(__SplVar3, 3); { :x :y :z | let i1 = integerPart(x); let j1 = integerPart(y); let k1 = integerPart(z); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); let k2 = min(o,+(k1, 1)); aBlock(at(at(at(self, i1), j1), k1), at(at(at(self, i2), j1), k1), at(at(at(self, i1), j2), k1), at(at(at(self, i2), j2), k1), at(at(at(self, i1), j1), k2), at(at(at(self, i2), j1), k2), at(at(at(self, i1), j2), k2), at(at(at(self, i2), j2), k2), fractionalPart(x), fractionalPart(y), fractionalPart(z)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :shape | let __SplVar4 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SplVar4, 1); let n = at(__SplVar4, 2); let __SplVar5 = assertIsOfSize(shape, 2); let p = at(__SplVar5, 1); let q = at(__SplVar5, 2); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); table(matrixInterpolation(self,bilinearInterpolation:/6),i, j) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :shape | let __SplVar6 = assertIsOfSize(shape(self), 3); let m = at(__SplVar6, 1); let n = at(__SplVar6, 2); let o = at(__SplVar6, 3); let __SplVar7 = assertIsOfSize(shape, 3); let p = at(__SplVar7, 1); let q = at(__SplVar7, 2); let r = at(__SplVar7, 3); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); let k = discretize((--(1, o)),r); table(volumeInterpolation(self,trilinearInterpolation:/11),i, j, k) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { let x = asList(upOrDownTo(1, size(self))); let y = self; simpleLinearRegression(x,y) }, { let __SplVar8 = assertIsOfSize(transpose(self), 2); let x = at(__SplVar8, 1); let y = at(__SplVar8, 2); simpleLinearRegression(x,y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self | if(isVector(self), { theilSenEstimator(asList(upOrDownTo(1, size(self))), self) }, { let __SplVar9 = assertIsOfSize(transpose(self), 2); let x = at(__SplVar9, 1); let y = at(__SplVar9, 2); theilSenEstimator(x, y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :tangents | { :t | if((>=(t, 1)), { last(self) }, { cubicHermiteFunctionPrimitive(self,tangents, nil, t) }) } }",
);
