...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :y1 :y2 :mu :aBlock:/3 | if(isSequence(mu), { collect(mu, { :each | blend(y1,y2, each, aBlock:/3) }) }, { aBlock(y1, y2, mu) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_x, _y) {
    ...
    let _differentiateThreePoint_4 = function (_i, _j1, _j2, _j3) {
      /* ArityCheck */
      if (arguments.length !== 4) {
    ...
    _toDo_3(3, _hyphenMinus_2(_n, 1), function (_i) {
      /* ArityCheck */
      if (arguments.length !== 1) {
        const errorMessage = "Arity: expected 1, _i";
        throw new Error(errorMessage);
      ...
      /* Statements */
      return _if_3(
        _ampersand_2(_lessThanSign_2(_abs_1(_wP), _epsilon), function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
            throw new Error(errorMessage);
          ...
          return _atPut_3(
            ...
            _solidus_2(
              _plusSign_2(
                ...
                _asterisk_2(_hyphenMinus_2(_xv, _xvM), _at_2(_differences, _i)),
              ),
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_x, _y, _n) {
    ...
    _ifTrue_2(_tildeEqualsSign_2(_size_1(_x), _size_1(_y)), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
    ...
    _ifTrue_2(_lessThanSign_2(_size_1(_x), _n), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
    ...
    return _ifFalse_2(_isStrictlyIncreasing_1(_x), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
            ...
            _solidus_2(
              _asterisk_2(
                ...
                _plusSign_2(
                  ...
                  _asterisk_2(_at_2(_y, _hyphenMinus_2(_i, 1)), _at_2(_h, _i)),
                ),
              ),
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_x, _c, _mu) {
    ...
    let _i = _hyphenMinus_2(
      _binaryDetectIndex_2(_k, function (_each) {
        /* ArityCheck */
        if (arguments.length !== 1) {
          const errorMessage = "Arity: expected 1, _each";
          throw new Error(errorMessage);
...
sl.extendTypeOrTraitWithMethod(
  ...
  ["x", "y", "firstDerivative"],
  function (_x, _y, _firstDerivative) {
    /* ArityCheck */
    if (arguments.length !== 3) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  "interpolation",
  ["data", "method"],
  function (_data, _method) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _data, _method";
      throw new Error(errorMessage);
    } /* Temporaries */
    let _f_2 = _caseOfOtherwise_3(_method, [
    ...
    /* Statements */
    return _if_3(_isVector_1(_data), function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
        const errorMessage = "Arity: expected 0, ";
        throw new Error(errorMessage);
      ...
      let __SPL179 = _assertIsOfSize_2(_transposed_1(_data), 2);
      let _x = _at_2(__SPL179, 1);
      let _y = _at_2(__SPL179, 2);
      /* Statements */
      return _f_2(_x, _y);
    });
  },
  "{ :data :method | let f:/2 = caseOfOtherwise(method, [->({ 'Akima' }, { akimaInterpolator:/2 }), ->({ 'Linear' }, { linearInterpolator:/2 }), ->({ 'Spline' }, { cubicSplineInterpolator:/2 })], { error(data,'interpolation: unknown method') }); if(isVector(data), { let y = data; let x = asList(upOrDownTo(1, size(y))); f(x, y) }, { let __SPL179 = assertIsOfSize(transposed(data), 2); let x = at(__SPL179, 1); let y = at(__SPL179, 2); f(x, y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _aBlock_6) {
    ...
    let __SPL180 = _assertIsOfSize_2([
      _numberOfRows_1(_self),
      _numberOfColumns_1(_self),
    ], 2);
    let _m = _at_2(__SPL180, 1);
    let _n = _at_2(__SPL180, 2);
    /* Statements */
  ...
  "{ :self :aBlock:/6 | let __SPL180 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL180, 1); let n = at(__SPL180, 2); { :x :y | let i1 = integerPart(x); let j1 = integerPart(y); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); aBlock(at(at(self, i1), j1), at(at(self, i2), j1), at(at(self, i1), j2), at(at(self, i2), j2), fractionPart(x), fractionPart(y)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "volumeInterpolation",
  ["self", "aBlock:/11"],
  function (_self, _aBlock_11) {
    /* ArityCheck */
    if (arguments.length !== 2) {
      const errorMessage = "Arity: expected 2, _self, _aBlock_11";
      throw new Error(errorMessage);
    } /* Temporaries */
    let __SPL181 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL181, 1);
    let _n = _at_2(__SPL181, 2);
    let _o = _at_2(__SPL181, 3);
    /* Statements */
  ...
  "{ :self :aBlock:/11 | let __SPL181 = assertIsOfSize(shape(self), 3); let m = at(__SPL181, 1); let n = at(__SPL181, 2); let o = at(__SPL181, 3); { :x :y :z | let i1 = integerPart(x); let j1 = integerPart(y); let k1 = integerPart(z); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); let k2 = min(o,+(k1, 1)); aBlock(at(at(at(self, i1), j1), k1), at(at(at(self, i2), j1), k1), at(at(at(self, i1), j2), k1), at(at(at(self, i2), j2), k1), at(at(at(self, i1), j1), k2), at(at(at(self, i2), j1), k2), at(at(at(self, i1), j2), k2), at(at(at(self, i2), j2), k2), fractionPart(x), fractionPart(y), fractionPart(z)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _shape) {
    ...
    let __SPL182 = _assertIsOfSize_2([
      _numberOfRows_1(_self),
      _numberOfColumns_1(_self),
    ], 2);
    let _m = _at_2(__SPL182, 1);
    let _n = _at_2(__SPL182, 2);
    let __SPL183 = _assertIsOfSize_2(_shape, 2);
    let _p = _at_2(__SPL183, 1);
    let _q = _at_2(__SPL183, 2);
  ...
  "{ :self :shape | let __SPL182 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL182, 1); let n = at(__SPL182, 2); let __SPL183 = assertIsOfSize(shape, 2); let p = at(__SPL183, 1); let q = at(__SPL183, 2); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); table(matrixInterpolation(self,bilinearInterpolation:/6),i, j) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  function (_self, _shape) {
    ...
    let __SPL184 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL184, 1);
    let _n = _at_2(__SPL184, 2);
    let _o = _at_2(__SPL184, 3);
    let __SPL185 = _assertIsOfSize_2(_shape, 3);
    let _p = _at_2(__SPL185, 1);
    let _q = _at_2(__SPL185, 2);
    let _r = _at_2(__SPL185, 3);
    let _i = _discretize_2(_hyphenMinusHyphenMinus_2(1, _m), _p);
    let _j = _discretize_2(_hyphenMinusHyphenMinus_2(1, _n), _q);
  ...
  "{ :self :shape | let __SPL184 = assertIsOfSize(shape(self), 3); let m = at(__SPL184, 1); let n = at(__SPL184, 2); let o = at(__SPL184, 3); let __SPL185 = assertIsOfSize(shape, 3); let p = at(__SPL185, 1); let q = at(__SPL185, 2); let r = at(__SPL185, 3); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); let k = discretize((--(1, o)),r); table(volumeInterpolation(self,trilinearInterpolation:/11),i, j, k) }",
);
