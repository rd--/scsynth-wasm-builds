...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _method) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        let __SPL11 = _assertIsOfSize_2(_transposed_1(_self), 2);
  ...
  "{ :self :method | let f:/2 = namedInterpolatorFunction(method); if(isVector(self), { let y = self; let x = asList(upOrDownTo(1, size(y))); f(x, y) }, { let __SPL11 = assertIsOfSize(transposed(self), 2); let x = at(__SPL11, 1); let y = at(__SPL11, 2); f(x, y) }) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :aBlock:/6 | let __SPL12 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL12, 1); let n = at(__SPL12, 2); { :x :y | let i1 = integerPart(x); let j1 = integerPart(y); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); aBlock(at(at(self, i1), j1), at(at(self, i2), j1), at(at(self, i1), j2), at(at(self, i2), j2), fractionPart(x), fractionPart(y)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _aBlock_11) {
    ...
    let __SPL13 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL13, 1);
    let _n = _at_2(__SPL13, 2);
    let _o = _at_2(__SPL13, 3);
    /* Statements */
  ...
  "{ :self :aBlock:/11 | let __SPL13 = assertIsOfSize(shape(self), 3); let m = at(__SPL13, 1); let n = at(__SPL13, 2); let o = at(__SPL13, 3); { :x :y :z | let i1 = integerPart(x); let j1 = integerPart(y); let k1 = integerPart(z); let i2 = min(m,+(i1, 1)); let j2 = min(n,+(j1, 1)); let k2 = min(o,+(k1, 1)); aBlock(at(at(at(self, i1), j1), k1), at(at(at(self, i2), j1), k1), at(at(at(self, i1), j2), k1), at(at(at(self, i2), j2), k1), at(at(at(self, i1), j1), k2), at(at(at(self, i2), j1), k2), at(at(at(self, i1), j2), k2), at(at(at(self, i2), j2), k2), fractionPart(x), fractionPart(y), fractionPart(z)) } }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :self :shape | let __SPL14 = assertIsOfSize([numberOfRows(self), numberOfColumns(self)], 2); let m = at(__SPL14, 1); let n = at(__SPL14, 2); let __SPL15 = assertIsOfSize(shape, 2); let p = at(__SPL15, 1); let q = at(__SPL15, 2); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); table(matrixInterpolation(self,bilinearInterpolation:/6),i, j) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _shape) {
    ...
    let __SPL16 = _assertIsOfSize_2(_shape_1(_self), 3);
    let _m = _at_2(__SPL16, 1);
    let _n = _at_2(__SPL16, 2);
    let _o = _at_2(__SPL16, 3);
    let __SPL17 = _assertIsOfSize_2(_shape, 3);
    let _p = _at_2(__SPL17, 1);
    let _q = _at_2(__SPL17, 2);
    let _r = _at_2(__SPL17, 3);
    let _i = _discretize_2(_hyphenMinusHyphenMinus_2(1, _m), _p);
    let _j = _discretize_2(_hyphenMinusHyphenMinus_2(1, _n), _q);
  ...
  "{ :self :shape | let __SPL16 = assertIsOfSize(shape(self), 3); let m = at(__SPL16, 1); let n = at(__SPL16, 2); let o = at(__SPL16, 3); let __SPL17 = assertIsOfSize(shape, 3); let p = at(__SPL17, 1); let q = at(__SPL17, 2); let r = at(__SPL17, 3); let i = discretize((--(1, m)),p); let j = discretize((--(1, n)),q); let k = discretize((--(1, o)),r); table(volumeInterpolation(self,trilinearInterpolation:/11),i, j, k) }",
);
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self) {
    ...
    let __SPL18 = _assertIsOfSize_2(_transposed_1(_self), 2);
...
sl.extendTypeOrTraitWithMethod(
      ...
      [
        ...
        _hyphenMinusGreaterThanSign_2(
          ...
          sl.annotateFunction(function () {
            ...
            return _nearestNeighborInterpolator_2;
          }, []),
        ),
      ],
      sl.annotateFunction(function () {
  ...
  "{ :self | caseOfOtherwise(self, [->({ 'Akima' }, { akimaInterpolator:/2 }), ->({ 'CubicSpline' }, { cubicSplineInterpolator:/2 }), ->({ 'Linear' }, { linearInterpolator:/2 }), ->({ 'NearestNeighbor' }, { nearestNeighborInterpolator:/2 })], { error(self,'interpolatorFunction: unknown method') }) }",
);
