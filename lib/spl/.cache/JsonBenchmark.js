...
sl.addMethodToExistingType(
  ...
  "atPut",
  ["self", "name", "index"],
  sl.annotateFunction(function (_self, _name, _index) {
    /* ArityCheck */
...
sl.addMethodToExistingType(
  ...
  "stringHash",
  ["self", "s"],
  sl.annotateFunction(function (_self, _s) {
    /* ArityCheck */
    if (arguments.length !== 2) {
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _name, _aJsonValue) {
    /* ArityCheck */
    if (arguments.length !== 3) {
  ...
  sl.annotateFunction(function (_self, _name) {
    ...
    return _if_3(
      ...
      sl.annotateFunction(function () {
        ...
        return _unimplementedCase_2(_self, "indexOf");
      }, []),
    );
  }, ["self", "name"]),
  "{ :self :name | let index = at(table(self), name); if((&(!=(index, 0), { =(name, at(names(self), index)) })), { index }, { unimplementedCase(self,'indexOf') }) }",
);
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _ifTrue_2(
        _equalsSign_2(_current_1(_self), "n"),
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
      ...
      _ifTrue_2(
        _equalsSign_2(_current_1(_self), "t"),
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
      ...
      _ifTrue_2(
        _equalsSign_2(_current_1(_self), "f"),
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
      ...
      _ifTrue_2(
        _equalsSign_2(_current_1(_self), '"'),
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
...
sl.addMethodToExistingType(
  ...
  "readListElement",
  ["self", "array"],
  sl.annotateFunction(function (_self, _array) {
    /* ArityCheck */
    if (arguments.length !== 2) {
...
sl.addMethodToExistingType(
  ...
  ["self", "object"],
  sl.annotateFunction(function (_self, _object) {
    /* ArityCheck */
    if (arguments.length !== 2) {
...
sl.addMethodToExistingType(
  ...
  "readRequiredChar",
  ["self", "ch"],
  sl.annotateFunction(function (_self, _ch) {
    /* ArityCheck */
    if (arguments.length !== 2) {
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    return _valueWithReturn_1(sl.annotateFunction(function (_return_1) {
      ...
      _ifTrue_2(
        _equalsSign_2(_current_1(_self), "b"),
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
      ...
      _ifTrue_2(
        _equalsSign_2(_current_1(_self), "r"),
        sl.annotateFunction(function () {
          /* ArityCheck */
          if (arguments.length !== 0) {
            const errorMessage = "Arity: expected 0, ";
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    _ifTrue_2(
      _exclamationMarkEqualsSign_2(_firstDigit, "0"),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self, _ch) {
    ...
    return _if_3(
      _equalsSign_2(_current_1(_self), _ch),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addMethodToExistingType(
  ...
  sl.annotateFunction(function (_self) {
    ...
    /* Statements */
    _if_3(
      _equalsSign_2("", _captureBuffer_1(_self)),
      sl.annotateFunction(function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
...
sl.addMethodToExistingType(
  ...
  "expected",
  ["self", "expected"],
  sl.annotateFunction(function (_self, _expected) {
    /* ArityCheck */
    if (arguments.length !== 2) {
...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_self, _offset, _line, _column) {
    /* ArityCheck */
