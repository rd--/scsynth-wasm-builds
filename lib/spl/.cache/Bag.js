...
sl.addMethod(
  ...
  function (_self, _aBag) {
    ...
    /* Statements */
    return _and_2(_isBag_1(_aBag), function () {
      /* ArityCheck */
      ...
      /* Statements */
      return _and_2(_equals_2(_size_1(_self), _size_1(_aBag)), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
  ...
  function (_self, _anObject, _anInteger) {
    ...
    _if_3(_includes_2(_self, _anObject), function () {
      ...
      return _atPut_3(
        _contents_1(_self),
        _anObject,
        _plus_2(_at_2(_contents_1(_self), _anObject), _anInteger),
      );
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Temporaries */
    let _s = _dividedBy_2(_size_1(_self), 100.0);
    let _n = 0;
    /* Statements */
    return _collect_2(_sortedCounts_1(_self), function (_a) {
      ...
      /* Statements */
      _n = _plus_2(_n, _key_1(_a));
      return _minusGreaterThan_2(
        _dividedBy_2(_n, _roundTo_2(_s, 0.1)),
        _value_1(_a),
      );
    });
  },
  ...
  function (_self) {
    ...
    return _injectInto_3(
      ...
      function (_max, _each) {
        /* ArityCheck */
        if (arguments.length !== 2) {
          const errorMessage = "Arity: expected 2, _max, _each";
          console.error(errorMessage);
          throw Error(errorMessage);
        }
        /* Statements */
  ...
  function (_self) {
    ...
    return _injectInto_3(
      ...
      function (_min, _each) {
        /* ArityCheck */
        if (arguments.length !== 2) {
          const errorMessage = "Arity: expected 2, _min, _each";
          console.error(errorMessage);
          throw Error(errorMessage);
        }
        /* Statements */
...
sl.addMethod(
  ...
  function (_self, _oldObject, _whenAbsent_0) {
    ...
    _if_3(_includes_2(_self, _oldObject), function () {
      ...
      /* Statements */
      return _if_3(_equals_2(_count, 1), function () {
        /* ArityCheck */
        if (arguments.length !== 0) {
          const errorMessage = "Arity: expected 0, ";
          console.error(errorMessage);
        ...
        /* Statements */
        return _atPut_3(_contents_1(_self), _oldObject, _minus_2(_count, 1));
      });
    }, function () {
      /* ArityCheck */
      if (arguments.length !== 0) {
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _do_2(_contents_1(_self), function (_each) {
      ...
      /* Statements */
      return _tally = _plus_2(_tally, _each);
    });
    return _tally;
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    _associationsDo_2(_contents_1(_self), function (_anAssociation) {
      ...
      return _add_2(
        _answer,
        _minusGreaterThan_2(_value_1(_anAssociation), _key_1(_anAssociation)),
      );
    });
    return _sortBy_2(_answer, _greaterThanEquals_2);
  },
...
sl.addMethod(
  ...
  function (_self) {
    ...
    /* Statements */
    return _plusPlus_2(_storeString_1(_contents_1(_self)), ".asBag");
  },
  ...
  function (_self) {
    ...
    return _ifEmpty_3(_self, function () {
      ...
      _withIndexDo_2(_contents_1(_self), function (_count, _value) {
        ...
        /* Statements */
        return _sum = _plus_2(_sum, _times_2(_value, _count));
      });
      return _sum;
    });
  },
