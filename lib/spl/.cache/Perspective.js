...
sl.extendTypeOrTraitWithMethod(
  ...
  "{ :eye :center :up | let z = normalize((-(eye, center))); let x = cross(up,z); let y = cross(z,x); let __SplVar1 = assertIsOfSize(normalize(x), 3); let x1 = at(__SplVar1, 1); let x2 = at(__SplVar1, 2); let x3 = at(__SplVar1, 3); let __SplVar2 = assertIsOfSize(normalize(y), 3); let y1 = at(__SplVar2, 1); let y2 = at(__SplVar2, 2); let y3 = at(__SplVar2, 3); let __SplVar3 = assertIsOfSize(z, 3); let z1 = at(__SplVar3, 1); let z2 = at(__SplVar3, 2); let z3 = at(__SplVar3, 3); let __SplVar4 = assertIsOfSize(negate(eye), 3); let w1 = at(__SplVar4, 1); let w2 = at(__SplVar4, 2); let w3 = at(__SplVar4, 3); [[x1, y1, z1, w1], [x2, y2, z2, w2], [x3, y3, z3, w3], [0, 0, 0, 1]] }",
);
