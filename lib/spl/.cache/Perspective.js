...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_eye, _center, _up) {
    ...
    let __SPL171 = _assertIsOfSize_2(_normalize_1(_x), 3);
    let _x1 = _at_2(__SPL171, 1);
    let _x2 = _at_2(__SPL171, 2);
    let _x3 = _at_2(__SPL171, 3);
    let __SPL172 = _assertIsOfSize_2(_normalize_1(_y), 3);
    let _y1 = _at_2(__SPL172, 1);
    let _y2 = _at_2(__SPL172, 2);
    let _y3 = _at_2(__SPL172, 3);
    let __SPL173 = _assertIsOfSize_2(_z, 3);
    let _z1 = _at_2(__SPL173, 1);
    let _z2 = _at_2(__SPL173, 2);
    let _z3 = _at_2(__SPL173, 3);
    let __SPL174 = _assertIsOfSize_2(_negated_1(_eye), 3);
    let _w1 = _at_2(__SPL174, 1);
    let _w2 = _at_2(__SPL174, 2);
    let _w3 = _at_2(__SPL174, 3);
    /* Statements */
  ...
  "{ :eye :center :up | let z = normalize((-(eye, center))); let x = cross(up,z); let y = cross(z,x); let __SPL171 = assertIsOfSize(normalize(x), 3); let x1 = at(__SPL171, 1); let x2 = at(__SPL171, 2); let x3 = at(__SPL171, 3); let __SPL172 = assertIsOfSize(normalize(y), 3); let y1 = at(__SPL172, 1); let y2 = at(__SPL172, 2); let y3 = at(__SPL172, 3); let __SPL173 = assertIsOfSize(z, 3); let z1 = at(__SPL173, 1); let z2 = at(__SPL173, 2); let z3 = at(__SPL173, 3); let __SPL174 = assertIsOfSize(negated(eye), 3); let w1 = at(__SPL174, 1); let w2 = at(__SPL174, 2); let w3 = at(__SPL174, 3); [[x1, y1, z1, w1], [x2, y2, z2, w2], [x3, y3, z3, w3], [0, 0, 0, 1]] }",
);
