...
sl.extendTypeOrTraitWithMethod(
  ...
  sl.annotateFunction(function (_eye, _center, _up) {
    ...
    let __SPL136 = _assertIsOfSize_2(_normalize_1(_x), 3);
    let _x1 = _at_2(__SPL136, 1);
    let _x2 = _at_2(__SPL136, 2);
    let _x3 = _at_2(__SPL136, 3);
    let __SPL137 = _assertIsOfSize_2(_normalize_1(_y), 3);
    let _y1 = _at_2(__SPL137, 1);
    let _y2 = _at_2(__SPL137, 2);
    let _y3 = _at_2(__SPL137, 3);
    let __SPL138 = _assertIsOfSize_2(_z, 3);
    let _z1 = _at_2(__SPL138, 1);
    let _z2 = _at_2(__SPL138, 2);
    let _z3 = _at_2(__SPL138, 3);
    let __SPL139 = _assertIsOfSize_2(_negated_1(_eye), 3);
    let _w1 = _at_2(__SPL139, 1);
    let _w2 = _at_2(__SPL139, 2);
    let _w3 = _at_2(__SPL139, 3);
    /* Statements */
  ...
  "{ :eye :center :up | let z = normalize((-(eye, center))); let x = cross(up,z); let y = cross(z,x); let __SPL136 = assertIsOfSize(normalize(x), 3); let x1 = at(__SPL136, 1); let x2 = at(__SPL136, 2); let x3 = at(__SPL136, 3); let __SPL137 = assertIsOfSize(normalize(y), 3); let y1 = at(__SPL137, 1); let y2 = at(__SPL137, 2); let y3 = at(__SPL137, 3); let __SPL138 = assertIsOfSize(z, 3); let z1 = at(__SPL138, 1); let z2 = at(__SPL138, 2); let z3 = at(__SPL138, 3); let __SPL139 = assertIsOfSize(negated(eye), 3); let w1 = at(__SPL139, 1); let w2 = at(__SPL139, 2); let w3 = at(__SPL139, 3); [[x1, y1, z1, w1], [x2, y2, z2, w2], [x3, y3, z3, w3], [0, 0, 0, 1]] }",
);
