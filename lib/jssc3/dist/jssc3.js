...
function parse2(path) {
    return isWindows ? parse1(path) : parse(path);
}
...
function pathStem(aPath) {
    return parse2(aPath).name;
}
...
function QuadN(freq, a, b, c, xi) {
    return makeUgen('QuadN', 1, 2, 0, [
        freq,
        a,
        b,
        c,
