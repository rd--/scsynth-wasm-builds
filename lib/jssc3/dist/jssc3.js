...
function arrayExtendCyclically(anArray, size) {
    ...
    for(let x1 = 0; x1 < size - initialSize; x1 += 1){
        result.push(arrayAtWrap(anArray, x1));
    }
    return result;
}
...
function oscInt32(x1) {
    return oscData('i', x1);
}
function oscFloat(x1) {
    return oscData('f', x1);
}
function oscString(x1) {
    return oscData('s', x1);
}
function oscBlob(x1) {
    return oscData('b', x1);
...
function Allpass1(input, freq) {
    return makeUgen('Allpass1', 1, 2, 0, [
        input,
        freq
    ]);
}
function Allpass2(input, freq, rq) {
    return makeUgen('Allpass2', 1, 2, 0, [
        input,
        freq,
        rq
    ]);
...
function BfDecode1(w, x1, y, z, azimuth, elevation, wComp) {
...
function DecodeB2(numChan, w, x1, y, orientation) {
...
function FbSineN(freq, im, fb, a, c, xi, yi) {
    return makeUgen('FBSineN', 1, 2, 0, [
        freq,
        im,
        fb,
        a,
...
function RMEQ(input, freq, rq, k) {
    return makeUgen('RMEQ', 1, [
        0
    ], 0, [
        input,
        freq,
...
function RMShelf(input, freq, k) {
    return makeUgen('RMShelf', 1, 2, 0, [
        input,
        freq,
        k
    ]);
}
function RMShelf2(input, freq, k) {
    return makeUgen('RMShelf2', 1, 2, 0, [
        input,
        freq,
        k
    ]);
}
function Rotate2(x1, y, pos) {
...
function Spreader(input, theta, filtsPerOctave) {
    return makeUgen('Spreader', 2, 2, 0, [
        input,
        theta,
        filtsPerOctave
    ]);
...
function WDistances(gate, x1, y, z, coordinateArray) {
...
function WkNearest(numChannels, gate, x1, y, z, coordinateArray) {
...
export { A2K as A2K };
export { Allpass1 as Allpass1 };
export { Allpass2 as Allpass2 };
...
export { Rlpf as Rlpf };
export { RMEQ as RMEQ };
export { RMShelf as RMShelf };
export { RMShelf2 as RMShelf2 };
...
function setPointerControls(scSynth, n, w, x1, y) {
