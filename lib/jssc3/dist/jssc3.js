...
function b_alloc_then_memcpy(bufferNumber, numberOfFrames, numberOfChannels, sampleRate, bufferData, byteSwap) {
    ...
    return b_alloc_then(bufferNumber, numberOfFrames, numberOfChannels, encodeOscPacket(b_memcpy(bufferNumber, numberOfFrames, numberOfChannels, sampleRate, bufferData, byteSwap)));
}
